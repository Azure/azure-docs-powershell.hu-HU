...
## Áttekintés
A lemez titkosítási kulcs tulajdonságát a Disk Update objektumon állítja be.
...
## Leírás
A **set-AzDiskUpdateDiskEncryptionKey** parancsmag a Disk Encryption Key tulajdonságát a Disk Update objektumban állítja be.
