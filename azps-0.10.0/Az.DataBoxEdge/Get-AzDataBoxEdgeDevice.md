...
## Leírás
A **Get-AzDataBoxEdgeDevice** parancsmag információkat kap az elérhető adatmező Edge-eszközökről. Az eszköz nevét az erőforráscsoport nevével együtt megadhatja, ha egy adott eszközön szeretne információt kapni. 
...
### -Értesítés
Értesítések beolvasása az adatmező szélén/átjáró eszközön
...
### -ExtendedInfo
További információ kérése a megadott adatok mező Edge/Data Box Gateway eszközéhez
...
### -NetworkSetting
A megadott adatmező Edge/Data Box Gateway eszköz hálózati beállításainak beolvasása
...
### -UpdateSummary
Információkat kaphat az eszköz utolsó vizsgálatán alapuló frissítések elérhetőségéről. Az eszközön minden folyamatban lévő letöltési vagy telepítési feladatról is tájékoztatást kap.
