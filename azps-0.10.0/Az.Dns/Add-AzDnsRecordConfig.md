...
## Leírás
A **Add-AzDnsRecordConfig** PARANCSMAG egy DNS-rekordot ad hozzá egy **Recordset** objektumhoz.
...
Mivel a CNAME rekord legfeljebb egy rekordban szerepelhet, kezdetben üres rekordnak kell lennie, vagy a meglévő rekordokat el kell távolítani a Remove-AzDnsRecordConfig.
...
Ez a **rekordhalmaz** kapcsolat nélküli megjelenítése, és a változtatások nem változtatják meg a DNS-válaszokat addig, amíg az Set-AzDnsRecordSet parancsmagot nem futtatja.
