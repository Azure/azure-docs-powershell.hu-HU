...
## Leírás
A **Get-AzPolicyAssignment** parancsmag minden házirend-feladatot vagy adott hozzárendelést beolvas.
...
Az első parancs beolvassa a ResourceGroup11 nevű erőforráscsoport nevű erőforráscsoportot a Get-AzResourceGroup cmdletand a $ResourceGroup változóban tárolja.
