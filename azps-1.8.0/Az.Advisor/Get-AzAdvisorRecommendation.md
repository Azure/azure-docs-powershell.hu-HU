...
## Áttekintés
Az Azure Advisor-javaslatok listáját kapja.
...
## Leírás
Beolvassa az Azure Advisor-javaslatok listáját. Lehet szűrni kategória, erőforrás-azonosító, név stb.
...
```
Megkapja az összes javaslat listáját.
...
Type                 : Microsoft.Advisor/recommendations
```
A kategória szerinti teljesítménnyel szűrt javaslatok listáját kapja meg.

## PARAMÉTEREK

### -Category (kategória)
Az ajánlás kategóriája
