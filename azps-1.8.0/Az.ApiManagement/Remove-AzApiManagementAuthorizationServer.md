...
## Leírás
A **Remove-AzApiManagementAuthorizationServer** parancsmag eltávolítja az Azure API-kezelési engedélyezési kiszolgálóját.
...
Ez a parancs eltávolítja a megadott API-kezelési engedélyezési kiszolgálót.
