...
### Példa 1 a napi adatmennyiség sapka beállítása az alkalmazásbeli betekintések erőforráshoz
```
...
A napi adatvolumeni sapka beállítása napi 400GB és az üzenet küldésének leállítása az "ellenőrzés" erőforráscsoport "testgroup" erőforráscsoport esetén
