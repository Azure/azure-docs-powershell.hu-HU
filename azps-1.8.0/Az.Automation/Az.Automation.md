...
## Leírás
Ez a témakör az Azure Automation parancsmagokkal kapcsolatos súgótémaköröket jeleníti meg.

## Az. automatizálási parancsmagok
...
Beolvassa az Azure automatizálási vezérlők listáját.
...
Automatizálási webhorgokat kap.
...
### [Új – AzAutomationSoftwareUpdateConfiguration](New-AzAutomationSoftwareUpdateConfiguration.md)
Ütemezett Azure automatizálási szoftverfrissítési konfigurációt hoz létre.

### [Új – AzAutomationSourceControl](New-AzAutomationSourceControl.md)
Automatizálási adatforrás-vezérlőt hoz létre.
...
Automatizálási hitelesítő adatok eltávolítása.

### [Remove-AzAutomationDscConfiguration](Remove-AzAutomationDscConfiguration.md)
Az automatizálásból eltávolítja a DSC-konfigurációkat.
...
Az Azure automatizálási verziókövetés eltávolítása.
...
Egy automatizálási feladat felfüggesztése.
