...
## Leírás
A **set-AzBatchTask** parancsmag frissíti egy tevékenység tulajdonságait az Azure kötegfájl-szolgáltatásban.
A Get-AzBatchTask parancsmaggal **PSCloudTask** objektumot hozhat létre.
...
Az első parancs **beolvassa a feladatot a Get-AzBatchTask** függvénnyel, majd a $Task változóban tárolja.
