...
## Leírás
A **Get-AzConsumptionReservationDetail** parancsmag foglalási adatokat kap a megadott dátumtartomány számára.

## Példák

### Példa 1: foglalási adatok beszerzése foglalási megrendelési azonosítóval a megadott dátumtartomány szerint
```powershell
...
### 2. példa: foglalási adatok beszerzése foglalási megrendelési azonosítóval és a megadott dátumtartomány foglalási azonosítójával
```powershell
...
### -EndDate
A záró adatok (éééé-hh-nn) a foglalás részleteiben.
...
### -StartDate
Az adatok kezdése (éééé-hh-nn) a foglalás részleteiben.
...
### Microsoft. Azure. commands. fogyasztás. models. PSReservationDetail
