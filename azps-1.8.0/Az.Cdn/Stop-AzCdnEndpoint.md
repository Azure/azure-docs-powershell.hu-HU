...
## Leírás
A **stop-AzCdnEndpoint** parancsmag leállítja az Azure Content Delivery Network (CDN) végpontját.
...
### -CdnEndpoint
Azt a végpont-objektumot adja meg, amelyre a parancsmag leáll.
...
### -EndpointName
Annak a végpontnak a nevét adja meg, amelyre a parancsmag leáll.
