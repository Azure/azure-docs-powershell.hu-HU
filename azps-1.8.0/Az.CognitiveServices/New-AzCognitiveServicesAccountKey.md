...
## Leírás
A **New-AzCognitiveServicesAccountKey** parancsmag regenerálta egy API-kulcsot a kognitív szolgáltatások fiókjához.
...
### -Kulcsnév
Az újragenerálni kívánt kulcs nevét adja meg.
...
### Microsoft. Azure. Management. CognitiveServices. modellek. kulcsnév
