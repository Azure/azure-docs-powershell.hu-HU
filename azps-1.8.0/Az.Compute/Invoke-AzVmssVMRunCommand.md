...
## Leírás
Hivatkozhat a Futtatás parancsra a Virtual Machine Scale set VM alkalmazásban.
...
A RunPowerShellScript Futtatás parancsával megnyithatja a "sample.ps1" parancsfájlt, és a "vmssname" erőforráscsoport "rgname" erőforráscsoporthoz tartozó "0" VM-es AZONOSÍTÓJÚ paramétereit.
...
### -InstanceId
A virtuálisgép-készlet virtuális gép példányának azonosítója.
...
A PS Virtual Machine Scale set VM objektuma.
...
### -VMScaleSetName
A virtuális gép méretarány beállítása VM.
