...
## Leírás
A **meghívó-AzDataFactoryV2IntegrationRuntimeUpgrade** parancsmag az önálló integrációs futtatókörnyezetet frissíti, ha az új verzió elérhető.

## Példák

### 1. példa: egy önállóan üzemeltetett integrációs futtatókörnyezet frissítése
```
...
A parancsmag a "teszt-selfhost-IR" nevű "tesztelt-DF-EU2" adatkezelési futtatókörnyezetet frissíti.
