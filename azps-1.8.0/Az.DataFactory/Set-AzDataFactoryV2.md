...
### 2. példa: egy meglévő gyári objektum segítségével adatfeldolgozót hozhat létre a repoconfiguration részleteiben.
```
...
### -HostName (állomásnév)
A repó-konfiguráció állomásnevét tároló név.
...
### -Projektnév
A projekt neve a repo-konfigurációhoz.
...
A repó-konfiguráció bérlői azonosítója.
