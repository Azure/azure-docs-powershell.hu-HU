...
## Leírás
Az **Add-AzDataLakeStoreTrustedIdProvider** parancsmag egy megbízható identitás-szolgáltatót ad hozzá a megadott Data Lake Store-fiókhoz.

## Példák

### 1. példa: megbízható identitás-szolgáltató hozzáadása
```
...
A "MyProvider" szolgáltató felveszi a "ContosoADL" fiókot a szolgáltató végpontjának " https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 "

## PARAMÉTEREK

### -Fiók
Az adattó-tároló fiók neve, amely a megadott megbízható identitás-szolgáltatót adja hozzá.
...
### -Name (név)
A felvenni kívánt megbízható személyazonosság-szolgáltató neve
...
### -ProviderEndpoint
Az érvényes megbízható szolgáltató végpontja a következő formátumban: https://sts.windows.net/\<provider identitás \> "
...
### -ResourceGroupName
Annak az erőforráscsoportnek a neve, amely alatt a megbízható személyazonosság-szolgáltatót felvenni kívánt fiók.
