...
## Áttekintés
A törölt fájlok vagy mappák visszaállítása az Azure Data Lakeben.
...
## Leírás
A **Restore-AzDataLakeStoreDeletedItem** parancsmag visszaállítja a törölt fájlokat vagy mappákat az Adattó áruházban. A törölt elemek elérési útját igényli a Kuka retunred a Get-AzDataLakeStoreDeletedItem.

## Példák

### 1. példa: fájl visszaállítása az adattó áruházból a-Force beállítás használatával
```
...
### -Destination (cél)
A hely elérési útja, ahová a törölt fájlt vagy mappát vissza kell állítani. 
...
### -PassThru
IGAZ logikai érték visszaadása a siker érdekében.
...
### -Path (elérési út)
A törölt fájl vagy mappa elérési útvonala a kukában.
...
### -RestoreAction
A rendeltetési hely nevének ütközése – "másolat" vagy "felülírás"
...
### -Type (típus)
A visszaállítandó bejegyzés típusa – "fájl" vagy "mappa"
