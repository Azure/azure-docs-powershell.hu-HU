...
## Leírás
A **New-AzDeploymentManagerService** parancsmag egy szolgáltatás topológiája alatt hoz létre egy szolgáltatást, és egy olyan objektumot ad eredményül, amely az adott szolgáltatást jelképezi.
Adja meg a szolgáltatást a nevével, a szolgáltatási topológiával, és az erőforráscsoport nevével. 

A parancsmag egy szolgáltatási objektumot ad eredményül. Ezt az objektumot helyileg is módosíthatja, majd a Set-AzDeploymentManagerService parancsmag használatával alkalmazhatja a módosításokat.
