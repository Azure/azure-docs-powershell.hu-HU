...
### 3. példa: az összes fontos boltíves kezelt tárolási fiók listázása szűréssel
```powershell
...
Felsorolja azokat a fiókokat, amelyek kulcsait az "myvault" és a "teszt" kezdetű Vault kezeli.
