...
## Leírás
A **Get-AzIntegrationAccountAssembly** parancsmag egy integrációs fiókból kapja meg a kódösszeállítást.

## Példák

### Példa 1: kódösszeállítás beszerzése paraméterek alapján
```powershell
...
Beszerezhet egy "sampleAssembly" nevű kódösszeállítást az "sampleIntegrationAccount" erőforráscsoport "sampleResourceGroup" erőforráscsoporthoz tartozó "" nevű integrációs fiókban.

### 2. példa: az integrációs fiók összes összeállításának felsorolása paraméterek szerint
```powershell
...
Az "sampleIntegrationAccount" ("sampleResourceGroup") erőforráscsoport az integrációs fiókban található összes kódösszeállítás beolvasása.
