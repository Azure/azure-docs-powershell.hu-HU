...
## Leírás
Az **Add-AzWebtestAlertRule** parancsmag metrikát, eseményt vagy webteszt típust ad hozzá vagy frissít egy figyelmeztetési szabályhoz.
...
### Példa 1: webteszt figyelmeztetési szabály hozzáadása
```
...
Ez a parancs webteszt-figyelmeztetési szabályt ad hozzá vagy frissít.
...
### -FailedLocationCount
A webteszt szabályok sikertelen helyének számát adja meg.
Ez hasonló a más típusú szabályokban szereplő küszöbértékhez.
...
### -MetricNamespace
A szabály metrikus névterét adja meg.
...
### -TargetResourceUri
A webteszt erőforrás-AZONOSÍTÓját adja meg.
...
### System. Collections. Generic. list ' 1 [[Microsoft. Azure. Management. monitor. Management. models. RuleAction, Microsoft. Azure. PowerShell. parancsmagok. monitor, Version = 1.0.0.0, Culture = semleges, PublicKeyToken = null]]
