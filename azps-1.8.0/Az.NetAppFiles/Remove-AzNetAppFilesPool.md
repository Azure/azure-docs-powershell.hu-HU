...
## Leírás
A **Remove-AzNetAppFilesPool** parancsmag törli a ANF-készletet.
...
### -AccountObject
Az eltávolítandó készletet tartalmazó ügyfél-objektum
...
### -InputObject
Az eltávolítandó Pool objektum
...
### -PassThru
A megadott alkalmazáskészlet sikeres eltávolításának visszavonása
