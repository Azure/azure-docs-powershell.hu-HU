...
## Leírás
A Get-AzDdosProtectionPlan parancsmag a DDoS védelmi csomagot kapja.

## Példák

### Példa 1: konkrét DDoS védelmi csomag beszerzése
```
...
Ebben az esetben meg kell adnia a **ResourceGroupName** és a **Name** attribútumot is, amely megfelel az erőforráscsoport és a DDoS védelmi terv nevének.

### 2. példa: egy erőforráscsoport minden DDoS védelmi tervének beszerzése
```
...
Ebben az esetben csak az **ResourceGroupName** paramétert adjuk meg a DDoS védelmi csomagok listájának beszerzéséhez.

### 3. példa: az előfizetésben szereplő összes DDoS védelmi csomag beszerzése
```
...
Itt nem adunk meg semmilyen paramétert az előfizetésben szereplő összes DDoS védelmi csomag listájának beszerzéséhez.

### Példa 4: az összes DDoS védelmi csomag beszerzése előfizetésben
```
...
Ez a parancsmag a "teszt" kezdetű összes DdosProtectionPlans visszaadja.
...
### -ResourceGroupName
A DDoS védelem terve erőforráscsoport nevét adja meg.
