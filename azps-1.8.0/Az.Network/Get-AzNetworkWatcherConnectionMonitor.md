...
### Példa 1: a kapcsolat monitorjának beszerzése név szerint a megadott helyen
```
...
Ebben a példában a kapcsolat monitort a megadott helyen, név szerint szerezheti be.

### 2. példa: a kapcsolati monitorok szűréssel való beolvasása
```
...
Ebben a példában bemutatjuk az összes olyan NetworkWatcher_centraluseuap-monitort, amely a "cm"-vel kezdődően jelenik meg
