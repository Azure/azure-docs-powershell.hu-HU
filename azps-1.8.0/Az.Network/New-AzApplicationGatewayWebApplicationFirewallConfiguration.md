...
## Leírás
A **New-AzApplicationGatewayWebApplicationFirewallConfiguration** parancsmag létrehoz egy webalkalmazás-TŰZFAL (WAF) konfigurációt egy Azure Application Gateway számára.
...
### -FileUploadLimitInMb
Maximális feltöltési korlát MB-ban
...
Maximális kérés: a szövegtörzs mérete KB-ban
...
### -RequestBodyCheck
Azt, hogy a kérési törzs be van-e jelölve vagy sem.
