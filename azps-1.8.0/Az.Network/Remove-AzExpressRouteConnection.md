...
A fenti létrehoz egy erőforráscsoport, virtuális WAN, virtuális hálózat, virtuális hub a Nyugat-amerikai "testRG" erőforráscsoport az Azure-ban. Ezt követően egy ExpressRoute átjáró jön létre a virtuális központban, 2 léptékű egységgel.

Miután létrehozta az átjárót, az a New-AzExpressRouteConnection parancs segítségével csatlakozik a ExpressRouteSite.

Ezután eltávolítja a kapcsolatot a kapcsolat nevével.
...
Ugyanaz, mint a példa 1, de most már eltávolítja a kapcsolatot a Get-AzExpressRouteConnection-től a vezetékes objektummal.
...
### -InputObject
A frissítendő ExpressRouteConenction objektum.
...
### -ResourceId
A törlendő ExpressRouteConenction-objektum erőforrás-azonosítója.
