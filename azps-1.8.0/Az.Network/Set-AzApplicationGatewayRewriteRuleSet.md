...
## Leírás
A **set-AzApplicationGatewayRewriteRuleSet** parancsmag módosítja a kérések útválasztási szabályát.
...
A második parancs a $rule változóban megadott átírási szabályok használatához módosította az alkalmazás átjárójának átírási szabályát.
