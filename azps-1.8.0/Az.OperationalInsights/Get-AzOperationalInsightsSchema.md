...
## Leírás
A **Get-AzOperationalInsightsSchema** parancsmag azt a sémát adja meg, amely az erőforráscsoport adott munkaterületéhez van társítva.

## Példák

### Példa 1: a sémák beszerzése egy munkaterületre
```
...
### Microsoft. Azure. Command. OperationalInsights. models. PSSearchGetSchemaResponse
