...
## Leírás
A **New-AzOperationalInsightsComputerGroup** parancsmag egy számítógép-csoportot hoz létre egy erőforrás-csoportban és-helyen.
...
### -Category (kategória)
A számítógép csoport kategóriáját adja meg.
...
### -DisplayName
A számítógép csoport megjelenítendő nevét adja meg.
...
### -Query
A számítógép csoport lekérdezését adja meg.
...
A parancsmag az erőforráscsoport számítógépcsoport csoportját hozza létre.
...
### -SavedSearchId
A számítógép csoportjának AZONOSÍTÓját adja meg.
