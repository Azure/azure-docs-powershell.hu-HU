...
## Leírás
A **unregister-AzRecoveryServicesBackupManagementServer** parancsmag a System Center Data Protection Manager (SCDPM) kiszolgálóját vagy az Azure Backup Servert a boltozatról.
...
A helyreállítási szolgáltatások biztonságimásolat-tárolója.
