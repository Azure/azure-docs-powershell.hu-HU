...
## Leírás
A **New-AzSearchQueryKey** parancsmag új lekérdezési kulcsot hoz létre az Azure Search szolgáltatáshoz.
...
A példa létrehoz egy új lekérdezési kulcsot az Azure Search szolgáltatáshoz.
...
### -Name (név)
Keresési szolgáltatás lekérdezési kulcsának neve.
