...
ms.locfileid: "93669255"
---
# <span data-ttu-id="ce2e6-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="ce2e6-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="ce2e6-102">Áttekintés</span><span class="sxs-lookup"><span data-stu-id="ce2e6-102">SYNOPSIS</span></span>
<span data-ttu-id="ce2e6-103">Az Azure Security Center által észlelt biztonsági riasztásokat kapja</span><span class="sxs-lookup"><span data-stu-id="ce2e6-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="ce2e6-104">SZINTAXISA</span><span class="sxs-lookup"><span data-stu-id="ce2e6-104">SYNTAX</span></span>

### <span data-ttu-id="ce2e6-105">SubscriptionScope (alapértelmezett)</span><span class="sxs-lookup"><span data-stu-id="ce2e6-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="ce2e6-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="ce2e6-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="ce2e6-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="ce2e6-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="ce2e6-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="ce2e6-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="ce2e6-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="ce2e6-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="ce2e6-110">Leírás</span><span class="sxs-lookup"><span data-stu-id="ce2e6-110">DESCRIPTION</span></span>
<span data-ttu-id="ce2e6-111">Az Azure Security Center által észlelt biztonsági riasztásokat kapja</span><span class="sxs-lookup"><span data-stu-id="ce2e6-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="ce2e6-112">Példák</span><span class="sxs-lookup"><span data-stu-id="ce2e6-112">EXAMPLES</span></span>

### <span data-ttu-id="ce2e6-113">Példa 1</span><span class="sxs-lookup"><span data-stu-id="ce2e6-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="ce2e6-114">Az resoruces-on belül észlelt összes biztonsági figyelmeztetést kapja</span><span class="sxs-lookup"><span data-stu-id="ce2e6-114">Gets all the security alerts that were detected on resoruces inside a subscription</span></span>

### <span data-ttu-id="ce2e6-115">2. példa</span><span class="sxs-lookup"><span data-stu-id="ce2e6-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="ce2e6-116">Az resoruces-on a "myService1" erőforráscsoport belsejében észlelt összes biztonsági figyelmeztetést kapja.</span><span class="sxs-lookup"><span data-stu-id="ce2e6-116">Gets all the security alerts that were detected on resoruces inside the "myService1" resource group</span></span>

### <span data-ttu-id="ce2e6-117">3. példa</span><span class="sxs-lookup"><span data-stu-id="ce2e6-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="ce2e6-118">A resoruces-ban a "myService1" erőforráscsoport belsejében észlelt biztonsági figyelmeztetést kapja.</span><span class="sxs-lookup"><span data-stu-id="ce2e6-118">Gets a specific security alert that were detected on resoruces inside the "myService1" resource group</span></span>

## <span data-ttu-id="ce2e6-119">PARAMÉTEREK</span><span class="sxs-lookup"><span data-stu-id="ce2e6-119">PARAMETERS</span></span>

### <span data-ttu-id="ce2e6-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="ce2e6-120">-DefaultProfile</span></span>
<span data-ttu-id="ce2e6-121">Az Azuretal való kommunikációhoz használt hitelesítő adatok, fiók, bérlői fiók és előfizetés.</span><span class="sxs-lookup"><span data-stu-id="ce2e6-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="ce2e6-122">-Hely</span><span class="sxs-lookup"><span data-stu-id="ce2e6-122">-Location</span></span>
<span data-ttu-id="ce2e6-123">Helyre.</span><span class="sxs-lookup"><span data-stu-id="ce2e6-123">Location.</span></span>
...
### <span data-ttu-id="ce2e6-124">-Name (név)</span><span class="sxs-lookup"><span data-stu-id="ce2e6-124">-Name</span></span>
<span data-ttu-id="ce2e6-125">Erőforrás neve</span><span class="sxs-lookup"><span data-stu-id="ce2e6-125">Resource name.</span></span>
...
### <span data-ttu-id="ce2e6-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="ce2e6-126">-ResourceGroupName</span></span>
<span data-ttu-id="ce2e6-127">Erőforráscsoporthoz tartozó név.</span><span class="sxs-lookup"><span data-stu-id="ce2e6-127">Resource group name.</span></span>
...
### <span data-ttu-id="ce2e6-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="ce2e6-128">-ResourceId</span></span>
<span data-ttu-id="ce2e6-129">Erőforrás-azonosító.</span><span class="sxs-lookup"><span data-stu-id="ce2e6-129">Resource ID.</span></span>
...
### <span data-ttu-id="ce2e6-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="ce2e6-130">CommonParameters</span></span>
<span data-ttu-id="ce2e6-131">Ez a parancsmag a következő általános paramétereket támogatja:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-,-PipelineVariable-WarningAction</span><span class="sxs-lookup"><span data-stu-id="ce2e6-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="ce2e6-132">További információ: about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="ce2e6-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="ce2e6-133">BEMENETEK</span><span class="sxs-lookup"><span data-stu-id="ce2e6-133">INPUTS</span></span>

### <span data-ttu-id="ce2e6-134">System. String</span><span class="sxs-lookup"><span data-stu-id="ce2e6-134">System.String</span></span>

## <span data-ttu-id="ce2e6-135">KIMENETEK</span><span class="sxs-lookup"><span data-stu-id="ce2e6-135">OUTPUTS</span></span>

### <span data-ttu-id="ce2e6-136">Microsoft. Azure. commands. Security. models. riasztások. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="ce2e6-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="ce2e6-137">MEGJEGYZI</span><span class="sxs-lookup"><span data-stu-id="ce2e6-137">NOTES</span></span>

## <span data-ttu-id="ce2e6-138">KAPCSOLÓDÓ HIVATKOZÁSOK</span><span class="sxs-lookup"><span data-stu-id="ce2e6-138">RELATED LINKS</span></span>
