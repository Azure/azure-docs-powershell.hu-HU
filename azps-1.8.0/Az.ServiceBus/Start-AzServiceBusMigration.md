...
## Leírás
A **Start-AzServiceBusMigration** parancsmag új áttelepítési konfigurációt hoz létre, és elindítja az entitások áttelepítését a szokásostól a prémium névtérig
...
Új áttelepítési konfiguráció létrehozása "TestingNamespaceStandardMirgation"-hoz ' TestingNamespacePremiumMirgation ' névterekhez
...
### -PostMigrationName
Áttelepítési név közzététele a standrad-névtérben az áttelepítés során
