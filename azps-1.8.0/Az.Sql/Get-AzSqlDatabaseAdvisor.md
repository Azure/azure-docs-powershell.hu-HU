...
### Példa 1: a megadott adatbázis összes tanácsadójának listázása
```
...
Ez a parancs megjeleníti a WIRunner nevű adatbázis összes tanácsadóját, amely a Wi-Runner-Ausztrália-Kelet nevű kiszolgálóhoz tartozik.

### 2. példa: a megadott adatbázis egyetlen tanácsadójának beszerzése
```
...
Ez a parancs a CreateIndex nevű tanácsadót kapja a WIRunner nevű adatbázishoz.
...
Ez a parancs beilleszti az "WIRunner" nevű adatbázis összes tanácsadóját a válaszban szereplő javasolt műveletekkel.
Mivel a parancs a *ExpandRecommendedActions* paramétert használja, a parancsmag az ajánlott műveleteket kapja meg a válaszsal.

### Példa 4: egyetlen tanácsadó beszerzése a válaszban szereplő javasolt műveletekkel
```
...
Ez a parancs a CreateIndex nevű tanácsadót a WIRunner nevű adatbázisból kapja meg a válaszban szereplő javasolt műveletekkel.
Mivel a parancs a *ExpandRecommendedActions* paramétert használja, a parancsmag az ajánlott műveleteket kapja meg a válaszsal.

### Példa 5: a megadott adatbázis összes tanácsadójának listázása szűréssel
```
...
Ez a parancs megjeleníti a WIRunner nevű adatbázis összes tanácsadóját, amely a Wi-Runner-Ausztrália-Kelet nevű kiszolgálóhoz tartozik, és a "d" betűvel kezdődik.

## PARAMÉTEREK

### -AdvisorName
Annak a tanácsadónak a nevét adja meg, amely a parancsmagot kapja.
...
### -DatabaseName
Annak az adatbázisnak a nevét adja meg, amelynek a parancsmagja a tanácsadót kéri.
...
Azt jelzi, hogy ez a parancsmag az ajánlott műveleteket kapja meg a válaszsal.
...
## MEGJEGYZI
* Kulcsszavak: Azure, azurerm, ARM, erőforrás, kezelés, vezető, SQL, Database, MSSQL, Advisor
