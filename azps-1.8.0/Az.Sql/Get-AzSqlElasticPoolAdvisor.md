...
## Leírás
A **Get-AzSqlElasticPoolAdvisor** parancsmag egy vagy több Azure SQL elasztikus Pool-tanácsadót kap az Azure SQL rugalmas készletéhez.

## Példák

### 1. példa: a megadott rugalmas készlet összes tanácsadójának felsorolása
```
...
A parancs megjeleníti a WIRunnerPool nevű rugalmas készlet összes tanácsadóját.

### 2. példa: egyetlen tanácsadót kap a megadott rugalmas készlethez
```
...
Ez a parancs a CreateIndex nevű tanácsadót a WIRunnerPool nevű rugalmas készlethez kapja.
...
Ez a parancs a rugalmas készlet összes tanácsadóját beilleszti a válaszban szereplő javasolt műveletekkel.
...
### 5. példa: a megadott rugalmas készlet összes tanácsadójának listája szűréssel
```
...
A parancs megjeleníti a WIRunnerPool nevű rugalmas készlet minden tanácsadóját, amely a "d" betűvel kezdődik.
...
### -ElasticPoolName
Annak a rugalmas készletnek a neve, amelyhez a parancsmag kéri a tanácsadót.
...
Jelzi, hogy a parancsmag a válaszban szereplő ajánlott műveleteket tartalmazza.
...
## MEGJEGYZI
* Kulcsszavak: Azure, azurerm, ARM, erőforrás, kezelés, vezető, SQL, elasticpool, MSSQL, Advisor
