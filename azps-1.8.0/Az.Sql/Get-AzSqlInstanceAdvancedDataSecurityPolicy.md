...
## Leírás
A **Get-AzSqlInstanceAdvancedDataSecurityPolicy** parancsmag egy felügyelt példány speciális adatbiztonsági házirendjének lekérdezését.

## Példák

### Példa 1 – a felügyelt példány speciális adatbiztonsága
```powershell
...
### Példa: a felügyelt példány speciális adatbiztonsága a felügyelt példányok erőforrásból
```powershell
