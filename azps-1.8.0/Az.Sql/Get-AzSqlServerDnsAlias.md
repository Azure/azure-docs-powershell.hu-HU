...
## Leírás
A megadott Azure SQL Server DNS-alias beszerzése vagy a kiszolgáló összes DNS-aliasának listázása
...
A kiszolgáló összes DNS-aliasának listázása az adott kiszolgálón
...
A kiszolgáló és az alias neve által megadott DNS-alias beolvasása
...
A "dnsaliasname" kezdetű kiszolgáló DNS-aliasait sorolja fel.
