...
## Leírás
A **Get-AzSqlServerUpgradeHint** parancsmag árazási szintű tippeket ad az Azure SQL-adatbázis kiszolgálójának frissítéséhez.
...
### Microsoft. Azure. Command. SQL. ServiceTierAdvisor. Model. UpgradeServerHint
