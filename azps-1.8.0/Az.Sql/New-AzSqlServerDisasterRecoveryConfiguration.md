...
## Leírás
A **New-AzSqlServerDisasterRecoveryConfiguration** parancsmag létrehoz egy SQL adatbázis-kiszolgálói rendszer-helyreállítási konfigurációt.
...
### -FailoverPolicy
A feladatátvételi házirendet adja meg.
...
### -PartnerServerName
A partner kiszolgálójának a nevét adja meg.
