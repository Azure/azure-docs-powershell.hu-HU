...
## Leírás
A **set-AzSqlServerRecommendedActionState** parancsmag frissíti az Azure SQL Server által javasolt műveletek állapotát.
Ez a parancsmag az új állapot alapján az ajánlott lépéseket alkalmazza, visszaállítja vagy elveti.

## Példák

### Example1: a megadott javasolt tevékenység állapotának frissítése függőben
```
...
A kiszolgáló által javasolt "IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893" a "függőben" állapotú műveletek

## PARAMÉTEREK

### -AdvisorName
Az ajánlott műveleteket tartalmazó tanácsadó nevét adja meg.
