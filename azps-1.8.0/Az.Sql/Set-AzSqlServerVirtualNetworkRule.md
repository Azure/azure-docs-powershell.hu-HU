...
## Leírás
Ez a parancs módosítja egy Azure SQL Server virtuális hálózati szabály konfigurációját.
A kiszolgálón lévő virtuális hálózati szabályok beállításához használja inkább a "AzSqlServerVirtualNetworkRule" és a "Remove-AzSqlServerVirtualNetworkRule" parancsot.
...
Módosítja egy meglévő virtuális hálózati szabályt az új virtuális hálózat alhálózati azonosítójával, amely az új virtuális hálózatról tartalmaz információkat.
...
Az Azure SQL Server virtuális hálózati szabályának neve.
...
A szabály virtuális hálózati alhálózati azonosítója.
...
### Microsoft. Azure. Command. SQL. VirtualNetworkRule. Model. AzureSqlServerVirtualNetworkRuleModel
