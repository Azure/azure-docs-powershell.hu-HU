...
## Leírás
Az **Update-AzRmStorageContainer** parancsmag a tároló blob-tárolóját módosítja.

## Példák

### Példa 1: a Storage blob-tároló metaadatait és a nyilvános hozzáférést a tárolási fiók nevével és a tároló nevével módosítja.
```
...
Ez a parancs módosítja a blob-tároló metaadatait és a nyilvános hozzáférést a tárolási fiók nevével és a tároló nevével.

### 2. példa: a nyilvános hozzáférés letiltása a tároló blob-tárolójában a tárolási fiók objektummal és a tároló nevével
```
...
Ez a parancs letiltja a nyilvános hozzáférést a tároló blob-tárolóban a tárolási fiók objektummal és a tároló nevével.

### 3. példa: a nyilvános hozzáférés beállítása blob-ként az adattároló blob-tárolók esetén a csővezetéket tartalmazó tárolási fiókban
```
...
Ez a parancs a nyilvános hozzáférést blob-ként adja meg a csővezetéken tárolt tárterület-tárolókban.
