...
## Leírás
Létrehoz egy olyan objektumot, amely egy, az Azure tárolási útját jelképezi, és egy webalkalmazásban van elhelyezve.
...
### -AccessKey
Access-kulcs az Azure Storage-fiókhoz
...
### -MountPath
Annak a tárolónak az elérési útja, ahol a megosztásnév által megadott megosztás ki lesz téve
...
Egyedinek kell lennie a Web App vagy a bővítőhelyen belül
...
### -Megosztásnév
Annak a megosztásnak a neve, amelyet a tárolóhoz kell csatlakoztatni
...
### Microsoft. Azure. Command. WebApps. models. WebAppAzureStoragePath
