...
## Leírás
A **New-AzWebAppSSLBinding** parancsmag létrehoz egy Secure Socket Layer (SSL) tanúsítvány-kötést az Azure Web App alkalmazáshoz.
...
A Get-AzWebAppSlot parancsmaggal letölthet egy bővítőhelyet.
