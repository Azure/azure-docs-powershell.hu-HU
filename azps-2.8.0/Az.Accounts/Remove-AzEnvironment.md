...
## Leírás
A Remove-AzEnvironment parancsmag eltávolítja az adott Azure-példányhoz való csatlakozáshoz szükséges végpontokat és metaadat-információkat.

## Példák

### Példa 1: tesztkörnyezet létrehozása és eltávolítása
```
...
Ez a példa bemutatja, hogyan hozhat létre környezetet a AzEnvironment használatával, és hogy hogyan törölheti a környezetet a Remove-AzEnvironment használatával.
