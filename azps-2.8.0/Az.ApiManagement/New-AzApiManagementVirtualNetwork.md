...
Ezt a parancsot a **set-AzApiManagement** és a **New-AzApiManagement** parancsmag használja.

## Példák

### Példa 1: virtuális hálózat létrehozása és meglévő APIM-szolgáltatás frissítése a VNET
```powershell
...
Ez a példa virtuális hálózatot hoz létre, majd felhívja a **set-AzApiManagement** parancsmagot.
...
Ebben a példában egy új APIM-szolgáltatás jön létre virtuális hálózatba `External` üzemmódba.
