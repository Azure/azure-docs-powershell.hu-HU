...
## Leírás
A **set-AzApiManagementLogger** parancsmag módosította az Azure API-kezelési **naplózó** beállításait.

## Példák

### Példa 1: a EventHub Logger módosítása
```powershell
...
Ez a parancs módosítja az id Logger123 tartalmazó naplózó.

## PARAMÉTEREK

### -ConnectionString
Egy Azure-esemény hubok kapcsolati karakterláncát adja meg, amely a házirend-jogosultságok küldését is tartalmazza.
...
### -IsBuffered
Azt adja meg, hogy a naplózó rekordjai a közzététel előtt puffereltek.
...
### -LoggerId
A frissítendő naplózó AZONOSÍTÓját adja meg.
...
### -PassThru
Jelzi, hogy ez a parancsmag a parancsmag által módosított  **PsApiManagementLogger** adja eredményül.
