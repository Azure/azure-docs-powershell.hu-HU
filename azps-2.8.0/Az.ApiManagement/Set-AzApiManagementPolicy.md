...
### Formátumú
A házirend formátumát adja meg. Használatakor `application/vnd.ms-azure-apim.policy+xml` a házirendben található kifejezéseknek XML-escapenak kell lenniük. Ha `application/vnd.ms-azure-apim.policy.raw+xml` **nem** szükséges, hogy a házirend XML-megmeneküljon.
Az alapértelmezett érték `application/vnd.ms-azure-apim.policy+xml` .
