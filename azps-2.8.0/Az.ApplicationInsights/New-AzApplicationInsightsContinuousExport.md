...
### Példa 1 új, folyamatos exportálási konfiguráció létrehozása az alkalmazásbeli betekintések erőforrásához
```
...
Új alkalmazás létrehozása: a folyamatos exportálási konfiguráció exportálása a "Request" és a "trace" dokumentumtípusok "teststorageaccount" a "testgroup" erőforráscsoport "" testcontainer tartalmazza. A SAS-tokennek érvényesnek kell lennie, és írási engedéllyel kell rendelkeznie a tárolóhoz, máskülönben a folyamatos exportálási funkció nem működik. Ha a SAS-token lejárt, a folyamatos exportálás funkció nem fog működni.
