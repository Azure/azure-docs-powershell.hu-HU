...
## Áttekintés
Azure Automation Software Update Configuration Azure Query-objektum létrehozása
...
## Leírás
A szoftverfrissítési konfiguráció Azure lekérdezési objektumát hozza létre, amely egy, az ütemterven futtatott szoftverfrissítési konfiguráció létrehozásához használható, amely frissíti az Azure virtuális gépek dinamikusan megoldott listája listáját.
...
### -Hely
Az Azure Virtual Machines helyének listája.
...
### -Címke
Az Azure Virtual Machines címkéje
...
### Microsoft. Azure. Command. Automation. Model. UpdateManagement. TagOperators

### System. String

## KIMENETEK

### Microsoft. Azure. Command. Automation. Model. UpdateManagement. AzureQueryProperties
