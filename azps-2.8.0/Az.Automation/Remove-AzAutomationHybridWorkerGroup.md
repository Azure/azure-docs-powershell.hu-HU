...
## Leírás
Az Remove-AzAutomationHybridWorkerGroup parancsmag eltávolítja a hibrid munkacsoportot az automatizálásból.

## Példák

### Példa 1
Ez a parancs eltávolítja a hibrid munkatársat név szerint.
...
### -Name (név)
A hibrid munkatárs csoport neve.
