...
### 3. példa: a VM-be telepített összes bővítmény beolvasása
```
...
Ez a parancs a VirtualMachine22 nevű virtuális gépre telepített bővítmények listáját kapja meg az erőforráscsoport ResourceGroup11.
