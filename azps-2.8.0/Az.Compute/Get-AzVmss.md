...
### 2. példa: egy erőforráscsoport minden Vmss beolvasása
```
...
Az összes Vmss beolvasása az erőforráscsoport "Group001" csoportjában

### 3. példa: az előfizetésben szereplő összes Vmss beszerzése
```
PS C:\> Get-AzVmss
...
Az összes Vmss beszerzése az előfizetésbe.

### Példa 4: az összes Vmss beolvasása szűrés használatával
```
...
A "VMSS00" kezdetű előfizetés összes Vmss beszerzése.
