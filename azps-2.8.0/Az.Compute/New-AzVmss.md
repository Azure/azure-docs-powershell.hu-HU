...
### – Prioritás
A virtuális gép léptéke beállítás prioritása.  Csak a támogatott értékek "normál" és "alacsony".
...
Annak a közelségi helynek a neve vagy erőforrás azonosítója, amellyel az adott méretarány használható.
