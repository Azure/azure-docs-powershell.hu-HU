...
## Leírás
A Remove-AzDataFactoryV2IntegrationRuntime parancsmag eltávolítja az integrációs futtatókörnyezetet.

## Példák

### 1. példa: az integrációs futtatókörnyezet eltávolítása
```
...
Ez a parancs eltávolítja a "teszt-foglalt-IR" nevű integrációs futtatókörnyezetet a ' teszt-DF ' nevű adatgyárból.
