...
## Leírás
Az New-AzDataMigrationTask parancsmag adatáttelepítési feladatot hoz létre. Ez a parancsmag a feladattípusok enumerálása, az Azure Resource Group, a kapcsolódó Azure-adatbázis áttelepítési szolgáltatásának és a Project adatbevitelének paramétereit veszi figyelembe. 
...
Az alábbi példa azt szemlélteti, hogy miként hozhat létre egy MyMigrationTask nevű új adatáttelepítési feladatot a TestService nevű myDMSProject és szolgáltatás nevű projektben. 
...
### -MigrationValidation 
Tevékenység-visszajelzési objektum érvényesítési hívással, nem kötelező, de javasolt.
...
### – Várjon
Várjon-e feladatot a tevékenység befejezéséhez. Ha a jelölő be van állítva, akkor minden egyes másodperc elteltével ellenőrizze a tevékenység befejeződését, és térjen vissza a felhasználóhoz a tevékenység tulajdonságai között, ahol a kimenet vagy a hiba megvizsgálható. 
```yaml
...
### Microsoft. Azure. Command. DataMigration. models. PSProjectTask
