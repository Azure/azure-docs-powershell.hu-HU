...
## Leírás
A Remove-AzDataMigrationService parancsmag eltávolítja az Azure-adatbázis áttelepítési szolgáltatásának példányát az Azure-ról. A DeleteRunningTask paraméter ellátása eltávolítja az összes, az Azure adatbázis áttelepítési szolgáltatási feladatát, amely az eltávolítandó szolgáltatáshoz tartozik. 
