...
## Leírás
A **New-AzDeploymentManagerArtifactSource** parancsmag tárgyi forrást hoz létre.
Adja meg a *nevet* , a *ResourceGroupName* és a szükséges tulajdonságokat.

A visszaadott objektumot helyileg módosíthatja, majd a Set-AzDeploymentManagerArtifactSource parancsmag használatával alkalmazhatja a módosításokat az objektum forrására.

A parancsmag egy olyan ArtifactSource objektumot ad eredményül, amely ResourceId hivatkozik az New-AzDeploymentManagerServiceTopology parancsmagban, így a ServiceUnit-erőforrásokhoz, a sablon-és a Parameters-fájlokhoz szükséges leletek is hivatkozhatók erre a helyről.
...
A ContosoResourceGroup a ContosoArtifactSource nevű tárgyi forrást hozza létre az erőforrás helyére. A SasUri tulajdonság egy Azure Storage SAS URI azonosítóval rendelkezik annak a tárolónak a tárolójában, ahol a leletek vannak tárolva.

## PARAMÉTEREK

### -ArtifactRoot
A nem kötelező könyvtár a leletek tárolójában.
...
### -SasUri
A SAS-URI az Azure Storage tárolóhoz, ahol a leletek vannak tárolva.
