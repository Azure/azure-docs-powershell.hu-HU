...
## Leírás
A **Remove-AzDeploymentManagerStep** parancsmag egy lépést töröl.
...
### 3. példa: lépés eltávolítása New-AzDeploymentManagerStep által visszaadott objektum használatával
### Példa 1
```powershell
