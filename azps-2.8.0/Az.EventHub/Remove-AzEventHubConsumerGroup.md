...
## Leírás
A Remove-AzEventHubConsumerGroup parancsmag eltávolítja és törli a megadott fogyasztói csoportot az adott esemény központból.
...
### Példa 2,2-InputObject – csővezetékek használata
```
...
### Példa 3,2-ResourceId karakterlánc használatával
```
...
### -ResourceId
ConsumerGroup erőforrás-azonosító
