...
Megkapja az integrációs fiók kódösszeállítását.

### [Get-AzIntegrationAccountBatchConfiguration](Get-AzIntegrationAccountBatchConfiguration.md)
Megkapja az integrációs fiók kötegének konfigurációját.
...
### [Új – AzIntegrationAccount](New-AzIntegrationAccount.md)
...
### [Új – AzIntegrationAccountAssembly](New-AzIntegrationAccountAssembly.md)
Létrehozza az integrációs fiók kódösszeállítását.

### [Új – AzIntegrationAccountBatchConfiguration](New-AzIntegrationAccountBatchConfiguration.md)
...
### [Új – AzIntegrationAccountSchema](New-AzIntegrationAccountSchema.md)
...
Eltávolítja az integrációs fiók kódösszeállítását.
...
### [Teszt-AzLogicApp](Test-AzLogicApp.md)
