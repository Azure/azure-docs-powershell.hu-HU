...
Megkapja az összes regisztráció definícióját.
...
Az azonosítóját adja meg a regisztrációs definícióban.
...
A teljes mértékben minősített erőforrás-azonosítóval kapja meg a regisztrációs definíciót.
...
### -Azonosító
A regisztrációs definíciós azonosító (például b0c052e5-c437-4771-a476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
...
### -ResourceId
A regisztrációs definíció (például/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationDefinitions/b0c052e5-c437-4771-a476-8b1201158a57) teljesen minősített erőforrás-azonosítója
```yaml
Type: System.String
