...
## Leírás
A **set-AzMarketplaceTerms** parancsmag az adott közzétevői azonosító (közzétevő), az ajánlat azonosítója (szorzat) és a terv azonosítója (név) rekord tárgyát menti.
...
### 2. példa
A Publisher-szerződés beállítása az "elfogadás" értékre A ' get-AzMarketplaceTerms ' parancsmag "terms" paramétere értékének beszerzése
...
### -InputObject
Get-AzMarketplaceTerms parancsmagban visszaadott fogalmak objektum Ez egy kötelező paraméter, ha az elfogadható paraméter értéke igaz.
