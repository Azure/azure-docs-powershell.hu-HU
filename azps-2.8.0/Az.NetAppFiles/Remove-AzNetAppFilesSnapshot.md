...
## Leírás
A **Remove-AzNetAppFilesSnapshot** parancsmag törli a ANF-pillanatfelvételt.
...
Ez a parancs törli a "MyAnfSnapshot" ANF-pillanatfelvételt.
...
### -InputObject
Az eltávolítandó pillanatkép-objektum
...
### -PassThru
A megadott kötet sikeres eltávolításának visszaadása
...
### -ResourceGroupName
A ANF pillanatképének erőforráscsoport csoportja
...
### -ResourceId
A ANF pillanatképének erőforrás-azonosítója
...
### -VolumeObject
Az eltávolítandó pillanatképet tartalmazó kötet objektum
