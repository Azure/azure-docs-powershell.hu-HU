...
## Leírás
Az **Update-AzNetAppFilesVolume** parancsmag ANF-kötetet frissít.

## Példák

### Példa 1: ANF-kötet frissítése
```
...
Ez a parancs frissíti a "MyAnfVolume" ANF-kötetet az új UsageThreshold méretével.
...
### -PoolObject
A frissítendő kötetet tartalmazó Pool objektum
