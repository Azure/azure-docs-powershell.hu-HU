...
## Leírás
A **Get-AzApplicationGatewayAutoscaleConfiguration** parancsmag automatikus méretarányos konfigurációt kap az alkalmazás-átjáróban.
...
A második parancs kibontja az alkalmazás-átjáró automatikus méretezési konfigurációját.
