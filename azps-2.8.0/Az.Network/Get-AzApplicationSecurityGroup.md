...
### 4. példa: az alkalmazás biztonsági csoportjai szűréssel olvashatók be.
```
...
A fenti parancs a "MyApplicationSecurityGroup" kezdetű összes alkalmazás biztonsági csoportját visszaállítja.
