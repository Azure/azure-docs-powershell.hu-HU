...
## Leírás
A **Get-AzDelegation** parancsmag az alhálózatból kapja meg a elnevezett delegálást. Ha a program nem nevezi el a meghatalmazást, akkor a megadott alhálózat összes delegációját visszaállítja.
