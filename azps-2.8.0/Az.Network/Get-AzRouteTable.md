...
## Leírás
A **Get-AzRouteTable** parancsmag Azure Route-táblázatokat kap.
...
### 2. példa: a lista Route-táblái szűréssel
```
...
Ez a parancs minden olyan útválasztási táblát beolvas, amelynek a neve "RouteTable"-val kezdődik
