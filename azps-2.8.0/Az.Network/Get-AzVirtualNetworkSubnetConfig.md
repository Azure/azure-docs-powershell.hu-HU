...
## Leírás
A **Get-AzVirtualNetworkSubnetConfig** parancsmag egy vagy több alhálózat-konfigurációt kap egy Azure virtuális hálózatban.
...
### -ResourceId
Annak az alhálózatnak az erőforrás-azonosítóját adja meg, amely a parancsmagot kapja.
