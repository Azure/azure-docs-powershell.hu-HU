...
## Leírás
**A New-AzApplicationGatewayRewriteRuleSet** parancsmag átírási szabályt hoz létre egy Azure Application Gateway-nek.
...
A parancs létrehoz egy ruleset1 nevű szabályt, és az eredményt az $ruleset nevű változóban tárolja.
