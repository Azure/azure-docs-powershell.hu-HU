...
## Leírás
Létrejön egy ExpressRoute-kapcsolat az egy helyszíni ExpressRoute-áramkört, amely egy virtuális csomóponton belül a ExpressRoute-átjáróhoz csatlakozik.
...
A fentiekben létrehozunk egy erőforráscsoport, virtuális WAN, virtuális hálózat, virtuális hub, expressz útvonal-átjáró és egy ExpressRoute-áramkör a közép-Közép-amerikai "testRG" erőforráscsoporthoz az Azure-ban. Miután létrehozta az átjárót, az a New-AzExpressRouteConnection parancs segítségével csatlakozik az ExpressRoute-Áramkörhez.
...
### -AuthorizationKey
Az ExpressRoute-áramkör tulajdonosa által kapott kulcs egy másik előfizetésben lévő átjáróval való kapcsolat létrehozására használható.
...
Annak az Express Route-áramkörnek az erőforrás-azonosítója, amelyhez az útvonal-átjáró kapcsolata jön létre.
...
A kapcsolat fölérendelt ExpressRouteGateway.
...
### -ParentResourceId
A kapcsolat fölérendelt ExpressRouteGateway tartozó erőforrás-azonosító.
...
### -RoutingWeight
Annak a csomagnak az útválasztási tömege, amelyet ehhez a kapcsolathoz kell rendelni.
