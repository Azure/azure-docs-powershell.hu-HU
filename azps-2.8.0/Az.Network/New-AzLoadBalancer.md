...
## Leírás
A **New-AzLoadBalancer** parancsmag az Azure terheléselosztó bővítményt hozza létre.
...
Fontos tudni, hogy ez a példa csak azt szemlélteti, hogy miként hozhat létre terheléselosztót. Az Add-AzNetworkInterfaceIpConfig parancsmag használatával is konfigurálnia kell a hálózati adapterek különböző virtuális gépekhez való hozzárendeléséhez.
