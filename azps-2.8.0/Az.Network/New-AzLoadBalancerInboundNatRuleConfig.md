...
## Leírás
A **New-AzLoadBalancerInboundNatRuleConfig** parancsmag beérkező hálózati címfordítási (NAT) szabály-konfigurációt hoz létre az Azure terheléselosztó szolgáltatásához.
...
A *FrontendIpConfiguration* , a *Protocol* , a *FrontendPort* és a *BackendPort* paraméter mind szükséges a bejövő címfordítási szabályok konfigurációjának létrehozásához.
