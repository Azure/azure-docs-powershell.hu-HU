...
## Leírás
A **New-AzLoadBalancerRuleConfig** parancsmag létrehoz egy szabály-konfigurációt az Azure terheléselosztó szolgáltatásához.

## Példák

### 1: szabály-konfiguráció létrehozása Azure-terheléselosztó esetén
```
...
Az első három parancs a nyilvános IP-címet, az előtér-előnézetet, valamint a szabály konfigurációjának megfelelő szondát tartalmaz a Forth parancsban. A Forth parancs új szabályt hoz létre, amelynek neve MyLBrule bizonyos előírásokkal.

## PARAMÉTEREK

### -BackendAddressPool
Itt adhatja meg azt a **BackendAddressPool** -objektumot, amellyel társítani szeretné a terheléselosztó szabály konfigurációját.
...
### -BackendPort
A terheléselosztási szabály konfigurációjának megfelelő adatforgalomhoz tartozó backend-portot adja meg.
...
### -Protocol
A terheléselosztási szabályok konfigurációjának megfelelő protokollt adja meg.
