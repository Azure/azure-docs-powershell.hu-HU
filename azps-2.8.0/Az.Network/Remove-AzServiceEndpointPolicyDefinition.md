...
Ez a parancs eltávolítja a szolgáltatás végpontjának házirendjét a név PolicyDef1
...
### -InputObject
A szolgáltatás Endpoint Policy definition objektuma.
...
### -Name (név)
A szolgáltatás végpont-definíciójának neve
...
### -ResourceId
A szolgáltatás végpont-definíciójának azonosítója.
