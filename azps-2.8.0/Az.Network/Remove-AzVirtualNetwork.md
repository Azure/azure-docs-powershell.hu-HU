...
## Leírás
A **Remove-AzVirtualNetwork** parancsmag eltávolítja az Azure virtuális hálózatot.
...
Ebben a példában egy erőforráscsoport virtuális hálózata jön létre, majd azonnal törli azt. Ha a virtuális hálózat törlésekor a kérdését szeretné letiltani, használja a-Force jelölőt.
...
### -Name (név)
Annak a virtuális hálózatnak a neve, amely a parancsmagot eltávolítja.
...
### -ResourceGroupName
Annak a virtuális hálózatnak a neve, amely a parancsmag eltávolítását tartalmazza.
