...
## Leírás
A **set-AzLoadBalancerRuleConfig** parancsmag frissíti a terheléselosztási szabályok konfigurációját.
...
A második parancs a pipeline operátor segítségével továbbítja a terheléselosztást $slb a AzLoadBalancerRuleConfig-hoz, amely egy NewRule nevű szabályt ad hozzá.
A harmadik parancs átadja a terheléselosztó **beállítást a set-AzLoadBalancerRuleConfig** , amely az új szabály konfigurációját állítja be.
...
Ez a parancsmag frissíti a paraméter által megadott terheléselosztó szabály konfigurációját.
