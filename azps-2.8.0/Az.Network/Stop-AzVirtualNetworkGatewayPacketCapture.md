...
## Leírás
Leállítja a csomag rögzítési műveletét egy virtuális hálózati átjárón, és feltölti az eredményt adott SasUrl-tárolóra.
...
### -InputObject
A virtuális hálózati átjáró objektum, amelyen a csomag elindítható.
...
### -Name (név)
Annak a virtuális hálózati átjárónak a neve, amelybe a csomagot el kell indítani.
...
### -ResourceId
Az Azure Resource ID a VirtualNetworkGateway, ahol a csomagot el szeretné indítani.
...
### -SasUrl
A SAS URL-csomag rögzítése a virtuális hálózati átjárón.
