...
## Leírás
A parancs segítségével megtekintheti azokat az örökölt társközi erőforrásokat, amelyek mindegyike az Azure erőforrás-kezelési (ARM) erőforrásokra konvertálja őket.
