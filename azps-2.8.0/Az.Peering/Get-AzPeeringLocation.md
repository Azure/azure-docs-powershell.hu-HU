...
## Leírás
Itt érheti el azokat a társközi lehetőségeket, amelyekben a felhasználók kapcsolatba léphetnek a KARJÁN.
...
A helyek hosszú listája. Az összes közvetlen társas létesítményt kapja.
...
Megkapja a Honolulu-beli Exchange-alapú levelezés helyét. 
...
Megkeresi az Exchange-alapú levelezés helyét a 71-ös peer-azonosítóban. 
...
### -DirectPeeringType
Válassza az "Edge", a "CDN" és a "tranzit" parancsot.
...
### -Kind
A teljes egyenrangú erőforrást jeleníti meg.
...
### -PeeringDbFacilityId
A PeeringDB.com-eszköz azonosítója
...
### Microsoft. Azure. PowerShell. parancsmagok. társközi. models. PSPeeringLocation
