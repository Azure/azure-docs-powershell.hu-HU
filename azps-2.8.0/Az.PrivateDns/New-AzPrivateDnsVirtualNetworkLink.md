...
### VirtualNetworkId (alapértelmezett)
```
...
## Leírás
A **New-AzPrivateDnsVirtualNetworkLink** parancsmag új, privát tartománynévrendszer (DNS) virtuális hálózati hivatkozást hoz létre a megadott erőforráscsoport és privát zónában. Adjon meg egy egyedi hivatkozás nevét a Name ( *név* ) paraméterhez, vagy a parancsmag hibát ad vissza. A *Confirm* paramétert és $ConfirmPreference Windows PowerShell-változót használva beállíthatja, hogy a parancsmag kér-e megerősítést.

## Példák

### Példa 1: privát DNS virtuális hálózati hivatkozás létrehozása
```
...
Ez a parancs létrehoz egy új virtuális hálózati hivatkozást, amely a myzone.com és a virtuális hálózat "myvirtualnetwork" nevű privát DNS-zónával van társítva (amelyet már létrehoztak az erőforráscsoport) a megadott erőforráscsoporthoz, majd a $Link változóban tárolja.
...
### -EnableRegistration
Váltás az olyan paraméterre, amely azt jelzi, hogy a hivatkozás engedélyezve van-e.
...
### -Name (név)
A létrehozandó virtuális hálózati hivatkozás nevét adja meg.
...
### -RemoteVirtualNetworkId
Egy másik bérlői virtuális hálózat erőforrás-azonosítója.
...
### -ResourceGroupName
Azt az erőforráscsoportot adja meg, amelyben létre szeretné hozni a hivatkozást.
...
### -VirtualNetwork
A hivatkozáshoz társított virtuális hálózat-objektum.
...
### -VirtualNetworkId
A hivatkozáshoz társított virtuális hálózat erőforrás-azonosítója.
...
### -ZoneName
Annak a zónának a nevét adja meg, amely a virtuális hálózat hivatkozásához fog kapcsolódni.
