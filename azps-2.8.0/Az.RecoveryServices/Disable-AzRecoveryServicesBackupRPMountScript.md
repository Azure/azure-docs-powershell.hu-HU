...
## Leírás
A Disable-AzRecoveryServicesBackupRPMountScript parancsmag leválasztja azokat a helyreállítási pont fájljait, amelyek korábban a Get-AzRecoveryServicesBackupRPMountScript parancsmag használatával lettek felszerelve.

## Példák

### Példa 1: helyreállítási pont leválasztása
```
