...
## Leírás
A **Get-AzRecoveryServicesAsrEvent** a megadott kijelölési szűrők alapján kapja meg az események listáját a boltozatban.
...
### -ResourceId
Az esemény ResourceId adja meg.
...
### Microsoft. Azure. Command. RecoveryServices. SiteRecovery. ASREvent
