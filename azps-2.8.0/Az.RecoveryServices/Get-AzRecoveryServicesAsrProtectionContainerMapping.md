...
## Leírás
A **Get-AzRecoveryServicesAsrProtectionContainerMapping** parancsmag információkat kap a védelmi tárolóról a megadott ASR-védelmi tárolóhoz tartozó replikációs házirend-megfeleltetések (társítás) esetén.
