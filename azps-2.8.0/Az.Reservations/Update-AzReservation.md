...
Frissíti a megadott AppliedScopeType az `Reservation` egy-és InstanceFlexibility be értékre.
...
A megadott AppliedScopeType frissíti a `Reservation` megosztott és a InstanceFlexibility.
...
### -InstanceFlexibility
Ha van, frissíti a InstanceFlexibility értékét `Reservation` . Ha nincs megadva, a meglévő érték változatlan marad.
