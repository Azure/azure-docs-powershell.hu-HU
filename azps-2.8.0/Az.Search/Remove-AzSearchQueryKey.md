...
## Leírás
A **Remove-AzSearchQueryKey** parancsmag eltávolítja a lekérdezési kulcsot az Azure Search szolgáltatásból.
...
A példa eltávolítja a Query billentyűt az Azure Search szolgáltatásból.
...
### -Érték
Keresési szolgáltatás lekérdezési kulcsának értéke
