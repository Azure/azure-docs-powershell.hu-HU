...
Standard = időszak. Max és Basic = 14 nap
...
A duplikáltelem-észlelési előzmények időablaka, egy [időszak](https://msdn.microsoft.com/library/system.timespan.aspx) érték, amely meghatározza a duplikáltelem-észlelési előzmények időtartamát. Az alapértelmezett érték 10 perc.
...
### -MaxSizeInMegabytes
MaxSizeInMegabytes – a várólista maximális mérete megabájtban, ami a várólistához lefoglalt memória mérete. Az alapértelmezett érték a 1024. A Max standard SKU esetében a 5120 és a prémium SKU a 81920, a megengedett értékek: 1024, 2048, 3072, 4096, 5120, 10240, 20480, 40960, 81920
...
### -RequiresSession
RequiresSession – az az érték, amely azt jelzi, hogy a várólista munkameneteket használ
