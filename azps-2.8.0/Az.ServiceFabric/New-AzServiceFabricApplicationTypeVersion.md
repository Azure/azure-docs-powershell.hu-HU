...
## Leírás
Ez a parancsmag létrehoz egy új, az PackageUrl-ban megadott csomagot, ennek a telepítés során elérhetőnek kell lennie az Azure Resource Manager REST-végpontján keresztül, és a kiterjesztés. sfpkg a kicsomagolt és a tömörített alkalmazást tartalmazza. Ez a parancs akkor hozza létre az alkalmazást, ha még nem létezik.
...
Ebben a példában egy "v1" típusú "testAppType" típusú típus jön létre. A csomagban található alkalmazás jegyzékfájljának verziószáma megegyezik a verzióban megadott verziószámmal.
...
### -DefaultParameter
Adja meg az alkalmazás paramétereinek alapértelmezett értékét kulcs/érték párokként.
...
### Microsoft. Azure. Command. ServiceFabric. models. PSApplicationTypeVersion
