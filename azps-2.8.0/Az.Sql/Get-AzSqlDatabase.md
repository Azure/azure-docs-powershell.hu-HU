...
## Leírás
A **Get-AzSqlDatabase** parancsmag egy vagy több Azure SQL-adatbázisból áll az Azure SQL adatbázis-kiszolgálóról.
...
### 3. példa: az összes adatbázis beolvasása a kiszolgálón szűréssel
```
...
Ez a parancs a server01 nevű kiszolgálón az "adatbázis" kezdetű adatbázisokat kapja meg.
