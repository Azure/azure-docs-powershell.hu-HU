...
## Leírás
A **Get-AzSqlDeletedInstanceDatabaseBackup** parancsmag egy megadott, törölt SQL-példány-adatbázis biztonsági másolatát kapja, amelyet visszaállíthat, vagy minden törölt biztonsági másolatot visszaadhat.
Ezt a parancsmagot az Azure SQL instance Database szolgáltatása is támogatja.
...
### Microsoft. Azure. Command. SQL. ManagedDatabaseBackup. Model. AzureSqlDeletedManagedDatabaseBackupModel
