...
## Leírás
A Get-AzSqlElasticJobStepExecution parancsmag egy vagy több feladat-végrehajtást kap a projekt végrehajtásához

## Példák

### Példa 1 – egy vagy több feladat-végrehajtási lépés végrehajtása a projekt végrehajtásában
```
...
### Példa: 2 – egy vagy több feladat-végrehajtási lépés végrehajtása a projekt végrehajtásában, a szűrés lépésről lépésre
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
