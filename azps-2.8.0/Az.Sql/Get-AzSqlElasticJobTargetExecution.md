...
## Leírás
A Get-AzSqlElasticJobTargetExecution parancsmag egy vagy több projektfeladat-végrehajtási feladatot kap a projekt végrehajtásához

## Példák

### Példa 1 – egy vagy több projektfeladat kivégzése a projekt végrehajtásához
```
...
### Példa: 2 – egy vagy több projektfeladat-végrehajtási művelet végrehajtása a projekt végrehajtásában – a szűrés lépésről lépésre
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Aktív
Megjelölés aktív kivégzéssel való szűrésre
...
### -CreateTimeMax
Szűrés a maximális idő létrehozásával
...
### -EndTimeMax
Szűrés a befejezési idő Max szerint
