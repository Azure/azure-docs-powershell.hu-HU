...
## Leírás
A Get-AzSqlInstanceDatabaseSensitivityRecommendation parancsmag az Azure SQL Managed instance (Azure SQL Managed instance Database) adatbázis oszlopainak ajánlott adattípusait és érzékenységi címkéit számítja ki.

## Példák

### 1. példa: az Azure SQL-alapú felügyelt adatbázis ajánlott adattípusai és érzékenységi címkéjének beszerzése.
```powershell
...
### 2. példa: ajánlott adattípusok és az Azure SQL-alapú felügyelt példányok adatfeliratai a csővezetékek használatával.
```powershell
