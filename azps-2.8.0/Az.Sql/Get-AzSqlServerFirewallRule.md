...
## Leírás
A **Get-AzSqlServerFirewallRule** parancsmag tűzfal-szabályokat kap az Azure SQL-adatbázis-kiszolgálón.
Ha megadhatja a tűzfalszabály nevét, ez a parancsmag információt kap az adott tűzfalszabály-szabályról.

## Példák

### Példa 1: a kiszolgáló összes szabályának lekérése
```
...
Ez a parancs beolvassa a Server01 nevű kiszolgáló összes tűzfal-szabályát.

### 2. példa: a kiszolgálók összes szabályának beszerzése szűréssel
```
...
Ez a parancs a "szabály" kezdetű Server01 nevű kiszolgáló összes tűzfal-szabályát beolvassa.
...
### -Kiszolgálónév
Az SQL-kiszolgáló nevét adja meg.
