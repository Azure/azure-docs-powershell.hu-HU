...
## Leírás
A **Get-AzSqlSyncGroup** parancsmag információt ad egy vagy több Azure SQL adatbázis-szinkronizálási csoportról.
...
### 3. példa: az Azure SQL szinkronizálási csoport minden előfordulásának beolvasása a szűrést használó Azure SQL-adatbázisba
```
...
A parancs a "SyncGroup" kezdetű Azure SQL-adatbázishoz rendelt összes Azure SQL adatbázis-szinkronizálási csoportra vonatkozó információt kap.
