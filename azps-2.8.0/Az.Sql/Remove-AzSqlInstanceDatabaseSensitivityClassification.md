...
## Leírás
A Remove-AzSqlInstanceDatabaseSensitivityClassification parancsmag eltávolítja az Azure SQL Managed instance-adatbázisban az oszlopok adattípusait és érzékenységi címkéit.

## Példák

### 1. példa: az Azure SQL-alapú SQL-adatbázisokban tárolt oszlopok adattípusának és érzékenységi címkéjának eltávolítása
```powershell
...
### 2. példa: a jelenlegi adattípusok és a bennük található adatfeliratok eltávolítása Azure SQL-alapú SQL-alapú SQL Server-adatbázisból csővezetékekkel.
```powershell
...
### 3. példa: az Azure SQL felügyelt példányban lévő adatbázis adattípusának és érzékenységi címkéjának eltávolítása csővezetékekkel.
```powershell
