...
### Példa 3,1: a blob-tároló naplózási házirendjének engedélyezése az Azure SQL-adatbázisokban speciális szűréssel a T-SQL predikátum használatával
```
...
### Példa 3,2: az Azure SQL-adatbázis naplózási házirendjéből származó speciális szűrési beállítások eltávolítása
```
...
### Példa 4: az Azure SQL-adatbázisok esemény-központi naplózási házirendjének engedélyezése
```
...
### Példa 5: az Azure SQL-adatbázisok esemény-központi naplózási házirendjének letiltása
```
...
### Példa 6: az Azure SQL-adatbázisok naplózási Analytics-naplózási házirendjének engedélyezése
```
...
### 7. példa: az Azure SQL-adatbázisok naplózási Analytics-naplózási házirendjének letiltása
```
...
### 8. példa: az Azure SQL-adatbázisok naplózási házirendjének letiltása a csővezetéken keresztül
```
...
### 9. példa: tiltsa le az Azure SQL-adatbázisból a blob-tárterületre való küldést, és engedélyezze a naplózást az Analytics szolgáltatásban.
```
...
### 10. példa: engedélyezze az Azure SQL-adatbázisok naplózási rekordjainak küldését a blob-tároló, az esemény-hub és a log Analytics segítségével.
```
