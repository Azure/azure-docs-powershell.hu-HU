...
## Leírás
A Set-AzSqlElasticJobStep parancsmag a feladat lépéseit frissíti

## Példák

### Példa 1 – a projekt egy tevékenységhez tartozó célcsoportjának frissítése
```
...
### 2. példa – egy projekthez tartozó T-SQL-parancsfájl frissítése
```
PS C:\> $jobStep = Get-AzSqlElasticJobStep -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -StepName step1
...
Feladat lépésének frissítése egy projektből
...
A kezdeti újrapróbálkozás ennyi idő után
...
A maximális újrapróbálkozás ennyi idő után
...
### -OutputTableName
A Készletrevételi táblázat neve
...
### -RemoveOutput
Annak jelzése, hogy el szeretné-e távolítani a kimenetet
...
Az újrapróbálkozási intervallum hát szorzója
