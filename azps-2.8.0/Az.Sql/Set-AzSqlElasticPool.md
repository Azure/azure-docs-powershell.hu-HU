...
## Leírás
A **set-AzSqlElasticPool** parancsmag az Azure SQL-adatbázisban egy rugalmas készlet tulajdonságainak beállítását adja meg. Ez a parancsmag módosíthatja a eDTUs ( *DTU* ), a maximális tárterületet ( *StorageMB* ), a maximális eDTUs az adatbázisokban ( *DatabaseDtuMax* ) és a minimális eDTUs per Database ( *DatabaseDtuMin* ).
...
### -StorageMB
A rugalmas készlet tárterületének korlátját adja meg megabájtban. További információt az New-AzSqlElasticPool parancsmag című témakörben találhat.
...
### -Címkék
A kulcs-érték párok szótárát adja meg, hogy a parancsmag a rugalmas készletet a kivonatoló táblázat formájában társítja. Példa: `@{key0="value0";"key 1"=$null;key2="value2"}`
...
### -VCore
Az SQL Azure rugalmas készlet vcore megosztott száma összesen.
