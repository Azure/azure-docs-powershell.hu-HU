...
### Példa 3,1: a blob-tároló naplózási házirendjének engedélyezése az Azure SQL Server speciális szűrési funkciójával a T-SQL predikátummal
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -BlobStorageTargetState Enabled -StorageAccountResourceId "/subscriptions/7fe3301d-31d3-4668-af5e-211a890ba6e3/resourceGroups/resourcegroup01/providers/Microsoft.Storage/storageAccounts/mystorage" -PredicateExpression "statement <> 'select 1'"
```

### Példa 3,2: az Azure SQL Server-kiszolgálók naplózási házirendjéből származó speciális szűrési beállítások eltávolítása
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -PredicateExpression ""
```

### Példa 4: az Azure SQL Server esemény központi naplózási házirendjének engedélyezése
```
...
### Példa 5: az Azure SQL Server esemény központi naplózási házirendjének letiltása
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -EventHubTargetState Disabled
```

### Példa 6: az Azure SQL Server log Analytics naplózási házirendjének engedélyezése
```
...
### 7. példa: az Azure SQL Server log Analytics naplózási házirendjének letiltása
```
PS C:\>Set-AzSqlServerAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -LogAnalyticsTargetState Disabled
```

### 8. példa: az Azure SQL Server rendszerhez tartozó log Analytics naplózási házirendjének letiltása a csővezetéken keresztül
```
...
### 9. példa: tiltsa le az Azure SQL Server-alapú naplózási rekordok küldését a blob-tárolóra, és engedélyezze a naplózást az elemzéshez.
```
...
### 10. példa: engedélyezze az Azure SQL Server-alapú naplózási rekordok küldését a blob-tároló, az esemény-hub és a log Analytics segítségével.
```
