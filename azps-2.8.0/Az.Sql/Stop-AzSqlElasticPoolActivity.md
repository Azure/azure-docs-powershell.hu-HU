...
## Leírás
A **stop-AzSqlElasticPoolActivity** parancsmag egy rugalmas készleten megszünteti az aszinkron frissítési műveletet.

## Példák

### 1. példa: az aszinkron frissítési művelet megszakítása rugalmas készleten
```
...
Ez a parancs a rugalmas készleten lemondja az aszinkron frissítések műveletet.
...
### -OperationId
A lekérdezni kívánt művelet azonosítója.
...
### Microsoft. Azure. Command. SQL. ElasticPool. Model. AzureSqlElasticPoolActivityModel
