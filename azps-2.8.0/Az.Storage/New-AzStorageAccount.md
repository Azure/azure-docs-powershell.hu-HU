...
### 6. példa: hozzon létre egy tárterületet az Azure-fájlok AAD DS-hitelesítéssel.
```
...
Ez a parancs az Azure Files AAD DS-hitelesítéssel hoz létre tárolási fiókot.
