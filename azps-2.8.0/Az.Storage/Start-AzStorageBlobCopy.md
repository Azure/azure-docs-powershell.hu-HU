...
### Példa 6: a blokk blob másolása a cél tárolóba egy új blob nevű névvel, valamint a cél blob-StandardBlobTier beállítása archívumként RehydratePriority
```
...
Ez a parancs elindítja a blokk blob másolási műveletét a cél tárolóba egy új blob nevű névvel, és beállítja a cél blob-StandardBlobTier az archívumként RehydratePriority
