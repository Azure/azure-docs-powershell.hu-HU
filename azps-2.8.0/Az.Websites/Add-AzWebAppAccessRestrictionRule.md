...
## Áttekintés
Access-restiction-szabályt ad hozzá az Azure Web App alkalmazáshoz.
...
## Leírás
Az **Add-AzWebAppAccessRestrictionRule** parancsmag hozzáférési korlátozási szabályt ad az Azure Web App alkalmazáshoz.

## Példák

### Példa 1: IP-hozzáférés korlátozási szabályának hozzáadása egy webalkalmazáshoz
```
PS C:\>Add-AzWebAppAccessRestrictionRule -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
-Name IpRule -Priority 200 -Action Allow -IpAddress 10.10.0.0/8
```

Ez a parancs egy olyan hozzáférési korlátozási szabályt ad hozzá, amelyben a 200 és az IP-címtartomány a ContosoSite nevű webalkalmazáshoz tartozik, amely az erőforráscsoport alapértelmezett – web-WestUS.

### 2. példa: alhálózati szolgáltatás végpontjának hozzáférési korlátozási szabályának hozzáadása egy webalkalmazáshoz
```
PS C:\>Add-AzWebAppAccessRestrictionRule -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
-Name SubnetRule -Priority 300 -Action Allow -SubnetName appgw-subnet -VirtualNetworkName corp-vnet
```

Ez a parancs egy Access-korlátozási szabályt ad hozzá a 300 prioritással és a Corp-vnet egy ContosoSite nevű appgw-alhálózattal egy nevű webalkalmazáshoz, amely az erőforráscsoport alapértelmezett webWestUS-tartozik.
...
### -Leírás
Hozzáférés korlátozásának leírása.
...
Adja meg, hogy a szolgáltatás végpontjának az alhálózatra való regisztrálását ellenőrizni kell-e.
...
### – Prioritás
Hozzáférés korlátozásának prioritása Például: 500.
