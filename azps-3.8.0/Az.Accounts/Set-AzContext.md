...
## Leírás
A Set-AzContext parancsmag az aktuális munkamenetben futtatott parancsmagok hitelesítési adatait állítja be.
...
### -Előfizetés
Annak az előfizetésnek a neve vagy azonosítója, amelyhez a környezetet be kell állítani. Ez a paraméter aliasokat tartalmaz a-SubscriptionName és a SubscriptionId, így az érthetőség kedvéért az előfizetések helyett a név és azonosító megadásakor is használhatók.
