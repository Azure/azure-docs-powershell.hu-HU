...
## Leírás
**Remove-AzActionRule** parancsmag: a műveleti szabály törlése.
...
Ez a parancsmag törli a ActionRuleName nevű műveleti szabályt az erőforráscsoport teszt-RG
...
### -ResourceId
Műveletkérő szabály kérése az azonosító megadásával.
