...
## Leírás
A **New-AzApiManagementApiVersionSet** parancsmag létrehoz egy API-készletet az Azure API felügyeleti környezetében.
...
A parancs létrehoz egy API-verziót, amely a verziószámozási sémát `Query` és a lekérdezési paramétert adja meg `api-version` .
...
Ha nem ad meg azonosítót, a program létrehozza az azonosítót.
...
Ha a verziószámozási séma lekérdezése van kiválasztva, akkor ezt az értéket kell megadnia.
