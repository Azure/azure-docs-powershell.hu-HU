...
## Leírás
A **New-AzApiManagementOperation** parancsmag API-műveletet hoz létre.

## Példák

### Példa 1: API-kezelési művelet létrehozása
```powershell
...
Ez a parancs API-kezelési műveletet hoz létre.

### 2. példa: API-kezelési művelet létrehozása a kérés és válasz részleteivel
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Ez a példa API-kezelési műveletet hoz létre a kérés és válasz részleteivel.

## PARAMÉTEREK

### -ApiId
Az API-kezelési művelet azonosítóját adja meg.
...
### -ApiRevision
Az API-módosítás azonosítója Ez a paraméter nem kötelező. Ha nem adja meg, akkor a művelet a jelenleg aktív API-verzióhoz lesz csatolva.
...
### -Leírás
Az új API-művelet leírását adja meg.
...
### -Módszer
Az új API-kezelési művelet HTTP-metódusát adja meg.
...
### -Name (név)
Az új API-kezelési művelet megjelenítendő nevét adja meg.
...
### -Request (kérés)
Az API-kezelési művelet részleteit adja meg.
...
### – Válaszok
A lehetséges API-kezelési műveletek tömbjét adja meg.
...
### -TemplateParameters
Az *UrlTemplate* paraméterben megadott paraméterek tömbjét adja meg.
Ha nem adja meg ezt a paramétert, akkor a *UrlTemplate* alapuló alapértelmezett érték jön létre.
...
### Microsoft. Azure. Command. ApiManagement. ServiceManagement. models. PsApiManagementParameter []

### Microsoft. Azure. Command. ApiManagement. ServiceManagement. models. PsApiManagementRequest

### Microsoft. Azure. Command. ApiManagement. ServiceManagement. models. PsApiManagementResponse []
