...
## Leírás
A **Remove-AzApiManagementApiFromProduct** parancsmag egy Azure API-kezelési API-t távolít el egy termékekből.

## Példák

### 1. példa: az API eltávolítása a termékekből
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiFromProduct -Context $ApiMgmtContext -ProductId "0123456789" -ApiId "0001" -PassThru
```

Ez a parancs eltávolítja a megadott API-t egy termékekből.

## PARAMÉTEREK

### -ApiId
A termékekből eltávolítandó API AZONOSÍTÓját adja meg.
...
### -Környezet
Megadja a **PsApiManagementContext**.
...
### -PassThru
Jelzi, hogy ez a parancsmag az $True értékét adja eredményül, ha a művelet sikeres, vagy $False.
...
### -Termékkód
Annak a termékeknek az AZONOSÍTÓját adja meg, amelyből el szeretné távolítani az API-t.
