...
## Leírás
Az Remove-AzAttestationPolicySigner parancsmag eltávolítja a megbízható házirend-aláírót a bérlő számára az Azure tanúsítványban.
...
A *pshtest* nevű tanúsítvány-szolgáltató megbízható aláírójának eltávolítása.
...
### – Aláíró
Az "AAS-policyCertificate" nevű RFC7519 JSON-webtokent adja meg, amelynek az értéke egy olyan RFC7517 JSON-webkulcs, amely az eltávolítandó megbízható aláírási kulcsot tartalmazza.
A RFC7519 JWT be kell jelentkeznie a meglévő megbízható aláírási kulcsok egyikével.
