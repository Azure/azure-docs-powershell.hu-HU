...
## Leírás
A **Remove-AzAutomationSchedule** parancsmag az Azure Automation szolgáltatásból törli az ütemtervet.
...
Ez a parancs törli a Schedule01 az automatizálási fiók Contoso17 az erőforrás csoport ResourceGroup01.

## PARAMÉTEREK

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelyhez ez a parancsmag eltávolítja az ütemtervet.
...
### -Name (név)
A parancsmag által eltávolított ütemterv nevét adja meg.
...
### -ResourceGroupName
Annak a csoportnak a nevét adja meg, amelyhez ez a parancsmag eltávolítja az ütemtervet.
