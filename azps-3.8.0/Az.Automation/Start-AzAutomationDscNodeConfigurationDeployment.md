...
## Leírás
A **Start-AzAutomationDscNodeConfigurationDeployment** parancsmag a kívánt állapot-konfigurációs (DSC) csomópont-konfigurációt telepíti az Azure automatizálásban.
