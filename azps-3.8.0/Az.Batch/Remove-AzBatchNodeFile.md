...
## Leírás
A **Remove-AzBatchNodeFile** parancsmag egy Azure kötegfájl-csomópontot töröl egy tevékenységhez vagy egy kiszámított csomóponthoz.

## Példák

### Példa 1: egy tevékenységhez társított fájl törlése
```
...
Ez a parancs a **Get-AzBatchNodeFile** használatával kapja meg a csomópontot.
A fájl társítva van azzal a tevékenységgel, amelynek azonosító Task26 a Job Job-000001.
...
Ha **PSNodeFile** szeretne beolvasni, használja az Get-AzBatchNodeFile parancsmagot.
