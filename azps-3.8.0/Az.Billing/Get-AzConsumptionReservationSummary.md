...
## Leírás
A **Get-AzConsumptionReservationSummary** parancsmag napi vagy havi gabona foglalási összefoglalókat kap.

## Példák

### Példa 1: foglalási összesítések beszerzése a havi gabona foglalási rendelési azonosítójával
```powershell
...
### 2. példa: foglalási összesítések beszerzése a havi gabona foglalási rendelési azonosítójával és a foglalási azonosítóval
```powershell
...
### 3. példa: foglalási összesítések beszerzése a napi gabona időtartományához tartozó foglalási rendelési azonosítóval
```powershell
...
### Példa 4: foglalási összesítések beszerzése foglalási megrendelési azonosítóval és a napi gabona foglalási azonosítójával
```powershell
...
### -EndDate
A záró (éééé-hh-nn) a foglalási összefoglalóban, csak a napi gabona esetében szükséges.
...
### -Grain
A foglalás összefoglalójának időpontja naponta vagy havonta lehet.
...
### -ReservationId
Egy foglalás azonosítója egy foglalási rendelésen belül.
...
### -ReservationOrderId
Egy foglalási vásárlás azonosítója.
...
### -StartDate
A foglalás összefoglalójának kezdési (éééé-hh-nn), csak a napi gabona esetén szükséges.
...
### Microsoft. Azure. commands. fogyasztás. models. PSReservationSummary
