...
## Leírás
Az **Add-AzVmssNetworkInterfaceConfiguration** parancsmag hálózati illesztőfelület-konfigurációt ad hozzá a Virtual Machine Scale set (VMSS) beállításhoz.
...
Azt adja meg, hogy a hálózati felület gyorsított hálózati kapcsolaton van-e.
...
### -EnableIPForwarding
Megadja, hogy engedélyezve van-e az IP-továbbítás ezen a NIC-ben.
...
### Microsoft. Azure. Management. számítás. models. VirtualMachineScaleSetIPConfiguration []
