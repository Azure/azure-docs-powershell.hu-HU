...
## Leírás
A **set-AzVmssDiskEncryptionExtension** parancsmag engedélyezi a titkosítást egy VM-léptékű készleten. Ez a parancsmag lehetővé teszi a titkosítást, ha telepíti a titkosítási bővítményt a VM-méretarány beállítással.

A Linux virtuális gépek esetében a *VolumeType* paraméternek jelen kell lennie, és "Data" értékre kell állítania.
...
Ez a parancs engedélyezi a Windows VMs minden lemezén a VM méretarányos készletben való titkosítást.
...
Ez a parancs engedélyezi az összes Linux VM adatlemezén a VM-méretarányos készletben való titkosítást.
...
Linux: a **VolumeType** paraméternek jelen kell lennie, és az adatértéknek kell lennie. 

Windows: a **VolumeType** paramétert (ha van) az All vagy az os értékre kell állítani. Ha a **VolumeType** paraméter nincs kihagyva az "összes" értékkel.
