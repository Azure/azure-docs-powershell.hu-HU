...
A kulcsfájl frissíti a merevlemez-titkosítási készletet az adott aktív kulccsal.
...
### -InputObject
A merevlemez-titkosítási készlet helyi objektuma.
...
### -Name (név)
A lemez titkosítási készletének neve.
