...
### -ProtectFromScaleIn
Azt jelzi, hogy a virtuális gép méretarányát a VM-es verzió nem veszi figyelembe a törlést a méretarányos művelet során.
...
Azt jelzi, hogy a VMSS kezdeményezett modell-vagy műveleteket (többek között a méretarányt) nem kell alkalmazni a VMSS VM-re.
