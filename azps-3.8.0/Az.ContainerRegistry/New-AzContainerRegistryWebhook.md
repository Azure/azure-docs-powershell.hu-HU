...
## Leírás
Az New-AzContainerRegistryWebhook parancsmag létrehoz egy tárolót, melyet a webhook hoz létre.

## Példák

### Példa 1: tároló-nyilvántartó webakasztó létrehozása.
```
...
Hozzon létre egy tároló-nyilvántartó webkampót.
...
### -Header
Egyéni fejlécek, amelyeket felvesz a webhook-értesítésekre.
...
### -Hely
Webhook-hely
A beállításjegyzék alapértelmezett helye.
...
### -Állapot
Webhook-állapot, alapértelmezett érték engedélyezve
