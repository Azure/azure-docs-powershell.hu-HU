...
## Áttekintés
Beolvassa a CosmosDB Cassandra szóköz billentyűt.
...
## Leírás
A **Get-AzCosmosDBCassandraKeyspace** parancsmag új vagy frissített CosmosDB hoz létre.
...
A Get-AzCosmosDBCassandraKeyspace egy meglévő CassandraKeyspace tulajdonságait kapja meg. Az erőforrás kibontásával kibonthatja a _etagt, _tst _rid tulajdonságokat.
...
### – Részletes
Ha meg van határozva, akkor a parancsmag a megfelelő átviteli értékkel rendelkező térközt adja eredményül.
