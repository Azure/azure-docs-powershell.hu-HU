...
## Áttekintés
Megkapja a CosmosDB Gremlin-adatbázisát.
...
## Leírás
A **Get-AzCosmosDBGremlinDatabase** parancsmag a CosmosDB Gremlin adatbázist kapja.
...
Az erőforrás-objektum _ridt, _tst _etag tartalmaz.
...
### – Részletes
Ha meg van határozva, akkor a parancsmag a megfelelő átviteli értékkel rendelkező adatbázist adja eredményül.
