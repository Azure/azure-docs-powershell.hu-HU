...
## Áttekintés
Beolvassa a MongoDB-adatbázis CosmosDB átviteli tulajdonságait.
...
## Leírás
A **Get-AzCosmosDBMongoDBDatabaseThroughput** parancsmag az MongoDB-adatbázis átviteli tulajdonságait kapja meg.
