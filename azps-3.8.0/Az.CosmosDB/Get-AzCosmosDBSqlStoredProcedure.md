...
## Leírás
A **Get-AzCosmosDBSqlStoredProcedure** parancsmag minden létező SQL-StoredProcedures-CosmosDB megjelenik egy adott ResourceGroupName, accountname, databasename és ContainerName, és egy CosmosDB-StoredProcedure, ResourceGroupName, accountname, databasename, ContainerName, StoredProcedureName és.
...
### Microsoft. Azure. Command. CosmosDB. models. PSSqlStoredProcedureGetResults
