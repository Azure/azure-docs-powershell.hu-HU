...
## Áttekintés
Új PSConflictResolutionPolicy típusú objektum létrehozása A set-AzCosmosDBGremlinGraph paraméter értéke lehet.
...
## Leírás
Az Gremlin API ConflictResolutionPolicy megfelelő objektum.
