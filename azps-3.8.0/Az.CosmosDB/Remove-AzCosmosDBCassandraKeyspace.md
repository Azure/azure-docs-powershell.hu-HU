...
## Áttekintés
Törli a CosmosDB Cassandra szóköz billentyűt.
...
## Leírás
A **Remove-AzCosmosDBCassandraKeyspace** parancsmag törli a meglévő CosmosDB a Cassandra szóköz billentyűkombinációval.
...
A parancsmag olyan objektumot ad eredményül, amely bool (ha a-PassThru áthalad), amely igaz, ha a törlés sikeres volt.
