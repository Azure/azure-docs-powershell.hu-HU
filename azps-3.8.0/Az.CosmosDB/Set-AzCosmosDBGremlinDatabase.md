...
## Áttekintés
A CosmosDB Gremlin-adatbázisát állítja be.
...
## Leírás
A **set-AzCosmosDBGremlinDatabase** parancsmag a CosmosDB Gremlin adatbázist állítja be.
...
### -Forgalom
Az Gremlin-adatbázis (RU/s) átviteli sebessége.
