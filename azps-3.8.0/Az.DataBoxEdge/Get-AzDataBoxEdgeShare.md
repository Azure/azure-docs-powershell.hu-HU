...
## Leírás
A **Get-AzDataBoxEdgeShare** parancsmag az adatdobozos Edge-eszköz számára elérhető megosztásokat kapja meg. Ha a név meg van jelenítve, akkor a megosztást a név alapján kapja meg.
