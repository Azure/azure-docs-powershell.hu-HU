...
## Leírás
A **Get-AzDataBoxEdgeStorageAccountCredential** parancsmag a megfelelő tárolási fiók hitelesítő adatait adja meg az adatok mező szélén lévő eszközön. Megadhatja a név, az erőforráscsoport neve és az eszköz neve paramétert, amellyel információkat kaphat egy adott tárolási fiók hitelesítő adatairól.
