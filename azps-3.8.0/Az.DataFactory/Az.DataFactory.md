...
Az Azure Data Factory által az összes aktív adatfolyam-debug munkamenet beolvasása
...
### [Meghívó-AzDataFactoryV2IntegrationRuntimeUpgrade](Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade.md)
...
### [Meghívó-AzDataFactoryV2Pipeline](Invoke-AzDataFactoryV2Pipeline.md)
Arra hívja fel a futószalagot, hogy indítsa el a futtatását.

### [Új – AzDataFactory](New-AzDataFactory.md)
Adatfeldolgozót hoz létre.

### [Új – AzDataFactoryDataset](New-AzDataFactoryDataset.md)
Adatkészletet hoz létre az adatfeldolgozóban.

### [Új – AzDataFactoryEncryptValue](New-AzDataFactoryEncryptValue.md)
...
### [Új – AzDataFactoryGatewayAuthKey](New-AzDataFactoryGatewayAuthKey.md)
...
### [Új – AzDataFactoryV2IntegrationRuntimeKey](New-AzDataFactoryV2IntegrationRuntimeKey.md)
Önkiszolgáló integrációs futásidejű kulcs újbóli létrehozása

### [Új – AzDataFactoryV2LinkedServiceEncryptedCredential](New-AzDataFactoryV2LinkedServiceEncryptedCredential.md)
...
Adatforgalom eltávolítása az adatgyárból.
...
### [Mentés-AzDataFactoryLog](Save-AzDataFactoryLog.md)
...
Adatáramlás-debug munkamenet indítása az Azure Data Factory-ban.
...
Az adatgyárban futó csővezeték leállítása
...
Adatáramlás-debug munkamenet leállítása az Azure Data Factory-ban.

### [Felfüggesztés – AzDataFactoryPipeline](Suspend-AzDataFactoryPipeline.md)
Az Azure Data Factory csővezetékének felfüggesztése

### [Szinkronizálás – AzDataFactoryV2IntegrationRuntimeCredential](Sync-AzDataFactoryV2IntegrationRuntimeCredential.md)
