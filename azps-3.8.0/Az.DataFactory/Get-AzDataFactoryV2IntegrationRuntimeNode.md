...
## Leírás
A **Get-AzDataFactoryV2IntegrationRuntimeNode** parancsmag az integrációs futásidejű csomópontok részletes adatait kapja meg.

## Példák

### Példa 1: az integrációs futtatókörnyezet csomópontjának részletes adatait kapja meg.
```
...
A parancsmag az "Node_1" nevű csomópontról ad információt az "ellenőrzés – selfhost – IR" "teszt-DF-EU2" adatkezelési futtatókörnyezetben.

### 2. példa: az integrációs futtatókörnyezet csomópontjának részletes adatait az IP-címmel együtt kapja meg.
```
...
A parancsmag az "Node_1" nevű csomópontról ad információt az "ellenőrzés – selfhost – IR" "teszt-DF-EU2" adatkezelési futtatókörnyezetben, az IP-címmel együtt.
...
### -Ip_cím
Az integrációs futásidejű csomópont IP-címe.
...
### Microsoft. Azure. Command. DataFactoryV2. models. PSManagedIntegrationRuntimeNode

### Microsoft. Azure. Command. DataFactoryV2. models. PSSelfHostedIntegrationRuntimeNode
