...
## Leírás
A **Start-AzDataFactoryV2IntegrationRuntime** parancsmag a felügyelt dedikált integrációs futtatókörnyezetet indítja el. Az erőforrás kiépítve, és azt követően, hogy a művelet az "Elindítva" állapotú.
