...
## Leírás
A Invoke-AzDataMigrationCommand parancsmag egy új, meglévő áttelepítési feladaton futtatandó parancsot hoz létre.
...
A fenti példák az Invoke-AzDataMigrationCommand parancsmagot használják a meglévő szolgáltatásokhoz, projektekhez és feladatokhoz tartozó parancsok létrehozásához.
...
### -Feladatnév
Annak a tevékenységnek a neve, amelyen a parancs fut.
...
```
### -Objektumnév
Annak az adatbázis-objektumnak a neve, amelyet a parancs fog futni.
