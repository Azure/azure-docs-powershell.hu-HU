...
## Leírás
A **Get-AzDataShareDataSetMapping** parancsmag információt kap egy adott adatkészlet-megfeleltetésről, ha a név meg van adva. Ellenkező esetben az összes adatkészlet-megfeleltetésről információt kap egy megosztási előfizetésben. 
...
```
 ...
 Ez a parancs információt jelenít meg az összes adatkészlet-megfeleltetésről a megosztási előfizetésben.
...
### -Name (név)
Azure adathalmaz megfeleltetésének neve.
