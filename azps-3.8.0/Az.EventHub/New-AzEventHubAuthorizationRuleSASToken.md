...
## Áttekintés
Egy SAS-tokent hoz létre az Azure eventhub engedélyezési szabályához (Namespace/eventhub). 
...
## Leírás
A New-AzEventHubAuthorizationRuleSASToken parancsmag létrehoz egy megosztott Access-aláírási (SAS) tokent az Azure Eventhub Namesapce vagy az Azure Eventhub
...
### Microsoft. Azure. Command. EventHub. models. PSSharedAccessSignatureAttributes
