...
## Leírás
A Set-AzEventHubConsumerGroup parancsmag frissíti a megadott esemény-hubok fogyasztói csoportját.
...
A fogyasztói csoport MyConsumerGroupName felhasználói metaadatait a \` \` "tesztelés" értékre állítja.
...
### -UserMetadata
A ConsumerGroup felhasználói metaadatai
