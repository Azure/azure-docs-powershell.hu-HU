...
### 1. példa: a HTTPS letiltása egyéni tartományhoz a FrontDoorName és a ResourceGroupName.
```powershell
...
Tiltsa le a HTTPS protokollt az "frontendpointname1-Custom-XYZ" ("frontdoor1") és a ResourceGroupName ("resourcegroup1") FrontDoorName.

### 2. példa: a HTTPS letiltása egyéni tartományhoz a PSFrontendEndpoint objektummal.
```powershell
...
Tiltsa le a HTTPS protokollt egy egyéni tartományhoz a PSFrontendEndpoint objektummal.

### 3. példa: a HTTPS letiltása egyéni tartományhoz a ResourceId-ban.
```powershell
...
Tiltsa le a HTTPS protokollt egy "frontendpointname1-Custom-XYZ" egyéni tartományhoz a ResourceId-ban $resourceId.
...
### -ResourceId
A https letiltása a bejárati ajtó végpontjának erőforrás-azonosítója
