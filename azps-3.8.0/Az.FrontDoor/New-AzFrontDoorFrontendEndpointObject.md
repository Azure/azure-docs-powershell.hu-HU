...
PSFrontendEndpoint objektum létrehozása az első ajtó létrehozása céljából.
...
### -CertificateType
a frontendEndpoint való biztonságos csatlakozáshoz használt tanúsítvány típusa
...
### -HostName (állomásnév)
A frontendEndpoint gazdagép neve.
Tartománynévnek kell lennie.
...
### -ProtocolType
A biztonságos kézbesítéshez használt TLS-kiterjesztési protokoll
...
Engedélyezi-e a munkamenet-affinitás használatát az állomáson.
...
A munkamenet-affinitáshoz másodpercben használható TTL, ha van ilyen. Az alapértelmezett érték 0
...
### -Boltozat
Az SSL-tanúsítványt tartalmazó fő pince
...
### -WebApplicationFirewallPolicyLink
A webalkalmazás tűzfal-házirendjének minden állomáshoz tartozó erőforrás-azonosítója (ha szükséges)
