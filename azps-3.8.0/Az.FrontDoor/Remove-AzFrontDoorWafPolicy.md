...
## Leírás
A **Remove-AzFrontDoorWafPolicy** parancsmag a jelenlegi előfizetés alatti WAF-házirendet távolítja el.
...
Távolítsa el a $resourceGroupName $policyName nevű WAF-házirendet.
