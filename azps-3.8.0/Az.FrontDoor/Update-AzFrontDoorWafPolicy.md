...
## Leírás
Az **Update-AzFrontDoorWafPolicy** parancsmag egy meglévő WAF-házirendet frissít. Ha a bemeneti paraméterek nem érhetők el, akkor a meglévő WAF-házirendből származó régi paramétereket fogja használni.
...
[Új – AzFrontDoorWafPolicy](./New-AzFrontDoorWafPolicy.md) 
 ...
 [Új – AzFrontDoorWafCustomRuleObject](./New-AzFrontDoorWafManagedRuleObject.md)
