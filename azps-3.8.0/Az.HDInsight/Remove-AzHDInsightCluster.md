...
## Leírás
A **Remove-AzHDInsightCluster** parancsmag az előfizetésből eltávolítja a megadott HDInsight-fürtszolgáltatást.
...
### -PassThru
Ha a PassThru létezik, az eredmény kitermelése
