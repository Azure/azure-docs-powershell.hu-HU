...
## Leírás
A **set-AzIntegrationAccount** parancsmag módosította az integrációs fiókot.
Ez a parancsmag egy olyan objektumot ad eredményül, amely az integrációs fiókot jelképezi.
...
### Példa 1: az integrációs fiók módosítása
```
...
Ez a parancs módosítja egy IntegrationAccount31 nevű integrációs fiókot a megadott erőforráscsoport számára.
