...
## Leírás
A **set-AzIntegrationAccountCertificate** parancsmag módosította az integrációs fiók tanúsítványát.
...
### Példa 1: az integrációs fiók tanúsítványának módosítása
```
...
Ez a parancs módosítja az integrációs fiók tanúsítványát a megadott erőforráscsoport számára.
