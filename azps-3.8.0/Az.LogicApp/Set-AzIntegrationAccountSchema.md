...
## Leírás
A **set-AzIntegrationAccountSchema** parancsmag módosította az integrációs fiók sémáját.
Ez a parancsmag egy olyan objektumot ad eredményül, amely az integrációs fiók sémáját jelképezi.
Adja meg az integrációs fiók nevét, az erőforrás-csoport nevét és a séma nevét.
...
### Példa 1: az integrációs fiók sémájának módosítása
```
...
A parancs a IntegrationAccountSchema43 nevű integrációs fiók sémáját módosítja.
