...
## Leírás
Frissíti a meglévő kötelezettségvállalási terv erőforrását. Felhívjuk a figyelmét arra, hogy a kötelezettségvállalási terv legtöbb tulajdonsága megváltoztathatatlan, és nem módosítható. A módosítható tulajdonságok közé tartozik a SKU (amely lehetővé teszi a kötelezettségvállalási terv áttelepítését egy SKU-ról egy másikra) és a címkéket.

## Példák

### Példa 1: kötelezettségvállalási terv frissítése
```
...
### -SkuCapacity
Az az SKU kapacitása, amelyet az Azure ML kötelezettségvállalási csomag frissítésekor kell használni.
...
### -SkuName
Annak a SKU-nak a neve, amelyet az Azure ML kötelezettségvállalási csomag frissítésekor kell használni.
...
### -SkuTier
Az az SKU-szint, amelyet az Azure ML kötelezettségvállalási csomag frissítésekor kell használni.
...
### -Címke
A kötelezettségvállalási terv erőforrásának címkéi
