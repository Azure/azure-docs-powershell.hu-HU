...
## Leírás
Az **Add-AzExpressRouteCircuitConnectionConfig** parancsmag egy áramkör-kapcsolati konfigurációt ad egy ExpressRoute-áramkör személyes kinézetéhez. Ez a beállítás lehetővé teszi a két útvonal közötti átirányítást régiónként vagy előfizetésben. Felhívjuk a figyelmét arra, hogy a **AzExpressRouteCircuitConnectionConfig** futtatása után az Set-AzExpressRouteCircuit parancsmagot kell hívnia a konfiguráció aktiválásához.
...
```
### -AddressPrefixType
Ez a cím azt a családi címet adja meg, amelyhez a cím előtag tartozik.
