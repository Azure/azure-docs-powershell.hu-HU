...
A rendelkezésre álló privát végpontok típusának visszaadása a helyen
...
Újraírási szabály URL-konfigurációjának létrehozása az alkalmazás-átjárókban
...
Létrehoz egy kapcsolat monitort.
...
Eltávolít egy kapcsolat monitort.

### [Remove-AzNetworkWatcherFlowLog](Remove-AzNetworkWatcherFlowLog.md)
Egy folyamatábra-erőforrás eltávolítása.
...
Adatfolyam-naplózási erőforrás frissítése
...
Válassza le a virtuális hálózati átjáró VPN-kapcsolatát.

### [Disconnect-AzP2sVpnGatewayVpnConnection](Disconnect-AzP2sVpnGatewayVpnConnection.md)
Válassza le a p2s VPN-átjáró VPN-kapcsolatát.
