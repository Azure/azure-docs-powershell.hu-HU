...
## Leírás
A **Get-AzExpressRouteCircuitStat** parancsmag ExpressRoute-áramkör forgalmi statisztikáit keresi meg. A statisztika tartalmazza az elsődleges és a másodlagos útvonalon keresztül küldött és fogadott bájtok számát.

## Példák

### Példa 1: ExpressRoute-os adatforgalmi statisztika megjelenítése
```
