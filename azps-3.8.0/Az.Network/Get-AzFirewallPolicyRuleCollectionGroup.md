...
## Leírás
A **Get-AzFirewallPolicyRuleCollectionGroup** parancsmag a tűzfal-házirendben említett RuleCollectionGroup kapja.
...
Ez a példa beolvassa a collectionGroup szabályt a tűzfal-házirend $fp
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. commands. Network. models. PSAzureFirewall, Microsoft. Azure. PowerShell. parancsmagok. Network, Version = 1.12.0.0, Culture = semleges, PublicKeyToken = null]]
