...
### 3. példa: a hálózati illesztők beolvasása szűréssel
```
...
Ez a parancs a "teszt" kezdetű jelenlegi előfizetéshez tartozó összes hálózati csatolót megkapja.
...
### -ResourceId
A hálózati kapcsolat Azure Resource Manager azonosítója.
