...
## Leírás
**A New-AzApplicationGatewayRewriteRule** parancsmag átírási szabályt hoz létre az Azure-alkalmazás átjárója számára.

## Példák

### Példa 1: átírási szabály létrehozása az alkalmazás-átjáróhoz
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

Ez a parancs létrehoz egy Szabály1 nevű átírási szabályt, és az eredményt az $rule nevű változóban tárolja.

## PARAMÉTEREK

### -ActionSet
Az átírási szabály ActionSet
...
### -Feltétel
Az Újraírási szabály feltétele a végrehajtáshoz
...
### -RuleSequence
Az Újraírási szabály elrendelése az Újraírási szabály halmazában
