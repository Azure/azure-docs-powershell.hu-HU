...
## Leírás
**A New-AzApplicationGatewayRewriteRuleActionSet** parancsmag az Azure Application Gateway-hez létrehozott átírási szabályhoz.
...
Ez a parancs létrehoz egy új szabály-műveleti halmazt, és az eredményt az $action nevű változóban tárolja.
...
A kérés fejléc-konfigurációjának listája
...
A válasz fejléc-konfigurációinak listája
