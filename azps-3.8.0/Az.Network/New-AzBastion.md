...
### ByPublicIpAddressByVirtualNetwork (alapértelmezett)
```
...
## Leírás
Bástya-erőforrást hoz létre. Ehhez szüksége lesz egy nyilvános IP-címre és egy VirtualNetwork. Ebben a VirtualNetwork a name AzureBastionSubnet alhálózatnak kell lennie. a ágyéki IP-címet a SKU standard értékkel kell létrehozni.
...
### -PublicIpAddress
A bástya nyilvános IP-cím objektuma.
...
### -PublicIpAddressId
A Bastion-hez tartozó nyilvános IP-cím Azure Resource ID azonosítója.
...
### -PublicIpAddressName
A bástya nyilvános IP-cím erőforrásának neve.
...
A bástya nyilvános IP-cím nevű erőforráscsoport neve.
...
### -ResourceGroupName
Az erőforráscsoport neve, ahová a bástya létrehozása szükséges.
...
### -VirtualNetwork
A bástya virtuális hálózati objektuma.
...
### -VirtualNetworkId
A bástya virtuális hálózat Azure Resource ID azonosítója.
...
### -VirtualNetworkName
A bástya virtuális hálózati erőforrásának neve.
...
A virtuális hálózat erőforráscsoport neve a bástya számára.
