...
## Leírás
A **New-AzExpressRoutePort** parancsmag létrehoz egy Azure ExpressRoutePort
...
### -BandwidthInGbps
A beszerzett portok sávszélessége a Gbps-ben
...
### -Beágyazás
Beágyazási módszer a fizikai portokon.
...
### – Identitás
Felhasználó által kiosztott identitás a MacSec-konfiguráció olvasásához
...
### -Hivatkozás
A ExpressRoutePort-erőforrás fizikai hivatkozásainak halmaza
...
### -PeeringLocation
Annak a megadási helynek a neve, amelyet a ExpressRoutePort fizikailag társítanak.
