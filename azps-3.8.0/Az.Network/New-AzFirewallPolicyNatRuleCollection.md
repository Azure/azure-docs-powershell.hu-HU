...
## Leírás
A **New-AzFirewallPolicyNatRuleCollection** parancsmag létrehoz egy NAT-szabályt az Azure tűzfal házirendjéhez.
...
Ez a példa NAT-szabályt hoz létre egy hálózati szabállyal

## PARAMÉTEREK

### -ActionType
A szabály típusú műveletek típusa
...
### -Name (név)
A hálózati szabály gyűjtemény neve
