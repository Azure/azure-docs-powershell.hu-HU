...
```
## Leírás
A **New-AzIpConfigurationBgpPeeringAddressObject** létrehoz egy IpConfigurationBgpPeeringAddressObject objektumot, amely a virtuális hálózati átjáró bgpsettings BgpPeeringAddresses tulajdonságát képviseli.
...
A fenti IpConfigurationBgpPeeringAddressObject létre fog hozni. Ez az új objektum a gw1ipconfBgp1.
...
### -CustomAddress
A BgpPeeringAddresses virtuális hálózati átjáró CustomAddress listája.
...
### -IpConfigurationId
A virtuális hálózati átjáró IpConfigurationId a BgpPeeringAddresses-hoz.
