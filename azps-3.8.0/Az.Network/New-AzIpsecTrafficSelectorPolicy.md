...
## Leírás
Az New-AzTrafficSelectorPolicy parancsmag létrehoz egy forgalmi választó házirend-javaslatot, amelyet a virtuális hálózati átjáró kapcsolata esetén kell használni.
...
A forgalmi kiválasztó házirend példányát hozza létre, és paraméterként hozzáadja a virtuális hálózati átjáró-kapcsolat IKEv2-protokollal való létrehozásakor.
...
### -LocalAddressRange
CIDR-címtartományok gyűjteménye
