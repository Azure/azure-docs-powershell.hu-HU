...
## Leírás
New-AzNetworkWatcherConnectionMonitorEndpointObject parancsmag a kapcsolat figyelése végpontot hozza létre.
...
Név: workspaceEndpoint ResourceId:/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace cím: szűrő: {"type": "include", "Items": [{"type": "AgentAddress"; "cím": "WIN-P0HGNDO2S1B"}]}

## PARAMÉTEREK

### -Address (cím)
A kapcsolati figyelő végpontjának címe (IP vagy tartománynév).
...
### -FilterType
A végpontok szűrő működése Jelenleg csak a "include" támogatott.
...
### -Name (név)
A kapcsolat figyelője végpontjának neve.
...
### -ResourceId
A kapcsolat figyelője végpontjának erőforrás-azonosítója.
