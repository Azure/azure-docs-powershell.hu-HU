...
## Leírás
A New-AzNetworkWatcherConnectionMonitorProtocolConfigurationObject parancsmag protokoll-konfigurációt hoz létre a TCP, a HTTP vagy az ICMP protokollal végzett teszteléshez.
...
### -DisableTraceRoute
Az az érték, amely azt jelzi, hogy le kell-e tiltani az elérésiút-vizsgálatot a nyomkövetési útvonallal
...
### -Path (elérési út)
Az URI elérési útvonal-összetevője Például a \" /dir1/dir2 \" .
...
### -Port
Annak a portnak a csatlakoztatása, amelyhez csatlakozni szeretne.
...
### -PreferHTTPS
Az az érték, amely azt jelzi, hogy a HTTPS a HTTP-t részesíti előnyben olyan esetekben, ahol a választás nem explicit.
...
### -RequestHeader
A kéréssel továbbítani kívánt HTTP-fejlécek.
...
A sikeresnek ítélt HTTP-állapotkódok Például \" 2xx, 301-304418 \" .
