...
## Leírás
A **New-AzVpnServerConfiguration** parancsmag segítségével új VpnServerConfiguration hozhat létre különböző VpnProtocols, VpnAuthenticationTypes és IpsecPolicies, valamint beállíthatja a kijelölt VPN-hitelesítési típust a kapcsolódó paraméterekkel, mint az ügyfélnek a webhelyhez való kapcsolódást előfeltétele.
...
A fenti parancs új VpnServerConfiguration hoz létre a VpnAuthenticationType tanúsítványként.
