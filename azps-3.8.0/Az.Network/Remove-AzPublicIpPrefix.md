...
## Leírás
A **Remove-AzPublicIpPrefix** parancsmag mindaddig eltávolítja az Azure nyilvános IP-előtagot, ameddig nincs kiosztott nyilvános IP-cím.
...
A $prefixName nevű nyilvános IP-előtag eltávolítása az erőforrás csoportból $rgName
...
### -ResourceId
Az eltávolítandó erőforrás resourceId
