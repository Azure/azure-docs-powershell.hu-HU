...
### ByVpnServerConfigurationName (alapértelmezett)
```
...
A fenti parancs eltávolítja a meglévő VpnServerConfiguration.
...
### -InputObject
A törlendő vpnServerConfiguration objektum.
...
### -ResourceId
A törlendő vpnServerConfiguration Azure Resource AZONOSÍTÓja.
