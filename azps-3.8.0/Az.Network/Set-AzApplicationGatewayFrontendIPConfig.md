...
## Leírás
A **set-AzApplicationGatewayFrontendIPConfig** parancsmag frissíti az előtér IP-konfigurációját.
Az alkalmazás-átjárók kétféle előtér-IP-címet támogatnak: 
- Nyilvános IP-címek
- Privát IP-címek, amelyek esetében a konfiguráció belső terheléselosztást (ILB) használ, az alkalmazás-átjárók legfeljebb egy nyilvános IP-címen és egy privát IP-címen lehetnek.
