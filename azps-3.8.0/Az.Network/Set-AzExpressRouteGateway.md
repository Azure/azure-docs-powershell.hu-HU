...
Set-AzExpressRouteGateway frissíti a ExpressRouteGateway tartozó méretarányos mértékegységeket.
...
A fenti létrehoz egy erőforráscsoport, virtuális WAN, virtuális hálózat, virtuális hub a Nyugat-amerikai "testRG" erőforráscsoport az Azure-ban. Ezt követően létrejön egy ExpressRoute-átjáró a virtuális központban, 2 léptékű egységgel, amelyet ezután 3 léptékű egységre kell módosítani.
...
### -InputObject
A ExpressRouteGateway frissíteni kell.
...
### -ResourceGroupName
A frissítendő ExpressRouteGateway erőforráscsoport neve.
...
### -ResourceId
Annak a ExpressRouteGateway a azonosítója, amelyet frissíteni kell.
