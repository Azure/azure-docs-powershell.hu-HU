...
## Leírás
A **set-AzExpressRoutePortIdentity** parancsmag frissíti egy helyi Azure ExpressRoutePort-objektumot. A **set-AzExpressRoutePort** használatával társíthatja a ExpressRoutePort.
