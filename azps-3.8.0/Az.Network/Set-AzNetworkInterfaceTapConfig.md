...
## Leírás
A **set-AzNetworkInterfaceTapConfig** frissíti a hálózati felület koppintásos konfigurációját.

## Példák

### 1. példa: a TapConfiguration beállítása frissített TapConfig névvel
```
...
A NetworkInterface koppintson a konfiguráció elemre
