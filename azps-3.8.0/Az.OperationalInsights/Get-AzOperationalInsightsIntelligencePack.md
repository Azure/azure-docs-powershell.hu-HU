...
## Leírás
A **Get-AzOperationalInsightsIntelligencePack** parancsmag az elérhető intelligencia csomagokat kapja.

## Példák

### 1. példa: intelligencia-csomagok beolvasása
```
PS C:\>Get-AzOperationalInsightsStorageInsight -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace"
```

Ez a parancs a rendelkezésre álló intelligencia csomagokat kapja.
