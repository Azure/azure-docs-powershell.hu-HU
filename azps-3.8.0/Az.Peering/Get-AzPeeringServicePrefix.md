...
## Leírás
A társas szolgáltatási objektumokra vonatkozó előtagok listája
...
A csővezeték-parancsok alapján egy társközi szolgáltatás előtagjait kapja meg.
...
Erőforrás-azonosítóval beolvashatja a társas szolgáltatások meghatározott előtagját.
...
A kibontott attribútumokat tartalmazó speciális előtagot kapja meg.
...
### – Kibontás
A társas szolgáltatások előtagjaként megjelenített események megtekintése
...
### -PeeringServiceName
A társas szolgáltatás neve. New-AzPeeringService parancsmagot használhat új társközi szolgáltatáshoz vagy Get-AzPeeringService a listákhoz.
