...
## Leírás
A PSPeering objektum visszaállítása
...
Az Md5 hitelesítési kulcs megadása

### A UseForPeeringService frissítése
```powershell
...
A szolgáltatás kijelzőjének beállítása

### Az IPv4-cím frissítése az Exchange-alapú levelezéshez
```powershell
...
Exchange-társközi IPv4-címének beállítása az ResourceId használatával
...
### -DirectConnection
Új közvetlen kapcsolatok létrehozása a New-AzDirectPeeringConnectionObject és a pipe parancs segítségével.
...
### -ExchangeConnection
Új Exchange-kapcsolat létrehozása a New-AzExchangePeeringConnectionObject és a pipe segítségével a parancs segítségével.
