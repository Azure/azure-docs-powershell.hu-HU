...
## Leírás
A **Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** parancsmaggal a védett Azure Virtual Machine védelemhez hozzáadhatja a lemezt.
...
A művelet indításához adja meg a megfelelő lemezkezelő-konfigurációt a védelemhez.
...
A művelet indításához adja meg a megfelelő lemezkezelő-konfigurációt a védelemhez. Csővezetéken keresztüli többszörözéssel védett elem

## PARAMÉTEREK

### -AzureToAzureDiskReplicationConfiguration
Itt adhatja meg az Azure rendszerhez az Azure katasztrófa-elhárítási forgatókönyvek esetén a Lemezkezelés esetén használt Disk-konfigurációt.
...
### -InputObject
A bemeneti objektum a parancsmaghoz: az ASR-replikációval védett elem objektum, amely megfelel az új lemez védelmének.
