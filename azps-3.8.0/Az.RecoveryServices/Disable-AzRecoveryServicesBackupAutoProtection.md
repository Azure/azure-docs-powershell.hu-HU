...
Az első parancsmag letiltja a biztonsági mentési házirendet.

## PARAMÉTEREK

### -BackupManagementType
Az erőforrás biztonságimásolat-kezelési típusa (például: Mohácsi, DPM).
...
### -WorkloadType
Az erőforrás terhelési típusa (például: AzureVM, WindowsServer, AzureFiles).
