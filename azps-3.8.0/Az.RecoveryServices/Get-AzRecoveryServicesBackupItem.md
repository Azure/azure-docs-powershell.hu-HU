...
A típusú megjelenített paraméter használata több Azure-fájlmegosztás visszaadásához vezethet. Ebben az esetben a name tulajdonságot $BackupItem változóban a Name tulajdonság értékét adja eredményül.
