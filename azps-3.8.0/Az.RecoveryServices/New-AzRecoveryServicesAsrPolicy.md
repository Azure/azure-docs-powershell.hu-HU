...
### -AzureToAzure
Kapcsoló paraméter adja meg az Azure-alapú házirendek létrehozásának forgatókönyvét.
...
### -AzureToVMware
A kapcsoló paraméter az Azure-hoz vMWare-házirendek létrehozásának forgatókönyvét adja meg.
