...
## Áttekintés
Eltávolítja a lemezeket a replikációs védelemmel ellátott elemekhez.
...
## Leírás
A **Remove-AzRecoveryServicesAsrReplicationProtectedItemDisk** parancsmag eltávolítja a lemezt az ASR-replikációs védelemmel ellátott elemből.
...
Indítsa el a műveletet, ha a nem felügyelt lemezekre vonatkozóan eltávolítja a megadott lemezt a VM védelmi szolgáltatásból.
...
Indítsa el a műveletet, ha a kezelt lemezről eltávolítja a megadott lemezt a védelmi VM-ből.
...
Elindítja a műveletet a megadott lemez eltávolításához, és visszaadja a védett lemezek eltávolítása művelet nyomon követéséhez használt ASR-feladatot.
...
### -Csúszásgátló
A felügyelt lemezvezérlő-azonosítók listáját adja meg.
...
### -InputObject
A bemeneti objektum a parancsmag: az ASR replikációs szolgáltatással védett elem objektuma, amely megfelel a lemez eltávolításának.
...
### -VhdUri
A VHD-URI-azonosítók listáját adja meg.
