...
## Leírás
Az **Update-AzRecoveryServicesAsrProtectionContainerMapping** parancsmag frissíti a megadott Azure-webhely-helyreállítási védelmi tárolók megfeleltetését.
...
A művelet indításához tiltsa le a tároló automatikus frissítésének engedélyezése jelölőnégyzetet.

## PARAMÉTEREK

### -AutomationAccountId
Az automatikus udpate használt automatizálási accountId adja meg.
...
### -AzureToAzure
Az Azure az Azure Protection tárolót adja meg.
...
### -DisableAutoUpdate
Váltson paramétert az automatikus frissítés letiltásához.
...
### -EnableAutoUpdate
Váltson paramétert az automatikus frissítés engedélyezéséhez.
...
### -InputObject
Objektum a védett tárolók megfeleltetéséhez.
