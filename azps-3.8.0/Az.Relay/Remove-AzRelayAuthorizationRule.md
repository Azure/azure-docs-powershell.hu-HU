...
## Leírás
A **Remove-AzRelayAuthorizationRule** parancsmag eltávolítja a megadott továbbítóügynök engedélyezési szabályait (Namespace/WcfRelay/HybridConnection).
...
Eltávolítja a névtér engedélyezési szabályát `AuthoRule1` `TestNameSpace-Relay1` .
...
Eltávolítja a `AuthoRule1` névtérből származó WcfRelay engedélyezési szabályát `TestWcfRelay` `TestNameSpace-Relay1` .
...
Eltávolítja a `AuthoRule1` névtérből származó HybridConnection engedélyezési szabályát `TestHybridConnection` `TestNameSpace-Relay1` .
