...
### 2. példa: az erőforráscsoport vagy a magasabb szintű zárolások lekérése
```
PS C:\> Get-AzResourceLock -ResourceGroupName "ResourceGroup11" -AtScope
```

Ez a parancs beolvassa az erőforrás-zárolásokat az erőforrás csoportban vagy az előfizetésben.
