...
Létrehoz egy új alkalmazást a "ServicePrincipalName" névvel és a "StrongPassworld!23" jelszóval, és létrehozza az egyszerű szolgáltatásnevet az éppen létrehozott alkalmazás alapján. A rendszer hozzáadja a kezdő dátumot és a záró dátumot a jelszó hitelesítő adataihoz.
...
Létrehoz egy új alkalmazást "ServicePrincipalName" és certifcate "$cert" névvel, és létrehozza a szolgáltatásnevet az éppen létrehozott alkalmazás alapján. A rendszer hozzáadja a záró dátumot a kulcs hitelesítő adataihoz.
