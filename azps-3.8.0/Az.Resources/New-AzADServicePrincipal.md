...
### 7. példa – új AD-szolgáltató létrehozása a DisplayName és a jelszó hitelesítő adataival
...
Új alkalmazást hoz létre a "ServicePrincipalName" és a password "StrongPassworld! 23" névvel, és létrehozza a szolgáltatást az imént létrehozott alkalmazás alapján. A program felveszi a kezdési és a befejezési dátumot a jelszó hitelesítő adataiba.
...
Egy új, "ServicePrincipalName" és certifcate "$cert" nevű alkalmazást hoz létre, és létrehozza a szolgáltatásnevet az imént létrehozott alkalmazás alapján. A befejezési dátum hozzáadódik a legfontosabb hitelesítő adatokhoz.
