...
## Leírás
A **New-AzPolicySetDefinition** parancsmag létrehoz egy házirend-készlet definícióját.

## Példák

### 1. példa: házirend-készlet definíciójának létrehozása a metaadatokkal egy házirendfájl használatával
```
[
   {
...
Ez a parancs létrehoz egy VMPolicySetDefinition nevű házirend-definíciós definíciót, amely azt jelzi, hogy a kategóriája a "virtuális gép", amely a C:\VMPolicy.jsban megadott házirend-definíciókat tartalmazza. Példa: a fenti VMPolicy.jstartalma.
...
Ez a parancs létrehoz egy VMPolicySetDefinition nevű, paraméteres házirend-definíciós definíciót, amely a C:\VMPolicy.jsban megadott házirend-definíciókat tartalmazza. Példa: a fenti VMPolicy.jstartalma.

### 3. példa: házirend-definíciós definíció létrehozása házirend-definíciós csoportokkal
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Ez a parancs létrehoz egy VMPolicySetDefinition nevű házirend-definíciós definíciót, amelyben a C:\VMPolicy.jsbe van állítva a házirend-definíciók csoportja. Példa: a fenti VMPolicy.jstartalma.
...
### -GroupDefinition
Az új házirendprofil definíciójának házirend-definíciós csoportjai. Ez lehet a csoportokat tartalmazó fájl elérési útja, vagy a csoportok JSON-karakterláncként.
...
### -Metadata
A házirend-készlet definíciójának metaadatai. Ez lehet a metaadatokat tartalmazó fájlnév vagy a metaadatok használata JSON-karakterláncként.
...
Ez lehet egy elérési út a Parameters deklarációt tartalmazó fájlnévhez vagy a Parameters deklaráció JSON-karakterláncként való eléréséhez.
