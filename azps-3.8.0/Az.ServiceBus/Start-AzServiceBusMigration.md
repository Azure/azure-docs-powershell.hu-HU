...
Új áttelepítési konfiguráció létrehozása "TestingNamespaceStandardMigration"-hoz ' TestingNamespacePremiumMigration ' névterekhez
...
### -PostMigrationName
A normál névtér áttelepítési nevének közzététele az áttelepítés során
