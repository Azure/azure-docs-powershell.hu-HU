...
### -Hely
A jelző szolgáltatás helye. A program az erőforráscsoport helyét használja, ha nincs megadva.
...
### -ResourceGroupName
Az erőforrás csoport neve. A program az alapértelmezett értéket használja, ha nincs megadva.
...
### -UnitCount
A szignáló szolgáltatás egységének száma 1-től 10-ig. Az alapértelmezett érték 1.
