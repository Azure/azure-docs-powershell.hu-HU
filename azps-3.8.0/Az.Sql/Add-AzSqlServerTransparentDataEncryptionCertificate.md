...
### AddAzureRmSqlServerTransparentDataEncryptionCertificateDefaultParameterSet (alapértelmezett)
```
...
## Leírás
A Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate a megadott SQL Server-példányhoz hozzáadja az átlátszó adattitkosítási tanúsítványt
...
TDE tanúsítvány felvétele SQL Serverbe az erőforráscsoport neve és az SQL-kiszolgáló neve segítségével
...
TDE-tanúsítvány felvétele a kiszolgálókra kiszolgálói resourceId használatával
...
TDE tanúsítvány felvétele az erőforráscsoport összes SQL-kiszolgálójára
...
### -PassThru
A sikeres végrehajtáskor a hozzáadott tanúsítványállapot-objektumot adja eredményül.
...
### -Jelszó
Az átlátszó adattitkosítási tanúsítvány jelszava
...
### -PrivateBlob
A privát blob az átlátszó adattitkosítási tanúsítványhoz
