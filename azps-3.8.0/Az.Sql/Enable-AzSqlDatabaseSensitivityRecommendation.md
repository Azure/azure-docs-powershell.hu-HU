...
## Leírás
Az Enable-AzSqlDatabaseSensitivityRecommendation parancsmag az adatbázis oszlopaira vonatkozó érzékenységi javaslatokat tesz lehetővé.

## Példák

### 1. példa: az egyes oszlopokra vonatkozó érzékenységi javaslatok engedélyezése Azure SQL-adatbázisokban.
```powershell
...
### 2. példa: az érzékenységi javaslatok engedélyezése egy adott oszlop Azure SQL-adatbázisban csővezetékek használatával.
```powershell
