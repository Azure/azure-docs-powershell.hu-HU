...
### Példa 4: az összes példány beolvasása egy adott gyűjtőn belül
```powershell
...
Ez a parancs a "instancePool0" példányban található összes példányról információt kap.

### Példa 5: az adott alkalmazáskészleten belül az összes példány beolvasása a instance Pool Object objektummal
```powershell
...
### Példa 6: a példányleírás minden előfordulásának beolvasása a példány-készlet erőforrás-azonosítójának használatával
```powershell
...
### 7. példa: felügyelt példány beszerzése az erőforrás-azonosítóval
```powershell
