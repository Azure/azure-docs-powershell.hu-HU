...
## Leírás
A **Get-AzSqlSyncAgent** parancsmag információt ad egy vagy több Azure SQL-szinkronizálási ügynökről.
Adja meg a szinkronizálási ügynök nevét, ha csak a szinkronizálási megbízott adatait szeretné látni.

## Példák

### 1. példa: az Azure SQL Serverhez rendelt összes példány beolvasása az Azure SQL Server-kiszolgálóval
```
...
Ez a parancs információt kap az Azure SQL Serverhez rendelt összes Azure SQL-szinkronizálási ügynökről.

### 2. példa: információk beszerzése Azure SQL-szinkronizáló ügynökről
```
...
Ez a parancs információt kap az Azure SQL-adatbázis szinkronizálási ügynökéről a "SyncAgent01" névvel

### 3. példa: az Azure SQL Serverhez rendelt összes példány beolvasása a szűrés segítségével
```
...
Ez a parancs a "SyncAgent" kezdetű Azure SQL Serverhez rendelt összes Azure SQL-szinkronizálási ügynökről kap információkat.
