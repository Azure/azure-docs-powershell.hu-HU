...
## Leírás
A **New-AzSqlInstancePool** parancsmag egy Azure SQL-példány készletet hoz létre.
...
A parancs létrehoz egy új Azure SQL-példány-készletet.
...
### -ComputeGeneration
A számítási generáció a példány-készletben.
...
### – Kiadás
A példány példányának kiadását.
...
### -Hely
A példány-készlet létrehozásának helye.
...
### – NetI
Az alhálózati azonosító, amelyet például a készlet létrehozásakor kell használni.
