...
## Leírás
A **Remove-AzSqlInstancePool** parancsmag eltávolítja az Azure SQL-példányok készletét.

## Példák

### 1. példa: a példányok készletének eltávolítása
```powershell
PS C:\> Remove-AzSqlInstancePool -ResourceGroup resourcegroup01 -Name instancePool0
```

### 2. példa: a példány-készlet eltávolítása az erőforrás-azonosítóval
```powershell
...
### 3. példa: egy példány készletének eltávolítása egy példány-gyűjtő objektummal
```powershell
...
Ez a parancs eltávolítja a instancePool0 nevű példány-készletet.
...
### -InputObject
A példánynév objektum, amelyet el kell távolítani.
...
### -ResourceId
A példány-készlet erőforrás-azonosítója, amelyet el szeretne távolítani.
