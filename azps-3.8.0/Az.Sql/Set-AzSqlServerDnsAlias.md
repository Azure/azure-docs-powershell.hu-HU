...
## Leírás
Ez a parancs frissíti azt a kiszolgálót, amelyre az alias mutat. Ezt a parancsot úgy kell kiállítani, hogy az előfizetésbe jelentkezzen be, ahol az az új kiszolgáló, amelyen az alias pont található.
...
Ez a parancs olyan aliasokat frissít, amelyek korábban a oldServer mutattak, és a kiszolgáló newServer mutatnak
...
### -Name (név)
Az Azure SQL Server DNS-aliasának neve.
...
### -SourceServerName
Annak az Azure SQL Server-kiszolgálónak a neve, amelyhez az alias jelenleg mutat.
...
A forráskiszolgáló erőforráscsoport neve.
...
A forráskiszolgáló előfizetési azonosítója
...
### -TargetServerName
Annak az Azure SQL Server-kiszolgálónak a neve, amelyhez az aliasnak mutatnia kell.
