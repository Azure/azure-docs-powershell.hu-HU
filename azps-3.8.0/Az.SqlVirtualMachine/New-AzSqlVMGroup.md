...
## Leírás
Az New-AzSqlVMGroup parancsmag létrehoz egy Azure SQL Virtual Machine-csoportot.
...
Új Azure SQL Virtual Machine-csoportot hoz létre, amelyben a teszt-csoport VM az erőforráscsoport ResourceGroup01 van.
a $profile a Microsoft. Azure. Management. SqlVirtualMachine. models. WsfcDomainProfile fájltípusú objektum.
...
A fürtök létrehozásához használt név
...
Az üzemeltetési fürtökhöz használt név
...
### -DomainFqdn
A tartomány teljesen minősített neve
...
A fájlmegosztásról választható elérési útja
...
### -Hely
Az SQL virtuálisgép-csoport helye.
...
### -Ajánlat
A virtuális SQL Machine-csoport ajánlata.
...
### -OuPath
Szervezeti egység elérési útvonala, amelyben a csomópontok és a klaszterek jelen lesznek
...
### -SKU
SQL Virtual Machine Group Edition típus
...
### -SqlServiceAccount
A fürtben a többi SQL-szolgáltatónál futtatandó SQL-szolgáltatás neve
...
A tanú-tároló fiók elsődleges kulcsa
...
### -Címke
A virtuális SQL Machine-csoporttal társítani kívánt címkék.
