...
## Leírás
A **Get-AzStackEdgeDevice** parancsmag információkat kap a rendelkezésre álló halom Edge-eszközökről. Az eszköz nevét az erőforráscsoport nevével együtt megadhatja, ha egy adott eszközön szeretne információt kapni. 
...
### -Értesítés
Értesítések beolvasása a halom szélén/átjáró eszközön
...
### -ExtendedInfo
További információk a megadott halom Edge/halom átjáró eszközhöz
...
### -NetworkSetting
A megadott halom Edge/halom átjáró eszköz hálózati beállításait kapja meg.
