...
## Leírás
A **Get-AzStackEdgeRole** parancsmag beolvassa az elérhető IoT-szerepköröket egy halom Edge-eszközhöz. Megemlítheti a Name (név) paramétert egy adott IoT szerepkör részleteinek megadásához.
