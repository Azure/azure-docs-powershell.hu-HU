...
## Leírás
A **Get-AzStackEdgeShare** parancsmag az elérhető megosztásokat kapja egy halom Edge-eszközön. Ha a név meg van jelenítve, akkor a megosztást a név alapján kapja meg.
