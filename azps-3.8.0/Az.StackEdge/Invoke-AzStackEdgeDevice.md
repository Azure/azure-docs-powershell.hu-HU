...
## Leírás
Az AzStackEdgeDevice parancsmag az átvizsgálandó műveleteket **kezdeményezi** , letöltheti és telepítheti a frissítéseket a halom szélén lévő eszközön. Az automatikus vizsgálat naponta fut, a következő parancsmag futtatásával explicit módon aktiválhatja a vizsgálatot.
...
### -FetchUpdate
A frissítések letöltése a halom szélén/átjáró eszközön
...
### -InstallUpdate
A frissítések telepítése a halom Edge/Gateway eszközön
...
### -ScanForUpdate
Frissítéseket keres a halom szélén/átjáró eszközön.
