...
## Leírás
A **New-AzStackEdgeStorageAccountCredential** parancsmag új, az Edge-beli tárolási fiók hitelesítő adatait hozza létre a halom szélén álló eszközökhöz.
...
tárolási fiók elérési kulcsának biztosítása
...
### -StorageAccountType
Lehetséges tárterület-Hozzáférési típus GeneralPurposeStorage, BlockStorage
