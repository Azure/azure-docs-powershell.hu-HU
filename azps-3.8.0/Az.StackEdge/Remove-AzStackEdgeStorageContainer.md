...
## Leírás
A **Remove-AzStackEdgeStorageContainer** parancsmag eltávolítja az Edge Storage-tárolóhoz tartozó tároló tárolót egy halom szélén futó eszközön. Megadhatja annak a tároló-tárolónak a nevét, amelyet paraméterként szeretne eltávolítani.
