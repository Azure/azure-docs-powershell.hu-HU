...
## Leírás
A **set-AzStackEdgeStorageAccountCredential** parancsmag a halom szélén lévő eszköz tárolási fiókjához tartozó tárolási fiók hitelesítő adatait frissíti.
...
Segítséget nyújt a tárolási fiókok elérési kulcsainak elforgatásához
