...
## Leírás
A **Get-AzStorageFileHandle** parancsmag a fájlmegosztás, a fájl vagy a fájl könyvtárát jeleníti meg.

## Példák

### 1. példa: a fájlmegosztás minden fájlleíró rekurzív módon, az ClientIp és a OpenTime szerint rendezve
```
...
Ez a parancs felsorolja a fájlok megosztását, és a kimenetet ClientIp, majd a OpenTime szerint rendezi.

### 2. példa: a fájl első 2 fájlleíró-fogópontjának listája rekurzívan 
```
...
Ez a parancs az első 2 fájlleíró rekurzív módon jeleníti meg a fájl könyvtárát.

### 3. példa: a harmadik a 6. fájl fogópontjának felsorolása egy fájlon 
```
...
Ez a parancs felsorolja a 3 a 6 a fájlon lévő fogópontokat.
...
### -Fájl
CloudFile objektum: a fájl a fájllista fogópontokat jelölte ki.
...
### -IncludeTotalCount
Az adathalmazban lévő objektumok (egy egész) számát, majd az objektumok számát adja eredményül. Ha a parancsmag nem tudja megállapítani a teljes számlálást, az "ismeretlen összeg számítása" értéket adja eredményül.
...
### -Skip (kihagyás)
Figyelmen kívül hagyja az első ' n ' objektumokat, majd a fennmaradó objektumokat kapja.
...
### – Első
Csak az első ' n ' objektumokat kapja meg.
