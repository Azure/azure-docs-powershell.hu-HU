...
## Leírás
A parancs Azure-szinkronizálási Felhőbeli végpontot hoz létre. A Felhőbeli végpontok egy meglévő Azure-fájlmegosztás hivatkozásai. Ez a fájl a megosztást jelöli, és a szinkronizálási csoport összes fájljának szinkronizálásakor a részvételi hozzájárulást adja meg.
...
A Felhőbeli végpontok a szinkronizálási csoportok elválaszthatatlan tagjai, ez a példa a "mySyncGroupName" nevű meglévő szinkronizálási csoporton belül létrehoz egy meglévőt.
...
### -AzureFileShareName
Tárhely-megosztási fiók neve (Azure fájlmegosztás neve)
...
### -Name (név)
A felhő végpontjának neve. Amikor az Azure portálon keresztül jön létre, a név az Azure-fájl megosztási hivatkozásának neve lesz.
...
Tárolási fiók bérlői azonosítója (vállalati címtár-azonosító)
