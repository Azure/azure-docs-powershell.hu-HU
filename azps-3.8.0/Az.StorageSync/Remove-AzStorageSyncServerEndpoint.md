...
## Leírás
A kiszolgáló végpontjának eltávolítása romboló művelet. Ez a kiszolgálói hely megszünteti a szinkronizálást. Ezt a műveletet nem kell végrehajtani a szinkronizálási problémák megoldásához. Ha ez a kiszolgáló-hely (beleértve a fájlokat is) ismét hozzáadódik ugyanahhoz a szinkronizálási csoporthoz, mint a kiszolgáló végpontja, akkor az ütközési fájlok és más nem szándékolt következmények eléréséhez vezethet. Ez a parancs csak a leszerelésre szolgál.
...
Ez a parancs eltávolítja a kiszolgáló végpontját.
...
### -InputObject
A ServerEndpoint bemeneti objektuma, normál esetben áthalad a csővezetéken.
