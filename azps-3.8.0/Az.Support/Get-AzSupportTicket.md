...
### 3. példa: az első 2 támogatási jegy állapota szerinti szűrés
```powershell
...
### 3. példa: az összes olyan támogatási jegy beszerzése, amely nyitott állapotban van, és a DEC 20th után jön létre, 2019
```powershell
