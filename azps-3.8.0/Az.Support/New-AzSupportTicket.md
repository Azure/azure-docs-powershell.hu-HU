...
### 15 példa: támogatási jegy létrehozása a CustomerContactDetail objektum helyett az egyes ügyfél-kapcsolatfelvételi paraméterek megadásával. 
```powershell
...
### 16. példa: támogatási jegy létrehozása az Azure 24 x 7 válaszára vonatkozó kéréssel 
```powershell
