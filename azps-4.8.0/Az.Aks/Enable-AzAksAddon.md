...
Engedélyezze a bővítményeket, `HttpApplicationRouting` `Monitoring` `AzurePolicy` `VirtualNode` és `KubeDashboard` az AK-ot.
...
### -WorkspaceResourceId
A megfigyelési munkaterület erőforrás-azonosítója.
