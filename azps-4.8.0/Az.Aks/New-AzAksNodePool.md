...
### Node Pool létrehozása alapértelmezett paraméterekkel
```powershell
...
### -ClusterObject
Adja meg azt a fürtcsomópont-objektumot, amelybe csomópontot szeretne létrehozni.
...
### -Force
Node Pool létrehozása akkor is, ha már létezik
...
### -OsType
A OsType az operációs rendszer típusának megadására használható.
Válasszon a Linux és a Windows közül.
A Linux alapértelmezett értéke.
...
A kis prioritású virtuális gép ScaleSetEvictionPolicy a kilakoltatási házirend megadására használható.
Alapértelmezés szerint törölni kell.
...
### -ScaleSetPriority
A virtuálisgép-készlet prioritásának megadására szolgáló ScaleSetPriority.
...
### -VmSetType
Egy csomópont-gyűjtő típusait jelöli.
A lehetséges értékek a következők: "VirtualMachineScaleSets", "AvailabilitySet"
