...
## Áttekintés
Műveleti szabály létrehozása vagy módosítása.
...
## Leírás
**Set-AzActionRule** létrehoz vagy frissít egy műveleti szabályt.
...
Ez a parancsmag műveleti szabályt hoz létre az előfizetések hatóköréhez.
...
Ez a parancsmag egy műveleti szabályt hoz létre a műveletek csoport számára, az erőforráscsoport hatókörével.
...
Ez a parancsmag műveleti szabályt hoz létre a diagnosztika beállításaihoz az erőforrás-hatókörökkel.

## PARAMÉTEREK

### -ActionGroupId
A műveleti csoport azonosítóját, amelyet értesíteni kell.
...
### -ActionRuleType
Műveleti szabály JSON formátum
...
Várható formátum – { \<operation\> : \<comma separated list of values\> } például.
Eredménye:/előfizetések/ad825170-845c-47db-8f00-11978947b089/resourceGroups/abvarma/Providers/Microsoft. ininsights/metricAlerts/teszt-mrmc-VM-abvarma
...
### -ReccurenceType
Adja meg, hogy mennyi ideig legyen érvényes a Letiltás.
...
### -ReccurentValue
Reccurent-értékek (ha szükséges) Heti- \[ 1, 2, \] havonta- \[ 1, 3, 5, 30 esetén\]
...
### -SuppressionEndTime
Letiltási befejezési idő
A 12/09/2018 06:00:00 + formátumot csak egyszer, naponta, hetente vagy havonta kell megemlíteni a Reccurent elfogadási ütemezésekor.
...
Várható formátum – { \<operation\> : \<comma separated list of values\> } például.
Tartalma: virtuális gépek, tárolási fiók
