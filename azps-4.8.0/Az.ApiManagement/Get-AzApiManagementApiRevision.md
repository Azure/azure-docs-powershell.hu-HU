...
## Leírás
A **Get-AzApiManagementApiRevision** PARANCSMAG az API összes korrektúrájának részleteit kapja meg.

## Példák

### Példa 1: az API minden API-változatának beolvasása
```powershell
...
Ez a parancs beilleszti a megadott API-t az API bizonyos ApiManagement-környezetbe.

## PARAMÉTEREK

### -ApiId
Az API-azonosító, amelynek a korrektúráit meg szeretné jeleníteni.
...
### Microsoft. Azure. Command. ApiManagement. ServiceManagement. models. PsApiManagementApiRevision
