...
## Leírás
A **Get-AzApiManagementAuthorizationServerClientSecret** parancsmag az Azure API-kezelés engedélyezési kiszolgálójának az ügyfél titkát kapja.

## Példák

### Példa 1: meghatározott engedélyezési kiszolgáló-ügyfél titkos azonosítójának beszerzése
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Ez a parancs a megadott engedélyezési kiszolgáló titkát kapja.
...
### -ResourceId
Az engedélyezési kiszolgáló ARM erőforrás-azonosítója.
Ha meg van adva, az azonosító alapján megpróbálja megtalálni az engedélyezési kiszolgálót.
Ehhez a paraméterhez szükség van.
...
Ha meg van adva az engedélyezési kiszolgáló, az azonosító alapján.
...
### Microsoft. Azure. Command. ApiManagement. ServiceManagement. models. PsApiManagementClientSecret
