...
## Leírás
A **Get-AzApiManagementCertificate** parancsmag minden olyan Azure API-kezelési tanúsítványt vagy tanúsítványt kap, amelyet Ön megadott.
...
### -ResourceId
A tanúsítvány ARM erőforrás-azonosítója. Ha meg van adva, a program megpróbálja megtalálni a tanúsítványt az azonosítóval. Ehhez a paraméterhez szükség van.
