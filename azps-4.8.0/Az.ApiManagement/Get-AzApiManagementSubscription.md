...
A billentyűk nem jelennek meg az eredmény részletei között. A kulcsok beszerzéséhez használja a **Get-AzApiManagementSubscriptionKey**.
...
### Példa 6: a termékek és a felhasználók összes előfizetésének beszerzése
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
