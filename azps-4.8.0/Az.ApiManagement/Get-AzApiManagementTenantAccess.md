...
## Leírás
A **Get-AzApiManagementTenantAccess** parancsmag a bérlői fiók hozzáférési konfigurációját kapja meg.
A billentyűk nem jelennek meg az eredmény részletei között. Az ügyfél titkának beszerzéséhez használja a **Get-AzApiManagementTenantAccessSecret**.
