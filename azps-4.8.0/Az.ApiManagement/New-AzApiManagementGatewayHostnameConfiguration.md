...
## Leírás
A **New-AzApiManagementGatewayHostnameConfiguration** parancsmag létrehoz egy gépnév configuratin a meglévő átjáróhoz.

## Példák

### Példa 1: a meglévő átjáró gépnév-konfigurációjának létrehozása
```powershell
...
Ez a parancs létrehoz egy "h01" gépnév-konfigurációt egy "G01" átjáróhoz.

## PARAMÉTEREK

### -CertificateResourceId
A meglévő tanúsítvány erőforrás-azonosítója. Ehhez a paraméterhez szükség van.
...
A hostname Confiuration új átjárójának azonosítója.
...
Jelölő a NegotiateClientCertificate érvényesítéséhez.
Ez a paraméter nem kötelező.
