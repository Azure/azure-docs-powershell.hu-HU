...
## Leírás
A **Remove-AzApiManagementGateway** parancsmag leválasztja az API-t egy átjáróról.
...
Ez a parancs eltávolítja a meglévő átjárót, és nem kéri a felhasználótól a megerősítést.
