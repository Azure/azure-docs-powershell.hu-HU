...
### 1. példa: egy app konfigurációs áruház kulcsának újragenerálása
```powershell
...
Ez a parancs újra létrehoz egy app konfigurációs áruház kulcsát.

### 2. példa: az App Configuration Store objektumának újragenerálása objektum szerint
```powershell
...
Ezzel a paranccsal létrehozhatja az App Configuration Store objektumának kulcsát.
...
### -Azonosító
Az újragenerálni kívánt kulcs azonosítója.
