...
### 1. példa: az App Configuration Store-név elérhetőségének tesztelése
...
Ez a parancs az App Configuration Store-név elérhetőségét teszteli.
...
### -Name (név)
Az elérhetőség ellenőrzésére szolgáló név.
...
### Microsoft. Azure. PowerShell. parancsmagok. AppConfiguration. modellek. Api20200601. INameAvailabilityStatus
