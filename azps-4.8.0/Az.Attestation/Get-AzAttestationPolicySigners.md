...
## Leírás
Az Get-AzAttestationPolicySigners parancsmag a megbízható házirend-aláírókat a bérlőtől kapja meg az Azure tanúsítványban.
...
Beolvassa a megbízható házirend-aláírókat a hitelesítő adatszolgáltató *pshtest* a *PSH-teszt-RG* csoportba.  Felhívjuk a figyelmét arra, hogy a tanúsítvány-szolgáltatónak nincs megbízható aláírója.
...
Beolvassa a megbízható házirend-aláírókat a hitelesítő adatszolgáltató *pshtest2* a *PSH-teszt-RG* csoportba.  Felhívjuk a figyelmét arra, hogy a tanúsítvány-szolgáltatónak egy megbízható aláírója van.
...
Beolvassa a megbízható házirend-aláírókat az igazolási alapértelmezett szolgáltatónál a *Közép-amerikai* helyen.  Felhívjuk a figyelmét arra, hogy nincsenek megbízható aláírók a tanúsítványok alapértelmezett szolgáltatói számára.
...
### -DefaultProvider
Ez a beállítás az alapértelmezett tanúsítvány-szolgáltató kérése.
...
### -Hely
Az alapértelmezett tanúsítvány-szolgáltató helyét adja meg.
...
### -Name (név)
A tanúsítvány-szolgáltató nevét adja meg.
...
### Microsoft. Azure. commands. igazolás. models. PSPolicySigners
