...
## Leírás
Az Set-AzAttestationPolicy parancsmag az Azure-tanúsítványban lévő bérlői fiókra állítja be a házirendet.
...
A felhasználó által definiált házirend beállítása a TEE Type *SgxEnclave* a tanúsítvány-szolgáltató *pshtest* szöveges házirend-formátummal (alapértelmezett).
...
Beállítja a felhasználó által definiált házirendet a TEE Type *SgxEnclave* a hitelesítő szolgáltató *pshtest* a JWT házirend-formátum használatával.
...
Ez a parancsmag a fenti paraméter által megadott bérlői tanúsítvány-házirendet határozza meg.
...
### -Házirend
Megadja a beállítani kívánt házirend-dokumentumot.  A házirend-formátum lehet szöveges vagy JSON webes jogkivonat (JWT).
...
### -PolicyFormat
A házirend formátumát adja meg szöveg vagy JWT (JSON web token) esetén.  Az alapértelmezett házirend-formátum a szöveg.
...
A következő négy típusú környezet támogatott: SgxEnclave, OpenEnclave, CyResComponent és VBSEnclave.
