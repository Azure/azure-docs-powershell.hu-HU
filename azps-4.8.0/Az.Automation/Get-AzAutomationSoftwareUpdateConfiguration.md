...
## Leírás
A Get-AzAutomationSoftwareUpdateConfiguration a szoftverfrissítési konfigurációk listáját számítja ki. Ha egy bizonyos szoftverfrissítés-konfigurációt szeretne beszerezni, adja meg a Name (név) paramétert. Azt is megteheti, hogy az Azure Resource id for this Virtual Machine rendszerhez megadhatja a szoftverfrissítési konfigurációkat, amelyek az Azure Virtual Machine-t célozzák meg.
