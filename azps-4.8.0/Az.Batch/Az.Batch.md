...
# Az.BatCH modul
## Leírás
Az Azure-modul Azure-köteg parancsmagja lehetővé teszi a Microsoft Azure batch Services kezelését az Azure PowerShell-ban.
...
Letilt egy kötegelt feladatok ütemezését.
...
A kötegelt fiókokat összegző statisztikaként kapja meg.
...
### [Új – AzBatchResourceFile](New-AzBatchResourceFile.md)
...
Egy köteg fiók eltávolítása.

### [Remove-AzBatchApplication](Remove-AzBatchApplication.md)
Egy alkalmazást töröl egy köteg fiókból.

### [Remove-AzBatchApplicationPackage](Remove-AzBatchApplicationPackage.md)
Egy alkalmazáscsomag-rekord és a bináris fájl törlése

### [Remove-AzBatchCertificate](Remove-AzBatchCertificate.md)
Tanúsítvány törlése egy fiókból.
