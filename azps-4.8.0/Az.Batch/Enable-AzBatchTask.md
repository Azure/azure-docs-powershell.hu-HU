...
## Leírás
Az **enable-AzBatchTask** parancsmag újraaktiválja a feladatot.
...
Ez a parancs azt a kötegelt feladatot kapja meg, amely a Task3 azonosítóval rendelkezik, és az Get-AzBatchTask parancsmagot használja.
