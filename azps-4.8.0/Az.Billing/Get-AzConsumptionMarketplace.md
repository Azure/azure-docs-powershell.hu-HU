...
## Leírás
A **Get-AzConsumptionMarketplace** parancsmag az előfizetés piacait kapja.

## Példák

### Példa 1: a piactérek használatának beszerzése
```powershell
...
### 2. példa: a piactér kihasználtságának beszerzése dátumtartomány használatával
```powershell
...
### 3. példa: a piactér BillingPeriodName beszerzése
```powershell
...
### 4. példa: a piactér használatát a példánynév szűrővel érheti el
```powershell
...
### -BillingPeriodName
Egy adott számlázási időszak neve, amely a hozzárendelni kívánt piactért kapja meg.
...
### -EndDate
A szűrni kívánt piacok záró dátuma (UTC-ben).
...
### -InstanceId
A szűrni kívánt piacok példányának azonosítója.
...
### -Példánynév
A szűrni kívánt piacok példányának neve.
...
### -ResourceGroup
A szűrni kívánt piacok erőforrás csoportja.
...
### -StartDate
A szűrni kívánt piacok kezdési dátuma (UTC-ben)
...
### Microsoft. Azure. commands. fogyasztás. models. PSMarketplace
