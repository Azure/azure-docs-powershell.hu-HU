...
### 1. példa: Blockchain-konzorciumok beszerzése
```powershell
PS C:\> Get-AzBlockchainConsortium -Location eastus

```

Ez a parancs felsorolja a konzorciumokat egy adott helyre szóló előfizetésben.
...
### Microsoft. Azure. PowerShell. parancsmagok. Blockchain. modellek. Api20180601Preview. IConsortium
