...
### 1. példa: a Transaction Node API-kulcsának újragenerálása név használatával.
```powershell
...
Ez a parancs API-kulcsokat hoz létre a tranzakciós csomópontokhoz név, erőforráscsoport használatával.

### 2. példa: a tranzakciós csomópont API-kulcsának újragenerálása
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
Ez a parancs API-kulcsokat hoz létre a Transaction Node-hoz a idenity használatával.
