...
### Példa 1: annak ellenőrzése, hogy elérhető-e az erőforrás neve
```powershell
...
A parancs azt ellenőrzi, hogy elérhető-e az erőforrás neve.

### 2. példa: annak ellenőrzése, hogy elérhető-e az erőforrás neve
```powershell
...
### -Name (név)
Beolvassa vagy beállítja az ellenőrizendő nevet.
...
### -Type (típus)
Az ellenőrizendő erőforrás típusa vagy típusának megadása
...
### Microsoft. Azure. PowerShell. parancsmagok. Blockchain. modellek. Api20180601Preview. INameAvailability
