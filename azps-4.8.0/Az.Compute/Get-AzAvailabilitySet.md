...
Ez a parancs beolvassa a AvailabilitySet03 nevű ResourceGroup11 nevű erőforrás-csoport elérhetőségi készletét.
...
### 3. példa: az összes elérhetőségi halmaz beolvasása szűréssel
```
...
Ez a parancs a "AvailabilitySet0" kezdetű ResourceGroup11 nevű erőforráscsoport elérhetőségi készleteit kapja meg.

### Példa 4: az összes elérhetőségi halmaz beszerzése a AvailabilitySet0 kezdődő névvel
```
...
Ez a parancs a "AvailabilitySet0" kezdetű elérhetőségi készleteket kapja meg.
