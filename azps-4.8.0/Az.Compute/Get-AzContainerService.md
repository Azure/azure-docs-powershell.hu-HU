...
## Leírás
A **Get-AzContainerService** parancsmag tároló szolgáltatást kap.
...
### 2. példa: az összes tároló szolgáltatás beszerzése
```
...
Ez a parancs beilleszti az előfizetésben az összes tároló szolgáltatást.

### 3. példa: az összes tároló szolgáltatás beolvasása az erőforrás csoportban
```
...
Ez a parancs a ResourceGroup17 minden tároló szolgáltatását bekapja.

### Példa 4: az összes tároló szolgáltatás beszerzése szűrő használatával
```
...
Ez a parancs a "CSResourceGroup1" kezdetű összes tároló szolgáltatást megkapja.
