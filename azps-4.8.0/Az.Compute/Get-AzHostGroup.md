...
## Leírás
Ez a parancsmag egy állomás-csoportot fog kapni.
Ez a parancsmag az erőforráscsoport összes állomását is felsorolja, ha nem adja meg a Host Name (állomásnév) nevet.
Ez a parancsmag az előfizetésben szereplő összes állomást is felsorolja, ha a csoport neve vagy az erőforráscsoport neve sem szerepel a csoportban.
...
Ez a parancs egy állomás-csoportot ad eredményül.
...
Ez a parancs a megadott erőforráscsoport összes Host-csoportját visszaadja.
...
Ez a parancs az előfizetésben szereplő összes állomás-csoportot visszaállítja.
...
### -InstanceView
Bontsa ki a visszaadott objektumot az állomás példányának nézeteit is felsorolva. 
