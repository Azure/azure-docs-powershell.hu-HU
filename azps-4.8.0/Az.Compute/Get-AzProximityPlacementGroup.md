...
## Leírás
Ez a parancsmag beolvassa vagy listázhatja a közelségi hely erőforrás (oka) t.
...
Ez a parancs a közelségi elhelyezés csoportba kerül
...
Ebben a parancsban a megadott erőforráscsoport alatti közelségi elhelyezési csoportok jelennek meg.
...
Ez a parancs az előfizetésben az összes Proximity-elhelyezési csoportot felsorolja.

## PARAMÉTEREK

### -ColocationStatus
Egy erőforrás helybeli állapotát jeleníti meg a közelségi hely csoportban.
