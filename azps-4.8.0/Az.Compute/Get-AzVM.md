...
## Leírás
A **Get-AzVM** parancsmag az Azure Virtual Machine modell nézetét vagy a példány nézetét kapja meg.
...
Adja meg az *állapot* paramétert úgy, hogy a virtuális gép példány nézetét az alapértelmezettként használt modell nézet helyett kapja meg.
...
### Példa 6: az összes virtuális gép beszerzése szűréssel
```
...
Ez a parancs a "teszt" kezdetű virtuális gépeket kapja meg az előfizetésben.
