...
## Leírás
A **New-AzAvailabilitySet** parancsmag egy Azure elérhetőségi készletet hoz létre.

## Példák

### Példa 1: elérhetőségi halmaz létrehozása
```
PS C:\> New-AzAvailabilitySet -ResourceGroupName "ResourceGroup11" -Name "AvailabilitySet03" -Location "West US"
```

Ez a parancs létrehoz egy AvailabilitySet03 nevű elérhetőségi készletet az ResourceGroup11 nevű erőforráscsoport-csoportban.
...
### -Hely
Az elérhetőségi halmaz helyét adja meg.
...
A platform hibás tartományának számát adja meg.
...
A platform Update domain count (platform frissítése) beállítás.
...
Annak a közelségi helynek az erőforrás-azonosítója, amellyel az elérhetőségi készlet használható.
...
- Igazítás: felügyelt lemezek esetén
...
### -Címke
A kulcs-érték párok a hash-táblázatok formájában.
