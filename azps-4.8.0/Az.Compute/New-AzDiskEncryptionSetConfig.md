...
A kulcs-tárolóban az adott aktív kulcs segítségével hozza létre a Lemezkezelés bővítményt.
...
### -EncryptionType
Ezzel a beállítással megadhatja a lemez titkosítási beállításának titkosítási típusát. A rendelkezésre álló értékek a következők: "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey".
...
### -KeyUrl
Az aktív kulcsra mutató URL-cím a betárcsázón
...
### -SourceVaultId
Az aktív kulcsot tartalmazó kulcskezelő erőforrás-azonosítója.
