...
Hozzon létre egy képgyűjteményt a képfájlok titkosításával.
...
### -DataDiskImage
Data Disk images.   például @ {Source = @ {ID =<source_id>}; LUN = 1; SizeInGB = 100; HostCaching = "ReadOnly"}
...
### -OSDiskImage
OS Disk Image (például @ {Source = @ {ID =<source_id>}; SizeInGB = 100; HostCaching = "ReadOnly"}
...
A gyűjtemény képének befejezési dátuma.
...
Ha be van állítva, akkor a kép definíciójának legújabb verziójáról telepített virtuális gépek nem fogják használni ezt a képváltozatot.
...
### -ReplicaCount
Az régiónként létrehozandó képverzió replikáinak száma.
...
### -SourceImageId
Annak a forrásnak az azonosítója, amelyből a kép verziója lesz létrehozva.
...
### -StorageAccountType
A kép tárolásához használandó tárterület-típust adja meg. Ez a tulajdonság nem frissíthető. A rendelkezésre álló értékek a Standard_LRS, a Standard_ZRS és a Premium_LRS.
...
### -TargetRegion
Azok a célterületek, amelyekben a képváltozatot replikálni fogja.
...
### Microsoft. Azure. commands. számítási. Automation. models. PSGalleryImageVersion
