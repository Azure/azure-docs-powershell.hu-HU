...
## Leírás
Ez a parancsmag létrehoz egy állomást.
...
Ezzel a paranccsal létrehozhatja a megadott SKU egy állomását a megadott Host-csoportban és az adott helyen.
...
Annak megadása, hogy az állomást meghibásodás esetén automatikusan kell-e cserélni. Az érték alapértelmezés szerint "true", ha nincs megadva.
...
### -LicenseType
Azt a szoftverlicenc-típust adja meg, amelyet az állomáson telepített VMs-szolgáltatónál alkalmazni fog. Lehetséges értékek: nincs, Windows_Server_Hybrid és Windows_Server_Perpetual.  Az alapértelmezett érték a nincs.
...
### -PlatformFaultDomain
Az állomás platform-meghibásodási tartományának számát adja meg.  Ezután a minimális érték 0, a maximális érték pedig 2.
...
### Microsoft. Azure. commands. számítási. Automation. models. PSHost
