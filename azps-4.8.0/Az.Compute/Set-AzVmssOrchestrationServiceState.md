...
Ez a parancs felfüggeszti az automatikus javítási szolgáltatást az "vmss1" VMSS "RG" erőforráscsoport esetén.
...
Ez a parancs a "RG" erőforráscsoport "vmss1" VMSS automatikus javítási szolgáltatást folytat.

## PARAMÉTEREK

### -Műveletek
A végrehajtandó művelet.  Lehetséges értékek: önéletrajz, felfüggesztés.
...
### -InputObject
A virtuális gép léptéke beállítás helyi objektuma.
