...
## Áttekintés
API egy új K8s-fürt regisztrálásához, és ezáltal egy követett erőforrás létrehozása a KARJÁN
...
### Példa 1: összekapcsolt kubernetes létrehozása
```powershell
...
A parancs létrehoz egy csatlakoztatott kubernetes.

### Példa 1: összekapcsolt kubernetes létrehozása paraméterekkel a kubeConfig és a kubeContext
```powershell
...
Ez a parancs létrehoz egy csatlakoztatott kubernetes paramétereket a kubeConfig és a kubeContext.
...
### -KubeContext
Kubconfig környezet az aktuális számítógépről
...
### -ResourceGroupName
Annak az erőforráscsoportnek a neve, amelyhez a kubernetes-fürtöt regisztrálták.
...
### -SubscriptionId
Annak az előfizetésnek az azonosítója, amelyhez a kubernetes-fürtöt regisztrálták.
