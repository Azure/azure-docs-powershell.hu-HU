...
## Áttekintés
Ha törölni kíván egy csatlakoztatott fürtöt, távolítsa el a követett erőforrást az Azure Resource Manager (ARM) alkalmazásban.
...
### 1. példa: csatlakoztatott kubernetes eltávolítása
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Ez a parancs eltávolítja a csatlakoztatott kubernetes

### 2. példa: összekapcsolt kubernetes objektum eltávolítása
```powershell
...
Ez a parancs eltávolítja az objektum által összekapcsolt kubernetes
