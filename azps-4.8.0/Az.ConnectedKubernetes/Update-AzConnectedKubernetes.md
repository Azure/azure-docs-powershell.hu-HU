...
### Példa 1: összekapcsolt kubernetes frissítése
```powershell
...
Ez a parancs frissíti a csatlakoztatott kubernetes.

### 2. példa: összekapcsolt kubernetes frissítése objektum szerint
```powershell
...
Ez a parancs az objektum által összekapcsolt kubernetes frissíti.
