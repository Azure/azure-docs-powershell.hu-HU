...
A bővítmény eléréséhez használandó művelet

### [Új – AzConnectedMachineExtension](New-AzConnectedMachineExtension.md)
A bővítmény létrehozásának vagy frissítésének művelete.

### [Remove-AzConnectedMachine](Remove-AzConnectedMachine.md)
A hibrid gép identitásának eltávolítására szolgáló művelet az Azure-ban.
