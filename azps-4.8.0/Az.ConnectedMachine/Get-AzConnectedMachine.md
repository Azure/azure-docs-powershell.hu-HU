...
## Áttekintés
Információt keres a modell nézetről vagy egy hibrid gép példány nézetéről.
...
### 1. példa: az előfizetésben lévő összes csatlakoztatott gép listázása
```powershell
...
Az előfizetésben lévő összes csatlakoztatott gép felsorolása.
Ha az előfizetés nincs megadva, az előfizetést az aktuális Azure PowerShell-környezetből fogja használni.

### 2. példa: az erőforráscsoport összes csatlakoztatott számítógépének listázása
```powershell
...
Az erőforráscsoport összes csatlakoztatott számítógépének listázása

### 3. példa: csatlakoztatott gép beszerzése egy erőforrás-csoportban név szerint
```powershell
...
Az erőforráscsoport csatlakoztatott számítógépének beszerzése név szerint
...
### – Kibontás
A művelethez alkalmazni kívánt kifejezés kibontása.
...
### Microsoft. Azure. PowerShell. parancsmagok. ConnectedMachine. modellek. Api20200802. IMachine
