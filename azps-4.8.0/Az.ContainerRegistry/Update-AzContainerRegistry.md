...
## Leírás
A Update-AzContainerRegistry parancsmag frissíti a tároló rendszerleíró adatbázisát.
...
Ez a parancs beállítja a megadott tároló beállításjegyzékét, hogy egy meglévő tárolási fiókot \` mystorageaccount \` az előfizetésben.
...
Például: @ {key0 = "value0"; key1 = $null; azonosító2 = "érték2"}
