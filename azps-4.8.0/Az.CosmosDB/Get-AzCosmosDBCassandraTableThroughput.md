...
## Áttekintés
Megkapja a Cassandra (Cassandra) táblázat átviteli értékét.
...
## Leírás
A **Get-AzCosmosDBCassandraTableThroughput** parancsmag az adott térköznek megfelelő átviteli objektumot kapja.
