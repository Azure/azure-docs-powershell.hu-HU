...
## Áttekintés
Megkapja a CosmosDB Gremlin gráfot.
...
## Leírás
A **Get-AzCosmosDBGremlinGraph** parancsmag a CosmosDB Gremlin diagram tulajdonságait kapja.
...
Az erőforrás-objektum IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etagt tartalmaz.
