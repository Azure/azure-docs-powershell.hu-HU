...
## Áttekintés
Beolvassa a CosmosDB táblázatot.
...
## Leírás
A **Get-AzCosmosDBTable** parancsmag meglévő táblát kap.
...
Az erőforrás-objektum a táblázat _rid, _ts, _ ETAG tulajdonságait tartalmazza.
