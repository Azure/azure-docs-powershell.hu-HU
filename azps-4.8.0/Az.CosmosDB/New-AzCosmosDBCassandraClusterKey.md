...
## Áttekintés
Új CosmosDB Cassandra cluster billentyűt hoz létre.
...
## Leírás
A **New-AzCosmosDBCassandraClusterKey** létrehoz egy új CosmosDB Cassandra cluster kulcsot.
...
### -OrderBy
A cluster kulcs elrendelése.
A lehetséges értékek a következők: "ASC", "desc"
...
### Microsoft. Azure. Command. CosmosDB. models. PSClusterKey
