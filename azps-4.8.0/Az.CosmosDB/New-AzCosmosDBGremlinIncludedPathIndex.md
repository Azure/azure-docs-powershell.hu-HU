...
## Áttekintés
Új PSIndexes típusú objektum létrehozása A set-AzCosmosDBGremlinIncludedPath paraméter értéke lehet.
...
## Leírás
Az Gremlin API IncludedPath's indexének megfelelő objektum.
