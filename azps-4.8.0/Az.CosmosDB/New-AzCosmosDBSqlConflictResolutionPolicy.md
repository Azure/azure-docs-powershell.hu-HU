...
## Áttekintés
Új PSSqlConflictResolutionPolicy típusú objektum létrehozása A set-AzCosmosDBSqlContainer paraméter értéke lehet.
...
## Leírás
Az SQL API ConflictResolutionPolicy megfelelő objektum.
