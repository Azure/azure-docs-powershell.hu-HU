...
## Áttekintés
Új PSIndexes típusú objektum létrehozása A set-AzCosmosDBSqlIncludedPath paraméter értéke lehet.
...
## Leírás
Az SQL API IncludedPath's indexének megfelelő objektum.
...
A lehetséges értékek a következők: "string", "szám", "pont", "sokszög", "LineString", "multisokszög"
...
### -Kind
Az index típusát adja meg.
A lehetséges értékek a következők: "hash", "méréstartomány", "térbeli"
...
### Microsoft. Azure. Command. CosmosDB. models. PSIndexes
