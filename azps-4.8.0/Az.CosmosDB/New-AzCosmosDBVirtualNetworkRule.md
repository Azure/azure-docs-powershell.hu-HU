...
### -Azonosító
Egy alhálózat erőforrás-azonosítója, például:/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
...
Logikai érték, amely azt jelzi, hogy a virtuális hálózat vnet-szolgáltatás végpontja engedélyezve van-e a tűzfalszabályok létrehozásához.
...
### Microsoft. Azure. Command. CosmosDB. models. PSVirtualNetworkRule
