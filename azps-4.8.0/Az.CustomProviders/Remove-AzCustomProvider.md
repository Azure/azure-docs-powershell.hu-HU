...
### Példa 1: egyéni szolgáltató eltávolítása.
```powershell
...
### 2. példa: egyéni szolgáltató eltávolítása a PassThru
```powershell
...
Egyéni szolgáltató eltávolítása a PassThru funkció használatával a siker vagy a kudarc jelzésére.
