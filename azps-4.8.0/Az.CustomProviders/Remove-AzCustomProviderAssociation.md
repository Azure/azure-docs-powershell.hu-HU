...
### 1. példa: egyéni szolgáltatói társítás eltávolítása.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Egyéni szolgáltatói társítás eltávolítása.

### 2. példa: egyéni szolgáltatói társítás eltávolítása csővezetékekkel
```powershell
...
Az egyéni szolgáltatói társítás eltávolítása a csővezetékek és a PassThru funkció segítségével a siker vagy a kudarc jelzéséhez.
