...
## Leírás
A **Get-AzDataBoxEdgeRole** parancsmag lekérdezi az IoT-szerepköröket az adatmező szélén lévő eszközön. Megemlítheti a Name (név) paramétert egy adott IoT szerepkör részleteinek megadásához.
