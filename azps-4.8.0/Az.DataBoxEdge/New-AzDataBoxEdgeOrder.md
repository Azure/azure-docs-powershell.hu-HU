...
## Leírás
A **New-AzDataBoxEdgeOrder** parancsmag új sorrendet hoz létre az adatmező Edge-eszközéhez. A rendelés létrehozása előtt először létre kell hozva egy adatmező-Edge-erőforrást. Megadhatja, hogy miként hozhatja létre a sorrendet a partnerek, a cégnév, az e-mailek, a cím stb.
