...
## Leírás
A **Start-AzDataFactoryV2Trigger** parancsmag elindítja az indítót az adatgyárban. Ha az indító a "leállt" állapotban van, a parancsmag elindítja az indítót, és az előbbi a futószalagokat a definíciója alapján hívja fel. Ha az indító már a "Started" állapotban van, ez a parancsmag nincs befolyással. Ha meg van adva az erő paraméter, a parancsmag nem jelenik meg az indítás megkezdése előtt.

## Példák

### 1. példa: trigger indítása
```
...
Elindítja az "WikiADF" Data Factory "ScheduledTrigger" nevű triggert.
