...
## Leírás
A **Restore-AzDataLakeStoreDeletedItem** parancsmag visszaállítja a törölt fájlokat vagy mappákat az Adattó áruházban. A AzDataLakeStoreDeletedItem a törölt elemek elérési útját igényli a kukában.
