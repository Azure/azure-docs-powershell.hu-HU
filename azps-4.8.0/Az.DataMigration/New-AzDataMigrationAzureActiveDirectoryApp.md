...
## Áttekintés
Új példány létrehozása DataMigration Azure ActiveDirectory Application details.
...
```
ApplicationId: "a AppId/Service Principal id" AppKey: System. Security. SecureString bérlői azonosító megkeresése: "bérlői azonosító"

## PARAMÉTEREK

### -AppKey
Azure Active Directory-kulcs
...
### Microsoft. Azure. Command. DataMigration. models. PSAzureActiveDirectoryApp
