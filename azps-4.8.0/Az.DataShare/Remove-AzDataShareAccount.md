...
## Leírás
A **Remove-AzDataShareAccount** parancsmag eltávolítja a DataShare-fiókot.
...
Ez a parancs eltávolítja a WikiADS nevű DataShare-fiókot a ADS nevű erőforráscsoport nevében.
...
### -InputObject
Az Azure Data Share-fiók objektuma.
