...
## Leírás
A **Remove-AzDataShareTrigger** parancsmag eltávolítja a DataShare-triggert
...
Ez a parancs eltávolítja a AdsTrigger nevű triggert az előfizetés megosztása AdsShareSubscription. 
...
### -InputObject
Azure Data Share trigger objektum
...
### -ResourceId
Az Azure Data Share trigger erőforrás-azonosítója
