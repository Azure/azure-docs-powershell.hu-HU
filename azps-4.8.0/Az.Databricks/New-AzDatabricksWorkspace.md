...
### Példa 1: Databricks-munkaterület létrehozása
```powershell
...
Ez a parancs létrehoz egy Databricks-munkaterületet.

### 2. példa: Databricks-munkaterület létrehozása testreszabott virtuális hálózattal
```powershell
...
Ez a parancs létrehoz egy Databricks-munkaterületet egy erőforrás-csoportban testre szabott virtuális hálózattal.

### 3. példa: Databricks munkaterület létrehozása a titkosítás engedélyezésével
```powershell
...
Ez a parancs létrehoz egy Databricks-munkaterületet, és a titkosításra való felkészülésre állítja be.
További információt a titkosítással kapcsolatos további beállítások Update-AzDatabricksWorkspace című témakörben találhat.
...
### -PrivateSubnetName
A virtuális hálózatban lévő privát alhálózat neve.
...
### -PublicSubnetName
A virtuális hálózatban lévő nyilvános alhálózat neve.
...
Logikai érték, amely azt jelzi, hogy a DBFS-os gyökérszintű fájlrendszer engedélyezve van-e a másodlagos titkosítási réteggel a REST-alapú adatok platformon kezelt kulcsaival.
...
### -VirtualNetworkId
Annak a virtuális hálózatnak az azonosítója, amelyhez a Databricks-fürtöt létre kell tenni.
