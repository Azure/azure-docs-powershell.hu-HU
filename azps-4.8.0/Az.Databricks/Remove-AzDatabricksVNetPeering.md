...
## Áttekintés
Törli a munkaterület vNetPeering.
...
### Példa 1: a databricks vnetének eltávolítása név szerint
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Ez a parancs eltávolítja a databricks név szerinti vnet.

### 2. példa: vnet databricks eltávolítása objektumból
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Ez a parancs eltávolítja a databricks objektum szerinti vnet.
