...
### Példa 1: dedikált HSM létrehozása meglévő virtuális hálózatba
```powershell
...
A parancs létrehoz egy dedikált HSM-t egy meglévő virtuális hálózatba.

**Megjegyzés:** Jelenleg `New-AzDedicatedHsm` olyan korlátozással rendelkezik, amelyet a HSM teljes kiépítése előtt ad eredményül.
Miután létrehozott egy új HSM-t, kérjük, hogy az állapotának lekérdezése, `Get-AzDedicatedHsm` és győződjön meg róla, hogy az új HSM `Provisioning State` `Succeeded` .
...
### -Hely
A támogatott Azure-hely, ahol a dedikált HSM-t létre kell tenni.
...
### -NetworkInterface
A dedikált HSM-hez társított hálózati illesztők erőforrás-azonosítóinak listáját adja meg.
A kivitelezéshez tekintse meg a NETWORKINTERFACE tulajdonságainak megjegyzések szakaszát, és hozzon létre egy ujjlenyomat-táblázatot.
...
### -ResourceGroupName
Annak az erőforrás csoportnak a neve, amelyhez az erőforrás tartozik.
...
### -StampId
Ezt a mezőt akkor fogja használni a program, ha az RP nem támogatja az elérhetőségi zónákat.
...
### – NetI
A kar erőforrás-azonosítója/subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/... formájában
...
NETWORKINTERFACE <INetworkInterface [] >: a dedikált HSM-hez társított hálózati illesztők erőforrás-azonosítóinak listáját adja meg.
