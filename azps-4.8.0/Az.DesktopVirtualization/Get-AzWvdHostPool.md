...
### Példa 1: a Windows virtuális asztali HostPool beszerzése név szerint
```powershell
...
Ez a parancs egy erőforráscsoport Windows virtuális asztali HostPool kap.

### 2. példa: a Windows virtuális asztali HostPools listája
```powershell
...
Ez a parancs egy erőforráscsoport Windows virtuális asztali HostPools sorolja fel.
