...
### Példa 1: a Windows virtuális asztali regisztrációs token beszerzése
```powershell
...
Ez a parancs egy Windows virtuális asztali regisztrációs tokent kap egy alkalmazáskészletben.
...
### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. RegistrationInfo
