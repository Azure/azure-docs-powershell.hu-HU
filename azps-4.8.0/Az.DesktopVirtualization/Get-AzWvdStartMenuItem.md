...
### 2. példa: a Windows Virtual Desktop Start menü elemeinek listája
```powershell
...
Ez a parancs felsorolja a Windows Virtual Desktop Start menü elemeit egy alkalmazás-csoportban.
...
### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. IStartMenuItem
