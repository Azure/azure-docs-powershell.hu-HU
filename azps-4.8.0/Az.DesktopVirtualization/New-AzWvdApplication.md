...
### Példa 1: Windows virtuális asztali alkalmazás létrehozása
```powershell
...
Ez a parancs egy Windows virtuális asztali alkalmazást hoz létre egy alkalmazás-csoportban.

## PARAMÉTEREK

### -AppAlias
Az App alias a Start menüből
