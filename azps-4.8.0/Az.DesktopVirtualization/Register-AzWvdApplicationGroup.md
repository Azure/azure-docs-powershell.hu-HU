...
### 1. példa: egy Windows Virtual Desktop-alkalmazás regisztrálása
```powershell
...
Ez a parancs egy Windows virtuális asztali alkalmazás csoportját regisztrálja egy munkaterületre.

## PARAMÉTEREK

### -ApplicationGroupPath
ApplicationGroupPath elérési útja
