...
### Példa 1: a Windows virtuális asztali ApplicationGroup törlése név szerint
```powershell
PS C:\> Remove-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName -Name ApplicationGroupName
```

Ez a parancs törli a Windows virtuális asztali ApplicationGroup egy Erőforráscsoportben.
