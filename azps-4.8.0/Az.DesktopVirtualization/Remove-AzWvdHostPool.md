...
### Példa 1: a Windows virtuális asztali HostPool törlése név szerint
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Ez a parancs törli a Windows virtuális asztali HostPool egy Erőforráscsoportben.
...
### -Force
A sessionHost törléséhez jelölje be az erő jelölőt.
