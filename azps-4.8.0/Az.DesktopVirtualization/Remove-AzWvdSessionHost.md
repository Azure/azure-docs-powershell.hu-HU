...
### Példa 1: a Windows virtuális asztali SessionHost törlése név szerint
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Ez a parancs törli a Windows virtuális asztali SessionHost egy állomás-készletben.
...
### -Force
Kényszerített jelölő: a sessionHost törlésének kényszerítése akkor is, ha a userSession létezik.
