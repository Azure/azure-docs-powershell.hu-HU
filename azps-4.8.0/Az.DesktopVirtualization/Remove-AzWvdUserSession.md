...
### Példa 1: a Windows virtuális asztali UserSession törlése név szerint
```powershell
...
Ez a parancs törli a Windows virtuális asztali UserSession a munkamenet-állomáson.
...
### -Force
A userSession kikapcsolásához kényszerítse a jelölőt.
