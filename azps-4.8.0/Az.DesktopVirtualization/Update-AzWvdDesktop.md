...
### Példa 1: a Windows virtuálisasztal-asztal frissítése
```powershell
...
Ez a parancs frissíti a Windows rendszerbeli virtuális asztali számítógépét egy alkalmazás-csoportban.
