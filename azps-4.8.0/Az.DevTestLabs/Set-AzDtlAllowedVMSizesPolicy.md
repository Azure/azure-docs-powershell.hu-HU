...
## Leírás
A **set-AzDtlAllowedVMSizesPolicy** parancsmag az engedélyezett virtuálisgép-méretekre vonatkozó házirendet adja meg, amely a laboratóriumban engedélyezett virtuális gépek méreteit tartalmazza.
...
### -Letiltása
Jelzi, hogy ez a parancsmag letiltja a házirendet.
...
### – Engedélyezés
Jelzi, hogy ez a parancsmag engedélyezi a házirendet.
...
### -LabName
Annak a laboratóriumnak a neve, amelyhez a parancsmag a virtuális gép méretére vonatkozó házirendet állítja be.
...
### -VmSizes
Karakterláncként adja meg a laboratóriumban engedélyezett virtuális számítógép-méretek listáját.
