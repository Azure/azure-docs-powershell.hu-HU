...
A IoT-hub az Azure IoT hub-eszközök kiépítési szolgáltatása a AllocationWeight és a ApplyAllocationPolicy segítségével.
...
### -ApplyAllocationPolicy
Logikai érték, amely azt jelzi, hogy a felosztási házirendet alkalmazza-e az IoT-hubhoz
...
### Microsoft. Azure. Command. Management. DeviceProvisioningServices. models. PSIotHubDefinitions
