...
## Leírás
Megtudhatja, hogy milyen adatokat kell beszereznie a tanúsítványigénylési csoporttól, vagy listázhatja az összes beiratkozási csoportot egy Azure IoT hub-eszköz kiépítési szolgáltatása
...
Eszköztelepítési csoport beszerzése az Azure IoT hub eszköz kiépítési szolgáltatásában.
...
Az összes eszköz-igénylési csoport listázása az Azure IoT hub eszközök kiépítési szolgáltatásában.
...
### Microsoft. Azure. Command. Management. DeviceProvisioningServices. models. PSEnrollmentGroups []
