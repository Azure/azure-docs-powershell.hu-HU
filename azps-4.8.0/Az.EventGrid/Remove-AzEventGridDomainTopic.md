...
Eltávolítja az esemény rácsa \` téma1 a \` tartomány \` Domain1 \` az erőforráscsoport \` MyResourceGroupName \` .
...
### -ResourceId
Az Event Grid domain témakört megadó erőforrás-azonosító.
