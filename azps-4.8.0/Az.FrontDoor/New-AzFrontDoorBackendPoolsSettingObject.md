...
## Leírás
A **New-AzFrontDoorBackendpoolsSettingObject** parancsmag új PSBackendPoolsSettings objektumot hoz létre a bejárati ajtó létrehozásához.

## Példák

### 1. példa: BackendPoolsSettings-objektum létrehozása alapértelmezett beállításokkal
```powershell
...
### 2. példa: BackendPoolsSettings objektum létrehozása a felhasználó által megadott értékekkel
```powershell
...
Engedélyezi-e a tanúsítvány nevének érvényesítését HTTPS-kérések esetén az összes backend-készletre.
Nincs hatással a nem HTTPS-kérésekre.
...
Küldési és fogadási időtúllépés a háttérben való továbbítás kérése során. Az időtúllépés elérésekor a kérés nem sikerül, és a visszatérési érték.
...
### Microsoft. Azure. Command. FrontDoor. models. PSBackendPoolsSetting
