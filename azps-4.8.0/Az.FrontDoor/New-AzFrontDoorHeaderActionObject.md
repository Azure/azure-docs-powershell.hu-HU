...
## Leírás
Létrehozza a PSHeaderAction objektumot az PSRulesEngineAction objektum létrehozásához.
...
### -HeaderActionType
Milyen típusú manipulációt kell alkalmazni a fejlécre.
...
### -HeaderName
Annak a fejlécnek a neve, amelyet a művelet alkalmazni fog.
...
### -Value (érték)
Az az érték, amellyel frissítheti a megadott fejléc nevét.
Ezt az értéket a program nem használja, ha a actionType törlődik.
...
### Microsoft. Azure. Command. FrontDoor. models. PSHeaderAction
