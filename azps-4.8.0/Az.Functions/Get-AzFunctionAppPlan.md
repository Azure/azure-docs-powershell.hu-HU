...
### Példa 1: az összes függvény app-csomag beszerzése.
```powershell
...
Ez a parancs az összes függvény app-csomagot beilleszti.

### 2. példa: a Function app-csomagok beolvasása az erőforráscsoport nevével
```powershell
...
Ez a parancs az erőforráscsoport neve alapján válik elérhetővé az alkalmazásban.

### 3. példa: az adott előfizetéshez tartozó Function app-csomagok beszerzése.
```powershell
...
Ez a parancs a megadott előfizetésekhez tartozó alkalmazás-csomagokat kapja.

### 4. példa: a Function app csomagok beszerzése hely szerint.
```powershell
...
Ez a parancs hely szerint kapja meg az App-csomagok működését.
