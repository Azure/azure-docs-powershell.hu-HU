...
### 1. példa: az app-beállítások eltávolítása egy függvény alkalmazásban.
```powershell
...
Ez a parancs eltávolítja az App beállításait egy függvény alkalmazásban.

## PARAMÉTEREK

### -AppSettingName
A Function App alkalmazásból eltávolítandó Function app-beállítások listája.
...
### -Force
Kényszeríti a parancsmagot a Function app beállítás eltávolítására a megerősítés kérése nélkül.
