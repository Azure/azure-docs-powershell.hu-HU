...
## Leírás
Az **Add-AzHDInsightStorage** parancsmag az Azure Storage Account bejegyzését hozzáadja az New-AzHDInsightClusterConfig parancsmag által létrehozott Azure HDInsight Configuration objektumhoz.
