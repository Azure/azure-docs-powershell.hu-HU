...
Ez a parancs eltávolítja az SAP-figyelés példányát név szerint.

### 2. példa: az SAP-monitor példányának eltávolítása objektumból
```powershell
...
Ez a parancs eltávolítja az objektum által létrehozott SAP-monitor példányát.
