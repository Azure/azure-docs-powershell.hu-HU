...
### Példa 1: SAP-monitor frissítése név szerint
```powershell
...
Ezek a parancsok a SAP-monitorokat név szerint frissítik.

### 2. példa: SAP-monitor objektumon keresztüli frissítése
```powershell
...
Ezekkel a parancsokkal frissítheti az SAP-monitort objektum alapján.
