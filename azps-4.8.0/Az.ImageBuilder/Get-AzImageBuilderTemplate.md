...
### Példa 1: az összes sablon listázása az előfizetésben
```powershell
...
Ez a parancs az előfizetés alatti összes sablont felsorolja.

### 2. példa: az összes sablon listázása egy erőforráscsoport alatt
```powershell
...
Ez a parancs felsorolja az összes, erőforráscsoport alatti sablont.

### 3. példa: sablon beszerzése erőforráscsoport szerint
```powershell
...
Ez a parancs egy erőforráscsoport alatti sablont kap.

### Példa 4: az erőforráscsoport alatti sablon beszerzése
```powershell
