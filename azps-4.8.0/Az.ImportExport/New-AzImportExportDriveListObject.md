...
### Példa 1: új DriveList létrehozása a ImportExport feladatához
```powershell
...
Ezekkel a parancsmagokkal új DriveList hozhat létre a ImportExport-hoz.

## PARAMÉTEREK

### -BitLockerKey
A meghajtó titkosításához használt BitLocker-kulcs.
...
### -BytesSucceeded
A meghajtóhoz sikeresen átvitt bájtok száma.
...
### -CopyStatus
Az adatátviteli folyamatra vonatkozó részletes állapot
Ezt a mezőt addig nem adja vissza a válasz, amíg a meghajtó az átadó államban van.
...
### -DriveHeaderHash
A meghajtó fejlécének hash értéke.
...
### -DriveId
A meghajtó hardveres sorozatszáma szóközök nélkül.
...
### -ErrorLogUri
Az adatátviteli művelethez tartozó, a blobot tartalmazó URI-azonosító.
...
### -ManifestFile
A manifest-fájl relatív elérési útja a meghajtón.
...
### -ManifestHash
A manifest-fájl Base16 kódolt MD5 hash-je a meghajtón.
...
### -ManifestUri
Egy URI, amely a Drive manifest-fájlt tartalmazó blobra mutat.
...
A meghajtóhoz befejezett százalékos készültségi érték
...
### -VerboseLogUri
Egy URI, amely rámutat az adatátviteli művelet részletes naplóját tartalmazó blobra.
...
### Microsoft. Azure. PowerShell. parancsmagok. ImportExport. modellek. Api20161101. IDriveStatus
