...
Hozzon létre egy IoT-os központi alkalmazást a standard árképzési szint ST2 az erőforráscsoport területén.
...
Hozzon létre egy IoT-os központi alkalmazást a szokásos árképzési szint ST2 az "westus" tartományban, egyéni megjelenítendő névvel az IOTC-default sablon alapján.
