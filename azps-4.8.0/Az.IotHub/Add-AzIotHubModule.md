...
## Leírás
Hozzon létre egy modult egy cél IoT-eszközön, amelyen a IoT-hub különböző engedélyezési típusú.
...
Hozzon létre egy modult egy cél IoT-eszközön alapértelmezett engedéllyel (megosztott titkos kulccsal).
