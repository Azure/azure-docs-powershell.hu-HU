...
## Leírás
Új végpont felvétele a IoT-központban. A támogatott végpontokról további információt a következő témakörben talál: https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
Adjon hozzá egy új, "E2" EventHub a "myiothub" IoT hub-hoz.
...
Adjon hozzá egy új, "S1" AzureStorageContainer a "myiothub" IoT hub-hoz.

## PARAMÉTEREK

### -ConnectionString
Az útválasztási végpont kapcsolati karakterlánca
...
A végpont-erőforrás erőforrás csoportja
...
A végpont-erőforrás SubscriptionId
...
### -Encoding
Válassza ki, hogy milyen formátumban szeretné továbbítani az adatait. Kiválaszthatja a JSON vagy a AVRO. Az alapértelmezett beállítás a AVRO.
...
### Microsoft. Azure. Command. Management. IotHub. models. PSRoutingServiceBusQueueEndpoint

### Microsoft. Azure. Command. Management. IotHub. models. PSRoutingServiceBusTopicEndpoint

### Microsoft. Azure. Command. Management. IotHub. models. PSRoutingStorageContainerEndpoint
