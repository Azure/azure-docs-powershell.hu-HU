...
## Leírás
Megtudhatja, hogy miként szerezheti be a IOT hub-eszközök adatait, vagy egy IOT-hub összes eszközét felsorolhatja.
...
Az IOT-hub minden eszközének megjelenítése
...
Megtudhatja, hogy miként szerezheti be a IoT hub eszköz adatait.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDeszközökhöz []
