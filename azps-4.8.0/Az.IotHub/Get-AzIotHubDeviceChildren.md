...
## Leírás
Az összes hozzárendelt nem élű eszköz megjelenítése pontosvesszővel elválasztott listának az összes Edge-eszközön vagy megadott eszközön.
...
Pontosvesszővel tagolt listaként jelenítse meg az összes hozzárendelt nem él eszközt.
...
Az összes hozzárendelt nem élű eszköz megjelenítése pontosvesszővel elválasztott listának az összes Edge-eszközön.
