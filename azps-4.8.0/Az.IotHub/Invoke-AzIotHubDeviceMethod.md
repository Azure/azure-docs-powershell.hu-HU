...
## Leírás
Közvetlen módszer meghívása egy eszközön. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsTovábbi információt itt talál.
...
Eszköz metódusának meghívása

## PARAMÉTEREK

### -ConnectionTimeOut
A kapcsolat sikeres létrejöttének megvárni kívánt másodpercek száma.
...
### -Name (név)
Annak a módszernek a neve, amelyre hivatkozni szeretne az eszközön.
...
### -Hasznos teher
Az eszközre való hivatkozáshoz használt módszer tartalma.
...
### -ResponseTimeOut
Annak a másodpercnek a száma, ameddig az eredmény a közvetlen módszerrel érkezik.
Az alapértelmezett érték 10.
...
### Microsoft. Azure. Command. Management. IotHub. models. PSCloudToDeviceMethodResult
