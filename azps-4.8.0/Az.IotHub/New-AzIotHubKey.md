...
### Példa 1 az elsődleges kulcs újragenerálása
```
...
Az Azure IOT-hub "testKey" engedélyezési házirendjének regenerált elsődleges kulcsa.

### 2. példa kulcsok cseréje
```
...
Az Azure IOT-hub "testKey" engedélyezési házirendjének swapping billentyűi.
