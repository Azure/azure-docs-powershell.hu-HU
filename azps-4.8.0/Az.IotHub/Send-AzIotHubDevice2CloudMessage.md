...
## Leírás
A parancs támogatja az üzenetküldést az alkalmazás és a rendszer tulajdonságaival.
...
Eszköz küldése Felhőbeli üzenetbe alapértelmezett átviteli típus használatával.
...
### -Üzenet
Üzenet szövegtörzse, amelyet a IoT-hub-ba küld el.
...
### -TransportType
A használandó átviteli típus.
Az alapértelmezett érték a Amqp.
