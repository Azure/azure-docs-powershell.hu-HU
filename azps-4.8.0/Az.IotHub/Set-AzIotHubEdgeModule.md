...
## Leírás
A megadott modul konfigurációs tartalmát alkalmazza a megadott Edge-eszközre.
Megjegyzés: a végrehajtáskor a parancs megjeleníti az eszközre alkalmazott modulok gyűjteményét.
...
Tesztelje az Edge-modulokat a fejlesztés során, ha egy céleszköz moduljait állít be.
...
### -ModulesContent
A IoT moduljainak konfigurációs tartalma.
...
### Microsoft. Azure. Command. Management. IotHub. models. PSModules []
