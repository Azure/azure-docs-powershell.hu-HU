...
A memória tanúsítvány házirend-objektumát hozza létre. autogenerated
...
### 3. példa: tárgyi alternatív név (vagy SAN) tanúsítvány létrehozása
...
Ebben a példában egy 3 DNS-nevet tartalmazó SAN tanúsítvány jön létre.
...
### -DnsName
A tanúsítványban lévő DNS-neveket adja meg. A tárgyas helyettesítő nevek (SANs) DNS-névként adhatók meg.
...
> [!NOTE]
> Ha a paraméterben pontosvesszőt (,) vagy pontot (.) kell használnia `SubjectName` , a tulajdonságot idézőjelek közé kell tenni. Használhatja például az O = "contoso, Ltd." függvényt. a szervezet neve mezőben.
