...
## Áttekintés
A Hálózatfigyelő által beállított hálózati szabály frissítése
...
## Leírás
Az **Update-AzKeyVaultNetworkRuleSet** parancs a megadott kulcs boltozatára érvényes hálózati szabályokat frissíti. 
...
Ez a parancs frissíti a megadott IP-tartománnyal és a virtuális hálózat "myVault" nevű boltozatát, amely lehetővé teszi az Azure Services hálózati szabályának megkerülését.

### 2. példa

A Hálózatfigyelő által beállított hálózati szabály frissítése autogenerated
...
### -Kitérő
A hálózati szabály megkerülését adja meg.
...
### -DefaultAction
A hálózati szabály alapértelmezett működését adja meg.
...
### System. null ' 1 [[Microsoft. Azure. commands. PSKeyVaultNetworkRuleDefaultActionEnum. models., Microsoft. Azure. PowerShell. parancsmagok. Vault, Version = 1.0.0.0, Culture = semleges, PublicKeyToken = null]]

### System. null ' 1 [[Microsoft. Azure. commands. PSKeyVaultNetworkRuleBypassEnum. models., Microsoft. Azure. PowerShell. parancsmagok. Vault, Version = 1.0.0.0, Culture = semleges, PublicKeyToken = null]]
