...
## Áttekintés
Hozzon létre egy új Kubernetes-vezérlő konfigurációt.
...
### Példa 1: configuation létrehozása kubernetes-fürtökhöz
```powershell
...
Ez a parancs létrehoz egy configuation a kubernetes-alapú fürtökhöz.
...
### -ClusterScoped
Ha a hágó értékre állítja a konfiguráció hatókörét a cluster értékre (az alapértelmezett névtér).
...
### -EnableHelmOperator
A sisak-operátor beállításának engedélyezése a git konfigurációban.
...
Az értékek felülbírálják az operátor Helm-diagramját.
...
Az operátor élén álló diagram verziója.
...
Az operátor példányának neve – a konkrét konfiguráció azonosítása.
...
### -OperatorNamespace
Az a névtér, amelyre az operátor van telepítve.
Legfeljebb 253 (kisbetűs), kötőjel és pont.
...
### -OperatorParameters
Az operátori példány paraméterei karakterlánc formátumban.
...
### -RepositoryUrl
A SourceControl-tárház URL-címe.
