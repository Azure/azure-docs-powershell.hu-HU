...
### Példa 1: az összes követett adatbázis listázása
```powershell
...
A fenti parancs felsorolja az összes olyan adatbázist, amely a fürt tulajdonosa, és amelyet egy másik fürt követett.
...
### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. IFollowerDatabaseDefinition
