...
### Példa 1: adott adatbázis minden adatkapcsolatának listázása
```powershell
...
### 2. példa: konkrét adatkapcsolat beszerzése név alapján
```powershell
...
A fenti parancs visszaadott "mykustodataconnection" nevű adatkapcsolatot ad eredményül az "mykustodatabase" "testnewkustocluster" nevű "" nevű "" nevű "testrg" erőforráscsoporthoz tartozó "" nevű adatkapcsolatban.
