...
### Példa 1: az adatbázis összes PrincipalAssignment listázása névvel
```powershell
...
A fenti parancs visszaadott minden PrincipalAssignment a "mykustodatabase" adatbázisban, amely a "testnewkustocluster" szektorcsoportban található.

### 2. példa: meghatározott PrincipalAssignment beszerzése az adatbázisban név szerint
```powershell
...
A fenti parancs visszaadott minden "kustoprincipal1" nevű PrincipalAssignment az "mykustodatabase" nevű adatbázisban, amely a "testnewkustocluster" ("") szektorcsoportban található.
...
### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. IDatabasePrincipalAssignment
