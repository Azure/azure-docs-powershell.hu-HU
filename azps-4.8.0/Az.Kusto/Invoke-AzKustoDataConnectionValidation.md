...
### Példa 1: a EventHub-adatkapcsolat paramétereinek érvényesítése
```powershell
...
A fenti parancs ellenőrzi a "myeventhubdc" nevű EventHub-adatkapcsolatot az "mykustodatabase" nevű adatbázis "testnewkustocluster".

### 2. példa: az EventGrid-adatkapcsolat paramétereinek érvényesítése
```powershell
...
A fenti parancs ellenőrzi a "myeventgriddc" nevű EventGrid-adatkapcsolatot az "mykustodatabase" nevű adatbázis "testnewkustocluster".

### 3. példa: az IotHub-adatkapcsolat paramétereinek érvényesítése
```powershell
...
A fenti parancs ellenőrzi a "myiothubdc" nevű IotHub-adatkapcsolatot az "mykustodatabase" nevű adatbázis "testnewkustocluster".

### 4. példa: EventHub-adatkapcsolat paramétereinek érvényesítése identitás útján
```powershell
...
### Példa 5: az EventGrid-adatkapcsolat paramétereinek érvényesítése identitás útján
```powershell
PS C:\> $database = Get-AzKustoDatabase -ResourceGroupName "testrg" -ClusterName "testnewkustocluster" -DatabaseName "mykustodatabase"
...
### 6. példa: IotHub-adatkapcsolat paramétereinek érvényesítése identitás útján
```powershell
PS C:\> $database = Get-AzKustoDatabase -ResourceGroupName "testrg" -ClusterName "testnewkustocluster" -DatabaseName "mykustodatabase" 
...
### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. IDataConnectionValidationResult
