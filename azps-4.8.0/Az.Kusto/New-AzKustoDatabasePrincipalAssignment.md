...
### 1. példa: Kusto-cluster Database principalAssignment létrehozása
```powershell
...
A fenti parancs létrehoz egy Kusto-principalAssignment
...
### -PrincipalId
Az adatbázis-megbízóhoz rendelt fő azonosító.
Lehet felhasználói e-mail-cím, alkalmazásspecifikus azonosító vagy biztonsági csoport neve.
