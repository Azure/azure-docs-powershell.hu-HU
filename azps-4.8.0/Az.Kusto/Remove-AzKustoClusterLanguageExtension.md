...
### 1. példa: a nyelvi kiterjesztések listájának eltávolítása a fürtből
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

A fenti parancs eltávolítja a KQL-lekérdezéseken belül futtatható nyelvi bővítmények listáját.
...
VALUE <ILanguageExtension [] >: a nyelvi bővítmények listája.
