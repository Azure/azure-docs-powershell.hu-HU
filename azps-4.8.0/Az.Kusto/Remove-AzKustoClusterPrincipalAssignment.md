...
### Példa 1: meglévő Kusto törlése PrincipalAssignment név szerint
```powershell
...
A fenti parancs törli a "kustoprincipal1" nevű PrincipalAssignment a Kusto "testnewkustocluster" nevű fürtjében.
