...
### Példa 1: meglévő Kusto-adatbázis törlése PrincipalAssignment néven
```powershell
...
A fenti parancs törli a "kustoprincipal1" nevű PrincipalAssignment a Kusto-adatbázisban "mykustodatabase".
