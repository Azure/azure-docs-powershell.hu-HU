...
### Példa 1: meglévő adatbázis frissítése név szerint
```powershell
...
A fenti parancs frissíti a "mykustodatabase" Kusto-adatbázis Soft törlési időszakát és forró gyorsítótári időszakát a "testrg" erőforráscsoport "testnewkustocluster" csoportjában.

### 2. példa: meglévő adatbázis frissítése identitás útján
```powershell
...
### 3. példa: létező írásvédett formátumú adatbázis frissítése név szerint
```powershell
PS C:\> $2ds = New-TimeSpan -Days 2
...
A fenti parancs frissíti a "mykustodatabase" Kusto-adatbázis forró gyorsítótári időszakát a "myfollowercluster" az erőforráscsoport "testrg" csoportjában.

### 4. példa: meglévő ReadOnly-adatbázis frissítése identitás útján
```powershell
...
### -HotCachePeriod
Az az időpont, amikor az adatgyorsítótárban meg kell őrizni a gyors lekérdezéseket a időszak-ban.
...
### -SoftDeletePeriod
Az az időpont, amikor az adatot meg kell őrizni, mielőtt a időszak-ban a lekérdezések elérhetővé válnak.
