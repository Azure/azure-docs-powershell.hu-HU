...
## Leírás
A **Get-AzIntegrationAccountMap** parancsmag egy erőforráscsoport integrációs fiókjának térképét kapja.
Az integrációs fiók nevének, az erőforrás csoport nevének és a megfeleltetés nevének megadása.
...
### Példa 1: integrációs fiók térképének beszerzése
```
...
Ez a parancs a megadott erőforráscsoport IntegrationAccountMap47 nevű integrációs fiókját kapja.

### 2. példa: az integrációs fiók megfeleltetésének beszerzése az integrációs fiók nevével
```
...
Ez a parancs az integrációs fiók nevével kapja meg az integrációs fiókot.
...
### -MapType
Az integrációs fiók megfeleltetési típusa.
