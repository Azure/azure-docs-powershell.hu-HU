...
### Példa 1: a MariaDB alatti összes konfiguráció listázása
```powershell
...
Ez a parancs felsorolja az összes konfigurációt a MariaDB alatt.

### 2. példa: a MariaDB konfigurációjának beszerzése
```powershell
...
Ez a parancs a MariaDB konfigurációját kapja.
...
### Microsoft. Azure. PowerShell. parancsmagok. MariaDb. modellek. Api20180601Preview. IConfiguration
