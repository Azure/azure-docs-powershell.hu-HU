...
ms.locfileid: "94025267"
---
# <span data-ttu-id="958a9-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="958a9-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="958a9-102">Áttekintés</span><span class="sxs-lookup"><span data-stu-id="958a9-102">SYNOPSIS</span></span>
<span data-ttu-id="958a9-103">Információt kap a kiszolgáló konfigurációjáról.</span><span class="sxs-lookup"><span data-stu-id="958a9-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="958a9-104">SZINTAXISA</span><span class="sxs-lookup"><span data-stu-id="958a9-104">SYNTAX</span></span>

### <span data-ttu-id="958a9-105">Lista (alapértelmezett)</span><span class="sxs-lookup"><span data-stu-id="958a9-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="958a9-106">Beszerzése</span><span class="sxs-lookup"><span data-stu-id="958a9-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="958a9-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="958a9-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="958a9-108">Leírás</span><span class="sxs-lookup"><span data-stu-id="958a9-108">DESCRIPTION</span></span>
<span data-ttu-id="958a9-109">Információt kap a kiszolgáló konfigurációjáról.</span><span class="sxs-lookup"><span data-stu-id="958a9-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="958a9-110">Példák</span><span class="sxs-lookup"><span data-stu-id="958a9-110">EXAMPLES</span></span>

### <span data-ttu-id="958a9-111">Példa 1: a MariaDB alatti összes konfiguráció listázása</span><span class="sxs-lookup"><span data-stu-id="958a9-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="958a9-112">Ez a parancs felsorolja az összes konfigurációt a MariaDB alatt.</span><span class="sxs-lookup"><span data-stu-id="958a9-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="958a9-113">2. példa: a MariaDB konfigurációjának beszerzése</span><span class="sxs-lookup"><span data-stu-id="958a9-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="958a9-114">Ez a parancs a MariaDB konfigurációját kapja.</span><span class="sxs-lookup"><span data-stu-id="958a9-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="958a9-115">PARAMÉTEREK</span><span class="sxs-lookup"><span data-stu-id="958a9-115">PARAMETERS</span></span>

### <span data-ttu-id="958a9-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="958a9-116">-DefaultProfile</span></span>
<span data-ttu-id="958a9-117">Az Azuretal való kommunikációhoz használt hitelesítő adatok, fiók, bérlői fiók és előfizetés.</span><span class="sxs-lookup"><span data-stu-id="958a9-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="958a9-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="958a9-118">-InputObject</span></span>
<span data-ttu-id="958a9-119">Az Identity paraméter a kiépítéshez, a INPUTOBJECT tulajdonságainak megjegyzések szakasza, valamint a kivonatoló táblázat létrehozása című témakörben talál.</span><span class="sxs-lookup"><span data-stu-id="958a9-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="958a9-120">-Name (név)</span><span class="sxs-lookup"><span data-stu-id="958a9-120">-Name</span></span>
<span data-ttu-id="958a9-121">A kiszolgáló konfigurációjának neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="958a9-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="958a9-122">-ResourceGroupName</span></span>
<span data-ttu-id="958a9-123">Az erőforrást tartalmazó erőforráscsoport neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="958a9-124">Ezt az értéket az Azure Resource Manager API-ból vagy a portálról kaphatja meg.</span><span class="sxs-lookup"><span data-stu-id="958a9-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="958a9-125">-Kiszolgálónév</span><span class="sxs-lookup"><span data-stu-id="958a9-125">-ServerName</span></span>
<span data-ttu-id="958a9-126">A kiszolgáló neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-126">The name of the server.</span></span>
...
### <span data-ttu-id="958a9-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="958a9-127">-SubscriptionId</span></span>
<span data-ttu-id="958a9-128">Az Azure-előfizetést azonosító előfizetési azonosító.</span><span class="sxs-lookup"><span data-stu-id="958a9-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="958a9-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="958a9-129">CommonParameters</span></span>
<span data-ttu-id="958a9-130">Ez a parancsmag a következő általános paramétereket támogatja:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-,-PipelineVariable-WarningAction</span><span class="sxs-lookup"><span data-stu-id="958a9-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="958a9-131">További információt a [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)című témakörben talál.</span><span class="sxs-lookup"><span data-stu-id="958a9-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="958a9-132">BEMENETEK</span><span class="sxs-lookup"><span data-stu-id="958a9-132">INPUTS</span></span>

### <span data-ttu-id="958a9-133">Microsoft. Azure. PowerShell. parancsmagok. MariaDb. models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="958a9-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="958a9-134">KIMENETEK</span><span class="sxs-lookup"><span data-stu-id="958a9-134">OUTPUTS</span></span>

### <span data-ttu-id="958a9-135">Microsoft. Azure. PowerShell. parancsmagok. MariaDb. modellek. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="958a9-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="958a9-136">MEGJEGYZI</span><span class="sxs-lookup"><span data-stu-id="958a9-136">NOTES</span></span>

<span data-ttu-id="958a9-137">ALIASOK</span><span class="sxs-lookup"><span data-stu-id="958a9-137">ALIASES</span></span>

<span data-ttu-id="958a9-138">KOMPLEX PARAMÉTEREK TULAJDONSÁGAI</span><span class="sxs-lookup"><span data-stu-id="958a9-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="958a9-139">Az alábbi paraméterek létrehozásához készítse el a megfelelő tulajdonságokat tartalmazó hash-táblázatot.</span><span class="sxs-lookup"><span data-stu-id="958a9-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="958a9-140">A hash-táblázatokról a Get-Help about_Hash_Tables futtatása című témakörben olvashat.</span><span class="sxs-lookup"><span data-stu-id="958a9-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="958a9-141">INPUTOBJECT <IMariaDbIdentity> : Identity paraméter</span><span class="sxs-lookup"><span data-stu-id="958a9-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="958a9-142">`[ConfigurationName <String>]`: A kiszolgáló konfigurációjának neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="958a9-143">`[DatabaseName <String>]`: Az adatbázis neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="958a9-144">`[FirewallRuleName <String>]`: A kiszolgáló tűzfala szabály neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="958a9-145">`[Id <String>]`: Erőforrás-identitás elérési útja</span><span class="sxs-lookup"><span data-stu-id="958a9-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="958a9-146">`[LocationName <String>]`: A hely neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="958a9-147">`[ResourceGroupName <String>]`: Az erőforrást tartalmazó erőforráscsoport neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="958a9-148">Ezt az értéket az Azure Resource Manager API-ból vagy a portálról kaphatja meg.</span><span class="sxs-lookup"><span data-stu-id="958a9-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="958a9-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: A biztonsági figyelmeztetés házirendjének neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="958a9-150">`[ServerName <String>]`: A kiszolgáló neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="958a9-151">`[SubscriptionId <String>]`: Az Azure-előfizetést azonosító előfizetési azonosító.</span><span class="sxs-lookup"><span data-stu-id="958a9-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="958a9-152">`[VirtualNetworkRuleName <String>]`: A virtuális hálózati szabály neve.</span><span class="sxs-lookup"><span data-stu-id="958a9-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="958a9-153">KAPCSOLÓDÓ HIVATKOZÁSOK</span><span class="sxs-lookup"><span data-stu-id="958a9-153">RELATED LINKS</span></span>
