...
### Példa 1: az összes tűzfalszabály listázása egy MariaDB alatt
```powershell
...
Ez a parancs felsorolja az összes girewall szabályt egy MariaDB alatt.

### 2. példa: tűzfalszabály beszerzése egy MariaDB alatt
```powershell
...
Ez a parancs egy MariaDB alatti tűzfal-szabályt kap.
