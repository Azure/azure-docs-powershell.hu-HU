...
Ha a AdministratorLoginPassword, az SKU-ot stb. Update-AzMariaDbServer
...
### Példa 1: a MariaDB konfigurációjának frissítése
```powershell
...
Ez a parancs frissíti a MariaDB konfigurációját.
