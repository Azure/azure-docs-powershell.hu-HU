...
## Áttekintés
Távoli megjelenítési fiók létrehozása
...
Új távoli megjelenítési fiók létrehozása "példa" a jelenlegi előfizetésben, erőforráscsoport a "rg1" és a közép-amerikai erőforrás csoportban.
...
### -Hely
Távoli megjelenítési fiók helye.
