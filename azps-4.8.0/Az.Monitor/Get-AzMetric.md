...
### Példa 4: az összegzett kimenet beolvasása adott metrika esetén a megadott szűrővel
```
...
Ezzel a paranccsal az oldalmegtekintések metrikájának összegzett kimenete meghatározott dimenzió szűrővel és összesítési típussal lesz meghatározva.
...
### -MetricFilter
A metrika dimenzió szűrőt adja meg az érték lekérdezéséhez.
...
### -MetricNamespace
A metrikus névteret adja meg a mérőszámok lekérdezéséhez.
...
### -OrderBy
A találatok rendezéséhez és a rendezés irányához használt összesítést adja meg (példa: SZUM ASC).
...
### -ResultType
A visszaadott eredmény (metaadat vagy adatok) meghatározása.
...
### -Top
A lekérdezni kívánt rekordok maximális számát adja meg (alapértelmezett: 10), amelyet az $filter meg kell adni.
...
### System. null ' 1 [[Microsoft. Azure. Management. monitor. models. AggregationType, Microsoft. Azure. Management. monitor, Version = 0.21.0.0, Culture = semleges, PublicKeyToken = 31bf3856ad364e35]]

### System. DateTime

### System. null ' 1 [[System. Int32, System. Private. CoreLib, Version = 4.0.0.0, Culture = semleges, PublicKeyToken = 7cec85d7bea7798e]]

### System. null ' 1 [[Microsoft. Azure. Management. monitor. models. ResultType, Microsoft. Azure. Management. monitor, Version = 0.21.0.0, Culture = semleges, PublicKeyToken = 31bf3856ad364e35]]
...
### Microsoft. Azure. commands. OutputClasses. PSMetric

## MEGJEGYZI

A támogatott metrikákkal kapcsolatos további tudnivalók a következő webhelyről érhetők el: https://docs.microsoft.com/en-us/azure/azure-monitor/platform/metrics-supported
