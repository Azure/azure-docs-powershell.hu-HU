...
## Leírás
A **New-AzActionGroupReceiver** parancsmag új műveleti csoportba foglalt vevőkészüléket hoz létre a memóriában.
...
az URI, ahová a webakasztókat el kell küldeni
...
### -ConnectionId
a vevőkészülék ITSM-kapcsolat azonosítója
...
### -IdentifierUri
az aad-hitelesítés azonosítójának URI azonosítója
...
### -IsGlobalRunbook
annak jelzése, hogy a példány globális runbook-e
...
### -ObjectId
a aad Auth webhook app Object ID
...
### -RoleId
A vevőkészülék kar szerepkör-azonosítója
...
a aad-hitelesítés bérlői azonosítója
...
### -TicketConfiguration
a vevőkészülék ITSM TicketConfiguration
...
### -UseAadAuth
az Add Authentication bővítmény használatára szolgáló jelölő
...
A megjelölés a gyakori riasztási sémát használja-e. Ezt az értéket az neglectedfor SMS, Azure app push, ITSM és Voice recievers fogja tartalmazni.
...
### -VoiceCountryCode
A hangvevőkészülék országkódot
...
### -VoicePhoneNumber
A hangvevőkészülék telefonszáma
...
### -WorkspaceId
a vevőkészülék ITSM munkaterület-azonosítója
