...
## Leírás
Létrehoz egy olyan objektumot, amely típusú trigger-feltételt hoz létre.
Ezt az objektumot az értesítési művelet objektumát létrehozó parancsnak kell átadnia
...
### -MetricTrigger
A metrika-lekérdezési szabály kiváltó feltétele
...
### -Küszöb
Az a küszöb, amelyen a riasztást kilőtték
...
### -ThresholdOperator
A küszöb operátor: GreaterThan, LessThan vagy egyenlő
...
### Microsoft. Azure. commands. OutputClasses. PSScheduledQueryRuleTriggerCondition
