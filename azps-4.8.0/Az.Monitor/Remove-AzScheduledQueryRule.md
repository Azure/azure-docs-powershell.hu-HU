...
### 1. példa: szabály neve szerinti eltávolítás
```powershell
PS C:\> Remove-AzScheduledQueryRule -ResourceGroupName "MyResourceGroup" -Name "LogAlertRule1"
```

### 2. példa: beviteli objektum szerinti eltávolítás
```powershell
PS C:\> Remove-AzScheduledQueryRule -InputObject $PSScheduledQueryRuleResource
```

### 3. példa: erőforrás-azonosító szerinti eltávolítás
```powershell
...
### -PassThru
A sikert vagy a hibát jelző értéket adja eredményül.
