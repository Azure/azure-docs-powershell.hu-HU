...
## Áttekintés
Frissítheti egy megoldás címkéit.
...
### 1. példa: a monitor naplózási elemzési megoldásának frissítése név szerint
```powershell
...
Ez a parancs név szerint frissíti a monitor log-elemzési megoldását.

### 2. példa: a monitor log-elemzési megoldásának frissítése objektum szerint
```powershell
...
Ez a parancs objektum alapján frissíti a monitor log-elemzési megoldását.
