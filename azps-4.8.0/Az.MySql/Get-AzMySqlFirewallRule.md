...
### Példa 1: a megadott MySql-kiszolgálón lévő összes tűzfal-szabály listázása
```powershell
...
Ez a parancsmag felsorolja az összes tűzfal-szabályt a megadott MySql-kiszolgálón.
