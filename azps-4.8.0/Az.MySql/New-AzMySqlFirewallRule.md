...
### Példa 1: új MySql-kiszolgáló tűzfalszabály létrehozása
```powershell
...
Ezzel a parancsmaggal létrehozhatja a MySql-kiszolgáló tűzfalszabályok szabályát.

### 2. példa: hozzon létre egy új MySql tűzfal-szabályt a-ClientIPAddress-ban.
```powershell
...
Ezzel a parancsmaggal létrehozhatja a MySql tűzfal-szabályt a-ClientIPAddress-ban.

### 3. példa: új MySql tűzfalszabály létrehozása az összes IPs engedélyezéséhez
```powershell
...
Ezzel a parancsmaggal létrehozhatja az összes IP-hez az új MySql-tűzfalszabályok használatát.

## PARAMÉTEREK

### -AllowAll
A 0.0.0.0-től a 255.255.255.255-ig terjedő összes IP-t engedélyezni kell.
...
Ha nincs megadva, az alapértelmezett érték nincs definiálva.
Ha a AllowAll létezik, az alapértelmezett név AllowAll_yyyy-MM-dd_HH-mm-SS.
...
### Microsoft. Azure. PowerShell. parancsmagok. MySql. models. Api20171201. IFirewallRule
