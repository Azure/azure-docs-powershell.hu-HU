...
### 1. példa: a MySql-kiszolgáló eltávolítása a resourceGroup és a kiszolgáló nevével
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Ez a parancsmag eltávolítja a MySql szervert a resourceGroup és a kiszolgálónév alapján.

### 2. példa: a MySql-kiszolgáló eltávolítása identitással
```powershell
...
Ezek a parancsmagok a MySql szervert identitással távolítják el.
