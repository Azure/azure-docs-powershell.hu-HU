...
Ez a parancs a MyVol replikációs állapotát kapja meg.

## PARAMÉTEREK

### -AccountName
A replikációs célként megadott kötet ANF-fiókjának neve
...
### -InputObject
A ANF replikációs cél mennyiségi objektuma a replikációs állapot eléréséhez
...
### -PoolName
A replikációs célként megadott kötet ANF-készletének neve
...
### Microsoft. Azure. Command. NetAppFiles. models. PSNetAppFilesReplicationStatus
