...
## Leírás
A **Get-AzNetAppFilesSnapshot** parancsmag részleteket tartalmaz egy ANF pillanatképről.

## Példák

### Példa 1: ANF pillanatképének beszerzése
```
...
Ez a parancs a MyAnfSnapshot nevű pillanatképet a "MyAnfVolume" kötetről kapja meg.
...
### -VolumeObject
A visszaadni kívánt pillanatképet tartalmazó mennyiségi objektum
