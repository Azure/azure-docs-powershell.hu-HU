...
## Leírás
A **Get-AzNetAppFilesVolume** parancsmag részleteket tartalmaz a ANF-kötetekről.

## Példák

### Példa 1: ANF-kötet beszerzése
```
...
Ez a parancs a MyAnfVolume nevű kötetet a "MyAnfPool" poolból kapja. 
...
### -PoolObject
A visszaadni kívánt kötetet tartalmazó Pool objektum
