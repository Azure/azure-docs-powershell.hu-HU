...
Ez a parancs felfüggeszti a ANF replikációs kapcsolatát a "MyDestinationAnfVolume" köteten.
...
### -InputObject
A cél ANF objektum a replikációval
...
### -PassThru
Annak megadása, hogy a megadott kötet-replikáció megszakítása történt-e
