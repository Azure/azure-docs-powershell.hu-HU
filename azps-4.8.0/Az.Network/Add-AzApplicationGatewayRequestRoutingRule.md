...
## Leírás
Az **Add-AzApplicationGatewayRequestRoutingRule** parancsmag a kérések útválasztási szabályait hozzáadja egy alkalmazás-átjáróhoz.

## Példák

### 1. példa: kérés-útválasztási szabály hozzáadása az alkalmazás-átjáróhoz
```
...
A második parancs hozzáadja a Request Routing szabályt az Application Gateway programhoz.

## PARAMÉTEREK

### -ApplicationGateway
Annak az alkalmazásnak az átjáróját adja meg, amelyre a parancsmag a kérések útválasztási szabályát felveszi.
...
### -BackendAddressPool
Az Application Gateway back-end Address Pool objektumát adja meg.
...
### -BackendHttpSettings
Egy alkalmazás átjárójának back-end HTTP Settings objektumát adja meg.
...
A backend HTTP-beállítási AZONOSÍTÓját adja meg az alkalmazás-átjárók számára.
...
### -HttpListener
Az Application Gateway HTTP-figyelő objektumát adja meg.
...
### -HttpListenerId
Az Application Gateway HTTP-figyelő AZONOSÍTÓját adja meg.
...
### -Name (név)
A Request Routing szabály nevét adja meg, amely a parancsmagot adja hozzá.
...
### -UrlPathMapId
A művelettervi szabály URL-elérési útjának AZONOSÍTÓját adja meg.
