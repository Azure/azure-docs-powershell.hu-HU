...
## Leírás
Az **Add-AzApplicationGatewayTrustedRootCertificate** parancsmag egy megbízható legfelső szintű tanúsítványt ad egy Azure Application Gateway-nek.
...
A második parancs hozzáadja az új megbízható főtanúsítványt az Application Gateway-hoz a főtanúsítvány elérési útjának beviteléhez.
A harmadik parancs új backend http-beállítást hoz létre a megbízható főtanúsítvány használatával a backend-kiszolgáló tanúsítványának érvényesítéséhez.
A negyedik parancs frissíti az alkalmazás-átjárót.
