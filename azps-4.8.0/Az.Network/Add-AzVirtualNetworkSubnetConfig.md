...
### 1. példa: alhálózat felvétele meglévő virtuális hálózatba
```powershell
...
### 2. példa: delegálás felvétele egy meglévő virtuális hálózatba felvett alhálózatba
```powershell
...
### -IpAllocation
Az alhálózat IpAllocations adja meg.
