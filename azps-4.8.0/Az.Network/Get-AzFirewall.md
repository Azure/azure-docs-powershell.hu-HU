...
## Leírás
A **Get-AzFirewall** parancsmag egy vagy több tűzfalat kap egy erőforráscsoportben.
...
### 3: az összes tűzfal lekérése szűréssel
```
...
Ez a példa beolvassa az összes "azFw" kezdetű tűzfalat.

### 4: a tűzfal lekérése, majd az alkalmazási szabályok gyűjteményének hozzáadása a tűzfalhoz
```
...
### 5: a tűzfal lekérése, majd a hálózati szabályok gyűjteményének hozzáadása a tűzfalhoz
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 6: a tűzfal lekérése, majd egy alkalmazási szabály gyűjteményének beolvasása a tűzfalból
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 7: a tűzfal lekérése, majd egy hálózati szabály-gyűjtemény beolvasása a tűzfalból
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 8: a tűzfal lekérése, majd az alkalmazás szabály-gyűjteményének eltávolítása a tűzfalból
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 9: tűzfal beolvasása és a hálózati szabály gyűjteményének eltávolítása a tűzfalból
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 10: a tűzfal lekérése, majd a tűzfal lefoglalása
```
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. commands. Network. models. PSAzureFirewall, Microsoft. Azure. PowerShell. parancsmagok. Network, Version = 1.0.0.0, Culture = semleges, PublicKeyToken = null]]
