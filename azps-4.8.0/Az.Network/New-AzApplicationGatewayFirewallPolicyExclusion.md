...
## Leírás
A **New-AzApplicationGatewayFirewallPolicyExclusion** parancsmag új kizárási szabály listája a tűzfal házirendjében.
...
Ez a parancs létrehoz egy új kivonási bejegyzést a RequestHeaderNames és a StartsWith nevű műveleti nevű változóhoz, az XYZ nevűt. A program a kizárási bejegyzést $exclusionEntry menti.
