...
## Áttekintés
Az Express Route porthoz tartozó engedélyezési dokumentum letöltése
...
## Leírás
New-AzExpressRoutePortLOA parancsmag az Express Route-port PDF formátumban tölti le az engedélyezési dokumentum egy betűjét.
...
Töltse le az Express Route port "myPort" engedélyezési dokumentumát, és tárolja az "loa.pdf" fájlban.
...
### -Ügyfélneve
Annak az ügyfélnek a neve, akihez az Express Route port van rendelve.
...
### -Destination (cél)
A kimeneti filepath az engedély betűjelének tárolásához.
...
### -ResourceGroupName
Az Express Route portot tartalmazó erőforráscsoport neve.
