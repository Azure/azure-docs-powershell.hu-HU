...
### Példa 1: szabály létrehozása az összes HTTPS-forgalom engedélyezéséhez a 10.0.0.0-ból
```powershell
...
### 2. példa: szabály létrehozása a 10.0.0.0/24 alhálózat WindowsUpdate engedélyezéséhez
```powershell
