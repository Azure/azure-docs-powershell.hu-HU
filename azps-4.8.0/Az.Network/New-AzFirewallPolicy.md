...
## Leírás
A **New-AzFirewallPolicy** parancsmag Azure tűzfal-házirendet hoz létre.

## Példák

### Példa 1:1. Üres házirend létrehozása
```powershell
PS C:\> New-AzFirewallPolicy -Name fp1 -ResourceGroupName TestRg
```

Ez a példa Azure tűzfal-házirendet hoz létre.

### Példa 2:2. Üres házirend létrehozása a ThreatIntel móddal
```powershell
PS C:\> New-AzFirewallPolicy -Name fp1 -ResourceGroupName TestRg -ThreatIntelMode "Deny"
```

Ez a példa egy Azure tűzfal-házirendet hoz létre egy veszélyforrás Intel móddal

### Példa 3:3. Üres házirend létrehozása a ThreatIntel whitelist szolgáltatóval
```powershell
...
Ez a példa egy Azure tűzfal-házirendet hoz létre egy veszélyforrás Intel whitelist segítségével
...
### -BasePolicy
Az alapházirend, amelyet örökölni szeretne
...
### -ThreatIntelMode
A veszélyforrások felderítésének üzemmódja.
