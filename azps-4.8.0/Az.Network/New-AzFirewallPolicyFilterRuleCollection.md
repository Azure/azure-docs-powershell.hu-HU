...
## Leírás
A **New-AzFirewallPolicyFilterRuleCollection** parancsmag létrehoz egy szűrő szabály-gyűjteményt az Azure tűzfal házirendjéhez.
...
Ez a példa egy szűrő szabályt hoz létre 2 szabály feltételével
...
### -Name (név)
Az alkalmazási szabály gyűjteményének neve
...
### – Prioritás
A szabály-gyűjtemény prioritása
...
### -Szabály
Az alkalmazás szabályainak listája
