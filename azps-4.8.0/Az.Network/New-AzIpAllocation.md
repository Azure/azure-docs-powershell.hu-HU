...
## Leírás
A **New-AzIpAllocation** parancsmag létrehoz egy Azure IpAllocation
...
### -Force
Ha egy erőforrást felül szeretne bírálni, ne kérjen megerősítést.
...
### -IpAllocationTag
Az IP-kiosztás kiosztási címkéi
...
### -IpamAllocationId
Az IP-kiosztás IPAM-allokációs azonosítója
