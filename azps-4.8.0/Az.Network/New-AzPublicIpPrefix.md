...
### Példa 1: új nyilvános IP-előtag létrehozása
```powershell
PS C:\> $publicIpPrefix = New-AzPublicIpPrefix -Name $prefixName -ResourceGroupName $rgName -PrefixLength 30
```

A parancs új nyilvános IP-előtag-erőforrást hoz létre. 
...
### -SKU
A nyilvános IP-előtag SKU-neve.
