...
## Leírás
Az New-AzRadiusServer parancsmag létrehoz egy külső RADIUS-kiszolgáló konfigurációt, amelyet a virtuális hálózati átjáró és a VPN-kiszolgáló konfigurációja hoz létre.
...
Több külső RADIUS-kiszolgáló konfigurációjának létrehozása az új virtuális hálózati átjáró P2S konfigurálásához.
...
### -RadiusServerScore
Külső RADIUS-kiszolgáló pontszáma
