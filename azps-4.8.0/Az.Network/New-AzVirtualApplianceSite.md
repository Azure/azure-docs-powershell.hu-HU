...
## Áttekintés
Hálózat virtuális készülékhez kapcsolt webhely létrehozása
...
## Leírás
A New-AzVirtualApplianceSite parancs létrehoz egy virtuális Appliance-webhelyet, amely egy hálózat virtuális készülék-erőforráshoz csatlakozik.
...
Hozzon létre egy új virtuális készülék-webhelyet az erőforrás csoportban: testrg.

## PARAMÉTEREK

### -AddressPrefix
A webhely címének előtagja.
...
### -O365Policy
Az Office 365 kitörési irányelvei.
