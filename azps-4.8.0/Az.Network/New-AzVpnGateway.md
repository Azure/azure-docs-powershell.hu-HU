...
A New-AzVpnGateway méretezhető VPN-átjárót hoz létre. Ez a szoftver által definiált, a VirtualHub-on belüli kapcsolatok a webhelyek között. 

Az átjáró az ebben vagy az Set-AzVpnGateway parancsmagban megadott méretarány alapján átméretezi a méretarányokat és a méretarányokat. 

Egy kapcsolat be van állítva egy olyan elágazásból/webhelyről, amelyet a VPNSite a skálázható átjárónak nevezünk. Mindegyik kapcsolat két Active-Active-alagútból áll.

A VpnGateway ugyanabba a helyre kerül, mint a hivatkozott VirtualHub.
