...
Ez a példa létrehoz egy erőforráscsoportot, a virtuális WAN-ot, a virtuális hubot, a skálázható ExpressRoute-átjárót Közép-amerikai, majd azonnal törli. Ha szeretné, hogy a virtuális átjáró törlésekor a kérdés ne legyen letiltva, használja a-Force jelölőt.
Ezzel törli a ExpressRouteGateway és a hozzá társított összes ExpressRouteConnections.
...
Ez a példa létrehoz egy erőforráscsoportot, a virtuális WAN-ot, a virtuális hub-ot, a skálázható ExpressRoute-átjárót a Nyugat-középen, majd azonnal törli azt. Ez a törlés a PowerShell-csővezetékek használatával történik, amely a Get-AzExpressRouteGateway parancs által visszaadott ExpressRouteGateway objektumot használja.
...
### -InputObject
A törlendő ExpressRouteGateway objektum.
...
### -ResourceId
A törlendő ExpressRouteGateway Azure Resource AZONOSÍTÓja.
