...
A **Remove-AzLocalNetworkGateway** parancsmag a helyszíni átjáró név és erőforrás csoport neve alapján történő törlésére szolgáló objektumot törli.

## Példák

### Példa 1: helyi hálózati átjáró törlése
```powershell
Remove-AzLocalNetworkGateway -Name myLocalGW -ResourceGroupName myRG
```

Törli a helyi hálózati átjáró objektumát a "myLocalGW" nevű erőforrás-csoport "myRG" Megjegyzés: először törölnie kell a helyi hálózati átjáróval való összes kapcsolatot a **Remove-AzVirtualNetworkGatewayConnection** parancsmaggal.
