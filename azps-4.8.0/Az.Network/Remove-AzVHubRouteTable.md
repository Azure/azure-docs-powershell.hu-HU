...
## Leírás
Törli a megadott virtuális központtal társított központi útválasztási táblázatot.
...
### -InputObject
Az eltávolítandó vhubroutetable-erőforrás.
...
### -ResourceId
Az eltávolítandó vhubroutetable erőforrás azonosítója.
