...
## Áttekintés
Módosítja egy PrivateLink-konfigurációt.
...
## Leírás
A **set-AzApplicationGatewayPrivateLinkConfiguration** parancsmag az Azure Application Gateway privateLink-konfigurációját módosítja.

## Példák

### 1. példa: PrivateLink-konfiguráció beállítása
```
...
A második parancs a privateLink konfigurációt a name privateLinkConfig01-ra állítja be, hogy az IP-konfigurációt használja az $privateLinkIpConfiguration 01-ben tárolva
