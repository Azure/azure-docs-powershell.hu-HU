...
## Leírás
A **set-AzApplicationGatewaySslCertificate** parancsmag az alkalmazás-ÁTJÁRÓk SSL-tanúsítványát frissíti.

## Példák

### Példa 1: meglévő SSL-tanúsítvány frissítése az alkalmazás-átjárón
```
...
Frissítsen egy meglévő SSL-tanúsítványt a ApplicationGateway01 nevű alkalmazás-átjáróhoz.

### 2. példa: meglévő SSL-tanúsítvány frissítése a "secretId" (verziószám nélküli) kulccsal az Application Gatewayben
```
...
A titka és a meglévő SSL-tanúsítvány frissítése a használatával `Set-AzApplicationGatewaySslCertificate` .

### 3. példa: meglévő SSL-tanúsítvány frissítése az Application Gateway segítségével
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
