...
## Leírás
A **set-AzExpressRouteCircuitConnectionConfig** parancsmag egy ExpressRoute-áramkör személyes kinézetében létrehozott áramköri kapcsolati konfigurációt frissít. Ez a beállítás lehetővé teszi a két útvonal közötti átirányítást régiónként vagy előfizetésben.
Fontos tudni, hogy a **set-AzExpressRouteCircuitConnectionConfig** futtatása előtt fel kell vennie az áramköri kapcsolatot a **Add-AzExpressRouteCircuitConnectionConfig** használatával. A **set-AzExpressRouteCircuitPeeringConfig** futtatása után a Set-AzExpressRouteCircuit parancsmagot is el kell végeznie a konfiguráció aktiválásához.


## Példák

### Példa 1: áramkör-kapcsolati erőforrás frissítése meglévő ExpressRoute-áramkörre
```
...
### 2. példa: az áramköri kapcsolat konfigurációjának beállítása csővezeték használatával meglévő ExpressRoute-áramkörrel
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
...
### -AddressPrefix
Az IPv4-alagutak közötti VxLan-alagutak létrehozásához szükséges minimális/29 ügyféli címtartomány.
vagy legalább/125 ügyfél-címterület létrehozása az VxLan-alagutak között az IPv6-alagutak közötti útválasztási kapcsolatok között.
...
```
### -AddressPrefixType
Annak a címnek a címét adja meg, amelyhez a cím előtag tartozik.
