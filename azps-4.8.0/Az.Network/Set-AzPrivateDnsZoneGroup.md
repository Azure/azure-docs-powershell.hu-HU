...
## Leírás
A **set-AzPrivateDnsZoneGroup** parancsmag frissíti a DNS Zone (DNS-zóna) csoportot.
...
A fenti példa frissíti a dnsgroup1 nevű DNS-zóna csoportot egy új dnsconfig, amely egy másik DNS-zónára hivatkozik.
