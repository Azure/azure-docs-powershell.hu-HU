...
Először hozzunk létre egy virtuális hub Route-objektumot, és a virtuális hub Route Table-erőforrás létrehozásához használjuk azt. Ezután az útválasztási táblázat erőforrását a virtuális központba a Set-AzVirtualHub parancs segítségével állíthatja be.
...
### -RouteTable
A virtuális hubhoz társított útválasztási táblák.
