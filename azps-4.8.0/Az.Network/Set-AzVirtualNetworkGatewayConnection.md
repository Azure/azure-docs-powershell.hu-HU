...
## Leírás
A **set-AzVirtualNetworkGatewayConnection** parancsmag a virtuális hálózati átjáró kapcsolatát adja meg.
...
### 2. példa: Címkék hozzáadása és frissítése meglévő VirtualNetworkGatewayConnection
```
$conn = Get-AzVirtualNetworkGatewayConnection -Name 1 -ResourceGroupName myRG
