...
## Áttekintés
A csomag rögzítési műveletének leállítása a VPN-átjárón.
...
## Leírás
A csomag rögzítési műveletének leállítása a VPN-átjárón, és az eredmény feltöltése adott SasUrl-tárolóra.
...
### -InputObject
A VPN-átjáró objektum, amelybe a csomag elindul.
...
### -Name (név)
Annak a VPN-átjárónak a neve, amelybe a csomagot el kell indítani.
...
### -ResourceId
Az Azure Resource ID a VpnGateway, ahol a csomagot el szeretné indítani.
...
### -SasUrl
A SAS URL-csomag rögzítése a VPN-átjárón
