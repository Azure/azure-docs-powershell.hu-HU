...
## Leírás
Az **Update-AzP2sVpnGateway** parancsmag lehetővé teszi, hogy egy meglévő P2SVpnGateway frissítsen a VirtualHub-ban az új VpnClientAddressPool vagy az új VpnServerConfiguration vagy a VpnGatewayScaleUnit módosításával.
...
Az **Update-AzP2sVpnGateway** parancsmag lehetővé teszi, hogy egy meglévő P2SVpnGateway frissítsen a VirtualHub-ban az új VpnClientAddressPool. Amikor a webhely ügyfélprogramja csatlakozik ezzel a P2SVpnGateway, az adott VpnClientAddressPool tartozó IP-címet az ügyfél kapja.

### 2. példa

Frissítsen egy meglévő P2SVpnGateway a VirtualHub csoportban a webhely-kapcsolat pontra. autogenerated
...
Az Internet Security Flag engedélyezése e P2SVpnGateway-kapcsolatokhoz
...
Az Internet Security Flag letiltása ehhez a P2SVpnGateway-kapcsolatokhoz
...
### -VpnClientAddressPool
P2S VpnClient AddressPool a P2SVpnGateway P2SConnectionConfiguration.
...
### -VpnGatewayScaleUnit
A P2SVpnGateway méretarányos egysége.
...
A P2SVpnGateway csatolni kívánt VpnServerConfiguration.
...
A VPN-kiszolgáló konfigurációja objektum azonosítója, amelyhez a P2SVpnGateway hozzá lesz rendelve.
