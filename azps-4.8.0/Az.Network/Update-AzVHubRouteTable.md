...
## Áttekintés
A VirtualHub társított hub Route Table-erőforrás törlése
...
## Leírás
Itt frissítheti a megadott útválasztási táblát, amely társítva van a megadott virtuális csomóponthoz a megadott útvonalakkal vagy címkékkel.
...
Ez a parancs törli a virtuális hub központi útválasztási táblázatát.
...
### -InputObject
A frissítendő vhubroutetable-erőforrás.
...
### -ParentObject
Az erőforrás fölérendelt virtuális hub objektuma.
...
### -ResourceId
A frissítendő vhubroutetable erőforrás azonosítója.
...
### – Útvonal
Az útválasztási táblázat útvonalainak listája.
...
[Új – AzVHubRoute](./New-AzVHubRoute.md)
