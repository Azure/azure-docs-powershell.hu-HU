...
Fürtök beolvasása és listázása
...
Törölt munkaterületek listázása
...
Munkaterülethez kapcsolt szolgáltatás beszerzése vagy listázása

### [Get-AzOperationalInsightsLinkedStorageAccount](Get-AzOperationalInsightsLinkedStorageAccount.md)
Kapcsolt tárterület-fiók beszerzése vagy listázása
...
### [Új – AzOperationalInsightsCluster](New-AzOperationalInsightsCluster.md)
Fürt létrehozása
...
### [Új – AzOperationalInsightsLinkedStorageAccount](New-AzOperationalInsightsLinkedStorageAccount.md)
Kapcsolt tárolási fiók létrehozása a munkaterülethez
...
A munkaterülethez kapcsolt tárolási fiók beállítása
