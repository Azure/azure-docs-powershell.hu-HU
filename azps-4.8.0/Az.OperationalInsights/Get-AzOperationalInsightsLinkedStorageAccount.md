...
## Leírás
Kapcsolt tárterület beszerzése, az összes kapcsolt tárolási fiók listázása, ha a "-DataSourceType" parancs nincs megadva
...
a munkaterület {munkaterület-név} accoounts kapcsolt tárterületének listázása

## PARAMÉTEREK

### -DataSourceType
Az adatforrás típusa csak "CustomLogs", "AzureWatson".
...
### Microsoft. Azure. Command. OperationalInsights. models. PSLinkedStorageAccountsResource
