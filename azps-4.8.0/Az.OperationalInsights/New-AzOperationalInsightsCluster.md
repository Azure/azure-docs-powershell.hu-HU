...
### -IdentityType
az identitás típusának értéke lehet "SystemAssigned", "nincs".
...
### -Hely
A fürt által telepített földrajzi terület.
...
### -SkuCapacity
SKU-kapacitás: az értéknek az 100 többszörösének kell lennie, és az 1000-2000-ös tartományába kell lennie.
...
### -SkuName
SKU neve, most csak "CapacityReservation" lehet
...
### Microsoft. Azure. Command. OperationalInsights. models. PSCluster
