...
## Leírás
Az előfizetésből, erőforráscsoporthoz vagy név alapján kapja meg a munkatársait.
...
Megkapja az előfizetéshez tartozó összes erőforrást.
...
Beolvassa az Exchange társközi nevű `myExchangePeering1`
...
Megkapja az erőforrás-azonosító alapján megnevezett Exchange-társat `myExchangePeering1` .
