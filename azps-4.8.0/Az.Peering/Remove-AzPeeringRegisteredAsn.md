...
## Leírás
Lehetővé teszi a Registered ASN-nek a fölérendelt társközi erőforrásból való eltávolítását.
...
Az ASN-es regisztráció erőforrás-azonosítóval való eltávolítása
