...
### 1. példa: az előfizetésben szereplő összes irányítópult listázása
```powershell
...
Az összes irányítópult listázása az előfizetésben

### 2. példa: egyetlen portál adatainak beolvasása
```powershell
...
Egyetlen irányítópult részleteinek beszerzése
