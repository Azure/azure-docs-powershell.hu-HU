...
### Példa 1: a PostgreSql-kiszolgáló replikájának beolvasása az erőforráscsoport és a kiszolgáló neve alapján
```powershell
...
Ez a parancsmag a PostgreSql-kiszolgáló replikáját erőforrás csoport és kiszolgálónév szerint kapja.
