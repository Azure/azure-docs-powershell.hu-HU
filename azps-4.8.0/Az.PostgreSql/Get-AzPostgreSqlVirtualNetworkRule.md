...
### Példa 1: a megadott PostgreSql-kiszolgálón található virtuális hálózati szabályok felsorolása
```powershell
...
Ez a parancsmag felsorolja az összes virtuális hálózati szabályt a megadott PostgreSql-kiszolgálón.
