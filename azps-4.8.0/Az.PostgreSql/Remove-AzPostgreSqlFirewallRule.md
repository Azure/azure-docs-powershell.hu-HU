...
### 1. példa: a PostgreSql-tűzfal szabályának eltávolítása név szerint
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Ez a parancsmag eltávolítja a PostgreSql-tűzfal szabályát név szerint.

### 2. példa: a PostgreSql-tűzfal szabályának eltávolítása identitással
```powershell
...
Ezek a parancsmagok eltávolítják a PostgreSql-tűzfal szabályát identitás szerint.
