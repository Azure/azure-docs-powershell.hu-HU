...
Ez a parancsmag frissíti a PostgreSql-konfigurációt név szerint.

### 2. példa: a PostgreSql-konfiguráció frissítése identitással.
```powershell
...
Ezek a parancsmagok identitással frissítik a PostgreSql-konfigurációt.
