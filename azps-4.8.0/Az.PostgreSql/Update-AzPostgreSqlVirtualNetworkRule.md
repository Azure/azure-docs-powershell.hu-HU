...
### 1. példa: a PostgreSql virtuális hálózat szabályának frissítése név szerint
```powershell
...
Ez a parancsmag a PostgreSql virtuális hálózati szabályát frissíti név szerint.

### 2. példa: a PostgreSql virtuális hálózat szabályának frissítése identitással.
```powershell
...
Ezek a parancsmagok a PostgreSql virtuális hálózati szabályát identitás szerint frissítik.
...
### Microsoft. Azure. PowerShell. parancsmagok. PostgreSql. models. Api20171201. IVirtualNetworkRule
