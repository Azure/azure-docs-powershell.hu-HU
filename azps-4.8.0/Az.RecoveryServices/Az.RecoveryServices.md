...
## Leírás
Ez a témakör az Azure Recovery Services-parancsmagok súgótémaköröket jeleníti meg.
...
A már védett Azure Virtual Machine-alapú védelemhez adja hozzá a lemezt.
...
Az egyik régióban lévő boltozatból másolhatja az adatot egy másik régióban lévő boltozatba.
...
Ez a parancs egy bizonyos tárolón vagy az összes regisztrált tárolón belül minden védelemmel ellátott elemet visszakeres. A program az alkalmazás hierarchiájának minden elemét tartalmazza. A DBs és a felsőbb szintű, például a AvailabilityGroup stb.
...
### [Importálás – AzRecoveryServicesAsrVaultSettingsFile](Import-AzRecoveryServicesAsrVaultSettingsFile.md)
...
### [Inicializálás – AzRecoveryServicesBackupProtectableItem](Initialize-AzRecoveryServicesBackupProtectableItem.md)
...
### [Új – AzRecoveryServicesAsrAzureToAzureDiskReplicationConfig](New-AzRecoveryServicesAsrAzureToAzureDiskReplicationConfig.md)
...
### [Új – AzRecoveryServicesAsrInMageAzureV2DiskInput](New-AzRecoveryServicesAsrInMageAzureV2DiskInput.md)
Létrehoz egy lemezkezelő-objektumot a vMWare Virtual Machine-lemezek replikálásához.
...
### [Új – AzRecoveryServicesAsrProtectableItem](New-AzRecoveryServicesAsrProtectableItem.md)
Vegye fel a fizikai kiszolgálót a védett elemek listájára.

### [Új – AzRecoveryServicesAsrProtectionContainer](New-AzRecoveryServicesAsrProtectionContainer.md)
...
### [Új – AzRecoveryServicesAsrvCenter](New-AzRecoveryServicesAsrvCenter.md)
...
Új helyreállítási szolgáltatások boltozatának létrehozása

### [Register-AzRecoveryServicesBackupContainer](Register-AzRecoveryServicesBackupContainer.md)
A **Register-AzRecoveryServicesBackupContainer** parancsmag egy Azure VM-et rögzít az AzureWorkloads meghatározott workloadType.
...
Törli a helyreállítási szolgáltatások boltozatát.
...
A feladatátvételi művelet véglegesítése előtt módosítja a sikertelenül módosított elem helyreállítási pontját.
...
### [Visszavonás – AzRecoveryServicesBackupItemDeletion](Undo-AzRecoveryServicesBackupItemDeletion.md)
...
Frissítse az Azure site Recovery Protection Container megfeleltetését.
