...
### -AzureToVMware
Az Azure a vMWare katasztrófa-helyreállítást adja meg.
...
### -HyperVToAzure
Kapcsoló paraméter, amely azt jelzi, hogy a Hyper-V virtuális gépek az Azure-ra való replikálásához a megadott házirendet használja a rendszer.
...
A replikációs cél Azure Storage Account ID azonosítóját adja meg. Akkor használható, ha a cél tárolási fiókja a replikáció, ha az New-AzRecoveryServicesASRReplicationProtectedItem parancsmaggal való engedélyezéskor a rendszer nem ad meg alternatív szolgáltatást.
...
### -VmmToVmm
Kapcsoló paraméter, amely azt jelzi, hogy a megadott házirend a VMM felügyelt Hyper-V virtuális gépek két Hyper-V-webhelyre való replikálásához használatos.
...
### -VMwareToAzure
Kapcsoló paraméter, amely azt jelzi, hogy a megadott házirend a VMware Virtual Machines Azure rendszerhez való replikálásához használatos.
