...
### Példa 1: a feloldatlan függő erőforrások listájának beolvasása
```powershell
...
Az áthelyezési gyűjtemények feloldatlan függő erőforrásainak listája
...
### Microsoft. Azure. PowerShell. parancsmagok. ResourceMover. modellek. Api20191001Preview. IUnresolvedDependencyCollection
