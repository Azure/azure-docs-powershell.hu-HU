...
Ez a parancs a megadott erőforráscsoport-hatókörben a What-If eredményét adja meg egy egyéni sablonfájl és egy, a lemezen lévő paramétert tartalmazó fájl használatával.
A parancs a *ResourceGroupName* paraméterrel megadhatja azt az erőforráscsoport-csoportot, amelyben a sablont telepítik.
...
### 2. példa: What-If eredményének beszerzése erőforráscsoport-hatókörben a ResourceIdOnly
```powershell
PS C:\> Get-AzResourceGroupDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -ResourceGroupName "myRG1" `
...
### -ExcludeChangeType
Vesszővel elválasztott erőforrás-módosítási típusokat kell kizárni What-If eredményből.
