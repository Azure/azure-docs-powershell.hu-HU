...
## Leírás
Új Azure Active Directory-alkalmazást hoz létre. Az alábbi engedélyek szükségesek az alkalmazás létrehozásához:
...
Új Azure Active Directory-alkalmazás létrehozása és a jelszóhoz kapcsolódó hitelesítő adatok társítása.

## PARAMÉTEREK

### -AvailableToOtherTenants
Az az érték, amely azt adja meg, hogy az alkalmazás egyetlen bérlő vagy több bérlői fiók-e.
...
### -DisplayName
Az új alkalmazás megjelenített neve.
...
### -Hitelesítő adatok
Az alkalmazáshoz társított tanúsítvány-hitelesítő adatok listája.
...
### -PasswordCredentials
Az alkalmazáshoz társított jelszós hitelesítő adatok listája.
...
### -ReplyUrls
Az alkalmazás válaszának URL-címei.
