...
## Leírás
A **New-AzManagementGroupDeployment** parancsmag egy felügyeleti csoportba helyezi a bevezetést.

Ha egy felügyeleti csoportban szeretne bevezetést hozzáadni, adja meg a kezelési csoportot, a helyet és a sablont.
...
Ha erőforrásokat szeretne hozzáadni az előfizetéshez, használja a **AzSubscriptionDeployment** , amely létrehoz egy telepítést az előfizetéses hatókörben, amely az előfizetési szint erőforrásait telepíti.
Ha erőforrásokat szeretne felvenni a bérlői hatókörben, használja az **új AzTenantDeployment** , amely a bérlői hatókörben létrehoz egy bevezetést.
...
A parancs létrehoz egy új üzembe állítást a "myMG" felügyeleti csoportnál egy egyéni sablon és egy sablonfájl segítségével a lemezen, a definiált címkék paraméterrel.
...
Ez a parancs egy új üzembe állítást hoz létre a "myMG" felügyeleti csoportnál egy egyéni sablon és egy olyan lemezen lévő sablonfájl használatával, amely a memória-Hashtable lett átalakítva.
...
### -WhatIfResultFormat
A What-If eredmény formátuma. A-WhatIf vagy a-Confirm kapcsoló beállításakor alkalmazható.
