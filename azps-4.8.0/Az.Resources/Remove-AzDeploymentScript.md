...
## Leírás
A **Remove-AzDeploymentScript** parancsmag eltávolítja a telepítő parancsfájlt és a hozzá tartozó erőforrásokat.
...
Törli a MyDeploymentScript nevű telepítő parancsfájlt az erőforráscsoport DS-TestRG.
