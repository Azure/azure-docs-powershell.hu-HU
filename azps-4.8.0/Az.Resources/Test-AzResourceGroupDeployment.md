...
### 1. példa: a bevezetést egyéni sablon objektummal és paraméterrel tartalmazó fájllal tesztelheti.
...
Ez a parancs a megadott sablonfájl és a paraméter-fájl alapján létrehozott, a memóriában lévő Hashtable segítségével teszteli az adott erőforráscsoport telepített példányát.

### 2. példa: a telepítés a sablonfájl és a paraméter fájlja segítségével
...
Ez a parancs a megadott sablonfájlt és egy paraméteres fájlt használva teszteli a megadott erőforráscsoport és erőforrás bevezetését.
