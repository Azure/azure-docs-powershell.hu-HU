...
## Leírás
A **unregister-AzResourceProvider** parancsmag egy Azure Resource Provider bejegyzésének törlése.

## Példák

### 1. példa: az erőforrás-szolgáltató regisztrációjának megszüntetése a ProviderNamespace

```powershell
PS C:\>Unregister-AzResourceProvider -ProviderNamespace "Microsoft.support"
```

Ez a parancs a "Microsoft. support" erőforrás-szolgáltató regisztrációjának törlését teszi lehetővé.
