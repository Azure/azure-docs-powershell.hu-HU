...
ms.locfileid: "94024469"
---
# <span data-ttu-id="50851-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="50851-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="50851-102">Áttekintés</span><span class="sxs-lookup"><span data-stu-id="50851-102">SYNOPSIS</span></span>
<span data-ttu-id="50851-103">Az Azure Security Center által észlelt biztonsági riasztásokat kapja</span><span class="sxs-lookup"><span data-stu-id="50851-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="50851-104">SZINTAXISA</span><span class="sxs-lookup"><span data-stu-id="50851-104">SYNTAX</span></span>

### <span data-ttu-id="50851-105">SubscriptionScope (alapértelmezett)</span><span class="sxs-lookup"><span data-stu-id="50851-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="50851-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="50851-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="50851-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="50851-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="50851-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="50851-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="50851-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="50851-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="50851-110">Leírás</span><span class="sxs-lookup"><span data-stu-id="50851-110">DESCRIPTION</span></span>
<span data-ttu-id="50851-111">Az Azure Security Center által észlelt biztonsági riasztásokat kapja</span><span class="sxs-lookup"><span data-stu-id="50851-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="50851-112">Példák</span><span class="sxs-lookup"><span data-stu-id="50851-112">EXAMPLES</span></span>

### <span data-ttu-id="50851-113">Példa 1</span><span class="sxs-lookup"><span data-stu-id="50851-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="50851-114">Az előfizetésben szereplő erőforrásokban észlelt összes biztonsági riasztást kapja</span><span class="sxs-lookup"><span data-stu-id="50851-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="50851-115">2. példa</span><span class="sxs-lookup"><span data-stu-id="50851-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="50851-116">A "myService1" erőforráscsoporthoz tartozó erőforrásokban észlelt összes biztonsági figyelmeztetést kapja.</span><span class="sxs-lookup"><span data-stu-id="50851-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="50851-117">3. példa</span><span class="sxs-lookup"><span data-stu-id="50851-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="50851-118">A "myService1" erőforráscsoporthoz tartozó erőforrásokban észlelt speciális biztonsági figyelmeztetést kap</span><span class="sxs-lookup"><span data-stu-id="50851-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="50851-119">PARAMÉTEREK</span><span class="sxs-lookup"><span data-stu-id="50851-119">PARAMETERS</span></span>

### <span data-ttu-id="50851-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="50851-120">-DefaultProfile</span></span>
<span data-ttu-id="50851-121">Az Azuretal való kommunikációhoz használt hitelesítő adatok, fiók, bérlői fiók és előfizetés.</span><span class="sxs-lookup"><span data-stu-id="50851-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="50851-122">-Hely</span><span class="sxs-lookup"><span data-stu-id="50851-122">-Location</span></span>
<span data-ttu-id="50851-123">Helyre.</span><span class="sxs-lookup"><span data-stu-id="50851-123">Location.</span></span>
...
### <span data-ttu-id="50851-124">-Name (név)</span><span class="sxs-lookup"><span data-stu-id="50851-124">-Name</span></span>
<span data-ttu-id="50851-125">Erőforrás neve</span><span class="sxs-lookup"><span data-stu-id="50851-125">Resource name.</span></span>
...
### <span data-ttu-id="50851-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="50851-126">-ResourceGroupName</span></span>
<span data-ttu-id="50851-127">Erőforráscsoporthoz tartozó név.</span><span class="sxs-lookup"><span data-stu-id="50851-127">Resource group name.</span></span>
...
### <span data-ttu-id="50851-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="50851-128">-ResourceId</span></span>
<span data-ttu-id="50851-129">Erőforrás-azonosító.</span><span class="sxs-lookup"><span data-stu-id="50851-129">Resource ID.</span></span>
...
### <span data-ttu-id="50851-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="50851-130">CommonParameters</span></span>
<span data-ttu-id="50851-131">Ez a parancsmag a következő általános paramétereket támogatja:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-,-PipelineVariable-WarningAction</span><span class="sxs-lookup"><span data-stu-id="50851-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="50851-132">További információt a [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)című témakörben talál.</span><span class="sxs-lookup"><span data-stu-id="50851-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="50851-133">BEMENETEK</span><span class="sxs-lookup"><span data-stu-id="50851-133">INPUTS</span></span>

### <span data-ttu-id="50851-134">System. String</span><span class="sxs-lookup"><span data-stu-id="50851-134">System.String</span></span>

## <span data-ttu-id="50851-135">KIMENETEK</span><span class="sxs-lookup"><span data-stu-id="50851-135">OUTPUTS</span></span>

### <span data-ttu-id="50851-136">Microsoft. Azure. commands. Security. models. riasztások. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="50851-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="50851-137">MEGJEGYZI</span><span class="sxs-lookup"><span data-stu-id="50851-137">NOTES</span></span>

## <span data-ttu-id="50851-138">KAPCSOLÓDÓ HIVATKOZÁSOK</span><span class="sxs-lookup"><span data-stu-id="50851-138">RELATED LINKS</span></span>
