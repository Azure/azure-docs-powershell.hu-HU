...
## Áttekintés
Lekérdezi egy meglévő szabály definícióját egy adott előfizetésben a témakörben. 
...
## Leírás
A **Get-AzServiceBusRule** parancsmag a megadott szabály leírását az adott előfizetésben kapja meg.
