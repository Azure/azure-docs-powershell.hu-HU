...
## Leírás
A **New-AzServiceBusSubscription** parancsmag új előfizetést hoz létre a megadott buszjárati témakörhöz.
...
Az az érték, amely azt jelzi, hogy az előfizetéshez tartozik-e a szűrő kiértékelésének kivételeinek támogatása.
...
### -RequiresSession
RequiresSession – az az érték, amely azt jelzi, hogy a várólistán ismétlődő észlelés szükséges.
