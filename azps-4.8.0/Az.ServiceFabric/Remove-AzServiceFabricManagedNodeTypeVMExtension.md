...
## Leírás
A VM kiterjesztés eltávolítása a csomópont típusától név szerint. Használja a [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) , és tekintse meg a VmExtensions tulajdonságot, és tekintse meg a csomópont típusának aktuális kiterjesztését.
...
A kiterjesztés eltávolítása a csomópont típusáról név szerint
...
A csomópont-típus kiterjesztését név szerint távolíthatja el a csövekkel.
