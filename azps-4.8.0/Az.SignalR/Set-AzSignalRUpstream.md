...
A következő JSON a tényleges sablonokat adja meg. 
...
### Az összes upstream beállítás törlése
```powershell
...
### -Clear (Törlés)
Törölje a jelet az összes upstream beállításból.
...
### -Sablon
Sablon elem (ek) a upstream beállításokhoz.
Kötelező kulcs: UrlTemplate.
Választható billentyűk: HubPattern, EventPattern, CategoryPattern.
Példa: splatting: @ {UrlTemplate = ' http://host-connections1.com ', HubPattern = ' csevegés '; EventPattern = ' Broadcast '}, @ {UrlTemplate = ' http://host-connections2.com '}
...
### Microsoft. Azure. Command. Signal. models. PSServerlessUpstreamSettings

## MEGJEGYZI

## KAPCSOLÓDÓ HIVATKOZÁSOK

[Paraméterek továbbítása a PowerShellben a splatting használatával](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
