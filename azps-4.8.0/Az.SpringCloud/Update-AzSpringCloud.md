...
### 1. példa: a tavaszi Felhőbeli szolgáltatás frissítése név szerint.
```powershell
...
Frissítse a tavaszi felhő szolgáltatását név szerint.

### 2. példa: a tavaszi felhő szolgáltatás frissítése a pipe-ról
```powershell
...
Frissítse a tavaszi felhő szolgáltatását a pipe-ról.
...
### -Címke
A szolgáltatás címkéi, amelyek az erőforrást leíró kulcspárt tartalmazó párok listáját tartalmazzák.
...
### -TraceAppInsightInstrumentationKey
Célalkalmazás Insight Instrumentation-kulcs
...
### -TraceEnabled
Azt jelzi, hogy engedélyezve van-e a nyomkövetési funkció?
...
### Microsoft. Azure. PowerShell. parancsmagok. SpringCloud. modellek. Api20190501Preview. IServiceResource
