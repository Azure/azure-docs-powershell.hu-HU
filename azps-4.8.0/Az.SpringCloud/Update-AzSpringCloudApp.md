...
### 1. példa: a tavaszi felhő alkalmazás frissítése név szerint.
```powershell
...
Frissítse a tavaszi felhő alkalmazást név szerint.

### 2. példa: a tavaszi felhő alkalmazás frissítése a pipe-ról
```powershell
...
A tavaszi felhő alkalmazás frissítése a pipe-ról

## PARAMÉTEREK

### -ActiveDeploymentName
Az alkalmazás aktív bevezetésének neve
...
### -HttpsOnly
Annak jelzése, hogy csak HTTPS engedélyezett.
...
### -Hely
Az alkalmazás földrajzi helye mindig ugyanaz, mint a szülő-erőforrás
...
Az állandó lemez csatlakoztatási útja
...
Az állandó lemez mérete GB-ban
...
### – Nyilvános
Azt jelzi, hogy az alkalmazás kiteszi-e a nyilvános végpontot
...
Az ideiglenes lemez csatlakoztatási útvonala
...
Az ideiglenes lemez mérete GB-ban
...
### Microsoft. Azure. PowerShell. parancsmagok. SpringCloud. modellek. Api20190501Preview. IAppResource
