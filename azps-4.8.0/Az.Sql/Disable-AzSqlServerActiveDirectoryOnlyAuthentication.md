...
### UseResourceGroupAndServerNameParameterSet (alapértelmezett)
```
...
## Leírás
A **disable-AzSqlServerActiveDirectoryOnlyAuthentication** parancsmag letiltja az Azure Active Directoryt (Azure ad) az aktuális előfizetéshez tartozó AzureSQL-kiszolgálók hitelesítési követelményeihez.
...
Ez a parancs letiltja az Azure Active Directoryt (Azure AD) csak a ResourceGroup01 nevű Server01 társított AzureSQL-kiszolgáló hitelesítési követelményét.
...
### -InputObject
A használni kívánt SQL Server-objektum.
...
### -Kiszolgálónév
Annak az Azure SQL Server-kiszolgálónak a neve, amelyen az Azure Active Directory csak a hitelesítést használja.
...
### Microsoft. Azure. Command. SQL. ServerActiveDirectoryAdministrator. Model. AzureSqlServerActiveDirectoryOnlyAuthenticationModel
