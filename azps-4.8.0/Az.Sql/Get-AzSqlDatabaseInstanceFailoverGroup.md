...
## Leírás
Beolvassa a konkrét példány-feladatátvételi csoportot, vagy felsorolja a példány feladatátvételi csoportját a felhasználó előfizetése alá tartozó régióban.

A parancs végrehajtásához a példány-feladatátvételi csoport bármely területe használható. A visszaadott értékek az adott régióban lévő felügyelt példányok állapotát tükrözik a példány-feladatátvételi csoporttal kapcsolatban.
...
A régió összes feladatátvételi csoportjának felsorolása
...
Konkrét példány-feladatátvételi csoport beszerzése
...
### -Name (név)
A lekérdezni kívánt példány-feladatátvételi csoport neve.
