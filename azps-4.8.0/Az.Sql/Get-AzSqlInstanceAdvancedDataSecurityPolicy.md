...
## Leírás
A **Get-AzSqlInstanceAdvancedDataSecurityPolicy** parancsmag a felügyelt példány speciális adatbiztonsági házirendjének lekérdezését kéri.

## Példák

### 1. példa: a felügyelt példány speciális adatbiztonsága
```powershell
...
### 2. példa: a felügyelt példány speciális adatbiztonsága a felügyelt példányok erőforrásból
```powershell
