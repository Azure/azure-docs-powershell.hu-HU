...
## Leírás
A **Get-AzSqlInstanceDatabaseGeoBackup** parancsmag egy vagy több Azure SQL-adatbázisból redundáns biztonsági mentést kap egy Azure SQL-adatbázisból felügyelt példányról.

## Példák

### Példa 1: az adatbázis redundáns biztonsági mentése példányban
```
...
Ez a parancs a managedInstance1 nevű példányban minden redundáns biztonsági mentést kap.

### 2. példa: az adatbázis redundáns biztonsági másolatának beszerzése név alapján egy felügyelt példányon
```
...
Ez a parancs a managedDatabase1 nevű adatbázis redundáns biztonsági másolatát egy managedInstance1 nevű példányból kapja meg.

### 3. példa: az adatbázis redundáns biztonsági másolatának beszerzése szűréssel
```
...
Ez a parancs minden olyan redundáns biztonsági másolatot kap, amely a managedInstance1 nevű példányban a "managedDatabase" kezdetű.
...
### -Name (név)
A lekérdezni kívánt példány-adatbázis neve.
