...
## Leírás
Az Get-AzSqlInstanceOperation parancsmag információt kap az SQL-alapú felügyelt példány műveleteiről. A művelet nevének megadásával megtekintheti az összes műveletet egy felügyelt példányban, vagy megtekintheti az adott műveletet.

## Példák

### Példa 1: az összes példány műveleteinek beolvasása
```powershell
...
Ez a parancs minden műveletet SQL-kezelt példányként kap.

### 2. példa: speciális művelet beszerzése
```powershell
...
Ez a parancs SQL-alapú felügyelt példányban a "5870c6d8-6703-4b27-8ae4-687b4ca7caea" névvel lép működésbe.

### 3. példa: műveleti erőforrás azonosítójának használata
```powershell
...
Ez a parancs a '/subscriptions/a8c9a924-06c0-4bde-9788-e7b1370969e1/resourceGroups/ps3753/providers/Microsoft.Sql/managedInstances/ps3698/operations/5870c6d8-6703-4b27-8ae4-687b4ca7caea ' azonosítójú azonosítóval működik.
...
### -ResourceId
A felügyelt példány műveleti erőforrás-azonosítója.
...
### Microsoft. Azure. Command. SQL. ManagedInstanceOperation. Model. AzureSqlManagedInstanceOperationModel
