...
## Leírás
A **Get-AzSqlServer** parancsmag információt ad egy vagy több Azure SQL-adatbázis-kiszolgálóról.
...
### Példa 4: az összes SQL Server-példány beolvasása egy erőforráscsoport használatával szűréssel
```
...
Ez a parancs információt kap a "kiszolgálóval" kezdődő erőforráscsoport-ResourceGroup01 társított összes Azure SQL-adatbázis-kiszolgálóról.
