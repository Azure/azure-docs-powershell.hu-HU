...
## Leírás
A **Get-AzSqlServerAdvancedDataSecurityPolicy** parancsmag a kiszolgáló speciális adatbiztonsági házirendjének lekérdezését kéri.

## Példák

### Példa 1: a kiszolgáló speciális adatbiztonsága
```powershell
...
### 2. példa: a kiszolgáló speciális adatbiztonsága a kiszolgálói erőforrásból
```powershell
