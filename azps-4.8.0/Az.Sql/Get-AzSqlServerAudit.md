...
## Leírás
A **Get-AzSqlServerAudit** parancsmag az Azure SQL Server-kiszolgálók naplózási beállításait kapja meg.
...
### 2. példa: az Azure SQL Server naplózási beállításainak beolvasása csővezetéken keresztül
```
...
### 3. példa: az Azure SQL Server naplózási beállításainak beszerzése
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
