...
### Példa 1: a Szinkronizáló séma beszerzése központi adatbázishoz
```powershell
...
### 2. példa: a Szinkronizáló séma beszerzése egy központi adatbázishoz és a táblázatok kibontása
```powershell
...
### 3. példa: a szinkronizálási séma beszerzése egy tag-adatbázishoz
```powershell
