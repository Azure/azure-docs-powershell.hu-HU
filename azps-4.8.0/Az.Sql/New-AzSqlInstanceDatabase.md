...
### CreateNewInstanceDatabaseFromInputParameters (alapértelmezett)
```
...
## Leírás
A **New-AzSqlInstanceDatabase** parancsmag egy Azure SQL Managed instance-adatbázist hoz létre.

## Példák

### Példa 1: adatbázis létrehozása megadott példányban
```
...
Ez a parancs létrehoz egy Database01 nevű példány-adatbázist, például a managedInstance1.
...
### -Szétválogatás
Az Azure SQL-példányok adatbázis-egybevetésének szétválogatása.
...
### -Name (név)
A létrehozandó Azure SQL-példány-adatbázis neve.
...
### -Címke
Az Azure SQL instance adatbázisához társítani kívánt Címkék
