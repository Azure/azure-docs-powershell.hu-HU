...
## Leírás
Új Azure SQL Server DNS-Alias létrehozása, amely a megadott kiszolgálón van mutatva.
...
Ez a parancs Azure SQL Server DNS-aliast hoz létre a kiszolgáló kiszolgálónév nevű aliasName.
