...
### Példa 1: egyetlen biztonsági másolat törlése erőforráscsoporthoz
```powershell
...
Törli a biztonsági másolatot a név 601061b7-d10b-46e0-bf77-a2bfb16a6add; 131655666550000000
...
### 3. példa: egy hely minden biztonsági mentésének törlése
```powershell
...
Ez a parancs törli a hosszú távú adatmegőrzési biztonsági mentéseket a northeurope helyéhez.
...
### -InputObject
Az adatbázis hosszú távú adatmegőrzési objektuma eltávolításra készül.
...
### -Kiszolgálónév
Annak az Azure SQL Server-kiszolgálónak a neve, amelyben a biztonsági másolat található.
