...
## Leírás
A **Remove-AzSqlServerAudit** parancsmag eltávolítja az Azure SQL Server-kiszolgálók naplózási beállításait.
Adja meg a kiszolgáló azonosítóját a *ResourceGroupName* és a *kiszolgálónév* paraméterben.

## Példák

### 1. példa: az Azure SQL Server naplózási beállításainak eltávolítása
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### 2. példa: az Azure SQL Server-kiszolgálók naplózási beállításainak eltávolítása a csővezetéken keresztül
```
