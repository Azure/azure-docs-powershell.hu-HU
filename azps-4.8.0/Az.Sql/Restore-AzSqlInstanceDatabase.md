...
## Leírás
A **Restore-AzSqlInstanceDatabase** parancsmag egy példány adatbázisát a Geo-redundáns biztonsági másolatból, az időpontból az aktív adatbázisból vagy hosszú távú adatmegőrzési biztonsági másolatból állítja vissza.
...
### 4. példa: a törölt példányok adatbázisának visszaállítása időpontból
```
...
Az első parancs a törölt példányok "D1" nevű adatbázisát (például "managedInstance1") kapja.
A második parancs visszaállítja a meghívott adatbázist a megadott időpontos biztonsági másolatról a Database01_restored nevű adatbázisra.

### Példa 5: a törölt példányok adatbázisának visszaállítása időpontból
```
PS C:\> $deletedDatabase = Get-AzSqlDeletedInstanceDatabaseBackup -ResourceGroupName "ResourceGroup01" -InstanceName "managedInstance1" -DatabaseName "DB1"
...
Az első parancs a törölt példányok "D1" nevű adatbázisát (például "managedInstance1") kapja.
A második parancs visszaállítja a beolvasott adatbázist a megadott időpontos biztonsági másolatról a "beviteli objektum" Database01_restored nevű adatbázisra.

### 6. példa: adatbázis visszaállítása a LTR biztonsági másolatból.
```
...
Visszaállítja a LTR biztonsági másolatát a megadott erőforrás-AZONOSÍTÓval (amely a Get-AzSqlInstanceDatabaseLongTermRetentionBackup futtatásával érhető el).
