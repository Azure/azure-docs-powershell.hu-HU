...
## Leírás
Ez a parancs módosítja egy példány-feladatátvételi csoport konfigurációját.
...
### -InputObject
A megadni kívánt példány-feladatátvételi csoport objektuma
...
### -ResourceId
A beállítani kívánt példány-feladatátvételi csoport erőforrás-azonosítója.
