...
## Leírás
Az **Update-AzSqlSyncGroup** parancsmag az Azure SQL-adatbázis szinkronizálási tagjainak tulajdonságait módosítja.
...
Ez a parancs visszaállítja a tag-adatbázis rendszergazdai jelszavát.
...
A szinkronizálási tag adatbázisának azonosítója, amelyet akkor kell használni, ha a UsePrivateLinkConnection értéke igaz.
...
Szeretné-e a privát hivatkozást használni a szinkronizálási tagra való csatlakozáskor.
