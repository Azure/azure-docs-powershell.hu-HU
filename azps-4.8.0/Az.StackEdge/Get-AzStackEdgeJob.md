...
## Leírás
A **Get-AzStackEdgeJob** parancsmag az aktív feladatokat egy halom szélén álló eszközön kapja meg. Megemlítheti a Name (név) paramétert egy adott feladat részleteinek beolvasásához.
...
### Microsoft. Azure. PowerShell. parancsmagok. StackEdge. models. PSStackEdgeJob
