...
## Leírás
A **Get-AzStackEdgeStorageAccountCredential** parancsmag a megfelelő tárterület-fiók hitelesítő adatait a halom szélén lévő eszközön kapja meg. Megadhatja a név, az erőforráscsoport neve és az eszköz neve paramétert, amellyel információkat kaphat egy adott tárolási fiók hitelesítő adatairól.
...
### -Name (név)
A használandó tárterület-fiók neve
...
### Microsoft. Azure. PowerShell. parancsmagok. StackEdge. models. PSStackEdgeStorageAccountCredential
