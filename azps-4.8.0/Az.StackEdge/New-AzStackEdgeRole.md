...
### ConnectionStringParameterSet (alapértelmezett)
```
...
## Leírás
A **New-AzStackEdgeRole** parancsmag új szerepkört hoz létre egy halom szélén álló eszközhöz.
...
### -ConnectionString
Kapcsolati karakterláncok megadása
...
### -DeviceProperty
Az eszközök tulajdonságainak megadása
...
### -EncryptionKey
Az Edge-eszköz titkosítási kulcsa
...
Adja meg a IOT-eszköz kapcsolati karakterláncát.
...
Az IOT Edge eszköz elérési kulcsa
...
Adja meg a kapcsolati karakterláncot az Edge-eszközön
...
### -Platform
A platform beállítása az ex: Linux rendszerhez
...
### -RoleStatus
Az állapot engedélyezése/letiltása
...
### Microsoft. Azure. PowerShell. parancsmagok. StackEdge. models. PSStackEdgeRole
