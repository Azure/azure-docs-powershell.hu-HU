...
## Leírás
A **Get-AzStorageAccountManagementPolicy** parancsmag egy Azure-tárterületet tároló fiók kezelési házirendjét kapja meg.

## Példák

### Példa 1: a tárolási fiók kezelési házirendjének beszerzése.
```
...
Ez a parancs a tárolási fiók kezelési házirendjét kapja meg.
