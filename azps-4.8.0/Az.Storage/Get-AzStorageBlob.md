...
### Példa 5: a tároló összes blobjának beolvasása blob-verzióval
```
...
Ez a parancs a tárolóban található összes blobot beilleszti a blob-verzióba.

### Példa 6: egyetlen blob-verzió beszerzése
```
...
Ez a parancs a VersionId-nal egyetlen bináris verzióját kap.

### 7. példa: egyetlen blob-pillanatfelvétel beszerzése
```
...
Ez a parancs egyetlen blob-pillanatfelvételt kap a SnapshotTime.
...
Ha meg van adva egy érték a paraméterhez, a parancsmag az összes olyan blobot felsorolja, amely megfelel a paraméternek. Ez a paraméter a karakterláncban bárhol a helyettesítő karaktereket támogatja.
...
### -IncludeVersion
A blob-verziók csak akkor jelennek meg a listában, ha ez a paraméter létezik, alapértelmezés szerint a blob nem tartalmaz blob-verziókat.
