...
## Leírás
A **New-AzRmStorageShare** parancsmag eltávolítja a tárterület-megosztást.

## Példák

### 1. példa: tárterület-megosztás eltávolítása a tárolási fiók nevével és a megosztási névvel
```
PS C:\>Remove-AzRmStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" -Name "myshare"
```

Ez a parancs eltávolítja a tárterület-megosztást a tárolási fiók nevével és a megosztási névvel.

### 2. példa: tárterület-megosztás eltávolítása a Storage Account objektummal és a megosztási névvel
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Ez a parancs eltávolítja a tárterület-megosztást a Storage Account objektummal és a megosztási névvel.

### 3. példa: az összes tárterület-megosztás eltávolítása a tároló fiókban
```
PS C:\>Get-AzStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" | Remove-AzRmStorageShare -Force
```

Ez a parancs eltávolítja az összes tárterület-megosztást a tároló fiókban a csővezetéken.
...
### -Force
A megosztás és az összes tartalom eltávolításának kényszerítése
