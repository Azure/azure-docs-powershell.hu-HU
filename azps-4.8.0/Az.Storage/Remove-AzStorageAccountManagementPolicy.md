...
## Leírás
A **Remove-AzStorageAccountManagementPolicy** parancsmag eltávolítja az Azure Storage-fiók kezelési házirendjét.

## Példák

### 1. példa: a tárolási fiók kezelési házirendjének eltávolítása.
```
PS C:\>Remove-AzStorageAccountManagementPolicy -ResourceGroupName "MyResourceGroup" -AccountName "mystorageaccount"
```

Ez a parancs eltávolítja a tárolási fiók kezelési házirendjét.
...
### -InputObject
Eltávolítandó felügyeleti objektum
