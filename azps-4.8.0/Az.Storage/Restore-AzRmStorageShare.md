...
## Leírás
A **Restore-AzRmStorageShare** parancsmag érvényes adatmegőrzési napokon belül visszaállítja a törölt fájlok megosztását, ha engedélyezve van a Soft delete használata.
...
Ez a parancs először törli a fájlokat, majd felsorolja a megosztásokat, és megtekinti a törölt megosztási verziót, végül visszaállítja a normál megosztást. A megosztás törlése előtt engedélyeznie kell a "Soft Delete" (frissítés – AzStorageFileServiceProperty) lehetőséget.
...
### -DeletedShareVersion
Törölt megosztási verzió, amelyet vissza fog állítani.
...
### -Name (név)
Törölt megosztás neve, amelyet vissza fog állítani.
