...
### 3. példa: ImmutabilityPolicy frissítése
```
...
Ez a parancs a ImmutabilityPolicy 3 alkalommal frissíti a tárterület-tároló blob-tárolóját, így a ImmutabilityPeriod 12 napig nem ETAG, majd a ImmutabilityPeriod 9 napig tart a ETAG, végül a AllowProtectedAppendWrite.
...
Ezt a tulajdonságot csak a zárolt időalapú adatmegőrzési házirendek esetében lehet módosítani. Ezzel a tulajdonsággal engedélyezve van az új blokkok hozzáfűzése a immutability-védelem és a megfelelőség megőrzése mellett. Csak az új blokkok adhatók hozzá, és a meglévő blokkok nem módosíthatók vagy törölhetők.
