...
## Leírás
Az **Update-AzSubscription** parancsmag Azure-előfizetést frissít
...
```
Az előfizetés frissítése

## PARAMÉTEREK

### -Műveletek
Az előfizetésben végrehajtandó művelet
...
### -SubscriptionId
Frissítendő előfizetési azonosító
