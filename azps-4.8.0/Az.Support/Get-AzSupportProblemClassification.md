...
## Áttekintés
A megadott szolgáltatáshoz tartozó probléma-besorolások beszerzése
...
### Példa 1: a szolgáltatáshoz tartozó összes probléma classificaitons a Service ID paraméter használatával.
```powershell
...
### 2. példa: a szolgáltatáshoz tartozó összes probléma classificaitons a szülő Service objektummal
```powershell
...
### 3. példa: egyetlen probléma részleteit classificaiton a csőhálózat által az azonosító szerint
```powershell
...
### -Azonosító
Probléma besorolási azonosítója
...
### -ServiceId
Annak a szolgáltatásnak az azonosítója, amelyhez minden probléma besorolását beolvasták.
...
### -ServiceObject
A szolgáltatási objektum, amelyre a probléma besorolását kéri.
