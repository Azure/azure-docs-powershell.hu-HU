...
## Áttekintés
Egy támogatási partnercsoport-objektumot hoz létre.
...
## Leírás
Ez egy olyan segítő parancsmag, amellyel támogatási jegy létrehozásakor vagy frissítésekor létrehozhatja az ügyfélszolgálati profil objektumát. A támogatási jegy létrehozásához kötelezően meg kell adnia az alábbi paramétereket: 
...
### 1. példa: Partnercsoport létrehozása
```powershell
