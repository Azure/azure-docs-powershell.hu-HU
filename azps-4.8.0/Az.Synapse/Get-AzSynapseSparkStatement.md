...
### GetSparkStatementsByIdParameterSet (alapértelmezett)
```
...
## Leírás
A **Get-AzSynapseSparkStatement** parancsmag információkat kap az Azure szinapszis Analytics Spark utasításról.
...
Ez a parancs a szikra-munkamenet alatt minden szikra kijelentést megkapja.
...
Ez a parancs a megadott Livius-AZONOSÍTÓval kapja meg a szikra utasítását.
...
Ez a parancs az összes szikra kijelentését beilleszti a folyamaton keresztül egy szikra fázisba.
...
### Microsoft. Azure. commands. szinapszis. models. PSSynapseSparkStatement
