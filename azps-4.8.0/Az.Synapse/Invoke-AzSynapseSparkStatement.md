...
## Leírás
A **meghívó-AzSynapseSparkStatement** parancsmag a szinapszis-elemző szikra utasítását hívja fel.
...
Ezek a parancsok olyan szikra-munkamenetet indítanak, amely egy szövegközi külső bejelentést hoz létre a csővezetéken keresztül.
...
Ezekkel a parancsokkal egy szikra-munkamenetet indíthat, majd hivatkozhat egy szövegközi szikra utasításra.
...
Ezek a parancsok olyan szikra-munkamenetet indítanak, amely egy fájlban a szikra kijelentéseit hívja fel.
...
### – Válasz
A teljes választ adja eredményül.
...
### -Munkamenet
A szikra munkamenet azonosítója
...
### -SessionObject
A szikra-munkamenet bemeneti objektuma, amely általában áthalad a csővezetéken.
...
### Microsoft. Azure. commands. szinapszis. models. PSSynapseSparkSession

## KIMENETEK

### Microsoft. Azure. commands. szinapszis. models. PSSynapseExtendedSparkStatement
