...
## Áttekintés
Egy szinapszis-Analytics SQL-adatbázis törlése
...
## Leírás
A **Remove-AzSynapseSqlPool** parancsmag véglegesen törli az Azure SZINAPSZIS Analytics SQL-adatbázisát.
...
Ez a parancs törli az Azure szinapszis Analytics SQL-adatbázisát.
...
Ez a parancs egy Azure szinapszis-Analytics SQL-adatbázist csővezetéken keresztül töröl.
...
Ez a parancs törli az Azure szinapszis-Analytics SQL-adatbázisát a megadott erőforrás-AZONOSÍTÓval.
...
### -InputObject
SQL-adatbázis bemeneti objektuma, általában áthalad a csővezetéken.
