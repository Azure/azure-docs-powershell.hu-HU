...
## Leírás
A **set-AzSynapseTrigger** parancsmag létrehoz egy triggert egy munkaterületen. Az eseményindítók a "leállt" állapotban jönnek létre, ami azt jelenti, hogy nem azonnal kezdenek hivatkozni a rájuk hivatkozó csővezetékekre.
...
Hozzon létre egy ContosoTrigger nevű új triggert a munkaterület ContosoWorkspace. Az trigger a "leállt" állapotban jön létre, ami azt jelenti, hogy az nem azonnal indul el. Az indítót a parancsmag használatával indíthatja el `Start-AzDataFactoryV2Trigger` .
...
Hozzon létre egy ContosoTrigger nevű új triggert a munkaterület ContosoWorkspace a csővezetéken keresztül. Az trigger a "leállt" állapotban jön létre, ami azt jelenti, hogy az nem azonnal indul el. Az indítót a parancsmag használatával indíthatja el `Start-AzDataFactoryV2Trigger` .
