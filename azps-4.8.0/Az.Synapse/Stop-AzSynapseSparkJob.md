...
### StopSparkJobByIdParameterSet (alapértelmezett)
```
...
## Leírás
A **stop-AzSynapseSparkJob** parancsmag lemondja a szinapszis-elemző szikra munkát.
...
Ez a parancs lemondja a szinapszis-elemző szikra munkát.
...
Ez a parancs lemondja a szinapszis-elemző Spark-feladatot a csővezetéken keresztül.
