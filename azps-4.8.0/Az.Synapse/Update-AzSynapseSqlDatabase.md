...
## Áttekintés
A szinapszis Analytics SQL-adatbázis frissítése
...
## Leírás
Az **Update-AzSynapseSqlDatabase** parancsmag egy Azure szinapszis-Analytics SQL-adatbázist frissít.
...
Ez a parancs frissíti az Azure szinapszis Analytics SQL-adatbázisát.
