...
### 1. példa: az összes eseményforrás listázása a megadott környezetben
```powershell
...
Ez a parancs felsorolja az összes eseményforrás a megadott környezetben.

### 2. példa: megadott eseményforrás beszerzése név alapján
```powershell
...
Ez a parancs egy adott esemény forrását kapja.

### 3. példa: meghatározott eseményforrás beszerzése objektum alapján
```powershell
...
### -Name (név)
A megadott környezethez társított idősorozat-adatforrások neve.
