...
### Példa 1: hozzáférési házirend létrehozása meghatározott környezethez
```powershell
...
Ez a parancs egy meghatározott környezethez hoz létre hozzáférési házirendet.
...
### -PrincipalObjectId
A objectId az Azure Active Directoryban.
