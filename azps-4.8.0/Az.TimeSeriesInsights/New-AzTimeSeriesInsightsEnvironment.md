...
### Példa 1: Gen1-idősorozat létrehozása – elemzések környezete
```powershell
...
Ez a parancs Gen1-adatsort hoz létre a betekintési környezetben.

### 2. példa: Gen2-idősorozat létrehozása – környezet
```powershell
...
Ez a parancs Gen2-adatsort hoz létre a betekintési környezetben.
...
### -Kapacitás
Az SKU kapacitása.
A Gen1-környezetek esetében ezt az értéket úgy módosíthatja, hogy a létrehozásuk után is támogassa a környezetek méretét.
...
Az esemény tulajdonságainak listája, amelyet a környezet adatainak particionálásakor fog használni.
A kivitelezéshez tekintse meg a PARTITIONKEYPROPERTY tulajdonságainak megjegyzések szakaszát, és hozzon létre egy ujjlenyomat-táblázatot.
...
### -StorageAccountKey
Annak a kezelési kulcsnak az értéke, amely az idősorozat-betekintést nyújtja, a tárolási fiókhoz írási hozzáférést biztosít.
...
### -StorageAccountName
Annak a tárolási fióknak a neve, amely a környezet hosszú távú adatait fogja tárolni.
...
Az idősorozat-betekintési szolgáltatás működése a környezet kapacitásának túllépése esetén
...
Az esemény tulajdonságainak listája, amelyet a környezet idősorozat-azonosítójának definiálására fog használni. A kivitelezéshez tekintse meg a TIMESERIESIDPROPERTY tulajdonságainak megjegyzések szakaszát, és hozzon létre egy ujjlenyomat-táblázatot.
...
A ISO8601 időszak adja meg, hogy hány napig maradnak elérhetők a környezet eseményei a meleg áruházban elérhető lekérdezésekhez.
...
### Microsoft. Azure. PowerShell. parancsmagok. TimeSeriesInsights. modellek. Api20200515. IEnvironmentResource
...
PARTITIONKEYPROPERTY <ITimeSeriesIdProperty [] >: az esemény tulajdonságainak listája, amelyet a környezet adatainak particionálásakor fog használni.
  - `[Name <String>]`: A tulajdonság neve.
  - `[Type <PropertyType?>]`: A tulajdonság típusa.

TIMESERIESIDPROPERTY <ITimeSeriesIdProperty [] >: az esemény tulajdonságainak listája, amelyet a környezet idősorozat-azonosítójának definiálására fog használni.
  - `[Name <String>]`: A tulajdonság neve.
  - `[Type <PropertyType?>]`: A tulajdonság típusa.
