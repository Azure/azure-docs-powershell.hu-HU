...
## Leírás
A **Get-AzAppServicePlanMetric** elérhetővé válik az App Service Plan mérőszámai.
...
Ez a parancs az App-csomag (PT1M-szavazási idő 1 perc) CPU-százalékát kapja meg a kezdő időpont és a Befejezés között
...
### Microsoft. Azure. Command. WebApps. models. WebApp. PSAppServicePlan
