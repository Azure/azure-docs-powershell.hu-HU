...
## Áttekintés
Útválasztási szabály eltávolítása a bővítőhelyről
...
## Leírás
A **Remove-AzWebAppTrafficRouting** parancsmag az Azure Web App-bővítőhelyről eltávolítja az útválasztási szabályt.

## Példák

### Példa 1 az adott útválasztási szabály eltávolítása a WebApp bővítőhelyről
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Ez a parancs eltávolítja az adott WebApp-bővítőhelyhez tartozó útválasztási szabályt.
