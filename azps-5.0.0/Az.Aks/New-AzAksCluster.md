...
A Windows VMs-szolgáltatáshoz használt rendszergazdai jelszónak legalább 12-nek kell lennie, amely legalább egy kisbetűs karaktert tartalmaz, azaz `[a-z]` egy `[A-Z]` és egy speciális karaktert `[!@#$%^&_()]` .
