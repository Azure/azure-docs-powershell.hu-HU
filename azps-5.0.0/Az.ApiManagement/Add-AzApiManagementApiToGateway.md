...
## Leírás
Az **Add-AzApiManagementApiToGateway** parancsmag egy Azure API-kezelési API-t ad az átjárónak.
...
### System. nulla ' 1 [[Microsoft. Azure. commands. ApiManagement. ServiceManagement. models. PsApiManagementGatewayApiProvisioningState, Microsoft. Azure. PowerShell. parancsmagok. ApiManagement. ServiceManagement, Version = 2.0.1.0, = semleges, PublicKeyToken = null]]
