...
A ClientSecret nem fog szerepelni az eredmény részletei között. Az ügyfél titkának beszerzéséhez használja a **Get-AzApiManagementAuthorizationServerClientSecret**.
...
### -ResourceId
Az engedélyezési kiszolgáló ARM erőforrás-azonosítója. Ha meg van adva, az azonosító alapján megpróbálja megtalálni az engedélyezési kiszolgálót. Ehhez a paraméterhez szükség van.
