...
## Leírás
A **Get-AzApiManagementGateway** PARANCSMAG az API-kezelési átjárókat kapja meg.

## Példák

### Példa 1: az összes átjáró beolvasása
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext
```

Ez a parancs beilleszti az összes átjárót.

### 2. példa: átjáró beszerzése AZONOSÍTÓval
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext -GatewayId "0123456789"
```

Ez a parancs a 0123456789 átjárót kapja.
...
### -GatewayId
Átjáró azonosítója
Ha meg van adva, az azonosító megkeresésével megpróbálja megtalálni az átjárót.
