...
## Leírás
A **Get-AzApiManagementOpenIdConnectProvider** parancsmag OpenID Connect-szolgáltatókat kap az Azure API-menedzsmentben.
A ClientSecret nem fog szerepelni az eredmény részletei között. Az ügyfél titkának beszerzéséhez használja a **Get-AzApiManagementOpenIdConnectProviderClientSecret**.
...
Ez a parancs a OICProvider01 AZONOSÍTÓját tartalmazó szolgáltatót kapja.
