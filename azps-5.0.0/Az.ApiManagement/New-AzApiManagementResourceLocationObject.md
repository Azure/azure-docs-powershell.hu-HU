...
## Leírás
A **New-AzApiManagementResourceLocationObject** parancsmag új erőforrás-tárolási szerződést hoz létre (az átjárókban használatos).

## Példák

### 1. példa: erőforrás-tárolási szerződés létrehozása
```powershell
PS C:\>$location = New-AzApiManagementResourceLocationObject -Name "n1" -City "c1" -District "d1" -CountryOrRegion "r1"
```

A parancs erőforrás-helyet hoz létre.
...
### -CountryOrRegion
Tartózkodási hely országa vagy régiója.
Ez a paraméter nem kötelező.
