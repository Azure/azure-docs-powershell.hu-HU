...
## Leírás
A **Remove-AzApiManagementGatewayHostnameConfiguration** parancsmag eltávolítja a gépnév konfigurációját a meglévő átjáróból.

## Példák

### 1. példa: meglévő átjáró-állomásnév konfigurációjának eltávolítása
```powershell
...
Ez a parancs eltávolítja a meglévő átjáró-állomásnevek konfigurációját, és nem kéri a felhasználótól a megerősítést.
...
A meglévő átjáró gépnév-konfigurációjának azonosítója.
Ehhez a paraméterhez szükség van.
...
### -InputObject
A PsApiManagementGatewayHostnameConfiguration példánya. Ehhez a paraméterhez szükség van.
...
### -ResourceId
A GatewayHostnameConfiguration kar ResourceId Ehhez a paraméterhez szükség van.
