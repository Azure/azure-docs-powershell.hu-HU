...
### 2. példa: API hozzáadása meglévő ApiVersionSet
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### 3. példa: a backend ServiceUrl megváltoztatása, ahol az API mutat
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Ebben a példában a ServiceUrl frissíti a `echo-api` mutatót.
