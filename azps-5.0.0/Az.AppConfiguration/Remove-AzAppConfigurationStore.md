...
### 1. példa: alkalmazás-konfigurációs tároló eltávolítása
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Ez a parancs eltávolítja az App Configuration Store áruházát.

### 2. példa: alkalmazás-konfigurációs áruház eltávolítása
```powershell
