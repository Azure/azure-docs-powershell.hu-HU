...
### Példa 1 a betekintési összetevő frissítése
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

a "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery "disabled" ("disabled") állapotának frissítése
...
A betekintési lenyelési adatok eléréséhez szükséges hálózati hozzáférés típusa.
Az értéknek "engedélyezve" vagy "Letiltva" kell lennie.
...
Az alkalmazások keresési lekérdezéséhez hozzáférő hálózati hozzáférés típusa.
Az értéknek "engedélyezve" vagy "Letiltva" kell lennie.
