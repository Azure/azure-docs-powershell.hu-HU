...
## Leírás
Az Get-AzAttestationPolicy parancsmag az Azure-tanúsítványban lévő bérlői fiókban kapja meg a házirendet.
...
Megkapja a házirendet a tanúsítvány-szolgáltató *pshtest* a Tee Type *SgxEnclave*.
...
Beolvassa a házirendet a tanúsítványok alapértelmezett szolgáltatójának: a *Dél-angol* (Tee) típusú *SgxEnclave*.
...
Ez a parancsmag a megadott bérlői tanúsítványra vonatkozó házirendet kapja meg.
...
### Microsoft. Azure. commands. igazolás. models. PSPolicy
