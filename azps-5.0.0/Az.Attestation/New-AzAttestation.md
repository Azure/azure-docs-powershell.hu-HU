...
## Leírás
Az New-AzAttestation parancsmag a megadott erőforráscsoport tanúsítványát hozza létre.
...
Hozzon létre egy *pshtest4* nevű tanúsítvány-szolgáltató új példányát egy pár címkével, és használja a aad Trust for mastering Tee Policy szolgáltatást.
...
Hozzon létre egy " *pshtest3* " nevű tanúsítvány-szolgáltató új példányát, amely a Isoladed megbízhatóságát használja a kisajátított Tee-házirendhez, a megbízható aláírási kulcsok halmazának megadásával egy PEM-fájlon keresztül.
...
### -Hely
Azt az Azure-területet adja meg, amelybe a tanúsítvány-szolgáltatót létre kívánja hozni. A ProviderNamespace paraméterrel Get-AzResourceProvider paranccsal megtekintheti a kívánt beállításokat.
...
### -Name (név)
A létrehozandó példány nevét adja meg.
A név lehet betűk, számjegyek és kötőjelek tetszőleges kombinációja.
A névnek betűvel vagy számmal kell kezdődnie.
...
A kibocsátási házirendhez tartozó megbízható aláírási kulcsok halmazát adja meg egyetlen tanúsítványfájl esetén.
...
### -ResourceGroupName
Annak a csoportnak a nevét adja meg, amelybe az igazolást létre szeretné hozni.
