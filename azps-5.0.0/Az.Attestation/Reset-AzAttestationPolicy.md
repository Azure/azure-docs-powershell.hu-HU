...
Ha a tanúsítvány-szolgáltató *pshtest* úgy van konfigurálva, hogy az izolált bizalmi modellt használja, a házirendet a Tee Type *SgxEnclave* alapértelmezett értékre kell állítania, ha az aláírt házirendet tartalmaz.
