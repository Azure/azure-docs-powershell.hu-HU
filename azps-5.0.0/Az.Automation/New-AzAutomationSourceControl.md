...
## Leírás
Az New-AzAutomationSourceControl parancsmag egy olyan konfigurációt hoz létre, amellyel az Azure automatizálási fiókját az VSTS-TFVC, a git vagy a GitHub VSTS kapcsolja össze.

## Példák

### Példa 1
Adatforrás-vezérlő konfiguráció létrehozása az Azure automatizálási fióknak a saját VSTS TFVC projekthez való csatolásához. Az TFVC-projekteknek nincsenek ágai, ezért a Branch paraméter nincs megadva.
...
### 2. példa
A verziókövetés konfigurációjának létrehozásával az Azure automatizálási fiókját összekapcsolhatja a saját VSTS git Project segítségével.
...
### 3. példa
Adatforrás-vezérlő konfiguráció létrehozása az Azure automatizálási fióknak a GitHub projectkel való összekapcsolásához
...
Ha a DoNotPublishRunbook be van állítva, az azt jelenti, hogy a felhasználói runbooks "piszkozatként" lesz importálva.
