...
## Leírás
A **stop-AzBatchCertificateDeletion** parancsmag lemond egy tanúsítvány sikertelen törléséről az Azure kötegfájl-szolgáltatásban.
Csak akkor állíthatja le a törlést, ha a tanúsítvány a **DeleteFailed** állapotban van.
Ez a parancsmag visszaállítja a tanúsítványt az **aktív** állapotra.

## Példák

### Példa 1: törlés megszüntetése
```
...
Ez a parancs törli a megadott ujjlenyomatot tartalmazó tanúsítvány törlését.
...
### -Ujjlenyomat
Annak a tanúsítványnak az ujjlenyomatát adja vissza, amelyre az adott parancsmag visszaállítja az **aktív** állapotot.
