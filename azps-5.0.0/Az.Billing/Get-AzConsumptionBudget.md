...
## Leírás
A Get-AzConsumptionBudget parancsmag egy előfizetésben vagy egy erőforráscsoport listájában kapja meg a költségvetéseket.

## Példák

### 1. példa: a költségvetések listájának beszerzése az előfizetési szinten
```powershell
...
### 2. példa: a költségvetések listájának beszerzése az erőforrás csoport szintjén
```powershell
...
### 3. példa: költségvetés beszerzése a költségvetés nevével az előfizetési szinten
```powershell
...
### Példa 4: költségvetés beszerzése a költségvetés nevével az erőforrás csoport szintjén
```powershell
