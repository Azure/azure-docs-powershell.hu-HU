...
### Példa 1: blockchain-tranzakció csomópont létrehozása
```powershell
...
Ez a parancs létrehoz egy blockchain-tranzakció csomópontot.
...
### -FirewallRule
A tűzfalszabályok beolvasása vagy visszaállítása.
A kivitelezéshez tekintse meg a FIREWALLRULE tulajdonságainak megjegyzések szakaszát, és hozzon létre egy ujjlenyomat-táblázatot.
...
### -Hely
A tranzakció csomópont helyét kapja vagy állítja be.
...
### -Jelszó
A Transaction node (DNS-végpont) alapvető hitelesítő jelszavának megadása
...
FIREWALLRULE <IFirewallRule [] >: beolvassa vagy beállítja a tűzfalszabályok szabályait.
