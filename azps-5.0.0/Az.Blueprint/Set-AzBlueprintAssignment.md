...
A terv definíciójának egy meglévő tervrajz-hozzárendelését frissítheti a `$blueprintObject` definiált paraméterrel meghatározott kezelési csoportban megadott előfizetésre.
