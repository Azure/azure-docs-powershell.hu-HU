...
## Leírás
A Get-AzCdnOriginGroup parancsmag egy CDN-származási csoportot keres.
...
Ez a parancs a megadott végponton belül a kezdőpont csoportot fogja kapni.
...
### -ResourceId
A származási csoport erőforrás-azonosítója
