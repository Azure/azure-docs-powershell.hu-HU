...
## Leírás
A New-AzCdnOrigin új CDN-forrást fog létrehozni a megadott végponton belül.
...
Ez a parancsmag új CDN-kezdőpontot hoz létre a megadott végponthoz. A megadott állomásnevet a forrásként fogja használni. 

## PARAMÉTEREK

### -CdnOrigin
A CDN Origin objektuma.
...
### -HostName (állomásnév)
Azure CDN Origin Host Name (név)
