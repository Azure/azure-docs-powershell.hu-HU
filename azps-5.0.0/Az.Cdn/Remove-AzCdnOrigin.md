...
## Leírás
A Remove-AzCdnOrigin egy CDN-kezdőpontot fog törölni a megadott végpontról. Ha a származási hely a megadott végponton belül az egyetlen eredete, akkor a törlés meghiúsul, mert legalább 1 származási pontra van szükség. 
...
```
Ez a parancsmag eltávolítja a megadott kezdőpontot az adott végpontról. 
