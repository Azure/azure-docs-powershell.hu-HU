...
## Leírás
A **New-AzCognitiveServicesAccount** parancsmag a megadott típusú és SKU-hoz létrehoz egy kognitív szolgáltatásokat tartalmazó fiókot.
...
### -ApiProperty
A ApiProperties (kognitív szolgáltatások) fiók. Bizonyos típusú fiókokhoz szükséges.
...
### -Hely
Azt a helyet adja meg, ahol létre szeretné hozni a fiókot.
...
### -PublicNetworkAccess
A kognitív szolgáltatások fiók hálózati hozzáférés típusa.
...
### -ResourceGroupName
Annak az erőforrás-csoportnak a nevét adja meg, amelyhez hozzá szeretné rendelni a fiókot.
Az erőforráscsoportnek már léteznie kell.
...
- S2
- S3
- S4 további tudnivalókért olvassa el a [kognitív szolgáltatás API](https://www.microsoft.com/cognitive-services/en-us/apis)-k című témakört.
...
### -Type (típus)
A létrehozandó fiók típusát adja meg. Használja `Get-AzCognitiveServicesAccountType` a parancsmagot a jelenlegi elfogadható értékek beolvasásához.
