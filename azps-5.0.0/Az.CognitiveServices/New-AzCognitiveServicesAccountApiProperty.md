...
## Áttekintés
A kognitív Services-fiók ApiProperties új példányának létrehozása
...
## Leírás
Hozza létre a kognitív Services-fiók ApiProperties új példányát.
Új fiók létrehozásakor vagy meglévő fiók frissítésekor használhatja a ApiProperties.
Az ApiProperties bizonyos típusú fiókokhoz szükséges.
...
A fenti példa létrehoz egy QnAMaker-fiókot, az API tulajdonság "QnaRuntimeEndpoint".
