...
## Leírás
A **Get-AzDiskAccess** parancsmag a Disk-hozzáférések tulajdonságait kapja meg

## Példák

### 1. példa: alapértelmezett paraméterérték használata 
```
...
Ez a parancs a "ResourceGroup01" erőforráscsoport "DiskAccess01" nevű Disk Access-erőforrásának tulajdonságait kapja meg.

### 2. példa: erőforráscsoport szerint Get-AzDiskAccess
```
...
Ez a parancs a "ResourceGroup01" erőforráscsoport erőforrás-elérési területének tulajdonságait kapja meg.


### 3. példa: az összes lemez elérésének beszerzése
```
...
Ez a parancs beolvassa az előfizetés alatti minden lemez tulajdonságait.

### Példa 4: az összes lemez elérésének beolvasása helyettesítő karakter használatával
```
...
Ez a parancs a "DiskAccessMicrosoft" karakterrel kezdődően az előfizetéses név alatti összes lemezen elérhető tulajdonságot kapja.

### Példa 5: a ResourceId használatával beolvashatja a Disk Accesst.
```
...
Ez a parancs beolvassa a lemez elérésének tulajdonságait a megadott ResourceId.
...
### -Name (név)
A lemez elérési útjának nevét adja meg.
...
### -ResourceId
A lemez eléréséhez szükséges erőforrás-azonosító.
