...
## Leírás
Ez a parancsmag egy állomást kap az állomás-csoportban.
Ez a parancsmag a Host-csoportok összes állomását is felsorolja, ha az állomásnév nincs megadva.
...
Ez a parancs egy állomást ad eredményül.
...
Ez a parancs egy állomás példányának nézetét számítja ki.
...
Ez a parancs visszaadja az adott házigazda csoport összes állomását.
...
### -InstanceView
Azt jelzi, hogy ez a parancsmag csak az állomás példány nézetét kapja meg.
