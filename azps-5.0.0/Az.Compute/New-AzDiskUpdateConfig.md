...
## Leírás
A **New-AzDiskUpdateConfig** parancsmag egy konfigurálható Disk Update-objektumot hoz létre.
...
### -DiskMBpsReadOnly
A teljes átviteli sebesség (Mbit/s), amelyet a rendszer minden VMs-meghajtón a megosztott merevlemez írásvédett módú csatlakoztatásakor megenged. MBps: a 10 MB/s sebességű bájtok száma itt az ISO-jelölést használja, a 10-es hatáskörökkel.
...
### -MaxSharesCount
A merevlemezhez egyidejűleg használható VMs-tartomány maximális száma. Az értéknél nagyobb érték azt jelzi, hogy egyszerre több VMs-eszközön lehet csatlakoztatni egy lemezt.
...
### -Tier (Tier)
A lemez teljesítőképességi szintje.
