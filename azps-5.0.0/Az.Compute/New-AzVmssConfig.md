...
Létrehozza a VMSS konfigurációs objektumát. autogenerated
...
### -MaxPrice
Itt adhatja meg, hogy a helyszíni VM/VMSS milyen maximális árat fizessen. Ez az ár amerikai dollárban van. Ezt az árat a program összehasonlítja a VM-méret aktuális áraival. A helyszíni VM/VMSS létrehozásának/frissítésének időpontjában az árak is összehasonlíthatók lesznek, és a művelet csak akkor fog sikerülni, ha a maxPrice nagyobb, mint a jelenlegi ár. A maxPrice a VM/VMSS létrehozása után is használni fogja a helyszíni VM/VMSS, ha a jelenlegi ár túllépi a maxPrice. Lehetséges értékek: bármely nullánál nagyobb decimális érték. Példa: 0,01538.  -1 – azt jelzi, hogy a hely VM/VMSS nem szabad az árak miatt kizárni. Az alapértelmezett Max ár is-1, ha az nem az Ön által megadott.
