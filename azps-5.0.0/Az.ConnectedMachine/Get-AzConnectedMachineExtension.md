...
### Példa 1: egy gép összes bővítményének listázása
```powershell
...
Egy adott gép összes bővítményének listázása.

### 2. példa: adott bővítmény beszerzése a számítógépen
```powershell
...
Meghatározott bővítményt kap a számítógépen.
...
### -Számítógépnév
Annak a gépnek a neve, amely a kiterjesztést tartalmazza.
