...
## Áttekintés
Tároló csoportokba kerül.

## SZINTAXISA

### ListContainerGroupParamSet (alapértelmezett)
```
...
## Leírás
A **Get-AzContainerGroup** parancsmag a megadott tároló vagy az erőforráscsoport összes tároló csoportját, illetve az előfizetést kapja meg.

## Példák

### Példa 1: a megadott tároló csoport beolvasása
```
...
A parancs a megadott tároló csoportba kerül.

### 2. példa: egy erőforráscsoport tároló csoportjának beolvasása
```
...
A parancs a tároló csoportokat az erőforrás csoportban kapja `demo` .

### 3. példa: a Container-csoportok bekerülnek az aktuális előfizetésbe
```
...
A parancs az aktuális előfizetésben a tároló csoportokat kapja.

### 4. példa: az erőforrás-azonosítóval kapja a tároló-csoportokat.
```
...
A parancs a tároló csoportot az erőforrás-azonosítóval kapja meg.
