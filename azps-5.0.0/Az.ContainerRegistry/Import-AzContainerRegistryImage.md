...
BusyBox importálása az ACR-ba Megjegyzés 
* a "tár/" szót fel kell venni a forrás képe előtt. "BusyBox: Latest" => "Library/BusyBox: Latest"
* Hitelesítő adatokra van szükség, ha a forrás beállításjegyzéke nem érhető el nyilvánosan
...
Az ACR-ből az ACR-BusyBox importálhatja a forrást. Megjegyzés 
* Hitelesítő adatokra van szükség, ha a rendszergazdai felhasználó a forráskódot letiltotta.
...
### Üzemmód
Ha az erő, minden meglévő cél-címke felülírható.
Ha nincs ilyen, minden meglévő cél-címke sikertelen lesz a művelet megkezdése előtt.
...
### -Jelszó
A forrás-nyilvántartóval való hitelesítéshez használt jelszó.
...
### -RegistryName
A cél beállításjegyzékének neve.
...
### -SourceImage
A forrás kép tárházának neve.

Adjon meg egy képet tárház szerint ("Helló-világ").
Ez a ' legújabb ' címkét fogja használni.

Adjon meg egy képet a címke szerint ("Helló-világ: legújabb").

Adjon meg egy képet egy sha256-alapú manifest Digest (' hello-world@sha256:abc123 ') segítségével.
...
A forrás Azure-tároló beállításjegyzékének erőforrás-azonosítója.
...
### -TargetTag
A repo \[ : címke karakterlánca \] .
Ha a címke nincs kihagyva, a program a forrást fogja használni (vagy a "legújabb", ha a forrás címke is hiányzik).
...
A repositoryk neveinek listája csak a manifesztek másolatát tartalmazza.
A program nem hoz létre címkét.
...
### -Felhasználónév
A forrás-nyilvántartóval való hitelesítéshez használt Felhasználónév.
