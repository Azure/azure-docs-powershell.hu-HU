...
### AddAddNetworkRuleWithoutInputObject (alapértelmezett)
```
...
## Leírás
Hálózati szabálykészlet létrehozása vagy frissítése
...
Új hálózati szabálykészlet létrehozása

## PARAMÉTEREK

### -DefaultAction
Alapértelmezett tevékenység, lehet "Allow" vagy "deny"
...
### Microsoft. Azure. Command. ContainerRegistry. models. PSNetworkRuleSet
