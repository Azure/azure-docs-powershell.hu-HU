...
## Áttekintés
A CosmosDB MongoDB-adatbázis beolvasása
...
## Leírás
A **Get-AzCosmosDBMongoDBDatabase** parancsmag a CosmosDB MongoDB adatbázist kapja.
...
Az erőforrás-objektum _rid, _ts, _etag tulajdonságokat tartalmaz.
