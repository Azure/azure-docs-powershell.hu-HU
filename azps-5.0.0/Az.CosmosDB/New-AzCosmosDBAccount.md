...
Bool: annak jelzése, hogy engedélyezve van-e a AnalyticalStorage a fiókban.
...
### -EnableFreeTier
Bool: annak jelzése, hogy engedélyezve van-e a FreeTier a fiókban.
...
### -IpRule
Tűzfal támogatása Az CIDR űrlap IP-címeinek vagy IP-címeinek halmazát adja meg, hogy az adott adatbázis-fiókhoz tartozó ügyfél IP-címei engedélyezettek legyenek.
...
### -ServerVersion
ServerVersion, érvényes csak MongoDB-fiókok esetén.
