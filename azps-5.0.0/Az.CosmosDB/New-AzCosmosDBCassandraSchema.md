...
## Áttekintés
Új CosmosDB Cassandra-séma létrehozása.
...
## Leírás
A **New-AzCosmosDBCassandraSchema** létrehoz egy új CosmosDB Cassandra-sémát.
...
### -PartitionKey
A particionálási kulcsokat tartalmazó karakterláncok tömbje
