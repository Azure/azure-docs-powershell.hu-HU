...
## Áttekintés
Új CosmosDB-IndexingPolicy objektumot hoz létre.
...
## Leírás
A **New-AzCosmosDBGremlinIndexingPolicy** parancsmag új, PSIndexingPolicy típusú objektumot hoz létre.
...
### -Automatikus
Bool annak jelzése, hogy az indexelő házirend automatikus-e
...
### -CompositePath
A Microsoft. Azure. commands. CosmosDB. PSCompositePath fájltípusú objektumok tömbje
...
### -ExcludedPath
A excludedPath tartalmazó karakterláncok tömbje (az Azure Cosmos DB szolgáltatásban kizárt JSON-dokumentumon belül az elérési utat adja meg.)  elemek.
...
### -IncludedPath
A includedPath tartalmazó karakterláncok tömbje (az Azure Cosmos DB szolgáltatás részét képező JSON-dokumentumon belül az elérési utat adja meg.) elemek.
...
### -IndexingMode
Az indexelési mód jelzése.
A lehetséges értékek a következők: "konzisztens", "lusta", "nincs"
...
### -SpatialSpec
A Microsoft. Azure. commands. CosmosDB. PSSpatialSpec fájltípusú objektumok tömbje
...
### Microsoft. Azure. Command. CosmosDB. models. PSIndexingPolicy
