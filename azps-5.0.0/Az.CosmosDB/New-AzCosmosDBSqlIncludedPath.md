...
## Áttekintés
Új PSIncludedPath típusú objektum létrehozása A set-AzCosmosDBSqlContainer paraméter értéke lehet.
...
## Leírás
Az SQL API IncludedPath megfelelő objektum.
...
### – Index
Az útvonal indexelésének listája
...
### Microsoft. Azure. Command. CosmosDB. models. PSIncludedPath
