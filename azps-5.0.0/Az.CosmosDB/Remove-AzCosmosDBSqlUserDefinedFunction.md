...
## Leírás
A **Remove-AzCosmosDBSqlUserDefinedFunction** parancsmag törli a megadott ResourceGroupName, accountname és databasename tartozó SQL-UserDefinedFunction CosmosDB.
...
### -InputObject
SQL-felhasználó által definiált függvény objektum
