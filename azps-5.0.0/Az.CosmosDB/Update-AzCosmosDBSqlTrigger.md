...
### -TriggerOperation
Az a művelet, amelyhez az trigger társítva van.
A lehetséges értékek a következők: "all", "Create", "Update", "Delete", "csere"
...
### -TriggerType
Az indító típusa.
A lehetséges értékek a következők: "pre", "bejegyzés"
...
### Microsoft. Azure. Command. CosmosDB. models. PSSqlTriggerGetResults
