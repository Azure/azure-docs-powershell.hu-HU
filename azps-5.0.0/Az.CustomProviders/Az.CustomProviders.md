...
## Leírás
Microsoft Azure PowerShell: egyéni szolgáltatói parancsmagok

## Az. CustomProviders parancsmagok
### [Get-AzCustomProvider](Get-AzCustomProvider.md)
Megkapja az egyéni erőforrás-szolgáltatói jegyzékfájlt.

### [Get-AzCustomProviderAssociation](Get-AzCustomProviderAssociation.md)
Társítás kérése

### [Új – AzCustomProvider](New-AzCustomProvider.md)
Az egyéni erőforrás-szolgáltató létrehozása vagy frissítése

### [Új – AzCustomProviderAssociation](New-AzCustomProviderAssociation.md)
...
Frissít egy meglévő egyéni erőforrás-szolgáltatót.
A JAVÍTÁSon keresztül jelenleg csak a címkéket lehet frissíteni.
