...
Frissítheti egy egyéni szolgáltató címkéit.

### 2. példa: az egyéni szolgáltató frissítése a csővezetékekkel
```powershell
...
Egyéni szolgáltató frissítése a csővezetékek segítségével
