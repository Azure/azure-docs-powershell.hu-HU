...
### BandwidthParameterSet (alapértelmezett)
```
...
## Leírás
A **New-AzDataBoxEdgeBandwidthSchedule** parancsmag új sávszélesség-ütemtervet hoz létre az adatmezők Edge-eszközéhez a sávszélesség-használat kezeléséhez.
...
### -UnlimitedBandwidth
Korlátlan sávszélességet állít be, ha a False beállítás értéke 20 Mbps, az alapértelmezett érték lesz beállítva
