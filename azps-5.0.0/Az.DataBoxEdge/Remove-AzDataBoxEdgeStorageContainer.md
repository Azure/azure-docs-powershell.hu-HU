...
## Leírás
A **Remove-AzDataBoxEdgeStorageContainer** parancsmagja eltávolítja az Edge Storage-fiókhoz tartozó tároló tárolót az adatmező szélén lévő eszközön. Megadhatja annak a tároló-tárolónak a nevét, amelyet paraméterként szeretne eltávolítani.
