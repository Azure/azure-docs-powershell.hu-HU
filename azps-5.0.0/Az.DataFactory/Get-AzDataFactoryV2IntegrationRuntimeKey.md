...
## Leírás
Beolvashatja az integrációs futtatókörnyezet kulcsait. A kulcsok az integrációs futásidejű csomópontok regisztrálására szolgálnak.

## Példák

### Példa 1: integrációs futásidejű kulcsok beszerzése
```
...
[Új – AzDataFactoryV2IntegrationRuntimeKey]()
