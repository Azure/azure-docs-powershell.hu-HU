...
## Leírás
A **set-AzDataFactoryV2** parancsmag adatfeldolgozót hoz létre a megadott erőforráscsoport-névvel és-hellyel.
...
### 2. példa: a meglévő gyári objektum segítségével adatfeldolgozót hozhat létre a repó konfigurációs adataival.
```
...
Ez a parancs létrehoz egy WikiADF nevű adattárolót az ADF nevű erőforrás-csoportban, az EastUS helyen, az Azure DevOps adatforrás-vezérlési beállításaival.

### 3. példa: adatgyár létrehozása a GitHub repo Configuration Details (új gyári objektum) segítségével.
```
...
Ez a parancs létrehoz egy WikiADF nevű adattárolót az ADF nevű erőforrás-csoport EastUS helyéről a GitHub verziókövetés konfigurációjával..

## PARAMÉTEREK

### -AccountName
A repó-konfigurációhoz tartozó fióknév.
...
Az adatok gyári globális paramétereit tartalmazó szótár.
...
### -HostName (állomásnév)
A GitHub repó-konfiguráció állomásnevét adja meg.
...
### -Hely
Az adatfeldolgozó ebben a régióban jön létre.
...
### -Projektnév
A projekt neve Azure DevOps for repo Configuration.
...
### -RepositoryName
A repó-konfiguráció tárházának neve.
...
### -ResourceId
Az Azure Resource ID of v2 Data Factory.
...
### -RootFolder
A repó-konfiguráció gyökerének mappája.
...
Az Azure DevOps repo Configuration (bérlői azonosító)
