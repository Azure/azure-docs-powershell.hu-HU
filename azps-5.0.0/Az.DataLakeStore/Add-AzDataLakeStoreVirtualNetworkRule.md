...
## Leírás
Az **Add-AzDataLakeStoreVirtualNetworkRule** parancsmag virtuális hálózati szabályt ad a megadott Data Lake Store-fiókhoz.
...
Ezzel létrehoz egy új virtuális hálózati szabályt "myVNET" néven a "frissíteni" fiókban "testId" alhálózati azonosítóval

## PARAMÉTEREK

### -Fiók
Az Data Lake Store fiók a virtuális hálózati szabály hozzáadásához
