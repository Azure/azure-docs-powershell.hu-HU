...
### 1. példa: az összes vnet kilistázása egy databricks alatt
```powershell
...
Ez a parancs felsorolja az összes vnet a databricks csoportban.

### 2. példa: vnet való Ismerkedés
```powershell
...
Ez a parancs vnet-alapú kinézetet kap.

### 3. példa: vnet kikérése objektum alapján
```powershell
