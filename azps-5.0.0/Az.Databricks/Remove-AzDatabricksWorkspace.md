...
### 1. példa: Databricks-munkaterület eltávolítása
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Ez a parancs eltávolítja a Databricks-munkaterületet egy erőforrás-csoportból.

### 2. példa: Databricks-munkaterület eltávolítása objektum alapján
```powershell
