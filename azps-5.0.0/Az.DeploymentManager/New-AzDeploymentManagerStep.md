...
## Leírás
A **New-AzDeploymentManagerStep** parancsmag létrehoz egy központi kivezetési lépést, amelyre hivatkozhat a kivezetésben.
Adja meg a *nevet* , a *ResourceGroupName* és a szükséges tulajdonságokat.

A visszaadott objektumot helyileg módosíthatja, majd az Set-AzDeploymentManagerStep parancsmag használatával alkalmazhatja a módosításokat.
...
Annak a fájlnak az elérési útvonala, ahol az állapot-ellenőrzés tulajdonságai meg vannak határozva.
