...
### Példa 1: a Windows virtuális asztali asztal beszerzése név alapján
```powershell
...
Ez a parancs egy asztali Windows rendszerű asztali alkalmazás-csoportba kerül.

### 2. példa: a Windows virtuális asztali asztali verzióinak listája
```powershell
...
Ez a parancs egy alkalmazás-csoportban listsWindows a virtuális asztali asztalokat.
...
### -Name (név)
A megadott asztali csoporton belüli asztal neve
...
### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. IDesktop

### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. IDesktopList
