...
### Példa 1: a Windows virtuális asztali UserSession beszerzése név szerint
```powershell
...
Ez a parancs a Windows virtuális asztali UserSession a munkamenet-állomáson.

### 2. példa: a Windows virtuális asztali UserSessions listája
```powershell
...
Ez a parancs felsorolja a Windows virtuális asztali UserSessions a munkamenet-tárolóban.

### 3. példa: a Windows virtuális asztali UserSessions listázása a Host Pool-ban
```powershell
...
Ez a parancs felsorolja a Windows virtuális asztali UserSessions egy állomás egy alkalmazáskészletében.
...
A szűréshez érvényes tulajdonságok a userPrincipalName és a sessionstate.
...
### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. IUserSession
