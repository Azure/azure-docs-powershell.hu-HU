...
### Példa 1: a Windows virtuális asztali ApplicationGroup létrehozása név szerint
```powershell
...
Ez a parancs létrehoz egy Windows virtuális asztali ApplicationGroup egy Erőforráscsoportben.

### 2. példa: a Windows virtuális asztali ApplicationGroup létrehozása név szerint
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Az ApplicationGroup erőforrás típusa.
...
### -HostPoolArmPath
A ApplicationGroup HostPool kar elérési útja.
