...
### Példa 1: a Windows virtuális asztali HostPool létrehozása név szerint
```powershell
...
Ez a parancs létrehoz egy Windows virtuális asztali HostPool egy Erőforráscsoportben.
...
### -CustomRdpProperty
Az HostPool egyéni RDP-tulajdonsága.
...
### -ExpirationTime
A regisztrációs token lejárati ideje.
...
### -MaxSessionLimit
A HostPool maximális munkamenet-korlátja.
...
A HostPool PersonalDesktopAssignment típusa.
...
Az előnyben részesített alkalmazásobjektum-csoport típusa, alapértelmezett az asztali alkalmazás csoportba
...
### -SsoContext
A ssoContext titkos kulcsát tartalmazó elérési út.
...
### -VMTemplate
VM-sablon a sessionhosts-konfigurációhoz a hostpool belül.
...
### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. IHostPool
