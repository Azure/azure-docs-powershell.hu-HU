...
### Példa 1: Windows virtuális asztali regisztrációs jogkivonat létrehozása
```powershell
...
Ez a parancs létrehoz egy Windows virtuális asztali regisztrációs tokent egy állomás-készletben.
...
### Microsoft. Azure. PowerShell. parancsmagok. DesktopVirtualization. modellek. Api20191210Preview. IRegistrationInfo
