...
### Példa 1: a Windows virtuális asztali Worksapce létrehozása név szerint
```powershell
...
Ez a parancs egy Windows virtuális asztali munkaterületet hoz létre egy Erőforráscsoportben.

### 2. példa: a Windows virtuális asztali Worksapce létrehozása név szerint
```powershell
PS C:\> New-AzWvdWorkspace -ResourceGroupName ResourceGroupName `
                        -Name WorkspaceName `
                        -Location 'eastus' `
...
### -ApplicationGroupReference
ApplicationGroup-erőforrás-azonosítók listája
