...
### Példa 1: a Windows virtuális asztali regisztrációs jogkivonat törlése
```powershell
PS C:\> Remove-AzWvdRegistrationInfo -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName
```

Ez a parancs törli a Windows virtuális asztali regisztrációs tokent egy állomás-készletben.
