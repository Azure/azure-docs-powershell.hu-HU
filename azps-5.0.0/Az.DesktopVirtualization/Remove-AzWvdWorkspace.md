...
### Példa 1: a Windows virtuális asztali Worksapce törlése név szerint
```powershell
PS C:\> Remove-AzWvdWorksapce -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Ez a parancs törli a Windows virtuális asztal munkaterületét egy erőforráscsoport-csoportban.
