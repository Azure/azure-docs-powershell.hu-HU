...
### 1. példa: a Windows virtuális asztali alkalmazás csoportjának regisztrációjának megszüntetése
```powershell
...
Ez a parancs a Windows virtuálisasztal-alkalmazás csoportjának egy munkaterületre való törlésének megszüntetése.

## PARAMÉTEREK

### -ApplicationGroupPath
ResourceGroupName elérési útja
