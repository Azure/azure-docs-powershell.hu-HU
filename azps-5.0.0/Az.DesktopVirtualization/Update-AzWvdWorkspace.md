...
### Példa 1: a Windows virtuális asztali Worksapce frissítése név szerint
```powershell
...
Ez a parancs frissíti egy Windows virtuális asztali munkaterületet egy Erőforráscsoportben.

## PARAMÉTEREK

### -ApplicationGroupReference
A applicationGroup hivatkozásainak listája
