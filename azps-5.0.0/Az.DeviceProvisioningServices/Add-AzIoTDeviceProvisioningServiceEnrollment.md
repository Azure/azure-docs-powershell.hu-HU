...
## Leírás
Eszköz-igénylés létrehozása Azure IoT hub eszközök kiépítési szolgáltatásában.
...
Tanúsítványigénylés létrehozása a TPM-tanúsítvánnyal.
...
### -EndorsementKey
TPM-eszköz TPM-záradékának kulcsa.
...
### -StorageRootKey
TPM-tároló gyökérszintű kulcsa a TPM-eszközhöz.
