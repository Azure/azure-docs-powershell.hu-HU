...
## Áttekintés
Egy Eventhub-fürt vagy a szektorcsoportok listájának lekérdezése az adott erőforráscsoport számára
...
## Leírás
Azoknak a régióknak a Get-AzEventHubClustersAvailableRegion parancsmag listája, amelyekhez dedikáltak.
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. commands. EventHub. models. PSEventHubsAvailableCluster, Microsoft. Azure. PowerShell. parancsmagok. EventHub, Version = 1.5.0.0, Culture = semleges, PublicKeyToken = null]]
