...
## Leírás
Az **enable-AzFrontDoorCustomDomainHttps** lehetővé teszi a https használatát egy egyéni tartományhoz.

## Példák

### 1. példa: engedélyezze a HTTPS protokollt egy egyéni tartományhoz, amelyen a FrontDoorName és a ResourceGroupName használható a bejárati ajtóval felügyelt tanúsítvány.
```powershell
...
HTTPS engedélyezése egy egyéni tartományhoz: "frontendpointname1-Custom-XYZ", amely a bejárati ajtó "frontdoor1", az "resourcegroup1" erőforráscsoport "" az első ajtó felügyelt tanúsítvány használatával.

### 2. példa: engedélyezze a HTTPS protokollt egy egyéni tartományhoz, amelyen a FrontDoorName és a ResourceGroupName saját tanúsítvánnyal rendelkezik a kulcskezelő szolgáltatásban.
```powershell
...
### 3. példa: engedélyezze a HTTPS protokollt egy egyéni tartományhoz a PSFrontendEndpoint objektummal az első ajtó által felügyelt tanúsítvány használatával.
```powershell
...
Engedélyezze a HTTPS protokollt egy egyéni tartományhoz a PSFrontendEndpoint objektummal az első ajtó által felügyelt tanúsítvány használatával.

### Példa 4: a HTTPS engedélyezése egyéni tartományhoz erőforrás-azonosítóval az első ajtó által felügyelt tanúsítvány használatával.
```powershell
...
HTTPS engedélyezése egyéni tartományhoz: "frontendpointname1-Custom-XYZ" az erőforrás-azonosítóval $resourceId a bejárati ajtót felügyelt tanúsítvány használatával.
...
### -InputObject
A frontend végpont objektum a frissítéshez.
...
### -MinimumTlsVersion
Az ügyfeleknek a bejárati ajtóval való SSL-kézfogás létesítéséhez szükséges minimális TLS-verzió.
...
### -ResourceId
A https engedélyezése a bejárati ajtó végpontjának erőforrás-azonosítója
...
### -SecretName
A teljes tanúsítvány (PFX) teljes tanúsítványát képviselő kulcs-Vault-titok neve
...
### -SecretVersion
A teljes tanúsítvány (PFX) teljes tanúsítványát jelképező kulcsfájl-titok verziója.
...
### -VaultId
Az SSL-tanúsítványt tartalmazó fő pince-azonosító
