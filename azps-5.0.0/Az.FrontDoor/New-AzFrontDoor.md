...
## Leírás
A **New-AzFrontDoor** parancsmag új Azure betárcsázós betöltőt hoz létre a megadott erőforrás-csoportban a jelenlegi előfizetés csoportban.

## Példák

### Példa 1: bejárati ajtó létrehozása megadott paraméterek alapján.
```powershell
