...
A "New-AzFrontDoorRulesEngineRule" parancsmaggal létrehozhatja a szabályok motorjának szabályait, hogy átmenjenek a parancsmag "-Rules" paraméterére.
...
Új szabály-végrehajtó konfiguráció létrehozása a megadott bejárati ajtóhoz.
...
### -Szabály
Az egyes szabályok motor-konfigurációját meghatározó szabályok listája.
