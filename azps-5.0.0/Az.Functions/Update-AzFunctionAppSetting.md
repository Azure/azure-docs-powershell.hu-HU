...
### Példa 1: új App-beállítás felvétele egy függvény alkalmazásban.
```powershell
PS C:\> Update-AzFunctionAppSetting -Name MyAppName -ResourceGroupName MyResourceGroupName -AppSetting @{"Name1" = "Value1"}
```

Ez a parancs egy új App-beállítást ad hozzá egy függvény alkalmazásban.

## PARAMÉTEREK

### -AppSetting
A billentyűk és az értékek Hashtable leírják, hogy milyen App-beállításokat kell hozzáadni vagy frissíteni a Function App alkalmazásban.
...
### -Force
Kényszeríti a parancsmagot a Function app beállítás frissítésére a megerősítés kérése nélkül.
...
### Microsoft. Azure. PowerShell. parancsmagok. functions. models. Api20190801. IStringDictionary
