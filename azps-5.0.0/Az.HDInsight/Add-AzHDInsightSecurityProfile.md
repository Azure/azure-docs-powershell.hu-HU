...
### 1. példa: biztonsági profil hozzáadása a cluster Configuration objektumhoz
```
...
Ez a parancs a biztonsági profil értékét hozzáadja a-Hadoop-001 nevű fürthöz.
...
### -DomainResourceId
Active Directory tartományi erőforrás-azonosító a fürthöz.
