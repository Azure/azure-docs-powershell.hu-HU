...
### -StorageAccountKey
A Storage Account Access kulcs beolvasása vagy megadása
...
A tárolási fiók erőforrás-azonosítóját kapja vagy állítja be.
...
### -StorageAccountType
Az alapértelmezett tárterület-fiók típusának megadása vagy beállítása.
