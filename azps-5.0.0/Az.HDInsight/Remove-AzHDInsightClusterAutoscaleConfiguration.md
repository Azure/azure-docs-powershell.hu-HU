...
## Leírás
A **Remove-AzHDInsightClusterAutoscaleConfiguration** parancsmag eltávolítja a HDInsight-fürt automatikus méretezési konfigurációját.

## Példák

### 1. példa: a HDInsight-fürt automatikus méretezési konfigurációjának eltávolítása.
```powershell
...
Ez a parancs eltávolítja a HDInsight-fürt automatikus méretarányos konfigurációját.
