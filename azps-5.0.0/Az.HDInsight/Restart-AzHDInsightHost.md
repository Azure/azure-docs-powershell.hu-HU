...
## Leírás
Ez az **Újraindítás – AzHDInsightHost** parancsmag újraindítja a HDInsight-fürt adott állomásait.
...
Ez a parancs a fürt két állomását indítja el: worknode1, worknode2.
...
Ez a parancs bemutatja, hogyan működhet együtt a "Get-AzHDInsightHost" parancsmaggal.
...
Az állomás nevének beolvasása vagy megadására szolgáló beállítás.
...
### System. Collections. Generic. IList ' 1 [[Microsoft. Azure. commands. HDInsight. models. Management. AzureHDInsightHostInfo, Microsoft. Azure. PowerShell. parancsmagok. HDInsight, Version = 3.2.0.0, Culture = semleges, PublicKeyToken = null]]
