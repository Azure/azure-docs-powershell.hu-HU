...
### FlushParameterSet (alapértelmezett)
```
...
## Leírás
Az **Update-AzHpcCache** parancsmag az Azure HPC-gyorsítótárát frissíti.
...
### -Force
Azt jelzi, hogy a parancsmag nem kér megerősítést. Ez a parancsmag alapértelmezés szerint arra kéri, hogy erősítse meg, hogy szeretné-e frissíteni a gyorsítótárat.
...
### -InputObject
A frissítendő gyorsítótár-objektum.
...
### -ResourceGroupName
Annak az erőforráscsoport-csoportnak a neve, amely alatt frissíteni szeretné a gyorsítótárat.
