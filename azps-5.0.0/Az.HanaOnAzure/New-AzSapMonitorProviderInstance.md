...
### 1. példa: az SAP-monitorok példányának létrehozása a HANA karakterláncmal
```powershell
...
Ez a parancs az SAP-monitor egy példányát a HANA karakterláncban hozza létre.

### 2. példa: az SAP-monitor példányának létrehozása a HANA-alapú kulcs boltozatával
```powershell
...
Ez a parancs az SAP-monitor egy példányát a HANA for HANA (fő pince) segítségével hozza létre.
...
### -HanaDatabaseName
Az SAP HANA-példány adatbázisának neve.
...
A HANA-hitelesítő adatokat tartalmazó kulcsfájl erőforrás-azonosítója.
...
A titkos azonosító a HANA-hitelesítő adatokat tartalmazó fő Vault-titokhoz.
...
### -HanaDatabaseSqlPort
Az SAP HANA-példány adatbázisának SQL-portja.
...
A SAP HANA-példány adatbázisának a felhasználóneve.
...
### -Metadata
A szolgáltató példány metaadatait tartalmazó JSON karakterlánc.
...
### -ProviderType
A szolgáltató példány típusa.
A támogatott értékek a következők: "SapHana".
