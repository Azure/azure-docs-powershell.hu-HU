...
### Példa 1: SAP-monitor eltávolítása név szerint
```powershell
PS C:\> Remove-AzSapMonitor -ResourceGroupName nancyc-hn1 -Name ps-sapmonitor-t02

```

Ez a parancs eltávolít egy SAP-monitort név szerint.

### 2. példa: SAP-monitor objektumból való eltávolítása
```powershell
...
Ez a parancs eltávolít egy SAP-monitort objektum alapján.
