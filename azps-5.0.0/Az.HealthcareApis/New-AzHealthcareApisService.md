...
## Áttekintés
Egy szolgáltatási példány metaadatait hozza létre.
...
## Leírás
Egy szolgáltatási példány metaadatait hozza létre vagy frissíti.

## Példák

### Példa 1: létrehoz egy új Azure healthcareapis fhir szolgáltatás nevű MyService az erőforráscsoport MyResourceGroup egy olyan helyen, westus2 a 400 cosmosdb
```powershell
...
### -AllowCorsCredential
HealthcareApis Fhir szolgáltatás AllowCorsCredential.
...
### -Közönség
A HealthcareApis Fhir szolgáltatás célközönsége.
...
HealthcareApis Fhir szolgáltató hatóság.
...
### -CorsMethod
A CORS metódus HealthcareApis Fhir szolgáltatásának listája.
...
### -CorsOrigin
A HealthcareApis Fhir szolgáltatás CORS eredete. Adja meg az API-t elérő származási webhelyek URL-címét, vagy használja a *-ot bármely webhelyről való hozzáférés engedélyezéséhez.
...
HealthcareApis Fhir szolgáltatás CosmosOfferThroughput.
...
### -EnableSmartProxy
HealthcareApis Fhir szolgáltatás EnableSmartProxy.
...
A HealthcareApis Fhir-szolgáltatása exportálja a tárolási fiók nevét.
...
### -Kind
A HealthcareApis szolgáltatás típusa.
Az alapértelmezett érték a Fhir
