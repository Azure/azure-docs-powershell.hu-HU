...
## Áttekintés
Egy szolgáltatási példány törlése.
...
A meglévő HealthcareApis-szolgáltatás törlése a megadott erőforráscsoporthoz tartozó névvel
...
A meglévő HealthcareApis-szolgáltatás törlése a megadott ResourceId.
...
A megadott HealthcareApis-szolgáltatási objektum törlése
...
### -InputObject
HealthcareApis szolgáltatás objektum
...
### -PassThru
Ha a művelet sikeres, az igaz értéket ad eredményül.
...
### -ResourceId
A HealthcareApis szolgáltatás ResourceId.
