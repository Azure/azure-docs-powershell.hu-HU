...
### Példa 1: a minden futási eredmény listázása egy sablon alatt
```powershell
...
Ez a parancs felsorolja a minden futási eredményt egy sablon alatt.

### 2. példa: futtatási eredmény megszerzése sablon alatt
```powershell
...
Ez a parancs a futási eredményt egy sablon alatt kapja.

### 3. példa: futtatási eredmény megszerzése sablon alatt
```powershell
...
### Microsoft. Azure. PowerShell. parancsmagok. ImageBuilder. modellek. Api20200214. IRunOutput
