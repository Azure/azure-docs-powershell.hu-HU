...
## Leírás
Adjon meg egy pontosvesszővel elválasztott listát a nem Edge-eszközök azonosítói a megadott Edge-eszköz gyermekeiként.
...
Nem szélezett eszközök felvétele gyermekként az Edge-eszköz függetlenül attól a nem az Edge eszközön már gyermek a másik Edge-eszközön.
