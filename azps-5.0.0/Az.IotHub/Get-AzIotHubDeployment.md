...
## Leírás
Megtudhatja, hogy miként IoT meg a IoT Edge-példányok központi telepítését egy IoT-központban.
...
Megtudhatja, hogy miként veheti fel a IoT Edge-példányát.
...
Felsorolja az összes IoT Edge-példányát egy IoT-központban.
