...
## Leírás
Az Azure IoT központi verziójában található IoT-eszközök minden moduljának vagy meghatározott moduljának listája kapcsolati karakterlánca.
...
A IoT-eszközök minden modul kapcsolati karakterláncának megjelenítése egy IOT-központban.
...
A másodlagos modul kapcsolati karakterláncát beolvashatja egy IOT-hub IoT-eszközéhez.
...
### -Típus
Megosztott hozzáférés házirend-kulcs típusa az Auth szolgáltatáshoz.
...
### Microsoft. Azure. Command. Management. IotHub. models. PSModuleConnectionString
