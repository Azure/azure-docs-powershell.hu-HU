...
## Leírás
Kiértékelheti a cél egyéni vagy rendszermetrikáját egy IoT-alapú példányban.
A IOT hub által számított előre definiált rendszermetrikák nem szabhatók testre.
- A "célzott" a IoT Edge eszközeit jeleníti meg, amelyek megfelelnek a bevezetési célzási feltételnek.
- Az "alkalmazott" kifejezés azokat a célzott IoT jeleníti meg, amelyeket a magasabb prioritású példányok nem céloznak meg.
- A "jelentéskészítés sikere" a IoT Edge-eszközöket jeleníti meg, amelyek arról számoltak be, hogy sikeresen telepítették a modulokat.
- A "jelentéskészítési hiba" a IoT Edge-eszközöket jeleníti meg, amelyek arról számoltak be, hogy egy vagy több modult nem sikerült telepíteni. 
  A hiba további kivizsgálásához csatlakozzon távolról a fenti eszközökhöz, és tekintse meg a naplófájlokat.
...
Értékelje a rendszer "jelentéskészítési siker" mérőszámát.
