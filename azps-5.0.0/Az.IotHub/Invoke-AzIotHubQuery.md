...
## Leírás
A IoT-hub lekérdezése erős SQL-szerű nyelv segítségével az eszközök és a modulokra, a munkahelyekre és az üzenetek továbbítására vonatkozó információk lekéréséhez.
https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-languageTovábbi információt itt talál.
...
Az összes eszköz különálló adatainak lekérdezése az Azure IoT-központban.
...
Lekérdezés Top 2 modul Twin Data on a céleszköz.
...
### -Query
Végrehajtani kívánt felhasználói lekérdezés.
...
### -Top
A visszaadni kívánt elemek maximális száma
Alapértelmezés szerint a lekérdezésnek nincs kupakja.
