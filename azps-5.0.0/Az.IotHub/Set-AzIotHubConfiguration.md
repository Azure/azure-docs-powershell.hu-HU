...
## Leírás
A IoT automatikus eszközkezelés konfigurációjának meghatározott tulajdonságainak frissítése
Megjegyzés: a konfigurációs tartalmak nem állandók. A frissíthető konfigurációs tulajdonságok "címkék", "metrikák", "prioritás" és "targetCondition".
https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-managementTovábbi információt itt talál.
...
Az eszközbeállítások prioritásának módosítása és a TARGET-feltétel frissítése
...
### -Force
Lehetővé teszi a konfigurációs objektum lecserélését abban az esetben is, ha a legutóbbi időponttól kezdve frissült.
