...
## Áttekintés
Teljes biztonsági másolat a felügyelt HSM-ról
...
## Leírás
Teljes mértékben biztonsági másolat készítése a felügyelt HSM-ról a tárolási fiókra.
Segítségével `Restore-AzManagedHsm` visszaállíthatja a biztonsági mentést.
...
A parancsmag létrehoz egy mappát (általában elnevezett `mhsm-{name}-{timestamp}` ) a tároló tárolóban, tárolja a biztonsági másolatot abban a mappában, és megjeleníti a mappa URI-azonosítóját.
