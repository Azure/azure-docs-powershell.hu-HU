...
## Áttekintés
Biztonsági másolat készítése a felügyelt HSM biztonsági tartományának adatainak visszaállításáról.
...
## Leírás
Ez a parancsmag biztonsági másolatot hoz létre a felügyelt HSM biztonsági tartományának adatainak visszaállításáról.
...
Ez a parancs beolvassa a testmhsm nevű felügyelt HSM-fájlt, és menti a felügyelt HSM biztonsági tartomány biztonsági másolatát a megadott kimeneti fájlba.
...
### -InputObject
Felügyelt HSM-t képviselő objektum
...
### -OutputPath
Adja meg, hogy milyen elérési utat szeretne letölteni a rendszer a biztonsági tartományba.
...
### -PassThru
Ha meg van adva egy logikai érték, akkor a parancsmag sikere után egy logikai értéket ad vissza.
...
### -Kvórum
A biztonsági tartomány helyreállításhoz való visszafejtéséhez szükséges részvények minimális száma.
