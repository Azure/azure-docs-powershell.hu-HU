...
Ez a parancs a ITPfx nevű kulcsot a contoso nevű kulcsfájl minden verziójában megkapja.
...
### Példa 5: az összes törölt, de el nem távolított billentyű lekérése a fő boltozatra
```powershell
