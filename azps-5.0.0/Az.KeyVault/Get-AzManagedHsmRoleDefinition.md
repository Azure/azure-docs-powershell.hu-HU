...
## Áttekintés
A megadott felügyelt HSM listához tartozó szerepkör-definíciók.
...
A példa a "felügyelt HSM biztonsági másolat" szerepkört kapja, és megvizsgálja az engedélyeit.
...
### -RoleDefinitionName
A beolvasott szerepkör definíciójának neve.
...
### Microsoft. Azure. Command. PSKeyVaultRoleDefinition. models.
