...
- Ezzel a paranccsal `Add-AzKeyVaultCertificate` tanúsítvány-aláírási kérést hozhat létre, és elküldheti azt egy hitelesítő szervezetnek. Olvassa el https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
[A CSR létrehozása és egyesítése a Key Vault-ban](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)