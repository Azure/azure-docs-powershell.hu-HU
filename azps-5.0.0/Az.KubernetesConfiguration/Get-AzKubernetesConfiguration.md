...
## Áttekintés
A verziókövetés konfigurációjának részleteit kapja meg.
...
### Példa 1: a kubernetes-fürt összes konfigurációjának beolvasása
```powershell
...
Ez a parancs beilleszti a kubernetes-fürt összes konfigurációját.

### 2. példa: kubernetes-fürt konfigurációjának beszerzése név szerint
```powershell
...
Ez a parancs a kubernetes-cluster konfigurációját név szerint kapja.

### Példa 3: kubernetes-fürt konfigurációjának beszerzése objektum szerint
```powershell
...
Ez a parancs a kubernetes-fürtök objektum szerinti konfigurációját kapja meg.

### Példa 4: a kubernetes-fürt konfigurációjának beszerzése csővezetéken
```powershell
...
Ez a parancs a kubernetes-fürt konfigurációját pipeline szerint kapja.
...
### -ClusterRp
Az Kubernetes-as cluster RP-Microsoft. ContainerService (ak-fürtök esetében) vagy Microsoft. Kubernetes (helyi K8S-fürtök esetén).
...
### Microsoft. Azure. PowerShell. parancsmagok. KubernetesConfiguration. modellek. Api20191101Preview. ISourceControlConfiguration
