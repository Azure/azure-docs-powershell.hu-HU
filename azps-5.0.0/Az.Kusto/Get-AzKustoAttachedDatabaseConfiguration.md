...
### Példa 1: a fürt összes AttachedDatabaseConfigurations listázása
```powershell
...
A fenti parancs felsorolja az összes AttachedDatabaseConfigurations a "testnewkustoclusterf" szektorcsoportban.

### 2. példa: adott AttachedDatabaseConfiguration beszerzése egy fürtben
```powershell
...
A fenti parancs a "myfollowerconfiguration" nevű AttachedDatabaseConfigurations a "testnewkustoclusterf" nevű fürtben számítja ki.
