...
### Példa 1: egy erőforráscsoport összes Kusto listázása
```powershell
...
### 2. példa: adott Kusto-fürt beszerzése név szerint
```powershell
...
A fenti parancs az "testrg" erőforráscsoport "testnewkustocluster" nevű Kusto-fürtöt számítja ki.
