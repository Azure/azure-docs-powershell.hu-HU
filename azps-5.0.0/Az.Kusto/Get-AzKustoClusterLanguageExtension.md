...
### Példa 1: egy fürthöz beállított nyelvi bővítmények listázása
```powershell
...
A fenti parancs a KQL-lekérdezéseken belül futtatható nyelvi bővítmények listáját jeleníti meg.
...
### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. ILanguageExtension
