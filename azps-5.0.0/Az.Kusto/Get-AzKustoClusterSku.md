...
### Példa 1: támogatható SKU-listák
```powershell
...
A fenti parancs a feljogosított SKU-t sorolja fel.

### 2. példa: meghatározott szektorcsoportokra feljogosított SKU-listák
```powershell
...
A fenti parancs megjeleníti a megfelelő SKU-ot adott fürtökhöz.
...
### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. IAzureResourceSku

### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. ISkuDescription
