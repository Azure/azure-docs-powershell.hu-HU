...
### Példa 1: új AttachedDatabaseConfiguration létrehozása
```powershell
...
A fenti parancs létrehoz egy írásvédett adatbázist "mykustodatabase" a cluster "testnewkustoclusterf".
Az "mykustodatabase" adatbázis a "testnewkustocluster" cluster "" adatbázisból következik
...
### -ClusterResourceId
Annak a fürtnek az erőforrás-azonosítója, amelyben a csatolni kívánt adatbázisok találhatók.
...
### -DatabaseName
Annak az adatbázisnak a neve, amelyet csatolni szeretne, használja * ha a jelenlegi és a jövőbeli adatbázisokat szeretné követni.
...
A megbízók alapértelmezett módosítási típusa
...
### -Name (név)
A csatolt adatbázis-konfiguráció neve.
...
### Microsoft. Azure. PowerShell. parancsmagok. Kusto. modellek. Api20200614. IAttachedDatabaseConfiguration
