...
### Példa 1: Kusto-cluster principalAssignment létrehozása
```powershell
...
A fenti parancs Kusto-fürtöt hoz létre principalAssignment
...
### -PrincipalId
A cluster Principal-hoz rendelt fő azonosító.
