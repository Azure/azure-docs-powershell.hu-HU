...
### CreateExpandedEventHub (alapértelmezett)
```
...
### Példa 1: új EventHub-adatkapcsolat létrehozása
```powershell
...
A fenti parancs új EventHub-adatkapcsolatot hoz létre a "myeventhubdc" nevű adatbázis "mykustodatabase" nevű adatbázisában "testnewkustocluster".
...
A fenti parancs új EventGrid-adatkapcsolatot hoz létre a "myeventgriddc" nevű adatbázis "mykustodatabase" nevű adatbázisában "testnewkustocluster".
...
A fenti parancs új IotHub-adatkapcsolatot hoz létre a "myiothubdc" nevű adatbázis "mykustodatabase" nevű adatbázisában "testnewkustocluster".
