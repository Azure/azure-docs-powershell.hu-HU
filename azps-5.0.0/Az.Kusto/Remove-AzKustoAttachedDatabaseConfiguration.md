...
### Példa 1: meglévő AttachedDatabaseConfiguration törlése név szerint
```powershell
...
A fenti parancs törli a "myfollowerconfiguration" AttachedDatabaseConfiguration "" testnewkustoclusterf megadott követő adatbázist.
