...
### 1. példa: a használatban lévő adatkapcsolati nevek elérhetőségének ellenőrzése
```powershell
...
A fenti parancs azt jeleníti meg, hogy a "mykustodataconnection" nevű adatkapcsolat létezik-e a "mykustodatabase" adatbázisban.

### 2. példa: a használatban lévő adatkapcsolati nevek elérhetőségének ellenőrzése
```powershell
...
A fenti parancs azt jeleníti meg, hogy a "mydataconnection" nevű adatkapcsolat létezik-e a "mykustodatabase" adatbázisban.
