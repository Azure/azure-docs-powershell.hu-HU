...
### Példa 1: a használatban lévő adatbázis-principalassignment elérhetőségének ellenőrzése
```powershell
...
A fenti parancs azt jeleníti meg, hogy a "myprincipal" nevű PrincipalAssignment létezik-e az "mykustodatabase" nevű adatbázis "testnewkustocluster".

### 2. példa: a nem használt adatbázis-principalassignment elérhetőségének ellenőrzése
```powershell
