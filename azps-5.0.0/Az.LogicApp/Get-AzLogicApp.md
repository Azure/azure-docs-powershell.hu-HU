...
## Leírás
A **Get-AzLogicApp** parancsmag logikai alkalmazást kap.
...
### Példa 1: logikai alkalmazás beszerzése egy erőforrás-csoportból
```
...
Ez a parancs egy logikai alkalmazást kap a ResourceGroup11 nevű erőforráscsoport nevében.
...
### -Name (név)
Annak a logikai alkalmazásnak a nevét adja meg, amely a parancsmagot kapja.
...
### -ResourceGroupName
Annak a csoportnak a nevét adja meg, amelyben a parancsmag logikai alkalmazást kap.
...
### -Verzió
A logikai alkalmazás verziószámát adja meg.
