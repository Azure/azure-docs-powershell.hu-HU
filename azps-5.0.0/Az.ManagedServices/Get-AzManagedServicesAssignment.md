...
A regisztrációt a regisztráció megadása nélkül kapja meg.
...
Beilleszti a regisztrációs feladatot név szerint a regisztráció meghatározása részleteivel.
...
Megkapja az összes regisztrációs feladatot a megadott hatókörben.
...
### -Scope (hatókör)
Az a tartomány, amelyben a regisztrálási feladat létrehozva van.
