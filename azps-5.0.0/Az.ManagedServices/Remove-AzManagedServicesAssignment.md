...
A regisztrálási feladat törlése az alapértelmezett tartományon név szerint.
...
A megadott hatókörből törli a regisztrációs feladatot név szerint.
...
### -Scope (hatókör)
A regisztrációs feladat hatóköre.
