...
### Példa 1: tűzfalszabály létrehozása egy MariaDB alatt
```powershell
...
Ez a parancs a MariaDB csoportban hoz létre tűzfal-szabályt.

### 2. példa: új MariaDB-tűzfal-szabály létrehozása a-ClientIPAddress.
```powershell
...
Ezzel a parancsmaggal létrehozhatja a MariaDB-ClientIPAddress.

### 3. példa: új MariaDB-tűzfalszabályok létrehozása az összes IPs engedélyezéséhez
```powershell
...
Ezzel a parancsmaggal új MariaDB-tűzfalszabályok hozhatók létre az összes IP-hez.
