...
### Példa 1: új MariaDB létrehozása
```powershell
...
A parancs új MariaDB hoz létre.

## PARAMÉTEREK

### -AdministratorLoginPassword
A rendszergazda jelszava SecureString kell lennie.
...
A rendszergazda felhasználóneve.
...
### -GeoRedundantBackup
Engedélyezze a Geo-redundáns vagy nem a kiszolgáló biztonsági másolatát.
