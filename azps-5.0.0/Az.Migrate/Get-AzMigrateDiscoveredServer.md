...
## Áttekintés
Az összes felfedezett kiszolgáló beolvasása egy áttelepítési projektben.
...
Az áttelepítési projekt összes kiszolgálójának beolvasása
...
Kiszolgáló beszerzése egy áttelepítési projektben név szerint.
A név a kiszolgáló egyedi Paramenter.

### 3 Példa: lista egy készüléken
```powershell
...
A projektben lévő készülékek összes kiszolgálójának listázása.

### 4 példa: beolvasás egy készüléken
```powershell
...
Szerezzen be egy kiszolgálót a készülékhez a projektben.
A név a kiszolgáló egyedi Paramenter.

### Példa 5: lista és szűrés megjelenítendő névvel
```powershell
...
A kiszolgálók egy áttelepítési projektben és a megjelenítendő névvel rendelkező válaszok szűrése

### Példa 6: lista egy készüléken, és szűrés megjelenített névvel
```powershell
...
Az áttelepítési projektben a készülékek listáját, valamint a megjelenítendő névvel rendelkező válaszokat szűrheti.

## PARAMÉTEREK

### -ApplianceName
A készülék nevét adja meg.
Ez a belső Térkép egy webhelyre mutat.
...
### -DisplayName
A VMware Machine megjelenítendő nevét adja meg.
...
Ez egy belső név.
Felhasználók esetében használja a megjelenítendő nevet.
...
### Microsoft. Azure. PowerShell. parancsmagok. áttelepítés. models. Api202001. IVMwareMachine
