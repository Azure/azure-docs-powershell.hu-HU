...
### Példa 1: az összes anyag beolvasása erőforráscsoport szerint és a boltozat neve
```powershell
...
A teljes anyag kinyerése az erőforráscsoport és a boltozat csoportban

### 2. példa: az anyag beolvasása erőforráscsoport szerint, a boltozat neve és a szövet neve
```powershell
...
### Microsoft. Azure. PowerShell. parancsmagok. áttelepítés. models. Api20180110. IFabric
