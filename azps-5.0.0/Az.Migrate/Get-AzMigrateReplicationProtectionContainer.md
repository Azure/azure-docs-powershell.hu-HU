...
### 1. példa: az összes védett tároló felsorolása a boltozaton és a szöveten
```powershell
...
### Microsoft. Azure. PowerShell. parancsmagok. áttelepítés. models. Api20180110. IProtectionContainer
