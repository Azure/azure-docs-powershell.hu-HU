...
### Példa 1: az összes szolgáltató beszerzése a Vault-ban
```powershell
...
### -ProviderName
Helyreállítási szolgáltató neve
...
### Microsoft. Azure. PowerShell. parancsmagok. áttelepítés. models. Api20180110. IRecoveryServicesProvider
