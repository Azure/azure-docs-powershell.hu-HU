...
## Áttekintés
Lekérdezi a replikálási kiszolgáló részleteit.
...
### Példa 1: adatok beolvasása azonosító szerint
```powershell
...
### 2. példa: az összes listázása a Projectben azonosító szerint
```powershell
...
### 2. példa: a Projectben név szerint listázva
```powershell
...
### -DiscoveredMachineId
A felismert kiszolgáló gépi AZONOSÍTÓját adja meg.
...
### -Projektnév
A jelenlegi előfizetésben az Azure áttelepítési projektet adja meg.
...
### Microsoft. Azure. PowerShell. parancsmagok. áttelepítés. models. Api20180110. IMigrationItem
