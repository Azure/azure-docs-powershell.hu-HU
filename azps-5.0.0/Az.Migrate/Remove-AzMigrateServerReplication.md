...
## Áttekintés
Leállítja az áttelepített kiszolgáló replikálását.
...
### 1. példa: eltávolítás azonosítóval
```powershell
...
Újraszinkronizálás azonosítóval
...
### -TargetObjectID
Annak a replcating-kiszolgálónak a megadása, amelyhez a replicatio le kell tiltani.
