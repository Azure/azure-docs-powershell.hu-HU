...
## Áttekintés
Elindítja a replikálási kiszolgáló áttelepítését.
...
### -InputObject
Azt a replikálási kiszolgálót adja meg, amelyen a teszt áttelepítését kezdeményezni kell.
...
### -TestNetworkID
Frissíti a virtuális hálózati azonosítót a cél Azure-előfizetésben, amelyet az áttelepítés teszteléséhez kell használni.
...
INPUTOBJECT <IMigrationItem> : azt a replikáló kiszolgálót adja meg, amelyre a teszt-áttelepítést be kell indítani. A kiszolgálói objektum az Get-AzMigrateServerReplication parancsmag használatával is beolvasható.
