...
## Leírás
Naplózási riasztási szabály frissítése, ha a parancs támogatja a csak az "enabled" tulajdonság frissítését.
A többi tulajdonság frissítéséről a [set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) parancs nyújt tájékoztatást.

## Példák

### Példa 1: szabály nevének frissítése
```powershell
...
### 2. példa: beviteli objektum általi frissítés
```powershell
...
### 3. példa: erőforrás-azonosító szerinti frissítés
```powershell
