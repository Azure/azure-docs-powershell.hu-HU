...
### 1. példa: a MySql-kiszolgáló beolvasása alapértelmezett környezettel
```powershell
...
Ezt a parancsmagot a MySql-kiszolgáló alapértelmezett környezettel kapja.

### 2. példa: a MySql-kiszolgáló beolvasása erőforráscsoport és kiszolgálónév szerint
```powershell
...
Ez a parancsmag az erőforráscsoport és a kiszolgáló neve alapján kapja meg a MySql-kiszolgálót.

### 3. példa: a megadott erőforráscsoport összes MySql-kiszolgálójának listája
```powershell
...
### 4. példa: a MySql-kiszolgáló beolvasása identitással
```powershell
...
Ez a parancsmag a MySql-kiszolgálót identitás szerint jeleníti meg.
