...
### 1. példa: a MySql tűzfalszabályok eltávolítása név szerint
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Ez a parancsmag eltávolítja a MySql tűzfal szabályát név szerint.

### 2. példa: a MySql tűzfal szabályának eltávolítása identitással
```powershell
...
Ezek a parancsmagok a MySql-tűzfal szabályait identitással távolítják el.
