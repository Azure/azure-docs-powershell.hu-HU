...
### 1. példa: a MySql-kiszolgáló virtuális hálózati szabályának eltávolítása név szerint
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Ez a parancsmag eltávolítja a MySql-kiszolgáló virtuális hálózati szabályát név szerint.

### 2. példa: a MySql-kiszolgáló virtuális hálózati szabályának eltávolítása identitással
```powershell
...
Ezek a parancsmagok a MySql-kiszolgáló virtuális hálózati szabályait identitással távolítják el.
