...
### 1. példa: a MySql-kiszolgáló újraindítása erőforráscsoport és kiszolgálónév szerint
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Ez a parancsmag a MySql Servert az erőforráscsoport és a kiszolgáló neve alapján indítja el.

### 2. példa: a MySql-kiszolgáló újraindítása identitással
```powershell
...
Ezek a parancsmagok a MySql szervert identitással indítják újra.
