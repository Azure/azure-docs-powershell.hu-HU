...
Ez a parancsmag a MySql konfigurációját név szerint frissíti.

### 2. példa: a MySql-konfiguráció frissítése identitással.
```powershell
...
Ezek a parancsmagok identitással frissítik a MySql konfigurációt.
