...
### 1. példa: a MySql-kiszolgáló frissítése az erőforráscsoport és a kiszolgáló neve szerint
```powershell
...
Ez a parancsmag az erőforráscsoport és a kiszolgáló neve szerint frissíti a MySql-kiszolgálót.

### 2. példa: frissítse a MySql szervert identitással.
```powershell
...
Ez a parancsmag identitással frissíti a MySql-kiszolgálót.
