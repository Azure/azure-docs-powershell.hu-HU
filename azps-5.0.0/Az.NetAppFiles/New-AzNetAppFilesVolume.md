...
Ezzel a paranccsal létrejön az új ANF-kötet "MyAnfVolume" a "MyAnfPool" alkalmazáskészleten belül.
...
### -CreationToken
A kötet egyedi fájlelérési útja
...
### -ExportPolicy
Az exportálási házirendet reprezentáló Hashtable tömb
...
### -ReplicationObject
A replikációs objektumot reprezentáló Hashtable tömb
...
### -ServiceLevel
A ANF-kötet szolgáltatási szintje
...
### -SnapshotId
Kötet létrehozása pillanatképből A pillanatkép azonosításához használt UUID v4 vagy erőforrás-azonosító
...
### – NetI
Egy delegált alhálózat Azure Resource URI azonosítója
...
### -UsageThreshold
A maximális tárterület kvótája a fájlrendszerben bájtban kifejezve
