...
Ez a parancs eltávolítja a ANF replikációs kapcsolatát a "MyDestinationAnfVolume" köteten.
...
### -InputObject
A ANF az eltávolítandó replikációval
...
### -PassThru
A megadott ANF-replikáció sikeres eltávolításának visszaadása
