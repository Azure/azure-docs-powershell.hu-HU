...
## Leírás
A cél köteten lévő kapcsolat folytatása és újraszinkronizálása
...
Ez a parancs folytatja a ANF replikációs kapcsolatát a "MyDestinationAnfVolume" köteten.
...
### -InputObject
A ANF replikációs cél mennyiségi objektuma az újraszinkronizáláshoz
...
### -Name (név)
A ANF replikációs cél kötetének neve
...
### -PassThru
A megadott replikációs kötet újraszinkronizálásának visszaadása
...
### -ResourceGroupName
A ANF replikációs rendeltetési kötetének erőforráscsoport
...
### -ResourceId
A ANF replikációs célként megadott kötet erőforrás-azonosítója
