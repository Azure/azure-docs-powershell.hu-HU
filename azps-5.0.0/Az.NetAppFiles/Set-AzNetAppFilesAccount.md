...
## Leírás
A **set-AzNetAppFilesAccount** PARANCSMAG a ANF-fiókot módosítja.

## Példák

### Példa 1: ANF-fiók módosítása
```
...
Ez a parancs egy frissítést hajt végre az adott fiókban. Az Active Directory hiánya azt jelenti, hogy az törlődik a fiókból.
