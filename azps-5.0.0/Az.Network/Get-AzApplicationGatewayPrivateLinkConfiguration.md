...
## Áttekintés
Az alkalmazás-átjáró privát hivatkozásának beállítása.
...
## Leírás
A **Get-AzApplicationGatewayPrivateLinkConfiguration** parancsmag az Application Gateway privát hivatkozásának konfigurációját kapja meg.

## Példák

### Példa 1: a privát hivatkozás beszerzése beállítás
```powershell
...
A második parancs beolvassa a privateLinkConfig01 nevű privát hivatkozás-konfigurációt a $AppGw, és a $PrivateLinkConfiguration változóban tárolja.

### 2. példa: a privát hivatkozás konfigurációjának beszerzése
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Az első parancs beolvassa a ApplicationGateway01 nevű alkalmazás-átjárót a ResourceGroup01 nevű erőforráscsoport nevéből, és a $AppGw változóban tárolja.
A második parancs a $AppGw, és a $PrivateLinkConfigurations változóban tárolja az összes magánjellegű hivatkozás konfigurációját.
...
### -Name (név)
Az Application Gateway privateLink-konfigurációjának neve
...
[Új – AzApplicationGatewayPrivateLinkConfiguration](./New-AzApplicationGatewayPrivateLinkConfiguration.md)
