...
## Leírás
A **Get-AzAvailablePrivateEndpointType** parancsmag az összes elérhető privát végpont-típust visszaállítja a helyről.
...
Ez a példa a hely minden elérhető privát végpont-típusát visszaállítja.
