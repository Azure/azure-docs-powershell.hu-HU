...
A fenti létrehoz egy erőforráscsoport, virtuális WAN, virtuális hálózat, virtuális hub a Nyugat-középen amerikai "testRG" erőforráscsoport az Azure-ban. Ezt követően egy ExpressRoute átjáró jön létre a virtuális központban, 2 léptékű egységgel.

Ezt követően a ExpressRouteGateway a resourceGroupName és az átjáró nevével kapja meg.
...
Ez a parancs a "teszt" kezdetű összes ExpressRouteGateways fogja kapni
