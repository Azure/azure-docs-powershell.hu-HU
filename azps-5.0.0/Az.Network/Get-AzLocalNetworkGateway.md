...
A **Get-AzLocalNetworkGateway** parancsmag a helyszíni átjáró nevét és az erőforráscsoport neve alapján adja eredményül.

## Példák

### Példa 1: helyi hálózati átjáró beszerzése
```powershell
...
A helyi hálózati átjáró objektumát adja eredményül, az "myRG" erőforráscsoporthoz tartozó "myLocalGW1" névvel

### 2. példa: a helyi hálózati átjárók beszerzése szűréssel
```powershell
...
A helyi hálózati átjáró objektumát adja eredményül, az "myRG" erőforráscsoporthoz tartozó "myLocalGW" névvel kezdve
