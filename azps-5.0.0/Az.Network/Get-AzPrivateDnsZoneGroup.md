...
## Leírás
A **Get-AzPrivateDnsZoneGroup** parancsmag egy vagy több titkos DNS-zóna csoportba kerül.

## Példák

### Példa 1: személyes DNS-zóna csoportjának beolvasása
```powershell
...
A fenti példa beolvassa a dnsgroup1 nevű privát DNS-zóna csoportot az erőforráscsoport RG csoportjában.
