...
## Áttekintés
Beolvassa a VirtualHub társított hub Route Table erőforrást.
...
## Leírás
A megadott virtuális központhoz társított megadott hub-útválasztási táblázat lesz.
...
Ez a parancs a virtuális központ központi útválasztási táblázatát kapja.
...
Ez a parancs felsorolja az összes hub Route táblát a megadott VirtualHub.
...
### -ResourceId
A beolvasott vhubroutetable-erőforrás erőforrás-azonosítója.
