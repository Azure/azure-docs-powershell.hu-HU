...
## Áttekintés
A hálózat virtuális készülékhez kapcsolódó erőforrás (oka) t tartalmazó webhelyek beszerzése vagy listázása
...
## Leírás
A Get-AzVirtualApplianceSite olyan webhelyeket kap vagy sorol fel, amelyek egy vagy több hálózati virtuális készülék-erőforráshoz kapcsolódnak.
...
Virtuális készülék webhelyének erőforrásának beszerzése
...
Virtuális Appliance-források listázása egy hálózati virtuális készüléken.
...
A webhelyhez csatolt hálózati virtuális készülék.
...
### -ResourceId
A virtuális gép webhelyének erőforrás-azonosítója.
