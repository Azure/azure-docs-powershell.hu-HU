...
## Áttekintés
Meghatározott virtuális útválasztó-társ által hirdetett útvonalak listája
...
## Leírás
Ha név vagy objektum szerint adja meg A virtuális útválasztót, egy adott virtuális útválasztó által az adott partnernek hirdetett útvonalakat sorolja fel.
...
### -PeerName
Virtuális útválasztó-társ neve
...
### -ResourceGroupName
A virtuális útválasztó társközi erőforráscsoport neve
