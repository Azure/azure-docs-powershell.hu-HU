...
## Áttekintés
IP-konfiguráció létrehozása a PrivateLink-konfigurációhoz való társításhoz
...
## Leírás
A **New-AzApplicationGatewayPrivateLinkIpConfiguration** parancsmag olyan IP-konfigurációt hoz létre, amelyet az Azure Application Gateway PrivateLink-konfigurációjához társít.

## Példák

### 1. példa: PrivateLink IP-konfigurációja
```powershell
PS C:\> $PrivateLinkIpConfiguration = New-AzApplicationGatewayPrivateLinkIpConfiguration -Name "ipConfig01" -Subnet $subnet -Primary
```

Ez a parancs létrehoz egy "ipConfig01" nevű PrivateLink IP-konfigurációt, amelyet az eredmény az $PrivateLinkIpConfiguration nevű változóban tárol. 
...
### -Elsődleges
Jelzi, hogy az IP-konfiguráció elsődleges.
...
### -PrivateIpAddress
A ipConfiguration privát IP-címe, ha a statikus kiosztást szeretné használni.
...
Az IP-konfiguráció IP-verziója
