...
## Áttekintés
A terheléselosztó backend-cím konfigurációját számítja ki. 
...
### Példa 1
### 2. példa: új loadbalancer-cím, virtuális hálózati hivatkozással
```powershell
...
### -Ip_cím
A backend-gyűjtőhöz hozzáadni kívánt Ip_cím
...
### -Name (név)
A backend-cím konfigurációjának neve
...
### -VirtualNetworkId
A backend Address config társított virtuális hálózat
