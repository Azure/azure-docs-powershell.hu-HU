...
## Áttekintés
Hozzon létre egy hálózati virtuális készülék erőforrást.
...
## Leírás
A New-AzNetworkVirtualAppliance parancs létrehoz egy hálózati Virtual Appliance-erőforrást az Azure-ban.
...
Új hálózati virtuális készülék erőforrást hoz létre az erőforráscsoport: testrg.
...
A Cloudinit-konfiguráció egyszerű szövegként van formázva.
...
A Cloudinit-konfiguráció blob-tárolójának URL-címe.
...
### -VirtualHubId
A virtuális hub erőforrás-azonosítója.
