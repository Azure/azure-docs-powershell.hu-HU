...
### -AzureSubnet
Azure alhálózati végpont kapcsolója
...
### -CoverageLevel
A végpont tesztelési hatóköre.
A támogatott értékek az alapértelmezettek, az alacsony, a BelowAverage, az átlag, a AboveAvergae, a teljes.
...
### -ExcludeItem
Azoknak az elemeknek a listája, amelyeket ki kell zárni a végponti hatókörből.
...
### -IncludeItem
Azoknak az elemeknek a listája, amelyeket fel kell venni a endpont-tartományba.
...
### -MMAWorkspaceMachine
MMA munkaterület-gép végpont kapcsolója
...
### -MMAWorkspaceNetwork
MMA-munkaterület hálózati végpont kapcsoló.
