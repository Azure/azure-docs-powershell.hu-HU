...
## Leírás
Az New-AzNetworkWatcherConnectionMonitorOutputObject parancsmag a kapcsolat figyelése cél objektumot hozza létre.
...
Írja be a következőt: "Munkaterület" WorkspaceSettings: {"WorkspaceResourceId": "MyWSResourceId"}
...
### -OutputType
A kapcsolat-monitor kimeneti rendeltetési típusa. Jelenleg csak \" a munkaterület \" támogatott.
...
### -WorkspaceResourceId
Log Analytics Workspace-erőforrás azonosítója
