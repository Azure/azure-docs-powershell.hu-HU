...
## Leírás
Az New-AzNetworkWatcherConnectionMonitorTestConfigurationObject parancsmag létrehoz egy kapcsolat-monitor teszt-konfigurációt.
...
Név: httpTC TestFrequencySec: 120 PreferredIPVersion: ProtocolConfiguration: {"Port": 443, "Method": "GET", "RequestHeaders": [{"név": "Allow", "value": "GET"}], "ValidStatusCodeRanges": ["2xx"; "300-308"]; "PreferHTTPS": true} SuccessThreshold: {"ChecksFailedPercent": 20, "RoundTripTimeMs": 30} 
...
### -Name (név)
A kapcsolat figyelője teszt-konfiguráció neve.
...
### -PreferredIPVersion
A tesztelés kiértékeléséhez használni kívánt IP-verzió. Előfordulhat, hogy a kapcsolati monitor más paraméterektől függően eltérő verziót használ.
...
Az egyes protokollokon végzett tesztelési értékeléshez használt paraméterek.
...
A teszteléshez csak a sikeres kiértékeléshez engedélyezett sikertelen vizsgálatok maximális százalékos aránya.
...
A vizsgálat során az eredményként való kiértékeléshez megengedett maximális idő ezredmásodpercben.
...
### -TestFrequencySec
A teszt kiértékelésének gyakorisága másodpercben.
