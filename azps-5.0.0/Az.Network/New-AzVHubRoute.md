...
```
A fenti parancsok bemutatják a már meglévő AzVHubRoute RoutingConfiguration, majd hozzáadhat egy statikus útvonalat a kapcsolathoz. Azt is megteheti, hogy új kapcsolatot hoz létre a statikus útvonalon belül, az első példa [itt található.](New-AzRoutingConfiguration.md)
## PARAMÉTEREK
