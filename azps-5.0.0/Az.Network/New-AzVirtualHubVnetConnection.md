...
Az New-AzVirtualHubVnetConnection parancsmag olyan HubVirtualNetworkConnection-erőforrást hoz létre, amely egy virtuális hálózatot hoz létre az Azure Virtual hub-hoz. autogenerated
...
```
A fenti művelet új útválasztási konfigurációt hoz létre, és statikus útvonalakat hoz létre az útválasztási konfigurációban a következő ugrással megadott IP-címmel. Ezt az útválasztási konfigurációt ezután átadhatja a New-AzVirtualHubVnetConnection parancsnak a paraméter-RoutingConfiguration.
