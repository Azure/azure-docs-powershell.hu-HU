...
A fentiekben létrehozunk egy erőforráscsoportot (virtuális WAN) a kelet-amerikai "nonlinkSite" erőforráscsoporthoz az Azure-ban. 

Ezután létrehoz egy VpnSite, amely egy ügyfél-fióktelepet jelenít meg, és a virtuális WAN-ra hivatkozik.

Az IPSec-kapcsolat ezután beállítható az adott elágazással és egy VpnGateway a New-AzVpnConnection parancs segítségével.
...
A fentiekben létrehozunk egy erőforráscsoportot, egy virtuális WAN-csoportot és egy VpnSite, amelyben az Azure-alapú "Multilink" erőforráscsoport a kelet-amerikai VpnSiteLinks tartalmaz.

### 3. példa

Új Azure VpnSite-erőforrás létrehozása autogenerated
...
### -O365Policy
Az Office 365 forgalmi breakout irányelvei ebben a VpnSite.
...
### -VpnSiteLink
Annak a VpnSiteLinks a listája, amelyre ez a VpnSite van.
