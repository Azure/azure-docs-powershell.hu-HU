...
## Leírás
A **Remove-AzCustomIpPrefix** parancsmag eltávolítja a CustomIpPrefix.
...
Eltávolítja a CustomIpPrefix nevű $prefixName az erőforráscsoport csoportból $rgName
