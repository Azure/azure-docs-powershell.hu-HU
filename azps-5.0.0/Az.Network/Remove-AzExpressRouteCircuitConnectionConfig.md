...
### 3. példa: az áramkör-kapcsolat konfigurációjának eltávolítása egy ExpressRoute-áramkörről egy adott cím család számára
```
$circuit_init = Get-AzExpressRouteCircuit -Name $initiatingCircuitName -ResourceGroupName $rg
...
### Példa 4: az áramkör-kapcsolat konfigurációjának eltávolítása egy ExpressRoute-áramkörről egy adott cím család számára
```
...
```
### -AddressPrefixType
Annak a címnek a családját adja meg, amelyet el kell távolítani a konfigból. 
