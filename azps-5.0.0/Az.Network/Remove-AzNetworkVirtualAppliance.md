...
## Áttekintés
Hálózati virtuális készülék erőforrásának eltávolítása.
...
## Leírás
A Remove-AzNetworkVirtualAppliance parancs eltávolítja a hálózat virtuális Appliance-erőforrását.
...
A hálózat virtuális készülékhez tartozó erőforrás törlése
