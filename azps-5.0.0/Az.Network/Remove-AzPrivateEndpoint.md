...
## Leírás
A **Remove-AzPrivateEndpoint** parancsmag eltávolítja a privát végpontot. 
...
Ez a példa eltávolítja a MyPrivateEndpoint1 nevű privát végpontot.
...
### -ResourceGroupName
A privát végpont erőforráscsoport neve.
