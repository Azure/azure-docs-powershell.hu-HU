...
## Leírás
A Set-AzNetworkWatcherConnectionMonitor parancsmag frissíti a kapcsolat figyelése erőforrást.

## Példák

### 1. példa: a kapcsolat monitorának frissítése
```
...
### -ResourceId
ConnectionMonitor erőforrás-azonosító.
