...
```
### 3. példa
Csomagkapcsolt rögzítési példa az összes belső és külső csomag rögzítésére
```powershell
...
### -FilterData
Szűrési lehetőségek a virtuális hálózati átjáró kapcsolaton keresztüli csomagok rögzítésének megkezdéséhez.
...
### -Name (név)
A virtuális hálózati átjáró kapcsolatának neve, amelybe a csomagot el kell indítani.
