...
### -FilterData
Szűrési lehetőségek a virtuális hálózati átjáró indítási csomagjának rögzítésére.
...
### -Name (név)
A virtuális hálózat átjárójának neve, ahová a csomagot el kell indítani.
