...
## Leírás
Hozzon létre regisztrált ASN a társközi objektumokhoz.

## Példák

### A személyes használat és a regisztrált ASN létrehozása
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Szerezzen be egy olyan munkatársat, aki regisztrált ASN-t szeretne felvenni. Ezután adja át a parancsmagot.
...
### Microsoft. Azure. PowerShell. parancsmagok. társközi. models. PSPeeringRegisteredAsn
