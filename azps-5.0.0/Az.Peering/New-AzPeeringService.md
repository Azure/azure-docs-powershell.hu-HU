...
## Leírás
A társas szolgáltatás létrehozása.
...
Egy társközi szolgáltatási objektumot hoz létre a szolgáltatóval és a kinézeti helyekkel. Használat a conjuction-ban `Get-AzPeeringServiceProvider` és a `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Az Azure-területtől eltérő fizikai hely. Get-AzPeeringServiceLocation [-Country <country> ] használata
...
A társas szolgáltató neve.
Get-AzPeeringServiceProvider parancsmag használata listához
...
### -Címke
A Microsoft InputObject szolgáltatással társítani kívánt címkék.
