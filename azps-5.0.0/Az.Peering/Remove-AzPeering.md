...
## Leírás
Perminently: egy társközi erőforrás törlése
...
Erőforrás-azonosítóval rendelkező társközi fiók eltávolítása
...
### -InputObject
Az objektum beolvasásához használja a Get-AzPeering.
...
### -PassThru
Igaz érték visszaadása befejezettként
