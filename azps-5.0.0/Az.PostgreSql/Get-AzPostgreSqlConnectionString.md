...
### Példa 1: PostgreSql-kiszolgáló kapcsolódási karakterláncának beolvasása az erőforráscsoport és a kiszolgáló neve alapján
```powershell
...
Ez a parancsmag a PostgreSql Server Connection karakterláncot az erőforráscsoport és a kiszolgálónév alapján kapja meg.

### 2. példa: PostgreSql-kiszolgáló kapcsolati karakterláncának beolvasása identitás szerint
```powershell
...
Ez a parancsmag identitással kapja meg a PostgreSql-kiszolgáló kapcsolati karakterláncát.
