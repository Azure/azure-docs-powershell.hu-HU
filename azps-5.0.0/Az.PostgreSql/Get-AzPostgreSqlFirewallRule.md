...
### Példa 1: a megadott PostgreSql-kiszolgáló összes tűzfal-szabályának listázása
```powershell
...
Ez a parancsmag a megadott PostgreSql-kiszolgálón lévő összes tűzfalszabály listáját tartalmazza.

### 2. példa: tűzfalszabály beszerzése név alapján
```powershell
...
Ez a parancsmag a tűzfal szabályait név szerint kapja.

### 3. példa: tűzfalszabályok beszerzése identitással
```powershell
...
Ez a parancsmag identitással kapja meg a tűzfal szabályait.
