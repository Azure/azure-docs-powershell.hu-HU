...
### 1. példa: új PostgreSql-kiszolgáló tűzfal-szabály létrehozása
```powershell
...
Ezzel a parancsmaggal létrehozhatja a PostgreSql Server-tűzfalszabályok szabályát.

### 2. példa: új PostgreSql-tűzfalszabályok létrehozása a-ClientIPAddress használatával.
```powershell
...
Ezzel a parancsmaggal létrehozhatja a PostgreSql-tűzfal szabályát a-ClientIPAddress-ban.

### 3. példa: új PostgreSql-tűzfal szabály létrehozása az összes IPs engedélyezéséhez
```powershell
...
Ezzel a parancsmaggal új PostgreSql-tűzfalszabályok hozhatók létre az összes IP-hez.
...
### Microsoft. Azure. PowerShell. parancsmagok. PostgreSql. models. Api20171201. IFirewallRule
