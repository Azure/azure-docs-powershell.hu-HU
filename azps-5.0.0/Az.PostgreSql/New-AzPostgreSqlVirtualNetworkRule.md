...
### 1. példa: új PostgreSql-kiszolgáló virtuális hálózati szabály létrehozása
```powershell
...
Ezekkel a parancsmagokkal létrehozhatja a PostgreSql-kiszolgáló virtuális hálózati szabályát.
