...
### 1. példa: a PostgreSql-kiszolgáló eltávolítása a resourceGroup és a kiszolgáló nevével
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Ez a parancsmag eltávolítja a PostgreSql Servert a resourceGroup és a kiszolgálónév alapján.

### 2. példa: a PostgreSql-kiszolgáló eltávolítása identitással
```powershell
...
Ezek a parancsmagok a PostgreSql-kiszolgálót identitással távolítják el.
