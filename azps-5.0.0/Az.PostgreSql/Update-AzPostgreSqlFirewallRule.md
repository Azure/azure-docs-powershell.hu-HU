...
### 1. példa: a PostgreSql-tűzfal szabályának frissítése név szerint
```powershell
...
Ez a parancsmag a PostgreSql-tűzfal szabályait név szerint frissíti.

### 2. példa: a PostgreSql-tűzfal szabályának frissítése identitással.
```powershell
...
Ezek a parancsmagok a PostgreSql-tűzfal szabályait identitás szerint frissítik.

### 3. példa: a PostgreSql Firewall Rule by-ClientIPAddress frissítése
```powershell
...
Ezek a parancsmagok a PostgreSql tűzfal szabályait frissítik ClientIPAddress.
