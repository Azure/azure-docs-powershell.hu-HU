...
### Példa 4: az összes AzureVM-feladat beszerzése az elmúlt két napon sikeres befejezés után

```powershell
$vault = Get-AzRecoveryServicesVault -ResourceGroupName "resourceGroup" -Name "vaultName"
$Jobs = Get-AzRecoveryServicesBackupJob  -VaultId $vault.ID  -Status Completed -From (Get-Date).AddDays(-2).ToUniversalTime() -BackupManagementType AzureVM
```
Az első parancsmag beolvassa a boltozat objektumát. A második parancsmag minden olyan AzureVM-feladatot tárol az adott Vault-ban, amely a $jobs utolsó két napján befejeződött. Módosítsa a BackupManagementType paraméter értékét a Mohácsi értékre a Mohácsi-ügynök munkahelyeinek beolvasásához.

## PARAMÉTEREK

### -BackupManagementType

A védelemmel ellátott erőforrások osztálya. Jelenleg a parancsmag által támogatott értékek: AzureVM, AzureStorage, AzureWorkload, Mohácsi.
