...
## Leírás
A **Get-AzRecoveryServicesBackupProtectionPolicy** parancsmag az Azure Backup Protection házirendjeit kapja a boltozathoz.
...
A védelemmel ellátott erőforrások osztálya. A parancsmag által támogatott értékek jelenleg a AzureVM, az AzureStorage és a AzureWorkload
...
### -WorkloadType
Az erőforrás terhelési típusa. Az aktuálisan támogatott értékek a AzureVM, az AzureFiles, az MSSQL
