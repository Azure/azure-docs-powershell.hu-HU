...
## Leírás
A **New-AzRelayAuthorizationRule** parancsmag új engedélyezési szabályt hoz létre a megadott továbbítóügynökök (Namespace/WcfRelay/HybridConnection) számára.
...
`AuthoRule1`A hibrid kapcsolat **figyelési** jogát hozza létre `TestHybridConnection` .
