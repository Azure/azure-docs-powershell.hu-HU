...
## Leírás
A **Remove-AzRelayHybridConnection** parancsmag eltávolítja a HybridConnection a megadott továbbító névtérből.
...
Eltávolítja a HybridConnection `TestHybridConnection` a névtérből `TestNameSpace-Relay1` .
