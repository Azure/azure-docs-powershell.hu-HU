...
## Leírás
A teljes módosítások listája `Reservation` .
...
Az adott foglalás korábbi verzióinak áttekintése
...
### -Foglalás
Pipe Object paraméter az `Reservation` s értékhez
...
### -ReservationId
A `Reservation` megjelenítendő előzmények ReservationId
...
### -ReservationOrderId
Az a ReservationOrderId, amelyben `ReservationOrder` a `Reservation`
