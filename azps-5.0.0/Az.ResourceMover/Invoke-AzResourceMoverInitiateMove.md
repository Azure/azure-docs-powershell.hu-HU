...
### Példa 1: a dependecies érvényesítése az erőforrások áthelyezésének megkezdése előtt.
```powershell
...
Ellenőrizze a dependecies, mielőtt elindítja az erőforrás-áthelyezést.

### 2. példa: áthelyezés kezdeményezése az áthelyezés gyűjteményben a "MoveResource név" beállítással
```powershell
...
Az áthelyezés az áthelyezés gyűjteményben a "MoveResource név" beállítással

### 3. példa: áthelyezés kezdeményezése az áthelyezés gyűjteményben a "SourceARMID" bemenettel
```powershell
...
Lépés: az áthelyezés a gyűjteményben a "SourceARMID" érték beírásával kezdeményezhető.
