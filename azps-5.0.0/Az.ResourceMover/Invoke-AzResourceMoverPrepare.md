...
### Példa 1: a dependecies érvényesítése az erőforrások előkészítése előtt
```powershell
...
Ellenőrizze a dependecies, mielőtt felkészüljenek az erőforrásokra.

### 2. példa: Felkészülés az erőforrások készletére az áthelyezés gyűjteményben a "MoveResource név" értékkel bemenetként
```powershell
...
A "MoveResource név" érték beírásával kezdeményezi az áthelyezési gyűjteményben az erőforrások készletére való felkészülést.

### 3. példa: Felkészülés az erőforrások készletére az áthelyezés gyűjteményben a "SourceARMID" használatával
```powershell
...
Az áthelyezés gyűjteményben az "SourceARMID" kifejezésre való felkészülést kezdeményez az áthelyezési gyűjteményben.
