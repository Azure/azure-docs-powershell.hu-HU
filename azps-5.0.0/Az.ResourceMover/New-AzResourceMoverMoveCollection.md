...
### Példa 1: új áthelyezési gyűjtemény létrehozása.
```powershell
...
Új áthelyezési gyűjtemény létrehozása az előfizetésen belül.
...
### -IdentityPrincipalId
A fő azonosítót kapja vagy állítja be.
...
### -IdentityTenantId
A bérlői azonosítót kapja vagy állítja be.
...
### -IdentityType
A területi áthelyezési szolgáltatáshoz használt identitás típusa.
...
### -SourceRegion
A forrás terület beolvasása vagy beállítása.
...
### -TargetRegion
A cél területének beolvasása vagy beállítása.
