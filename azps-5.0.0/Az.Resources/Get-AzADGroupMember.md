...
### 1. példa: HIRDETÉSCSOPORT-objektum azonosítója alapján listázhatja a tagokat
...
### 2. példa: a tagokat a HIRDETÉSCSOPORT-azonosítók alapján listázhatja a személyhívóval
...
### 3. példa: a tagok kilistázása csővezetékekkel

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Get-AzADGroupMember
```

Megkapja a "85F89C90-780E-4AA6-9F4F-6F268D322EEE" azonosítójú HIRDETÉSCSOPORTOT, és a csoport összes tagjának listázásához a Get-AzADGroupMember parancsmagot használja. 
...
### Microsoft. Azure. Command. ActiveDirectory. PSADObject
