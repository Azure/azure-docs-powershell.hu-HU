...
Ez a parancs a What-If a bérlői hatókörben egy egyéni sablonfájl és egy, a lemezen lévő paramétert tartalmazó fájl használatával kapja a találatokat.
...
### 2. példa: What-If eredmény megszerzése a bérlői hatókörben a ResourceIdOnly
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
