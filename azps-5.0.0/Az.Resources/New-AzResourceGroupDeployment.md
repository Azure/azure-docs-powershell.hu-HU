...
Ez a parancs létrehoz egy új üzembe állítást egy egyéni sablon és egy sablonfájl segítségével a lemezen, a definiált címkék paraméterrel.
...
Ez a parancs egy új üzembe állítást hoz létre egy olyan egyéni és egy sablonfájl segítségével, amelyet a memóriában lévő Hashtable alakítottak.
Az első két parancs elolvassa a sablonfájl szövegét a lemezen, és a memória-Hashtable alakítja.
Az utolsó parancs a *TemplateObject* paramétert használva adja meg a Hashtable és a *TemplateParameterFile* paramétert egy paramétert és paramétert tartalmazó fájl megadásához.

### 3. példa

Azure-bevezetést ad hozzá egy erőforrás-csoporthoz. autogenerated
...
- Kész: az erőforrás-kezelő az erőforrás csoportban található erőforrásokat törli, a sablonban azonban nincs megadva. 
- Növekményes: az erőforrás-kezelő nem módosított erőforrásokat hagy elő az erőforrás csoportban, a sablonban azonban nincs megadva.
