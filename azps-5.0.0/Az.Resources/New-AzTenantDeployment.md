...
## Leírás
A **New-AzTenantDeployment** parancsmag bevezetést ad a jelenlegi bérlői hatókörhöz.

Ha a bérlői hatókörben szeretne bevezetést hozzáadni, adja meg a helyet és a sablont.
...
Ha erőforrásokat szeretne felvenni egy felügyeleti csoportba, használja az **új AzManagementGroupDeployment** , amely egy felügyeleti csoportban hoz létre központi telepítést.
...
Ez a parancs létrehoz egy új üzembe állítást az aktuális bérlői hatókörben egy egyéni sablon és egy sablonfájl segítségével a lemezen, a definiált címkék paraméterrel.
...
A parancs a jelenlegi bérlői webhelyre egy egyéni sablon és egy, a memória Hashtable-ra átalakított sablonfájl segítségével hoz létre új központi üzembe állítást.
