...
## Leírás
A **Remove-AzPolicySetDefinition** parancsmag eltávolítja a házirend-definíciót.
...
### -InputObject
A set definition objektum a másik parancsmagból származó kimenet eltávolításához.
