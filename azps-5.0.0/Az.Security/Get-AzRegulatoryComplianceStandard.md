...
## Leírás
Megtudhatja, hogy spcific-e a szabályok megfelelőségi satandard, vagy felsorolhatja az egyes előfizetések szerinti megfelelőségi szabványokat.
...
Az előfizetésben szereplő minden szabályozási megfelelőségi szabvány beszerzése.
...
Az egyes szabályozási megfelelőségi szabványokat a szokásos név szerint részletezve érheti el.
...
Az erőforrás-azonosító szerint meghatározott szabályozási megfelelőségi standardokat tudhat meg.
...
### Microsoft. Azure. Command. SecurityCenter. models. RegulatoryCompliance. PSSecurityRegulatoryComplianceStandard
