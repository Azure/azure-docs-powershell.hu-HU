...
## Leírás
A New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject parancsmag új listát hoz létre a megtagadott egyéni figyelmeztetési szabályokról az IoT biztonsági megoldásban az eszközök biztonsági csoportjához.
...
Új tiltó lista létrehozása egyéni figyelmeztetési szabály a Rull típus "SomeRuleType" és a status set to desuha
