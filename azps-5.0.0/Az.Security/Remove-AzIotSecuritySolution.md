...
## Leírás
A Remove-AzIotSecuritySolution parancsmag egy bizonyos IOT biztonsági megoldást töröl. A IoT biztonsági megoldás biztonsági adatokat és eseményeket gyűjt a IoT-eszközökről és a IoT hub-ról a fenyegetések megelőzése és észlelése érdekében.
...
A "MySample" IoT biztonsági megoldás törlése a "MyResourceGroup" erőforráscsoporthoz
