...
## Leírás
A Update-AzIotSecuritySolution parancsmag az alábbi updayes közül legalább egy adott IoT biztonsági megoldást tartalmaz: címkék, ajánlás-konfiguráció, felhasználó által definiált erőforrások.
A IOT biztonsági megoldásban csak a megadott tulajdonságok lesznek frissítve.
A IoT biztonsági megoldás biztonsági adatokat és eseményeket gyűjt a IoT-eszközökről és a IoT hub-ról a fenyegetések megelőzése és észlelése érdekében.
...
A "MySample" IOT biztonsági megoldásának frissítése a "MyResourceGroup" erőforráscsoporthoz "az ajánlás konfigurációja és a felhasználó által definiált erőforrásokkal"
