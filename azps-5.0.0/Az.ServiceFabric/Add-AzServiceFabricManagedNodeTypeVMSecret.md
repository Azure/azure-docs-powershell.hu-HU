...
## Leírás
Adjon hozzá titkos tanúsítványt a csomópont típusához. A titkot az Azure Key Vault-ban kell tárolni. A Key Vault-ról további információt a mi az Azure Key Vault? című témakörben talál. (https://azure.microsoft.com/en-us/documentation/articles/key-vault-whatis/). A parancsmagokról további információt az Azure Key Vault-parancsmagok ( https://msdn.microsoft.com/library/azure/dn868052.aspx) a Microsoft Developer Network Library vagy a Set-AzKeyVaultSecret parancsmag) című témakörben talál.
...
Ezzel a vesszővel elválasztott tanúsítvány titkos kulccsal, és a megadott titkos azonosítóval rendelkezik.
...
Ezzel a vesszővel elválasztott tanúsítvány titkos kulccsal rendelkezik, és a megadott titkos azonosítóval rendelkezik, a csövekkel.
...
### -CertificateStore
Annak a virtuális gépnek a tanúsítványtárolóját adja meg, amelyhez a tanúsítványt hozzá szeretné adni.
A megadott tanúsítványtároló implicit módon szerepel az LocalMachine-fiókban.
...
### -CertificateUrl
Ez egy titkos kulcsként feltöltött tanúsítvány URL-címe.
Ha titkos kulcsot szeretne hozzáadni a kulcshoz, olvassa el a \[ kulcs vagy titok hozzáadása a kulcs boltozatához című témakört \] https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add) .
Ebben az esetben a tanúsítványnak a következő JSON-objektum Base64-kódolásának kell lennie, amely UTF-8-ban kódolt: \<br\> \<br\> { \<br\> "Data": " \<Base64-encoded-certificate\> "; \<br\> "adattípus": "pfx", " \<br\> Password": " \<pfx-file-password\> " \<br\> }/
...
### -SourceVaultId
A tanúsítványokat tartalmazó fő Vault-erőforrás azonosítója.
