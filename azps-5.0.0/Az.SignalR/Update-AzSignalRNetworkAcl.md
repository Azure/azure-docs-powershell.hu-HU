...
## Áttekintés
A Szignálók hálózati hozzáférés-vezérlési szolgáltatásának frissítése
...
## Leírás
Frissítse a Szignálók hálózati hozzáférés-vezérlési szolgáltatását, például az alapértelmezett műveleteket és a hálózat hozzáférési szabálygyűjteményeit a nyilvános és a privát kapcsolathoz.

## Példák

### A RESTAPI engedélyezése, a nyilvános hálózat ClientConnection és az alapértelmezett műveletek megtagadásának beállítása
```powershell
...
### Ügyfél-kapcsolat és kiszolgáló kapcsolat engedélyezése privát végpontos kapcsolat esetén
```powershell
...
### Ügyfél-kapcsolat elutasítása nyilvános hálózat és privát végpontos kapcsolat esetén
```powershell
...
### – Engedélyezés
Engedélyezett hálózati ACL-eket
...
### -DefaultAction
A jelzést tartalmazó hálózat ACL-je alapértelmezett működésének engedélyezése vagy elutasítása. Ez a beállítás azt határozza meg, hogy a hálózati hozzáférés-vezérlési listák megtagadása vagy a hálózati ACL- Ha például az alapértelmezett művelet engedélyezve van, akkor csak az ACL-eket kell megtagadnia.
...
### -Deny
A hálózat hozzáférési szabálygyűjteményeit megtagadva
...
### -PrivateEndpointName
A frissítendő magánjellegű végpontok neve (i)
...
### -PublicNetwork
Nyilvános hálózati hozzáférés-vezérlési listák frissítése
...
### Microsoft. Azure. Command. Signal. models. PSSignalRNetworkAcls
