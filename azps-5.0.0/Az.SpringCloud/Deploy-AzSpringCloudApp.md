...
### 1. példa: telepítse a helyi lefordított jar szolgáltatást név szerint.
```powershell
...
Telepítse a helyi lefordított jar szolgáltatást név szerint.
...
### -JarPath
A jar elérési útjának deploied kell lennie.
