...
### 1. példa: a tavaszi felhő alkalmazás létrehozása
```powershell
...
A tavaszi felhő alkalmazás létrehozása
...
### Microsoft. Azure. PowerShell. parancsmagok. SpringCloud. modellek. Api20200701. IAppResource
