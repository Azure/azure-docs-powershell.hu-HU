...
### 1. példa: a tavaszi Felhőbeli szolgáltatás eltávolítása név szerint.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

A tavaszi felhő szolgáltatás eltávolítása név szerint

### 2. példa: a tavaszi felhő szolgáltatás eltávolítása a pipe-ról
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

A tavaszi felhő szolgáltatás eltávolítása a pipe-ról
