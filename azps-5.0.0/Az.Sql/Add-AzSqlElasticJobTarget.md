...
## Leírás
Az Add-AzSqlElasticJobTarget parancsmag a cél erőforrást hozzáadja a célcsoporthoz.
...
### 2. példa: adatbázis-tároló hozzáadása
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### 3. példa: rugalmas Pool-cél hozzáadása
```powershell
...
### 4. példa: szilánk-térképes cél hozzáadása
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Cél (kiszolgáló, rugalmas készlet, adatbázis és szilánk-Térkép) hozzáadása a célcsoporthoz
