...
## Leírás
A **disable-AzSqlInstanceActiveDirectoryOnlyAuthentication** parancsmag letiltja az Azure Active Directoryt (Azure ad), ha az aktuális előfizetésben csak a AzureSQL kezelt példány hitelesítési követelményeire van szükség.
...
Ez a parancs letiltja az Azure Active Directoryt (Azure AD) csak a ResourceGroup01 nevű ManagedInstance01 társított AzureSQL-alapú felügyelt példány hitelesítési követelményét.
