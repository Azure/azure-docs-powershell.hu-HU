...
## Leírás
A Get-AzSqlDatabaseSensitivityRecommendation parancsmag az adatbázis oszlopainak ajánlott adattípusait és érzékenységi címkéit számítja ki.

## Példák

### 1. példa: az Azure SQL-adatbázisok ajánlott adattípusai és érzékenységi címkéi
```powershell
...
### 2. példa: az Azure SQL-adatbázisok ajánlott adattípusai és érzékenységi címkéi a csővezetékek használatával.
```powershell
