...
### 1. példa: egy vagy több Job Target-cél beolvasása egy projekt-végrehajtásból
```powershell
...
### 2. példa: egy vagy több Job Target-cél kivégzése egy projekt végrehajtásával – a szűrés lépésről lépésre
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
