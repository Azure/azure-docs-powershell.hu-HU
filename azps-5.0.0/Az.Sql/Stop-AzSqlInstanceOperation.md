...
### StopByNameAndManagedInstanceAndResourceGroupParameterSet (alapértelmezett)
```
...
## Leírás
Az Stop-AzSqlInstanceOperation parancsmag az SQL-alapú felügyelt példányban megadott operáció nevével leáll.

## Példák

### Példa 1: speciális művelet beszerzése
```powershell
...
Ez a parancs egy SQL-alapú felügyelt példányban a "d0f5bef5-e2b1-4ef8-bb42-2e54073874f9" névvel nem működik.

### 2. példa: műveleti erőforrás-azonosító használata
```powershell
...
Ez a parancs nem működik a $managedInstanceOperation. id azonosítójú erőforrás-azonosítóval.

### 3. példa: műveleti objektum használata
```powershell
...
Ez a parancs nem működik az objektum $managedInstanceOperationval.
...
### -ResourceId
A műveleti objektum erőforrás-azonosítója a leállításhoz
