...
### UnlimitedBandwidthParameterSet (alapértelmezett)
```
...
## Leírás
A **New-AzStackEdgeBandwidthSchedule** parancsmag új sávszélesség-ütemtervet hoz létre a halom Edge-eszközéhez a sávszélesség-használat kezeléséhez.
...
### -UnlimitedBandwidth
Korlátlan sávszélességet ad meg
