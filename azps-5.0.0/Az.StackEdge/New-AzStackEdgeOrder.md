...
## Leírás
A **New-AzStackEdgeOrder** parancsmag új rendelést hoz létre egy halom Edge-eszközhöz. A rendelés létrehozása előtt először létre kell vennie egy halom Edge-eszköz erőforrását. Megadhatja, hogy miként hozhatja létre a sorrendet a partnerek, a cégnév, az e-mailek, a cím stb.
...
### – E-mail
A frissítések fogadására szolgáló e-mailek listája, elfogadja a 10 e-mailek maximumát.
...
### Microsoft. Azure. PowerShell. parancsmagok. StackEdge. models. PSStackEdgeOrder
