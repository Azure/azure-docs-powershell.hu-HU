...
## Leírás
A **Get-AzDataLakeGen2Item** parancsmag az Azure Storage-fiókjában található fájl vagy könyvtár adatait kapja meg.
...
### Példa 1: címtár létrehozása egy fájlrendszerből, és a Részletek megjelenítése
```
...
Ez a parancs egy fájlrendszerből kap könyvtárat, és megjeleníti a részleteket.

### 2. példa: fájl beszerzése fájlrendszerről
```
...
Ez a parancs a fájlrendszerből származó fájlok részleteit kapja meg. 
...
Nem adja meg ezt a paramétert a FileSystem gyökérkönyvtárának beszerzéséhez.
