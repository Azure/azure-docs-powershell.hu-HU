...
### Példa 4: tárterület-megosztás beszerzése a megosztás kihasználtsága bájtban
```
...
Ez a parancs egy tárterület-megosztást kap a tárolási fiók nevével és a megosztási névvel, és belefoglalja a megosztási kihasználtságot bájtban.

### 5. példa: a tárolási fiók tárterület-megosztásának listázása, a törölt megosztások felvétele
```
...
Ez a parancs felsorolja az összes tárterület-megosztást, mely tartalmazza a tárolási fiók nevét tartalmazó tárterület-fiók törölt részvényeit.
...
### -GetShareUsage
Adja meg ezt a paramétert a megosztás bájtban való használatáról.
...
### -IncludeDeleted
A törölt megosztások közé tartozik alapértelmezés szerint a lista megosztása nem fogja tartalmazni a törölt megosztásokat
