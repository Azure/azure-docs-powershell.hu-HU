...
## Leírás
A **Get-AzStorageFileCopyState** parancsmag az Azure-tárterület fájlmásolási műveletének állapotát kapja meg.
A fájl másolása fájlból kell futnia.
...
### 2. példa: a másolás és a csővezeték másolása a másolási állapot eléréséhez
```
...
Az első parancs elindítja a "contosofile" fájlt "contosofile_copy"-ra, és a kimenetet a destiantion-fájl objektumba. A második parancs a destiantion a Get-AzStorageFileCopyState-ra, hogy másolja a vágólapra a fájlmásolási állapotot.
