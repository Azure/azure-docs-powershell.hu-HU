...
## Leírás
A **Get-AzStorageObjectReplicationPolicy** parancsmag egy tárolási fiók objektum-replikációs házirendjét kapja vagy listázza.

## Példák

### Példa 1: az objektum replikációs házirendjének beszerzése konkrét házirend-azonosítóval és a szabályok megjelenítése.
```
...
Ez a parancs egy objektum replikációs házirendjét jeleníti meg konkrét házirend-azonosítóval, és megjeleníti annak szabályait.

### 2. példa: a List objektum replikációs házirendje egy tárterület-fiókból
```
...
Ez a parancs megjeleníti az objektum replikációs házirendjét egy tárterület-fiókból.
