...
## Leírás
A **Start-AzStorageFileCopy** parancsmag a forrásfájl szövegfájlba való másolását kezdi.
...
Környezet beolvasásához használja az **új AzStorageContext**.
...
A Get-AzStorageBlob parancsmag segítségével létrehozhat egy felhőalapú blobot, vagy megadhat egyet.
...
Létrehozhat felhőalapú blob-tároló objektumot, vagy használhatja az Get-AzStorageContainer parancsmagot.
...
### -SrcFile
Egy **CloudFile** -objektumot ad meg.
Létrehozhat egy felhőalapú fájlt, vagy beszerezhet egyet a **Get-AzStorageFile** segítségével.
...
A Get-AzStorageShare parancsmag segítségével létrehozhatja a felhőalapú fájlokat, vagy megadhat egyet.
...
### Microsoft. WindowsAzure. Command. Common. Storage. ResourceModel. AzureStorageFile
