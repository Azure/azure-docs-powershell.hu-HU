...
## Leírás
A **Get-AzSynapseIntegrationRuntimeKey** parancsmag az integrációs futtatókörnyezet kulcsait kapja meg. A kulcsok az integrációs futásidejű csomópontok regisztrálására szolgálnak.
...
A parancsmag a ' teszt-selfhost-IR ' nevű integrációs futásidejű kulcsait keresi meg.
...
### Microsoft. Azure. commands. szinapszis. models. PSIntegrationRuntimeKeys
