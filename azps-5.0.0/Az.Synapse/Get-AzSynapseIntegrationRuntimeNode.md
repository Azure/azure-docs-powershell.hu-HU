...
## Leírás
A **Get-AzSynapseIntegrationRuntimeNode** parancsmag az integrációs futásidejű csomópontok részletes adatait kapja meg.
...
A parancsmag az "Node_1" nevű csomópontról kapja az "tesztelje a selfhost-IR" nevű csomópontot a munkaterület ContosoWorkspace.
...
A parancsmag az "Node_1" nevű csomópontról kapja a "teszt-selfhost-IR"-ban a munkaterület "teszt-DF-EU2" nevű csomópontját, az IP-címet is beleszámítva.
...
### Microsoft. Azure. commands. szinapszis. models. PSManagedIntegrationRuntimeNode

### Microsoft. Azure. commands. szinapszis. models. PSSelfHostedIntegrationRuntimeNode
