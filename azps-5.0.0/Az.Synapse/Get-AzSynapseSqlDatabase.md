...
## Áttekintés
A szinapszis Analytics SQL-adatbázis beolvasása
...
## Leírás
[Ez a funkció egy korlátozott előzetes verzió, amely eredetileg csak bizonyos előfizetésekhez érhető el.] A **Get-AzSynapseSqlDatabase** parancsmag információkat kap az Azure SZINAPSZIS Analytics SQL-adatbázisról.
...
Ez a parancs minden SQL-adatbázist beolvas egy munkaterületen.
...
Ez a parancs az SQL-adatbázist az ContosoSqlDatabase nevű munkaterület-ContosoWorkspace kapja.
...
Ez a parancs a munkaterületen a csővezetéken keresztül minden SQL-adatbázishoz jut.
...
Ez a parancs az SQL-adatbázist a megadott erőforrás-AZONOSÍTÓval kapja.
...
### -Name (név)
A szinapszis SQL-adatbázis neve.
...
### -ResourceId
A szinapszis SQL-adatbázis erőforrás-azonosítója.
...
### Microsoft. Azure. commands. szinapszis. models. PSSynapseSqlDatabase
