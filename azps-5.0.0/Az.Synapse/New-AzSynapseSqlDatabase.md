...
## Áttekintés
A szinapszis Analytics SQL-adatbázis létrehozása.
...
## Leírás
A **Get-AzSynapseSqlDatabase** parancsmag információkat kap az Azure SZINAPSZIS Analytics SQL-adatbázisról.
...
Ez a parancs az Azure szinapszis Analytics SQL-adatbázisát hozza létre.
