...
## Leírás
A **New-AzSynapseWorkspace** parancsmag az Azure szinapszis Analytics-munkaterületet hozza létre.
...
Ez a parancs létrehoz egy ContosoWorkspace nevű szinapszis-elemzési munkaterületet, amely az ContosoAdlGenStorage-adattárolót használja, a ContosoResourceGroup nevű erőforrás-csoportban.
...
Az alapértelmezett ADLS Gen2-tárolási fiók neve.
...
### -Hely
Az Azure régió, ahol az erőforrást létre kell tenni.
...
Az Azure szinapszis-munkaterülethez rendelt, Szinapszisral felügyelt virtuális hálózat neve.
