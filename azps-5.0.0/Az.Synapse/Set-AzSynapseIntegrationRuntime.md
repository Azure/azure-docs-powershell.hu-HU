...
## Leírás
A **set-AzSynapseIntegrationRuntime** parancsmag meghatározott paraméterekkel frissíti az integrációs futtatókörnyezetet.
...
Az Azure Blob Storage nevű hivatkozott szolgáltatás neve, amely a Self-Hosted és az Azure-SSIS integrációs futtatókörnyezet közötti adatok áthelyezésekor használatos adatmegőrzési adattárolóra hivatkozik.
...
A Self-Hosted és az Azure-SSIS-integrációs futtatókörnyezetek közötti adatáthelyezéshez használt adattároló elérési útját a program akkor használja, ha meg van adva egy alapértelmezett tároló.
...
### -ExpressCustomSetup
A SSIS-integrációs futtatókörnyezet Express egyéni beállítása, amely az egyéni beállítási parancsfájl nélkül használható a konfigurációk és külső gyártók összetevőinek beállításához.
...
### -LicenseType
Az SSIS-infravörös beállításhoz használni kívánt licenc típusa.
Két típus létezik: LicenseIncluded vagy BasePrice.
Ha jogosult az Azure hibrid használati előnyeinek (AHUB) árazására, kérjük, válassza a BasePrice.
Ha nem, akkor válassza a LicenseIncluded lehetőséget.
...
### -VNetId
Annak az VNet az azonosítója, amelyhez az integrációs futtatókörnyezet csatlakozni fog.
