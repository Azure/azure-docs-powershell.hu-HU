...
### StopSparkStatementByIdParameterSet (alapértelmezett)
```
...
## Leírás
A **stop-AzSynapseSparkStatement** parancsmag visszamondja a szinapszis-elemző szikra utasítását.
...
Ez a parancs a megadott Livius-azonosítójú Spark-azonosítóval mondja le a szikra utasítását.
...
Ez a parancs lemondja a szikra-kimutatást a megadott Livius-AZONOSÍTÓval a csővezetéken keresztül.
