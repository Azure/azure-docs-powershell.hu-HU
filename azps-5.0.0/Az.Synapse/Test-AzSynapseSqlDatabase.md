...
## Áttekintés
A szinapszis-Analytics SQL-adatbázis meglétének ellenőrzése.
...
## Leírás
A **AzSynapseSqlDatabase** parancsmag a szinapszis-statisztika SQL-adatbázis létezését ellenőrzi.
...
Ez a parancs ellenőrzi a megadott SQL-adatbázis létezését.
