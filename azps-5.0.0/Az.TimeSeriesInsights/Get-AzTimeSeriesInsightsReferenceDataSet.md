...
### 1. példa: az összes hivatkozási adathalmaz listázása a megadott környezetben
```powershell
...
Ez a parancs felsorolja az összes hivatkozási adatkészletet a megadott környezetben.

### 2. példa: megadott hivatkozási adatkészlet beolvasása név szerint
```powershell
...
Ez a parancs a megadott hivatkozási adatkészletet kapja.

### 3. példa: az adott hivatkozási adatkészletet objektum alapján adja meg
```powershell
