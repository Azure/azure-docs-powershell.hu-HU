...
### 1. példa: eventhub-eseményforrás létrehozása a megadott környezetben
```powershell
...
A parancs létrehoz egy eventhub-eseményforrás a megadott környezetben.

### 2. példa: iothub-eseményforrás létrehozása a megadott környezetben
```powershell
...
A parancs létrehoz egy iothub-eseményforrás a megadott környezetben.

## PARAMÉTEREK

### -ConsumerGroupName
Az esemény/IOT hub fogyasztói csoportjának neve, amely azokat a partíciókat tárolja, amelyekből az események olvashatók lesznek.
...
Az eseményforrás erőforrás-azonosítója az Azure Resource Managerben.
...
### -Kulcsnév
Annak a SAS-kulcsnak a neve, amely az idősorozat-betekintést adja az esemény/IOT-központ eléréséhez.
...
### -ServiceBusNameSpace
Annak a buszjáratnak a neve, amely az esemény hub-ot tartalmazza.
...
### -SharedAccessKey
Az idősoros elemzést támogató megosztott hozzáférési kulcs értéke az esemény/IOT hub olvasási jogosultságával.
...
Az esemény-tulajdonság, amelyet az eseményforrás időbélyegzőként fog használni.
...
### Microsoft. Azure. PowerShell. parancsmagok. TimeSeriesInsights. modellek. Api20200515. IEventSourceResource
