...
### 1. példa: a hivatkozási adathalmaz létrehozása meghatározott környezethez  
```powershell
...
Ez a parancs egy bizonyos környezethez hivatkozási adatkészletet hoz létre.

## PARAMÉTEREK

### -DataStringComparisonBehavior
A hivatkozás az adathalmaz fő összehasonlító viselkedését a tulajdonság használatával állíthatja be.
Alapértelmezés szerint az érték "sorszám", ami azt jelenti, hogy a kis-és nagybetűk összehasonlítása az eseményekkel való kapcsolódáskor vagy új hivatkozási adatok hozzáadásakor történik.
Ha a "OrdinalIgnoreCase" érték van beállítva, akkor a rendszer a kis-és nagybetűket is használja.
...
### -Tulajdonság
A hivatkozási adatkészlet fő tulajdonságainak listája.
A kivitelezéshez tekintse meg a következőt: megjegyzések szakasz a tulajdonságok tulajdonságainak megjelenítéséhez, és hozzon létre egy kivonatoló táblázatot.
...
### -Name (név)
A hivatkozás adatkészletének neve.
...
IReferenceDataSetKeyProperty <[] >: a hivatkozási adatkészlet fő tulajdonságainak listája.
  - `[Name <String>]`: A Key tulajdonság neve.
  - `[Type <ReferenceDataKeyPropertyType?>]`: A kulcs tulajdonság típusa.
