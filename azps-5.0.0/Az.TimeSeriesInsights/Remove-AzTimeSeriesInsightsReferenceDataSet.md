...
### Példa 1: megadott hivatkozási adatkészlet eltávolítása név szerint
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Ez a parancs eltávolítja a megadott hivatkozási adatkészletet.

### 2. példa: a megadott hivatkozási adatkészlet eltávolítása objektum alapján
```powershell
