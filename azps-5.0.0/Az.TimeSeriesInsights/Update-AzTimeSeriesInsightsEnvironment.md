...
### 1. példa: Gen1-idősorozatok környezetbe való betekintésének frissítése
```powershell
...
Ez a parancs frissíti a Gen1-adatsorozatok környezetének áttekintését.

### 2. példa: a Gen1-idősorozatok környezetének frissítése
```powershell
...
### -Címke
A környezet további tulajdonságainak kulcs-érték párjai
