...
### Példa 1: megadott eseményforrás frissítése név szerint
```powershell
...
Ez a parancs frissíti az adott esemény forrását.

### 3. példa: adott eseményforrás frissítése objektum szerint
```powershell
...
### -Címke
Az eseményforrás további tulajdonságainak kulcs-érték pároka
