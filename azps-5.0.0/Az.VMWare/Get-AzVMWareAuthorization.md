...
Ez a parancsmag a `azps-test-auth` privát felhőben kap engedélyt `azps-test-cloud`

### 2. példa: lista-engedélyezés
```powershell
...
Ez a parancsmag a `azps-test-auth` privát felhő szerinti engedélyezést jeleníti meg `azps-test-cloud`
...
### Microsoft. Azure. PowerShell. parancsmagok. VMWare. models. Api20200320. IExpressRouteAuthorization
