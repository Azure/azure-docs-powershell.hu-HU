...
### Példa 1: privát felhő létrehozása
```powershell
...
### -NetworkBlock
A címek blokkjának egyedinek kell lennie az előfizetése VNet, valamint a helyszíni.
Ellenőrizze, hogy a CIDR formátuma megfelel-e (A. B. C. D/X), ahol A, B, C, D 0 és 255 között van, az X pedig 0 és 22 között van
...
### -NsxtPassword
Tetszés szerint állítsa be a NSX-T kezelő jelszavát a privát felhő létrehozásakor
...
### -VcenterPassword
Tetszés szerint állítsa be a vCenter rendszergazdai jelszavát a privát felhő létrehozásakor
