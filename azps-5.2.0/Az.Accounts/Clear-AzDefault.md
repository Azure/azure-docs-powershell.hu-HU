...
## LEÍRÁS
A Clear-AzDefault parancsmag eltávolítja a felhasználó által beállított alapértelmezett értékeket a felhasználó által megadott kapcsolóparaméterek alapján.
...
Ez a parancs eltávolítja a felhasználó által beállított alapértelmezett erőforráscsoportot az aktuális környezetben.
...
### -Force
Az összes alapértelmezett eltávolítása, ha nincs megadva alapértelmezett beállítás
...
### -ResourceGroup
Alapértelmezett erőforráscsoport ürítása
