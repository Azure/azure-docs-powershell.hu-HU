...
Egy **PSCredential objektumot** ad meg. A **PSCredential** objektumról a következőt írja be: `Get-Help Get-Credential` . A **PSCredential** objektum felhasználói azonosítót és jelszót biztosít a szervezeti azonosítóhoz, illetve az alkalmazásazonosítót és a titkos adatokat a szolgáltatásnévhez.
...
> [!NOTE]
> Az aktuális API korlátai miatt bérlői azonosítót kell használnia a bérlő neve helyett, amikor vállalati vállalati (B2B) fiókhoz csatlakozik.
