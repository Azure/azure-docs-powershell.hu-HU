...
Ez a parancs beállítja a megadott előfizetést, majd beállítja a jelenlegi környezet használatát. A munkamenet minden ezt követő parancsmagja alapértelmezés szerint az új előfizetést (Contoso-előfizetés 1) használja.
