...
Az alábbi példa bemutatja, hogy miként szerezheti be egy Azure-fiók összes engedélyezett bérlői webhelyét.

### 2. példa: Adott bérlői webhely szerzése
```
PS C:\> Connect-AzAccount
...
Ebben a példában azt mutatjuk be, hogy miként szerezhet be egy adott engedélyezett bérlői fiókot egy Azure-fiókból.
...
### -TenantId
Annak a bérlőnek az azonosítóját adja meg, amelybe a parancsmagot beállítja.
