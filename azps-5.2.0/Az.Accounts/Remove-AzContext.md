...
## LEÍRÁS
Azure-környezet eltávolítása a környezetek készletből
...
Az alapértelmezett környezet eltávolítása
...
### -Force
Környezet eltávolítása akkor is, ha az az alapértelmezett
...
### -PassThru
Az eltávolított környezet visszaadja
