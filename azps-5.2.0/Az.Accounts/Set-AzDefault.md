...
## LEÍRÁS
A Set-AzDefault parancsmag hozzáadja vagy módosítja az alapértelmezett értékeket az aktuális környezetben.
...
Ez a parancs az alapértelmezett erőforráscsoportot a felhasználó által megadott erőforráscsoportra állítja be.
...
### -Force
Új erőforráscsoport létrehozása, ha az alapértelmezett beállítás nem létezik
