...
## SYNOPSIS
Engedélyezi az Azure Advisor javaslat(ak)t.
...
## LEÍRÁS
Ez a parancsmag korábban nem használt javaslatot tesz lehetővé. Az ajánláshoz társított összes emetkezést is eltávolíthatja.
...
Eltávolítja az adott javaslat összes csökkentését a "recommendation_id" névvel.
...
Eltávolítja a folyamatból a megadott javaslat(ak) összes adatát.
...
### -RecommendationName
A javaslat Erőforrásneve mezőben.
