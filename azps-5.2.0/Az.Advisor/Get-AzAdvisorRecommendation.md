...
## SYNOPSIS
Az Azure Advisor javaslatainak listáját tartalmazza.
...
## LEÍRÁS
Az Azure Advisor-javaslatok listájának beszerzése. Kategória, erőforrás-azonosító, név stb. szerint szűrhető.
...
```
Az összes javaslat listáját tartalmazza.
...
Type                 : Microsoft.Advisor/recommendations
```
Az összes javaslat listáját kategóriateljesítmény szerint szűri.

## PARAMETERS

### -Category
Az ajánlott kategória
...
### -ResourceGroupName
A javaslat Erőforráscsoport neve
