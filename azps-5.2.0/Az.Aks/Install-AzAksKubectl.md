...
### A kutectl legújabb verziójának letöltése és telepítése
```powershell
...
### -Destination
A kutectl telepítésének elérési útja.
Alapértelmezés szerint a telepítés a ~/.azure-kutectl/
...
### -DownloadFromMirror
Letöltés tükörwebhelyről: https://mirror.azure.cn/kubernetes/kubectl/
...
### -Force
Meglévő kutectl felülírása kérdés nélkül
...
### -Version
A telepítendre használt kutectl-verzió, például "v1.17.2".
Alapértelmezett érték: Legutóbbi
