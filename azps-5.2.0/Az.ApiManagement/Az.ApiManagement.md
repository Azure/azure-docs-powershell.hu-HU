...
## Leírás
Ez a témakör az Azure API Felügyeleti parancsmagok súgótémakörét mutatja be.

## Az.ApiManagement parancsmagok
...
Api-kezelő szolgáltatás biztonsági szolgáltatása.

### [Export-AzApiManagementApi](Export-AzApiManagementApi.md)
API exportálása fájlba.

### [Get-AzApiManagement](Get-AzApiManagement.md)
Listát vagy adott API Management Service-leírást kap.
...
Az API összes API-változatának részletei

### [Get-AzApiManagementApiSchema](Get-AzApiManagementApiSchema.md)
Az API-séma részleteinek lekérte
...
API-kezelési engedélyezési kiszolgálót kap.

### [Get-AzApiManagementAuthorizationServerClientSecret](Get-AzApiManagementAuthorizationServerClientSecret.md)
Api Management authorization server client secret (API Management authorization server client secret) kap.

### [Get-AzApiManagementBackend](Get-AzApiManagementBackend.md)
A Backend részleteinek megtekintése.
...
A szolgáltatásban háttérkiszolgálóval konfigurált API-kezelési tanúsítványokat kap a közös hitelesítéshez.

### [Get-AzApiManagementDiagnostic](Get-AzApiManagementDiagnostic.md)
A szolgáltatás vagy az Api szintjén konfigurált diagnosztikai adatok lekérte. A diagnosztika az Api Management átjárótól származó kérések és válaszok naplózására használható.
...
Az összes vagy adott állomásnév-konfigurációt beveszi a meglévő átjáróhoz.

### [Get-AzApiManagementGatewayKey](Get-AzApiManagementGatewayKey.md)
A meglévő átjáró kulcsait kapja meg

### [Get-AzApiManagementGroup](Get-AzApiManagementGroup.md)
Az összes vagy adott API-kezelési csoportot beveszi.
...
Az identitásszolgáltató ügyfélprogramjának titkos lekérte.
...
Azon külső erőforrások kapcsolati állapotát kapja meg, amelyektől az Api Management szolgáltatás a felhőszolgáltatáson belülre esik. Ez a cloudservice számára látható DNS-kiszolgálókat is visszaadja.

### [Get-AzApiManagementOpenIdConnectProvider](Get-AzApiManagementOpenIdConnectProvider.md)
OpenID Connect-szolgáltatókat kap.

### [Get-AzApiManagementOpenIdConnectProviderClientSecret](Get-AzApiManagementOpenIdConnectProviderClientSecret.md)
Az OpenID Connect-szolgáltató ügyfélprogramjának titkos neve.

### [Get-AzApiManagementOperation](Get-AzApiManagementOperation.md)
Listát vagy adott API-műveletet kap.
...
Listát vagy adott terméket kap.
...
Előfizetési kulcsokat kap.

### [Get-AzApiManagementTenantAccess](Get-AzApiManagementTenantAccess.md)
Egy bérlő hozzáférési konfigurációját kapja meg.
...
Egy bérlő Git-hozzáférés-konfigurációját kapja meg.

### [Get-AzApiManagementTenantGitAccessSecret](Get-AzApiManagementTenantGitAccessSecret.md)
Egy bérlő Git-hozzáférési konfigurációs kulcsait kapja meg.

### [Get-AzApiManagementTenantSyncState](Get-AzApiManagementTenantSyncState.md)
A konfigurációs adatbázis és a Git-tárház közötti legutóbbi szinkronizálás állapotát kapja meg.
...
Létrehozza a PsAzureApiManagementContext példányt.

### [New-AzApiManagementCustomHostnameConfiguration](New-AzApiManagementCustomHostnameConfiguration.md)
Létrehozza a `PsApiManagementCustomHostNameConfiguration` .

### [New-AzApiManagementDiagnostic](New-AzApiManagementDiagnostic.md)
Új diagnosztika létrehozása globális vagy Api-hatókörben.
...
Létrehoz egy állomásnevet konfiguráló kiszolgálót a meglévő átjáróhoz.
...
A **PsApiManagementHttpMessageDiagnostic** példányának létrehozása, amely a diagnosztikai eszköz http-üzenet diagnosztikai beállítása
...
Létrehoz egy API management logger.
...
OpenID Connect-szolgáltatót hoz létre.

### [New-AzApiManagementOperation](New-AzApiManagementOperation.md)
API-kezelési műveletet hoz létre.
...
LÉTREHOZ egy API-kezelési terméket.
...
Új erőforráshely-szerződés létrehozása (az átjárókban használatos).
...
Megosztott hozzáférési jogkivonatot hoz létre a felhasználónak.
...
Módosításokat tesz közzé egy Git-ágból a konfigurációs adatbázisba.

### [Remove-AzApiManagement](Remove-AzApiManagement.md)
Eltávolít egy API-kezelési szolgáltatást.
...
Eltávolít egy API-t egy termékből.
...
Egy adott API-változat eltávolítása
...
Eltávolít egy OpenID Connect-szolgáltatót.
...
Eltávolítja az API-kezelési házirendet egy adott hatókörből.

### [Remove-AzApiManagementProduct](Remove-AzApiManagementProduct.md)
Eltávolít egy meglévő API-kezelő terméket.
...
Töröl egy meglévő felhasználót.

### [Remove-AzApiManagementUserFromGroup](Remove-AzApiManagementUserFromGroup.md)
Eltávolít egy felhasználót egy csoportból.

### [Restore-AzApiManagement](Restore-AzApiManagement.md)
Visszaállít egy API-kezelési szolgáltatást a megadott Azure-tárterület blobból.

### [Save-AzApiManagementTenantGitConfiguration](Save-AzApiManagementTenantGitConfiguration.md)
Módosítások mentése véglegesítés létrehozásával az aktuális konfigurációhoz.

### [Set-AzApiManagement](Set-AzApiManagement.md)
Azure Api Management szolgáltatás frissítése

### [Set-AzApiManagementApi](Set-AzApiManagementApi.md)
Módosít egy API-t.

### [Set-AzApiManagementApiRevision](Set-AzApiManagementApiRevision.md)
Módosítja az API-változatot
...
Frissíti az API-verziókészletet az API-kezelési környezetben.
...
Módosít egy API-kezelési tanúsítványt, amely a háttérprogrammal történő közös hitelesítéshez van konfigurálva.

### [Set-AzApiManagementDiagnostic](Set-AzApiManagementDiagnostic.md)
Módosítja az API-kezelés diagnosztikai eszközét a globális vagy az API-hatókörben.
...
Módosítja az API Management Loggert.
...
Konfigurál egy API-kezelési átjárót.
