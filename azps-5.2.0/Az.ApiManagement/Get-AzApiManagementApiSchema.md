...
## LEÍRÁS
A **Get-AzApiManagementApiSchema** parancsmag megkapja az API-séma részleteit

## PÉLDÁK

### 1. példa: Az Api api-sémájának részleteinek lekérte
```powershell
...
Ez a parancs az adott ApiManagement környezethez tartozó `swagger-petstore-extensive` API-sémákhoz tartozó összes API-sémát lekérte.

### 2. példa: Az Api-hoz társított séma lekérte
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceId /subscriptions/subid/resourceGroups/resourceGroupName/providers/Microsoft.ApiManagement/service/sdktestapim4163
...
Ez a parancs egy api-hoz társított API-sémát kap egy adott `5cc9cf67e6ed3b1154e638bd` `swagger-petstore-extensive` ApiManagement környezetben.
...
### -ResourceId
Api-séma arm resource identifier. Ha meg van adva, a rendszer megpróbálja megtalálni az api-sémát az azonosító alapján. Ezt a paramétert kötelező megadni.
