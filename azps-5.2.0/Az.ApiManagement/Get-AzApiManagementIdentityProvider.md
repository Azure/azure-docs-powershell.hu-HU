...
Szerezze be a szolgáltatás összes konfigurációszolgáltatóját.
...
Az Azure Active Directory identitásszolgáltató-konfigurációját kapja meg.

### 3. példa: Az AAD B2C típusú identitásszolgáltató lekérte
```powershell
