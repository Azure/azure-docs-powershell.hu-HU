...
### 1. példa: Szolgáltatói ügyfél titkos kódjának lekérte azonosító használatával
```
...
Ez a parancs az OICProvider01 azonosítójú szolgáltató ügyféltitkját kapja meg.
...
Az OpenID connectszolgáltató azonosítója.
Ezt a paramétert kötelező megadni.
