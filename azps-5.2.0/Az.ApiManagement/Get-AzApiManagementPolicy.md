...
### -ApiRevision
Az API-változat azonosítója. Ez a paraméter nem kötelező. Ha nincs megadva, a rendszer beolvassa a házirendet az aktuálisan aktív api-változatból.
...
Ha nem adja meg ezt a paramétert, akkor az eredményt a művelet műveletként prodigálta.
