...
## LEÍRÁS
A **Get-AzApiManagementSubscription** parancsmag egy adott előfizetést kap, vagy ha nincs előfizetés megadva, az összes előfizetést.
...
Ha meg van adva, ez a parancsmag az előfizetést az azonosító alapján találja meg.
