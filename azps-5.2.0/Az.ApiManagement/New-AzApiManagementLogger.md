...
## LEÍRÁS
A **New-AzApiManagementLogger** parancsmag létrehoz egy Azure API Management **Logger-t.**

## PÉLDÁK

### 1. példa: Naplózó létrehozása
```powershell
...
Ez a parancs létrehoz egy ContosoSdkEventHub nevű naplózót a megadott kapcsolati karakterlánc használatával.

### 2. példa

Létrehoz egy API management logger. (automatikusan generált)
...
### -ConnectionString
Egy Azure Event Hubs kapcsolati karakterláncot ad meg, amely az alábbiakkal kezdődik: `Endpoint=endpoint and key from Azure classic portal`
Konfigurálni kell a kapcsolati karakterláncban a küldési jogokkal együtt megadott kulcsot.
...
### -InstrumentationKey
A Betekintések alkalmazás eszközműveleti kulcsa. Ez a paraméter nem kötelező.
...
### -IsBuffered
Azt adja meg, hogy a rendszer a közzététel előtt pufferelje-e a naplóban található rekordokat.
Az alapértelmezett érték $True.
A rekordok pufferelése esetén a rendszer 15 másodpercenként küldi el a rekordokat az eseményközpontok számára, vagy amikor a puffer 256 KB-nyi üzenetet kap.
...
### -LoggerId
A naplózó azonosítóját adja meg.
Ha nem ad meg azonosítót, ez a parancsmag létrehoz egyet.
...
### -Name
Egy eseményközpont entitásnevét adja meg az Azure klasszikus portálján.
