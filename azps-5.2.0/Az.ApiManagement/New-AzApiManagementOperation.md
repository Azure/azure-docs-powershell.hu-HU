...
### 1. példa: API-kezelési művelet létrehozása
```powershell
...
### 2. példa: API-kezelési művelet létrehozása a kérelem és a válasz részleteivel
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Ez a példa létrehoz egy API-kezelési műveletet a kérelem és a válasz részleteivel.

## PARAMETERS

### -ApiId
Az API-kezelési művelet azonosítója.
...
### -ApiRevision
Az API-változat azonosítója. Ez a paraméter nem kötelező. Ha nincs megadva, a művelet az aktuálisan aktív API-változathoz lesz csatolva.
...
### -Válaszok
A lehetséges API-kezelési műveletekre adott válaszok tömbje.
...
### -TemplateParameters
Az *UrlTemplate* paraméterben definiált paraméterek tömbjét adja meg.
Ha nem adja meg ezt a paramétert, a rendszer létrehoz egy alapértelmezett értéket az *UrlTemplate mező alapján.*
