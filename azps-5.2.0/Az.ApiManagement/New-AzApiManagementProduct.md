...
## LEÍRÁS
A **New-AzApiManagementProduct** parancsmag api-kezelő terméket hoz létre.

## PÉLDÁK

### 1. példa: Előfizetést nem igénylő termék létrehozása
```
...
Ez a parancs létrehoz egy API-kezelő terméket.
Nincs szükség előfizetésre.

### 2. példa: Előfizetést és jóváhagyást igénylő termék létrehozása
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Előfizetésre és jóváhagyásra van szükség.
Ez a parancs 10 napra állítja az értesítési időszakot.
Az előfizetés időtartama egy évre van állítva.

## PARAMETERS

### -ApprovalRequired
Azt jelzi, hogy a termék előfizetése jóváhagyást igényel-e.
Ez a paraméter alapértelmezés szerint **$False.**
...
### -LegalTerms
A termék jogi feltételeit határozza meg.
...
### -ProductId
Az új termék azonosítója.
Ha nem adja meg ezt a paramétert, új termék jön létre.
...
### -State
A termék állapotát határozza meg.
psdx_paramvalues
- Nincs közzétolva
- Közzétéve: Az alapértelmezett érték nincs közzétéve.
...
Azt jelzi, hogy a terméknek előfizetésre van-e szüksége.
