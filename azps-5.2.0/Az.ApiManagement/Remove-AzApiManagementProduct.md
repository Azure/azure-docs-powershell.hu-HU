...
## LEÍRÁS
Az **Remove-AzApiManagementProduct** parancsmag eltávolít egy meglévő API-kezelő terméket.

## PÉLDÁK

### 1. példa: Meglévő termék és az összes előfizetés eltávolítása
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementProduct -Context $apimContext -ProductId "0123456789" -DeleteSubscriptions
```

Ez a parancs eltávolít egy meglévő terméket és az összes előfizetést.
...
### -DeleteSubscriptions
Azt jelzi, hogy törölni szeretné-e a termékre vonatkozó előfizetéseket.
Ha nem adja meg ezt a paramétert, és az előfizetések létezik, kivételt kell beállítania.
...
### -PassThru
Azt jelzi, hogy ez a parancsmag $True, ha sikeres, vagy egy $False értéket, ha nem sikerül.
