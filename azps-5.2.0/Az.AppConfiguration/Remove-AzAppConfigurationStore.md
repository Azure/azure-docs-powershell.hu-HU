...
## SYNOPSIS
Egy konfigurációs tároló törlése.
...
### 1. példa: Alkalmazáskonfigurációs áruház eltávolítása
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Ez a parancs eltávolítja az alkalmazáskonfigurációs áruházat.

### 2. példa: Alkalmazáskonfigurációs áruház eltávolítása
```powershell
