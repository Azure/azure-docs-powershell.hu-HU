...
## SYNOPSIS
Annak ellenőrzése, hogy használható-e a konfigurációs tároló neve.
...
### 1. példa: Az appkonfigurációs áruház nevének elérhetőségének tesztelése
...
Ez a parancs teszteli az alkalmazáskonfigurációs áruház nevének elérhetőségét.
...
### -Name
Az elérhetőség ellenőrzésére vonatkozó név.
