...
Alkalmazáselemzési erőforrás lekérte, és a "teszt" nevű erőforrás árazási tervének adatait is beveszi a "tesztcsoport" erőforráscsoportba
...
### -Full
Ha meg van adva, az alkalmazás vissza fogja kapni az árazási tervet/napi árcsomagot, valamint az alkalmazásstatikációk összetevő állapotát.
