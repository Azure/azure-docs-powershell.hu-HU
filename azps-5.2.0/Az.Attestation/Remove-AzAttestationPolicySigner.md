...
## LEÍRÁS
A Remove-AzAttestationPolicySigner parancsmag eltávolítja egy bérlő megbízható házirend-aláíróját az Azure Attestation szolgáltatásban.
...
Távolítsa el a pshtest nevű szolgáltató megbízható *aláíróját.*
...
### -Aláíró
Azt az RFC7519 JSON web tokent adja meg, amely egy "maa-policyCertificate" nevű igénylést tartalmaz, amelynek értéke egy RFC7517 JSON webkulcs, amely egy eltávolítható megbízható aláíró kulcsot tartalmaz.
