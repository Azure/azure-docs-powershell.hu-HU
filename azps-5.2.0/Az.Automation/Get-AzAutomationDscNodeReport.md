...
## SYNOPSIS
Egy DSC-csomópontról az Automatizálásnak küldött jelentéseket kapja.
...
## LEÍRÁS
A **Get-AzAutomationDscNodeReport** parancsmag az APS kívánt államkonfigurációs (DSC) csomópontról az Azure Automation szolgáltatásnak küldött jelentéseket kapja.
...
Az első parancs a Contoso17 nevű automatizálási fiók Számítógép14 nevű számítógépének DSC-csomópontját kapja meg.
A parancs ezt az objektumot a $Node tárolja.
A második parancs a Számítógép14 nevű DSC-csomópontból a Contoso17 nevű automatizálási fiókba küldött megadott azonosító által azonosított jelentés metaadatait kapja.
