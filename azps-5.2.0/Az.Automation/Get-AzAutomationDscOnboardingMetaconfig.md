...
## LEÍRÁS
A **Get-AzAutomationDscOnboardingMetaconfig** parancsmag létrehozza a kívánt APS-konfigurációs (DSC) metakonfigurációs Felügyelt objektumformátum (MOF) fájlokat.
