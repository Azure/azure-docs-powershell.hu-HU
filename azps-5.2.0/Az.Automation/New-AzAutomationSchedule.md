...
Az első parancs a **Get-Date** parancsmag használatával hoz létre dátumobjektumot, majd az objektumot a $StartDate tárolja.
Adjon meg egy olyan időt, amely a jövőben legalább öt perc.
A második parancs a **Get-Date** parancsmag használatával létrehoz egy dátumobjektumot, majd az objektumot a $EndDate tárolja.
...
Azt jelzi, hogy ezt az ütemezési objektumot fogja használni szoftverfrissítés-konfiguráció ütemezéséhez.
