...
## LEÍRÁS
A **Remove-AzAutomationConnection** parancsmag eltávolítja a kapcsolatot az Azure Automationből.
...
Ez a parancs eltávolítja a ContosoConnection nevű tanúsítványt a Contoso17 nevű automatizálási fiókból.

## PARAMETERS

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelyből a parancsmag eltávolítja a kapcsolatot.
...
### -Name
A parancsmag által eltávolított kapcsolat nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyből a parancsmag eltávolítja a kapcsolatot.
