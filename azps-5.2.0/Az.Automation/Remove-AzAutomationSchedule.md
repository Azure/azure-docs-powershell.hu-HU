...
## LEÍRÁS
A **Remove-AzAutomationSchedule** parancsmag törli az ütemezést az Azure Automatizálásból.

## PÉLDÁK

### 1. példa: Ütemezés eltávolítása
```
PS C:\>Remove-AzAutomationSchedule -AutomationAccountName "Contoso17" -Name "Schedule01" -ResourceGroupName "ResourceGroup01"
```

Ez a parancs törli az Erőforráscsoport01 erőforráscsoport Contoso17 automatizálási fiókjában az Schedule01 nevű ütemezést.

## PARAMETERS

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelynek a parancsmagja eltávolít egy ütemezést.
...
### -Name
Annak az ütemezésnek a nevét adja meg, amelyből a parancsmag eltávolítja.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelynek a parancsmagja eltávolítja az ütemtervet.
