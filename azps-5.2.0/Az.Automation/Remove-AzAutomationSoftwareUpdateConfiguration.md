...
## LEÍRÁS
Ez a parancsmag eltávolított egy Azure Automation szoftverfrissítés-konfigurációt.

## PÉLDÁK

### 1. példa
Az alábbi példa bemutatja, hogyan távolíthatja el a MyUpdateConfigurationt az automatizálási fiókból.
...
### -Name
Az eltávolítható szoftverfrissítés-konfiguráció neve.
...
### -PassThru
A PassThru egy objektumot ad vissza, amely azt az elemet tartalmazza, amellyel dolgozik. Ez a parancsmag alapértelmezés szerint nem hoz létre kimenetet.
...
Az eltávolítható szoftverfrissítés-konfiguráció.
