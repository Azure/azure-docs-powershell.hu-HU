...
## LEÍRÁS
Az **Enable-AzBatchAutoScale** parancsmag lehetővé teszi a megadott készlet automatikus méretezését.
...
Az első parancs definiál egy képletet, majd menti azt a $Formula változóba.
A második parancs engedélyezi az automatikus méretezést a MyPool nevű készleten a $Formula.

## PARAMETERS

### -AutoScaleEvaluationInterval
Azt az időt adja meg (percben), amely alatt a készlet mérete automatikusan módosul az automatikus skálázási képletnek megfelelően.
...
### -Id
Annak a készletnek az objektumazonosítóját adja meg, amelyhez engedélyezni szeretné az automatikus méretezést.
