...
## SYNOPSIS
Köteg számítási csomópontokat kap egy készletből.
...
## LEÍRÁS
A **Get-AzBatchComputeNode** parancsmag azure batch számítási csomópontokat kap egy készletből.
Adja meg a *PoolID* vagy *a Pool paramétert.*
Adja meg *az Azonosító* paramétert egyetlen számítási csomópont be szereznie.
Adja meg *a Szűrő* paramétert az OData-szűrőnek megfelelő számítási csomópontok be szereznie.

## PÉLDÁK

### 1. példa: Számítási csomópont lekérte azonosító alapján
```
...
Ez a parancs a tvm-2316545714_1-20150725t213220z azonosítójú számítási csomópontot a Pool06 azonosítókészletből kapja meg.
A Get-AzBatchAccountKey parancsmag használatával kontextust rendelhet a $Context változóhoz.

### 2. példa: Az összes inaktív számítási csomópont behozása egy készletből
```
...
Ez a parancs az id Pool06 azonosítót tartalmazó készletben található összes inaktív számítási csomópontot megkapja.
A parancs az üresjárati állapotot adja meg a Szűrő *paraméter* használatával.

### 3. példa: Az összes számítási csomópont lekérte egy adott készletben
```
...
Ez a parancs a készletet, amely a Pool07 azonosítót használja a Get-AzBatchPool parancsmag használatával.
A parancs a folyamat műveleti operátorával átadja a készletet az aktuális parancsmagnak.
Ez a parancsmag az összes számítási csomópontot ebből a készletből kapja.
...
Ez a parancsmag olyan számítási csomópontokat ad vissza, amelyek megfelelnek a paraméter által megadott szűrőnek.
Ha nem ad meg szűrőt, ez a parancsmag a készlet összes számítási csomópontját visszaadja.
...
### -Id
Annak a számítási csomópontnak az azonosítója, amelyből a parancsmag a készletből kijön.
...
### -MaxCount
Azt adja meg, hogy legfeljebb hány számítási csomópontot kell visszaadni.
...
### -Pool
A számítási csomópontokat tartalmazó **PSCloudPool-objektumot** adja meg.
**PSCloudPool-objektum** beszerzéséhez használja a Get-AzBatchPool parancsmagot.
...
### -PoolId
A számítási csomópontokat tartalmazó készlet azonosítója.
