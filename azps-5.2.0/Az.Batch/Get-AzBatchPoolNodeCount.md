...
## LEÍRÁS
A Get-AzBatchPoolNodeCount parancsmag lehetővé teszi az ügyfeleknek, hogy készlet szerint csoportosítva visszaszámolják a csomópontok számát csomópontonként. A csomópontok lehetséges állapotok létrehozása, üresjárata, aPool elhagyása, offline, előre elindított, újraindítás, újraképezés, futás, indítás, indítás, ismeretlen, használhatatlan és aStartTask várakozása. A parancsmag a PoolId vagy a Pool paramétert használva csak a készlet megadott készletazonosítóját szűri. 
...
Az aktuális kötegfiók környezetében lévő készletek csomópontonkénti száma.
...
Csomópontok száma csomópontonként egy adott készletazonosítóhoz

## PARAMETERS

### -BatchContext
A BatchAccountContext példány, amely a Batch szolgáltatás használata során használható.
...
### -MaxCount
Azt adja meg, hogy legfeljebb hány készletet kell visszaadni.
...
### -Pool
Azt a **PSCloudPoolt adja** meg, amelynek a csomópontszámát le kell állítani.
...
### -PoolId
Annak a készletnek az azonosítója, amelynek a csomópontszámát le kell számítani.
