...
Az első parancs a **Get-AzBatch Paranccsal** kap feladatot, majd a feladatot a $Job tárolja.
...
### -Job
Megadja azt a **PSCloud Parancsfájlt,** amelyhez ez a parancsmag frissíti a Batch szolgáltatást.
