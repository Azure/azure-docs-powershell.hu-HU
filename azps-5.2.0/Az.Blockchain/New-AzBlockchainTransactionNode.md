...
### 1. példa: Blockchain tranzakciós csomópont létrehozása
```powershell
...
Ez a parancs blockchain tranzakciós csomópontot hoz létre.
...
### -Location
Beállítja vagy beállítja a tranzakciós csomópont helyét.
