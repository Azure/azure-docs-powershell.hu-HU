...
### UpdateTemplateArtifact (alapértelmezett)
```
...
## LEÍRÁS
Tárgy frissítése Kétféleképpen frissíthet egy tárgyat: bemeneti fájlként egy JSON-összetevőn keresztül vagy az adott tárgy beágyazott paramétereinek biztosításával. Bár a JSON metódus nem követeli meg az összetevő típusának beágyazott paraméteres módszerrel való megadva, a felhasználónak meg kell adnia az összetevő típusát a -Type paraméteren keresztül.
...
A JSON-fájlon keresztül frissítheti az egyik tárgyat.
...
Egy összetevő frissítése a beágyazott paramétereken keresztül.
...
Egy elem frissítése egy ARM sablonfájlon keresztül.
