...
## LEÍRÁS
Remove-AzCdnOrigin egy CDN-forrást a megadott végpontról. Ha a forrás az egyetlen forrás a megadott végponton belül, akkor a törlés sikertelen lesz, mivel legalább 1 forrásra van szükség. 
...
```
Ez a parancsmag eltávolítja a megadott origint a megadott végpontról. 
