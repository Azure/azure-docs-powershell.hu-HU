...
## LEÍRÁS
Az **Add-AzImageDataDisk** parancsmag hozzáad egy adatlemezt egy képobjektumhoz.
...
A következő három parancs az operációs rendszer lemezének elérési útját és két adatlemezt rendel a $osDiskVhdUri, $dataDiskVhdUri 1 és $dataDiskVhdUri 2 változókhoz.
