...
## LEÍRÁS
Az **Add-AzVmssAdditionalUnattendContent** parancsmag információkat ad a felügyelet nélküli Windows Setup válaszfájlhoz.

## PÉLDÁK

### 1. példa: Adatok hozzáadása a felügyelet nélküli Windows Setup válaszfájlhoz
```
PS C:\> Add-AzVmssAdditionalUnattendContent -VirtualMachineScaleSet $VMSS -ComponentName  $AUCComponentName -Content  $AUCContent -PassName $AUCPassName -SettingName  $AUCSetting
```

Ez a parancs információkat ad a felügyelet nélküli Windows Setup válaszfájlhoz.

## PARAMETERS

### -ComponentName
A hozzáadott tartalommal konfigurálni szükséges összetevő neve.
Az egyetlen megengedett érték a Microsoft-Windows-Shell-Setup.
...
### -Content
A megadott elérési úthoz és összetevőhez unattend.xml XML formátumú tartalmat adja meg.
...
### -PassName
Annak a passznak a neve, amelyre a tartalom vonatkozik.
Az egyetlen megengedett érték az oobeSystem.
...
Adja meg a virtuális gép **Scale Set objektumát.**
