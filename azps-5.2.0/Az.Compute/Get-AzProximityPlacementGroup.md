...
## LEÍRÁS
Ez a parancsmag be fogja szerezni vagy listába sorolja a Közelség elhelyezési csoport erőforrás(ak)t.
...
Ez a parancs a közelség elhelyezési csoportját kapja
...
Ez a parancs felsorolja az adott erőforráscsoporton belül az összes közeli elhelyezési csoportot.
...
Ez a parancs felsorolja az előfizetéshez közeli elhelyezési csoportokat.

## PARAMETERS

### -ColocationStatus
Egy erőforrás áthelyezési állapotát jeleníti meg a közelítési elhelyezési csoportban.
...
### -ResourceId
A közelítés elhelyezési csoportjának erőforrás-azonosítója.
