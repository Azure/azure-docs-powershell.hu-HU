...
### -EnableUltraSSD
Lehetővé teszi, hogy egy vagy több felügyelt adatlemez UltraSSD_LRS tárolófióktípussal a virtuális gép méretaránykészletén.
...
A HealthProbeId a következő alakban áll: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/azs/{name}'.
...
### -Priority
A virtuális machien prioritása a méretaránykészletben.  Csak a "Normál", a "Direkt" és a "Gyenge" érték támogatott.
