...
### RestartResourceGroupNameParameterSetName (alapértelmezett)
```
...
## LEÍRÁS
Az **Restart-AzVM** parancsmag újraindít egy Azure virtuális gépet.
...
Ez a parancs újraindítja a VirtualMachine07 nevű virtuális gépet az ResourceGroup11-ben.
...
### -PerformMaintenance
A virtuális gép karbantartásának végrehajtása.
