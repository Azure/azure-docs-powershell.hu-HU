...
### -AbDemonInterval
Megadja, hogy a rendszer milyen gyakorisággal (percben) fut. Ha nem szeretné telepíteni a szolgáltatásokat az Azure VM-en, akkor ebben a mezőben állítsa be az értéket 0-ként.
...
### -Secret
Az adattáska elemértékének titkosításához és visszafejtéséhez használt titkosítási kulcs.
