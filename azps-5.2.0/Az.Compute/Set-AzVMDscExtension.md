...
A Sample.ps1.zip feltöltése a **Publish-AzVMDscConfiguration használatával történt.**

## PARAMETERS

### -ArchiveBlobName
Annak a konfigurációs fájlnak a nevét adja meg, amelyet korábban feltöltött a Publish-AzVMDscConfiguration parancsmag.
...
A paraméter elfogadható értékei a következőek: Engedélyezés és Letiltás.
