...
## LEÍRÁS
A **Set-AzVmssDiskEncryptionExtension parancsmag** lehetővé teszi a titkosítást egy VM-méretkészleten. Ez a parancsmag lehetővé teszi a titkosítást úgy, hogy telepíti a lemeztitkosítási bővítményt a VM méretkészletére.
