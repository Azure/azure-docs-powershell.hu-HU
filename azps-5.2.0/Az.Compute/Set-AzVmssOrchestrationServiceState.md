...
Ez a parancs felfüggeszti az automatikus javítási szolgáltatást a VMSS "vmss1" "rg" erőforráscsoportban.
...
Ez a parancs az "rg" erőforráscsoport VMSS "vmss1" rendszerében folytatja az automatikus javítási szolgáltatást.

## PARAMETERS

### -Művelet
Az végrehajtani szükséges művelet.  Lehetséges értékek: Folytatás, Felfüggesztés.
...
### -InputObject
A virtuális gép méretaránykészletének helyi objektuma.
