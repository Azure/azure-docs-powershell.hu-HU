...
## SYNOPSIS
API a csatlakoztatott fürterőforrás bizonyos tulajdonságainak frissítéséhez
...
### 1. példa: Csatlakoztatott rendszernetek frissítése
```powershell
...
Ez a parancs frissíti a csatlakoztatott rendszerhálózatokat.

### 2. példa: Csatlakoztatott kumernetek frissítése objektum szerint
```powershell
...
Ez a parancs objektum szerint frissíti a csatlakoztatott rendszerhálózatokat.
