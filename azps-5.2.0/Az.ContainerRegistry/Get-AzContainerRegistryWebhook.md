...
## LEÍRÁS
A Get-AzContainerRegistryWebhook parancsmag egy megadott webhook típusú tároló beállításjegyzéket vagy egy tároló beállításjegyzékének összes webhookját megkapja.

## PÉLDÁK

### 1. példa: Megadott webhook lekérte egy tároló beállításjegyzékét
```powershell
...
Tároló beállításjegyzékének megadott webhook-ját lekérte

### 2. példa: Egy tároló beállításjegyzékének összes webhookja
```powershell
...
A tárolóadatbázis összes webhooksának be szereznie

### 3. példa: A konfigurációs adatokat tartalmazó tárolóadatbázis megadott webhook-jának lekérte
```powershell
...
A konfigurációs adatokat tartalmazó tárolóadatbázis megadott webhook-jának be szereznie
...
A webhook konfigurációs információinak lekérte.
...
### -ResourceId
A tároló beállításjegyzékének Webhook erőforrás-azonosítója
