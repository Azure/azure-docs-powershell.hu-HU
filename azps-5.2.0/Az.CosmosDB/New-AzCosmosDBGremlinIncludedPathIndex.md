...
## SYNOPSIS
Létrehoz egy új, PSIndexes típusú objektumot. Paraméterértékként a Set-AzCosmosDBGremlinIncludedPath paraméterértékeként is átadott.
...
## LEÍRÁS
A Gremlin API IncludedPath-indexének megfelelő objektum.
