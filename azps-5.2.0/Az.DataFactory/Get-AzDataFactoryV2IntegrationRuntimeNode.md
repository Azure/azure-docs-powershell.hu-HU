...
## LEÍRÁS
A **Get-AzDataFactoryV2IntegrationRuntimeNode** parancsmag megkapja az integrációs futásidejű csomópont részletes adatait.

## PÉLDÁK

### 1. példa: Egy integrációs futásidejű csomópont részletes adatait tartalmazza.
```
...
A parancsmag a "test-df-eu2" data factory "test-df-eu2" nevű, önkiszolgáló integrációs futásidejű "test-selfhost-ir" "Node_1" nevű csomópontról kap információkat.

### 2. példa: Egy integrációs futásidejű csomópont részletes adatait az IP-címmel együtt kapja meg.
```
...
A parancsmag információkat kap a "test-df-eu2" data factory "test-df-eu2" nevű, önkiszolgáló integrációs futásidejű "test-selfhost-ir" "Node_1" nevű csomópontról, beleértve az IP-címet is.
...
### -IpAddress
Az integráció futásidejű csomópontjának IP-címe.
