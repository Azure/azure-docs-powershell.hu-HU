...
```
Egy eseményindító másik példányát indítja el egy új eseményindító futtatásának azonosítójával, és megtartja az eredeti eseményindító futtatásával egy időben aStartTime és a windowEndTime ablakot.
