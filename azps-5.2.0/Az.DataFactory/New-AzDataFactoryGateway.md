...
## LEÍRÁS
A **New-AzDataFactoryGateway** parancsmag létrehoz egy átjárót az Azure Data Factoryban.
...
Ez a parancs létrehoz egy ContosoGateway nevű átjárót a WikiADF nevű adatüzemben az ADF nevű erőforráscsoportban.

## PARAMETERS

### -DataFactory
EGY **PSDataFactory-objektumot** ad meg.
Ez a parancsmag létrehoz egy átjárót a paraméter által megadott adat factoryhoz.
...
### -Name
A létrehozni szükséges átjáró nevét adja meg.
...
Ez a parancsmag létrehoz egy átjárót, amely a paraméter által megadott csoporthoz tartozik.
