...
## LEÍRÁS
A **Stop-AzDataFactoryV2IntegrationRuntime** parancsmag leállítja a felügyelt dedikált integrációs futási futásiidőt "Elindítva" állapotban, amelyet a Start-AzDataFactoryV2IntegrationRuntime parancsmag indított el. Az erőforrások felszabadulnak, az állam pedig a "Leállítva" állapotra átvitelt ad vissza.

## PÉLDÁK

### 1. példa: "Elindítva" állapotban futó felügyelt integrációs futási idő leállítása.
```
...
A felügyelt integrációs futásidejű "test-reserlved-ir" "Elindítva" állapotban van. A Stop-AzDataFactoryV2IntegrationRuntime futtatása után az erőforrások felszabadulnak, az állam pedig "Leállítva" állapotba kerül.
