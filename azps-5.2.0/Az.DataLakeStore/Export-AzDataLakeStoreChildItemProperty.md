...
## LEÍRÁS
Az **Export-AzDataLakeStoreDataItemProperty** az adott címtár ADLS-tárhelyhasználatának vagy/vagy/vagy ACL-használatának, valamint alkönyvtáraknak és fájloknak a jelentésére használható.
...
Szerezze be a lemezhasználatot és az ACL-használatot az /a alatti összes alkönyvtárhoz és fájlhoz. IncludeFile ensures the usage is reported for files
...
### -IncludeFile
A statok megjelenítése fájlszinten (alapértelmezés szerint csak a címtárszintű adatok megjelenítése)
...
### -MaximumDepth
A legfelső szintű címtártól a lemezhasználat vagy az acl megjelenítésének maximális mélysége
...
Ebben az esetben a DumpFile egy ADL-elérési út
