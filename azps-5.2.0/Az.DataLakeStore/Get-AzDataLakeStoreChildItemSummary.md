...
## LEÍRÁS
A **Get-AzDataLakeStoreDataItemSummary** egy adott elérési úthoz olvassa be a tartalom összefoglalását. Rekurzív módon kiszámítja a fájlok, könyvtárak és az adott elérési út alatti fájlok teljes méretét.
...
### Microsoft.Azure.Commands.DataLakeStore.Models.DataLakeStoreStoreSummary
