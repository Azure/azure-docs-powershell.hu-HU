...
## LEÍRÁS
A **Get-AzDataLakeStoreItemPermission** parancsmag megkapja egy fájl vagy mappa oktális engedélyét a Data Lake Store-ban.

## PÉLDÁK

### 1. példa: A fájl engedélyeinek oktális beállítása
```
PS C:\>Get-AzDataLakeStoreItemPermission -AccountName "ContosoADL" -Path "/file.txt"
```

Ez a parancs a fájl oktális engedélyét kapja.
