...
## LEÍRÁS
A **New-AzDataLakeStoreAccount** parancsmag létrehoz egy új Data Lake Store-fiókot.
...
Ez a parancs létrehoz egy ContosoADL nevű Data Lake Store-fiókot az Egyesült Államok 2. keleti helyére.

## PARAMETERS

### -DefaultGroup
Megadja annak az AzureActive Directory-csoportnak az objektumazonosítóját, amely az új fájlok és mappák alapértelmezett csoporttulajdonosa.
...
### -DisableEncryption
Azt jelzi, hogy a fiókra semmilyen titkosítási formában nem lesz alkalmazva.
...
### -Location
A fiókhoz használni használt hely.
...
### -Name
A létrehozni szükséges fiók nevét adja meg.
