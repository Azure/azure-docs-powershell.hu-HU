...
## LEÍRÁS
A Stop-AzDataMigrationService parancsmag leállítja az Azure Database Migration Service futó állapotban található példányát.
...
A fenti példa leállítja a TestService nevű Azure Adatbázis-áttelepítési szolgáltatás egy példányát a bemeneti paraméterként átadott szolgáltatásnév alapján.
...
A fenti példa leállítja az Azure Database Migration Service egy olyan példányát, amely a PSDataMigrationService objektum bemeneti paraméterként átadott.
