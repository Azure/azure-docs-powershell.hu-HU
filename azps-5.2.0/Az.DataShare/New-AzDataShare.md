...
## LEÍRÁS
A **New-AzDataShare** parancsmag adatmegosztást hoz létre egy megadott Azure-adatmegosztási fiókon belül az erőforráscsoport nevének, fióknevének, megosztási nevének és megosztásának megadva. A leírás és a használati feltételek opcionális paraméterek, amelyek beállíthatók az adatmegoszlás létrehozásakor.
