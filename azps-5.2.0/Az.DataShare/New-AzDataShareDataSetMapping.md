...
## LEÍRÁS
A **New-AzDataShareDataSetMapping** parancsmag adatkészlet-megfeleltetést hoz létre a forrásadatkészletek és a tárfiók között a megosztási előfizetésben.
...
Ez a parancs létrehoz egy adatkészletet, amely megfeleltetést hoz létre az AdsDataSetMapping értéknek a Share Subscription AdsStorage tárhelyfiókjára vonatkozó AdsShareSubscription értékhez a WikiAdsAccount adatmegosztási fiókban.
