...
## LEÍRÁS
A **New-AzDataShareSynchronizationSetting** létrehoz egy szinkronizálási beállítást a megosztási fiókban való megosztáshoz, amely akár naponta, akár óránként ismétlődik egy adott időpontban.
...
Ez a parancs szinkronizálási beállítást hoz létre napi ismétlődési intervallumon, 9:00 órakor a AdsShare megosztásához a WikiAds adatmegosztási fiókban.
...
### -RecurrenceInterval
A szinkronizálási beállítás ismétlődési időköze (nap vagy óra)
...
### -SynchronizationTime
Az ütemezett szinkronizálási beállítás kezdési ideje
