...
### 1. példa: Dedikált HSM eltávolítása név szerint
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Ez a commnad név szerint eltávolítja a hardveres biztonsági modulokat.

### 2. példa: Dedikált HSM eltávolítása objektumról
```powershell
...
Ez a commnad objektumról eltávolítja a dedikált HSM-et.
