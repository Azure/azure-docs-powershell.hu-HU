...
### 1. példa: Virtuális asztali Windows regisztrációs jogkivonat beszerzése
```powershell
...
Ez a parancs egy Windows virtuális asztali regisztrációs jogkivonatot kap egy gazdakészletben.
