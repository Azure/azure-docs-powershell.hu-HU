...
### 2. példa: A Windows virtuális asztal Start menüjének elemeinek felsorolása
```powershell
...
Ez a parancs a Windows virtuális asztal Start menüjének elemeit sorolja fel egy aplicaton csoportban.
