...
### 1. példa: Windows Virtuális asztali alkalmazáscsoport létrehozása név szerint
```powershell
...
Ez a parancs létrehoz egy Windows virtuális asztali alkalmazáscsoportot egy erőforráscsoportban.

### 2. példa: Windows Virtuális asztali alkalmazáscsoport létrehozása név szerint
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Az ApplicationGroup erőforrástípusa.
...
### -FriendlyName
Az ApplicationGroup rövid neve.
...
### -HostPoolArmPath
Az ApplicationGroup HostPool-kar útvonala.
