...
### 1. példa: A Windows Virtuális asztal felhasználófelhasználói munkamenetének törlése név szerint
```powershell
...
Ez a parancs törli a Windows virtuális asztali felhasználófelhasználói munkamenetet a munkamenetgazdákban.
...
### -Force
A jelölő kényszerítve jelentkezzen be a userSession alkalmazásból.
