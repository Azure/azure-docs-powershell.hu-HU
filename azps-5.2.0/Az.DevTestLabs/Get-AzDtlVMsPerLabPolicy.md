...
## LEÍRÁS
A **Get-AzDtlVMsPerLabPolicy** parancsmag egy laboratóriumi házirend alapján kapja meg a virtuális gépeket, így meg lehet állítani a laboratóriumokban engedélyezett virtuális gépek teljes számát.
A parancsmag visszaadja a házirend engedélyezett vagy letiltott állapotát, valamint a házirendben beállított laboratóriumban engedélyezett virtuális gépek teljes számát.
...
### -LabName
Annak a laboratóriumnak a neve, amelyhez ez a parancsmag a virtuális gépeket beveszi.
