...
## LEÍRÁS
Ezt az ellenőrző kódot egy tanúsítvány igazolásának befejezéséhez használjuk. Ezt az ellenőrző kódot használhatja a főtanúsítványok titkos kulcsával aláírt új tanúsítvány CN-kódjaként.
...
Ellenőrző kód létrehozása a "mycertificate" számára.
...
Ellenőrző kód létrehozása a "mycertificate" folyamat használatával.
