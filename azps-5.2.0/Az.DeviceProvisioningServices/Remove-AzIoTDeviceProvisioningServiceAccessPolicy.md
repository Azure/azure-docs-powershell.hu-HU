...
A megosztott hozzáférési házirend "mypolicy" törlése egy Azure IoT Hub-eszköz kiépítési szolgáltatásban.
...
A megosztott hozzáférési házirend "mypolicy" törlése egy Azure IoT-központbeli eszköz kiépítési szolgáltatásában egy folyamat használatával.
