...
## LEÍRÁS
Eszköz-regisztráció törlése egy Azure IoT-központ eszköz kiépítési szolgáltatásában.
...
Törölhet egy megadott regisztrációs rekordot.
...
Törölje az összes regisztrációs rekordot.
