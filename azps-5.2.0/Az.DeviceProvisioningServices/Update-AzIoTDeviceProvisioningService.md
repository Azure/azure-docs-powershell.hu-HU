...
Frissítse a kiosztási házirendet egy Azure IoT-központbeli eszközkiosztási szolgáltatás "myiotdps" "GeoLatency" szolgáltatására.
...
Vegyen fel címkéket az Azure IoT Hub eszköz kiépítési szolgáltatásának "myiotdps" szolgáltatásához.
...
Címke törlése és új címkék hozzáadása egy Azure IoT Hub-eszköz kiépítési szolgáltatásához "myiotdps" folyamat használatával.

## PARAMETERS

### -AllocationPolicy
IoT-eszközkiosztási szolgáltatásfoglalási házirend
...
### -Reset
IoT-eszközök kiépítési szolgáltatáscímkéinek alaphelyzetbe állítása
...
### -Tag
IoT-eszköz kiépítési szolgáltatáscímke-gyűjteménye
