...
Sorolja fel a MyResourceGroupName erőforráscsoport eseményrács tartományát (ha van ilyen), amely megfelel $odataFilter \` \` 10 tartománynak. Ha több találat érhető el, a $result. A NextLink nem lesz $null. A tartományok következő oldalának lehívása érdekében a felhasználó várhatóan újra hívja az Get-AzEventGridDomain és az eredményt használja. Az előző hívásból kapott NextLink. A hívónak meg kell állnia, amikor az eredmény álljon meg. A NextLink $null.
