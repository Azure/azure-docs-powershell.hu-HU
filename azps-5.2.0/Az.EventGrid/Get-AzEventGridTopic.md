...
Ha a témakör neve meg van adni, a rendszer egyetlen eseményrácstémát ad vissza.
...
Ha további témakörök is elérhetők, a következő hívásban a NextLink értékét kell használni a témakörök következő lapjára való bejedhez.
