...
A \' \` \` \` MyResourceGroupName erőforráscsoport Eseményrács tartomány1 kulcs1\\ kulcsának megfelelő kulcs újragenerálásával. \`
...
A MyResourceGroupName erőforráscsoportban a \' \` \` \` MyResourceGroupName erőforráscsoportban a key key2\\ eseményrács tartományának megfelelő kulcsot a teljes erőforrás-azonosító használatával \` újragenerálja.
