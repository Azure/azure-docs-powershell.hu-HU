...
Létrehozza a \` MyConsumerGroupName fogyasztói csoportot az Event Hub MyEventHubName nevű, a \` \` \` MyNamespaceName névterére hatókörű, \` \` \` MyResourceGroupName \` erőforráscsoporttal.
