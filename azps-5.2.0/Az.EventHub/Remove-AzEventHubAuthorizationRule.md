...
## LEÍRÁS
A Remove-AzEventHubAuthorizationRule parancsmag eltávolítja és törli a megadott engedélyezési szabályt a megadott eseményközpontból.
...
Eltávolítja a \` MyAuthRuleName engedélyezési szabályt \` a Namespace \` MyNamespaceName \` névtérből.
...
Eltávolítja a \` MyAuthRuleName engedélyezési szabályt \` a \` MyEventHubName \` eseményközpontból.
