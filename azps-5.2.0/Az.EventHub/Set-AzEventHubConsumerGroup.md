...
## LEÍRÁS
A Set-AzEventHubConsumerGroup parancsmag frissíti a megadott Event Hubs fogyasztói csoportot.
...
A MyConsumerGroupName fogyasztói csoport felhasználói metaadatait \` \` "Tesztelés" típusúra állítja.
