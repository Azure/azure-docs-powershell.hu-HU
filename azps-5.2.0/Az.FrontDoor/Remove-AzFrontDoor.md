...
### 4. példa: Távolítsa el az aktuális előfizetés alatt az összes "frontdoor1" nevű FrontDoorsot.
```powershell
PS C:\> Remove-AzFrontDoor -Name "frontdoor1" | Remove-AzFrontDoor
```

Távolítsa el az aktuális előfizetés alatt a "frontdoor1" nevű FrontDoorsokat.
...
### -ResourceGroupName
Az erőforráscsoport, amelyhez a Front Door tartozik.
