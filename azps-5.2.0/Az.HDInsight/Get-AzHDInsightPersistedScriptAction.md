...
## LEÍRÁS
A **Get-AzHDInsightPersistedScriptAction parancsmag** az Azure HDInsight-fürt állandó parancsfájlműveleteit kapja meg, és időrendben listázza őket, vagy egy megadott állandó parancsfájlművelet részleteit is megjeleníti.

## PÉLDÁK

### 1. példa: Az állandó parancsfájl-műveletek lekérte egy fürtön
```
PS C:\>Get-AzHDInsightPersistedScriptAction -ClusterName "your-hadoop-001"
```

Ez a parancs megőrzetlen parancsműveleteket kap a -hadoop-001 nevű fürtben.
...
### -Name
Az állandó parancsfájl-művelet nevét adja meg.
