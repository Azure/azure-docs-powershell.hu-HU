...
## LEÍRÁS
A **New-AzHDInsightSqoop JobDefinition** parancsmag egy Azure HDInsight-fürthöz használható Sqoop-feladatobjektumot definiál.

## PÉLDÁK

### 1. példa: Sqoop-feladatdefiníció létrehozása
```
PS C:\># Cluster info
...
Ez a parancs létrehoz egy Sqoop feladatdefiníciót.
...
### -LibDir
A Sqoop feladat tárkönyvtárát határozza meg.
