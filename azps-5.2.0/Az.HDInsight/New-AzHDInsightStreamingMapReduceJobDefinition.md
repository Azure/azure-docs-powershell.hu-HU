...
## LEÍRÁS
A **New-AzHDInsightStreamingMapReduce JobDefinition** parancsmag definiálja a Streaming MapReduce job objectot azure HDInsight-fürthöz való használatra.

## PÉLDÁK

### 1. példa: Streaming MapReduce feladatdefiníció létrehozása
```
PS C:\># Cluster info
...
Ez a parancs létrehozza a Streaming MapReduce feladatdefiníciót.
...
### -CommandEnvironment
Parancssori környezeti változók tömbje, amelyek akkor állíthatók be, amikor egy feladat munkavégi csomópontokon fut.
...
### -InputPath
A bemeneti fájlok elérési útját adja meg.
...
### -OutputPath
A feladat kimenetének elérési útját adja meg.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightStreamingMapReduce ParanccsDefinition
