...
## LEÍRÁS
Ez a **Set-AzHDInsightClusterAutoscaleConfiguration** parancsmag beállítja egy Azure HDInsight-fürt automatikus skálázási konfigurációját.

## PÉLDÁK

### 1. példa: A HDInsight-fürt betöltésalapú automatikusskála-konfigurációjának beállítása
```powershell
...
Ez a parancs beállítja egy Azure HDInsight-fürt betöltésalapú automatikusskála-konfigurációját.

### 2. példa: A HDInsight-fürt ütemezésalapú automatikus skálázásának beállítása
```powershell
...
Ez a parancs beállítja a HDInsight-fürt ütemezésalapú automatikusskála-konfigurációját.

### 3. példa: A HDInsight-fürt automatikus skálázási konfigurációjának beállítása egy másik fürt alapján, amely beállította az automatikus skálázást
```powershell
...
Ez a parancs beállítja a HDInsight-fürt automatikus skálázási konfigurációját egy másik fürt alapján.
...
### -Feltétel
Beállítja vagy beállítja az ütemezésalapú automatikus skálázás feltételét.
...
### -MaxWorkerNodeCount
Beállítja vagy beállítja a munkaterhelés-alapú automatikus skálázás maximális számát.
...
### -MinWorkerNodeCount
Beállítja vagy beállítja a munkaterhelés-alapú automatikus skálázás minimális számát.
...
### -Schedule
Ütemezésen alapuló paraméterek beállítása
...
### -TimeZone
Beállítja vagy beállítja az ütemezésalapú automatikus méretezés időzónát.
