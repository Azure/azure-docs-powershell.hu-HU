...
### 1. példa: Az SAP-monitor példányának eltávolítása név szerint
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Ez a parancs név szerint eltávolítja az SAP-monitor példányát.

### 2. példa: Az SAP-monitor példányának eltávolítása objektumról objektumra
```powershell
...
Ez a parancs objektumról objektumra eltávolítja az SAP-monitor példányát.
