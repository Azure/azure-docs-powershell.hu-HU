...
## SYNOPSIS
Egy meglévő egészségügyiApis egészségügyi szolgáltatás frissítése.
...
### 1. példa: Frissíti a MyResourceGroup erőforráscsoport MyResourceGroup nevű meglévő healthcareapis szolgáltatását az 500-as értékekkel.
...
### 2. példa: Frissíti a MyResourceGroup erőforráscsoport MyResourceGroup nevű meglévő egészségügyi szolgáltatását az 500 és a kulcskulcs uri "https:// \<my-keyvault> .vault.azure.net/keys/" értékével. \<my-key>
...
### -SofferThroughput
HealthcareApis FhirService SOfferThroughput.
...
Tiltsa le a Felügyelt identitást.
...
### -ResourceGroupName
HealthcareApis Service Resource Group Name (Egészségügyi szolgáltatáserőforrás-csoport neve).
