...
## LEÍRÁS
Létrehoz egy kulcsot a megadott IotHubhoz.
A Kulcsnevek nem egyediek, ezért gondosan kell kezelni őket.

## PÉLDÁK

### 1. példa: Kulcs hozzáadása iotHubhoz
```
PS C:\> Add-AzIotHubKey -ResourceGroupName "myresourcegroup" -Name "myiothub" -KeyName "newkey" -PrimaryKey "primarykey" -SecondaryKey "secondarykey" -Rights RegistryRead
```

Létrehoz egy "mykey" nevű kulcsot a RegistryRead engedélyekkel rendelkező iothub "myiothub" számára.
