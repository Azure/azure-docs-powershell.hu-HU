...
## LEÍRÁS
Az IoT-központban található IoT-eszközön található IoT-eszközmodulok vagy -listamodulok részleteinek megtekintése.
...
Az IoT-központban lekérte egy IoT-eszközmodul részleteit.
...
Az IoT-központban egy IoT-eszközön található összes modul megjelenítése.
