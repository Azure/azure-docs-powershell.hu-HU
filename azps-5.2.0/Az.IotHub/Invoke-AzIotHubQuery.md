...
## LEÍRÁS
Egy IoT-központot lekérdez egy hatékony SQL-hez hasonló nyelv használatával, amely az eszköz- és modullekérdezésekkel, a feladatokkal és az üzenetek átirányításával kapcsolatos információkat olvassa be.
További https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language információt itt is láthat.
...
Lekérdezheti az összes eszköz eszközét egy Azure IoT-központban.
...
Lekérdezés a 2 modul legfelső adatokat egy céleszközön.
...
### -Query
Végrehajtandó felhasználói lekérdezés.
...
### -Top
A vissza nem térhet elemek maximális száma.
Alapértelmezés szerint a lekérdezésben nincs nagybetű.
