...
## LEÍRÁS
Létrehoz egy új IotHubot.
Az IotHubot létrehozhatja az alapértelmezett tulajdonságokkal, vagy megadhatja a bemeneti tulajdonságokat.

## PÉLDÁK

### 1. példa: Új IotHub létrehozása alapértelmezett tulajdonságokkal
```
PS C:\> $tags = @{}
...
Létrehozza az "S1" termékváltozat "myiothub" nevű új IotHubját, az 1-es kapacitást és a "northeurope" helyet a Címkék között.

### 2. példa: Új IotHub létrehozása a CloudToDevice-várólista MaxDeliveryCount értékében 20-ra van állítva
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Létrehozza az "S1" termékváltozat "myiothub" nevű új IotHubját, az 1-es kapacitást és a "northeurope" helyet, és speciális beviteli tulajdonságokat ad $properties.
...
### -Location
Az a hely, ahol létre kell hozatni az IoT-központot. 
...
### -Tag
Az IoT-központ példánycímkéi. Property bag in key-value pairs in a form of a hash table.
