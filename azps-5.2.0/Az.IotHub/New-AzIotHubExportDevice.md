...
## LEÍRÁS
Új exportálási eszközre vonatkozó feladatot hoz létre az IotHubhoz.
Ezzel az összes eszközt a megadott tárolóba exportálja. Az SAS URI létrehozásáról az alábbi cikkben olvashat.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## PÉLDÁK

### 1. példa: Exportálási eszköz kérésének megoldása.
```
...
Létrehoz egy új exportálási eszközkérést az IotHub "myiothub" számára, a kulcsokat kivéve.
...
### -ExcludeKeys
Lehetővé teszi az eszközök kulcsok nélküli exportálását.
...
Az Uri, amelybe exportálni kell a blobot. 
