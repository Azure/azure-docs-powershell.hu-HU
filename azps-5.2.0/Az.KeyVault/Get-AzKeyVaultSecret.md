...
Ezek a parancsok az ITSecret nevű titkos parancs aktuális verzióját jelenítik meg, majd megjeleníti a titkos érték egyszerű szöveges értékét.

(Megjegyzés: használja a 3. módszert, ha PowerShell [ConstrainedLanguage](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_language_modes?view=powershell-7.1#constrained-language-constrained-language)módban dolgozik, például biztonságos/jogosultsággal rendelkező hozzáférésű munkaállomásokon.)
