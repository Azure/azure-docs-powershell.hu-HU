...
## LEÍRÁS
A **New-AzKeyVaultCertificateOrganizationDetail parancsmag** létrehoz egy memória-tanúsítvány szervezeti részleteit tartalmazó objektumot.

## PÉLDÁK

### 1. példa: Szervezeti részletek objektum létrehozása
```powershell
...
Az első parancs létrehozza a tanúsítvány-rendszergazda adatait tartalmazó objektumot, majd azt a $AdminDetails tárolja.
A második parancs létrehoz egy tanúsítvány szervezeti részleteket tartalmazó objektumot, majd tárolja azt a $OrgDetails változóban.

## PARAMETERS

### -AdministratorDetails
A tanúsítványt kezelő szervezet rendszergazdáit határozza meg.
...
### -Id
Megadja a szervezet azonosítóját.
