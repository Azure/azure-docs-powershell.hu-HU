...
## LEÍRÁS
Ez a parancsmag frissíti az Azure által felügyelt HSM állapotát.

## PÉLDÁK

### 1. példa: Felügyelt Hsm frissítése közvetlenül
```powershell
...
Frissíti az erőforráscsoportban elnevezett felügyelt Hsm `$hsmName` `$resourceGroupName` címkéit.

### 2. példa: Felügyelt Hsm frissítése pipázás használatával
```powershell
...
A felügyelt Hsm címkéit pipaszintaxissal frissíti.
