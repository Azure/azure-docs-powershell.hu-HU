...
### 1. példa: Új AttachedDatabaseConfiguration létrehozása
```powershell
...
A fenti parancs létrehoz egy ReadOnly adatbázist "mykustodatabase" a "testnewkustoclusterf" fürtben.
A "testnewkustocluster" fürt "mykustodatabase" adatbázisát követi.
...
### -ClusterResourceId
Annak a fürtnek az erőforrás-azonosítója, amelybe a csatolni szeretné az adatbázisokat.
...
### -DatabaseName
A csatolni kívánt adatbázis neve a *, ha az összes jelenlegi és jövőbeli adatbázist követni szeretné.
...
Az alapértelmezett principals módosítási típus
