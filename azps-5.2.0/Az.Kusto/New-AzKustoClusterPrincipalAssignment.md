...
### 1. példa: Kusto-fürt egyszerű hozzárendelése
```powershell
...
A fenti parancs egy Kusto-fürt egyszerű hozzárendelését hozza létre
...
### -PrincipalId
A fürtnévhez rendelt egyszerű azonosító.
