...
### 1. példa: Új Kusto-adatbázis létrehozása név szerint
```powershell
...
A fenti parancs létrehoz egy "mykustodatabase" nevű új Kusto-adatbázist a meglévő "testnewkustocluster" fürtben, amely a "testrg" erőforráscsoportban található.
