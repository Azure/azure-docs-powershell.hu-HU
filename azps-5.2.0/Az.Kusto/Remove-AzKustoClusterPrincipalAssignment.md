...
### 1. példa: Meglévő Kusto-fürt – PrincipalAssignment törlése név szerint
```powershell
...
A fenti parancs törli a Kusto-fürt "testnewkustocluster" kustoprincipal1 nevű PrincipalAssignment rekordját.
