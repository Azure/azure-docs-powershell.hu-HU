...
A fenti parancs frissíti a "mykustodatabase" Kusto-adatbázis "testnewkustocluster" nevű fürtje "testnewkustocluster" nevű, "testrg" erőforráscsoportban található adattörlési és gyors-gyorsítótár-időszakát.

### 2. példa: Meglévő adatbázis frissítése identitáson keresztül
```powershell
...
### -HotCachePeriod
A Gyors lekérdezések időkorlában való gyorsítótárazása a TimeSpanban.
