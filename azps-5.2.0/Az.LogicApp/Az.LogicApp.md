...
# Az.LogicApp modul
## Leírás
Ez a témakör a Logic Apps-parancsmagok súgótémakörét mutatja be.

## Az.LogicApp-parancsmagok
### [Get-AzIntegrationAccount](Get-AzIntegrationAccount.md)
Integrációs fiókokat kap.
...
Integrációs fiók köteg-konfigurációját kapja.
...
Integrációs fióktanúsítványokat kap egy erőforráscsoporttól.
...
Ez a parancsmag szerződésenként és vezérlőszámonként egy adott beérkezett adatcsere-vezérlőszámot ad vissza.

### [Get-AzIntegrationAccountSchema](Get-AzIntegrationAccountSchema.md)
Integrációs fióksémák lekérte.

### [Get-AzApp](Get-AzLogicApp.md)
Logikai alkalmazást kap egy erőforráscsoporttól.
...
Egy logikai alkalmazás eseményindítóit kapja meg.

### [Get-AzCallTriggerCallbackUrl](Get-AzLogicAppTriggerCallbackUrl.md)
Logikai alkalmazás eseményindítójának url-címét kapja.

### [Get-AzAppTriggerHistory](Get-AzLogicAppTriggerHistory.md)
Logikai appban lejátsa az eseményindítók előzményeit.

### [Get-AzAppUpgradedDefinition](Get-AzLogicAppUpgradedDefinition.md)
Egy logikai app frissített definícióját kapja meg.
...
Módosítja az integrációs fiók térképét.
...
Módosít egy logikai alkalmazást egy erőforráscsoportban.

### [Start-AzApp](Start-AzLogicApp.md)
Logikai alkalmazást futtat egy erőforráscsoportban.

### [Stop-AzRunAppRun](Stop-AzLogicAppRun.md)
Megszakítja egy logikai alkalmazás futtatását.

### [Test-AzApp](Test-AzLogicApp.md)
Logikai alkalmazásdefiníciót ellenőriz.
