...
## LEÍRÁS
A **Get-AzIntegrationAccountAgreement** parancsmag integrációs fiókszerződést kap egy Azure-erőforráscsoporttól.
...
### 2. példa: Integrációs fiókszerződések lekérte az erőforráscsoport neve alapján
```
...
Ez a parancs az integrációs fiókszerződéseket az erőforráscsoport neve alapján kapja meg.
