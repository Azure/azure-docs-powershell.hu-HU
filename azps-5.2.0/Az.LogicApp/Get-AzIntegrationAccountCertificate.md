...
## LEÍRÁS
A **Get-AzIntegrationAccountCertificate parancsmag** integrációs fióktanúsítványokat kap egy erőforráscsoporttól.
Adja meg az integrációs fiók nevét, az erőforráscsoport nevét és a tanúsítvány nevét.
...
Ez a parancs az IntegrationAccountCertificate01 nevű integrációs fiók tanúsítványát kapja meg.

### 2. példa: Integrációs fiók tanúsítványának lekérte az integrációs fiók neve alapján
```
...
Ez a parancs az IntegrationAccount31 nevű integrációs fiók tanúsítványait kapja meg.
