...
## LEÍRÁS
A **Get-Az LogicApp** parancsmag kap egy logikai alkalmazást.
...
### 1. példa: Logikai alkalmazás lekérte egy erőforráscsoportból
```
...
Ez a parancs az ResourceGroup11 nevű erőforráscsoportból kap egy logikai alkalmazást.
...
### -Name
Annak a logikai alkalmazásnak a nevét adja meg, amelybe ez a parancsmag kerül.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyben ez a parancsmag logikai alkalmazást kap.
...
### -Version
Egy logikai alkalmazás verzióját határozza meg.
