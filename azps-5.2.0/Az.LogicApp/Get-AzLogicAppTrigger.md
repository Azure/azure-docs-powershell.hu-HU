...
## LEÍRÁS
A **Get-Az LogicAppTrigger parancsmag** triggereket kap egy logikai alkalmazásból.
Ez a parancsmag **egy WorkflowTrigger-objektumot** ad vissza.
Adja meg a munkafolyamatot, az erőforráscsoportot és az eseményindítót.
...
### 1. példa: Logikai alkalmazás kiváltása
```
...
Ez a parancs a LogicApp05 nevű logikai appból kapja meg a Trigger01 nevű eseményindítót.

### 2. példa: Logikai alkalmazás összes eseményindítójának lekérte
```
...
Ez a parancs a LogicApp07 nevű logikai alkalmazás indítóit kapja meg.
...
### -Name
Annak a logikai alkalmazásnak a nevét adja meg, amelyből a parancsmag elindítja az eseményindítót.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyben a parancsmag eseményindítót kap.
...
### -TriggerName
A parancsmag által lekért eseményindító neve.
