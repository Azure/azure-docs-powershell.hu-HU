...
## LEÍRÁS
A **Remove-AzIntegrationAccountAssembly** parancsmag eltávolít egy szerelvényt egy integrációs fiókból.

## PÉLDÁK

### 1. példa: Szerelvény eltávolítása paraméterek alapján
```powershell
PS C:\> Remove-AzIntegrationAccountAssembly -ResourceGroupName "sampleResourceGroup" -IntegrationAccountName "sampleIntegrationAccount" -AssemblyName "sampleAssembly"
```

Eltávolítja a "sampleAssembly" nevű szerelvényt, amely a "sampleIntegrationAccount" integrációs fiókban található.
