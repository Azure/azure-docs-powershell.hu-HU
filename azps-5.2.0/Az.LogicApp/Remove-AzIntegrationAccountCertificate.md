...
## LEÍRÁS
A **Remove-AzIntegrationAccountCertificate** parancsmag eltávolítja az integrációs fiók tanúsítványát egy erőforráscsoportból.
...
### 1. példa: Integrációs fiók tanúsítványának eltávolítása
```
...
Ez a parancs eltávolítja az IntegrationAccount31 nevű integrációs fiók tanúsítványát.
