...
Létrehozza a MyCommitmentPlanName nevű új Azure Machine Learning-beli kötelezettségvállalási tervet a "MyResourceGroup" csoportban és az Egyesült Államok déli részén. Ebben a példában az SKU DevTest/Standard függvényt használjuk, ami azt jelenti, hogy a kötelezettségvállalási terv által biztosított erőforrásokat a DevTest/Standard korlátai határozzák meg. Ebben a példában a Termékváltozat 1, ami azt jelenti, hogy a terv költsége a DevTest költségének 1-edik része lesz, és a tervben található erőforrások a DevTest által biztosítandó 1-edik erőforrást fogják tartalmazni.
