...
## SYNOPSIS
Felhasználóhoz rendelt identitást/identitásokat kap.

## SZINTAXIS

### SuscriptionParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **Get-AzUserAssignedIdentity** meglévő felhasználóhoz rendelt identitásokat kap.

## PÉLDÁK

### 1. példa
Ez a példa parancsmag lekérte a felhasználóhoz rendelt identitást a PSRG erőforráscsoportban azonosító **1** **névvel**
...
### 2. példa
Ez a példa parancsmag az összes felhasználó által hozzárendelt identitást a PSRG erőforráscsoport **alatt kapja meg.**
...
### 3. példa
Ez a példa parancsmag begyakorlja az előfizetéshez rendelt összes felhasználóhoz rendelt identitást.
