...
## LEÍRÁS
A Get-AzMapsAccount egy kiépített Azure Maps-fiókot kap, akár erőforráscsoport, akár név, akár erőforrás-azonosító alapján. Ezenkívül az erőforráscsoport összes fiókja, illetve az aktuális előfizetéshez az összes Azure Maps-fiók listáját is visszaadhatja.
...
A MyResourceGroup erőforráscsoport MyAccount nevű fiókjának lekérte, ha van ilyen.
...
Beveszi a MyResourceGroup erőforráscsoport összes Azure Maps-fiókot.
...
Az aktuális előfizetésben lévő összes Azure Maps-fiókot beveszi.
...
Beveszi az Erőforrás-azonosító által megadott Térképek-fiókot.
