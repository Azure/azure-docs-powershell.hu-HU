...
### 1. példa: Az összes virtuális hálózati szabály felsorolása a MariaDB szerint
```powershell
...
Ez a parancs felsorolja a MariaDB alatti összes virtuális hálózati szabályt.

### 2. példa: Virtuális hálózati szabály lekérte a MariaDB
```powershell
...
Ez a parancs a MariaDB alatt virtuális hálózati szabályt kap.
