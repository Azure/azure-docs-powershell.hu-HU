...
## LEÍRÁS
Az **Add-AzAutoscaleSetting** parancsmag létrehoz egy automatikus skálázási beállítást.
...
### 1. példa: Automatikus skálázási beállítás létrehozása
```
...
Az első két parancs a [New-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) segítségével hoz létre két automatikus skálázási szabályt( $Rule 1 és $Rule 2.
A harmadik és negyedik parancs a [New-AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) segítségével hoz létre automatikus skálázási profilokat ($Profile 1 és $Profile 2) az $Rule 1 és a $Rule 2 segítségével.
Az utolsó parancs létrehoz egy automatikus skálázási beállítást az $Profile 1 és a $Profile 2 profiljaival.

## PARAMETERS

### -AutoscaleProfile
Megadja az automatikus skálázási beállításhoz hozzáadni $Null profilt.
...
### -DisableSetting
Letilt egy meglévő automatikus skálázási beállítást.
...
### -InputObject
Az Automatikus méretezés beállításának teljes specifikációja
...
### -Location
Az Automatikus méretezés beállítás helyét adja meg.
...
### -Name
Az automatikus skálázási beállítás nevét adja meg.
...
### -Értesítés
Vesszővel elválasztott értesítések listáját adja meg.
...
### -ResourceGroupName
Az Automatikus méretezés beállítással társított erőforrás erőforráscsoportját adja meg.
...
### -TargetResourceId
Az automatikus méretezéshez szükséges erőforrás azonosítója.
