...
## LEÍRÁS
Az **Remove-AzAlertRule** parancsmag eltávolít egy riasztási szabályt.
Meg kell adnia a riasztási szabály nevét és azt az erőforráscsoportot, amelyhez hozzá van rendelve.
...
### 1. példa: Értesítési szabály eltávolítása
```
...
Ez a parancs eltávolítja a Myalert-7da64548-214d-42ca-b12b-b245bb8f0ac8 nevű riasztási szabályt a Default-Web-CentralUS erőforráscsoportban.
...
### -Name
Az eltávolítható riasztási szabály nevét adja meg.
...
### -ResourceGroupName
A riasztási szabály erőforráscsoportját adja meg.
