...
## LEÍRÁS
A naplóriasztás szabályának frissítése esetén ez a parancs csak az "Enabled" tulajdonság frissítését támogatja.
A többi tulajdonság frissítéséhez lásd a [Set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) parancsot.

## PÉLDÁK

### 1. példa: Frissítés szabálynév szerint
```powershell
...
### 2. példa: Frissítés bemeneti objektum alapján
```powershell
...
### 3. példa: Frissítés erőforrás-azonosító szerint
```powershell
