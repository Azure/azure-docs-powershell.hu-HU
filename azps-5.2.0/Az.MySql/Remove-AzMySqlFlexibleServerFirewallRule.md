...
### 1. példa: A MySql tűzfalszabály eltávolítása név szerint
```powershell
...
Ez a parancsmag név szerint eltávolítja a MySql tűzfalszabályt.

### 2. példa: A MySql tűzfalszabály eltávolítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás szerint eltávolítják a MySql tűzfalszabályt.
