...
### 1. példa: A MySql-kiszolgáló újraindítása erőforráscsoport és kiszolgálónév alapján
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Ez a parancsmag erőforráscsoport és kiszolgálónév szerint újraindítja a MySql-kiszolgálót.

### 2. példa: A MySql-kiszolgáló újraindítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás alapján indítják újra a MySql-kiszolgálót.
