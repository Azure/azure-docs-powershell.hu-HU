...
### 1. példa: A MySql tűzfalszabály frissítése név szerint
```powershell
...
Ez a parancsmag név szerint frissíti a MySql tűzfalszabályt.

### 2. példa: A MySql tűzfalszabály frissítése identitás szerint.
```powershell
...
Ezek a parancsmagok identitás szerint frissítik a MySql tűzfalszabályt.

### 3. példa: A MySql tűzfalszabály frissítése -ClientIPAddress szerint.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/PowershellMySqlTest/providers/Microsoft.DBforMySQL/servers/mysql-test/firewallRules/rule"
...
Ezek a parancsmagok frissítik a MySql tűzfalszabályt -ClientIPAddress szerint.
