...
## LEÍRÁS
A **Get-AzNetAppFilesVolume** parancsmag anF-kötetek részleteit tartalmazza.

## PÉLDÁK

### 1. példa: ANF-hangerő lekérte
```
...
Ez a parancs a MyAnfVolume nevű kötetet a "MyAnfPool" készletből kapja meg. 
...
### -PoolObject
A vissza nem térhet mennyiséget tartalmazó készletobjektum
