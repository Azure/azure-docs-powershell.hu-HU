...
## LEÍRÁS
A **Remove-AzNetAppFilesActiveDirectory** parancsmag törli az ANF active directory-konfigurációt.
...
Ez a parancs törli az új ANF active directory-konfigurációt "MyADName" néven.
...
### -PassThru
Visszaadja, hogy a megadott Active Directory-címtár eltávolítása sikeresen megtörtént-e
