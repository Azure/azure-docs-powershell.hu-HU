...
## LEÍRÁS
A **Remove-AzNetAppFilesBackupPolicy** parancsmag törli az ANF biztonsági mentési házirendet.
...
Ez a parancs törli az új ANF biztonsági mentési házirendet "MyBackupPolicy" néven a "MyAccount" fiókhoz.
...
### -AccountObject
Az eltávolítható biztonsági mentési házirendet tartalmazó Fiók objektum
...
### -PassThru
Annak visszaadése, hogy a megadott biztonságimásolat-házirend eltávolítása sikeresen megtörtént-e
