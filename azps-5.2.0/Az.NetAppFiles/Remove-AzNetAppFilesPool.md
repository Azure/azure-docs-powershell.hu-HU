...
## LEÍRÁS
A **Remove-AzNetAppFilesPool** parancsmag törli az ANF-készletet.
...
Ez a parancs törli a "MyAnfPool" ANF-készletet.
...
### -AccountObject
Az eltávolítható készletet tartalmazó fiókobjektum
...
### -InputObject
Az eltávolítható készletobjektum
...
### -PassThru
Annak visszaadése, hogy a megadott készlet eltávolítása sikeresen megtörtént-e
...
### -ResourceGroupName
Az ANF-készlet erőforráscsoportja
