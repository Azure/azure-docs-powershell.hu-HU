...
### 2. példa: Az ExpressRoute-áramkörhöz társított kapcsolati erőforrás be- és csatlakoztatása pipázás használatával
```
...
### -ExpressRouteCircuit
Az ExpressRoute-áramkör objektuma, amely az áramköri kapcsolat konfigurációját tartalmazza.
