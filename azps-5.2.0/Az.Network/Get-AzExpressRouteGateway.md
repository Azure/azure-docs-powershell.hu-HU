...
A fenti létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub in West Central US, Virtual Hub in West Central US in "testRG" resource group in Azure. Ezután létrejön egy ExpressRoute-átjáró a virtuális központban 2 méretarányú egységben.

Ezt követően az ExpressRouteGateway az erőforrásCsoportneve és az átjáró neve segítségével jut hozzá.
...
Ez a parancs az összes Olyan ExpressRouteGatewayt beszerzi, amely a "teszt" kifejezéssel kezdődik
...
### -ResourceId
Az expressRouteGateway törölt Azure-erőforrásazonosítója.
