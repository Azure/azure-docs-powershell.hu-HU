...
## LEÍRÁS
A **Get-AzNetworkProfile** parancsmag egy meglévő hálózati profil legfelső szintű erőforrását olvassa be
...
Ez a parancs beolvassa a hálózati profil np1-et az rg1 erőforráscsoportban
...
Ez a lekérdezés az "np" kezdetú hálózati profilokat olvassa be.
...
### -ExpandResource
A kibontani szükséges erőforrás-hivatkozás.
...
### -ResourceId
A hálózati profil Azure-erőforrás-kezelői azonosítója.
