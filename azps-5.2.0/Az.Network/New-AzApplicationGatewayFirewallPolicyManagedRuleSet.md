...
Létrehozza a "RuleRuleSetType" tulajdonságot $ruleSetType, a ruleSetVersion as $ruleSetVersion és a RuleGroupOverrides csoportot teljes listaként ( $ruleGroupOverride 1, $ruleGroupOverride 2) az új ManagedRuleSet hozzárendeli a $managedRuleSet
