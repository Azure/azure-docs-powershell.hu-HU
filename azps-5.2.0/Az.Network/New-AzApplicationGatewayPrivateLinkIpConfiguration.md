...
## SYNOPSIS
Ip-konfigurációt hoz létre a PrivateLink-konfigurációhoz társítva
...
## LEÍRÁS
A **New-AzApplicationGatewayPrivateLinkIpConfiguration** parancsmag létrehoz egy Ip-konfigurációt, amely egy Azure-alkalmazás átjáróHoz tartozó PrivateLink-konfigurációval lesz társítva.

## PÉLDÁK

### 1. példa: PrivateLink IP-konfiguráció
```powershell
PS C:\> $PrivateLinkIpConfiguration = New-AzApplicationGatewayPrivateLinkIpConfiguration -Name "ipConfig01" -Subnet $subnet -Primary
```

Ez a parancs létrehoz egy "ipConfig01" nevű PrivateLink IP-konfigurációt, amely az eredményt a $PrivateLinkIpConfiguration. 
...
### -Primary
Az ip-konfiguráció elsődleges beállítása.
...
### -PrivateIpAddress
Az ipConfiguration privát IP-címe, ha statikus terhelést kíván.
