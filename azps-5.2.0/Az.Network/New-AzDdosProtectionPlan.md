...
Először létrehozunk egy új DDoS Védelmi tervet a **New-AzDdosProtectionPlan paranccsal.**
Másodikként a tervhez társítani kívánt virtuális hálózat legfrissebb verzióját tudjuk szerezni. Frissítjük a **DdosProtectionPlan** tulajdonságot egy **PSResourceId** objektummal, amely az újonnan létrehozott terv azonosítójára hivatkozik. Ebben az esetben, ha a virtuális hálózatot DDoS védelmi tervhez társítjuk, az **EnableDdosProtection** jelzőt is beállíthatjuk igazra.
Végül az új állapotot a helyi változó **Set-AzVirtualNetwork-be** való kipipálva történő megőrzésével maradunk meg.
