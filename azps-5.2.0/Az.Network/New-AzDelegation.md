...
## LEÍRÁS
A **New-AzDelegation** parancsmag létrehoz egy szolgáltatásdelegálást, amely hozzáadható az alhálózathoz.
...
Az első parancsmag létrehoz egy delegálást, amely hozzáadható egy alhálózathoz, és a helyi $delegation tárolja. A második és a harmadik parancsmag lekéri a delegálható alhálózatot. A negyedik parancsmag hozzáadja a létrehozott meghatalmazást az érdekes alhálózathoz, a végleges parancsmag pedig elküldi a frissített konfigurációt a kiszolgálónak.
