...
## LEÍRÁS
A **New-AzExpressRoutePort** parancsmag létrehoz egy Azure ExpressRoutePortot
...
### -BandwidthInGbps
A portok sávszélessége Angol fontban
...
### -Identity
Felhasználóhoz rendelt identitás a MacSec-konfiguráció olvasásához
...
### -Link
Az ExpressRoutePort erőforrás fizikai kapcsolatainak halmaza
...
### -PeeringLocation
Annak a társviszony-létesítő helynek a neve, amelyhez az ExpressRoutePort fizikailag megfeleltetve van.
