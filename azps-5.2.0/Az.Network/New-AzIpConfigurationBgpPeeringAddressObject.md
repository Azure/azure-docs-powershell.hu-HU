...
```
## LEÍRÁS
A **New-AzIpConfigurationBgpPeeringAddressObject** létrehoz egy IpConfigurationBgpPeeringAddressObject objektumot, amely a BgpPeeringAddresses tulajdonságot képviseli a virtuális hálózati átjáró bgpsettings szolgáltatásában.

## PÉLDÁK

### 1: AzIpConfigurationBgpPeeringAddressObject létrehozása
```
...
A fenti ipConfigurationBgpPeeringAddressObject.Ez az új objektum a gw1ipconfBgp1 lesz.
...
### -CustomAddress
A virtual network gateway CustomAddress List for BgpPeeringAddresses.
...
### -IpConfigurationId
A virtuális hálózati átjáró IpConfigurationId for BgpPeeringAddresses.
