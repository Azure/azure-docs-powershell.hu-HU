...
## SYNOPSIS
Hozzon létre egy hálózati virtuális eszköz típusú erőforrást.
...
## LEÍRÁS
A New-AzNetworkVirtualAppliance parancs létrehoz egy virtuális hálózati eszköz típusú erőforrást az Azure-ban.
...
Létrehoz egy új hálózati virtuális eszköz típusú erőforrást az erőforráscsoportban: testrg.
...
A Bootstrap konfigurációs blob URL-címe.
...
A Cloudinit beállítása egyszerű szövegként.
...
A Cloudinit konfigurációs blobtároló URL-címe.
...
### -Termékváltozat
A virtuális eszköz termékváltozata.
...
### -VirtualHubId
A virtuális központ erőforrás-azonosítója.
