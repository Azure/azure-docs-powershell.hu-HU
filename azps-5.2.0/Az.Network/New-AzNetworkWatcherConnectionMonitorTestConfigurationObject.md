...
## LEÍRÁS
A New-AzNetworkWatcherConnectionMonitorTestConfigurationObject parancsmag létrehoz egy kapcsolatfigyelő tesztkonfigurációt.
...
Név: httpTC TestFrequencySec : 120 PreferredIPVersion: ProtocolConfiguration : { "Port": 443, "Módszer": "GET", "RequestHeaders": [ { "Name": "Allow"; "Value": "GET" } ], "ValidStatusCodeRanges": [ "2xx", "300-308" ], "PreferHTTPS": true } SuccessThreshold : { "ChecksFailedPercent": 20, "RoundTripTimeMs": 30 } 
...
### -Name
A kapcsolatfigyelő tesztkonfigurációjának neve.
...
### -PreferredIPVersion
A teszt kiértékelése során használni kívánt IP-verzió. A kapcsolatfigyelő más paraméterektől függően másik verziót is használhat.
...
Az egyes protokollok tesztelésének elvégzéséhez használt paraméterek.
...
A sikertelen vizsgálatok maximális százalékos értéke a sikeresként értékelhető teszthez.
...
A teszt sikeres kiértékeléséhez megengedett maximális oda-vissza menetidő ezredmásodpercben.
...
### -TestFrequencySec
A teszt kiértékelési gyakorisága másodpercben.
