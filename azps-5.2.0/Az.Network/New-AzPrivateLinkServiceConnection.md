...
Ebben a példában egy privát kapcsolatszolgáltatás-kapcsolati objektumot hozhat létre a memóriában, és így privát végpontot hozhat létre.

### 2. példa

Létrehoz egy privát kapcsolatszolgáltatás-konfigurációt. (automatikusan generált)
