...
## LEÍRÁS
A **New-AzPrivateLinkServiceIpConfig** parancsmag létrehoz egy privát hivatkozásszolgáltatás IP-konfigurációját. Ez a konfiguráció a privát végpontról bejövő forgalom nat-ing forrásának beállítására használható. 
...
Ebben a példában egy privát hivatkozásszolgáltatás IP-konfigurációját hozhatja létre a memóriában.

### 2. példa

Hozzon létre egy privát hivatkozásszolgáltatás IP-konfigurációját. (automatikusan generált)
...
### -PrivateIpAddress
Az ipConfiguration privát IP-címe, ha a statikus terhelés meg van adva.
...
### -Primary
Azt jelzi, hogy az ip-konfiguráció elsődleges-e vagy sem.
