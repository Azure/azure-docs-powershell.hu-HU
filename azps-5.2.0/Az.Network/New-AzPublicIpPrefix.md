...
## LEÍRÁS
A **New-AzPublicIpPrefix** parancsmag létrehoz egy nyilvános IP-előtagot.

## PÉLDÁK

### 1. példa: Új nyilvános IP-előtag létrehozása
```powershell
PS C:\> $publicIpPrefix = New-AzPublicIpPrefix -Name $prefixName -ResourceGroupName $rgName -PrefixLength 30
```

Ez a parancs új nyilvános IP-előtagforrást hoz létre. 

### 2. példa: Új globális nyilvános IP-előtag létrehozása
```powershell
...
Ez a parancs egy új globális nyilvános IP-előtagforrást hoz létre. 
...
### -Termékváltozat
A nyilvános IP-előtag termékváltozat neve.
...
### -Tier
A nyilvános IP-előtag termékváltozatrétege.
