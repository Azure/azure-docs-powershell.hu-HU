...
## SYNOPSIS
Hozzon létre egy hálózati virtuális eszközre csatlakoztatott webhelyet.
...
## LEÍRÁS
A New-AzVirtualApplianceSite parancs virtuális berendezés-webhelyet hoz létre egy hálózati virtuális eszköz típusú erőforráshoz csatlakoztatva.
...
Hozzon létre egy új virtuális eszközwebhelyet az erőforráscsoportban: testrg.

## PARAMETERS

### -AddressPrefix
A webhely címelőtagja.
...
A hálózati virtuális készülék, amelyhez a webhely csatolva van.
...
### -O365Policy
Az Office 365 törési házirendje.
