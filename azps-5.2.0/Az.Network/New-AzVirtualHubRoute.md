...
A fenti virtuális központi útvonalobjektumot hoz létre, amely része lehet a virtuális központi útválasztási táblának.

A virtuális központi útvonal egy memóriaobjektum, amely VirtualHubRouteTable-objektum létrehozásához használható.
