...
A fentiekkel létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub és VpnSite in West US in "testRG" resource group in Azure. Ezután létrejön egy VPN-átjáró a virtuális központban 2 méretarányú egységben.

Miután létrehozta az átjárót, a virtuális magánhálózathoz csatlakozik a New-AzVpnConnection paranccsal.
...
A fentiekkel létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub és VpnSite, 1 VpnSiteLinks in West US in "testRG" resource group in Azure).
Ezután létrejön egy VPN-átjáró a virtuális központban.
Miután létrehozta az átjárót, az 1 VpnSiteLinkConnections és a VpnSiteLink közötti New-AzVpnConnection paranccsal csatlakozik a VpnSite-webhelyhez.
...
Az a sávszélesség, amelyet a kapcsolatnak mbps-ként kell kezelnie.
...
Internetkapcsolat biztonságának engedélyezése ehhez a kapcsolathoz
...
### -ParentObject
A kapcsolathoz a szülő VpnGateway.
...
### -ParentResourceId
A kapcsolathoz a szülő VpnGateway erőforrás-azonosítója.
...
Csatlakozás kezdeményezése közben használja a helyi Azure IP-címet forráscímként.
...
Ehhez a kapcsolathoz házirendalapú forgalomválasztókat használjon.
...
### -VpnSite
Az a távoli vpn-webhely, amelyhez ez a központi virtuális hálózati kapcsolat kapcsolódik.
...
A VpnConnection vpnsiteLinkConnections listája.
