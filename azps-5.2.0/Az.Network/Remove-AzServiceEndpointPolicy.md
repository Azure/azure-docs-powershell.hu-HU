...
## LEÍRÁS
A **Remove-AzServiceEndpointPolicy** parancsmag eltávolít egy szolgáltatás végponti házirendet.

## PÉLDÁK

### 1. példa: Szolgáltatásvégpont-házirend eltávolítása név használatával
```
Remove-AzServiceEndpointPolicy -Name "Policy1" -ResourceGroup "resourcegroup1"
```

Ez a parancs eltávolítja a "resourcegroup1" nevű erőforráscsoporthoz tartozó szolgáltatásvégpont-házirendet a Házirend1 névvel.

### 2. példa: Szolgáltatásvégpont-házirend eltávolítása bemeneti objektum használatával
```
Remove-AzServiceEndpointPolicy -InputObject $Policy1 -ResourceGroup "resourcegroup1"
```

Ez a parancs eltávolítja az "erőforráscsoport1" nevű erőforráscsoporthoz tartozó szolgáltatásvégpont-házirendobjektum-házirend1-et.
...
### -InputObject
A szolgáltatás végponti házirendobjektuma.
...
### -ResourceId
A szolgáltatásvégpont-házirend azonosítója.
