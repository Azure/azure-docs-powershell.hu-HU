...
## LEÍRÁS
A **Set-AzApplicationGatewayAuthenticationCertificate parancsmag** frissíti az Azure-alkalmazásátjárók hitelesítési tanúsítványát.

## PÉLDÁK

### 1. példa: Hitelesítési tanúsítvány frissítése
```
...
A második parancs frissíti a cert01 nevű hitelesítési tanúsítványt az alkalmazás-átjáróban.
A harmadik parancs frissíti az alkalmazás átjáróját.

## PARAMETERS

### -ApplicationGateway
Megadja annak az alkalmazás-átjárónak a nevét, amelyhez ez a parancsmag egy hitelesítési tanúsítványt frissítéseket ad.
...
### -CertificateFile
Annak a hitelesítési tanúsítványfájlnak az elérési útját adja meg, amellyel ez a parancsmag frissíti a tanúsítványt.
...
### -Name
A parancsmag által frissülő hitelesítési tanúsítvány neve.
