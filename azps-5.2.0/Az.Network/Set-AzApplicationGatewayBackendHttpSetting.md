...
### -ApplicationGateway
Egy olyan alkalmazás-átjáróobjektumot ad meg, amellyel a parancsmag háttér-HTTP-beállításokat társít.
...
### -Port
A háttérkiszolgáló-készletben található egyes kiszolgálókhoz használni használt port.
