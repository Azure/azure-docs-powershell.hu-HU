...
## LEÍRÁS
A **Set-AzApplicationGatewayRewriteRuleSet** parancsmag módosítja a kéréstovábbítási szabályt.
...
A második parancs módosítja az újraírási szabálykészletet ahhoz, hogy az alkalmazás-átjáró a $rule szabályokat használja.
