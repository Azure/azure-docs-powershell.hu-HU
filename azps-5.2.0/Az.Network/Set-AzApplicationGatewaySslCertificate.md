...
## SYNOPSIS
Frissíti egy alkalmazás-átjáró SSL-tanúsítványát.
...
## LEÍRÁS
A **Set-AzApplicationGatewaySslCertificate** parancsmag egy alkalmazás-átjáró SSL-tanúsítványát frissíti.

## PÉLDÁK

### 1. példa: Meglévő SSL-tanúsítvány frissítése az alkalmazás-átjárón
```
...
Frissítsen egy meglévő SSL-tanúsítványt az ApplicationGateway01 nevű alkalmazás-átjáróhoz.

### 2. példa: Meglévő SSL-tanúsítvány frissítése a KeyVault Secret (version-less secretId) használatával az Alkalmazás átjárón
```
...
Szerezze be a titkos tanúsítványt, és frissítsen egy meglévő SSL-tanúsítványt. `Set-AzApplicationGatewaySslCertificate`

### 3. példa: Meglévő SSL-tanúsítvány frissítése a KeyVault Secret használatával az alkalmazásátjárón
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
...
Szerezze be a titkos tanúsítványt, és frissítsen egy meglévő SSL-tanúsítványt. `Set-AzApplicationGatewaySslCertificate`
Megjegyzés: Ha szükséges, hogy az Application Gateway szinkronizálja a tanúsítványt a KeyVaulttal, kérjük, adja meg a verziószám nélkül titkosazonosítót.

## PARAMETERS

### -ApplicationGateway
Azt az alkalmazás-átjárót adja meg, amelyhez az SSL-tanúsítvány társítva van.
...
### -CertificateFile
Az SSL-tanúsítvány elérési útját adja meg.
...
### -Password
Megadja az SSL-tanúsítvány jelszavát.
