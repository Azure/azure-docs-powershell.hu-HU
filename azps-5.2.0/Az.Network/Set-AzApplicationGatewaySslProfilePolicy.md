...
## SYNOPSIS
Módosítja egy alkalmazásátjáró SSL-profiljának SSL-házirendét.
...
## LEÍRÁS
A **Set-AzApplicationGatewaySslProfilePolicy** parancsmag módosítja egy alkalmazásátjáró SSL-profiljának SSL-házirendét.
...
A letiltani szükséges SSL-protokollok listája
...
### -SslProfile
Az alkalmazás átjárója SSL-profilja
