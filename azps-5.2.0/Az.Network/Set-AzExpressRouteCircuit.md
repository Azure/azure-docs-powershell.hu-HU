...
## LEÍRÁS
A **Set-AzExpressRouteCircuit** parancsmag menti a módosított ExpressRoute-áramkört az Azure-ba.

## PÉLDÁK

### 1. példa: ExpressRoute-áramkör ServiceKey-ének módosítása
```
...
### -ExpressRouteCircuit
A parancsmag által módosított **ExpressRouteCircuit-objektumot** adja meg.
