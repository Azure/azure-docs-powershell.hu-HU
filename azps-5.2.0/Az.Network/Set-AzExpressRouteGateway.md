...
A **Set-AzExpressRouteGateway** parancsmaggal frissítheti egy meglévő ExpressRouteGateway méretarányát, vagy frissítheti az erőforráscímkéket.
...
A fentiekkel létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub in West US in "testRG" resource group in Azure). Ezután létrejön egy ExpressRoute-átjáró a virtuális központban 2 méretarányú egységben, amelyet aztán 3 méretarányú egységekre módosítunk.
...
### -InputObject
Az ExpressRouteGateway, amit frissíteni kell.
...
### -ResourceGroupName
A frissíthető ExpressRouteGateway erőforráscsoportneve.
...
### -ResourceId
Az ExpressRouteGateway frissíthető azonosítója.
