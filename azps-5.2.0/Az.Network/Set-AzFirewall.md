...
Ebben a példában először egy tűzfal jön létre alkalmazásszabálygyűjtemények nélkül. Ezután létrejön egy alkalmazásszabály és egy alkalmazásszabálygyűjtemény, majd a tűzfal objektum módosul a memóriában anélkül, hogy ez hatással lenne a felhőbeli valódi konfigurációra. Ahhoz, hogy a módosítások a felhőben is tükröződniük Set-AzFirewall meg kell őket.
