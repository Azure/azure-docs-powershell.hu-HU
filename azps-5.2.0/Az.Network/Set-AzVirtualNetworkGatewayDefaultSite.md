...
A kényszerített alagutaszás virtuális magánhálózati alagutat használ; Ehhez az átjáróhoz egy alapértelmezett webhelyre, egy helyi átjáróra van szükség, ahol a rendszer átirányítja az Azure internetes forgalmát.
...
A Get-AzLocalNetworkGateway segítségével létrehozhat egy objektumhivatkozást egy helyi átjáróra.
...
A $VirtualGateway használható paraméterértékként a *VirtualNetworkGateway* paraméterhez:
