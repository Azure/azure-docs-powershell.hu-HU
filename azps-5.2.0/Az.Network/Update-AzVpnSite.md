...
## LEÍRÁS
Az **Update-AzVpnSite** parancsmag frissíti a VPN-webhelyet.
...
A fenti létrehoz egy erőforráscsoportot (Virtuális WAN az Egyesült Államok nyugati részén, "testRG" erőforráscsoportként az Azure-ban). 

Ezután létrehoz egy VpnSite-t, amely egy ügyfélágat képvisel, és a virtuális WAN-hoz kapcsolódik.

A webhely létrehozása után frissíti a webhely IpAddress címét a Set-AzVpnSite paranccsal.

## PARAMETERS

### -AddressSpace
A virtuális hálózat címelőtagja.
Használja ezt vagy a AddressSpaceObject címet, de ne mindkettőt.
...
### -ResourceId
A vpn-webhely Azure-erőforrásazonosítója.
