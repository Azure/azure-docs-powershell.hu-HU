...
## LEÍRÁS
A **New-AzOperationalInsightsCustomLogDataSource** parancsmag egyéni naplózási házirendet határoz meg.
...
### -CustomLogRawJson
Az egyéni gyűjtemény házirendet nyers JavaScript-objektum-notation (JSON) karakterláncként adja meg.
