...
## LEÍRÁS
Az Update-AzPeering frissítéssel együtt használva ez memóriaművelet, és csak a következővel marad `Update-AzPeering` meg: . 
...
A társviszony-létesítés szolgáltatáshoz használható kapcsolat frissítése
