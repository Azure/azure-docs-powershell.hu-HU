...
### 1. példa: Az irányítópult definíciójának frissítése irányítópultsablon használatával
```powershell
...
Irányítópult-definíció frissítése szaggatott vonalas sablonfájl használatával.
