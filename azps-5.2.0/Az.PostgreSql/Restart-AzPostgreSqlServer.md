...
### 1. példa: A PostgreSql-kiszolgáló újraindítása erőforráscsoport és kiszolgálónév alapján
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Ez a parancsmag erőforráscsoport és kiszolgálónév szerint újraindítja a PostgreSql-kiszolgálót.

### 2. példa: A PostgreSql-kiszolgáló újraindítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás szerint indítják újra a PostgreSql-kiszolgálót.
