...
## LEÍRÁS
A New-AzPowerBIEmbeddedCapacity parancsmag létrehoz egy új Beágyazott PowerBI-kapacitást
...
Létrehoz egy tesztkapacitás nevű kapacitást az Azure régió nyugati részén, az Egyesült Államok nyugati részén és az erőforráscsoport tesztRG-ében. A kapacitás termékváltozatának szintje A1 lesz.

## PARAMETERS

### - Rendszergazda
Vesszővel elválasztott nevek beállítása rendszergazdaként a kapacitáson
...
### -Location
Az Azure-régió, ahol a PowerBI beágyazott kapacitást üzemeltet
