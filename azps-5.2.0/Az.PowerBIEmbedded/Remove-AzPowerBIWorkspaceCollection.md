...
## LEÍRÁS
A **Remove-AzPowerBIWorkspaceCollection** parancsmag eltávolítja a Power BI munkaterület-gyűjteményét az Azure-előfizetésből és -erőforráscsoportból.

## PÉLDÁK

### 1. példa: Munkaterület-gyűjtemény eltávolítása
```
PS C:\>Remove-AzPowerBIWorkspaceCollection -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11"
```

Ez a parancs eltávolítja a WCN11 nevű munkaterület-gyűjteményt a megadott erőforráscsoportban.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyből a parancsmag eltávolít egy munkaterület-gyűjteményt.
...
Annak a Power BI-munkaterületi gyűjteménynek a neve, amelyről a parancsmag eltávolítja.
