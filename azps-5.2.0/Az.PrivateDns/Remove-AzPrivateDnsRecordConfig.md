...
Ez a példa eltávolít egy A rekordot egy meglévő rekordkészletből. Ha ez az egyetlen rekord a rekordkészletben, az eredmény egy üres rekordkészlet lesz. Ha teljes egészében el szeretne távolítani egy rekordkészletet, tekintse meg a Remove-AzPrivateDnsRecordSet rekordkészletet.
...
Ez a példa eltávolít egy SRV rekordot egy meglévő rekordkészletből. Ha ez az egyetlen rekord a rekordkészletben, az eredmény egy üres rekordkészlet. Ha teljes egészében el szeretne távolítani egy rekordkészletet, tekintse meg a Remove-AzPrivateDnsRecordSet rekordkészletet.
...
Ez a példa eltávolít egy TXT rekordot egy meglévő rekordkészletből. Ha ez az egyetlen rekord a rekordkészletben, az eredmény egy üres rekordkészlet. Ha teljes egészében el szeretne távolítani egy rekordkészletet, tekintse meg a Remove-AzPrivateDnsRecordSet rekordkészletet.
