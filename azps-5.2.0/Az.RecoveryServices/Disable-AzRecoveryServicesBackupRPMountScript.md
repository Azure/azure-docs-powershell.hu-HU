...
## LEÍRÁS
A Disable-AzRecoveryServicesBackupRPMountScript parancsmag leválasztja a helyreállítási pont fájljait, amelyeket korábban a Get-AzRecoveryServicesBackupRPMountScript parancsmag használatával szereltek fel.

## PÉLDÁK

### 1. példa: Helyreállítási pont leválasztása
```powershell
...
Leválasztja a helyreállítási pont összes fájlját. (automatikusan generált)
...
### -PassThru
Adja vissza a helyreállítási pontot.
