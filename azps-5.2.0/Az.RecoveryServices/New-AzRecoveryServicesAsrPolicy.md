...
### -AzureToVMware
A Kapcsoló paraméter az Azure-nak a vMWare-házirendek létrehozásának forgatókönyvét határozza meg.
...
### -VmmToVmm
A paraméter váltása a házirend megadásához a VMM-kiszolgáló által kezelt Hyper-V webhelyek közötti replikáláshoz használatos.
