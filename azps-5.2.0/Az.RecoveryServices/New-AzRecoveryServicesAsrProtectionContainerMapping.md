...
## LEÍRÁS
A **New-AzRecoveryServicesAsrProtectionContainerMapping** parancsmag létrehoz egy Azure Site Recovery Protection Container megfeleltetést úgy, hogy társítja a megadott replikációs házirendet a megadott védelmi tárolóhoz.
...
Elindítja a védelmi tároló megfeleltetésének létrehozását a megadott paraméterekkel, és visszaadja a művelet nyomon követéséhez használt ASR-feladatot.
...
### -Name
A Védelmi tároló megfeleltetés nevét adja meg.
...
### -Házirend
A megfeleltetésben használt replikációs házirend ASR-replikációs házirend-objektumát adja meg.
...
A megfeleltetésben használt elsődleges védelmi tároló ASR védelmi tárolóobjektumát adja meg.
...
Megadja annak a helyreállítási védelmi tárolónak az ASR védelmi tárolóobjektumát, amely a megfeleltetésben használatos (nem Azure-beli helyreállítási helyre való replikálás esetén használatos).)
