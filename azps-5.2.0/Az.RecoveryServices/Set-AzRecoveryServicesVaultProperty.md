...
## LEÍRÁS
A **Set-AzRecoveryServicesVaultProperty** parancsmag frissíti a helyreállítási szolgáltatások tároló tulajdonságait.
Ez a parancsmag az aktuális halmaz művelet után visszaadja a frissített tárolótulajdonságokat.
A tároló ezen parancsmagtulajdonságával, például a szoftveres törlés funkcióval bármikor engedélyezhető.
**A tároló SoftDeleteFeatureState** tulajdonsága csak akkor tiltható le, ha nincsenek regisztrálva tárolók a tárolóban.
