...
## LEÍRÁS
A **New-AzRelayAuthorizationRule** parancsmag létrehoz egy új engedélyezési szabályt a megadott továbbítási entitásokhoz (Namespace/WcfRelay/HybridConnection).
...
A `AuthoRule1` **névtérhez hallgató** jogokat hoz `TestNameSpace-Relay1` létre.
...
Engedélyezési szabályt `AuthoRule1`  hoz létre a WcfRelay figyelése `TestWCFRelay1` jogosultságokkal.
...
A `AuthoRule1` hibrid **kapcsolathoz hallgató** jogokkal hozza `TestHybridConnection` létre.
