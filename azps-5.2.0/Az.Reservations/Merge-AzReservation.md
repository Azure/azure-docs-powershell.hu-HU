...
## LEÍRÁS
A megadott `Reservation` értékeket egyesítheti egy új. `Reservation` Az egyesítés alatt lévő két fájlnak `Reservation` azonos tulajdonságokkal kell bírnie.
...
A megadott két érték `Reservation` egyesítése egybe `Reservation`
