...
## LEÍRÁS
A Get-AzDenyAssignment paranccsal felsorolhatja az összes olyan elutasító feladatot, amely egy hatókörben hatékony.
Paraméterek nélkül ez a parancs az előfizetéshez megadott összes elutasítási feladatot visszaadja.
Ez a lista szűrhető a egyszerű feladat paramétereinek szűrésével, a feladat nevének és hatókörének elutasításával.
...
A megtagadás hozzárendelésének hatóköre az alábbi A paraméterkombinációk egyikével létezik megadva.
Hatókör – Ez a teljesen minősített hatókör az /subscriptions/ előjegyzéssel \<subscriptionId\> kezdve.
Ezzel szűri az adott hatókörben hatékony hozzárendeléseket, azaz az adott hatókörben és a fenti hatókörben elutasított összes hozzárendelést.
b.
...
c.
ResourceName, ResourceType, ResourceGroupName és (opcionális) ParentResource – Azonosítja az előfizetés egy adott erőforrását, és szűri az elutasítási hozzárendeléseket, amelyek az adott erőforrás hatókörében hatékonyak.
...
Minden olyan hozzárendelést elutasít, amely a tesztelési hatókörben vagy az azt fentebb john.doe@contoso.com megadott felhasználóhoz lett hozzárendelve.
...
A ResourceGroupName, az ResourceType és a ParentResource paraméterekkel együtt kell használni.
...
A parancs szűri az összes olyan hozzárendelést, amely ilyen hatókörben hatékony.
