...
A **Get-AzDeployment** alapértelmezés szerint az összes telepítést az aktuális előfizetési hatókörben kapja meg.
...
Ez a parancs az összes központi telepítést az aktuális előfizetési hatókörben kapja meg.
