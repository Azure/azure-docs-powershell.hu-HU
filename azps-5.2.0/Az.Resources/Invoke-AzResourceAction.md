...
## LEÍRÁS
Az **Invoke-AzResourceAction** parancsmag meghív egy műveletet egy megadott Azure-erőforráson.
A támogatott műveletek listájának lekértérte az Azure Resource Explorer eszközt.

## PÉLDÁK

### 1. példa: Virtuális gép indítása a ResourceId-val
...
Ez a parancs elindítja a virtuális gépet a következővel: {ResourceId}.

### 2. példa: Virtuális gép erőforrás-hozzárendelésének meghívása a ResourceName névvel
...
Ez a parancs leállítja a virtuális gépet a következővel: {ResourceId}.
A parancs megadja a *Force* paramétert, ezért nem kér megerősítést.

### 3. példa: Erőforrásszolgáltató regisztrálásának meghívása az Erőforrásazonosító függe
...
Ez a parancs a "Microsoft.Network" erőforrásszolgáltatót regisztrálja.
A parancs megadja a *Force* paramétert, ezért nem kér megerősítést.

## PARAMETERS

### -Művelet
Az meghívni szükséges művelet nevét adja meg.
...
Annak az erőforrásnak a nevét adja meg, amelyre a parancsmag műveletet meghív.
...
A bővítményerőforrás típusát határozza meg.
...
### -Parameters
A parancsmag által elindított művelet paramétereit adja meg kivonattáblaként.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyben a parancsmag egy műveletet meghív.
...
### -ResourceId
Annak az erőforrásnak a teljes erőforrás-azonosítóját adja meg, amelyre a parancsmag műveletet meghív.
...
### -ResourceName
Annak az erőforrásnak a nevét adja meg, amelyre a parancsmag egy műveletet meghív.
