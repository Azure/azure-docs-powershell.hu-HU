...
## LEÍRÁS
A **New-AzPolicySetDefinition parancsmag** létrehoz egy házirendkészlet-definíciót.

## PÉLDÁK

### 1. példa: Házirendkészlet-definíció létrehozása metaadatokkal egy házirendkészletfájl használatával
```
[
   {
...
Ez a parancs létrehoz egy VMPolicySetDefinition nevű házirendkészlet-definíciót, metaadatokkal jelezve, hogy a kategória "Virtuális gép", amely a C:\VMPolicy.jsmegadott házirenddefiníciókat tartalmazza. A fenti példában VMPolicy.jsa be van téve.

### 2. példa: Paraméteres házirendkészlet-definíció létrehozása
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Ez a parancs létrehoz egy VMPolicySetDefinition nevű paraméteres házirendkészlet-definíciót, amely tartalmazza a C:\VMPolicy.jsmegadott házirenddefiníciókat. A fenti példában VMPolicy.jsa be van téve.

### 3. példa: Házirendkészlet-definíció létrehozása házirenddefiníciós csoportokkal
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Ez a parancs létrehoz egy VMPolicySetDefinition nevű házirendkészlet-definíciót, amely a be van állítva a C:\VMPolicy.jscsoportosításával. A fenti példában VMPolicy.jsa be van téve.
...
### -GroupDefinition
Az új házirendkészlet-definíció házirenddefiníciós csoportjai. Ez lehet egy olyan fájl elérési útja, amely a csoportokat tartalmazza, vagy a csoportokat JSON-karakterláncként.
...
### -ManagementGroupName
Az új házirendkészlet-definíció felügyeleti csoportjának neve.
...
### -Metadata
A házirendkészlet-definíció metaadatai. Ez lehet egy olyan fájlnév elérési útja, amely tartalmazza a metaadatokat vagy a metaadatokat JSON-karakterláncként.
...
### -Parameter
A házirendkészlet-definíció paramétereinek deklarációja.
Ez lehet egy olyan fájlnév elérési útja, amely a paraméterdeklarációt tartalmazza, vagy a paraméterek deklarációja JSON-karakterláncként.
...
### -SubscriptionId
Az új házirendkészlet-definíció előfizetésazonosítója.
