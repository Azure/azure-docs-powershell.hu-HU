...
## LEÍRÁS
A **Remove-AzPolicyAssignment** parancsmag eltávolítja a megadott házirend-hozzárendelést.
...
A második parancs eltávolítja a PolicyAssignment07 nevű házirend-hozzárendelést, amely erőforráscsoport szintjén lett hozzárendelve.
A **$ResourceGroup ResourceId** tulajdonsága azonosítja az erőforráscsoportot.

### 2. példa: Házirend-hozzárendelés eltávolítása azonosító szerint
```
PS C:\> $ResourceGroup = Get-AzResourceGroup -Name 'ResourceGroup11' 
...
Az első parancs egy ResourceGroup11 nevű erőforráscsoportot kap, majd az objektumot a $ResourceGroup tárolja.
A második parancs erőforráscsoportszinten kapja meg a házirend-hozzárendelést, majd azt a $PolicyAssignment tárolja.
A **$ResourceGroup ResourceId** tulajdonsága azonosítja az erőforráscsoportot.
Az utolsó parancs eltávolítja azt a házirend-hozzárendelést, amit a $PolicyAssignment **resourceid** tulajdonsága azonosít.
...
### -Id
A parancsmag által eltávolított házirend-hozzárendelés teljes erőforrás-azonosítóját adja meg.
...
### -InputObject
Az a házirend-hozzárendelési objektum, amely egy másik parancsmagból távolítja el a kimenetet.
