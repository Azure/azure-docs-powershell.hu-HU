...
A ResourceGroupName, az ResourceType és (opcionális) ParentResource paraméterekkel együtt kell használni egy hierarchikus hatókör felépítéséhez egy relatív URI-ként, amely azonosítja az erőforrást, és törli az adott hatókörű hozzárendelést.
