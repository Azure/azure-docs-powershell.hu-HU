...
## LEÍRÁS
A **Remove-AzTenantDeployment** parancsmag eltávolítja az Azure-telepítéseket a bérlő aktuális hatókörében, valamint a kapcsolódó műveleteket.
...
Ez a parancs eltávolítja a "RolesDeployment" központi telepítést a bérlő aktuális hatókörében.
...
Ez a parancs a központi telepítés "RolesDeployment" parancsát kapja meg az aktuális bérlői webhelyen, és eltávolítja azt.
