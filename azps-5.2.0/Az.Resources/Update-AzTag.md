...
Egy erőforrás vagy előfizetés címkéinek halmazát szelektíven frissíti.
...
Ez a művelet lehetővé teszi a megadott erőforrás vagy előfizetés címkéinek cseréjét, egyesítését vagy szelektív törlését. A megadott entitás legfeljebb 50 címkével lehet a művelet végén. A "csere" beállítás a meglévő címkék teljes halmazát lecseréli egy új készletre. Az "egyesítés" beállítás lehetővé teszi az új névvel kiegészítve címkék hozzáadását, valamint a meglévő névvel kiegészítve a címkék értékeinek frissítését. A "törlés" beállítás lehetővé teszi a megadott nevek vagy név/érték párok alapján történő címkék szelektív törlését.

## PÉLDÁK

### 1. példa: Az előfizetés címkéinek szelektív frissítése az "Egyesítés" művelettel
...
### 2. példa: Az előfizetés címkéinek szelektív frissítése a "Csere" művelettel
...
### -Tag
A frissítéshez használt címkék.
