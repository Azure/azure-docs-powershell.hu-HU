...
## LEÍRÁS
A Get-AzIotSecuritySolution parancsmag egy vagy több iot biztonsági megoldást ad vissza. Az IoT biztonsági megoldás biztonsági adatokat és eseményeket gyűjt az iot-eszközökről és az iOT-központban a veszélyforrások megelőzése és észlelése érdekében.
...
A MySample megoldás lekérte a "MyResourceGroup" erőforráscsoportban
...
A MyResourceGroup erőforráscsoport összes biztonsági megoldásának lekérte
