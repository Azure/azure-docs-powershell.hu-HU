...
## LEÍRÁS
Részletes felmérési adatokat olvashat, vagy felsorolhatja az összes felmérést egy adott szabályozási és szabályozási megfelelőségi szabvány alapján.
...
Az összes felmérést egy adott szabályozás és szabvány szerint hatja át.
...
A felmérésazonosítónak megfelelően adott, adott szabályozású és szabványos felmérést kap.
...
Konkrét felmérést az erőforrás-azonosító alapján, adott szabályozással és szabványsal kell végeznie.
