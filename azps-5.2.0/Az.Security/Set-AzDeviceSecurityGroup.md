...
## LEÍRÁS
A Set-AzDeviceSecurityGroup parancsmag létrehoz vagy frissíti az iot biztonsági megoldásban definiált eszközbiztonsági csoportot.
...
A meglévő eszközbiztonsági csoport frissítése az IoT Hubról "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub" "ActiveConnectionsNotInAllowedRange" szabálytípussal

## PARAMETERS

### -AllowlistRule
Listaszabályok engedélyezése lehetőséget.
...
### -HubResourceId
IoT-központ erőforrás-azonosítója.
