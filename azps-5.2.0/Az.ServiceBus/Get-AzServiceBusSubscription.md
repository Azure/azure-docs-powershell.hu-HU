...
## LEÍRÁS
A **Get-AzServiceBusSubscription** parancsmag az adott Service Bus-témakör előfizetési leírását adja vissza.
...
A megadott Service Bus-témakör előfizetési leírását adja eredményül.
...
Visszaadja a szolgáltatásbusz adott témaköréhez kapcsolódó előfizetések listáját. Alapértelmezés szerint 100 előfizetést ad vissza a rendszer, az előfizetések száma esetén használja a -MaxCount Parameter paramétert.
