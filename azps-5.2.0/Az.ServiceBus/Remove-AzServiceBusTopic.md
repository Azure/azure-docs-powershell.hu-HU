...
## LEÍRÁS
A **Remove-AzServiceBusTopic** parancsmag eltávolítja a témakört a megadott Service Bus névtérből.
...
Eltávolítja a `SB-Topic_exampl1` témakört a névtérből. `SB-Example1`
...
### 5. példa: ResourceId using String value
```powershell
