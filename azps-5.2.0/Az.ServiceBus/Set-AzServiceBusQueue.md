...
## LEÍRÁS
A **Set-AzServiceBusQueue** parancsmag frissíti a szolgáltatásbusz várólistájának leírását a megadott Szolgáltatásbusz névterében.
...
Frissíti a megadott várólistát egy új leírással a megadott névterben. Ebben a példában **a DeadLetteringOnMessageExpiration** tulajdonságot **igaz,** a **SupportOrdering** tulajdonságot pedig igazra **frissíti.**
