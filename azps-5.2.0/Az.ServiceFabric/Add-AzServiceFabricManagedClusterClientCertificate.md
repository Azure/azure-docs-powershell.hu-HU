...
### ClientCertByTpByObj (alapértelmezett)
```
...
Ez a parancs egy "csak olvasható" ügyfél tanúsítványt ad hozzá, amely közös neve "Contoso.com" és 2 kibocsátó.
...
Ez a parancs egy "csak olvasható" ügyfél tanúsítványt ad hozzá, amely közös neve "Contoso.com" és 2 kibocsátó, pipázással.
...
Csak a CommonName névvel együtt használható.
