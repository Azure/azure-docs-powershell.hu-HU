...
Ez a példa létrehozza a "testApp" alkalmazást a "testRG" erőforráscsoportban és a "testCluster" fürtben. A "TestAppType" "v1" alkalmazástípusnak már léteznie kell a fürtben, és az alkalmazásparamétereket definiálni kell az alkalmazás jegyzékfájlban, ellenkező esetben a parancsmag nem fog működni.

### 2. példa: Adja meg a -PackageUrl értéket az alkalmazástípus verzió létrehozásához az alkalmazás létrehozása előtt.
```powershell
