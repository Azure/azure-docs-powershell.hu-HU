...
## LEÍRÁS
Ez a parancsmag új alkalmazástípus-verziót hoz létre a -PackageUrl fájlban megadott csomag használatával, ennek REST-végponton keresztül kell elérhetőnek lennie ahhoz, hogy az Azure Resource Manager felhasználja a telepítés során, és az .sfpkg kiterjesztéssel csomagolva és tömörítve tartalmazza az alkalmazást. Ez a parancs létrehozza az alkalmazástípust, ha még nem létezik.
...
Ebben a példában létrehozunk egy "v1" alkalmazástípusú verziót a "testAppType" típus alatt. Az alkalmazás jegyzékfájlban szereplő verziójának a -Version verzióban megadott verzióval kell azonosnak lennie.
...
### -DefaultParameter
Adja meg az alkalmazásparaméterek alapértelmezett értékeit kulcs-érték párokként.
