...
## SYNOPSIS
Szolgáltatás eltávolítása a fürtből. Csak az ARM szolgáltatásokat támogatja.
...
## LEÍRÁS
Ez a parancsmag eltávolítja a fürtszolgáltatást.
...
Ez a példa eltávolítja a "testApp~testService1" szolgáltatást.
