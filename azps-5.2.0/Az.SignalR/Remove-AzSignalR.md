...
### SignalR-szolgáltatás eltávolítása
```
...
### Az összes SignalR szolgáltatás eltávolítása a pipe-ból
```
...
### -PassThru
Igaz értéket ad vissza, ha az eltávolítás sikeresen befejeződött.
