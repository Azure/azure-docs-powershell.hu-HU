...
### 1. példa: Telepítse a helyi lefordított üveget a szolgáltatáshoz név szerint.
```powershell
...
Telepítse a helyi lefordított üveget a szolgáltatáshoz név szerint.
...
### -JarPath
Az üveg útvonalát fel kell szabadodni.
