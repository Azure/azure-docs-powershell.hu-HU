...
## LEÍRÁS
A Add-AzSqlElasticJobTarget parancsmag hozzáad egy célerőforrást egy célcsoporthoz

## PÉLDÁK

### 1. példa: Kiszolgálói cél hozzáadása
```powershell
...
### 2. példa: Adatbázis-cél hozzáadása
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### 3. példa: Rugalmas készletcél hozzáadása
```powershell
...
### 4. példa: Shard térkép célértékének hozzáadása
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Cél (kiszolgáló, rugalmas készlet, adatbázis és szilvatérkép) hozzáadása a célcsoporthoz
