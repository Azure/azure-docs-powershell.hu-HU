...
### 2. példa: Tiltsa le a bizalmasság-javaslatokat olyan oszlopokban, amelyek bizalmasságra vonatkozó javaslatokat tartalmaznak a Piping funkcióval felügyelt Azure SQL-példány-adatbázisokban.
```powershell
