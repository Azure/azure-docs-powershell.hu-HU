...
## SYNOPSIS
Az Azure AD-hitelesítést csak egy adott SQL Felügyelt példányhoz engedélyezi.
...
## LEÍRÁS
Az **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** parancsmag lehetővé teszi, hogy az Azure Active Directory (Azure AD) csak hitelesítési követelményeket lásson egy AzureSQL Felügyelt példányhoz az aktuális előfizetésben.
...
Ez a parancs csak az Azure Active Directory (Azure AD) hitelesítését teszi lehetővé egy ManagedInstance01 nevű, Az AzureSQL Felügyelt példányhoz, amely egy ResourceGroup01 nevű erőforráscsoporthoz van társítva.
...
### -InstanceName
Az Azure SQL Felügyelt példány neve, amelybe csak az Azure Active Directory hitelesítés van beszúrva.
