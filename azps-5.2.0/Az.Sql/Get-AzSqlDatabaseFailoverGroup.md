...
## LEÍRÁS
Egy adott Azure SQL-adatbázis feladatátvételi csoportot kap, vagy egy kiszolgálón felsorolja a feladatátvételi csoportokat.
...
Egy adott feladatátvételi csoport levétele.
...
Szerezze be az összes feladatátvételi csoportot egy olyan kiszolgálón, amely az "fg" kezdetsel kezdődik.
