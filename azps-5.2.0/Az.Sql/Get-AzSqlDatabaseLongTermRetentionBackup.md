...
## LEÍRÁS
A **Get-AzSqlDatabaseLongTermRetentionBackup** parancsmag hosszú távú adatmegőrzési biztonsági másolatokat kap egy helyről, kiszolgálóról vagy adatbázisról, illetve egy adott hosszú távú adatmegőrzésről.

## PÉLDÁK

### 1. példa: Az összes biztonsági mentés lekérte egy helyre
```powershell
...
Ez a parancs a northeurope-ban található összes (esetleg élő vagy törölt) adatbázisra vonatkozó hosszú távú adatmegőrzési biztonsági másolatot kap, az erőforráscsoport csak akkor lesz beállítva, ha a kiszolgáló élő.

### 2. példa: Erőforráscsoport alatti hely összes biztonsági másolatának be szerezze
```powershell
...
Ez a parancs minden hosszú távú adatmegőrzési biztonsági másolatot kap az északeurope-i erőforráscsoportokban található (esetleg élő vagy törölt) adatbázisokról.

### 3. példa: Adott hosszú távú adatmegőrzési biztonsági másolat készítése
```powershell
...
Ez a parancs a 601061b7-d10b-46e0-bf77-a2bfb16a6add;13165566550000000 nevet kapja

### 4. példa: Az adatbázis összes hosszú távú adatmegőrzési biztonsági mentése
```powershell
...
Ez a parancs hosszú távú adatmegőrzési biztonsági másolatokat kap az adatbázis01-hez

### 5. példa: Hosszú távú adatmegőrzési biztonsági másolatok készítése szűréssel
```powershell
...
Ez a parancs minden biztonsági mentést a "601061b7" névvel kezdődik
...
### -DatabaseName
Annak az Azure SQL-adatbázisnak a neve, amelyből a biztonsági másolat jött létre.
...
### -DatabaseState
Annak az adatbázisnak az állapota, amelynek biztonsági másolatát meg szeretné találni, életre, törlésre vagy mindre.
...
### -InputObject
Az adatbázis-objektum, amelyről biztonsági másolatot készít.
...
### -Location
A biztonsági másolatok forráskiszolgálójának helye.
...
### -ServerName
Annak az Azure SQL Servernek a neve, amely alatt a biztonsági másolatok vannak.
