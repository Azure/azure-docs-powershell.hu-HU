...
## LEÍRÁS
A **Get-AzSqlDatabaseUpgradeHint** parancsmag az Azure SQL-adatbázis frissítésének árszint-tippjéihez jut.
...
### 1. példa: Javaslatok a kiszolgálón található összes adatbázisra vonatkozóan
```
