...
## LEÍRÁS
A **Get-AzSqlServerDisasterRecoveryConfigurationActivity** parancsmag tevékenységet kap egy SQL-adatbázis-kiszolgáló rendszer-helyreállítási konfigurációjában.
...
A kiszolgálórendszer helyreállítási konfigurációjának nevét adja meg.
