...
## LEÍRÁS
A **New-AzSqlInstancePool** parancsmag létrehoz egy Azure SQL-példánykészletet.
...
Ez a parancs egy új Azure SQL-példánykészletet hoz létre.
...
### -ComputeGeneráció
A példánykészlet számítási generációja.
...
### -Location
A példánykészlet létrehozására használt hely.
...
### -SubnetId
A példánykészlet létrehozásához használt alhálózati azonosító.
...
### -VCore
Azt határozza meg, hogy mennyi VCore-t társít a példányhoz.
