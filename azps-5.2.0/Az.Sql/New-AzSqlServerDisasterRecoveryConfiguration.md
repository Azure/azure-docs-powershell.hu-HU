...
## LEÍRÁS
A **New-AzSqlServerDisasterRecoveryConfiguration parancsmag** létrehoz egy SQL-adatbázis-kiszolgáló rendszer-helyreállítási konfigurációt.
...
### -FailoverPolicy
Megadja a feladatátvételi házirendet.
...
### -PartnerServerName
A partnerkiszolgáló nevét adja meg.
