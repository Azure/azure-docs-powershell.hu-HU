...
## LEÍRÁS
A **Remove-AzSqlDatabaseDataMaskingRule** parancsmag eltávolít egy adott adatmaszkolási szabályt egy Azure SQL-adatbázisból.
Az adatmaszkolási szabályokat a *ResourceGroupName,* *a ServerName,* a *DatabaseName* és a *RuleId* paraméter használatával távolíthatja el a parancsmag által eltávolított szabály azonosításához.
Ezt a parancsmagot az Azure SQL Server Stretch Database szolgáltatása is támogatja.

## PÉLDÁK

### 1. példa: Adatbázis-adatmaszkolási szabály eltávolítása
```
...
Ez a parancs eltávolítja az Adatbázis01 adatbázishoz definiált Szabály01 szabályt.
Az adatbázis a Server01 kiszolgálón található, és az ResourceGroup01 erőforráscsoporthoz van hozzárendelve.
