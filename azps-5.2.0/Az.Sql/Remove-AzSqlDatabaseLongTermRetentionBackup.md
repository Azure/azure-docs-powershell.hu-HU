...
### RemoveBackupDefault (alapértelmezett)
```
...
## LEÍRÁS
A **Remove-AzSqlDatabaseLongTermRetentionBackup** parancsmag törli a megadott biztonsági másolatot.

## PÉLDÁK

### 1. példa: Egyetlen biztonsági másolat törlése az erőforráscsoporttal
```powershell
...
Törli a biztonsági másolatot a 601061b7-d10b-46e0-bf77-a2bfb16a6add;131655665500000000

### 2. példa: Egyetlen biztonsági másolat törlése erőforráscsoport nélkül
```powershell
...
### 3. példa: Egy hely összes biztonsági másolatának törlése
```powershell
...
Ez a parancs törli a northeurope hely összes hosszú távú adatmegőrzési biztonsági másolatát.
...
### -InputObject
Az eltávolítható Adatbázis hosszú távú adatmegőrzési biztonsági másolat objektuma.
...
### -ResourceId
Az eltávolítható adatbázis hosszú távú adatmegőrzési biztonsági másolatának erőforrás-azonosítója.
...
### -ServerName
Annak az Azure SQL Servernek a neve, amely alatt a biztonsági másolat található.
