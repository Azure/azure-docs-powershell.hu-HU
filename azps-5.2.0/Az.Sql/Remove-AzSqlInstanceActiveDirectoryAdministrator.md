...
## LEÍRÁS
A **Remove-AzSqlInstanceActiveDirectoryAdministrator** parancsmag eltávolítja az Azure Active Directory (Azure AD) rendszergazdáját az AzureSQL Felügyelt példányhoz az aktuális előfizetésben.

## PÉLDÁK

### 1. példa: Rendszergazda eltávolítása
```
...
Ez a parancs eltávolítja az Erőforráscsoport01 erőforráscsoporttal társított ManagedInstanceName01 nevű felügyelt példány Azure AD-rendszergazdáját.
...
Ez a parancs eltávolítja az Azure AD-rendszergazdát a felügyelt példányobjektumból.
...
Ez a parancs eltávolítja az Azure AD rendszergazdáját felügyelt példány erőforrás-azonosító használatával.
...
### -PassThru
Meghatározza, hogy vissza kell-e térnie az eltávolított AD-rendszergazdának
