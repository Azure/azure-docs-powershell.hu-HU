...
### 3. példa: A T-SQL predikátum használatával végzett speciális szűrést használó Azure SQL-adatbázis blobtárhely-naplózási házirendének engedélyezése
```powershell
...
### 4. példa: A speciális szűrési beállítás eltávolítása egy Azure SQL-adatbázis naplózási házirendje alapján
```powershell
