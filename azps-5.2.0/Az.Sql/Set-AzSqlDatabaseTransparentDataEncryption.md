...
## LEÍRÁS
A **Set-AzSqlDatabaseTransparentDataEncryption** parancsmag módosítja egy Azure SQL-adatbázis TDE tulajdonságát.
...
Ez a parancs engedélyezi a TDE-t a Database01 nevű adatbázishoz a Server01 nevű kiszolgálón.

## PARAMETERS

### -DatabaseName
Annak az adatbázisnak a nevét adja meg, amely módosítja a parancsmagot.
