...
## LEÍRÁS
A Set-AzSqlElasticJob parancsmag frissíti a feladatot

## PÉLDÁK

### 1. példa: Frissíti a feladatot úgy, hogy egy óra múlva kezdődjön, és 1 óránként ismétlődjön
```powershell
...
### -Enable
Az ügyfeleket jelző jelölő engedélyezi ezt a feladatot.
...
### -RunOnce
A feladat jelzésére jelző jelölő egyszer fog futni
