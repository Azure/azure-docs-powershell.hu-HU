...
## LEÍRÁS
A **Set-AzSqlElasticPoolAdvisorAutoExecuteStatus** parancsmag beállítja az Azure SQL rugalmassági készlet tanácsadója automatikus futtatás tulajdonságát.
...
Ezzel a paranccsal engedélyezettre állítja a CreateIndex nevű tanácsadó automatikus végrehajtási állapotát.
...
### -AutoExecuteStatus
Egy új értéket ad meg, amelynek a parancsmagja frissíti az automatikus végrehajtás állapotát.
...
## MEGJEGYZÉSEK
* Kulcsszavak: azure, azurerm, arm, erőforrás, kezelés, kezelő, sql, rugalmas készlet, mssql, tanácsadó
