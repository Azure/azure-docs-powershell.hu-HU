...
Ez a parancs beállítja a rövid távú adatmegőrzési házirendet minden DB1 nevű törölt adatbázisra egy törölt adatbázis-objektum pipázásával. Megjegyzés: A törölt adatbázisok adatmegőrzési ideje csak csökkenthető.
...
### -InstanceName
Annak az Azure SQL Felügyelt példánynak a neve, amelyben az adatbázis van.
