...
Ha szabályozni szeretné a virtuális hálózati szabályok készletét a kiszolgálón, használja helyette az "Add-AzSqlServerVirtualNetworkRule" és a "Remove-AzSqlServerVirtualNetworkRule" parancsot.
