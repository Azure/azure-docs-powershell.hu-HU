...
## LEÍRÁS
A **Start-AzSqlInstanceDatabaseLogReplay** parancsmag elindítja a naplólejátszási szolgáltatást.
...
Ez a parancs új felügyelt adatbázist hoz létre, és a last_backup.bak visszaállításáig visszaállítja a biztonsági másolatokat a megadott tárolóból.
...
Ez a parancs új felügyelt adatbázist hoz létre, és visszaállítja a biztonsági másolatokat a megadott tárolóból, amíg a Complete-AzSqlInstanceDatabaseLogReplay meg nem hívjuk a legutóbbi szükséges biztonsági mentéssel.

## PARAMETERS

### -AutoCompleteRestore
Az a jelző, amely jelzi, hogy a művelet befejezésekor automatikusan be kell-e fejeződni a visszaállítás.
...
### -Collation
A használt példányadatbázis szétválogatása.
...
### -LastBackupName
Az utolsó visszaállítható biztonságimásolat-fájl neve.
...
### -PassThru
Meghatározza, hogy visszaadja-e a szinkronizálási csoportot.
