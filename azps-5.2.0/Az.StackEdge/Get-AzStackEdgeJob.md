...
## LEÍRÁS
A **Get-AzStackEdge Jobs** parancsmag az aktív feladatokat egy Stack Edge eszközön kapja meg. Megemlítheti a Name paramétert egy adott feladat részleteinek lekértérte.
...
### -Name
A feladat neve, általánosan guid azonosító
...
### Microsoft.Azure.PowerShell.Cmdlets.StackEdge.Models.PSStackEdgeSor
