...
## LEÍRÁS
Az **Add-AzRmStorageContainerLegalHold** parancsmag jogi visszatartáscímkéket ad egy tároló blobtárolóhoz

## PÉLDÁK

### 1. példa: Jogi holdcímkék hozzáadása tároló blobtárolóhoz tárfióknévvel és tárolónévvel
```
...
Ez a parancs jogi tárterületcímkéket ad a tárfiók nevét és tárolónevét tartalmazó tár blobtárolóhoz.

### 2. példa: Jogi holdcímkék hozzáadása tárterület blobtárolóhoz Tárfiók-objektummal és tárolónévvel
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>Add-AzRmStorageContainerLegalHold -StorageAccount $accountObject -ContainerName "myContainer"  -Tag  tag1
```

Ez a parancs jogi holdcímkéket ad egy Tárfiók-objektummal és tárolónévvel egy Tárfiók-tároló tárolóhoz.

### 3. példa: Jogi holdcímkék hozzáadása az összes tár blobtárolóhoz egy tárfiókban folyamaton keresztül
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Add-AzRmStorageContainerLegalHold -Tag  tag1,tag2,tag3
```

Ez a parancs jogi holdcímkéket ad a tárfiók összes tárterület-blobtárolója számára.
