...
### 2. példa: Másolás és folyamat kezdése a másolás állapotának szerezze be
```
...
Az első parancs a "contosofile" fájl másolását "contosofile_copy" szóra kezdi, és kimenetként kimenetet ad a destiantion fájlobjektumnak. A második parancssori folyamat a destiantion fájlobjektumot Get-AzStorageFileCopyState fájl másolási állapotának be szereznie.
