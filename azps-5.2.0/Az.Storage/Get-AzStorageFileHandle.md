...
### 1. példa: A fájlmegosztás összes fájlkezelő fogópontját listába rendezheti a ClientIp és az OpenTime szerint.
```
...
### -File
A CloudFile objektum a fájlt a fájl fogópontokkal való listájára jelölte.
...
### -IncludeTotalCount
Az adatkészletben lévő objektumok (egész szám) és az objektumok számát jelenti. Ha a parancsmag nem tudja megállapítani a teljes számát, akkor az "Ismeretlen teljes szám" értéket adja vissza.
