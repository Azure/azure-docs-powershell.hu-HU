...
A biztonsági azonosítót (SID) adja meg. Ezt a paramétert akkor kell beállítani, ha az -EnableActiveDirectoryDomainServicesForFile értéke igaz.
...
Állítsa be a titkosítási kulcstípust a várólistához. Az alapértelmezett érték a Szolgáltatás.
...
- Szolgáltatás: A táblázat mindig titkosítva lesz a Service-Managed kulcsokkal. 
...
- FileStorage. Fájltároló fiók, amely csak a fájlok tárolását támogatja.
...
### -Location
A létrehozni szükséges tárfiók helyét határozza meg.
...
### -MinimumTlsVersion
A tárterület-kérelmekben megengedett minimális TLS-verzió. A tulajdonság alapértelmezett értelmezése a TLS 1.0.
