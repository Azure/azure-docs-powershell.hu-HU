...
## LEÍRÁS
A **Remove-AzRmStorageContainer** parancsmag eltávolít egy tároló blobtárolót

## PÉLDÁK

### 1. példa: Tárterület blobtároló eltávolítása tárfióknévvel és tárolónévvel
```
PS C:\>Remove-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer"
```

Ez a parancs eltávolít egy tárterület blobtárolóját, amely tárfióknevet és tárolónevet is ad.

### 2. példa: Tárterület blobtároló eltávolítása Tárfiók-objektummal és tárolónévvel
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer"
```

Ez a parancs eltávolít egy Tárfiók-objektumot és -tároló nevét tartalmazó tár blobtárolót.

### 3. példa: Az összes tár blobtároló eltávolítása egy tárfiókból folyamaton keresztül
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainer -Force
```

Ez a parancs eltávolítja az összes tárterület blobtárolóját egy folyamatban lévő tárfiókban.
...
### -Force
A tároló és a benne található összes tartalom eltávolítása kényszerítve
