...
## LEÍRÁS
Az **Update-AzRmStorageContainer** parancsmag módosítja a Tároló blobtárolót

## PÉLDÁK

### 1. példa: Egy tároló blobtárolójának metaadatait és nyilvános hozzáférését módosítja tárfióknévvel és tárolónévvel
```
...
Ez a parancs módosítja egy tároló blobtárolójának metaadatait és nyilvános hozzáférését a tárfiók nevével és tárolónévvel.

### 2. példa: Nyilvános hozzáférés letiltása egy Tárfiók-objektummal és tárolónévvel tartalmazó tár blobtárolóban
```
...
Ez a parancs letiltja a nyilvános hozzáférést egy Tárfiók-objektummal és tárolónévvel tartalmazó tár blobtárolóban.

### 3. példa: Nyilvános hozzáférés beállítása Blob-ként egy tárfiók összes tár blobtárolója számára folyamatban lévő tárfiókban
```
...
Ezzel a paranccsal blobként állíthatja be a nyilvános hozzáférést egy tárfiók összes tárterület-blobtárolója számára.
