...
### 3. példa: Egyetlen probléma osztályának részleteinek megtekintése azonosító alapján a piping service objektummal
```powershell
...
### -Id
Probléma besorolásának azonosítója.
...
### -ServiceObject
Az a szolgáltatásobjektum, amelyhez hibabesorolások vannak beolvasva.
