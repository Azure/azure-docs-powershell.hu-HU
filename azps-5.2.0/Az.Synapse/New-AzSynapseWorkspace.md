...
## LEÍRÁS
A **New-AzSynapseWorkspace** parancsmag létrehoz egy Azure Synapse Analytics-munkaterületet.
...
Ez a parancs létrehoz egy ContosoWorkspace nevű Synapse Analytics munkaterületet, amely a ContosoAdlGenStorage adattárat használja a ContosoResourceGroup nevű erőforráscsoportban.
...
Az alapértelmezett ADLS Gen2 tárfiók neve.
...
Az alapértelmezett ADLS Gen2 fájlrendszer.
...
### -Location
Azure-régió, ahol az erőforrást létre kell létrehozni.
...
Az Azure Synapse munkaterülethez dedikált, Szinapszis által felügyelt virtuális hálózat neve.
...
SQL-rendszergazdai hitelesítő adatok.
