...
## LEÍRÁS
A **Set-AzSynapseTrigger** parancsmag létrehoz egy eseményindítót egy munkaterületen. Az eseményindítók "Leállítva" állapotban jön létre, ami azt jelenti, hogy nem kezdődnek azonnal a hivatkozott prognózisok.
...
Hozzon létre egy ContosoTrigger nevű új eseményindítót a ContosoWorkspace munkaterületen. Az eseményindító "Leállítva" állapotban jön létre, ami azt jelenti, hogy nem indul el azonnal. A parancsmag használatával elindítható egy `Start-AzDataFactoryV2Trigger` eseményindító.
...
Hozzon létre egy Új Eseményindítót a ContosoTrigger nevű munkaterületen a ContosoWorkspace folyamaton keresztül. Az eseményindító "Leállítva" állapotban jön létre, ami azt jelenti, hogy nem indul el azonnal. A parancsmag használatával elindítható egy `Start-AzDataFactoryV2Trigger` eseményindító.
