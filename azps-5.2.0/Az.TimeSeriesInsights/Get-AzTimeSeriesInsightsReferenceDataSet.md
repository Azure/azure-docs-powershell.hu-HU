...
### 1. példa: A megadott környezetben található összes hivatkozási adatkészlet felsorolása
```powershell
...
Ez a parancs felsorolja a megadott környezetben található összes hivatkozási adatkészletet.

### 2. példa: Megadott hivatkozási adatkészlet lekérte név szerint
```powershell
...
Ez a parancs egy megadott hivatkozási adatkészletet kap.

### 3. példa: Megadott hivatkozási adatkészlet lekérte objektum szerint
```powershell
...
### -Name
A megadott környezethez társított Time Series Insights hivatkozási adatkészlet neve.
