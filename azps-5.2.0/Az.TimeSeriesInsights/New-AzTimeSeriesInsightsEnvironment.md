...
### 1. példa: Generációs1 idősorok elemzési környezetének létrehozása
```powershell
...
Ez a parancs egy Gen1 idősorozat-elemzési környezetet hoz létre.

### 2. példa: A Gen2 idősorozatok elemzési környezetének létrehozása
```powershell
...
Ez a parancs egy Gen2 idősorozat-elemzési környezetet hoz létre.
...
A Gen1 környezetek esetében ez az érték a létrehozásuk után módosítható úgy, hogy támogassa a környezetek méretének méretezését.
...
A környezetben az adatok partíciókhoz használt eseménytulajdonságok listája.
A felépítésről a PARTITIONKEYPROPERTY tulajdonságok MEGJEGYZÉSEK szakaszában és egy kivonattábla létrehozásában található.
...
### -StorageAccountKey
Annak a felügyeleti kulcsnak az értéke, amely a Time Series Insights szolgáltatást írási hozzáférést biztosít a tárfiókhoz.
...
### -StorageAccountName
Annak a tárfióknak a neve, amely a környezet hosszú távú adatait fogja tartalmazni.
...
A Time Series Insights szolgáltatás viselkedése a környezet kapacitásának túllépése esetén
...
A környezet idősor-azonosítójának meghatározásához használt eseménytulajdonságok listája. Ennek létrehozásáról a TIMESERIESIDPROPERTY tulajdonságokat és a hash táblázatot hoz létre a NOTES (JEGYZETEK) szakaszban található.
...
ISO8601 időből, amely megadja, hogy a környezet eseményei hány napig lesznek elérhetők a meleg tárolóból való lekérdezéshez.
...
PARTITIONKEYPROPERTY <ITimeSeriesIdProperty[]>: A környezetben az adatok partíciókhoz használt eseménytulajdonságok listája.
  - `[Name <String>]`: A tulajdonság neve.
  - `[Type <PropertyType?>]`: A tulajdonság típusa.

TIMESERIESIDPROPERTY <ITimeSeriesIdProperty[]>: A környezet idősor-azonosítójának meghatározásához használt eseménytulajdonságok listája.
  - `[Name <String>]`: A tulajdonság neve.
  - `[Type <PropertyType?>]`: A tulajdonság típusa.
