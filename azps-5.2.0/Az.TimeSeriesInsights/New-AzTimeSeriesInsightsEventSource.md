...
### 1. példa: Eseményhub eseményforrás létrehozása a megadott környezetben
```powershell
...
Ez a parancs eseményhub eseményforrást hoz létre a megadott környezetben.
...
Ez a parancs egy iothub eseményforrást hoz létre a megadott környezetben.

## PARAMETERS

### -ConsumerGroupName
Az esemény/iot-központ fogyasztói csoportjának neve, amely tartalmazza az eseményeket olvasott partíciókat.
...
### -KeyName
Annak az SAS-kulcsnak a neve, amely hozzáférést biztosít a Time Series Insights szolgáltatásnak az eseményhez/iot-központhoz.
...
### -ServiceBusNameSpace
Az eseményközpontot tartalmazó szolgáltatásbusz neve.
...
### -SharedAccessKey
Annak a megosztott hozzáférési kulcsnak az értéke, amely olvasási hozzáférést biztosít a Time Series Insights szolgáltatásnak az eseményhez/iot-központhoz.
...
Az eseményforrás időbélyegeként használt eseménytulajdonság.
