...
### 1. példa: Hivatkozási adatkészlet létrehozása egy adott környezethez  
```powershell
...
Ez a parancs egy adott környezet hivatkozási adatkészletét hozza létre.

## PARAMETERS

### -DataStringComparisonBehavior
A hivatkozási adatkészlet kulcs-összehasonlítási viselkedése a tulajdonság használatával beállítható.
Az érték alapértelmezés szerint "Sorszám" – ez azt jelenti, hogy a program a kis- és nagybetűket megkülönböztető kulcsokat fogja összehasonlítani, miközben hivatkozási adatokat egyesel eseményekhez, illetve új hivatkozási adatok hozzáadása közben hoz létre.
Ha a "OrdinalIgnoreCase" beállítás be van állítva, a kis- és nagybetűk összehasonlítása fog hasonlítani a kis- és nagybetűkre.
...
### -KeyProperty
A hivatkozási adatkészlet főbb tulajdonságainak listája.
A KEYPROPERTY tulajdonságokat a NOTES (JEGYZETEK) szakaszból építi ki, és hozzon létre egy kivonattáblát.
...
### -Name
A hivatkozási adatkészlet neve.
...
KEYPROPERTY <IReferenceDataSetKeyProperty[]>: A hivatkozási adatkészlet főbb tulajdonságainak listája.
  - `[Name <String>]`: A kulcstulajdonság neve.
  - `[Type <ReferenceDataKeyPropertyType?>]`: A kulcstulajdonság típusa.
