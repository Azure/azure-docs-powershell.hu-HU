...
Visszaállít egy ContosoApp nevű törölt appot, amely a Default-Web-WestUS erőforráscsoporthoz tartozik. A ContosoPlan nevű appszolgáltatás-tervben létrejön egy új app, ugyanazokkal a névvel és erőforráscsoporttal, és a törölt app fájljai és beállításai visszaállítva lesznek.
...
Ha 2 törölt app van ugyanazokkal a névvel (ContosoApp), akkor mind a webhelyek adatait, mind a ContosoRestore appot visszaállítjuk a választott alkalmazással az azonosítóval való visszaállítás hívásával.
...
### -Force
A visszaállításhoz nem kell megerősítést kérnie.
...
### -UseDisasterRecovery
Segítségével helyreállítható egy törölt alkalmazás egy offline méretarányú egységből.
