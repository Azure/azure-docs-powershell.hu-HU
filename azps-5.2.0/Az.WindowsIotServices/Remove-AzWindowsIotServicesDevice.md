...
## SYNOPSIS
Windows IoT-eszközszolgáltatás törlése
...
### 1. példa: Windows IoT-szolgáltatások eltávolítása név szerint
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Ez a parancs név szerint eltávolítja a Windows IoT-szolgáltatásokat.

### 2. példa: Windows IoT-szolgáltatások eltávolítása folyamat szerint
```powershell
...
Ez a parancs folyamat szerint eltávolítja a Windows IoT-szolgáltatásokat.
