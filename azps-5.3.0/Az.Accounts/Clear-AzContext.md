...
### 1. példa: Globális környezet egyértelművé
```powershell
PS C:\> Clear-AzContext -Scope CurrentUser
```

Távolítsa el az összes fiók-, előfizetés- és hitelesítőadat-információt bármely PowerShell-munkamenetben.
...
### -Force
Az összes felhasználó és csoport törlése a globális hatókörből rákérdezés nélkül
...
### -Scope
Csak az aktuális PowerShell-munkamenet környezetének vagy az összes munkamenetnek a környezetét törölje.
