...
## LEÍRÁS
Az **Add-AzApiManagementApiToProduct** parancsmag hozzáad egy Azure API Management API-t egy termékhez.

## PÉLDÁK

### 1. példa: API hozzáadása termékhez
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Add-AzApiManagementApiToProduct -Context $ApiMgmtContext -ProductId "0123456789" -ApiId "0001"
```

Ez a parancs hozzáadja a megadott API-t a megadott termékhez.

## PARAMETERS

### -ApiId
Egy termékhez hozzáadni fog egy API azonosítóját adja meg.
...
### -ProductId
Annak a terméknek az azonosítója, amelyhez hozzá kell adni az API-t.
