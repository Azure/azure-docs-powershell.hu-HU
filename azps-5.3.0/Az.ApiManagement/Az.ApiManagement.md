...
Lekérte a bérlők hozzáférési konfigurációs kulcsait.
...
A konfigurációs adatbázis és a Git-tár közötti legutóbbi szinkronizálás állapotát kapja meg.
...
Létrehozza az új API-sémát az ApiManagement szolgáltatásban
...
Létrehoz egy API-kezelési tanúsítványt, amely használható a Backend-et használó hitelesítés során.
...
Új diagnosztika létrehozása a globális vagy api-hatókörben.
...
Létrehoz egy állomásnevet a meglévő átjáróhoz.
