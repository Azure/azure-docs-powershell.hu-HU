...
## LEÍRÁS
A **Get-AzApiManagementGatewayHostnameConfiguration** parancsmag az összes vagy adott állomásnév-konfigurációt megkapja a meglévő átjáróhoz.

## PÉLDÁK

### 1. példa: Az átjáró összes állomásnevének beállítása
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGatewayHostnameConfiguration -Context $apimContext  -GatewayId "0123456789"
```

Ez a parancs egy "0123456789" átjáró összes állomásnevét beveszi.

### 2. példa: Állomásnév beállítása az átjáróhoz
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Ez a parancs "123" állomásnév-konfigurációt kap egy "0123456789" átjáróhoz.
