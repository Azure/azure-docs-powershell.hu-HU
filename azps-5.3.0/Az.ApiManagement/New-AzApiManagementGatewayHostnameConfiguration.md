...
## LEÍRÁS
A **New-AzApiManagementGatewayHostnameConfiguration parancsmag** létrehoz egy állomásnevet configuratin a meglévő átjáróhoz.

## PÉLDÁK

### 1. példa: Állomásnév-konfiguráció létrehozása a meglévő átjáróhoz
```powershell
...
Ez a parancs egy "h01" állomásnév-konfigurációt hoz létre egy "g01" átjáróhoz.

## PARAMETERS

### -CertificateResourceId
A meglévő tanúsítványazonosító erőforrás-azonosítója. Ezt a paramétert kötelező megadni.
...
Az új átjáró állomásnevének konkuration azonosítója.
