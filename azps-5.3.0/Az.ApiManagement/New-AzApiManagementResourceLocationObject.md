...
## LEÍRÁS
A **New-AzApiManagementResourceLocationObject** parancsmag létrehoz egy új erőforráshely-szerződést (ezt az átjárók használják).

## PÉLDÁK

### 1. példa: Erőforrás-helyszerződés létrehozása
```powershell
PS C:\>$location = New-AzApiManagementResourceLocationObject -Name "n1" -City "c1" -District "d1" -CountryOrRegion "r1"
```

Ez a parancs létrehoz egy erőforráshelyet.

## PARAMETERS

### -City
Location City (Település) adatokat.
