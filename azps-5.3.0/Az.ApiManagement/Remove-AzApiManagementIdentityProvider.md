...
### 1. példa: A Facebook-identitásszolgáltató beállításainak eltávolítása az ApiManagement szolgáltatásból
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementIdentityProvider -Context $apimContext -Type 'Facebook' -PassThru
```

Törli a Facebook-identitásszolgáltató konfigurációjával kapcsolatos konfigurációt.
