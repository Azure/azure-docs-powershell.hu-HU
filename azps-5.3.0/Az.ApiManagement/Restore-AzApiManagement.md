...
## LEÍRÁS
A **Restore-AzApiManagement** parancsmag visszaállítja az API-felügyeleti szolgáltatást egy Azurestorage-blob adott biztonsági mentési környezetében.

## PÉLDÁK

### 1. példa: API-kezelési szolgáltatás visszaállítása
```
...
Ez a parancs visszaállít egy API-kezelési szolgáltatást az Azure storage blobból.
...
### -Name
Annak az API-kezelési példánynak a nevét adja meg, amely a biztonsági másolatsal együtt visszaállítható.
...
### -SourceBlobName
Az Azure-tár biztonságimásolat-forrás blobnevét adja meg.
...
### -SourceContainerName
Az Azure tár biztonságimásolat-tárolója nevét adja meg.
...
### -StorageContext
A tárterület-kapcsolat környezetét határozza meg.
