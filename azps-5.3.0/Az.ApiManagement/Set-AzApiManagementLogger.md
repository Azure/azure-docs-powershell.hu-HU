...
ms.locfileid: "98381708"
---
# Set-AzApiManagementLogger

## SYNOPSIS
Módosítja az API Management Logger eszközét.
...
## LEÍRÁS
A **Set-AzApiManagementLogger** parancsmag módosítja az Azure API Management **Logger** beállításait.

## PÉLDÁK

### 1. példa: Az EventHub naplózó módosítása
```powershell
...
Ez a parancs módosítja az azonosítónaplót123 azonosítójú naplózót.

### 2. példa

Módosítja az API Management Logger eszközét. (automatikusan generált)
...
### -ConnectionString
Egy Azure Event Hubs kapcsolati karakterláncot ad meg, amely tartalmazza a Házirend-küldési jogokat.
...
### -IsBuffered
Azt adja meg, hogy a rendszer a közzététel előtt pufferelje a naplóban található rekordokat.
A rekordok pufferelése esetén a rendszer 15 másodpercenként küldi el a rekordokat az eseményközpontok számára, vagy amikor a puffer 256 KB-os üzeneteket kap.
...
### -LoggerId
A frissítenie kell a naplózó azonosítóját adja meg.
...
### -PassThru
Azt jelzi, hogy ez a parancsmag a  **PsApiManagementLogger** értéket adja vissza, amely módosítja a parancsmagot.
