...
### 1. példa: Új Api-kulcs létrehozása egy alkalmazásstatstatóforráshoz
```
...
Az "readtelemetry", a "testGroup" erőforráscsoport "test" erőforráscsoportjának "WriteAnnotations" engedélyekkel rendelkező "testapiKey" engedélyekkel létrehozhatja az alkalmazásstatizálási api kulcsleírását.
