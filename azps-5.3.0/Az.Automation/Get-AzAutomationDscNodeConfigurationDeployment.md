...
## LEÍRÁS
A **Get-AzAutomationDscNodeConfigurationDeployment parancsmag** egy APS–kívánt államkonfigurációt (DSC) telepít az Azure Automationben.

## PÉLDÁK

### 1. példa: Csomópont-konfiguráció beállítása
```
