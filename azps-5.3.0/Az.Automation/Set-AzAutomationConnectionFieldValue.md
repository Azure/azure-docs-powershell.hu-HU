...
## LEÍRÁS
A **Set-AzAutomationConnectionFieldValue** parancsmag módosítja egy kapcsolat egy mezőjének értékét az Azure Automationben.

## PÉLDÁK

### 1. példa: Kapcsolat mezőértékének módosítása
```
...
Ez a parancs módosítja a ContosoConnection nevű Azure-kapcsolat előfizetésazonosítóját az AutomationAccount01 nevű automatizálási fiókban.

## PARAMETERS

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelynek a parancsmagja módosítja egy kapcsolat egyik mezőjét.
...
### -ConnectionFieldName
Megadja annak a mezőnek a nevét, amit ez a parancsmag módosít.
...
### -Name
Megadja annak a kapcsolatnak a nevét, amelynek a parancsmagja módosít egy mezőt.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelynek a parancsmagja módosítja egy kapcsolat egyik mezőjét.
...
### -Érték
A kapcsolatmezőben módosíthat egy értéket.
