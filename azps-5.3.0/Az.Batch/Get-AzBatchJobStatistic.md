...
## SYNOPSIS
Egy Batch-fiókra vonatkozó összefoglaló statisztikákat kap.
...
## LEÍRÁS
A **Get-AzBatchStatistic parancsmag** az Azure Batch-fiók összes feladatának összesítő statisztikáját leküldi.
A statisztikák összesítve vannak minden olyan munkakörben, amely valaha is létezik a fiókban, a fiók létrehozásától a statisztika legutóbbi frissítésének időpontig.

## PÉLDÁK

### 1. példa: Összesítő statisztika megjelenítése az összes álláshoz
```
