...
## SYNOPSIS
Készletösszegző statisztikákat kap egy Batch-fiókhoz.
...
A statisztikák a fiókban már létező összes készletben összesítve létezik, a fiók létrehozásától a statisztika legutóbbi frissítésének időpontig.
