...
## LEÍRÁS
A **Get-AzConstionMarketplace parancsmag** piactereket kap az előfizetéshez.

## PÉLDÁK

### 1. példa: Piactér-használat
```powershell
...
### 2. példa: Piactér-használat a dátumtartománysal
```powershell
...
### 3. példa: A BillingPeriodName piactéri használatának lekérte
```powershell
...
### 4. példa: Piactér-használat a InstanceName szűrővel
```powershell
...
### -BillingPeriodName
Annak a számlázási időszaknak a neve, amely a piactérhez társítva van.
...
### -EndDate
A szűrendő piacterek záró dátuma (UTC-ben).
...
### -InstanceId
A szűrni megfelelő piacterek példányazonosítója.
...
### -InstanceName
A szűrni megfelelő piacterek példányneve.
...
### -ResourceGroup
A szűrni szükséges piacterek erőforráscsoportja.
...
### -StartDate
A szűrendő piacterek kezdő dátuma (UTC-ben).
