...
## LEÍRÁS
A **Get-AzConstionReservationDetail parancsmag** foglalási részleteket kap a megadott dátumtartományhoz.

## PÉLDÁK

### 1. példa: Foglalás részleteinek lekérte a foglalási rendelés azonosítóját a megadott dátumtartományhoz
```powershell
...
### 2. példa: Foglalás részletei a foglalási rendelés azonosítójával és a megadott dátumtartományhoz megadott foglalásazonosítóval
```powershell
...
### -EndDate
A foglalás részleteinek záró adatai (YYYY-MM-DD az UTC-ben).
...
### -StartDate
A foglalás részleteinek kezdési adatai (YYYY-HH-DD az UTC-ben).
