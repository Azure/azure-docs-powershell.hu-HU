...
### 1. példa: A blockchain tag API-kulcsának újragenerálása név használatával
```powershell
...
Ez a parancs név, erőforráscsoport használatával újra létrehozza egy blockchain-tag Api-kulcsait.

### 2. példa: Az Api-kulcsok újragenerálása blokklánctag esetén idenity használatával
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Ez a parancs identitással újra létrehozza egy blockchain-tag API-kulcsait.
