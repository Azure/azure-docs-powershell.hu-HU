...
### CreateTemplateArtifact (alapértelmezett)
```
...
## LEÍRÁS
Új tárgy létrehozása A tárgy kétféleképpen hozható létre: bemeneti fájlként egy JSON-összetevőn keresztül vagy az adott tárgy beágyazott paramétereinek biztosításával. Bár a JSON metódus nem követeli meg az összetevő típusának beágyazott paraméteres módszerrel való megadva, a felhasználónak meg kell adnia az összetevő típusát a -Type paraméteren keresztül.
...
Hozzon létre egy új tárgyat egy JSON-fájlon keresztül.
...
Hozzon létre egy új összetevőt a beágyazott paramétereken keresztül.
...
Új elem létrehozása egy ARM sablonfájlon keresztül.

## PARAMETERS

### -ArtifactFile
Az összetevő-fájl helye JSON formátumban a lemezen.
...
### -DependsOn
Azoknak az összetevőknek a listája, amelyek az aktuális tárgy létrehozása előtt létrejönnek.
...
### -PolicyDefinitionId
A házirenddefiníció definícióazonosítója.
...
A házirenddefiníciós összetevőnek átadni szükséges paraméterek kivonata.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amely alatt az összetevő fog lennie.
...
A szerepkördefiníciós egyszerű azonosítók listája.
...
A ARM sablon paraméterfájljának helye a lemezen.
...
### -Type
Az összetevő típusa.
Három támogatott típus létezik: RoleAssignmentArtifact, PolicyAssignmentArtifact, TemplateArtifact.
