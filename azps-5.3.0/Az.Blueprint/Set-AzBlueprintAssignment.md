...
Frissítse a tervdefiníció meglévő hozzárendelését a megadott előfizetésen belül, és frissítse `$blueprintObject` a paramétereket. Rendszer által hozzárendelt identitást használ. A hely határozza meg a felügyelt identitás létrehozására vonatkozó régiót.
...
Frissítheti egy meglévő terv-hozzárendelést egy feladatfájlon keresztül. A feladatfájl formátuma megtalálható a kérelem/válasz mintáiban: https://github.com/Azure/azure-rest-api-specs/tree/master/specification/blueprint/resource-manager/Microsoft.Blueprint/preview/2018-11-01-preview/examples
...
A megadott felügyeleti csoporton belül a megadott előfizetésre vonatkozó tervdefiníció meglévő tervrajz-hozzárendelésének frissítése a `$blueprintObject` megadott paraméter használatával.
