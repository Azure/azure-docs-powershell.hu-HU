...
## SYNOPSIS
Új CDN-forráscsoport létrehozása
...
## LEÍRÁS
A New-AzCdnOriginGroup létrehoz egy új origincsoportot a megadott végponton belül. Ha ez a végpont első origincsoportja, akkor a DefaultOriginGroup tulajdonságot is be kell állítani.
...
```
Ez a parancsmag egy új origincsoportot hoz létre a megadott végponton belül. A forráshalmaz a megadott originazonosítókat fogja használni.
