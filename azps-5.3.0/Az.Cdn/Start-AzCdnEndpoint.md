...
## LEÍRÁS
A **Start-AzCdnEndpoint** parancsmag elindít egy Azure Content Delivery Network (CDN) végpontot.
...
### -CdnEndpoint
A parancsmag által elindított végpontot határozza meg.
...
### -EndpointName
A parancsmag által elindított végpont nevét adja meg.
