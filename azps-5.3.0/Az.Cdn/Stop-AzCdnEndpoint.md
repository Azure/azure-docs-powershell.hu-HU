...
## LEÍRÁS
A **Stop-AzCdnEndpoint** parancsmag leállítja az Azure Content Delivery Network (CDN) végpontot.
...
### -CdnEndpoint
A parancsmag végpontobjektumát határozza meg.
...
### -EndpointName
A parancsmag végpontjának nevét adja meg.
