...
## LEÍRÁS
Az **Add-AzVmssSshPublicKey** parancsmag hozzáadja a virtuálisgép-mérethalmazhoz (VMSS) virtuális géphez való csatlakozáshoz használható nyilvános kulcsokat a Secure Shellen (SSH) keresztül.
