...
Ez a parancs letiltja a titkosítást az összes típusú, VM002 nevű virtuális gép számára, amely a Group001 nevű erőforráscsoporthoz tartozik.
Mivel a *VolumeType* paraméter nincs megadva, a parancsmag az All értéket állítja be.
