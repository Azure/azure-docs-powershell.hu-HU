...
## LEÍRÁS
A **Get-AzVmss** parancsmag egy virtuális gép méretarány-készletének (VMSS) modell- és példánynézetét kapja meg.
A modellnézet a virtuális gép méretaránykészletének felhasználó által megadott tulajdonságai.
A példánynézet a virtuális gép méretaránykészletének példányszintű állapota.
Adja meg *a InstanceView* paramétert, hogy csak egy virtuális gép méretaránykészletének példánynézetét szerezze be.

## PÉLDÁK

### 1. példa: VMSS-tulajdonságok lekérte
```
...
Ez a parancs a VMSS001 nevű VMSSS tulajdonságát kapja meg, amely a Group0001 nevű erőforráscsoporthoz tartozik.
Mivel a parancs nem adja meg a *InstanceView* kapcsoló paramétert, a parancsmag megkapja a virtuális gép méretaránykészletének modellnézetét.

### 2. példa: Erőforráscsoport összes vmsének be szereznie
```
...
A "Group001" erőforráscsoport összes vmsének lekérte

### 3. példa: Az előfizetésben található összes vm lekérte
```
PS C:\> Get-AzVmss
...
Szerezze be az előfizetésben található összes Vms-et.

### 4. példa: Az összes vms lekérte szűrés használatával
```
...
Szerezze be az előfizetésben a "VMSS00" kezdettől induló összes vmst.
...
### -InstanceView
Azt jelzi, hogy ez a parancsmag csak a virtuális gép méretaránykészletének példánynézetét kapja meg.
...
### -OSUpgradeHistory
Azt jelzi, hogy ez a parancsmag felsorolja a virtuális gép méretkészletének os frissítési előzményeit.
