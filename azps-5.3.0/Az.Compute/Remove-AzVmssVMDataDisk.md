...
## LEÍRÁS
Az **Remove-AzVmssVMDataDisk** parancsmag eltávolítja az adatlemezt egy VM-méretkészlet virtuális gépről

## PÉLDÁK

### 1. példa: Adatlemez eltávolítása VIRTUÁLIS GÉP-mérethalmazból
```powershell
