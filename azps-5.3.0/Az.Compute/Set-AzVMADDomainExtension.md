...
## LEÍRÁS
A **Set-AzVMADDomainExtension parancsmag** hozzáad egy Azure Active Directory (AD) tartomány virtuális gépbővítményt egy virtuális géphez.
Ez a bővítmény lehetővé teszi, hogy a virtuális gép csatlakozzon egy tartományhoz.
...
### -JoinOption
Az illesztés beállítását adja meg. Az illesztési lehetőségekért [lásd: fJoinOptions](https://docs.microsoft.com/en-us/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
### -Name
A hozzáadni megfelelő tartománybővítmény neve.
...
### -OUPath
A tartományfiók szervezeti egységét adja meg.
Írja be a szervezeti egység teljes megkülönböztető nevét idézőjelek közé.
Az alapértelmezett érték a tartomány gépi objektumainál az alapértelmezett szervezeti egység.
...
### -Újraindítás
Azt jelzi, hogy ez a parancsmag újraindítja a virtuális gépet.
A módosítás érvénybe hozása gyakran újraindítást igényel.
...
### -TypeHandlerVersion
A tartománybővítmény verzióját határozza meg.
