...
Általánosított felhasználói lemezkép esetén a *SourceImageUri* paramétert és a *Windows* vagy *Linux* paramétereket is meg kell adnia ahhoz, hogy az Azure-platform a **Set-AzVMSourceImage** parancsmag használata helyett meg tudja határozni az operációs rendszer merevlemezének helyét és típusát.
