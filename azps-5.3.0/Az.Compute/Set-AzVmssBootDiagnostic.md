...
### 1. példa: A VMSS rendszerindításkor használt diagnosztikai profiltulajdonságának beállítása
```
...
Ez a parancs beállítja a ContosoVMSS nevű VMSS rendszerindítási diagnosztikai profiltulajdonságát.
