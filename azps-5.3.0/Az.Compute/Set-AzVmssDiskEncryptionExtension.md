...
## SYNOPSIS
Lemeztitkosítást tesz lehetővé EGY VIRTUÁLIS GÉP mérethalmazán.
...
Linuxos virtuális gépeken a *VolumeType* paraméternek jelen kell lennie, és az "Adatok" értéknek kell lennie.
...
### -VolumeType
Megadja, hogy milyen típusú virtuális gépköteteket kell titkosítási műveletet végrehajtani: operációs rendszer, adatok vagy mind. 

Linux: A **VolumeType paraméternek** jelen kell lennie, és adatokra kell állítani. 
