...
## LEÍRÁS
A **Start-AzVmss** parancsmag elindítja az összes virtuális gépet a virtuálisgép-mérethalmazon (VMSS) vagy virtuális gépeken.
...
Ez a parancs elindítja a ContosoVMSS nevű VMSS-hez tartozó példányazonosító karakterlánctömb által meghatározott virtuális gépkészletet.
...
Ez a parancs elindítja az összes virtuális gépet, amely a ContosoVMSS nevű VMSS-hez tartozik.
...
### -VMScaleSetName
Annak a VMSS-nek a nevét adja meg, amely elindítja a virtuális gépeket a parancsmagban.
