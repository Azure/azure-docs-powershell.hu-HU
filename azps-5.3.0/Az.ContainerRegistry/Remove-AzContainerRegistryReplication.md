...
## LEÍRÁS
A Remove-AzContainerRegistryReplication parancsmag eltávolítja a tároló beállításjegyzékének replikációját.

## PÉLDÁK

### 1. példa: Eltávolítja a tároló beállításjegyzékének replikációját.
```powershell
