...
## SYNOPSIS
A 2012-es sql tárolót kapja meg.
...
## LEÍRÁS
A **Get-AzCosmosDBSqlContainer** parancsmag lekérte az adott ResourceGroupName, AccountName és DatabaseName erőforráscsoport összes meglévő Tárolóját, és egy Adott ResourceGroupName, AccountName és ContainerName rekordhoz egyetlen Tárolót kap.
