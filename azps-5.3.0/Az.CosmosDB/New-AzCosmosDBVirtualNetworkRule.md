...
## SYNOPSIS
Hozzon létre egy új TárolóDB VirtualNetworkRule objektumot (PSVirtualNetworkRule).
...
### -Id
Egy alhálózat erőforrás-azonosítója, például: /subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/alhálózatok/{alnetName}
...
Logikai érték, amely azt jelzi, hogy létre kell-e hozni tűzfalszabályt, mielőtt a virtuális hálózat engedélyezné a virtuális hálózat szolgáltatás végpontját.
...
### Microsoft.Azure.Commands.FogsDB.Models.PSVirtualNetworkRule
