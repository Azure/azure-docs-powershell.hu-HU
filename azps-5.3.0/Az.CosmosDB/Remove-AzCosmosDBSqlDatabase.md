...
## SYNOPSIS
Törli a TárolóDB Sql-adatbázist.
...
## LEÍRÁS
A **Remove-AzCosmosDBSqlDatabase** parancsmag törli az adott ResourceGroupName, AccountName és DatabaseName fájlnak megfelelő TárolóAdatbázis sql-adatbázist.
