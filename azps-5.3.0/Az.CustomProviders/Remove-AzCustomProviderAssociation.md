...
### 1. példa: Egyéni szolgáltató társítás eltávolítása.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Egyéni szolgáltató-társítás eltávolítása

### 2. példa: Egyéni szolgáltatói társítás eltávolítása a Piping szolgáltatóval
```powershell
...
Távolítsa el az egyéni szolgáltató-társításokat a sikeresség vagy a sikertelenség jelzésére pipázás és a PassThru funkció használatával.
