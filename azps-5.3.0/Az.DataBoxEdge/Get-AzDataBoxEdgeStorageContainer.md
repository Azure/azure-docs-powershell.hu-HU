...
## LEÍRÁS
A **Get-AzDataBoxEdgeStorageContainer** parancsmag egy Data Box Edge-eszközön található Edge Storage-fiók tárolóját kapja meg. A nevet paraméterként megadhatja a parancsmagban egy adott tároló részleteinek lehívása érdekében. 
...
Meglévő EdgeStorageAccount objektum létrehozása
