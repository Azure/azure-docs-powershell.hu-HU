...
## LEÍRÁS
A **New-AzDataBoxEdgeStorageAccountCredential** parancsmag létrehoz egy új peremtárhelyfiók hitelesítő adatait egy Data Box Edge-eszközhöz.
...
tárfiók hozzáférési kulcsának létrehozása
...
### -StorageAccountType
Lehetséges Tárterület-elérés típusa GeneralPurposeStorage, BlockStorage
