...
## LEÍRÁS
A **Set-AzDataBoxEdgeRole** parancsmag frissíti egy IoT-szerepkört egy Data Box Edge-eszközön. A régi telepített megosztásokat felváltja a ShareName paraméterben újonnan megadottak.
...
A Megosztásnevek helyére a régi telepített megosztások az újonnan hozzáadott megosztások lesznek.
