...
## LEÍRÁS
Az integrációs futásidejű billentyűparancsok lekérte. A kulcsok egy integrációs futásidejű csomópont regisztrálását használják.

## PÉLDÁK

### 1. példa: Integrációs futásidejű kulcsok lekérte
```
