...
## LEÍRÁS
A **Get-AzDataLakeAnalyticsAccount** parancsmag információkat kap egy Azure Data Lake Analytics-fiókról.

## PÉLDÁK

### 1. példa: Adatok lekérte a Data Lake Analytics-fiók adatait
```
