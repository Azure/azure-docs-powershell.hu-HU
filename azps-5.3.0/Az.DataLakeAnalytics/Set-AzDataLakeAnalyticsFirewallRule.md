...
## LEÍRÁS
A **Set-AzDataLakeAnalyticsFirewallRule** parancsmag frissíti a tűzfalszabályt egy Azure Data Lake Analytics-fiókban.

## PÉLDÁK

### 1. példa: Tűzfalszabály frissítése
```
...
Ez a parancs frissíti a "ContosoAdlAcct" fiók tűzfalszabályát a következő új IP-tartományra: 127.0.0.1 - 127.0.0.10
