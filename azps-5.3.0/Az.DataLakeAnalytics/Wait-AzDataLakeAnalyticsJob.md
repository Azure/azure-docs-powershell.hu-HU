...
## LEÍRÁS
A **Wait-AzDataLakeAnalytics Job** parancsmag az Azure Data Lake Analytics-feladat befejezésére vár.
...
Az alábbi parancs megvárja, amíg a megadott azonosítójú feladat befejeződik.
...
### -JobId
Annak a feladatnak az azonosítóját adja meg, amelynek várnia kell.
...
### -TimeoutInSeconds
A várakozási műveletből való kilépésig várakozási másodpercek számát adja meg.
...
Adja meg a feladatállapot egyes ellenőrzései között eltelt másodpercek számát.
