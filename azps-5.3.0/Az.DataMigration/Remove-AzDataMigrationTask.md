...
## LEÍRÁS
A Remove-AzDataMigrationTask parancsmag eltávolítja az Azure Adatbázis-áttelepítési szolgáltatás egyik feladatát az Azure-ból.
...
Az előző példa eltávolít egy TestTask nevű Azure-adatbázis-áttelepítési szolgáltatást az Azure-ból a feladatnév paramétere alapján.
...
Az előző példa eltávolít egy, a PSProjectTask objektumon alapuló Azure Database Migration Service-feladatot.
