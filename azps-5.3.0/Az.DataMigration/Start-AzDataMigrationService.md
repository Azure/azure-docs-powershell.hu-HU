...
## LEÍRÁS
A Start-AzDataMigrationService parancsmag leállítva elindítja az Azure Adatbázis-áttelepítési szolgáltatás egy példányát. 
...
A fenti példa elindít egy Tesztszolgáltatás nevű Azure Database Migration Service-példányt a szolgáltatás neve alapján bemenetként átadott szolgáltatásnév alapján.
...
A fenti példa elindít egy Azure Database Migration Service példányt a BEMENETI paraméterként átadott PSDataMigrationService alapján.
