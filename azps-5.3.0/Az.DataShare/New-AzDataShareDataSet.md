...
## LEÍRÁS
A **New-AzDataShareDataSet** parancsmag adatkészleteket ad hozzá az adatmegosztási fiók Azure-adatmegosztásához. Hozzáadhat blob, ADLS Gen2 és ADLS Gen1 adattípusú adatkészleteket.
...
Ez a parancs hozzáad egy AdsDataSet nevű, típus blobtárolót tartalmazó adatkészletet az Azure-beli adatokat tároló AdsShare szolgáltatáshoz.
...
### -AdlsGen1FolderPath
Azure Storage ADLS gen1 mappa elérési útja
...
### -FileName
Azure storage ADLS gen1 fájlnév
...
Azure-tárfiók erőforrásazonosítója
