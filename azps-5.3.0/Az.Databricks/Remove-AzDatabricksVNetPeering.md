...
### 1. példa: Az adatkapcsolatok vnet-társviszonyának eltávolítása név szerint
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Ez a parancs eltávolítja az adatkapcsolatok név alapján való társviszonyát.

### 2. példa: Az adatkapcsolatok vnet-társviszonyának eltávolítása objektum szerint
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Ez a parancs eltávolítja az adatkapcsolatok vnet-társviszonyát objektum szerint
...
### Microsoft.Azure.PowerShell.Cmdlets.Databfüzets.Models.IDatabszolgáltatásokatsIdentity
