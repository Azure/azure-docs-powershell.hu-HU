...
Ez a parancs egy dedikált HSM-et hoz létre egy meglévő virtuális hálózatban.

**MEGJEGYZÉS:** Jelenleg van egy korlátozás, amely a HSM azure-on való teljes kiépítése előtt `New-AzDedicatedHsm` tér vissza.
...
Ennek létrehozásáról az NETWORKINTERFACE tulajdonságokat és egy hash táblázatot hoz létre a NOTES (JEGYZETEK) című szakaszban található.
