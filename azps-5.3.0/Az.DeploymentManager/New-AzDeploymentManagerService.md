...
## LEÍRÁS
A **New-AzDeploymentManagerService parancsmag** szolgáltatás-topológia alapján hoz létre egy szolgáltatást, és visszaadja az adott szolgáltatást képviselő objektumot.
Adja meg a szolgáltatást a neve, a szolgáltatás topológiája és az erőforráscsoport neve alapján. 

A parancsmag szolgáltatásobjektumot ad vissza. Ezt az objektumot helyben módosíthatja, majd a Set-AzDeploymentManagerService alkalmazhatja a szolgáltatásra.
...
Létrehozza a ContosoService1 nevű új szolgáltatást a ContosoServiceTopology szolgáltatás topológiája alatt a ContosoResourceGroup erőforráscsoportban, az Egyesült Államok középső területén. A TargetLocation tulajdonság azt jelzi, hogy a ContosoService1 szolgáltatást a megadott előfizetésben az Egyesült Államok keleti régiójában kell telepíteni.
...
### -ServiceTopologyName
Annak a szolgáltatás topológiának a neve, amelyhez a szolgáltatás tartozik.
...
### -TargetLocation
Meghatározza azt a helyet, ahol a szolgáltatásban található erőforrások telepítve lesznek.
...
Meghatározza, hogy a szolgáltatás mely erőforrásokra legyen telepítve.
