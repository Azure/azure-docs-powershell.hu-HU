...
### 1. példa: Windows Virtual Desktop ApplicationGroup név alapján
```powershell
...
Ez a parancs egy Windows virtuális asztali alkalmazáscsoportot kap egy erőforráscsoportban.

### 2. példa: A Windows virtuális asztali alkalmazáscsoportjainak listája
```powershell
...
Ez a parancs felsorolja egy erőforráscsoport Windows virtuális asztali alkalmazáscsoportját.
...
A szűrés érvényes tulajdonságai az applicationGroupType.
