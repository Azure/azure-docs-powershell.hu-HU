...
### 1. példa: Windows virtuális asztali felhasználóhoz jut név szerint
```powershell
...
Ez a parancs egy Windows virtuális asztali felhasználóSession-t kap egy munkamenetgazdában.

### 2. példa: A Windows virtuális asztali felhasználói felületének felsorolása
```powershell
...
Ez a parancs felsorolja a Windows virtuális asztali felhasználófelhasználói munkamenetgazda egy munkamenetgazdáit.

### 3. példa: A Windows virtuális asztal felhasználóinak listájának megjelenítése az állomáskészletben
```powershell
...
Ez a parancs felsorolja egy windowsos virtuális asztali felhasználó-összetűnések listáját egy gazdakészlet munkamenetgazdáiban.
...
A szűrés érvényes tulajdonságai a userprincipalname és a sessionstate.
...
### -Id
A megadott munkamenetgazda felhasználói munkamenetének neve
