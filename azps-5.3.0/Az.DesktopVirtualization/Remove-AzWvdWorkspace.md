...
### 1. példa: Windows virtuális asztali munkaterület törlése név szerint
```powershell
PS C:\> Remove-AzWvdWorkspace -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Ez a parancs törli a Windows virtuális asztal-munkaterületét egy erőforráscsoportban.
