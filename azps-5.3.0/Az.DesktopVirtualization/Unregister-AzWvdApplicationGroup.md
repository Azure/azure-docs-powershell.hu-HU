...
### 1. példa: Windows virtuális asztali alkalmazáscsoport regisztrációjának a regisztrációjának a
```powershell
...
Ez a parancs a Windows virtuális asztali alkalmazáscsoport munkaterületre való regisztrációját nem regisztrálja.

## PARAMETERS

### -ApplicationGroupPath
ResourceGroupName Elérési út
