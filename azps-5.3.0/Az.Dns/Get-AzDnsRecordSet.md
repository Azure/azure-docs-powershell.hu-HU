...
### 1. példa: Rekordkészletek lekérte a megadott nevet és típust
```
...
Mivel a *Name és* *a RecordType* paraméter meg van adva, csak egy **RecordSet-objektumot** ad vissza.
...
### -Name
A lekért **Rekordkészlet** nevét adja meg.
...
- SOA
- SRV
- TXT Ha nem adja meg a *RecordType* paramétert, a Name paramétert is ki kell *mellőznie.* Ez a parancsmag a zóna összes rekordkészletét visszaadja (az összes névből és típusból).
