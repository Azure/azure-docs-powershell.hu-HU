...
## LEÍRÁS
Eltávolítja az Azure Event Grid esemény-előfizetését egy Azure Event Grid-témakör, erőforrás, Azure-előfizetés vagy erőforráscsoport esetén.
...
Eltávolítja az esemény-előfizetés \` EventSubscription1-et \` egy Azure Event Grid \` topic1 témakörbe a \` \` MyResourceGroupName \` erőforráscsoportban.
...
Eltávolítja az esemény-előfizetés \` EventSubscription1-et \` egy \` MyResourceGroupName \` erőforráscsoporthoz.
...
Eltávolítja az esemény-előfizetés \` EventSubscription1-et \` az alapértelmezett Azure-előfizetésből.
...
Eltávolítja az esemény-előfizetés \` EventSubscription1-et \` az Eseményközpont névteréből.
...
Eltávolítja az esemény-előfizetés \` EventSubscription1-et \` egy eseményrácstémára.
...
Az eltávolítható esemény-előfizetés neve.
...
### -PassThru
Az Eltávolítás művelet állapotát adja eredményül. Ez a parancsmag alapértelmezés szerint nem hoz létre kimenetet.
...
### -ResourceId
Annak az erőforrásnak az azonosítója, amelynek az esemény-előfizetését el kell távolítani.
