...
Létrehoz egy engedélyezési szabályt, amely a MyAuthRuleName engedélyt adja a \` \` \` \` \` \` \` MyResourceGroupName \` nevű erőforráscsoporttal az Eseményközpont MyEventHubName nevű eseményközpontja számára a MyNamespaceName névterében.
