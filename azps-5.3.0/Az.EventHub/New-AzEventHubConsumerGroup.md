...
Létrehozza a \` MyConsumerGroupName fogyasztói csoportot az Event Hub MyEventHubName nevű, a \` \` \` MyNamespaceName névterére terjed ki, a \` \` \` MyResourceGroupName \` erőforráscsoporttal.
...
### -UserMetadata
Felhasználói metaadatok a ConsumerGroup szolgáltatáshoz
