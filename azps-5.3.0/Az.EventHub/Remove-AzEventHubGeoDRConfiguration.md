...
## LEÍRÁS
A **Remove-AzEventHubGeoDRConfiguration** parancsmag töröl egy aliast(Katasztrófa-helyreállítás konfiguráció)
...
Egy alias törlése (katasztrófa-helyreállítási konfiguráció)
