...
### ByFieldsWithBackendPoolsSettingParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **New-AzFrontDoor** parancsmag létrehoz egy új Azure Front Door terheléselegyenlőt a megadott erőforráscsoportban az aktuális előfizetés alatt

## PÉLDÁK

### 1. példa: A megadott paraméterek alapján hozzon létre egy front door-t.
```powershell
...
Hozzon létre egy előtéti adát a megadott paraméterek alapján.

## PARAMETERS

### -BackendPool
Az útválasztási szabályhoz rendelkezésre álló háttér-várólista.
...
### -EnabledState
A Front Door terheléselosztási eszköz EnabledState szolgáltatása.
...
### -ResourceGroupName
Az erőforráscsoport neve, amelybe a front door nevet fogja létrehozni.
