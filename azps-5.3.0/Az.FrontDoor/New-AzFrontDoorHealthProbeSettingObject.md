...
### -EnabledState
Engedélyezi-e, hogy a backendPools szolgáltatásban definiált háttértörlelőkre vonatkozó állapotszokásokat ad-e a rendszer. Az állapotok csak akkor tilthatók le, ha egy engedélyezett háttérkészletben egyetlen engedélyezett háttérkészlet található.
...
### -HealthProbeMethod
Azt adja meg, hogy melyik HTTP-módszert használja a BackendPools csoportban definiált háttér-nek.
...
### -Path
Az egészségügyi problémákhoz használt elérési út.
...
### -Protocol
Protokollrendszer ehhez az alapértelmezett beállításhoz: HTTP
