...
A frissíthető előtér-ajtó azonosítható a FrontoorName és ResourceGroupName, a PSFrontDoor objektum vagy a ResourceId segítségével. (Lásd például a fenti 3 példát) Az alábbi példa a PSFrontDoor objektumot használja.
...
### -EnabledState
A Front Door terheléselosztási rendszerének működési állapota.
