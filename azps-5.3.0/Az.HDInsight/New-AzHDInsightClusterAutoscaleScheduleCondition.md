...
## LEÍRÁS
A **New-AzHDInsightClusterAutoscaleScheduleCondition** parancsmag ütemezés-alapú automatikus skálázási feltételt hoz létre.
...
Ez a parancs olyan feltételt hoz létre, amely esetén a fürt automatikus méretezése 5 munkavégző csomópontra 9:00-kor, minden hétfőn, szerdán.

### 2. példa: Az automatikus skálázási feltételt is megszabaduló fürt automatikus skálázásának engedélyezése.
```powershell
...
### -Day
Beállítja vagy beállítja az automatikus méretezés ütemezési feltételének napjait.
...
### -Time
Beállítja vagy beállítja az automatikus méretezés ütemezési feltételének idejét.
...
### -WorkerNodeCount
Beállítja vagy beállítja az automatikus beosztás ütemezési feltételének ütemezési számát a munkabeosztáshoz.
