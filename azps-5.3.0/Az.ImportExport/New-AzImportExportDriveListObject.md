...
### 1. példa: Új DriveList létrehozása az ImportExport feladathoz
```powershell
...
Ezek a parancsmagok új DriveList-et hoznak létre az ImportExport feladathoz.
...
### -BytesSucceed
A meghajtóhoz bájtok átvitele sikerült.
...
### -CopyStatus
Az adatátviteli folyamat részletes állapota.
Ez a mező mindaddig nem ad vissza a válaszban, amíg a meghajtó átvitt állapotba nem áll.
...
### -DriveHeaderHash
A meghajtófejléc kivonatának értéke.
...
### -ErrorLogUri
Egy URI, amely az adatátviteli művelet hibanaplóját tartalmazó blobra mutat.
...
### -ManifestFile
A jegyzékfájl relatív elérési útja a meghajtón.
...
### -ManifestHash
A meghajtón található jegyzékfájl Base16 kódolású MD5-kivonata.
...
### -ManifestUri
A meghajtó jegyzékfájlját tartalmazó blobra mutató URI.
...
### -PercentComplete
A meghajtóra vonatkozó százalékos érték.
...
### -VerboseLogUri
Egy URI, amely az adatátviteli művelet részletes naplóját tartalmazó blobra mutat.
