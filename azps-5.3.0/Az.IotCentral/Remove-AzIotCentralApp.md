...
## SYNOPSIS
Egy központi IoT-alkalmazást töröl.
...
## LEÍRÁS
Töröl egy meglévő központi IoT-alkalmazást.

## PÉLDÁK

### 1. példa a törlésre és a központi IoT-alkalmazásra
```powershell
PS C:\> Remove-AzIotCentralApp -ResourceGroupName "MyResourceGroupName" -Name "MyAppResourceName"
```

A megadott Központi IoT-alkalmazás törlése.
