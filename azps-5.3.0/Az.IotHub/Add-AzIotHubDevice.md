...
Hozzon létre egy IoT-eszközt a legfelső szintű hitelesítésszolgáltatói hitelesítésszolgáltatóval letiltott állapottal és okból kifolyólag.
...
### -Gyermekek
A gyermekeszköz-lista (vesszővel elválasztva) hozzáadása csak a nem edge-hez használható eszközöket tartalmazza.
