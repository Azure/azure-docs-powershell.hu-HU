...
## LEÍRÁS
Hozzon létre egy modult egy másik engedélyezési típussal egy IoT-központban egy céleszközön.
...
Hozzon létre egy modult egy alapértelmezett engedélyezési eszközzel (megosztott privát kulcs).
...
### -PrimaryThumbprint
Az elsődleges kulcshoz használható explicit öna aláírt tanúsítvány thumbprint.
