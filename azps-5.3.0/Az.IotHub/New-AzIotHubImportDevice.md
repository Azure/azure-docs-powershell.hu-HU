...
## LEÍRÁS
Új importálási eszköz feladatot hoz létre az IotHubhoz.
Ezzel az összes eszközt importálja az IotHubra a megadott tárolóból. Az SAS URI létrehozásáról az alábbi cikkben olvashat.
...
Létrehoz egy új importálási eszközkérést az IotHub "myiothub" számára.
...
Az Uri, amelybe a kimenetet írni kell. 
