...
## LEÍRÁS
Eltávolít egy IotHub-kulcsot.
Ha több, azonos nevű kulcs van, a lista első elemét eltávolítja a program.

## PÉLDÁK

### 1. példa: IotHub törlése
```
PS C:\> Remove-AzIotHubKey -ResourceGroupName "myresourcegroup" -Name "myiothub" -KeyName "iothubowner1"
```

Eltávolítja az iothubowner1 nevű kulcsot a myiothub nevű IotHubból.
