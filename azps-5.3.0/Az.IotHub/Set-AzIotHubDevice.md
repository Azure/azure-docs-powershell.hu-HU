...
### ResourceSetForStatus (alapértelmezett)
```
...
Kapcsolja be az edge-funkciókat az eszközhöz.
...
Frissítse egy Iot Hub-eszköz engedélyezési típusát.
