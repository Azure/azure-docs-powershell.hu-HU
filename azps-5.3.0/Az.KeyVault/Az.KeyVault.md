...
A kulcstárban tárolt kulcs biztonsági gombja.

### [Backup-AzKeyVaultManagedStorageAccount](Backup-AzKeyVaultManagedStorageAccount.md)
A KeyVault által felügyelt tárfiók biztonsági létrehozása.
...
Felügyelt HSM szerepkör-hozzárendelések lekérte vagy listába sorolja azokat. A megfelelő paramétereket használva listába sorolja egy adott felhasználó hozzárendelését vagy egy szerepkördefiníciót.
...
Frissíti egy kulcs attribútumát egy kulcstárban.
