...
## LEÍRÁS
A felügyelt HSM-ről teljes biztonsági mentést kell készítenie egy tárfiókba.
Segítségével `Restore-AzKeyVault` visszaállíthatja a biztonsági másolatot.
...
A parancsmag létrehoz egy mappát (általában névvel) a tárolóban, a biztonsági másolatot abban a mappában tárolja, és kimenetként hozza létre a mappa `mhsm-{name}-{timestamp}` URI-ját.
...
### -StorageContainerUri
Annak a tárolónak az URI-ja, amely a biztonsági mentést fogja tárolni.
