...
### VaultAndCertName (alapértelmezett)
```
...
## LEÍRÁS
A **Get-AzKeyVaultCertificatePolicy** parancsmag egy azure-kulcstároló kulcstárában található tanúsítványra vonatkozó házirendet kapja meg.

## PÉLDÁK

### 1. példa: Tanúsítvány-házirend lekérve
```powershell
...
Ez a parancs a ContosoKV01 kulcstárolóban bekéri a TestCert01 tanúsítványházirata-t.
...
### -Name
Egy tanúsítvány nevét adja meg.
