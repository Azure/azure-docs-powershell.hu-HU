...
## LEÍRÁS
Az **Undo-AzKeyVaultManagedStorageSasDefinitionRemoval** parancs helyreállít egy korábban törölt felügyelt tár SAS-definíciót, feltéve hogy a helyreállítható törlés engedélyezve van ehhez a tárolóhoz, és hogy a helyreállítás a helyreállítási időszak során történik.
...
Ez a parancssorozat határozza meg, hogy a megadott tárTERÜLET SAS-definíciója létezik-e a tárolóban törölt állapotban; az ezt követő parancs helyreállítja a törölt sas-definíciót, és visszaállítja azt egy aktív állapotba.

## PARAMETERS

### -AccountName
KeyVault-felügyelt tárfiók neve.
A parancsmag egy felügyelt tár SAS-definíciójának teljes tartománynevét építi fel a tárolónévből, a jelenleg kijelölt környezetből és a felügyelt tárfiók nevéből.
...
### -InputObject
Törölt felügyelt tárTERÜLET SAS-definíciós objektuma
...
### -Name
A KeyVault által felügyelt tárTERÜLET SAS-definíciójának neve.
A parancsmag a cél teljes tartománynevét a tároló neve, az aktuálisan kijelölt környezet, a felügyelt tárfiók neve és az SAS-definíció neve alapján építi fel.
