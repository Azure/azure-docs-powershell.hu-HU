...
## LEÍRÁS
Az **Undo-AzKeyVaultRemoval** parancsmag helyreállít egy korábban törölt kulcstárat. A helyreállított tároló a helyreállítás után aktív lesz
...
Ez a parancs egy aktív és használható állapotba visszaállítja a korábban az eastus2 régióból és a MyResourceGroup erőforráscsoportból törölt MyKeyVault kulcstárat. A címkéket új címkére is cseréli.
...
### -Location
A törölt tároló eredeti Azure-régióját adja meg.
