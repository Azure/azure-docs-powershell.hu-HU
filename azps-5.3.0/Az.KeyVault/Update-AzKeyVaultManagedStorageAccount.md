...
Frissíti a kulcstároló felügyelt Azure Storage Account aktív kulcsát "key2" kulcsra. A frissítés után a "key2" lesz használatos AZ SAS-tokenek generáltatása során.
...
### -AutoRegenerateKey
A kulcs automatikus újragenerálása.
...
### -PassThru
A parancsmag alapértelmezés szerint nem ad vissza objektumot. Ha ez a kapcsoló meg van adva, akkor a felügyelt tárfiók-objektum visszaadása
...
### -ÉsPeriod
Időtartam. Ha engedélyezve van az automatikus újragenerálás kulcs, ez az érték azt adja meg, hogy a felügyelt tárfiók inaktív kulcsának időkora után a rendszer automatikusan újragenerálja a kulcsot, és aktív kulcssá válik. Ha nincs megadva, a felügyelt tárfiók kulcskulcsának meglévő értéke változatlan marad
