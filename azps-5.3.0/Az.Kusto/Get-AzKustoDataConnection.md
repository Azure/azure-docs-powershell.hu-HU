...
### 1. példa: Egy adott adatbázis összes adatkapcsolatának felsorolása
```powershell
...
A fenti parancs visszaadja a "testrg" erőforráscsoportban található "testnewkustocluster" fürt összes Kusto-adatbázisát.

### 2. példa: Adott adatkapcsolat létrehozása név szerint
```powershell
...
A fenti parancs a "testrg" erőforráscsoportban található meglévő "testnewkustocluster" "mykustodatabase" nevű adatbázis "mykustodatabase" nevű adatkapcsolatát adja vissza.
