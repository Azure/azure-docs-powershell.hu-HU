...
### 1. példa: Az adott Kusto-fürt és adatbázis adatbázis-kezelőinek listája
```powershell
...
A fenti parancs az adott Kusto-fürt és adatbázis adatbázis-kezelőinek listáját adja vissza.
