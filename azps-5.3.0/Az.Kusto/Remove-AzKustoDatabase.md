...
### 1. példa: Meglévő Kusto-adatbázis törlése név szerint
```powershell
PS C:\> Remove-AzKustoDatabase -ResourceGroupName testrg -ClusterName testnewkustocluster -Name mykustodatabase
```

A fenti parancs törli a "mykustodatabase" nevű Kusto-adatbázist a "testnewkustocluster" nevű fürtben, amely a "testrg" erőforráscsoportban található.
