...
### 1. példa: A használt fürt egyszerű hozzárendelési nevének elérhetőségének ellenőrzése
```powershell
...
A fenti parancs azt adja vissza, hogy létezik-e "myprincipal" nevű PrincipalAssignment a "testnewkustocluster" fürtben.

### 2. példa: A nem használt egyszerű hozzárendelési név elérhetőségének ellenőrzése
```powershell
...
A fenti parancs azt adja vissza, hogy létezik-e "newprincipal" nevű PrincipalAssignment a "testnewkustocluster" fürtben.
