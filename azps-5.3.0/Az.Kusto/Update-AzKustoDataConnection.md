...
### 1. példa: Meglévő EventHub-adatkapcsolat frissítése
```powershell
...
A fenti parancs frissíti a "mykustodatabase" adatbázis "mykventhubdc" nevű meglévő EventHub-adatkapcsolatát a "testnewkustocluster" fürtben.
...
A fenti parancs frissíti a "mykustodatabase" adatbázis "mykventgriddc" nevű Meglévő EventGrid-adatkapcsolatát a "testnewkustocluster" fürtben.
...
A fenti parancs frissíti a "mykustodatabase" adatbázis "mykustodatabase" nevű meglévő IotHub-adatkapcsolatát a "testnewkustocluster" fürtben.

### 4. példa: Meglévő EventHub-adatkapcsolat frissítése identitáson keresztül
```powershell
...
### 5. példa: Meglévő EventGrid-adatkapcsolat frissítése identitáson keresztül
```powershell
...
### 6. példa: Meglévő IotHub-adatkapcsolat frissítése identitáson keresztül
```powershell
...
### -IgnoreFirstRecord
Ha igaz érték van beállítva, az azt jelenti, hogy a be nem figyelmének minden fájl első rekordját figyelmen kívül kell hagynia.
