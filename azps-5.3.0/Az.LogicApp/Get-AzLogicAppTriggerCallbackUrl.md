...
## LEÍRÁS
A **Get-Az LogicAppTriggerCallbackUrl** parancsmag egy Logic App eseményindító URL-címét kapja egy erőforráscsoporttól.
Ez a parancsmag egy **WorkflowTriggerCallbackUrl** objektumot ad vissza, amely a visszahívási URL-címet képviseli.
Adja meg az erőforráscsoport nevét, a logikai alkalmazás nevét és az eseményindító nevét.
...
### 1. példa: Logikai alkalmazás eseményindítójának url-címe
```
...
Ez a parancs a Logic App eseményindítójának visszahívási URL-címét kapja.
...
### -TriggerName
Egy eseményindító nevét adja meg.
