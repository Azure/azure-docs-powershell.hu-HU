...
## LEÍRÁS
A **New-AzIntegrationAccountCertificate parancsmag** létrehoz egy integrációs fiók tanúsítványát.
Ez a parancsmag egy olyan objektumot ad vissza, amely az integrációs fiók tanúsítványát képviseli.
Adja meg az integrációs fiók nevét, az erőforráscsoport nevét, a tanúsítvány nevét, a kulcs nevét, a kulcsverziót és a kulcstároló azonosítóját.
...
### 1. példa: Integrációs fiók tanúsítványának létrehozása
```
...
Ez a parancs létrehozza az integrációs fiók tanúsítványát a megadott erőforráscsoportban.

## PARAMETERS

### -CertificateName
Megadja az integrációs fiók tanúsítványának nevét.
...
### -KeyName
A kulcstárolóban a tanúsítványkulcs nevét adja meg.
...
### -KeyVaultId
Egy kulcs tárolóazonosítót ad meg.
...
### -KeyVersion
A kulcstárolóban a tanúsítványkulcs verzióját határozza meg.
...
Egy nyilvános tanúsítványfájl (.cer) elérési útját adja meg.
