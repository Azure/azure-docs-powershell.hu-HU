...
## LEÍRÁS
Erőforrás karbantartási konfigurációjának regisztrálása
...
Karbantartási konfiguráció regisztrálása dedikált állomáshoz.
...
A konfiguráció-hozzárendelés nevének meg kell egyeznie a MaintenanceConfigurationName tulajdonságnévvel.
...
### -Location
Az erőforrás szóközök nélküli helye.
...
A teljesen minősített MaintenanceConfiguration.
