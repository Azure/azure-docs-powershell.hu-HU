...
## SYNOPSIS
Létrehoz egy új felhasználóhoz rendelt identitást, vagy frissíti a meglévő felhasználóhoz rendelt identitást.
...
## LEÍRÁS
A **New-AzUserAssignedIdentity** parancsmag létrehoz egy új felhasználóhoz rendelt identitást. Ha egy már meglévő identitással használja, frissítette az identitást.
Ha Azure Resource Manager-címkéket szeretne hozzáadni az identitáshoz, használja a Set-AzResource parancsmagot.

## PÉLDÁK

### 1. példa
Ez a példa parancsmag létrehoz egy  új felhasználóhoz rendelt identitást a PSRG erőforráscsoport **PSRG** csoportjában, az Erőforráscsoport helyén.
...
### 2. példa
Ez a példa parancsmag létrehoz egy  új felhasználóhoz rendelt identitást, amely a PSRG erőforráscsoport alatt a **PSRG** nevű erőforráscsoportban található a westus régióban.
...
### -Location
Az Azure-régió neve, ahol az identitást létre kell létrehozni.
...
### -Tag
Az identitáshoz társított Azure Resource Manager-címkék.
