...
Eltávolítja a név szerinti regisztrációdefiníciót az alapértelmezett hatókörben.
...
Törli a bemeneti objektumhoz megadott regisztrációs definíciót.
...
### -InputObject
A regisztrációs definíciós objektum.
