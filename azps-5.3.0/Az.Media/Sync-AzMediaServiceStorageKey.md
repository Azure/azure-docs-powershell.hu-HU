...
### 1. példa: Az adathordozó-szolgáltatással társított tárfiók kulcsának szinkronizálása
```
...
Az első parancs a Get-AzStorageAccount parancsmag segítségével lekérte a Storage135 nevű tárfiókot, amely az ResourceGroup001-hez tartozik, és az eredményt a $StorageAccount.
