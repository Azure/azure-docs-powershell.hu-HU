...
## LEÍRÁS
V2 **-es (nem klasszikus) metrikus alapú riasztási** szabályt ad hozzá vagy frissíti. A hozzáadott szabály egy erőforráscsoporthoz van társítva, és neve is van. Ez a parancsmag implementálja a ShouldProcess mintát, azaz megerősítést kérhet a felhasználótól, mielőtt ténylegesen létrehozza, módosítja vagy eltávolítja az erőforrást.

## PÉLDÁK

### 1. példa: Metrikus riasztási szabály hozzáadása virtuális géphez
...
Ez a parancs metrikus riasztási szabályt hoz létre egy virtuális géphez. $condition a [New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2criteria) parancsmag kimenete, a $act pedig a [New-AzActionGroup](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azactiongroup) parancsmag kimenete.

### 2. példa: Metrikus riasztási szabály hozzáadása egy előfizetés összes virtuális gépéhez
```powershell
...
Ez a parancs metrikus riasztási szabályt hoz létre az előfizetés összes, eastusban lévő virtuális gépéhez

### 3. példa: Metrikus riasztási szabály letiltása
```powershell
...
Ez a parancs letiltja a metrikus riasztási szabályt. A [Get-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/get-azmetricalertrulev2) kimenetét az [Add-AzMetricAlertRuleV2-re](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) szeretnénk kivezetni. 

### 4. példa: Metrikus riasztási szabály hozzáadása dimenziókkal
...
A parancsmagok fölött metrikus riasztási szabályt hozhat létre dimenziókkal.
...
### -Leírás
A metrikus riasztási szabály leírása
...
### -DisableRule
A szabály (állapot) letiltására vonatkozó jelölő
...
### -Súlyosság
A metrikus riasztási szabály súlyossága
