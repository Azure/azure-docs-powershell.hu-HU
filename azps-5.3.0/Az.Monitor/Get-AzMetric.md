...
## LEÍRÁS
A **Get-AzMetric** parancsmag egy adott erőforrás metrikus értékeit kapja.
...
### 3. példa: Részletes kimenet egy adott mutatóhoz
```
...
### 4. példa: Adott dimenziószűrővel megadott metrika összesített kimenete
```
