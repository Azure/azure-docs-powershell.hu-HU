...
## LEÍRÁS
A **Get-AzMetricDefinition** parancsmag metrikus definíciókat kap.

## PÉLDÁK

### 1. példa: Metrikus definíciók lekérte egy erőforráshoz
```
...
Ez a parancs a megadott erőforrás metrikákat definiáló definícióit kapja meg.

### 2. példa: Metrikus definíciók lekérte részletes kimenettel
```
...
Ez a parancs a webhely2 metrikus definícióit kapja meg.
A kimenet részletes.

### 3. példa: Metrikadefiníciók lekérte név szerint
```
...
Ez a parancs definíciókat kap a Bájt és a CpuTime metrikákhoz.
A kimenet részletes.
...
### -DetailedOutput
Azt jelzi, hogy a művelet részletes kimenetet tartalmazott.
Ha nem adja meg ezt a paramétert, a kimenet összegzi a kimenetet.
...
### -MetricNamespace
Meghatározza a metrikus névteret, amelynél lekérdezi a metrikák definícióit.
...
### -ResourceId
Az erőforrásazonosítót adja meg.
