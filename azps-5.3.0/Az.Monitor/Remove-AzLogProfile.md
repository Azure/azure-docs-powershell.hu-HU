...
## LEÍRÁS
A **Remove-AzLogProfile** parancsmag eltávolítja a naplóprofilokat.
...
Eltávolít egy naplóprofilt. (automatikusan generált)
...
### -Name
Az eltávolítható naplóprofil nevét adja meg.
