...
## LEÍRÁS
A **Get-AzNetAppFilesSnapshot** parancsmag egy ANF-pillanatfelvétel részleteit tartalmazza.

## PÉLDÁK

### 1. példa: ANF-pillanatkép készítése
```
...
Ez a parancs a MyAnfSnapshot nevű pillanatképet a MyAnfVolume kötetből kapja meg.
...
### -ResourceId
Az ANF-pillanatfelvétel erőforrás-azonosítója
...
### -VolumeObject
A visszaadott pillanatképet tartalmazó kötetobjektum
