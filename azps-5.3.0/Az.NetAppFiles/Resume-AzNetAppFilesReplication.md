...
## LEÍRÁS
A kapcsolat folytatása/újraszinkronizációja a célköteten
...
Ez a parancs folytatja az ANF-replikációs kapcsolatot a "MyDestinationAnfVolume" köteten.

## PARAMETERS

### -AccountName
A replikációs kötet ANF-fiókjának neve
...
### -InputObject
Az anf replikációs célkötetobjektum újraszinkronizációja
...
### -Name
Az ANF-replikációs célkötet neve
...
### -PassThru
Visszaadja, hogy a megadott replikációs kötet újraszinkronizációja történt-e
...
### -PoolName
A replikációs kötet ANF-készletének neve
...
### -ResourceGroupName
Az ANF-replikációs célkötet erőforráscsoportja
...
### -ResourceId
Az ANF-replikációs célkötet erőforrás-azonosítója
