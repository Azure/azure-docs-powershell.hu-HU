...
Ez a parancs felfüggeszti az ANF-replikációs kapcsolatot a "MyDestinationAnfVolume" köteten.
...
### -ForceBreak
Ha a replikáció állapota átvitele közben meg szeretné szakítani a replikációt, állítsa igazra.
...
### -InputObject
AnF-célkötet-objektum a tördendő replikációval
...
### -PassThru
Annak visszaadása, hogy történt-e a megadott mennyiségi replikációs törés
