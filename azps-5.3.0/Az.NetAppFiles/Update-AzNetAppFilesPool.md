...
## LEÍRÁS
Az **Update-AzNetAppFilesPool** parancsmag módosítja az ANF-készletet.

## PÉLDÁK

### 1. példa: ANF-készlet módosítása
```
...
Ez a parancs módosítja a "MyAnfPool" ANF készletet a megadott méretűre és QosType-típusra.
...
### -AccountObject
A frissítenie kell a készletet tartalmazó fiókobjektum
...
### -InputObject
Frissítend kell a készletobjektumot
...
### -QosType
A készlet qos típusa. Lehetséges értékek: "Automatikus", "Kézi"
