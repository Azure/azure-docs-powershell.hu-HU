...
## LEÍRÁS
Az **Add-AzApplicationGatewayCustomError** parancsmag egyéni hibát ad egy alkalmazás-átjáróhoz.

## PÉLDÁK

### 1. példa: Egyéni hiba hozzáadása az alkalmazás átjárószinthez
```powershell
...
Ez a parancs egyéni hibát ad az 502-es http állapotkódhoz az alkalmazás-átjáró $appgw, és visszaadja a frissített átjárót.

### 2. példa: Egyéni hiba hozzáadása az alkalmazás átjárót hallgatói szintjéhez
```powershell
...
Ez a parancs egyéni hibát ad hozzá az 502-es http állapotkódhoz az alkalmazás$appgw szinten, és visszaadja a frissített átjárót.
