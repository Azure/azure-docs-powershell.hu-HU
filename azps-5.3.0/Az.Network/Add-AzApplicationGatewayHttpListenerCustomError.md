...
## SYNOPSIS
Egyéni hibát ad hozzá egy alkalmazásátjáró http-hallgatója számára.
...
## LEÍRÁS
Az **Add-AzApplicationGatewayCustomError** parancsmag egyéni hibát ad hozzá egy alkalmazásátjáró http-hallgatója számára.
