...
## LEÍRÁS
Az **Add-AzApplicationGatewayTrustedRootCertificate** parancsmag hozzáad egy megbízható gyökértanúsítványt egy Azure-alkalmazás-átjáróhoz.
...
A második parancs egy új megbízható főtanúsítványt ad hozzá az alkalmazás-átjáróhoz, amely bemenetként a legfelső szintű tanúsítvány elérési útját használja.
A harmadik parancs új háttér-http-beállítást hoz létre megbízható gyökértanúsítvány használatával a háttérkiszolgálói tanúsítvány hitelesítéséhez.
A negyedik parancs frissíti az alkalmazás átjáróját.
...
### -CertificateFile
Tanúsítvány CER-fájl elérési útja
