...
Az első parancs leküldi a MyVnet nevű Azure virtuális hálózatot, és a folyamat segítségével átadja az eredményt a MySubnet nevű alhálózatnak a **Get-AzVirtualNetworkSubnetConfig** parancsmagnak.
A parancs ezután az eredményt a következő nevű változóban $Subnet.
A második parancs leküldi a MyLB nevű terheléselegyenítőt, és átadja az eredményt az **Add-AzLoadBalancerFrontendIpConfig** parancsmagnak, amely egy előtér-IP-konfigurációt ad a terheléseloszlálóhoz egy statikus privát IP-címmel az $Subnet nevű változóban tárolt alhálózatból.
...
A második parancs leküldi a MyLB nevű terheléselegyenítőt, és átadja az eredményt az **Add-AzLoadBalancerFrontendIpConfig** parancsmagnak, amely egy előlapi IP-konfigurációt ad a terheléselegyenlőnek, és a $PublicIp nevű változóban tárolt nyilvános IP-címet $PublicIp.
...
A második parancs leküldi a MyLB nevű terheléselegyenítőt, és átadja az eredményt az **Add-AzLoadBalancerFrontendIpConfig** parancsmagnak, amely hozzáad egy előtűnés IP-konfigurációt a terheléseloszlítóhoz, és a $PublicIpPrefix nevű változóban tárolt nyilvános IP-előtagot $PublicIpPrefix.
...
Ez a parancsmag előlapi IP-konfigurációt ad a paraméter által megadott terheléselosztási kiszolgálóhoz.
