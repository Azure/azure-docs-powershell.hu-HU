...
## LEÍRÁS
A **Get-AzApplicationGatewayPrivateLinkConfiguration** parancsmag az alkalmazás-átjárók privát csatolási konfigurációját kapja meg.
...
### 2. példa: A privát hivatkozáskonfiguráció listájának lekérte
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
