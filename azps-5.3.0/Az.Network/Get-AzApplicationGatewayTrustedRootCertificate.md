...
## LEÍRÁS
A **Get-AzApplicationGatewayTrustedRootCertificate** parancsmag megbízható gyökértanúsítványt kap az alkalmazás átjáróból egy adott néven.
...
A második parancs egy megadott nevű megbízható gyökértanúsítványt kap az alkalmazás átjáróból.
