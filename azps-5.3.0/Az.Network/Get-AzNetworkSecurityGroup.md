...
## LEÍRÁS
A **Get-AzNetworkSecurityGroup** parancsmag egy Azure-hálózati biztonsági csoportot kap.

## PÉLDÁK

### 1. példa: Meglévő hálózatbiztonsági csoport lekérése
```powershell
...
Ez a parancs az "rg1" erőforráscsoportban visszaadja az "nsg1" Azure-hálózat biztonsági csoportjának tartalmát.

### 2. példa: Meglévő hálózatbiztonsági csoportok felsorolása szűrés használatával
```powershell
...
Ez a parancs az "nsg" kezdetekkel kezdődik Azure-hálózatbiztonsági csoportok tartalmát adja vissza.
...
### -Name
Annak a hálózati biztonsági csoportnak a neve, amelybe ez a parancsmag kerül.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyhez a hálózati biztonsági csoport tartozik.
