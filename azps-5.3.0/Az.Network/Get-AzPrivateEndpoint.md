...
### 1. példa: Privát végpont lekérése
```powershell
...
Ez a parancs a MyPrivateEndpoint1 nevű privát végpontot a TestResourceGroup erőforráscsoportban kapja meg.

### 2. példa: Az összes magánjellegű végpont felsorolása az ResourceGroupban
```powershell
...
Ez a parancs a TestResourceGroup erőforráscsoport összes magánjellegű végpontja
