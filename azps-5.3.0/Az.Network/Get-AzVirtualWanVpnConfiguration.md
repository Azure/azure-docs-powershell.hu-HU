...
## SYNOPSIS
Vpn-konfigurációt kap a WAN-hoz a VpnConnections segítségével csatlakoztatott VpnS-webhelyek egy részkészletében. Feltölti a létrehozott Vpn-konfigurációt egy, az ügyfél által megadott tárterület-blobba.

## SZINTAXIS

### ByVirtualWanNameByVpnSiteObject (alapértelmezett)
```
...
A konfigurációt ezután ezzel a parancsmagal töltheti le.

Ha a parancsmag sikeres, akkor a letöltési konfigurációt az SignedSasUrl által jelzett blobba írja a rendszer.
...
### -InputObject
A módosítható VPN-webhelyobjektum
...
### -StorageSasUrl
A konfigurációt generáló tárolóhely SAS-url-címe.
...
### -VpnSite
A VpnSite-erőforrásazonosítók listája, amelyekhez konfigurációt kell létrehozni.
