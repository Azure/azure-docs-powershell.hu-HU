...
## LEÍRÁS
A **New-AzApplicationGatewayFirewallPolicyManagedRuleSet** létrehoz egy felügyelt szabályokat egy tűzfal-házirendhez.
...
Létrehoz egy ManagedRuleSetet a ruleSetType típussal $ruleSetType, ruleSetVersion as $ruleSetVersion és RuleGroupOverrides mint egy teljes listára ($ruleGroupOverride 1, $ruleGroupOverride 2) az új ManagedRuleSet hozzá van rendelve $managedRuleSet
...
### -RuleSetType
A RuleSetType megadása felügyeltRuleSetben
...
### -RuleSetVersion
A RuleSetVersion megadása felügyeltRuleSetben
