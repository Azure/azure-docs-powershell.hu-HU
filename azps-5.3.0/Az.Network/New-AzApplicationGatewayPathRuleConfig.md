...
A negyedik parancs létrehozza az elérésiút-szabályobjektumot, és egy $PathRuleConfig.
...
Egy meglévő háttércímkészlet azonosítója, amely hozzáadható az átjáró elérésiút-szabály konfigurációs beállításaihoz.
...
A HTTP-beállításokat a parancsmag használatával Get-AzApplicationGatewayBackendHttpSettings vissza.
...
### -FirewallPolicy
Az objektumhivatkozást egy legfelső szintű tűzfal-házirendre határozza meg. Az objektumhivatkozást egy parancsmag használatával New-AzApplicationGatewayWebApplicationFirewallPolicy létrehozni.
