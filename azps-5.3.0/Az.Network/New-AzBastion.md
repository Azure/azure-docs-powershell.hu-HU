...
## LEÍRÁS
Egy bastion erőforrást hoz létre. Ehhez szükség lesz egy nyilvános IP-címre és egy VirtualNetwork hálózatra. Ebben a VirtualNetworkben azureBastionSubnet nevű alhálózatnak kell lennie. A nemi ip-címet a Sku Standard szabványsal kell létrehozni.
...
### -PublicIpAddress
A bazsalika nyilvános IP-címobjektuma.
...
### -PublicIpAddressId
A nyilvános IP-cím, a bazsalika Azure-erőforrásazonosítója.
...
### -PublicIpAddressName
A nyilvános IP-cím erőforrásneve a bazsalika számára.
...
A nyilvános Ip-cím erőforráscsoport neve a bazsalika számára.
...
### -ResourceGroupName
Az erőforráscsoport neve, ahol létre kell hoznia a bástyát.
...
### -VirtualNetwork
A bazsalikom virtuális hálózati objektuma.
...
### -VirtualNetworkId
A virtuális hálózat Azure-erőforrásazonosítója a bazsalizációhoz.
...
### -VirtualNetworkName
A bazsalika virtuális hálózati erőforrásneve.
...
A virtuális hálózati erőforráscsoport neve a bástyához.
