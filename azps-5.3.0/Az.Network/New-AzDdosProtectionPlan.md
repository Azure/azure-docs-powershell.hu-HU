...
## LEÍRÁS
A New-AzDdosProtectionPlan parancsmag létrehoz egy DDoS védelmi tervet.

## PÉLDÁK

### 1. példa: DDoS védelmi terv létrehozása és társítása új virtuális hálózathoz
```
...
Először létrehozunk egy új DDoS Védelmi tervet a **New-AzDdosProtectionPlan paranccsal.**
Ezután létrehozunk egy új virtuális hálózatot a **New-AzVirtualNetwork** segítségével, és az újonnan létrehozott terv azonosítóját a **DdosProtectionPlanId** paraméterben adhatja meg. Ebben az esetben, mivel a virtuális hálózatot egy tervhez társítjuk, megadhatja az **EnableDdoSProtection paramétert is.**
...
Először létrehozunk egy új DDoS Védelmi tervet a **New-AzDdosProtectionPlan paranccsal.**
Másodikként a tervhez társítani kívánt virtuális hálózat legfrissebb verzióját tudjuk szerezni. Frissítjük a **DdosProtectionPlan** tulajdonságot egy **PSResourceId** objektummal, amely az újonnan létrehozott terv azonosítójára hivatkozik. Ebben az esetben, ha a virtuális hálózatot DDoS védelmi tervhez társítjuk, az **EnableDdosProtection** jelölőt is beállíthatjuk igazra.
Végül az új állapotot a helyi változó **Set-AzVirtualNetwork-be** való áttűnésének hatékonnyá történő áttűnésének megőrz használatával.
...
### -Location
Megadja a létrehozható DDoS védelmi terv helyét.
...
### -Name
A létrehozható DDoS védelmi terv nevét adja meg.
...
### -ResourceGroupName
A létrehozható DDoS védelmi terv erőforráscsoportját határozza meg.
