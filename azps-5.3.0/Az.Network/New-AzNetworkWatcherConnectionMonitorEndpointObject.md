...
## LEÍRÁS
New-AzNetworkWatcherConnectionMonitorEndpointObject parancsmag kapcsolatfigyelő végpontot hoz létre.
...
Név: workspaceEndpoint Type : MMAWorkspaceMachine ResourceId : /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace Address : Scope : { "Include": [ { "Address": "WIN-P0HGNDO2S1B" } ] }

## PARAMETERS

### -Address
A kapcsolatfigyelő végpont címe (IP vagy tartománynév).
...
### -CoverageLevel
Tesztelje a végpont lefedettségét.
A támogatott értékek: Default, Low, BelowAverage, Average, AboveAvergae, Full.
...
### -ExcludeItem
Azon elemek listája, amelyeket ki kell zárni a végpontok hatóköre alól.
...
### -IncludeItem
Azon elemek listája, amelyeket a végpontok hatókörében meg kell jelenni.
...
### -MMAWorkspaceMachine
MMA Workspace Machine végpont kapcsoló.
...
### -MMAWorkspaceNetwork
MMA Workspace Network végpont kapcsoló.
...
### -Name
A kapcsolatfigyelő végpont neve.
...
### -ResourceId
A kapcsolatfigyelő végpont erőforrás-azonosítója.
