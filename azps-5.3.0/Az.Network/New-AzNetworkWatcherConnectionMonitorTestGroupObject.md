...
## LEÍRÁS
A New-AzNetworkWatcherConnectionMonitorTestGroupObject parancsmag létrehoz egy kapcsolatfigyelő tesztcsoportot.

## PÉLDÁK

### 1. példa: Tesztcsoport létrehozása 2 testConfigurations, w source és 2 cél végponttal
...
### -Disable
Jelölő, amely jelzi, hogy a tesztcsoport le van-e tiltva.
...
### -Source
A forrás végpontjainak listája.
