...
Az útválasztási konfigurációhoz társított központi útválasztási tábla.
...
### -StaticRoute
Azon útvonalak listája, amelyek a VirtualHubról virtuális hálózati kapcsolatra irányítják az átirányítást.
