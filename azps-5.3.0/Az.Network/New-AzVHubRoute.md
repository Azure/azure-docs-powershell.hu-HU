...
## SYNOPSIS
Létrehoz egy VHubRoute-objektumot, amely paraméterként továbbkalmazható a New-AzVHubRouteTable parancsnak.
...
A fenti parancs létrehoz egy VHubRoute-objektumot, amelyben a következőHop lesz a megadott tűzfal, majd hozzáadható egy VHubRouteTable erőforráshoz.
...
A fenti parancs létrehoz egy VHubRoute-objektumot, amelyben a következőHop lesz a megadott hubVnetConnection, majd hozzáadható egy VHubRouteTable erőforráshoz.
...
```
A fenti parancsok beszerzik egy már meglévő AzVHubRoute RoutingConfiguration parancsát, majd hozzáadnak egy statikus útvonalat a kapcsolathoz. Másik lehetőségként, ha új kapcsolatot fog létrehozni a benne található statikus útvonalsal, kérjük, tekintse meg az [1. példát.](New-AzRoutingConfiguration.md)
## PARAMETERS
