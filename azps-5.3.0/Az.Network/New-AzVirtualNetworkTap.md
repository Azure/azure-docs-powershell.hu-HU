...
A VM-hez konfigurált összes forrás-koppintás erre a cél IP-címre + portra lesz irányítva.

### 2. példa: Virtuális Azure-hálózat létrehozása a LoadBalancer IP protokollal
```
# Create LoadBalancer
