...
## LEÍRÁS
Létrehoz egy új Azure VirtualWAN-erőforrást.
...
A fenti "testRG" erőforráscsoportot hoz létre a "Nyugat-Egyesült Államok" régióban, valamint egy Azure Virtuális WAN-t, amely ágat hoz létre az adott erőforráscsoportban az Azure-ban engedélyezett elágaztatási forgalomhoz.
