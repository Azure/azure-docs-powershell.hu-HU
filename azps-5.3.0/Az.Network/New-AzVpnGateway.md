...
New-AzVpnGateway létrehoz egy méretezhető VPN-átjárót. Ez a VirtualHubon belüli webhelykapcsolatok szoftverrel definiált kapcsolata. 

Ez az átjáró az ebben vagy a parancsmagban megadott méretarány alapján méretezi át Set-AzVpnGateway méretarányt. 

A kapcsolat egy VPNSite néven ismert ágból vagy webhelyről van beállítva a méretezhető átjáróval. Minden kapcsolat 2 különböző Active-Active része.
