...
### ByVirtualWanNameByVpnSiteIpAddress (alapértelmezett)
```
...
A fenti létrehoz egy "nonlinkSite" erőforráscsoportot az Azure-ban az Egyesült Államok keleti részén található Virtuális WAN erőforráscsoporttal. 

Ezután létrehoz egy VpnSite-t, amely egy ügyfélágat képvisel, és a virtuális WAN-hoz kapcsolódik.

Az IPSec-kapcsolatot ezután az e ágban és a VpnGatewayben is be lehet New-AzVpnConnection paranccsal.
...
A fentiekkel létrehoz egy erőforráscsoportot (Virtuális WAN és VpnSite, 1 VpnSiteLinks)az Egyesült Államok keleti részén, az Azure "multilink" erőforráscsoportban.

### 3. példa

Létrehoz egy új Azure VpnSite-erőforrást. (automatikusan generált)
...
### -BgpPeeringAddress
A VpnSite BGP-társviszony-címe.
...
### -BgpPeeringWeight
A VpnSite BGP-társviszony-létesítő súlya.
...
### -DeviceModel
A távoli VPN-eszköz eszközmodelle.
...
### -DeviceVendor
A távoli VPN-eszköz eszköz szállítója.
...
### -O365Policy
Az Office 365 forgalomtörési házirendje ehhez a VpnSite-hez.
...
### -VirtualWan
A VirtualWanhoz, a VpnSite-hez csatlakoztatni kell.
...
### -VirtualWanId
Ehhez a VpnSite-hez csatlakoztatni kell a ResourceId VirtualWant.
...
### -VirtualWanName
Annak a VirtualWannak a nevét, amelyhez a VpnSite-et csatlakoztatni kell.
...
Annak a VirtualWannak az erőforráscsoportnevét, amelyhez a VpnSite-et csatlakoztatni kell.
...
### -VpnSiteLink
A VpnSiteLinks listája, amelyek a VpnSite-webhelyhez vannak csatolva.
