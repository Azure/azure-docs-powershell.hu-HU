...
### -ConnectionBandwidth
Az a sávszélesség, amelyet ennek a kapcsolatnak mbps-ként kell kezelnie.
...
### -EnableBgp
A BGP engedélyezése ehhez a csatolási kapcsolathoz
...
### -IpSecPolicy
A csatolási kapcsolathoz figyelembe kell venni az IpSec-házirendet.
...
Használja a helyi Azure IP-címet forrás IP-címként ehhez a hivatkozáskapcsolathoz.
...
### -VpnSiteLink
A vpn-webhely hivatkozásobjektuma, amelyhez csatlakozni szeretne.
