...
## LEÍRÁS
A **Remove-AzApplicationGateway** parancsmag eltávolít egy alkalmazás-átjárót.

## PÉLDÁK

### 1. példa: Adott alkalmazás átjáró eltávolítása
```
PS C:\>Remove-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
```

Ez a parancs eltávolítja az ApplicationGateway01 nevű alkalmazás-átjárót az ResourceGroup01 nevű erőforráscsoportból.
...
### -Force
Azt jelzi, hogy a parancsmag az alkalmazás-átjáró törlését kényszeríti függetlenül attól, hogy erőforrások vannak-e hozzá rendelve.
...
### -Name
Az eltávolítható alkalmazás átjáró nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyhez az alkalmazás-átjáró tartozik.
