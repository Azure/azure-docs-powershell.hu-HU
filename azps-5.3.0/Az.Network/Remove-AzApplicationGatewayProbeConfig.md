...
### 1. példa: Állapot állapotának eltávolítása meglévő alkalmazás-átjáróból
```
PS C:\>$Gateway = Remove-AzApplicationGatewayProbeConfig -ApplicationGateway Gateway -Name "Probe04"
```

Ezzel a paranccsal eltávolítja az "1104" nevű állapotkezelő nevet az Átjáró nevű alkalmazás-átjáróból.
