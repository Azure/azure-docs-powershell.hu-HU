...
## LEÍRÁS
A **Remove-AzExpressRouteCircuitPeeringConfig** parancsmag eltávolítja az ExpressRoute-kapcsolat kapcsolati konfigurációját.

## PÉLDÁK

### 1. példa: Társviszony-konfiguráció eltávolítása ExpressRoute-áramkörből
```
