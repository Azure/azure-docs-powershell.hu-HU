...
## LEÍRÁS
A **Remove-AzNetworkProfile** parancsmag eltávolítja a hálózati profilt, ha nem jött létre tárolóhálózati felület (a tárolóhálózati felület konfigurációval ellentétben).
...
Ezzel eltávolítja a np1 nevű hálózati profilt az rg1 erőforráscsoportból.
...
### -Force
Ne kérjen megerősítést, ha erőforrást szeretne törölni
...
### -ResourceGroupName
A hálózati profil erőforráscsoportneve.
...
### -ResourceId
A hálózati profil Azure-erőforrás-kezelői erőforrásazonosítója.
