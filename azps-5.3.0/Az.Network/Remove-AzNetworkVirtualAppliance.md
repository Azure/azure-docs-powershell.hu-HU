...
## SYNOPSIS
Hálózati virtuális eszköz típusú erőforrás eltávolítása
...
## LEÍRÁS
A Remove-AzNetworkVirtualAppliance parancs eltávolítja a hálózati virtuális eszköz erőforrást.
...
Töröljön egy hálózati virtuális eszköz típusú erőforrást.
