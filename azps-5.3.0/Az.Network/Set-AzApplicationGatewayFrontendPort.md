...
## LEÍRÁS
A **Set-AzApplicationGatewayFrontendPort** parancsmag módosítja az alkalmazás-átjárók előtér-portját.

## PÉLDÁK

### 1. példa: Egy alkalmazás átjárójának előlapi portjának beállítása 80-ra
```
...
A második parancs módosítja az átjárót a $AppGw a FrontEndPort01 nevű előlapi port 80-as portjához.

## PARAMETERS

### -ApplicationGateway
Azt az alkalmazás-átjáróobjektumot adja meg, amellyel ez a parancsmag az előlapi portot társítja.
...
### -Name
A módosítani szükséges előlapi port nevét adja meg.
