...
### 1. példa: Az ExpressRoute-kapcsolat szolgáltató kiépítési állapotának módosítása
```
...
Megadja az **ExpressRouteCrossConnection** objektumot, amit ez a parancsmag módosít.
...
### -Társviszonyok
A keresztkapcsolat társviszony-listája
...
A szolgáltató kiépítési állapotát be kell állítani
