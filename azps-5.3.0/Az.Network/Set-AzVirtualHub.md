...
Először létrehozunk egy Virtual Hub Route objektumot, és egy virtuális központi útvonaltábla-erőforrást hozunk létre vele. Ezután ezt az útvonaltábla-erőforrást a virtuális központra állítva a Set-AzVirtualHub parancsot.
...
### -RouteTable
A virtuális központhoz társított útvonaltáblák.
