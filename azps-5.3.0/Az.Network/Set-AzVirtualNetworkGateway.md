...
Az első parancs egy Átjáró01 nevű virtuális hálózati átjárót kap, amely az ResourceGroup001 erőforráscsoporthoz tartozik, és az $Gateway A második parancs a Vpn ipsec házirendobjektumot a megadott ipsec-paraméterek szerint hozza létre.
...
Az első parancs egy Átjáró01 nevű virtuális hálózati átjárót kap, amely az ResourceGroup001 erőforráscsoporthoz tartozik, és a $Gateway A második parancs frissíti az Átjáró01 virtuális hálózati átjárót az AAD hitelesítési konfigurációjával: paraméter:aadTenantUri, aadAudienceId, aadIssuerUri for VpnClient.
...
A virtuális hálózati átjáró objektum, amelyből módosításokat lehet alapozni.
...
### -VpnClientProtocol
A P2S VPN-ügyfél alagutasíték-protokollok listája
