...
## SYNOPSIS
Leállítja a csomagrögzítési műveletet egy Vpn-átjárón.
...
## LEÍRÁS
Leállítja a csomagrögzítési műveletet egy Vpn-átjárón, és feltölti az eredményt az adott SasUrl tárolóra.
...
### -InputObject
A Vpn Gateway-objektum, amelyben a csomagrögzítést el kell kezdeni.
...
### -Name
A Vpn-átjáró neve, ahol a csomagrögzítést el kell kezdeni.
...
### -ResourceId
Annak a VpnGatewaynek az Azure-erőforrás-azonosítója, ahol a csomagrögzítést el kell kezdeni.
...
### -SasUrl
AZ SAS URL-csomagrögzítése a Vpn-átjárón.
