...
A VPN-kapcsolat olyan IPsec-kapcsolatot hoz létre, amely VPN-átjárót csatlakoztat az Azure-ban VPN-webhelyként képviselt távoli ügyfélághoz.
...
A kapcsolat ekkor frissül új IpSecPolicy-nak a Set-AzVpnConnection paranccsal.
...
A rendszer ekkor frissíti a kapcsolatot úgy, hogy a biztonságos karakterlánc-szerkezetet használva új megosztott kulcs legyen.
...
### -InputObject
Frissítend kell a VpnConnection objektumot.
...
### -ResourceId
A törölni kívánt VpnConnection-objektum erőforrás-azonosítója.
...
A VpnSiteLinkConnections azon listája, amelyekre a VpnConnectionnak szüksége van.
