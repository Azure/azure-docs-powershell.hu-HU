...
Ez a parancs letiltja a ContosoPartners nevű névteret a nyugat-amerikai adatközpontban, és hozzárendeli a ContosoNotificationsGroup erőforráscsoporthoz.
...
Ha törölni szeretne egy kritikus névteret, a tulajdonság értékét Hamis értékre kell állítania ahhoz, hogy a névteret ne kritikusként jelölje meg.
...
A Department:IT (Részleg) címkénél például a címke neve Részleg, a címke értéke pedig IT.
