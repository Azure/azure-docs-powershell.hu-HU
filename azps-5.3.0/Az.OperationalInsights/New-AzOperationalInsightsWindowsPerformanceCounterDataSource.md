...
## LEÍRÁS
A **New-AzOperationalInsightsWindowsPerformanceCounterDataSource** parancsmag hozzáad egy Windows teljesítményszámláló adatforrást a Windows operációs rendszert futtató csatlakoztatott számítógépekhez.
...
### -IntervalSeconds
A gyűjtemény időközét adja meg.
...
### -UseLegacyCollevessző
Használja a régi és az alapértelmezett 1656-et.
