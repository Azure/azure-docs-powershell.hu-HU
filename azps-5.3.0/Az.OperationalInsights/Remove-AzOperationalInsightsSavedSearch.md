...
## LEÍRÁS
A **Remove-AzOperationalInsightsSavedSearch** parancsmag eltávolít egy mentett keresést a munkaterületről.

## PÉLDÁK

### 1. példa: Mentett keresés eltávolítása
```
...
Ez a parancs eltávolítja a mentett keresést a munkaterületről.
