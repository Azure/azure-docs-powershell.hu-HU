...
A megadott erőforráscsoport összes erőforrásához (az aktuális munkamenet kontextusában az előfizetéshez) az utolsó napon létrehozott házirendesemény-rekordokat adja vissza.
...
A megadott erőforráscsoport összes erőforrásához (a megadott előfizetésben) az utolsó napon létrehozott házirendesemény-rekordokat adja vissza.
...
### 10. példa: Házirendesemények lekérte egy házirenddefinícióhoz a megadott előfizetésben
```powershell
...
A megadott házirend-hozzárendelés által (az előfizetés aktuális munkamenet kontextusában az erőforráscsoportban található) összes erőforráshoz (a jelenlegi munkamenet kontextusában a bérlőn belül) az utolsó napon létrehozott házirendesemény-rekordokat adja vissza.
