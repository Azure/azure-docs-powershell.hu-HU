...
### 1. példa: Előfizetés összes irányítópultjának felsorolása
```powershell
...
Előfizetés összes irányítópultjának felsorolása

### 2. példa: Egyetlen portál irányítópultjának részletei
```powershell
...
Egyetlen irányítópult részleteinek megtekintése
