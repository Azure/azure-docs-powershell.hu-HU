...
### 1. példa: A PostgreSql tűzfalszabály frissítése név szerint
```powershell
...
Ez a parancsmag név szerint frissíti a PostgreSql tűzfalszabályt.

### 2. példa: A PostgreSql tűzfalszabály frissítése identitás szerint.
```powershell
...
Ezek a parancsmagok identitás szerint frissítik a PostgreSql tűzfalszabályt.

### 3. példa: A PostgreSql tűzfalszabály frissítése -ClientIPAddress szerint.
```powershell
...
Ezek a parancsmagok frissítik a PostgreSql tűzfalszabályt a -ClientIPAddress szerint.
