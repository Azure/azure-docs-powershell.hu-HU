...
A második parancs elindítja a teljes adatátugrásokat a tároló1-ről a tároló2-re. 

### 2. példa: Adatok másolása a tároló1-ból a tároló2-be csak sikertelen elemek esetén
```powershell
PS C:\> $sourceVault = Get-AzRecoveryServicesVault -ResourceGroupName "rgName1" -Name "vault1"
PS C:\> $targetVault = Get-AzRecoveryServicesVault -ResourceGroupName "rgName2" -Name "vault2"
