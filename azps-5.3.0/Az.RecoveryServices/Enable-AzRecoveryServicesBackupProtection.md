...
## SYNOPSIS
Engedélyezi a biztonsági mentést egy megadott biztonságimásolat-védelmi házirendet be nem véő elemhez.
...
Engedélyezi a biztonsági mentést egy megadott biztonságimásolat-védelmi házirendet be nem véő elemhez. (automatikusan generált)
...
### -ExcludeAllDataDisks
Beállítás csak az operációs rendszer lemezeiről való biztonsági mentéshez
...
### -Item
Azt a biztonságimásolat-elemet adja meg, amelynek a parancsmagja védelmet tesz lehetővé.
