...
Helyreállítási pontokat kap a megadott asr replikációs védelem alatt található elemhez.
...
Azt az Azure-webhely-helyreállítási replikációs védett elem objektumot adja meg, amelyhez le kell szereznie az elérhető helyreállítási pontok listáját.
