...
A második parancs lejátsa azt a biztonságimásolat-elemet, amelynek a friendlyName értéke megegyezik a FriendlyName paraméterben megadott értékkel, majd azt $BackupItem változóban.
A FriendlyName paraméter használata több Azure-fájlmegosztás visszaadása esetén is okozhatja a visszaadott értékeket. Ilyen esetben a parancsmag végrehajtásához a -Name paraméter értékét kell visszaadni az eredményhalmazban visszaadott Name $BackupItem.
