...
A helyreállítási tervek összegyűjtik egy egységbe az alkalmazáshoz tartozó virtuális gépeket, és lehetővé teszik számukra a közös helyreállítást.
...
### -Path
A helyreállítási terv definíciójának json-fájljának elérési útját adja meg. A helyreállítási terv meghatározására json használható a helyreállítási terv létrehozásához.
