...
Indítsa el azt a műveletet, amely eltávolítja a megadott lemezeket a nem védett lemez védelmi VM-ről.
...
### -InputObject
A parancsmag bemeneti objektuma: Az ASR replikációs védett elemobjektuma, amelynek a lemezét el kell távolítani.
