...
## LEÍRÁS
A **Start-AzRecoveryServicesAsrPlannedFailoverService parancsmag** elindítja az Azure-webhely-helyreállítási replikációval védett elem vagy helyreállítási terv tervezett feladatátvételét.
...
Elindítja a megadott ASR helyreállítási terv tervezett feladatátvételét, és visszaadja a művelet nyomon követéséhez használt ASR-feladatot.

## PARAMETERS

### -CreateVmIfNotFound
Hozza létre a virtuális gépet, ha nem található meg, miközben nem áll vissza az elsődleges régióba (alternatív hely-helyreállításban használva).) A paraméter elfogadható értékei a következőek:
