...
Indítsa el a frissítési irányt a megadott helyreállítási tervhez, és visszaadja a művelet nyomon követéséhez használt ASR-feladatobjektumot.
...
Indítsa el a frissítési irányt a megadott replikációs védelemmel védett elemhez a védelmi tároló megfeleltetése által meghatározott cél azure-régióban, és használja a gyorsítótár-tárolót (a VM-hez hasonló régióban).
...
### -AzureToVMware
Az Azure-nak a vMWare-forgatókönyvre való váltását határozza meg.
...
### -RetentionVolume
A fő célkiszolgáló adatmegőrzési mennyisége.
...
### -VmmToVmm
Két VMM-felügyelt Hyper-V-webhely között védett, sikertelen hyper-V virtuális gép replikációs irányának frissítése.
