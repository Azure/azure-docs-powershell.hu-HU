...
## LEÍRÁS
A **Reset-AzRedisCache** parancsmag újraindítja egy Azure Redis Cache-példány csomópontját.

## PÉLDÁK

### 1. példa: Mindkét csomópont újraindítása
```
PS C:\>Reset-AzRedisCache -ResourceGroupName "ResourceGroup13" -Name "RedisCache06" -RebootType "AllNodes" -Force
```

Ez a parancs újraindítja mindkét csomópontot a RedisCache06 nevű gyorsítótárban.
...
### -RebootType
Meghatározza, hogy melyik csomópontot vagy csomópontokat indítsa újra.
...
### -ShardId
Annak a szegmensnek az azonosítóját adja meg, amely után a parancsmag újraindul egy olyan prémium szintű gyorsítótárban, amely engedélyezve van a fürtözéshez.
