...
### 1. példa: Az Áthelyezés gyűjtemény összes erőforrásának részletei.
```powershell
...
Az Áthelyezés gyűjtemény adott erőforrásainak részletei az erőforrás nevének áthelyezését használva.
...
### -Name
Az Erőforrás neve áthelyezése 2010.
