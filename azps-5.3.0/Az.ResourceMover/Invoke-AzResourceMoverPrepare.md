...
Az előkészítési művelet a "PreparePending" vagy a "PrepareFailed" moveState "PrepareFailed" moveResources műveleten van, és sikeresen befejeződik a moveResource moveState áttűnés a Függőben műveletre.
...
### 1. példa: A függő tényezők ellenőrzése az erőforrásokra való felkészülés előtt
```powershell
...
Az erőforrásokra való felkészülés előtt ellenőrizze a függőségeket.

### 2. példa: Felkészülés kezdeményezése az erőforráskészletre az Áthelyezési gyűjteményben a "MoveResource Name" bemenettel
```powershell
...
### 3. példa: Felkészülés kezdeményezése az erőforráskészletre az Áthelyezési gyűjteményben a "SourceARMID" használatával
```powershell
