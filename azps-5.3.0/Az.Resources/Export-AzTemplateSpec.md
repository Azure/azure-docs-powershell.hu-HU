...
### ExportByNameParameterSet (alapértelmezett)
```
...
## LEÍRÁS
Egy adott Sablon specifikációs verzióját exportálja a helyi fájlrendszerbe.

## PÉLDÁK

### 1. példa: Exportálás név szerint
```powershell
PS C:\> Export-AzTemplateSpec -ResourceGroupName 'myRG' -Name 'MyTemplateSpec' -Version 'v1.0' -OutputFolder 'v1'
```

Exportálja a "myRG" erőforráscsoport "MyTemplateSpec" nevű sablon specifikációjának "v1.0" verzióját a "v1" helyi kimeneti mappába.

### 2. példa: Exportálás erőforrás-azonosító szerint
```powershell
...
Exportálja a "MyTemplateSpec" nevű sablon specifikációjának "v1.0" verzióját az előfizetési alazonosító "myRG" erőforráscsoportjába a \{ \} "v1" helyi kimeneti mappába.
...
### -OutputFolder
Annak a mappának az elérési útja, amelybe a sablon specifikációs verziója fog kimenetet létrehozni.
...
### -Version
Az exportálni kívánt sablonverzió.
