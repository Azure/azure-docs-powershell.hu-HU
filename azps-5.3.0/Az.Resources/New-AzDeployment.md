...
## LEÍRÁS
A **New-AzDeployment** parancsmag hozzáad egy telepítést az aktuális előfizetési hatókörben.
Ide tartoznak a telepítéshez szükséges erőforrások is.

Az Azure-erőforrás egy felhasználó által felügyelt Azure-entitás. Az erőforrások egy erőforráscsoportban, például adatbázis-kiszolgálón, adatbázisban, webhelyen, virtuális gépen vagy tárfiókban is megélnek.
Az is lehet előfizetési szintű erőforrás, például szerepkör-definíció, házirend-definíció stb.
...
A **New-AzDeployment** parancsmag létrehoz egy telepítést az aktuális előfizetési hatókörben, amely az előfizetési szintű erőforrásokat telepíti.

Ha egy központi telepítést szeretne hozzáadni az előfizetéshez, adja meg a helyet és egy sablont.
...
Ez a parancs új telepítést hoz létre az aktuális előfizetési hatókörben egy egyéni sablon és egy lemezen lévő sablonfájl használatával, meghatározott címke paraméterrel.
...
A *sablon verzióját a TemplateVersion* paraméterrel adja meg.
...
Ez a parancs új telepítést hoz létre az aktuális előfizetési hatókörben egy egyéni sablon és egy, a lemezen lévő sablonfájl használatával, amelyet a rendszer memórián belülre konvertált hashtable-ként.
...
Vesszővel elválasztott erőforrás-módosítási típusok, amelyek nem lesznek kizárva a What-If eredményből. Akkor érvényes, ha a -WhatIf vagy a -Confirm kapcsoló be van állítva.
