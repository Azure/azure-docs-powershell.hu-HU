...
## SYNOPSIS
Előre definiált Azure-címkét hoz létre, vagy értékeket ad hozzá egy meglévő címkéhez | Létrehozza vagy frissíti a címkék teljes készletét egy erőforráson vagy előfizetésen.
...
Ez a parancsmag egy objektumot ad vissza, amely az új vagy módosított címkét adja vissza az értékeivel és az erőforrások számával együtt.
...
### 5. példa: Az előfizetés teljes címkéinek beállítása vagy frissítése
...
### 6. példa: Létrehozza vagy frissíti egy erőforrás teljes címkéit
...
Ha egy meglévő előre definiált címkének van a megadott neve, a **New-AzTag** új címke létrehozása helyett hozzáadja a megadott értéket (ha van ilyen) a címkéhez.
