...
## LEÍRÁS
A Remove-AzRoleAssignment parancsmagot használva visszavonhatja a hozzáférést egy adott hatókörű és szerepkörű egyszerű felhasználóhoz.
...
Eltávolítja az ObjectId által azonosított és az Olvasó szerepkörhöz hozzárendelt csoporttag szerepkör-hozzárendelését.
...
Ha nincs megadva, előfizetési szinten megpróbálja törölni a szerepkört.
