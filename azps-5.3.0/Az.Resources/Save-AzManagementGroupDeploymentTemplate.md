...
## LEÍRÁS
A **Save-AzManagementGroupDeploymentTemplate**  parancsmag egy JSON-fájlba menti a telepítősablont egy felügyeleti csoport központi telepítéséhez.
...
### 2. példa: Üzembe helyezés és sablon mentése
```
...
Ez a parancs a "RolesDeployment" központi telepítést a "myMG" felügyeleti csoportban kapja meg, és menti a sablonját.
...
### -Path
A sablonfájl kimeneti útvonala.
