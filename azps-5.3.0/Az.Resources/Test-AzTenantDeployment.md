...
## LEÍRÁS
A **Test-AzTenantDeployment parancsmag** határozza meg, hogy egy üzembe helyezési sablon és paraméterértékei érvényesek-e az aktuális bérlői hatókörben.
...
Ez a parancs a megadott sablonfájlt és paraméterfájlt használva teszteli az aktuális bérlői hatókörű telepítést.
...
Ez a parancs az aktuális bérlői tartományba tartozó telepítést teszteli egy adott sablonfájlból és egy paraméterfájlból létrehozott memória-kivonat segítségével.
