...
## LEÍRÁS
A **Get-AzSearchAdminKeyPair** parancsmag az Azure Search szolgáltatás rendszergazdai kulcspárt kap.
...
A példa az Azure Search szolgáltatás rendszergazdai kulcspárt kap.
