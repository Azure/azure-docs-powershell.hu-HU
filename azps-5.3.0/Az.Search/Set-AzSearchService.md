...
## LEÍRÁS
A **Set-AzSearchService** parancsmag módosítja az Azure Search szolgáltatást.
...
A példa 2-re módosítja az Azure Search szolgáltatás partíciók és replikaszámát.
