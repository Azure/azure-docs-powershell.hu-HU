...
## LEÍRÁS
A Disable-AzIotSecurityAnalyticsAggregatedAlert parancsmag mellőzi az iot hub eszközein található speciális, aggragált riasztásokat. Az összesített riasztások neve a riasztástípus és a riasztások aggragált dátumának kombinációja, "/" elválasztva egymástól.
...
Az "IoT_SucessfulLocalLogin/2020-03-15" (riasztástípusból és összesített dátumból egyesített név) az IoT "MySolutionName" biztonsági megoldásának "MyResourceGroup" erőforráscsoportban való mellőzése
...
A "/subscriptions/XXXXXXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Security/iotSecuritySolutions/MySolutionName/analyticsModels/default/aggregatedAlerts/IoT_SucessfulLocalLogin/2020-03-15" típusú összesített riasztás mellőzése
