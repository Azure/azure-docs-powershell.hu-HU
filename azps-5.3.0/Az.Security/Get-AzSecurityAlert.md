...
ms.locfileid: "98479798"
---
# <span data-ttu-id="bd1be-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="bd1be-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="bd1be-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="bd1be-102">SYNOPSIS</span></span>
<span data-ttu-id="bd1be-103">Az Azure Biztonsági központ által észlelt biztonsági riasztásokat kap</span><span class="sxs-lookup"><span data-stu-id="bd1be-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="bd1be-104">SZINTAXIS</span><span class="sxs-lookup"><span data-stu-id="bd1be-104">SYNTAX</span></span>

### <span data-ttu-id="bd1be-105">SubscriptionScope (alapértelmezett)</span><span class="sxs-lookup"><span data-stu-id="bd1be-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="bd1be-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="bd1be-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="bd1be-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="bd1be-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="bd1be-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="bd1be-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="bd1be-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="bd1be-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="bd1be-110">LEÍRÁS</span><span class="sxs-lookup"><span data-stu-id="bd1be-110">DESCRIPTION</span></span>
<span data-ttu-id="bd1be-111">Az Azure Biztonsági központ által észlelt biztonsági riasztásokat kap</span><span class="sxs-lookup"><span data-stu-id="bd1be-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="bd1be-112">PÉLDÁK</span><span class="sxs-lookup"><span data-stu-id="bd1be-112">EXAMPLES</span></span>

### <span data-ttu-id="bd1be-113">1. példa</span><span class="sxs-lookup"><span data-stu-id="bd1be-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="bd1be-114">Az előfizetésen belüli erőforrásokon észlelt összes biztonsági riasztást beveszi.</span><span class="sxs-lookup"><span data-stu-id="bd1be-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="bd1be-115">2. példa</span><span class="sxs-lookup"><span data-stu-id="bd1be-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="bd1be-116">A "myService1" erőforráscsoporton belüli erőforrásokon észlelt összes biztonsági riasztást begyara</span><span class="sxs-lookup"><span data-stu-id="bd1be-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="bd1be-117">3. példa</span><span class="sxs-lookup"><span data-stu-id="bd1be-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="bd1be-118">Egy adott biztonsági riasztást kap, amely a "myService1" erőforráscsoporton belüli erőforrásokon észlelt</span><span class="sxs-lookup"><span data-stu-id="bd1be-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="bd1be-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="bd1be-119">PARAMETERS</span></span>

### <span data-ttu-id="bd1be-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="bd1be-120">-DefaultProfile</span></span>
<span data-ttu-id="bd1be-121">Az Azure-ral való kommunikációhoz használt hitelesítő adatok, fiók, bérlő és előfizetés.</span><span class="sxs-lookup"><span data-stu-id="bd1be-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="bd1be-122">-Location</span><span class="sxs-lookup"><span data-stu-id="bd1be-122">-Location</span></span>
<span data-ttu-id="bd1be-123">Hely.</span><span class="sxs-lookup"><span data-stu-id="bd1be-123">Location.</span></span>
...
### <span data-ttu-id="bd1be-124">-Name</span><span class="sxs-lookup"><span data-stu-id="bd1be-124">-Name</span></span>
<span data-ttu-id="bd1be-125">Erőforrás neve.</span><span class="sxs-lookup"><span data-stu-id="bd1be-125">Resource name.</span></span>
...
### <span data-ttu-id="bd1be-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="bd1be-126">-ResourceGroupName</span></span>
<span data-ttu-id="bd1be-127">Erőforráscsoport neve.</span><span class="sxs-lookup"><span data-stu-id="bd1be-127">Resource group name.</span></span>
...
### <span data-ttu-id="bd1be-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="bd1be-128">-ResourceId</span></span>
<span data-ttu-id="bd1be-129">Erőforrás-azonosító.</span><span class="sxs-lookup"><span data-stu-id="bd1be-129">Resource ID.</span></span>
...
### <span data-ttu-id="bd1be-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="bd1be-130">CommonParameters</span></span>
<span data-ttu-id="bd1be-131">Ez a parancsmag a következő közös paramétereket támogatja: -Hibakeresés, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction és -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="bd1be-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="bd1be-132">További információt a [about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="bd1be-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="bd1be-133">INPUTS</span><span class="sxs-lookup"><span data-stu-id="bd1be-133">INPUTS</span></span>

### <span data-ttu-id="bd1be-134">System.String</span><span class="sxs-lookup"><span data-stu-id="bd1be-134">System.String</span></span>

## <span data-ttu-id="bd1be-135">KIMENETEK</span><span class="sxs-lookup"><span data-stu-id="bd1be-135">OUTPUTS</span></span>

### <span data-ttu-id="bd1be-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="bd1be-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="bd1be-137">MEGJEGYZÉSEK</span><span class="sxs-lookup"><span data-stu-id="bd1be-137">NOTES</span></span>

## <span data-ttu-id="bd1be-138">KAPCSOLÓDÓ HIVATKOZÁSOK</span><span class="sxs-lookup"><span data-stu-id="bd1be-138">RELATED LINKS</span></span>
