...
Beveszi az Azure Defender csomagokat egy előfizetéshez az Azure Biztonsági központban.
...
Ezzel a parancsmagkal előfizetésenként megtekintheti az egyes Azure Defender-csomagokat.

Az Azure Defenderről és a rendelkezésre álló csomagokról az [Azure Defender – Bevezetés szolgáltatásban olvashat részletesen.](https://docs.microsoft.com/azure/security-center/azure-defender)
...
Lekérte az előfizetéshez szükséges Azure Defender-előfizetések állapotát.
...
Az adott erőforrás-azonosító árazási adatait tartalmazza. Ahol az ResourceId az egyik visszaadott `Get-AzSecurityPricing` id.
...
Az Azure Defender nevű csomag árazási adatait tartalmazza. Hol `name` van az eredményül adott nevek `Get-AzSecurityPricing` egyike.
