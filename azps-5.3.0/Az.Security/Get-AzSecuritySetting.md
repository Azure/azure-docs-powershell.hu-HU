...
## SYNOPSIS
Biztonsági beállítások lekérte az Azure Biztonsági központban
...
## LEÍRÁS
A Get-AzSecuritySetting parancsmag biztonsági beállításokat kap az Azure Biztonsági központban.
...
MCAS-adatexport beállítást kap   
