...
## LEÍRÁS
A Remove-AzIotSecuritySolution parancsmag töröl egy adott iot biztonsági megoldást. Az IoT biztonsági megoldás biztonsági adatokat és eseményeket gyűjt az iot-eszközökről és az iOT-központban a veszélyforrások megelőzése és észlelése érdekében.
...
A "MySample" IoT biztonsági megoldás törlése a "MyResourceGroup" erőforráscsoporttal
