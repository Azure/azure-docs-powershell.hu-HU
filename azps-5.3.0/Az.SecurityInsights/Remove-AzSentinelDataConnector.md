...
## LEÍRÁS
A **Remove-AzSentinelDataConnector** parancsmag véglegesen töröl egy adatösszekötőt egy adott munkaterületről.
A **DataConnector-objektumokat** átadhatja a folyamat műveleti jelével, vagy megadhatja a szükséges paramétereket.
...
Ez a parancs eltávolítja az Adatösszekötőt a munkaterületről.
