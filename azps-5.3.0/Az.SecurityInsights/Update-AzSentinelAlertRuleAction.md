...
## LEÍRÁS
Az **Update-AzSentinelAlertRuleAction** parancsmag frissíti a könyvjelzőt a megadott munkaterületen.
A **AlertRuleAction** objektumokat paraméterként vagy a folyamat műveleti jelének használatával is átadhatja, vagy megadhatja a *AlertRuleId* és *az ActionId* paramétert.
...
Ebben a példában egy **AlertRuleAction** frissül, amely a meglévő *műveletet* új tulajdonságokra cseréli.
...
Ebben a példában egy **AlertRuleAction** frissül egy InputObject művelettel, amely egy meglévő *műveletet* új tulajdonságokra cserél.
