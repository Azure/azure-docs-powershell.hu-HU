...
## LEÍRÁS
A **Get-AzServiceBusGeoDRConfiguration** beolvassa az alias(Katasztrófa-helyreállítási konfiguráció) beállítást az elsődleges vagy másodlagos névtérhez
...
A "SampleDRConfigName" alias-konfiguráció lekérése az elsődleges névtér "SampleNamespace_Primary" esetén
