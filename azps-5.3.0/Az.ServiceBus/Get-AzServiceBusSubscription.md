...
## LEÍRÁS
A **Get-AzServiceBusSubscription** parancsmag visszaadja az előfizetés leírását a megadott Service Bus-témakörben.
...
A szolgáltatásbusz adott témakörének előfizetési leírását adja eredményül.
...
Visszaadja a szolgáltatásbusz adott témaköréhez kapcsolódó előfizetések listáját. Alapértelmezés szerint 100 előfizetést ad vissza, az előfizetések száma esetén használja a -MaxCount Parameter paramétert.
...
Visszaadja a szolgáltatásbusszal kapcsolatos témakör első 150 előfizetésének listáját.
...
### -MaxCount
Határozza meg, hogy legfeljebb hány előfizetést kell visszahozni.
