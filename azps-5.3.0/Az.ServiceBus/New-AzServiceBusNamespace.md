...
## LEÍRÁS
A **New-AzServiceBusNamespace** parancsmag létrehoz egy új Service Bus névteret. Létrehozás után a névtérerőforrás jegyzékfájlja nem módosítható. Ez a művelet idempotent.
...
Létrehoz egy új Service Bus névteret a megadott erőforráscsoporton belül.
...
### -SkuName
A Szolgáltatásbusz névterének termékváltozatának neve.
