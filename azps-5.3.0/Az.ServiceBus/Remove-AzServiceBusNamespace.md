...
### NamespacePropertiesSet (alapértelmezett)
```
...
## LEÍRÁS
A **Remove-AzServiceBusNamespace** parancsmag eltávolítja a névteret a megadott erőforráscsoportból.
...
Eltávolítja a Service Bus `SB-Example1` névterét a megadott erőforráscsoportból. `Default-ServiceBus-WestUS`

### 2.1. példa – InputObject – Változó használata:
```
PS C:\> $inputobject = Get-AzServiceBusNamespace <params>
PS C:\> Remove-AzServiceBusNamespace -InputObject $inputobject
```

Eltávolítja a szolgáltatásbusz névterét, amely a $inputobject.

### 2.2. példa – InputObject – Pipázás használata:
```
PS C:\> Get-AzServiceBusNamespace <params> | Remove-AzServiceBusNamespace
```

A Service Bus névterének eltávolítása a Piping használatával.
...
Eltávolítja a Service Bus névterét, amely az ARM -ResourceId paraméter $resourceid vagy a piping paraméterben megadott azonosítóból áll.
