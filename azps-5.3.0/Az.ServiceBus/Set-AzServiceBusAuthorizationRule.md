...
## LEÍRÁS
A **Set-AzServiceBusAuthorizationRule** parancsmag frissíti a megadott engedélyezési szabály leírását a szolgáltatásbusz adott névterében vagy várólistáján vagy témakörében.
...
Eltávolítja a **Manage** billentyűt a névtér engedélyezési szabályának `AuthoRule1` hozzáférési `SB-Example1` jogaiból.
...
Eltávolítja a **Kezelés** elérést a várólistán lévő engedélyezési `AuthoRule1` szabály hozzáférési jogosultságaiból. `SBQueue`
...
Eltávolítja a **Kezelés** elérést a témakörben található engedélyezési szabály `AuthoRule1` hozzáférési jogosultságaiból. `SBTopic`
...
### -InputObject
ServiceBus AuthorizationRule objektum
