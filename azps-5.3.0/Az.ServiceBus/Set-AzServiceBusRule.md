...
## LEÍRÁS
A **Set-AzServiceBusRule** parancsmag frissíti a megadott előfizetési szabály leírását.
...
Frissíti az előfizetés **szabályának mysqlexpression='condition'** sql-kifejezését a `SBRule` `SBSubscription` Topicban `SBTopic`
