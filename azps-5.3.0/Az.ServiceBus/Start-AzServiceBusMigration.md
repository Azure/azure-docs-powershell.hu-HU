...
## LEÍRÁS
A **Start-AzServiceBusMigration** parancsmag létrehoz egy új áttelepítési konfigurációt, és megkezdi az entitások áttelepítését a Standardból a Prémium névterekbe
...
Új áttelepítési konfigurációt hoz létre a "TestingNamespaceStandardMigration" és a "TestingNamespacePremiumMigration" névterek számára.
...
### -PostMigrationName
Áttelepítés utáni név a szokásos névtérhez az áttelepítésben
