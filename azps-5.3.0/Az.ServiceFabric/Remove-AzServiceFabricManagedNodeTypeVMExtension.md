...
## LEÍRÁS
Távolítsa el a vm bővítményt a csomóponttípusról név szerint. A [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) használatával a VmExtensions tulajdonságot használva láthatja a csomóponttípus aktuális bővítményét.
...
Távolítsa el a kiterjesztést a csomóponttípusról név szerint.
...
Távolítsa el a kiterjesztést a csomóponttípusról név szerint, pipázással.
