...
## LEÍRÁS
Beállítja a csomóponttípus erőforrástulajdonságokat, vagy reimage-műveleteket futtat a csomóponttípus -Reimage paraméterrel megadott ndes-ján. A reimgae művelet során a szolgáltatás hálócsomópontjai le lesznek tiltva, mielőtt újra képbe kerülnek a virtuális gépeket, és ismét engedélyezték őket, miután visszatértek. Ha ez az elsődleges csomóponttípusokon történik, kis ideig is szükség lehet rá, mivel előfordulhat, hogy nem tudja egyszerre újraimálni az összes csomópontot. A -ForceReimage akkor is kényszeríti a műveletet, ha a szolgáltatás szövete nem tudja letiltani a csomópontokat, de legyen körültekintő, mivel ez adatvesztést okozhat, ha állapotos terhelések futnak a csomóponton.
...
Frissítse a csomóponttípus példányszámát.
...
Frissítse a csomóponttípus megfelelő helymegjelenítését. Ez felülírja a régebbi helymegjelenítési webhelyeket, ha vannak ilyenek.
...
A 0-s és a 3-as csomópont újraimálása a csomóponttípuson.
...
Frissítse a csomópont példányszámát pipázással.

## PARAMETERS

### -ApplicationEndPort
Porttartomány alkalmazásvégi portja.
...
### -Kapacitás
A csomóponttípus csomópontjaira kulcs-/értékpárokként alkalmazott kapacitáscímkék, a fürterőforrás-kezelő ezeket a címkéket használva tudja megérteni, hogy egy csomópont mennyi erőforrással rendelkezik. A frissítés felülírja az aktuális értékeket.
...
### -EphemeralEndPort
Egy porttartomány áttűnő vég portja.
...
### -EphemeralStartPort
Egy porttartomány kezdetű portja.
...
### -ForceReimage
Ezzel a jelzővel akkor is kényszerítheti az eltávolítást, ha a szolgáltatási anyag nem tudja letiltani a csomópontokat.
Legyen óvatos, mert ez adatvesztést okozhat, ha állapotos terhelések futnak a csomóponton.
...
### -InstanceCount
A csomóponttípus csomópontjainak száma.
...
### -PlacementProperty
A csomóponttípus csomópontjaira kulcs/érték párokként alkalmazott elhelyezési címkék, amelyek bizonyos szolgáltatások (munkaterhelés) futtatásának jelzésére használhatók. A frissítés felülírja az aktuális értékeket.
...
### -Reimage
Megadhatja, hogy a csomóponttípus csomópontjainak újraimálása történik-e.
