...
### 1. példa: A Spring Cloud app frissítése név szerint.
```powershell
...
Frissítse a Spring Cloud appot név szerint.

### 2. példa: A Spring Cloud app frissítése a pipe-ból.
```powershell
...
Frissítse a Spring Cloud appot a pipe-ból.

## PARAMETERS

### -ActiveDeploymentName
Az app aktív központi telepítésének neve
...
### -HttpsOnly
Azt jelzi, hogy csak https engedélyezett-e.
...
### -Location
Az alkalmazás FÖLDRAJZI helye, mindig ugyanaz a szülőerőforrással
...
Az állandó lemez csatlakoztatási útvonala
...
### -Public
Azt jelzi, hogy az app elérhetővé teszi-e a nyilvános végpontot
