...
## LEÍRÁS
A **Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication** parancsmag letiltja az Azure Active Directory (Azure AD) csak hitelesítési követelményét egy AzureSQL Felügyelt példány esetében az aktuális előfizetésben.
...
Ez a parancs letiltja az Azure Active Directory (Azure AD) csak hitelesítési követelményét az ResourceGroup01 nevű erőforráscsoporthoz társított ManagedInstance01 nevű AzureSQL Felügyelt példány esetén.
