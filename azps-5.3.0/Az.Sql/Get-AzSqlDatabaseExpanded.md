...
### 1. példa: Szolgáltatásszintű tanácsadói adatokat tartalmazó adatbázis-objektum lekérte
```
PS C:\> Get-AzSqlDatabaseExpanded -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Ez a parancs visszaadja azt az adatbázist, amely kibontott tulajdonságokkal rendelkezik, és tartalmazza a szolgáltatásszintű tanácsadó adatait.
