...
## LEÍRÁS
A Get-AzSqlElasticJobStepExecution parancsmag egy vagy több feladatlépés végrehajtását kapja meg egy feladatvégrehajtásból

## PÉLDÁK

### 1. példa : Egy vagy több feladatlépés végrehajtása egy feladatvégrehajtásból
```
...
### 2. példa : Egy vagy több feladatlépés végrehajtását kapja egy feladatvégrehajtásból, lépésnév szerint szűrve
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
