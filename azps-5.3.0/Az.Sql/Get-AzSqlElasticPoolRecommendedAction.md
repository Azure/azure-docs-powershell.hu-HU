...
## LEÍRÁS
A **Get-AzSqlElasticPoolRecomasticAction** parancsmag egy vagy több javasolt műveletet kap egy Azure SQL rugalmassági készlet tanácsadóhoz.

## PÉLDÁK

### 1. példa: Tanácsadóhoz ajánlott összes művelet felsorolása
```
...
Ez a parancs a WiRunnerPool nevű rugalmas készlethez elérhető CreateIndex nevű tanácsadó által ajánlott műveletek listáját tartalmazza.
...
Ez a parancs a IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 a CreateIndex nevű tanácsadótól kapja meg az ajánlott \] műveletet.

## PARAMETERS

### -AdvisorName
Annak a tanácsadónak a nevét adja meg, amelyhez ez a parancsmag az ajánlott műveleteket kéri.
...
### -ElasticPoolName
Annak a rugalmas készletnek a neve, amelyhez ez a parancsmag az ajánlott műveleteket kéri.
...
### -ResourceGroupName
Annak a kiszolgálónak a nevét adja meg, amely ezt a rugalmas készletet tartalmazza.
