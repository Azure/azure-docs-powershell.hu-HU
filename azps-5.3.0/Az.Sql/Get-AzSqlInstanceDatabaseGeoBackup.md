...
## LEÍRÁS
A **Get-AzSqlInstanceDatabaseGeoBackup** parancsmag egy vagy több Azure SQL-adatbázisból redundáns biztonsági másolatot kap egy Azure SQL-adatbázis felügyelt példányából.

## PÉLDÁK

### 1. példa: Az összes adatbázis redundáns biztonsági mentése egy példányon
```
...
Ez a parancs az összes adatbázis redundáns biztonsági másolatát lekérte a managedInstance1 nevű példányról.

### 2. példa: Adatbázis redundáns biztonsági mentése név szerint felügyelt példányon
```
...
Ez a parancs egy felügyeltAdatbázis1 nevű adatbázis-redundáns biztonsági másolatot kap egy managedInstance1 nevű példányból.

### 3. példa: Az összes adatbázis redundáns biztonsági mentése egy példányon szűréssel
```
...
Ez a parancs minden olyan adatbázis-redundáns biztonsági másolatot kap a managedInstance1 példányról, amely a "managedDatabase" kezdetű.
...
### -Name
A visszakeresni megfelelő példányadatbázis neve.
