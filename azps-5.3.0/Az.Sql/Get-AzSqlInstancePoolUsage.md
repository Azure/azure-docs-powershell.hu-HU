...
## LEÍRÁS
A **Get-AzSqlInstancePoolUsage** parancsmag egy Azure SQL-példánykészlet által használt adatokat ad vissza.

## PÉLDÁK

### 1. példa: Egy Azure SQL-példánykészlet használatát használja fel
```powershell
...
Az Azure SQL-példánykészlet instancepool0-ját használja fel.

### 2. példa: Egy Azure SQL-példánykészlet használatát használja fel egy példánykészlet-objektum használatával
```powershell
...
Egy példánykészlet-objektum használatával lekérte az Azure SQL-példánykészlet példánypool0-ját.

### 3. példa: Egy Azure SQL-példánykészlet használatát használja egy példánykészlet erőforrás-azonosítójával
```powershell
...
Egy példánykészlet erőforrás-azonosítójának használatával lekérte az Azure SQL-példánykészlet példánypool0-jának használati adatokat.

### 3. példa: Egy Azure SQL-példánykészlet használatát kapja a készlet felügyelt példányhasználatának részletezésével.
```powershell
...
Az Azure SQL-példánykészlet instancepool0-ját használja a instancepool0-ban kezelt példányok használatával együtt.
...
### -InstancePool
A szülőpéldány-készlet objektum.
...
### -Name
A felügyelt példánykészlet neve.
