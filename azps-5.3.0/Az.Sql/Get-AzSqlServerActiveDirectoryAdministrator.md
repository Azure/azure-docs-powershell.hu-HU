...
## LEÍRÁS
A **Get-AzSqlServerActiveDirectoryAdministrator** parancsmag az aktuális előfizetésben lévő AzureSQL-kiszolgáló Azure Active Directory (Azure AD) rendszergazdájával kapcsolatos információkat kap.

## PÉLDÁK

### 1. példa: Információt kap egy kiszolgáló rendszergazdájától
```
...
Ez a parancs információkat kap egy Server01 nevű kiszolgáló Azure AD-rendszergazdájával kapcsolatban, amely egy ResourceGroup01 nevű erőforráscsoporthoz van társítva.
...
### -ServerName
Annak az SQL Servernek a nevét adja meg, amelyről a parancsmag információt kap.
