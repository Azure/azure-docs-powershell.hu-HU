...
## LEÍRÁS
A **Get-AzSqlServerAdvancedDataSecurityPolicy** parancsmag beolvassa egy kiszolgáló speciális adatbiztonsági házirendjét.

## PÉLDÁK

### 1. példa: Kiszolgáló speciális adatbiztonságának lekérte
```powershell
...
### 2. példa: Kiszolgáló speciális adatbiztonságot kap a kiszolgálóerőforrástól
```powershell
