...
## LEÍRÁS
Szerezze be az adott Azure SQL Server DNS-aliast, vagy sorolja fel a kiszolgáló összes kiszolgálói DNS-aliasát
...
Az adott kiszolgáló összes dns-aliasának listája
...
Kiszolgáló és aliasnév szerint megadott kiszolgáló DNS-aliast kap
...
Az adott kiszolgáló "dnsaliasname" kezdetű kiszolgálói DNS-aliasai.
