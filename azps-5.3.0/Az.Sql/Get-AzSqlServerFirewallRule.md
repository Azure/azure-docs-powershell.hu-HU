...
## LEÍRÁS
A **Get-AzSqlServerFirewallRule parancsmag** tűzfalszabályt kap egy Azure SQL Database-kiszolgálóhoz.
Ha megadja egy tűzfalszabály nevét, ez a parancsmag információt kap az adott tűzfalszabályról.

## PÉLDÁK

### 1. példa: A kiszolgáló összes szabályának lekérte
```
...
Ez a parancs a Kiszolgáló01 nevű kiszolgáló összes tűzfalszabályát beveszi.

### 2. példa: Egy kiszolgáló összes szabályának be szereznie szűrés használatával
```
...
Ez a parancs a "Szabály" kezdetű Kiszolgáló01 kiszolgálóra vonatkozó összes tűzfalszabályt megkapja.
...
### -FirewallRuleName
A tűzfalszabály nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amelyhez az SQL Server hozzá van rendelve.
