...
## LEÍRÁS
A **Get-AzSqlVirtualCluster** parancsmag egy vagy több Azure SQL virtuális fürtről ad információkat.
Adja meg a virtuális fürt nevét, hogy csak az adott fürt adatait lássa.

## PÉLDÁK

### 1. példa: Az erőforráscsoporthoz rendelt összes virtuális fürt lekérte
```powershell
...
Ez a parancs információkat kap az Erőforráscsoport01 erőforráscsoporthoz rendelt összes virtuális fürtről.

### 2. példa: Információk lekérte egy adott virtuális fürtről
```
...
Ez a parancs információkat kap a VirtualCluster1 virtuális fürtről az ResourceGroup01 erőforráscsoportban.
