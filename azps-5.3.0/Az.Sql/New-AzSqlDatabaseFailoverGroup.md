...
Két Azure SQL Database TDS-végpont jön létre a FailoverGroupName.SqlDatabaseDnsSuffix (például az FailoverGroupName.database.windows.net) és a FailoverGroupName.secondary.SqlDatabaseDnsSuffix fájlban. Ezek a végpontok használhatók a feladatátvételi csoport elsődleges és másodlagos kiszolgálóihoz való csatlakozásra. Ha az elsődleges kiszolgálót kimaradás érinti, a végpontok és adatbázisok automatikus feladatátvételét a feladatátvételi csoport feladatátvételi házirende és türelmi időszaka határozza meg.
