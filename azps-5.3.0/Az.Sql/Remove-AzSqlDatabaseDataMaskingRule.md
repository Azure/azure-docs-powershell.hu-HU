...
Az adatmaszkolási szabályok eltávolításához használja az *ResourceGroupName,* *a ServerName,* a *DatabaseName* és a *RuleId* paramétert a parancsmag által eltávolított szabály azonosításához.
