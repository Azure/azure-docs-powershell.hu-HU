...
## LEÍRÁS
Eltávolít egy vagy több adatbázist a megadott Azure SQL-adatbázis feladatátvételi csoportjából. Az adatbázisok és a replikációs kapcsolatok érintetlenek maradnak, de a továbbiakban nem lesznek elérhetők a feladatátvételi csoport végpontjain keresztül.
...
Ez a parancs úgy távolít el egy adatbázist a feladatátvételi csoportból, hogy bemászik.
...
Ez a parancs eltávolítja az összes adatbázist a feladatátvételi csoportból.
...
Ez a parancs eltávolítja egy rugalmas készlet összes adatbázisát egy feladatátvételi csoportból.

## PARAMETERS

### -Database
A feladatátvételi csoport elsődleges kiszolgálójának egy vagy több Azure SQL-adatbázisát el kell távolítani a feladatátvételi csoportból.
...
### -Force
Hagyja ki a művelet végrehajtásához szükséges megerősítő üzenetet.
