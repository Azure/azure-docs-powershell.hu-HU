...
## LEÍRÁS
A **Remove-AzSqlServerActiveDirectoryAdministrator** parancsmag eltávolítja az Azure Active Directory (Azure AD) azure-rendszergazdáját az AzureSQL Serverhez a jelenlegi előfizetésben.
...
Ez a parancs eltávolítja az Erőforráscsoport01 erőforráscsoporttal társított Kiszolgáló01 nevű kiszolgáló Azure AD-rendszergazdáját.
...
### -ServerName
Annak az SQL Servernek a nevét adja meg, amelyből a parancsmag eltávolítja a rendszergazdát.
