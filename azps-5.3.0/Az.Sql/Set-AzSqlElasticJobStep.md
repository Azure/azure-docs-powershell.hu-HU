...
## LEÍRÁS
A Set-AzSqlElasticJobStep parancsmag frissíti a feladatlépést

## PÉLDÁK

### 1. példa: Frissíti egy feladat feladatlépésének célcsoportját egy feladathoz
```powershell
...
### 2. példa: Egy feladat lépésének T-SQL-parancsfájljának frissítése egy feladathoz
```powershell
PS C:\> $jobStep = Get-AzSqlElasticJobStep -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -StepName step1
...
Egy feladat lépésének frissítése egy feladatból
...
### -RemoveOutput
A kimenet eltávolítását jelző jelölő
...
### -ResourceId
A feladatlépés erőforrás-azonosítója
