...
## LEÍRÁS
Az **Update-AzSqlSyncGroup** parancsmag módosítja egy Azure SQL Database Sync-tag tulajdonságait.
...
Ez a parancs alaphelyzetbe állítja a tagadatbázis rendszergazdai jelszavát.
...
A szinkronizálási tagadatbázis erőforrás-azonosítója, ha a UsePrivateLinkConnection igazra van állítva.
...
Hogy a szinkronizálási taghoz való csatlakozáskor használjon-e privát hivatkozást.
