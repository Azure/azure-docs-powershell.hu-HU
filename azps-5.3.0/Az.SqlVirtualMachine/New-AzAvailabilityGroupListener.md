...
## LEÍRÁS
A New-AzAvailabilityGroupListener parancsmag létrehoz egy új elérhetőségi csoport figyelőt.
...
Létrehozza az Sql Virtual Machine Group SqlVmGroup01 rendelkezésre állási csoportjának Availability Group AvailabilityGroup01 szolgáltatásának AgListener01 rendelkezésre állási csoportját.
...
### -Name
Availability Group Listener name (Elérhetőségi csoport hallgatója) neve.
...
### -Port
Az AG-hallgató portszáma. Az alapértelmezett érték 1433.
...
Nyilvános IP-cím erőforrás-azonosítója
...
### -SqlVirtualMachineId
Sql VM resource-id-ekkel kapcsolatos adatok listája
