...
## LEÍRÁS
A Remove-AzAvailabilityGroupListener parancsmag töröl egy rendelkezésre állási csoport figyelőt.
...
Törli az Elérhetőségi csoport hallgatója az AgListener01 csoportot az Elérhetőségi csoport rendelkezésre állása Csoport01 csoportjában.
...
### -InputObject
Availability Group Listener objektum.
...
### -PassThru
Azt adja meg, hogy a parancsmag végrehajtása után kimenetként adja-e meg a törölt erőforrást.
