...
## LEÍRÁS
A **Get-AzStackEdgeRole** parancsmag lehívja a stack edge-es eszközök rendelkezésre álló IoT-szerepköreit. Megemlítheti a Name paramétert egy adott IoT-szerepkör részleteinek lekértérte.
