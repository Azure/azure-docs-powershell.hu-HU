...
A fürtön elérhető regisztrált információk a fürt regisztrációjának a visszaszabadulnak, ha nem ad át paramétereket.
...
Ha nincs \<LocalClusterName\> megadva , akkor a -rg lesz az erőforráscsoport neve.
