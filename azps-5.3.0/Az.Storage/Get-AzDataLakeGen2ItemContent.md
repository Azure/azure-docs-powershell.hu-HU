...
## LEÍRÁS
A **Get-AzDataLakeGen2ItemContent** parancsmag egy Azure-tárfiók fájlrendszerében található fájlt tölt le.
...
### 2. példa: Fájl letöltése, majd a folyamat egy helyi fájlba való letöltéséhez
```
