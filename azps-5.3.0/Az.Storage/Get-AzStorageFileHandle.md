...
## LEÍRÁS
A **Get-AzStorageFileHandle** parancsmag felsorolja a fájlmegosztások, illetve fájlkönyvtárak vagy fájlok fogópontját.
...
### 2. példa: A fájlkönyvtárak első 2 fájlfogópontját sorolja fel rekurzív módon
```
...
### -IncludeTotalCount
Az adathalmazban lévő objektumok számát (egész számot) és az objektumokat jelenti. Ha a parancsmag nem tudja megállapítani a teljes számát, akkor az "Ismeretlen teljes szám" értéket adja eredményül.
