...
## LEÍRÁS
A **New-AzStorageBlobSASToken** parancsmag egy Azure-tár blobhoz létrehoz egy SAS-jogkivonatot.
...
Ebben a példában egy blob SAS-jogkivonatot hoz létre teljes blob engedéllyel.

### 2. példa: Blob SAS-jogkivonat létrehozása az élettartammal
```
...
### 3. példa: Felhasználói identitású SAS-jogkivonat létrehozása OAuth-hitelesítésen alapuló tárterületkörnyezetben
```
...
Ebben a példában egy OAuth-hitelesítésen alapuló tárterületkörnyezetet használó User Identity blob SAS-jogkivonatot hoz létre.

## PARAMETERS

### -Blob
A tár blobnevét adja meg.
...
**CloudBlob-objektum** beszerzéséhez használja a [Get-AzStorageBlob](./Get-AzStorageBlob.md) parancsmagot.
...
Amikor a tárterületkörnyezet OAuth-hitelesítésen alapul, felhasználói identitás blob SAS-jogkivonatot hoz létre.
...
### -ExpiryTime
Azt adja meg, hogy mikor jár le a megosztott hozzáférés aláírása.
Ha a tárterület környezete OAuth-hitelesítésen alapul, a lejárati időnek a jelenlegi időponttól 7 napon belül kell lennie, és nem lehet korábbi az aktuális időpontnál.
...
### -Engedély
A tár blob engedélyeinek megadása. Fontos megjegyezni, hogy ez egy karakterlánc, például `rwd` (Olvasás, Írás és Törlés). 
