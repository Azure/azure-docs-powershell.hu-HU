...
## LEÍRÁS
A **New-AzStorageContainerStoredAccessPolicy** parancsmag tárolt hozzáférési házirendet hoz létre egy Azure-tárolóhoz.

## PÉLDÁK

### 1. példa: Tárolt hozzáférési házirend létrehozása egy tárolóban
```
PS C:\>New-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

Ez a parancs létrehoz egy Policy01 nevű hozzáférési házirendet a MyContainer nevű tárolóban.
...
### -Engedély
A tároló eléréséhez szükséges engedélyeket adja meg a tárolt hozzáférési házirendben.
