...
### 1. példa: ACL-rekurzív beállítása egy directiryre
```
...
Ez a parancs először létrehoz egy 3 acl bejegyzéssel egy ACL-objektumot, majd rekurzívan állítja be az ACL-t egy címtárban.

### 2. példa: Rekurzív ACL beállítása a fájlrendszer gyökér directiry-ján
```
...
### 4. példa: Acl rekurzív beállítása egy címtárban és a ContinueOnFailure-on, majd a hibákból való folytatás egyes-egyesben
```
