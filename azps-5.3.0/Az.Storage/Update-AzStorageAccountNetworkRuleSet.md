...
## LEÍRÁS
Az **Update-AzStorageAccountNetworkRuleSet** parancsmag frissíti egy tárfiók NetworkRule tulajdonságát

## PÉLDÁK

### 1. példa: A NetworkRule összes tulajdonságának frissítése, beviteli szabályok a JSON-nal
```
...
Ez a parancs frissíti a NetworkRule összes tulajdonságát, a beviteli szabályokat pedig JSON-nal.

### 2. példa: A NetworkRule megkerülő tulajdonságának frissítése
```
PS C:\> Update-AzStorageAccountNetworkRuleSet -ResourceGroupName "myResourceGroup" -AccountName "mystorageaccount" -Bypass AzureServices,Metrics
```

A NetworkRule ezen parancsfrissítési bypass tulajdonsága (más tulajdonságok nem változnak).

### 3. példa: Tárfiók NetworkRule-szabályainak tisztítása
```
...
Ez a parancs megtisztítja egy tárfiók NetworkRule szabályát (a többi tulajdonság nem változik).
...
Az engedélyezett érték a következő értékek egyike vagy kombinációja: • Naplózás • Metrikák • Azureservices
...
### -DefaultAction
A DefaultAction érték, amely egy tárfiók NetworkRule tulajdonságára frissít.
...
### -IPRule
A tárfiók NetworkRule tulajdonságára frissítendő IpRule-objektumok tömbje.
