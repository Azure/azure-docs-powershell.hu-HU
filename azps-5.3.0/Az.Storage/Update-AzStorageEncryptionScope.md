...
## LEÍRÁS
Az **Update-AzStorageEncryptionScope** parancsmag módosítja a tárfiók titkosítási hatókörét.

## PÉLDÁK

### 1. példa: Titkosítási hatókör letiltása
```
...
Ez a parancs letiltja a titkosítási hatókört.

### 2. példa: Titkosítási hatókör engedélyezése
```
...
Ez a parancs titkosítási hatókört tesz lehetővé.

### 3. példa: Titkosítási tartomány frissítése a Tártitkosítás használatára
```
...
Ez a parancs frissíti a titkosítási hatókört a Tártitkosítás használatára.

### 4. példa: Titkosítási tartomány frissítése a Keyvault-titkosítás használatára
```
...
Ez a parancs a Keyvault-titkosítás használatára egy titkosítási hatókört hoz fel.
...
### -State
Frissítési titkosítási hatókör állapota, Lehetséges értékek: "Engedélyezve", "Letiltva".
