...
## LEÍRÁS
Az **Update-AzStorageServiceProperty** parancsmag módosítja az Azure Storage szolgáltatás tulajdonságait.

## PÉLDÁK

### 1. példa: Blob-szolgáltatás DefaultServiceVersion beállítása 2017-04-17-re
```
C:\PS>Update-AzStorageServiceProperty -ServiceType Blob -DefaultServiceVersion 2017-04-17
```

Ez a parancs a Blobszolgáltatás DefaultServiceVersion-ének beállítása 2017-04-17-re
...
A DefaultServiceVersion azt az alapértelmezett verziót jelzi, amely a Blob szolgáltatáshoz érkező kérelmekhez használható, ha nincs megadva egy bejövő kérés verziója. A lehetséges értékek közé tartozik a 2008-10-27-es verzió és az összes újabb verzió. További részleteket itt talál: https://docs.microsoft.com/en-us/rest/api/storageservices/versioning-for-the-az-storage-services
