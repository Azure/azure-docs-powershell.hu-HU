...
## LEÍRÁS
Az **Update-AzSubscription** parancsmag frissíti az Azure-előfizetést
...
### -Művelet
Az előfizetésen végre kell hajtanunk egy műveletet
...
### -SubscriptionId
Frissítend kell az előfizetés azonosítóját
