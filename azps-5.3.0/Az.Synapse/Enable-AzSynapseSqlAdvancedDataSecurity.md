...
## LEÍRÁS
Az **Enable-AzSynapseSqlAdvancedDataSecurity** parancsmag lehetővé teszi a speciális adatbiztonságot a munkaterületeken. A Speciális adatbiztonság egy egységes biztonsági csomag, amely magában foglalja az adatbesorolást, a biztonsági rés felmérését és a komplex veszélyforrások elleni védelmet a munkaterületen. (Automatikusan létrejön egy új tárfiók a biztonsági rések felmérésére. Ha korábban erre a célra hoztak létre tárfiókot, azt használja a rendszer.
