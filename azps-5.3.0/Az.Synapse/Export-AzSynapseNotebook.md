...
## LEÍRÁS
Az **Export-AzSynapseNotebook** parancsmag egy Azure Synapse-jegyzetfüzetet exportál egy jegyzetfüzetfájlba (.ipynb). A jegyzetfüzet neve lesz az exportált fájl neve. Ha megadja egy jegyzetfüzet nevét, a parancsmag exportálja azt. Ha nem ad meg nevet, a parancsmag exportálja a munkaterület összes jegyzetfüzetét.
...
A ContosoWorkspace munkaterületen lévő összes jegyzetfüzet exportálása a "C:\Jegyzetfüzet" mappába.
...
Exportálja a ContosoWorkspace munkaterületen található ContosoNotebook nevű jegyzetfüzetet a "C:\Notebook" mappába.
...
A ContosoWorkspace munkaterületen található ContosoNotebook nevű jegyzetfüzet exportálása a "C:\Notebook" mappába folyamaton keresztül.
...
### -OutputFolder
Az a mappa, ahová a jegyzetfüzetet el kell helyezni.
