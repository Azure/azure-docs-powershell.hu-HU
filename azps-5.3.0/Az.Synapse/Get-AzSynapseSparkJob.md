...
### GetSparkBeállítássByIdParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **Get-AzSynapseSpark Job** parancsmag egy Azure Synapse Analytics Spark-feladatot kap.
...
Ez a parancs az összes munkakört egy értékkészlet alatt kapja meg.
...
Ez a parancs a megadott alkalmazásazonosítóval kapja meg a feladatot.
...
Ez a parancs egy sparkkészlet alatt található összes feladathoz folyamaton keresztül jut el.
