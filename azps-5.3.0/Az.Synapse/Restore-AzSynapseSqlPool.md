...
### RestoreFromBackupIdByNameParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **Restore-AzSynapseSqlPool** parancsmag visszaállítja az Azure Synapse Analytics SQL-készletet bármely SQL-készlet biztonsági másolatából vagy visszaállítási pontjából.
A visszaállított SQL-készlet új SQL-készletként jön létre.
...
Ez a parancs egy Azure Synapse Analytics SQL-készletet hoz létre úgy, hogy visszaállítja az előfizetés bármely SQL-készletének legutóbbi biztonsági másolatát.
...
Ez a parancs egy Azure Synapse Analytics SQL-készletet hoz létre úgy, hogy az előfizetés bármely SQL-készletéből visszaállítási pontot használva helyreállít vagy másol egy korábbi állapotot.
...
Ez a parancs létrehoz egy Azure Synapse Analytics SQL-készletet úgy, hogy visszaállítja az előfizetés bármely SQL-készletének legutóbbi biztonsági másolatát erőforrás-azonosítóval.
...
Ez a parancs egy Azure Synapse Analytics SQL-készletet hoz létre úgy, hogy az előfizetés bármely SQL-készletéből egy visszaállítási pontot használva helyreállít vagy másol egy erőforrás-azonosítóval egy korábbi állapotot.
...
Az erőforráscsoport neve, amelyből létre kell hozni az SQL-készletobjektumot.
...
### -BackupResourceId
A visszaállítható biztonsági másolat SQL-készletobjektum erőforrás-azonosítója.
...
### -BackupSqlPoolName
Annak az SQL-készletobjektumnak a neve, amelyből létre kell hoznia az SQL-készletet.
...
### -BackupWorkspaceName
A synapse workspace name of bakcup SQL pool object to create from.
...
### -FromBackup
Azt jelzi, hogy az előfizetésben az SQL-készlet legutóbbi biztonsági másolatából kell visszaállítani.
...
### -FromRestorePoint
Azt jelzi, hogy az előfizetés bármely SQL-készletéből ki kell használnia egy visszaállítási pontot egy korábbi állapot helyreállításához vagy egy korábbi állapotból való másoláshoz.
...
### -PerformanceLevel
Az SQL-készlethez hozzárendelni szükséges SQL-szolgáltatásréteg és teljesítményszint.
Például DW2000c.
...
### -RestorePoint
A visszaállítás pillanatfelvételi ideje.
...
A forrás SQL-készlet objektumának erőforráscsoportneve, amelyből létre kell hozni.
...
### -SourceResourceId
A forrás SQL-készlet objektumának erőforrás-azonosítója, amelyből létre kell hozni.
...
### -SourceSqlPoolName
A forrás SQL-készlet objektumának neve, amelyből létre kell hozni.
...
### -SourceWorkspaceName
A Synapse munkaterületének neve a forrás SQL-készlet objektumból, amelyből létre kell hoznia.
