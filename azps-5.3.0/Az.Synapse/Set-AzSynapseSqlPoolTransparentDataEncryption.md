...
## LEÍRÁS
A **Set-AzSynapseSqlPoolTransparentDataEncryption** parancsmag módosítja egy Azure Synapse Analytics SQL-készlet TDE tulajdonságát.
...
Ez a parancs engedélyezi a TDE-t a ContosoSqlPool nevű SQL-készlethez a ContosoWorkspace nevű munkaterület alatt.
...
### -State
Az Azure Synapse Analytics sql pool transparent data encryption state.
