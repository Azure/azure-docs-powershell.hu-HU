...
### 1. példa: Az összes hozzáférési házirend felsorolása egy adott környezetben
```powershell
...
Ez a parancs felsorolja az adott környezetben található összes hozzáférési házirendet.

### 2. példa: Megadott hozzáférési házirend lekért neve
```powershell
...
Ez a parancs egy megadott hozzáférési házirendet kap.

### 3. példa: Megadott hozzáférési házirend lekérte objektumról objektumra
```powershell
...
### -Name
A megadott környezethez társított Time Series Insights hozzáférési házirend neve.
