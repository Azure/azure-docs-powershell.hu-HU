...
Másik lehetőségként végpontokat is hozzáadhat a New-AzTrafficManagerEndpoint parancsmag használatával.
...
### -MonitorPort
Megadja a végpontok állapotának figyelése érdekében használt TCP-portot.
...
A forgalom útválasztási módját adja meg.
