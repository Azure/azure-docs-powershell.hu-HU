...
## LEÍRÁS
A **Get-AzWebAppBackupConfiguration** parancsmag lekérte egy Azure Web App biztonsági másolatát.
...
Ez a parancs a Biztonsági másolat típusú konfigurációt a Default-Web-WestUS erőforráscsoport WebAppStandard nevű webappjában kapja meg.
