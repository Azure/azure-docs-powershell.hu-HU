...
## LEÍRÁS
A **Remove-AzWebAppBackup** parancsmag eltávolítja az Azure Web App megadott biztonsági másolatát.
...
Ez a parancs eltávolítja a biztonsági mentést "12345" azonosítójú biztonsági másolattal a Default-Web-WestUS erőforráscsoporthoz tartozó WebAppStandard nevű webappból.

## PARAMETERS

### -BackupId
Biztonsági másolat azonosítója
