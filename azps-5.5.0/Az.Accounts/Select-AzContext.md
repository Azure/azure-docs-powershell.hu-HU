...
## LEÍRÁS
Válassza ki az Azure PowerShell-parancsmagok célként (vagy fiókként vagy bérlőként) kívánt előfizetését.  A parancsmag után a jövőbeli parancsmagok a kijelölt környezetre fognak célozni.
