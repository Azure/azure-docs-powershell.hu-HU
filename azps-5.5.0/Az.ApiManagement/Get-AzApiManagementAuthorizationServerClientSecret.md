...
## LEÍRÁS
A **Get-AzApiManagementAuthorizationServerClientSecret** parancsmag az Azure API Management engedélyezési kiszolgálójának ügyféltitkját kapja meg.

## PÉLDÁK

### 1. példa: Egy megadott engedélyezési kiszolgáló ügyfélprogram-titkos kódjának lekérte azonosító alapján
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Ez a parancs megkapja a megadott engedélyezési kiszolgáló cient-titkos nevét.
...
### -ResourceId
Az engedélyezési kiszolgáló erőforrás-azonosítója.
Ha meg van adva, a rendszer megpróbálja megtalálni az engedélyezési kiszolgálót az azonosító alapján.
Ezt a paramétert kötelező megadni.
...
### -ServerId
Az engedélyezési kiszolgáló azonosítója.
Ha meg van adva, az engedélyezési kiszolgálót az azonosító alapján fogja megtalálni.
