...
### Összestermék bekészítése (alapértelmezett)
```
...
## LEÍRÁS
A **Get-AzApiManagementProduct** parancsmag kap egy listát vagy egy adott terméket.

## PÉLDÁK

### 1. példa: Az összes termék lekérte
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementProduct -Context $apimContext
```

Ez a parancs az összes API-kezelési terméket beveszi.

### 2. példa: Termék lekérte azonosító szerint
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementProduct -Context $apimContext -ProductId "0123456789"
```

Ez a parancs azonosító szerint kap egy API-kezelési terméket.

## PARAMETERS

### -ApiId
Az Api ApiId-ját használva megkeresi a relált termékeket. Ez a paraméter nem kötelező.
...
### -Title
A keresve keresve megadott termék címe.
Ha meg van adva, a parancsmag megpróbálja cím szerint lekérte a terméket.
