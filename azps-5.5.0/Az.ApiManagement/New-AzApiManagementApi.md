...
## LEÍRÁS
A **New-AzApiManagementApi** parancsmag létrehoz egy Azure API Felügyeleti API-t.
...
Ez az API nyilvános neve, amely a fejlesztői és rendszergazdai portálon jelenik meg.
