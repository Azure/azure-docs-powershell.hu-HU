...
## LEÍRÁS
A **New-AzApiManagementDiagnostic** parancsmag létrehoz egy diagnosztikai entitást globális vagy adott Api-hatókörben.

## PÉLDÁK

### 1. példa: Új globális hatókörű diagnosztikai eszköz létrehozása
```powershell
...
Ez a példa egy diagnosztikai entitást hoz létre a globális hatókörben.

### 2. példa: Diagnosztikai eszköz létrehozása az Api hatókörében
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
A fenti példa létrehoz egy diagnosztikát az API számára a fejléc és `httpbin` a 100 bájtos törzs `azuremonitor` naplózásához.
...
Ha meg van adva, az API-hatókör házirendet fog beállítani.
