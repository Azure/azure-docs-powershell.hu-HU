...
### -Type
Csoport típusa. Az egyéni csoport felhasználó által definiált csoport. A rendszercsoport tartalmaz rendszergazdákat, fejlesztőket és vendégeket. Rendszercsoport nem hozható létre és nem frissíthető.  A külső csoport a külső identitásszolgáltatótól (például Azure Active Directory) származó csoportok. Ez a paraméter nem kötelező, és alapértelmezés szerint egyéni csoportként van megadva.
