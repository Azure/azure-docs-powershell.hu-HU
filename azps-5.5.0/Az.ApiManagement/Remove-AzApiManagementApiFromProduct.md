...
## LEÍRÁS
A **Remove-AzApiManagementApiFromProduct** parancsmag eltávolítja az Azure API Management API-t egy termékből.

## PÉLDÁK

### 1. példa: API eltávolítása egy termékből
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiFromProduct -Context $ApiMgmtContext -ProductId "0123456789" -ApiId "0001" -PassThru
```

Ez a parancs eltávolítja a megadott API-t egy termékből.

## PARAMETERS

### -ApiId
A termékből eltávolítható API azonosítója.
...
### -Környezet
Egy **PsApiManagementContext-et ad meg.**
...
### -PassThru
Azt jelzi, hogy ez a parancsmag sikeres $True értéket ad vissza, vagy $False értéket.
...
### -ProductId
Annak a terméknek az azonosítója, amelyből el szeretné távolítani az API-t.
