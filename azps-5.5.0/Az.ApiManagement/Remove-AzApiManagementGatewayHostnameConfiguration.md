...
## LEÍRÁS
A **Remove-AzApiManagementGatewayHostnameConfiguration** parancsmag eltávolít egy állomásnevet a meglévő átjáróból.

## PÉLDÁK

### 1. példa: Meglévő átjáró gazdakiszolgáló-konfigurációjának eltávolítása
```powershell
...
Ez a parancs eltávolít egy meglévő átjáró-állomásnevet, és nem kér megerősítést a felhasználótól.
...
A meglévő átjáró gazdakiszolgáló-konfigurációjának azonosítója.
Ezt a paramétert kötelező megadni.
...
### -InputObject
A PsApiManagementGatewayHostnameConfiguration példánya. Ezt a paramétert kötelező megadni.
...
### -ResourceId
Arm ResourceId of the GatewayHostnameConfiguration. Ezt a paramétert kötelező megadni.
