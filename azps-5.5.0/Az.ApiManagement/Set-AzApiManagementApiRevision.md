...
## LEÍRÁS
A **Set-AzApiManagementApiRevision** parancsmag módosítja az Azure API Felügyeleti API-változatot.

## PÉLDÁK

### 1. példa: API-változat módosítása
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementApiRevision -Context $ApiMgmtContext -ApiId "echo-api" -ApiRevision "2" -Name "EchoApi" -ServiceUrl "https://contoso.com/apis/echo" -Protocols @('https') -Description "Responds with what was sent" -Path "echo"
```

A parancsmag egy új leírással, protokollal és elérési útkal frissíti az `2` API `echo-api` átdolgozását.
...
### -ApiRevision
A meglévő API-változat azonosítója. Ezt a paramétert kötelező megadni.
...
Ez a paraméter nem kötelező.
Az alapértelmezett érték $null.
Ha az AuthorizationScope meg van adva, meg kell adni.
...
### -InputObject
A PsApiManagementApi példánya. Ezt a paramétert kötelező megadni.
...
### -Name
Web API-név.
Az API nyilvános neve úgy, ahogyan a fejlesztői és rendszergazdai portálon látható lenne.
Ezt a paramétert kötelező megadni.
...
### -PassThru
Ha ez meg van adva, akkor a Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApi típus képviseli a beállított API-t.
...
### -Protocols
Web API-protokollok (http, https).
...
### -ServiceUrl
A webszolgáltatás API-t kitűnő URL-címe.
Ezt az URL-címet csak az Azure API Management fogja használni, és nem teszi nyilvánosra.
...
Az előfizetés kulcsfejlécének neve.
Ez a paraméter nem kötelező.
Az alapértelmezett érték $null.
...
Az előfizetéskulcs lekérdezési karakterláncának paraméterneve.
Ez a paraméter nem kötelező.
Az alapértelmezett érték $null.
