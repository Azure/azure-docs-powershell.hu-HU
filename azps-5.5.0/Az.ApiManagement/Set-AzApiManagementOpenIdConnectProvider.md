...
## LEÍRÁS
A **Set-AzApiManagementOpenIdConnectProvider** parancsmag módosítja az OpenID Connect-szolgáltatót az Azure API Managementben.

## PÉLDÁK

### 1. példa: A szolgáltató ügyfél titkos jának módosítása
```powershell
...
Ez a parancs módosítja az OICProvider01 azonosítójú szolgáltatót.
A parancs a szolgáltató ügyfél-titkosítását adja meg.

### 2. példa

Módosít egy OpenID Connect-szolgáltatót. (automatikusan generált)
...
### -ClientId
A fejlesztői konzol ügyfélazonosítóját adja meg.
...
### -ClientSecret
Megadja a fejlesztői konzol ügyfélprogram-titkos elemét.
...
### -MetadataEndpointUri
A szolgáltató metaadat-végpontjának URI-ját adja meg.
...
Megadja annak a szolgáltatónak az azonosítóját, amely módosítja a parancsmagot.
...
### -PassThru
Azt jelzi, hogy ez a parancsmag a **psApiManagementOpenIdConnectProvider** értéket adja vissza, amely módosítja a parancsmagot.
