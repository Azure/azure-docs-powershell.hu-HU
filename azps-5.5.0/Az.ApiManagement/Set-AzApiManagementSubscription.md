...
## LEÍRÁS
A **Set-AzApiManagementSubscription** parancsmag beállítja a meglévő előfizetési adatokat.

## PÉLDÁK

### 1. példa: Az előfizetés állapotának, elsődleges és másodlagos kulcsának beállítása
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementSubscription -Context $apimContext -SubscriptionId -0123456789 -PrimaryKey "80450f7d0b6d481382113073f67822c1" -SecondaryKey "97d6112c3a8f48d5bf0266b7a09a761c" -State "Active"
```

Ez a parancs beállítja az előfizetés elsődleges és másodlagos kulcsait, és aktiválja azt.
...
A paraméternek 1 és 300 karakter között kell lennie.
...
### -StateComment
Az előfizetés állapotát ékes megjegyzésként adja meg.
A paraméter alapértelmezett értéke $Null.
