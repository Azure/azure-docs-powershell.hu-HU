...
## LEÍRÁS
Az **Update-AzApiManagementGateway** parancsmag konfigurálja az API-kezelési átjárót.
...
Ez a parancs konfigurál egy átjárót.
...
### -InputObject
A PsApiManagementGateway példánya. Ezt a paramétert kötelező megadni.
...
### -PassThru
Ha ez meg van adva, akkor a Módosított átjárót képviselő Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway típusú példány.
...
### -ResourceId
Arm ResourceId of the Gateway. Ezt a paramétert kötelező megadni.
