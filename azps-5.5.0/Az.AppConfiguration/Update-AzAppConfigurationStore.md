...
Ez a parancs lehetővé teszi az Azure Key Vaultban tárolt kulcs adattitkosítását egy rendszer által hozzárendelt felügyelt identitás használatával.
A tárolónak engedélyeznie kell a szoftveres törlés és a végleges törlés elleni védelmet, és a felügyelt identitásnak a következő kulcsengedélyekkel kell rendelkeznie: get, wrapKey, unwrapKey.
...
A "SystemAssignedAndUserAssigned" típus egy implicit módon létrehozott identitást és egy felhasználó által hozzárendelt identitáskészletet is tartalmaz.
...
INPUTOBJECT: <IAppConfigurationIdentity> Identity Parameter
  ...
  - `[GroupName <String>]`: A privát hivatkozás típusú erőforráscsoport neve.
