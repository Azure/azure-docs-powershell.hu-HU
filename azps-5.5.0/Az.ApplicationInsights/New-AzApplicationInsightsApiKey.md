...
### 1. példa: Új Api-kulcs létrehozása egy alkalmazásstatékony erőforráshoz
```
...
Az "testGroup" erőforráscsoport "testGroup" erőforráscsoportjának "ReadTelemetry", "WriteAnnotations" engedélyekkel rendelkező "testapiKey" típusú, "WriteAnnotations" engedélyekkel rendelkező alkalmazásstatizálási api kulcsleírását hozhatja létre.
...
### -Leírás
Leírás az API-kulcs azonosításához.
...
### -Engedélyek
Engedélyek, amelyek használatát az API-kulcs engedélyezi az alkalmazások számára.
