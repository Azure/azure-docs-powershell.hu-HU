...
## LEÍRÁS
A Get-AzAttestationPolicySigners parancsmag lekérte a megbízható házirend-aláírókat egy bérlőtől az Azure Attestation szolgáltatásban.
...
A *psh-test-rg* erőforráscsoportban az Attestation Provider *pshtest* szolgáltató megbízható házirend-aláíróit kapja meg.  Felhívjuk a figyelmét arra, hogy ehhez a szolgáltatóhoz nincsenek megbízható aláírók.
...
A *psh-test-rg* erőforráscsoportban az Attestation Provider *pshtest2* szolgáltató megbízható házirend-aláíróit kapja meg.  Felhívjuk a figyelmét arra, hogy ehhez a szolgáltatóhoz egy megbízható aláíró van bejegyzve.
...
Lekérte a megbízható házirend-aláírókat az Amerikai Egyesült Államok helymeghatározási alapértelmezett *szolgáltatójához.*  Felhívjuk a figyelmét arra, hogy az Alapértelmezett szolgáltatóhoz nem állnak megbízható aláírók.
...
### -DefaultProvider
Azt adja meg, hogy ez egy alapértelmezett szolgáltatóhoz való kérelem.
...
### -Location
Az alapértelmezett szolgáltató helyét adja meg.
