...
## LEÍRÁS
A Remove-AzAttestation parancsmag törli a megadott igazolást.
...
Törölje a *psh-test-rg* nevű *erőforráscsoport pshtest3* nevű szolgáltatóját az aktuális előfizetésből.
...
### -InputObject
Attestation object to bedeleted.
...
### -Name
Az eltávolítható igazolás nevét adja meg.
...
### -ResourceGroupName
Az eltávolítható Azure-attestation erőforráscsoport nevét adja meg.
