...
## LEÍRÁS
A **Get-AzAutomationDscConfiguration** parancsmag az APS-hez szükséges államkonfigurációs (DSC) konfigurációkat kap az Azure Automationtől.
...
### 2. példa: DSC-konfiguráció lekért név szerint
```
