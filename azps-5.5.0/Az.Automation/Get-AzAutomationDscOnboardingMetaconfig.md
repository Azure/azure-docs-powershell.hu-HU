...
A parancsmag létrehoz egy mappát az .mof fájlokhoz.
A mappához Set-DscLocalConfigurationManager parancsmag futtatásával DSC-csomópontokként használhatja ezeket a számítógépeket egy Azure Automation-fiókba.

## PÉLDÁK

### 1. példa: Az Automatizálási DSC kiszolgálói
```
