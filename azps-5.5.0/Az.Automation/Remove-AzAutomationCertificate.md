...
## LEÍRÁS
A **Remove-AzAutomationCertificate** parancsmag eltávolítja a tanúsítványokat az Azure Automationből.
...
Ez a parancs eltávolítja a Cert01 nevű tanúsítványt a Contoso17 nevű automatizálási fiókból.

## PARAMETERS

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelyből a parancsmag eltávolítja a tanúsítványt.
...
### -Name
Annak a tanúsítványnak a nevét adja meg, amelyről a parancsmag eltávolítja.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyből a parancsmag eltávolítja a tanúsítványt.
