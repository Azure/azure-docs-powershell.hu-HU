...
## LEÍRÁS
A **Remove-AzAutomationDscConfiguration** parancsmag eltávolítja a kívánt APS-konfigurációkat az Azure Automationből.

## PÉLDÁK

### 1. példa

Eltávolítja a DSC-konfigurációkat az automatizálásból. (automatikusan generált)
...
Annak az automatizálási fióknak a nevét adja meg, amely a parancsmag által eltávolított DSC-konfigurációkat tartalmazza.
...
### -Name
A parancsmag által eltávolított DSC-konfiguráció nevét adja meg.
