...
## LEÍRÁS
A **Set-AzAutomationSchedule** parancsmag módosítja az ütemezést az Azure Automationben.

## PÉLDÁK

### 1. példa: Ütemezés módosítása
```
...
Ez a parancs módosítja az Ütemezés01 nevű ütemezés leírását.

## PARAMETERS

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelynek a parancsmagja módosítja az ütemezést.
...
### -IsEnabled
Meghatározza, hogy ez a parancsmag engedélyezi-e az ütemezést.
...
### -Name
Megadja annak az ütemezésnek a nevét, amit ez a parancsmag módosít.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelynek a parancsmagja módosítja az ütemtervet.
