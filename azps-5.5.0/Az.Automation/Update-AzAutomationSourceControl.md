...
## LEÍRÁS
A Update-AzAutomationSourceControl parancsmag módosítja egy mező értékét az Azure Automation forrásvezérlőiben.

## PÉLDÁK

### 1. példa
Ez a parancs hamisra állítja a PublishRunbook mezőt a VSTSNative nevű Azure Automation forrásvezérlőhöz a devAccount nevű fiókban.
...
Frissíti az Azure Automation forrásvezérlőt. (automatikusan generált)
