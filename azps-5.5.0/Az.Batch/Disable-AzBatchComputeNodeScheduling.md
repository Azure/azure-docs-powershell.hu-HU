...
Ha egy számítási csomóponton letiltja a feladatütemezést, eldöntheti azt is, hogy mit kell tenni a csomópont feladatsorában jelenleg található feladatokkal.
...
- Várja meg, amíg az összes jelenleg végrehajtott feladat befejeződik, majd tiltsa le a feladatütemezést a számítási csomóponton. 
...
Ezek a parancsok letiltják a tevékenységütemezést a Készletkészlet összes számítógépcsomópontán.
...
Mivel a *DisableComputeNodeSchedulingOptions* paraméter nem tartalmazta a számítási csomópontokon jelenleg futó feladatokat, a rendszer újraszámítja őket.
