...
## LEÍRÁS
A **Get-AzBatchCertificate** parancsmag a *BatchContext* paraméter által megadott Azure Batch-fiók tanúsítványait kapja meg.
Egy adott tanúsítvány beszerzéséhez adja meg a *ThumbprintAlgorithm és* *a Thumbprint paramétert.*
Adja meg *a Szűrő* paramétert az OData-szűrőnek megfelelő tanúsítványok be szereznie.

## PÉLDÁK

### 1. példa: Tanúsítvány lekérve thumbprint-sal
```
...
Ez a parancs egyetlen tanúsítványt kap, amely rendelkezik a megadott thumbprint-sal.
A tanúsítvány thumbprint algoritmusa sha1.

### 2. példa: Szűrt tanúsítványok lekérte
```
...
Ez a parancs az aktív állapotban lévő összes tanúsítványt a Batch-fiókból kapja meg.
A *Szűrő* paraméter az államot határozza meg.
...
Ha ezt a paramétert adja meg, ez a parancsmag a szűrőnek megfelelő tanúsítványokat kapja.
...
### -MaxCount
Azt adja meg, hogy legfeljebb hány tanúsítványt kell visszaadni.
...
### -Thumbprint
A parancsmag által lekért tanúsítvány thumbprintja.
...
### -ThumbprintAlgorithm
A Thumbprint paraméter *levezető algoritmusa.*
