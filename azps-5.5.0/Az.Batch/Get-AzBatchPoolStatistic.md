...
## LEÍRÁS
A **Get-AzBatchPoolStatistic** parancsmag lekérte a megadott fiók összes készletének élettartam-statisztikáját.
A statisztikák a fiókban már létező összes készlet összesítve létezik, a fiók létrehozásától a statisztika legutóbbi frissítésének időpontig.

## PÉLDÁK

### 1. példa: Egy fiók összes készletének erőforrás-statisztikája
```
...
A második parancs bekérte a megadott fiók összes készletének statisztikáját, majd a $PoolStatistics.
Az utolsó parancs  megjeleníti a $PoolStatistics.
