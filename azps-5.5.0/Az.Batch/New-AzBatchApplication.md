...
## LEÍRÁS
A **New-AzBatchApplication** parancsmag hozzáad egy alkalmazást a megadott Azure Batch-fiókhoz.

## PÉLDÁK

### 1. példa: Üres alkalmazás hozzáadása kötegfiókhoz
```
...
Ez a parancs létrehozza a Litware alkalmazást a ContosoBatch-fiókban.
Az alkalmazás kezdetben nem tartalmaz csomagokat.

## PARAMETERS

### -AccountName
Annak a Batch-fióknak a nevét adja meg, amelyhez ez a parancsmag hozzáad egy alkalmazást.
