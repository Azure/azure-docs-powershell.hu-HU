...
Ez a parancs hozzáad egy tanúsítványt a megadott Batch-fiókhoz az E:\Certificates\MyCert.cer fájl használatával.
...
Az első parancs felolvassa a MyCert.pfx nevű fájl adatait a $RawData változóba.
A második parancs hozzáad egy tanúsítványt a megadott Batch-fiókhoz a $RawData.
...
### -FilePath
A tanúsítványfájl elérési útját adja meg.
A tanúsítványfájlnak .cer vagy .pfx formátumúnak kell lennie.
...
### -Kind
A létrehozni szükséges tanúsítvány fajtája. Ha ez nincs megadva, akkor a jelszó nélküli összes tanúsítvány a CER, a jelszóval pedig a PFX.
...
### -Password
Megadja a tanúsítvány titkos kulcshoz való hozzáférésének jelszavát.
Ezt a paramétert akkor kell megadnia, ha .pfx formátumban ad meg tanúsítványt.
...
### -RawData
A nyers tanúsítvány adatait adja meg .cer vagy .pfx formátumban.
