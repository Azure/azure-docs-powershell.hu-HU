...
A készlet úgy van konfigurálva, hogy virtuális gépeket használjon STANDARD_D1_V2 Windows-2016-Datacenter operációs rendszer lemezképével, és a számítási csomópontok célszámát az automatikus skálázási képlet határozza meg.
...
Azt az időt adja meg percben, amely eltelik, mielőtt a készlet mérete automatikusan módosul az automatikus skálázási képletnek megfelelően.
...
A készlet konfigurációs beállításait adja meg az Azure felhőszolgáltatás platformján.
...
### -Metadata
Az új készlethez hozzáadni megfelelő metaadatokat adja meg kulcs-érték párokként.
...
A készlet számára lefoglalható dedikált számítási csomópontok célszámát adja meg.
