...
Szerezze be az adott számlát név szerint, és írja be a letöltési URL-címet az eredménybe.
...
A legújabb számlát a számlázási fiók nevével töltheti le, és az eredményben a számla letöltési URL-címét is meg kell kapnia.
...
### -BillingProfileName
Annak a számlázási profilnak a neve, amelyről számlát kell kapnia.
