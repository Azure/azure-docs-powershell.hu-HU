...
## LEÍRÁS
A **Get-AzConstionPriceSheet** parancsmag az előfizetés árlapját kapja meg.

## PÉLDÁK

### 1. példa: Árlapok lekérte
```powershell
...
### 2. példa: Árlapok lekérte a MeterDetails bővítve
```powershell
...
### 3. példa: A BillingPeriodName árlapja
```powershell
...
### 4. példa: Az árlapok első 5 rekordja
```powershell
...
### -BillingPeriodName
Annak a számlázási időszaknak a neve, amelybe be kell szerezni a hozzá társítani megfelelő árlapokat.
...
### -ExpandMeterDetail
Bontsa ki az árlapokat a MeterDetails alapján.
