...
### 2. példa: Foglalási adatok lekérte a foglalási rendelés azonosítójával és a megadott dátumtartományhoz megadott foglalásazonosítóval
```powershell
...
### -EndDate
A foglalás részleteinek záró adatai (YYYY-HH-DD az UTC-ben).
