...
## LEÍRÁS
A **Get-AzConstionReservationSummary** parancsmag foglalási összegzést kap a napi vagy havi adatokról.
...
### 4. példa: Foglalási összegzések lekérte a foglalási rendelés azonosítójával és a foglalásazonosítóval a naponta megadott dátumtartományhoz
```powershell
...
### -EndDate
A foglalás összefoglalásának záró adatai (YYYY-HH-DD az UTC-ben) csak a napi adatokhoz szükségesek.
