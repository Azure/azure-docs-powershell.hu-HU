...
### 1. példa: A tranzakciós csomópont Api-kulcsait név használatával újragenerálhatja.
```powershell
...
Ez a parancs Api-kulcsokat hoz létre egy tranzakciós csomóponthoz név, erőforráscsoport használatával.

### 2. példa: Az Api-kulcsok újragenerálása tranzakciós csomóponthoz
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
Ez a parancs api-kulcsokat hoz létre egy tranzakciós csomóponthoz idenity használatával.
...
### -KeyName
Beállítja vagy beállítja az API-kulcs nevét.
...
### -Érték
Beállítja vagy beállítja az API-kulcs értékét.
