...
## SYNOPSIS
Annak ellenőrzése, hogy elérhető-e egy erőforrás neve.
...
### 1. példa: Annak ellenőrzése, hogy elérhető-e egy erőforrás neve
```powershell
...
A parancs ellenőrzi, hogy elérhető-e egy erőforrás neve.

### 2. példa: Annak ellenőrzése, hogy elérhető-e egy erőforrás neve
```powershell
...
### -Name
Beállítja vagy ellenőrzi a nevet.
...
### -Type
Beállítja vagy beállítja az ellenőrizni szükséges erőforrás típusát.
