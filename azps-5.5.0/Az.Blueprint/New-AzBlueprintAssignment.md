...
## LEÍRÁS
Tervrajzdefiníció hozzárendelése előfizetéshez.
...
A megadott előfizetésben a megadott paraméter- és erőforráscsoportszótár használatával létrehozhat egy új tervrajz-hozzárendelést a `$blueprintObject` tervdefinícióhoz. Rendszer által hozzárendelt identitást használ. A hely határozza meg a felügyelt identitás létrehozására vonatkozó régiót.
...
Hozzon létre egy új tervrajz-hozzárendelést a megadott előfizetésben a megadott paraméter- és erőforráscsoportszótár alapján, és konfigurálja az erőforrászárolást az `$blueprintObject` **AllResources szolgáltatásban.** Alapértelmezés szerint a rendszer által hozzárendelt identitást használja.  A hely határozza meg a felügyelt identitás létrehozására vonatkozó régiót.
...
A megadott előfizetésben a megadott paraméter- és erőforráscsoport-szótár használatával létrehozhatja a tervdefiníció új tervrajz-hozzárendelését a megadott felhasználó által hozzárendelt `$blueprintObject` identitásazonosító használatával.
...
Terv-hozzárendelés létrehozása egy feladatfájlon keresztül. A feladatfájl formátuma a kérelem/válasz mintáiban található: https://github.com/Azure/azure-rest-api-specs/tree/master/specification/blueprint/resource-manager/Microsoft.Blueprint/preview/2018-11-01-preview/examples
...
Hozzon létre egy új tervrajz-hozzárendelést a megadott előfizetéshez a megadott felügyeleti csoporton belül a megadott paraméter `$blueprintObject` használatával.
...
### -SubscriptionId
Előfizetés azonosítója a tervrajzdefiníció hozzárendeléséhez.
