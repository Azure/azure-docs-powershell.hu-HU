...
### BySubscriptionAndName (alapértelmezett)
```
...
## LEÍRÁS
Távolítsa el az előfizetéshez hozzárendelt tervrajzot.
...
Távolítsa el a névvel megadott tervrajz-hozzárendelést a megadott előfizetésből. A parancsmag megerősítést kér a parancs végrehajtása előtt.
...
### -ManagementGroupId
Annak a felügyeleti csoportnak az azonosítója, amelybe a Tervrajz feladatot mentette.
...
### -PassThru
Ha be van állítva, a parancsmag visszaadja az eltávolított Tervrajz hozzárendelést képviselő objektumot. Ez a parancsmag alapértelmezés szerint nem hoz létre kimenetet.
...
### -SubscriptionId
Előfizetés azonosítója: A terv hozzárendelése telepítve van.
