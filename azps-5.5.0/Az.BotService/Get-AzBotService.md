...
### 1. példa: Az összes BotServices lekérte
```powershell
...
Az összes botszolgáltatás lekérte

### 2. példa: A BotService lekérte a ResourceGroupName és a Name nevet
```powershell
...
A BotService lekérte: ResourceGroupName and Name

### 3. példa: Az összes BotServices lekérte a ResourceGroupName szerint
```powershell
...
Az összes BotServices lekérte a ResourceGroupName szerint

### 4. példa: A BotService lekérte az inputObject által
```powershell
...
A BotService lekérte: inputObject
