...
Új robot létrehozása ResourceGroupName és ApplicationId szerint

### 2. példa: Új webalkalmazás létrehozása
```powershell
...
Új webalkalmazás létrehozása a ResourceGroupName és az ApplicationId alapján
