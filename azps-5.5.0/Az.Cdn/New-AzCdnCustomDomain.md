...
## LEÍRÁS
A **New-AzCdnCustomDomain** parancsmag létrehoz egy egyéni tartományt az Azure Content Delivery Network (CDN) végponthoz.
...
### -CdnEndpoint
Azt a CDN-végpontobjektumot adja meg, amelyhez az egyéni tartományt hozzáadta.
...
### -CustomDomainName
Az egyéni tartomány erőforrásnevét adja meg.
