...
Hozzon létre egy egyszerű feltételt.
...
### -MatchValue
Az egyezések lehetséges értékeinek listája.
...
### -NegateCondition
Azt ismerteti, hogy a feltétel eredményét negatáltként kell-e eredményül írni.
...
### -Választó
Az egyezni kívánt választó neve
...
### -Átalakítás
Átalakítás az alkalmazáshoz az egyezés előtt.
Lehetséges értékek: Kisbetű és Nagybetű
...
### Microsoft.Azure.Commands.Cdn.Models.Endpoint.PSDRuleCondition
