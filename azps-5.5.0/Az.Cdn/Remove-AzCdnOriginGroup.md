...
## LEÍRÁS
Remove-AzCdnOriginGroup egy CDN-forráscsoportot a megadott végpontról. 
...
Ez a parancsmag eltávolítja a megadott origincsoportot a megadott végpontról. 
...
### -ResourceId
Az Azure CDN-forráscsoport erőforrás-azonosítója.
