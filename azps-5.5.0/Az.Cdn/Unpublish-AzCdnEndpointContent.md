...
## LEÍRÁS
Az **Unpublish-AzCdnEndpointContent parancsmag** véglegesen leküldi az Azure Content Delivery Network (CDN) végpont tartalmát.
...
### -CdnEndpoint
A parancsmag véglegesként megadott végpontját adja meg.
...
### -EndpointName
Annak a végpontnak a nevét adja meg, amelytől a parancsmag véglegesen végleges.
...
### -PurgeContent
A forráskiszolgálón található azon tartalom relatív elérési útvonalának tömbje, amelyből a parancsmag véglegesen elromosodik.
