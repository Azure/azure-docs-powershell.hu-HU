...
### 1. példa: Felhőszolgáltatás példányának megtekintése
```powershell
...
Ez a parancsmag a ContosoCS nevű felhőszolgáltatás példánynézetét kapja meg, amely a ContosOrg nevű erőforráscsoporthoz tartozik.
