...
### 1. példa: Hálózati felületek lekérte a felhőszolgáltatás nevét
```powershell
...
Egy adott felhőbeli szolgáltatásnév összes hálózati felületét beveszi.

### 2. példa: Hálózati felületek lekérte a felhőszolgáltatás-objektumokat
```powershell
...
Egy adott felhőszolgáltatás-objektum összes hálózati felületét beveszi.

### 3. példa: Hálózati felületek lekérte egy felhőalapú szolgáltatásobjektum és szerepkörpéldány neve alapján.
```powershell
PS C:\> Get-AzCloudServiceNetworkInterfaces -CloudService $cs -RoleInstanceName WebRole1_IN_0

```

Egy adott felhőszolgáltatás-objektum és szerepkörpéldány nevének összes hálózati felületét beszeri.
...
<CloudService>CLOUDSERVICE: CloudService példány.
