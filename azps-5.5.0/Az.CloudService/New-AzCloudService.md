...
Ennek létrehozásáról az OSPROFILE tulajdonságairól és egy kivonattábláról a NOTES (JEGYZETEK) című szakaszban található.
...
A FELépítésről a NOTES (JEGYZETEK) szakaszban található a ROLEPROFILE tulajdonságok és a hash tábla létrehozása.
