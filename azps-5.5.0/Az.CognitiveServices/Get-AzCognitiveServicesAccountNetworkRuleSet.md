...
## LEÍRÁS
A **Get-AzCognitiveServicesAccountNetworkRuleSet** parancsmag egy Kognitív szolgáltatások-fiók NetworkRule tulajdonságát kapja meg

## PÉLDÁK

### 1. példa: Adott Kognitív Szolgáltatások-fiók NetworkRule tulajdonságának be szereznie
```
PS C:\> Get-AzCognitiveServicesAccountNetworkRuleSet  -ResourceGroupName "rg1" -Name "myaccount"
```

Ez a parancs egy adott Kognitív szolgáltatások-fiók NetworkRule tulajdonságát kapja meg
