...
## SYNOPSIS
Egy Azure értesítési központot erre a kommunikációs szolgáltatásra mutató hivatkozásokkal hoz létre.

## SZINTAXIS

### LinkExpanded (alapértelmezett)
```
...
## LEÍRÁS
Egy Azure értesítési központot ehhez a kommunikációs szolgáltatáshoz kapcsolódik.

## PÉLDÁK

### 1. példa: Az értesítési központ részleteinek interaktív megküldése
```powershell
...
A csatolt értesítési központ lehetővé teszi az ACS-erőforrásoknak, hogy bizonyos eseményekről értesítéseket küldjenek.
...
### -ConnectionString
Az értesítési központ kapcsolati karakterlánca
...
Annak az Azure Értesítési központnak a leírása, amely csatolva van a létrehozni szükséges kommunikációs szolgáltatáshoz, a NOTES (JEGYZETEK) szakaszban találja a LINKNOTIFICATIONHUBPARAMETER tulajdonságokat, és hozzon létre egy kivonattáblát.
...
Az értesítési központ erőforrás-azonosítója
...
LINKNOTIFICATIONHUBPARAMETER: A kommunikációs szolgáltatáshoz csatoló Azure értesítési központ <ILinkNotificationHubParameters> leírása
  - `ConnectionString <String>`: Az értesítési központ kapcsolati karakterlánca
  - `ResourceId <String>`: Az értesítési központ erőforrás-azonosítója
