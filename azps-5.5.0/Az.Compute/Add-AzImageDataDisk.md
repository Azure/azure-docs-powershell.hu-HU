...
## LEÍRÁS
Az **Add-AzImageDataDisk** parancsmag adatlemezt ad egy képobjektumhoz.
...
A következő három parancs az operációs rendszer lemezének elérési útját és két adatlemezt rendel a $osDiskVhdUri, $dataDiskVhdUri 1 és $dataDiskVhdUri 2 változóhoz.
Ez a megközelítés csak az alábbi parancsok olvashatóságát közelíti meg.
A következő három parancs hozzáad egy operációs rendszerlemezt és két adatlemezt a $imageConfig.
Az egyes lemezeket a $osDiskVhdUri, a $dataDiskVhdUri 1 és a $dataDiskVhdUri 2 tárolja.
Az utolsó parancs létrehoz egy ImageName01 nevű képet az Erőforráscsoport01 erőforráscsoportban.

## PARAMETERS

### -BlobUri
A blob URI-ként való hivatkozását adja meg.
...
### -DiskSizeGB
A lemez gigabájtban (GB) megadott mérete.
