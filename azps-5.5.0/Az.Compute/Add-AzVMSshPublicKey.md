...
## LEÍRÁS
Az **Add-AzVMSshPublicKey** parancsmag hozzáadja a Linux virtuális géphez a Secure Shell (SSH) rendszeren keresztüli csatlakozáshoz használható nyilvános kulcsokat. Ez nem használható a VM létrehozása után, ha azt követően próbálja ezt használni, hogy a VM update-AzVM nélküli létrehozása után nem történik hiba, ha az Update-AzVM paranccsal használja a parancsot, a parancs hibaüzenetet kap.
