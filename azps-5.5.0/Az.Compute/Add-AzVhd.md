...
## LEÍRÁS
Az **Add-AzVhd** parancsmag rögzített virtuális merevlemezek formájában feltölti a helyszíni virtuális merevlemezeket .vhd fájlformátumban egy blobtároló fiókba.
Konfigurálhatja a használni fogja a feltöltőszálak számát, vagy felülírhat egy meglévő blobot a megadott cél URI-ban.
