...
## LEÍRÁS
Az **Add-AzVmssDataDisk** parancsmag hozzáad egy adatlemezt a VIRTUÁLISgép-mérethalmaz (VMSS) példányhoz.
...
Ez a parancs egy üres adatlemezt ad a VMSS-objektumhoz.

## PARAMETERS

### -Gyorsítótárazás
A lemez gyorsítótárának típusát határozza meg.
...
### -DiskIOPSReadWrite
A felügyelt lemez Read-Write IOPS-át adja meg. Csak akkor érdemes használni, ha a StorageAccountType UltraSSD_LRS. Ha nincs megadva, a rendszer a diskSizeGB alapján rendeli hozzá az alapértelmezett értéket.
...
### -DiskMBpsReadWrite
A felügyelt lemez sávszélességét adja meg MB/másodpercben. Csak akkor érdemes használni, ha a StorageAccountType UltraSSD_LRS. Ha nincs megadva, a rendszer a diskSizeGB alapján rendeli hozzá az alapértelmezett értéket.
...
### -StorageAccountType
A lemez tárfióktípusát adja meg.
