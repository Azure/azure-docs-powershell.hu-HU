...
## SYNOPSIS
A VMSS-hez hozzáadja a hálózati felület konfigurációját.
...
A DNS-beállítások DNS-kiszolgálói IP-címeinek listája.
...
### -Primary
Azt jelzi, hogy a hálózati felület konfigurációja alapján létrehozott hálózati felületek lesznek-e a virtuális gép elsődleges hálózati információs központja (NIC).
