...
## LEÍRÁS
A **Get-AzContainerService** parancsmag tárolószolgáltatást kap.
Megtekintheti egy tárolószolgáltatás tulajdonságait, például az állapotot, a főkiszolgáló és az ügynökök számát, valamint a főkiszolgáló és az ügynök teljes tartománynevét.

## PÉLDÁK

### 1. példa: Tárolószolgáltatás lekérte
```
...
Ez a parancs egy CSResourceGroup17 nevű tárolószolgáltatást kap.

### 2. példa: Az összes tárolószolgáltatás lekérte
```
...
Ez a parancs az előfizetésben található összes tárolószolgáltatást lekérte.

### 3. példa: Az összes tárolószolgáltatás lekérte az erőforráscsoportban
```
...
Ez a parancs az ResourceGroup17 összes tárolószolgáltatását beveszi.

### 4. példa: Az összes tárolószolgáltatás lekérte a szűrőt
```
...
Ez a parancs az összes tárolószolgáltatást a "CSResourceGroup1" szótól kezdve kapja meg.
...
### -Name
Annak a tárolószolgáltatásnak a neve, amelybe ez a parancsmag be lesz stb.
...
### -ResourceGroupName
Annak a tárolószolgáltatásnak az erőforráscsoportját adja meg, amelybe ez a parancsmag kerül.
