...
Adja meg *az Állapot* paramétert, hogy egy virtuális gép példánynézetét használja az alapértelmezett modellnézet helyett.
...
### 4. példa: Az előfizetés összes virtuális gépének lekérte
```
PS C:\> Get-AzVM
