...
Ez a parancs létrehozza a megadott termékváltozat állomását az adott gazdacsoportban és a megadott helyen.
...
Azt adja meg, hogy hiba esetén az állomást automatikusan cserélje-e le a rendszer. Ha nincs megjelölve, az érték alapértelmezés szerint "igaz" lesz.
...
### -LicenseType
Azt a szoftverlicenc-típust adja meg, amely az állomáson telepített virtuális gépekre fog vonatkozni. Lehetséges értékek: Nincs, Windows_Server_Hybrid és Windows_Server_Perpetual.  Az alapértelmezett érték a Nincs.
...
### -PlatformFaultDomain
Az állomás platformhiba-tartományának számát adja meg.  Ezután a minimális érték 0, a maximális érték pedig 2.
...
### -Sku
A termékváltozat nevét adja meg.
