...
A következő három parancs az operációs rendszer lemezének és két adatlemezének elérési útját rendeli a $osDiskVhdUri, $dataDiskVhdUri 1 és $dataDiskVhdUri 2 változóhoz. Ez a módszer csak az alábbi parancsok olvashatóságát közelíti meg.
...
### -HyperVGeneráció
A képből létrehozott virtuális gép HiperVGeneráció típusát adja meg.  Az engedélyezett értékek a V1 és a V2.
...
A forrás virtuális számítógép azonosítója.
...
### -ZoneResilient
A zóna ellenállóvá tételének engedélyezése
