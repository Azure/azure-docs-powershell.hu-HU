...
Konfigurálható pillanatkép-objektumot hoz létre. (automatikusan generált)
...
### -ImageReference
Egy pillanatfelvétel képhivatkozását adja meg.
...
### -Növekményes
Növekményes pillanatképet ad meg. A növekményes pillanatfelvételek ugyanazon a lemezen kevesebb helyet foglalnak el, mint a teljes pillanatfelvételek, és meg is különböztethetőek.
