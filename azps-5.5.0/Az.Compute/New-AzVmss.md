...
A fenti összetett példa VMSS-et hoz létre, és az alábbiakban látható, hogy mi történik:
...
### -EnableUltraSSD
Használja az UltraSSD-lemezeket a virtuális gépekhez a méretaránykészletben.
...
### -Priority
A virtuális gép prioritása a méretaránykészletben.  Csak a "Normál", a "Direkt" és a "Gyenge" érték támogatott.
...
### -VmSize
A virtuális gép példányainak mérete ebben a méretkészletben.  Alapértelmezett méret (Standard_DS1_v2) fog használni, ha nincs megadva méret.
