...
Ez a parancs .zip-csomagot hoz létre az adott parancsprogramhoz és a függő erőforrásmodulhoz, és a helyi fájlban tárolja a .\MyConfiguration.ps1.zip.
...
### -AdditionalPath
A konfigurációs archívumban szerepeletni kívánt fájl vagy címtár elérési útját adja meg.
