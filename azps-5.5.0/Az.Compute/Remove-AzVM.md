...
## LEÍRÁS
A **Remove-AzVM** parancsmag eltávolít egy virtuális gépet az Azure-ból.

## PÉLDÁK

### 1. példa: Virtuális gép eltávolítása
```
PS C:\> Remove-AzVM -ResourceGroupName "ResourceGroup11" -Name "VirtualMachine07"
```

Ez a parancs eltávolítja a VirtualMachine07 nevű virtuális gépet az ResourceGroup11 erőforráscsoportban.
