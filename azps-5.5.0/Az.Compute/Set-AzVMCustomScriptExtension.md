...
### -Run
A parancsfájlt futtató parancs megadása.
...
A *Futtatás mező* értéke tartalmazhat a biztonságos parancsfájlnak átadni kívánt titkos információkat vagy jelszavakat.
...
A verzió beszerzéséhez futtassa a Get-AzVMExtensionImage parancsmagot a *PublisherName* és a CustomScriptExtension paraméter Microsoft.Compute értékével a *Type paraméterhez.*
