...
Ha a diagnosztikai konfiguráció nem ad meg tárfióknevet, vagy felül szeretné írni a konfigurációs fájlban megadott diagnosztikai tárfiók nevét, használja a *StorageAccountName* paramétert.
A diagnosztikai tárfióknak ugyanabban az előfizetésben kell lennie, mint a virtuális gépnek.
...
A verzió beszerzéséhez futtassa a Get-AzVMExtensionImage parancsmagot a *PublisherName* paraméterhez a Microsoft.Compute értékkel, a Type paraméterhez pedig a VMAccessAgent *parancsmagot.*
