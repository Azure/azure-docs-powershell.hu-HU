...
### -AdminUsername
Megadja azt a rendszergazdai fióknevet, amely a VMSS-ban található összes virtuális gépi példányhoz használható. <br>
...
Az objektum létrehozásához Add-AzVMSshPublicKey parancsmagot.
