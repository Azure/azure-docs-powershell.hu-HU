...
### 1. példa: Csatlakoztatott kumernetek eltávolítása
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Ez a parancs eltávolítja a csatlakoztatott kuberneteket

### 2. példa: Csatlakoztatott időhálózatok eltávolítása objektum alapján
```powershell
...
Ez a parancs objektum szerint eltávolítja a csatlakoztatott kuberneteket
