...
## LEÍRÁS
A bővítmény létrehozására vagy frissítésére használt művelet.
...
EXTENSIONPARAMETER: <IMachineExtensionUpdate> Gépi bővítményfrissítést ismertet.
  ...
  - `[Setting <IMachineExtensionUpdatePropertiesSettings>]`: A bővítmény Json által formázott nyilvános beállításai.
