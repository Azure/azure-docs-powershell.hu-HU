...
Ez a parancs a legújabb nginx-kép alapján létrehoz egy tárolócsoportot, és nyilvános IP-címet kér a 8000-es port megnyitásához.
...
Ez a parancs létrehoz egy tárolócsoportot, amely kiírja a "hello" és a stops (hello) nyomatot.
...
Ez a parancs létrehoz egy rendszerhez rendelt identitást tartalmazó tárolócsoportot a legújabb nginx-kép használatával, és nyilvános IP-címet kér a 8000-es port megnyitásához.
