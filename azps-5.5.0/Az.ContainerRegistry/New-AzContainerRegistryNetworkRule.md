...
## LEÍRÁS
Hozzon létre egy hálózati szabályobjektumot az aktuális PowerShell-munkamenetben.
...
Virtuálisnetwork szabálykészlet létrehozása.

## PARAMETERS

### -Action
A hálózati szabály művelete.
...
### -IPAddressOrRange
Az IP- vagy IP-tartomány CIDR formátumban való megadása.
Csak IPV4-cím engedélyezett.
...
### -IPRule
Adja meg, hogy létre kell hoznia az IPRule protokollt.
...
Egy alhálózat erőforrás-azonosítója, például: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/alhálózatok/{alnetName}.
...
### -VirtualNetworkRule
A VirtualNetworkRule létrehozására utal.
