...
## SYNOPSIS
Szerezze be a Keys{"ConnectionKeys", a "PrimaryReadOnly" vagy a "Keys"} billentyűparancsot az adott CossDB-fiókhoz. 
...
## LEÍRÁS
A kapcsolatbillentyűk listájának lekérte.
...
A 2010-es fiók kulcsait sorolja fel. A kulcstípus értéke a következő lehet: ConnectionStrings, Keys and ReadOnlyKeys. Az alapértelmezett érték a Kulcsok.
...
### -Type
Érték: {ConnectionStrings, Keys, ReadOnlyKeys}.
Az alapértelmezett érték a Kulcsok.
