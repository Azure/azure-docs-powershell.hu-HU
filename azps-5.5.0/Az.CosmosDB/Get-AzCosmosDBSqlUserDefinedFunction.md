...
## SYNOPSIS
A 2010-es sql-felhasználó által definiált függvényt kapja meg.
...
## LEÍRÁS
A **Get-AzCosmosDBSqlUserDefinedFunction** parancsmag lekérte az adott ResourceGroupName, AccountName, DatabaseName és ContainerName rekordhoz meglévő Összes Létező Sql UserDefinedFunctions listáját, és egy adott ResourceGroupName, AccountName, ContainerName és UserDefinedFunctionName fájlhoz egyetlen Sql UserDefinedFunction függvényt kap.
