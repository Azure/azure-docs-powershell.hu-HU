...
## SYNOPSIS
Létrehoz egy új FogasDB fürtkulcsot.
...
## LEÍRÁS
A **New-AzCosmosDBCassandraClusterKey létrehoz** egy új Tárolódátlag-fürtkulcsot.
...
### -OrderBy
A Fürtandra-fürtkulcs megrendelése.
...
### Microsoft.Azure.Commands.CossDB.Models.PSClusterKey
