...
## SYNOPSIS
Létrehoz egy új, PSSqlConflictResolutionPolicy típusú objektumot. A Set-AzCosmosDBSqlContainer paraméterértékeként is át lehetadva.
...
## LEÍRÁS
Az Sql API ConflictResolutionPolicy-jának megfelelő objektum.
