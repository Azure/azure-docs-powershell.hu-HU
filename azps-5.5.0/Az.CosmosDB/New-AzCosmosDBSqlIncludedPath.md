...
## SYNOPSIS
Új, PSIncludedPath típusú objektumot hoz létre. A Set-AzCosmosDBSqlContainer paraméterértékeként is át lehetadva.
...
## LEÍRÁS
Az Sql API IncludedPath-jának megfelelő objektum.
...
### -Index
Az elérési út indexének listája
...
Az index elérési utak általában a gyökértől indulnak, és helyettesítő karakterekkel (/elérési út/*) végződnek.
...
### Microsoft.Azure.Commands.EzresDB.Models.PSIncludedPath
