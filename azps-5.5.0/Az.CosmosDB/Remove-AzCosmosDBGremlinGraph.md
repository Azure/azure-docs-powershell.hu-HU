...
## LEÍRÁS
A **Remove-AzCosmosDBGremlinGraph** parancsmag törli a Fogdb Gremlin Graph rekordot.
...
A parancsmag egy bool (ha -PassThru sikeres) típusú objektumot ad vissza, amely igaz, ha a törlés sikeres volt.
...
### -PassThru
Igaz érték beállítása, ha a felhasználó kimenetet szeretne kapni.
A kimenet akkor igaz, ha a művelet sikeres volt, és hiba történik, ha nem.
