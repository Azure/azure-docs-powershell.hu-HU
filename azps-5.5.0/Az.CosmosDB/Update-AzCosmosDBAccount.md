...
## SYNOPSIS
Frissítheti a 2010-es fiók attribútumát.
...
## LEÍRÁS
Frissítse a 2010-es fiók tulajdonságait. A fiókrégió nem frissíthető egymás után más tulajdonságokkal.
...
Frissítette a DefaultConsistencyLevel értéket "Strong", Enabled AutomaticFailover, Enabled MultipleWriteLocations és Enabled VirtualNetwork forFogsDB account with name accountName (Engedélyezve a MultipleWriteLocations) beállításra. 
...
Bool ( annak jelzése, hogy az AnalyticalStorage engedélyezve van-e a fiókban).
...
### -IpRule
Tűzfal támogatása. Azt adja meg, hogy a CIDR űrlap IP-címei vagy IP-címtartományai az adott adatbázisfiókok ügyfél IP-címeinek engedélyezett listájaként szerepelniük kell.
...
### -Tag
A címkék kulcsérték-párokként való kivonata.
