...
## SYNOPSIS
Frissítheti a 2010-es fiók régióit.
...
## LEÍRÁS
Frissítheti a 2010-es fiók régióit. A hely meg lehet adni PSLocation típusú objektumként vagy feladatátvételi prioritás szerint rendezett Helynév karakterláncként.
A LocationObject paraméter az új hozzáadható helyeknek megfelelő új LocationObjects által hozzáfűzett aktuális helyek listáját (feladatátvételi prioritásokat is beleértve) vár.
A Hely paraméter az aktuális hely (feladatátvételi prioritás szerint rendezett) és az új helyek listáját várja. Felhívjuk a figyelmét arra, hogy csak a Régiók kiegészítését támogatjuk. Adja meg a Location (Hely) vagy a LocationObject (Helyobjektum) lehetőséget.
