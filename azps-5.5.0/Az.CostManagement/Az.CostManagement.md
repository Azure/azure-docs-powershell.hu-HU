...
## Leírás
Microsoft Azure PowerShell: Költség parancsmagok

## Az.CostManagement parancsmagok
### [Get-AzCostManagementExport](Get-AzCostManagementExport.md)
A megadott hatókör exportálási hatókörének exportálási nevével történő lekért művelet.
...
Az exportálás végrehajtásához szükséges művelet.
...
Memória-objektum létrehozása a QueryFilterhez
