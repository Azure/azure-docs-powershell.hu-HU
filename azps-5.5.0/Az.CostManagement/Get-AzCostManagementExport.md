...
### 1. példa: AzCostManagementExports lekért hatóköre
```powershell
...
AzCostManagementExports lekérte hatókör szerint

### 2. példa: AzCostManagementExport be szerezni név és hatókör szerint
```powershell
...
### -Kibontás
Az exportálás tulajdonságainak kibontásához használható.
Jelenleg csak a "runHistory" támogatott, és az exportálás legutóbbi 10 végrehajtásának adatait adja vissza.
