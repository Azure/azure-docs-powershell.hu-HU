...
### 1. példa: Exportálás meghívása ExportName és hatókör szerint
```powershell
...
### 2. példa: Export meghívása InputObject szerint
```powershell
...
INPUTOBJECT: <ICostManagementIdentity> Identity Parameter
  ...
  - `[ExternalCloudProviderType <ExternalCloudProviderType?>]`: A dimenzióval/lekérdezési műveletekkel társított külső felhőszolgáltató típusa. Ide tartozik az összekapcsolt fiók "külsőSubscriptions" és az "externalBillingAccounts" az összesített fiókhoz.
