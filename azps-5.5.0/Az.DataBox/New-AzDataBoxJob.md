...
A parancsmag az adatdoboz-feladat létrehozásához az összes szükséges paramétert és néhány opcionális paramétert beveszi.

## PARAMETERS

### -AddressType
A cím típusa. Rendelkezésre álló értékek: AddressType.None (alapértelmezett), AddressType.Lakás, AddressType.Commercial
...
### -Name
A létrehozni szükséges adatdoboz-feladat neve
