...
### ListByParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **Get-AzDataBoxEdgeDevice** parancsmag az elérhető Data Box Edge-eszközökhöz nyújt információkat. Az eszköz nevét az Erőforráscsoport neve csoportnévvel együtt megadhatja, hogy az információk egy adott eszközre vonatkoznak. 
...
### -Alert
Az adatmező szélén/átjáróeszközén található értesítések lehívása
...
### -ExtendedInfo
További információ a megadott Data Box Edge/Data Box Átjáró eszközről
...
### -NetworkSetting
A megadott Data Box Edge/Data Box Átjáró eszköz hálózati beállításainak lekérte
...
### -UpdateSummary
Információkat kap a frissítések elérhetőségéről az eszköz legutóbbi vizsgálatának alapján. Emellett információkat kap az eszközön folyamatban lévő letöltési vagy telepítési feladatokról is.
