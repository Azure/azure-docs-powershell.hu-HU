...
## LEÍRÁS
A **Get-AzDataBoxEdgeStorageAccountCredential** parancsmag megkapja a megfelelő tárfiók hitelesítő adatait a Data Box Edge eszközön. A Tárfiók adott hitelesítő adatairól a Név, az Erőforráscsoport neve és az Eszköznév paramétert is megadhatja.
