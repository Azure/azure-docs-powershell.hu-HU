...
## LEÍRÁS
A **New-AzDataBoxEdgeStorageAccount** parancsmag létrehoz egy új Edge Storage-fiókot egy Data Box Edge-eszközön. Egy eszköz esetén egy Edge Storage-fióknak legalább egy felhőbeli tárfióknak lehet megfeleltetve.
...
2 EdgeStorageAccounts az eszközön nem oszthat meg több mint 1 felhőalapú tárfiókot
...
### -Cloud
CloudStorageAccount rétegezést fog használni
