...
## LEÍRÁS
Az **Remove-AzDataBoxEdgeDevice** parancsmag eltávolítja az Adatmező-szegélyű eszközök konfigurációját.
...
A parancsmag használata előtt olvassa el az erőforrás törléséről a [dokumentációt](https://docs.microsoft.com/en-us/azure/databox-online/data-box-edge-return-device#delete-the-resource)
