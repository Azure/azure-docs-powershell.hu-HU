...
## LEÍRÁS
A **Remove-AzDataBoxEdgeStorageAccount** parancsmag eltávolítja a társított Edge Storage-fiókot egy Adatmező Edge-eszközhöz. Megadhatja a parancsmagban paraméterként eltávolítható Edge Storage-fiók nevét.
