...
## LEÍRÁS
Ez a **Set-AzDataBoxEdgeShare** lecseréli a hozzáférési jogokat
...
### -ClientAccessRight
Olvasható/írhatja az Accesst az ügyfélazonosítókhoz, például:@(@{"ClientId"="192.168.10.10";" AccessRight"="NoAccess"}, @{"ClientId"="192.168.10.11";" AccessRight"="ReadOnly"})
