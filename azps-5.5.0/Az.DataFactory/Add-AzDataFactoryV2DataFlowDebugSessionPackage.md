...
## LEÍRÁS
Ez a parancs az adatfolyam-erőforrást és annak függőségeit az adott hibakeresési munkamenethez csatolja. Az adatfolyam-hibakeresési munkafolyamat PowerShell-parancssorának a következőnek kell lennie:
...
Adatfolyam-csomag hozzáadása a "WikiADF" adatüzem "550effe4-93a3-485c-8525-eaf25259efbd" hibakeresési munkamenetéhez.
A Pakcage-fájl adatfolyam-hibakeresési erőforrást, az adatkészlet hibakeresési resouce listáját, a csatolt szolgáltatás-hibakeresési erőforrás listáját, a hibakeresési beállítást és a munkamenetazonosítót tartalmazza. Például:
...
A SessionID paraméter a csomagfájl meglévő sessionId tulajdonságának helyére használatos.
