...
Másik lehetőségként rendelje hozzá a **Get-AzDataFactoryDataset** parancsmag kimenetét egy változóhoz, majd a pont jelével tekintse meg a változóban tárolt adatkészlet-objektummal társított Location tulajdonságot.
