...
## LEÍRÁS
A Get-AzDataFactoryV2IntegrationRuntime parancsmag információkat kap az integrációs futásidőkről egy adat factoryban.
Ha megadja egy integrációs futásidő nevét, ez a parancsmag információt kap az integrációs futásidőről.
Ha nem ad meg nevet, ez a parancsmag információt kap az integrációs futásidőkről egy adatüzemüzemben.

## PÉLDÁK

### 1. példa: Az összes integrációs futásidejű futási idő felsorolása adatüzemben
```
...
### 2. példa: Felügyelt dedikált integrációs futási idő lekérte
```
...
Ez a parancs az "rg-test-dfv2" nevű erőforráscsoport és a "test-df-eu2" nevű adat factory előfizetésében a "test-dedicated-ir" nevű integrációs futásiidőről jelenít meg információkat.

### 3. példa: Felügyelt dedikált integrációs futásidejű futási idő lekérte részletes állapottal
```
...
Ez a parancs információkat jelenít meg az "rg-test-dfv2" nevű erőforráscsoport előfizetésében a "test-dedicated-ir" nevű integrációs futásidőről és a "test-df-eu2" nevű adatüzemről.

### 4. példa: Önkiszolgáló integráció futásidejű futásidejű futtatása
```
...
### 5. példa: Önkiszolgáló integráció futásidejű futási ideje részletes állapottal
```
...
### -Állapot
Az integráció futásidejű részleteinek állapota.
