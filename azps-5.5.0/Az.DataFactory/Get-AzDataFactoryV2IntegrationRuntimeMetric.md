...
## LEÍRÁS
A Get-AzDataFactoryV2IntegrationRuntimeMetric parancsmag metrikus adatokat kap az integráció futásidejére vonatkozó adatokhoz egy adat factoryban.

## PÉLDÁK

### 1. példa: Integráció futásidejű mutatója
```
...
Ez a parancs az "rg-test-dfv2" nevű erőforráscsoport és a "test-df-eu2" nevű adatüzemeltöltési csoport "test-selfhost-ir" nevű integrációs futásidejére vonatkozó metrikus adatokat jeleníti meg az előfizetésben.
