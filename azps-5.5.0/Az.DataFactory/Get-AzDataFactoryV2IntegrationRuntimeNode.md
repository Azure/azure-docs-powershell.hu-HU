...
A parancsmag a Node_1 "test-df-eu2" data factory "test-df-eu2" önkiszolgáló integrációs futásidejű "test-selfhost-ir" nevű csomópontjának adatait kapja.

### 2. példa: Egy integrációs futásidejű csomópont részletes adatait és IP-címét tartalmazza.
```
