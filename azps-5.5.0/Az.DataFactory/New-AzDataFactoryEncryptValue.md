...
### 3. példa: Kiszolgáló nevének és hitelesítő adatainak titkosítása a fájlrendszerhez csatolt szolgáltatásban
```
...
Ez a parancsmag a paraméter által megadott csatolt szolgáltatástípus adatait titkosítja.
A paraméter elfogadható értékei a következőek:
...
Helyszíni fájlrendszerhez kapcsolt szolgáltatás esetén, ha a fájlrendszer az átjáró számítógépének helyi, használja a Local vagy localhost szolgáltatást, és ha a fájlrendszer az átjárót kiszolgálótól eltérő kiszolgálón található, használja a \\ \\ kiszolgálónevet.
