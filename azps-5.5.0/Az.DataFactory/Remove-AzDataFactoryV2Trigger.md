...
## LEÍRÁS
A **Remove-AzDataFactoryV2Trigger** parancsmag eltávolít egy eseményindítót egy adatüzemből. Ha az _Kényszerítés_ paraméter meg van adva, a parancsmag nem kéri a parancsmagot az eseményindító eltávolítása előtt.

## PÉLDÁK

### 1. példa: Eseményindító eltávolítása
```
...
Távolítsa el az "ScheduledTrigger" eseményindítót a "WikiADF" adat factoryból.
...
### -InputObject
Az eltávolítható Eseményindító objektum.
