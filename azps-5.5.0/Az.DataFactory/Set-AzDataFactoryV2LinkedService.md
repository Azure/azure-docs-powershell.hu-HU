...
## LEÍRÁS
A Set-AzDataFactoryV2LinkedService parancsmag egy adattárat vagy egy felhőszolgáltatást az Azure Data Factoryhoz kapcsolódik.
...
A parancs a folyamat műveleti Format-List keresztül átadja az eredményt a Format-List parancsmagnak.
