...
## LEÍRÁS
A **Stop-AzDataFactoryV2Trigger** parancsmag leállít egy eseményindítót egy adatüzemben. Ha az eseményindító "Elindítva" állapotban van, a parancsmag leállítja az eseményindítót, és a továbbiakban nem indítja el a folyamatokat. Ha az eseményindító már a "Leállítva" állapotban van, ennek a parancsmagnak nincs hatása. Ha az Kényszerítés paraméter meg van adva, a parancsmag nem kéri a parancssort az eseményindító leállítása előtt.

## PÉLDÁK

### 1. példa: Eseményindító leállítása
```
...
Leállítja az "ScheduledTrigger" eseményindítót a "WikiADF" adat factoryban.
