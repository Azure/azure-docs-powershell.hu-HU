...
ms.locfileid: "100167819"
---
# Sync-AzDataFactoryV2IntegrationRuntimeCredential

## SYNOPSIS
Szinkronizálja a hitelesítő adatokat az integráció futásidejű csomópontjai között.
...
## LEÍRÁS
A **Sync-AzDataFactoryV2IntegrationRuntimeCredential** parancsmag szinkronizálja a helyszíni hitelesítő adatokat az integrációs futásidejű csomópontok között, így a hitelesítő adatoknak minden csomópontban azonosnak kell lenniük.

## PÉLDÁK

### 1. példa: Integrációs futásidejű hitelesítő adatok szinkronizálása

Szinkronizálja a hitelesítő adatokat az integrációs futásidejű csomópontok között. (automatikusan generált)
