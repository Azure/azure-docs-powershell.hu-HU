...
## LEÍRÁS
Az **Add-AzDataLakeAnalyticsDataSource** parancsmag hozzáad egy adatforrást egy Azure Data Lake Analytics-fiókhoz.

## PÉLDÁK

### 1. példa: Adatforrás hozzáadása fiókhoz
```powershell
PS C:\>Add-AzDataLakeAnalyticsDataSource -Account "ContosoAdlA" -DataLakeStore "ContosoAdlS"
```

Ez a parancs hozzáad egy Data Lake Store-adatforrást egy Data Lake Analytics-fiókhoz.

### 2. példa

Adatforrás hozzáadása Data Lake Analytics-fiókhoz. (automatikusan generált)
...
### -AccessKey
Megadja a hozzáadni szükséges Azure Blob-tárfiók hozzáférési kulcsát.
...
### -Blob
Megadja a hozzáadni használt Azure Blob Storage-fiók nevét.
...
### -DataLakeStore
Megadja a hozzáadni szükséges Azure Data Lake Store-fiók nevét.
