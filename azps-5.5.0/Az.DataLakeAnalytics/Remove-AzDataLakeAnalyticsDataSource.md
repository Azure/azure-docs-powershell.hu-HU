...
## LEÍRÁS
A **Remove-AzDataLakeAnalyticsDataSource** parancsmag eltávolít egy adatforrást egy Azure Data Lake Analytics-fiókból.
...
Ez a parancs eltávolítja az AzureStorage01 nevű adatforrást a ContosoAdlAccount nevű fiókból.
...
### -Blob
Az eltávolítható AzureBlob-tárfiók nevét adja meg.
...
### -DataLakeStore
Az eltávolítható AzureData Lake Store-fiók nevét adja meg.
