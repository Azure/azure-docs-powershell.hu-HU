...
## LEÍRÁS
A **Set-AzDataLakeAnalyticsCatalogItemAclEntry** parancsmag hozzáad vagy módosít egy bejegyzést (ACE) egy katalógus vagy katalóguselem hozzáférés-vezérlési listájában (ACL) a Data Lake Analytics szolgáltatásban.

## PÉLDÁK

### 1. példa: A katalógus felhasználói engedélyeinek módosítása
```powershell
...
Ez a parancs módosítja a Patti Fuller-hez tartozó ACE katalógust olvasási engedélyekkel.

### 2. példa: Adatbázis felhasználói engedélyeinek módosítása
```powershell
...
Ez a parancs olvasási engedélyekkel módosítja Patti Fuller számára az ACE-adatbázist.

### 3. példa: Katalógus egyéb engedélyeinek módosítása
```powershell
...
Ez a parancs módosítja az ACE-katalógust más számára olvasási engedélyekkel.

### 4. példa: Adatbázis egyéb engedélyeinek módosítása
```powershell
...
### 5. példa: A katalógus felhasználói tulajdonosi engedélyeinek módosítása
```powershell
...
Ez a parancs olvasásra állítja a fiók tulajdonosi engedélyét.

### 6. példa: Adatbázis felhasználói tulajdonosi engedélyeinek módosítása
```powershell
...
Ez a parancs olvasásra állítja az adatbázis tulajdonosi engedélyét.
...
### -Group
Csoport katalógusának ACL-bejegyzésének beállítása
...
### -ObjectId
A beállított felhasználó identitása.
...
### -Egyéb
Más típusú katalógus ACL-bejegyzésének beállítása
...
Az elérési út részeit pont (.) választja el egymástól.
...
### -Felhasználó
A felhasználó katalógusának ACL-bejegyzésének beállítása
