...
Figyelem: A fájlok törlése a legjobb munkamennyiség-művelet. Nincs garancia arra, hogy a fájlok a törlés után visszaállíthatóak. Ennek az API-nak a használata engedélyezett az engedélyezési listán keresztül. Ha az ADL-fiókja nincs whitelisted listán, akkor az api használata kivételt képez a Nem megvalósított kivételtől. További információért és segítségért forduljon a Microsoft ügyfélszolgálatához.
...
### -Destination
A törölt fájl vagy mappa visszaállításának céljának elérési útja. 
