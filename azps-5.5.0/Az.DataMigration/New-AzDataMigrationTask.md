...
## LEÍRÁS
A New-AzDataMigrationTask parancsmag adatáttelepítési feladatot hoz létre. Ez a parancsmag beveszi a tevékenységtípus-számláló, az Azure Erőforráscsoport, a kapcsolódó Azure-adatbázis-áttelepítési szolgáltatás és a Project paramétereit bemenetként. 
...
Ez a példa parancsfájl bemutatja, hogy miként hozhat létre egy MyMigrationTask nevű új adatáttelepítési feladatot a myDMSProject és a TestService nevű projektben. 
...
### -MigrationValidation 
Feladat válaszobjektuma érvényesítési hívásokkal, nem kötelező, de ajánlott.
...
### -Wait
Hogy várni kell-e a tevékenység befejezésére. Ha a jelölő be van állítva, minden másodpercben ellenőrzi, hogy befejeződik-e a feladat, és visszaadja a felhasználónak a feladat tulajdonságait, ahol meg lehet vizsgálni a kimenetet vagy a hibát. 
```yaml
