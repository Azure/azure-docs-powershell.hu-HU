...
## LEÍRÁS
A Remove-AzDataMigrationService parancsmag eltávolítja az Azure Adatbázis-áttelepítési szolgáltatás egy példányát az Azure-ból. A DeleteRunningTask paraméter megadva eltávolítja az eltávolított szolgáltatáshoz társított Összes Azure-adatbázis-áttelepítési szolgáltatást. 
...
A fenti példa eltávolítja a TestService nevű Azure Adatbázis-áttelepítési szolgáltatás egy példányát, amely a MyResourceGroup nevű Azure Resource Group nevű Azure Resource Groupban található.
