...
## LEÍRÁS
Stop-AzDataMigrationTask parancsmag futási állapotban leállítja az adatbázis-áttelepítési tevékenységet. 
...
A fenti példa leállítja a MyDMSTask nevű Azure Database Migration Service feladatot, amely a MyDMSProject és a TestService nevű Azure Database Migration Service példányhoz van társítva
...
A fenti példa leállítja a PSProjectTask bemeneti paraméterként átadott Azure Database Migration Service-feladatot
