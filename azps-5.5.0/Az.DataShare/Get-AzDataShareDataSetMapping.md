...
## LEÍRÁS
A **Get-AzDataShareDataSetMapping** parancsmag információt kap egy adott adatkészlet-megfeleltetésről, ha a név meg van adva. Ellenkező esetben információkat kap egy megosztási előfizetésben található összes adatkészlet-megfeleltetésről. 
...
```
 ...
 Ez a parancs információkat jelenít meg a megosztási előfizetésben található összes adatkészlet-megfeleltetésről.
...
### -Name
Azure-adatkészlet megfeleltetésének neve.
...
### -ResourceId
Az Azure-adatkészlet megfeleltetésének erőforrás-azonosítója.
...
Azure-adatok megosztására vonatkozó előfizetés neve.
