...
## LEÍRÁS
A **Get-AzDataShareInvitation** parancsmag információkat kap az adatmegosztáshoz hozzáadott meghívókról. Ha megadja a meghívó nevét, ez a parancsmag információt kap a meghívóról. Ha nem ad meg nevet, ez a parancsmag információt kap a megosztásban található összes meghívásról.
...
Ez a parancs információt nyújt a meghívó AdsInvitation funkcióról az adatmegosztási Hirdetések megosztása szolgáltatásban.
...
### -Name
Azure-adatok megosztására szóló meghívó neve
...
### -ResourceId
Az Azure-adatok megosztására szóló meghívó erőforrás-azonosítója
