...
## LEÍRÁS
**A New-AzDataShareAccount** parancsmag létrehoz egy adatmegosztási fiókot a megadott Azure-erőforráscsoportban.
...
Létrehozza a "WikiADS" nevű fiókot az "ADS" erőforráscsoportban
...
### -Location
Az adat-megosztási fiók létrehozására használt hely.
...
### -ResourceGroupName
A rendszer létrehoz egy erőforráscsoportot az Azure-adat-megosztási fiókban.
...
### -Tag
Az Azure-adat-megosztási fiókkal társítani szükséges címkék.
