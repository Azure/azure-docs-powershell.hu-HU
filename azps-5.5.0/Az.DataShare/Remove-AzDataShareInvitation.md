...
## LEÍRÁS
A **Remove-AzDataShareInvitation** parancsmag eltávolítja az adatmegosztási meghívásokat.
...
Ez a parancs eltávolítja az ADSInvite nevű meghívást a share AdsShare-ről. 
...
### -InputObject
Azure-adatok megosztására vonatkozó meghívási objektum
...
### -ResourceId
Az Azure-adatok megosztására vonatkozó meghívó erőforrás-azonosítója
