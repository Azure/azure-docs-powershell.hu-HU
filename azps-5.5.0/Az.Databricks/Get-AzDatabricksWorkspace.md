...
### 3. példa: Egy erőforráscsoport összes adatkapcsolati munkaterületének felsorolása
```powershell
...
### Microsoft.Azure.PowerShell.Cmdlets.Databszolgáltatásokat.Models.Api20180401.IWorkspace
