...
## SYNOPSIS
VNet-társviszonyt hoz létre a munkaterülethez.
...
### 1. példa: Vnet-társviszony létrehozása adatokhoz
```powershell
...
Ez a parancs egy vnet-társviszonyt hoz létre az adatkapcsolatok számára.

## PARAMETERS

### -AllowForwardedTraffic
A helyi virtuális hálózat virtuális hálózatában a virtuális gépről továbbított adatforgalom engedélyezett/engedélyezett lesz-e a távoli virtuális hálózatban.
...
### -AllowGatewayTransit
Ha átjáróhivatkozások használhatók távoli virtuális hálózatban a virtuális hálózathoz való csatoláshoz.
...
Hogy a helyi virtuális hálózati térben lévő virtuális gépek hozzáférhetnek-e a virtuális hálózatok távoli virtuális térben való eléréséhez.
...
### -DatabspacesAddressSpacePrefix
A CIDR-listában a virtuális hálózathoz fenntartott címblokkok listája.
...
### -DatabeidsVirtualNetworkId
Az adatkapcsolat virtuális hálózatának azonosítója.
...
### -UseRemoteGateway
Ha távoli átjárók használhatók ezen a virtuális hálózaton.
