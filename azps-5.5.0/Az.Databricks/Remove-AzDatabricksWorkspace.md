...
### 1. példa: Datab workspace eltávolítása
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Ez a parancs eltávolítja az Adatkapcsolatok munkaterületet egy erőforráscsoportból.

### 2. példa: Datab workspace eltávolítása objektumról objektumra
```powershell
