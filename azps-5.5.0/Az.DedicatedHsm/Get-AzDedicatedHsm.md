...
## SYNOPSIS
A megadott Azure dedikált HSM-et kapja meg.
...
### 1. példa: Az összes dedikált HSM lekért előfizetése
```powershell
...
Ez a parancs az összes dedikált HSM-et egy előfizetéshez kapja

### 2. példa: Az összes dedikált HSM lekérte egy erőforráscsoport alá.
```powershell
...
Ez a parancs az összes dedikált HSM-et egy erőforráscsoport alá kapja.

### 3. példa: Dedikált HSM lekért név szerint
```powershell
...
Ez a parancs név szerint dedikált HSM-et kap.

### 4. példa: Dedikált HSM-objektum létrehozása
```powershell
...
Ez a parancs objektumról dedikált HSM-et kap.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amelyhez a dedikált hsm tartozik.
...
### -Top
A vissza nem térhet találatok maximális száma.
...
INPUTOBJECT: <IDedicatedHsmIdentity> Identity Parameter
  ...
  - `[ResourceGroupName <String>]`: Annak az erőforráscsoportnak a neve, amelyhez az erőforrás tartozik.
