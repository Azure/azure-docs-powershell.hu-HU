...
### 1. példa: A dedikált HSM paramétercímkének frissítése név szerint
```powershell
...
Ez a parancs név szerint frissíti a dedikált HSM paramétercímkét

### 2. példa: A dedikált HSM paramétercímke frissítése objektum szerint
```powershell
...
Ez a parancs frissíti a dedikált HSM paramétercímkét objektum szerint
