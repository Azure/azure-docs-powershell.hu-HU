...
## LEÍRÁS
A **Get-AzDeploymentManagerService parancsmag** szolgáltatás-topológia alapján kap egy szolgáltatást, és visszaadja az adott szolgáltatást képviselő objektumot.
...
### 3. példa: Szolgáltatás lekérte a szolgáltatásobjektumot.
```powershell
