...
## LEÍRÁS
A **Remove-AzDeploymentManagerService parancsmag** egy szolgáltatás topológiája alatt töröl egy szolgáltatást.
...
Ez a parancs törli a ContosoService1 nevű szolgáltatást a ContosoResourceGroup szolgáltatás topológiája szerint.

### 2. példa: Szolgáltatás törlése az erőforrás-azonosító használatával.
```powershell
...
### 3. példa: Szolgáltatás törlése a szolgáltatásobjektum használatával.
```powershell
PS C:\> Remove-AzDeploymentManagerService -InputObject $serviceObject
```

Ez a parancs törli azt a szolgáltatást, amelynek a neve, a szolgáltatás topológiája és az Erőforráscsoport neve megegyezik a $serviceObject, ServiceTopologyName és ResourceGroupName tulajdonságaival.
