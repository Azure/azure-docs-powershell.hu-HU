...
### 1. példa: Virtuális asztali Windows-felhasználóSession létrehozása név szerint
```powershell
...
Ez a parancs felsorolja egy windowsos virtuális asztali felhasználófelhasználói munkamenetgazdát egy gazdakészletben.
