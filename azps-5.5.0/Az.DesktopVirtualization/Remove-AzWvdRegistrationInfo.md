...
## LEÍRÁS
Távolítsa el a windowsos virtuális asztali regisztrációs adatokat.

## PÉLDÁK

### 1. példa: Virtuális asztali Windows regisztrációs jogkivonat törlése
```powershell
PS C:\> Remove-AzWvdRegistrationInfo -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName
```

Ez a parancs törli a Windows virtuális asztali regisztrációs jogkivonatát egy gazdakészletben.
