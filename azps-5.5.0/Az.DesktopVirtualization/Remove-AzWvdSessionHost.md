...
### 1. példa: A Windows Virtual Desktop SessionHost törlése név szerint
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Ez a parancs törli a Windows Virtual Desktop SessionHost-t egy gazdakészletben.
...
### -Force
A jelölő kényszerítésével kényszerítheti a sessionHost törlését akkor is, ha a userSession létezik.
