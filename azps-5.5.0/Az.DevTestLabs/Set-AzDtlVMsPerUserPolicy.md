...
## LEÍRÁS
A **Set-AzDtlVMsPerUserPolicy** parancsmag beállítja a virtuális gépeket egy lab felhasználónkénti házirendje szerint, amely meghatározza a felhasználónként engedélyezett virtuális gépek maximális számát.
...
### -Disable
Azt jelzi, hogy ez a parancsmag letiltja a házirendet a laboratóriumban.
...
### -Enable
Azt jelzi, hogy ez a parancsmag engedélyezi a házirendet a laboratóriumban.
...
### -LabName
Annak a laboratóriumnak a neve, amelyhez ez a parancsmag beállítja a virtuális gépeket felhasználónkénti házirendenként.
