...
Töltse fel a hitelesítésszolgáltatói tanúsítvány CER-fájlját egy Azure IoT-központbeli eszköz kiépítési szolgáltatásba.
...
### -Path
Az X509-es tanúsítvány .cer fájl vagy .pem fájl elérési útja 64-es alapvonalú ábrázolása
