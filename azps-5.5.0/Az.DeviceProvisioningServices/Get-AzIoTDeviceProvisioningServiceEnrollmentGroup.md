...
## LEÍRÁS
Az Azure IoT Hub eszköz kiépítési szolgáltatásában található regisztrációs csoportok részleteinek megtekintése vagy az összes regisztrációs csoport felsorolása.
...
Eszközregisztrációs csoport lekérte egy Azure IoT-központ eszközépítési szolgáltatását.
