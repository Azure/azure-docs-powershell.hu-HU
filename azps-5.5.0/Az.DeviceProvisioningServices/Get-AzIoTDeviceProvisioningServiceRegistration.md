...
## LEÍRÁS
Szerezze be az eszköz regisztrációs állapotát vagy az eszközök regisztrációs állapotát egy Azure IoT-központ eszközépítési szolgáltatásának enrollmentGroup eszközcsoportja alatt.
...
Szerezze be az eszköz regisztrációs állapotát egy Azure IoT Hub eszközépítési szolgáltatásban.
