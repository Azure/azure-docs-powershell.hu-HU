...
Töröljön egy Azure IoT-központbeli eszköz kiépítési szolgáltatást (myiotdps).
...
Törölhet egy Azure IoT Hub-eszköz kiépítési szolgáltatását (myiotdps) a folyamat használatával.
