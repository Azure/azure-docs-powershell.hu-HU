...
A csatolt IoT-központ "myiothub" törlése egy Azure IoT-központ eszköz kiépítési szolgáltatásában.
...
A csatolt IoT-központ "myiothub" törlése egy Azure IoT-központ eszköz kiépítési szolgáltatásában folyamat használatával.
...
### -LinkedHubName
Csatolt IoT-központ állomásneve
