...
## SYNOPSIS
DigitalTwinsInstances Végpont lekérte.
...
### 1. példa: List AzDigitalTwinsEndpoint in ResourceGroup
```powershell
...
### 2. példa: AzDigitalTwinsEndpoint – EndpointName
```powershell
...
### 3. példa: AzDigitalTwinsEndpoint by 'AzDigitalTwinsEndpoint' Objektum
```powershell
