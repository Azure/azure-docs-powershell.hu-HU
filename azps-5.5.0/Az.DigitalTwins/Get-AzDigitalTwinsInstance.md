...
Az összes DigitalTwinsInstance alapértelmezés szerint
...
A megadott AzDigitalTwinsInstance by ResourceName

### 3. példa: GetViaIdentity
```powershell
...
A megadott AzDigitalTwinsInstance by Object
...
Az összes DigitalTwinsInstance by ResourceGroupName
