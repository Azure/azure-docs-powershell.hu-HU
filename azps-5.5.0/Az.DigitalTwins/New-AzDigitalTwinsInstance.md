...
## SYNOPSIS
Létrehozhatja vagy frissítheti a DigitalTwinsInstance metaadatait.
...
### 1. példa: AzDigitalTwinsInstance alapértelmezés szerint.
```powershell
...
AzDigitalTwinsInstance alapértelmezés szerint

### 2. példa: AzDigitalTwinsInstance by AzDigitalTwins objektum létrehozása.
```powershell
...
AzDigitalTwinsInstance by AzDigitalTwins objektum létrehozása
...
Ennek létrehozásáról a DIGITALTWINSCREATE tulajdonságokat és a hash táblázatot hoz létre a NOTES (JEGYZETEK) című szakaszban található.
...
DIGITALTWINSCREATE: <IDigitalTwinsDescription> A DigitalTwins szolgáltatás leírása.
  - `Location <String>`: Az erőforrás helye.
  - `[Tag <IDigitalTwinsResourceTags>]`: Az erőforráscímkék.
