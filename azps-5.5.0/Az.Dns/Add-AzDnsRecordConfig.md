...
## LEÍRÁS
Az **Add-AzDnsRecordConfig** parancsmag hozzáad egy DNS-rekordot egy **RecordSet-objektumhoz.**
...
A SOA-rekordok a DNS-zóna létrehozásakor jön létre, és a DNS-zóna törlésekor törlődnek.
SoA-rekordokat nem adhat hozzá és nem távolíthat el, de szerkesztheti őket.
...
### 1. példa: A rekord hozzáadása rekordkészlethez
```
...
Ebben a példában egy A rekordot ad hozzá egy meglévő rekordkészlethez.

### 2. példa: AAAA rekord hozzáadása egy rekordkészlethez
```
...
Ebben a példában egy AAAA rekordot egy meglévő rekordkészlethez ad hozzá.

### 3. példa: CNAME rekord hozzáadása egy rekordkészlethez
```
...
Ebben a példában egy CNAME rekordot egy meglévő rekordkészlethez ad hozzá.
Mivel a CNAME rekordkészletek legfeljebb egy rekordot tartalmazhatnak, kezdetben üres rekordkészletnek kell lennie, vagy a meglévő rekordokat el kell távolítani a Remove-AzDnsRecordConfig használatával.

### 4. példa: MX rekord hozzáadása rekordkészlethez
```
...
Ebben a példában egy MX rekordot egy meglévő rekordkészlethez ad hozzá.
A "@" rekordnév a zóna csúcsán beállított rekordot jelzi.

### 5. példa: NS rekord felvétele rekordkészletbe
```
...
Ebben a példában egy NS rekordot ad hozzá egy meglévő rekordkészlethez.

### 6. példa: PTR-rekord hozzáadása egy rekordkészlethez
```
...
Ebben a példában egy PTR rekordot ad hozzá egy meglévő rekordkészlethez.

### 7. példa: SRV rekord hozzáadása egy rekordkészlethez
```
...
Ez a példa hozzáad egy SRV rekordot egy meglévő rekordkészlethez.

### 8. példa: TXT rekord hozzáadása egy rekordkészlethez
```
...
Ebben a példában egy TXT rekordot egy meglévő rekordkészlethez ad hozzá.
...
### -CaaValue
A hozzáadni megfelelő CAA-rekord értékmezője.
...
### -Port
Egy szolgáltatásrekord portját adja meg.
...
### -RecordSet
A **szerkesztenie kell a RecordSet** objektumot adja meg.
