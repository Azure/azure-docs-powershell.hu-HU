...
Ez a parancs létrehoz egy új, myprivatezone.com nevű privát DNS-zónát a megadott erőforráscsoportban egy társított megoldási virtuális hálózattal (megadja az azonosítóját), majd a $Zone tárolja.
...
Delegálást is hozzáad a szülő DNS zone.com nevű szülő DNS-zónához, amely ugyanabban az előfizetésben és erőforráscsoportban található, mint a gyermekzóna.
...
### 6. példa: Dns-zóna létrehozása meghatalmazással szülőzóna-objektum megadásával
```
