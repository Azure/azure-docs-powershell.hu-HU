...
Másik lehetőségként megadhatja a DNS-zóna értékét egy **DnsZone-objektum** használatával, amely vagy a folyamaton, vagy a Zone paraméteren *keresztül adható* meg.
...
A **átadott DnsZone-objektum** a folyamaton keresztül is továbbítható.
...
## MEGJEGYZÉSEK
A DNS-zóna törlésének potenciálisan nagy hatása miatt ez a parancsmag alapértelmezés szerint megerősítést kér, ha a $ConfirmPreference Windows PowerShell változó értéke nem a Nincs.
