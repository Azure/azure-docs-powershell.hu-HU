...
## LEÍRÁS
Beállítja egy Eseményrács témakör tulajdonságait. Ezzel lecserélheti az Eseményrács témakör címkéit.
...
Beállítja a MyResourceGroupName erőforráscsoport Eseményrács témakörÉnek 1. tulajdonságát, hogy a címkéket a \` \` megadott "Részleg" és \` \` "Környezet" címkékre cserélje.
