...
## LEÍRÁS
Frissítse egy Eseményrács esemény-előfizetés tulajdonságait. Ezzel frissítheti egy meglévő esemény-előfizetés szűrőit, célhelyét vagy címkéit.
...
Frissíti az esemény-előfizetés ES1 végpontját \` \` a \` \` \` MyResourceGroupName erőforráscsoport Témakör1 témaköréhez: \`\`https://requestb.in/1kxxoui1\`
...
Frissíti az esemény-előfizetés ES1 tulajdonságát az EventHub névtér ContosoNamespace-hez az új végponttal " és az új \` \` \` https://requestb.in/1kxxoui1\ SubjectEndsWith \` szűrővel jpg formátumban\`
...
### -DomainName
Annak a tartománynak a neve, amelyhez létre kell hozatni az esemény-előfizetést.
...
### -ExpirationDate
Az esemény-előfizetés lejárati DateTime-ját határozza meg, amely után az esemény-előfizetés kivezetve lesz.
...
### -ResourceId
Annak az erőforrásnak az azonosítója, amelyhez az esemény-előfizetést létrehozta.
