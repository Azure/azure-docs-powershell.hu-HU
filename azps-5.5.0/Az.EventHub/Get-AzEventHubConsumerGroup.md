...
A \` \` \` \` \` MyResourceGroupName erőforráscsoport myResourceGroupName nevű erőforráscsoportjában található MyNamespaceName nevű eseményközpontban lekérte a fogyasztói csoportok \` listáját.
