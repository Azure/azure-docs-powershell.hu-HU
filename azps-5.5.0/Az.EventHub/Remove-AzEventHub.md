...
## LEÍRÁS
A Remove-AzEventHub parancsmag eltávolítja és törli a megadott Eseményközpontot a megadott névtérből.
...
Az Eseményközpont \` MyEventHubName \` eltávolítása.
...
### 3. példa: InputObject pipázás használatával:
```powershell
...
### 5. példa: ResourceId – Karakterlánc használata:
```powershell
