...
## LEÍRÁS
A Set-AzEventHubAuthorizationRule parancsmag frissíti a megadott engedélyezési szabályt a megadott eseményközpontban.
...
Frissíti a MyAuthRuleName engedélyezési szabályt, hogy a MyEventHubName eseményközpontra vonatkozó, a \` MyNamespaceName névtér által hatókörbe tartozó manage rightsot \` \` \` \` biztosítsa. \`
