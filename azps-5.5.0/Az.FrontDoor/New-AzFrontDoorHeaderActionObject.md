...
## LEÍRÁS
PSHeaderAction objektumot hoz létre a PSRulesEngineAction objektum létrehozásához.
...
### -HeaderActionType
Az élőfejre alkalmazandó kezelés típusa.
...
### -HeaderName
Annak a fejlécnek a neve, amelyre a művelet vonatkozni fog.
...
### -Érték
Az az érték, amely alapján frissíteni kell a megadott fejlécnevet.
Ez az érték nem használatos, ha az actionType értéke Delete.
