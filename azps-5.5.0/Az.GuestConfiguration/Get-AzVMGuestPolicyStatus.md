...
A kezdeményezés a "Initiative" definíciótípusú házirend.
Ez a parancsmag megfelelőségi állapotokat kap a VM-ről, és annak okait, hogy miért nem felel meg a kezdeményezésben található egyes házirendek követelményeinek.
...
Az állapot tartalmazza a virtuális gép megfelelőségi állapotát minden olyan kezdeményezésben, amely a "Vendégkonfiguráció" típusú kezdeményezésekre vonatkozik, megfelelőségi okokból, a megfelelőségi ellenőrzés ideje, valamint a megfelelőség szempontjából ellenőrzött erőforrás-információk.
...
A legújabb vendégkonfigurációs házirend-állapotok lekérte kezdeményezésazonosító alapján. Az állapot tartalmazza a virtuális gép megfelelőségi állapotát a kezdeményezésben az egyes házirendek esetén, megfelelőségi okokból, a megfelelőségi ellenőrzés ideje, a megfelelőség szempontjából ellenőrzött erőforrás-információk.
...
Az állapot tartalmazza a virtuális gép megfelelőségi állapotát a kezdeményezésben az egyes házirendek esetén, megfelelőségi okokból, a megfelelőségi ellenőrzés ideje, a megfelelőség szempontjából ellenőrzött erőforrás-információk.
Az eredmények között nem szerepel a korábban létrehozott állapot, csak a kezdeményezésben található egyes házirendek legutóbbi állapota.
...
A ReportId a ReportId tulajdonság, amely a Get-AzVMGuestPolicyStatus initiativeId vagy Initiative név alapján (további példákat is tartalmaz)
...
Egy olyan házirendet, amelyben a definíció típusa Kezdeményezés, a kategória pedig vendégkonfiguráció, egy hatókörhöz kell rendelni az állapotok lekért állapotának ellenőrzéshez.
