...
## LEÍRÁS
Az **Add-AzHDInsightStorage** parancsmag hozzáad egy Azure Storage-fiókbejegyzést a New-AzHDInsightClusterConfig által létrehozott Azure HDInsight konfigurációs objektumhoz.

## PÉLDÁK

### 1. példa: Azure-tárkulcs hozzáadása a fürtkonfigurációs objektumhoz
```
...
Ez a parancs hozzáad egy blobtároló-fiókbejegyzést a "your-hadoop-001" NEVŰ HDInsight-konfigurációhoz.
...
### -StorageAccountKey
Az új fürthöz hozzáadható tárfiók tárfiókkulcsát adja meg.
...
### -StorageAccountName
Annak a tárfióknak a nevét adja meg, amelybe fel kell venni a fürthöz.
