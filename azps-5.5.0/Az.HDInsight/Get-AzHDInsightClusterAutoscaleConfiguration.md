...
## LEÍRÁS
A **Get-AzHDInsightClusterAutoscaleConfiguration parancsmag** megkapja a HDInsight-fürt automatikus skálázási konfigurációját.

## PÉLDÁK

### 1. példa: A HDInsight-fürt automatikus skálázási konfigurációjának letelepítése.
```powershell
...
Ez a parancs a HDInsight-fürt automatikus skálázási konfigurációját kapja meg.
