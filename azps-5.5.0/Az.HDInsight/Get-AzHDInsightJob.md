...
## LEÍRÁS
A **Get-AzHDInsight Jobs** parancsmag fordított időrendi sorrendben kapja meg egy adott Azure HDInsight-fürt legutóbbi munkáit, a lista tetején pedig a legújabb feladat szerepel.
A JobId paraméter megadva *adott feladatot kap.*

## PÉLDÁK

### 1. példa: Legutóbbi feladatok lekérte egy adott Azure HDInsight-fürthöz
```
PS C:\># Cluster info
...
Ez a parancs a -hadoop-001 nevű fürt összes legutóbbi munkáját beveszi.
...
### -JobId
A lekért feladat feladatazonosítóját adja meg.
...
### -NumOfFeladats
A beolvassa a beolvassa feladatok számát.
