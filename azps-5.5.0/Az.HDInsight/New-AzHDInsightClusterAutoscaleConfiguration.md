...
### LoadAutoscaleParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **New-AzHDInsightClusterAutoscaleConfiguration** parancsmag létrehoz egy nem állandó objektumot, amely leírja egy Azure HDInsight-fürt automatikus skálás konfigurációját.

## PÉLDÁK

### 1. példa: Betöltésalapú automatikusskála-konfigurációt leíró objektum létrehozása
```powershell
PS C:\> New-AzHDInsightClusterAutoscaleConfiguration -MinWorkerNodeCount 3 -MaxWorkerNodeCount 5
```

Ez a parancs egy olyan objektumot hoz létre, amely leírja a betöltésalapú automatikusskála-konfigurációt.

### 2. példa: Automatikus méretezés ütemezési konfigurációját leíró objektum létrehozása
```powershell
...
Ezzel a paranccsal olyan objektumot hoz létre, amely leírja az automatikus méretezés ütemezési konfigurációját.
