...
## LEÍRÁS
A **New-AzHDInsightStreamingMapReduce JobDefinition** parancsmag meghatároz egy Streaming MapReduce feladatobjektumot azure HDInsight-fürthöz való használatra.
...
### -OutputPath
A kimeneti feladat elérési útját adja meg.
