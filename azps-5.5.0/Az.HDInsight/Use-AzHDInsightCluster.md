...
## LEÍRÁS
A **Use-AzHDInsightCluster** parancsmag kiválasztja az Azure HDInsight-fürtöt ahhoz a Invoke-AzHDInsightHiveJob-parancsmaghoz, amely a Hive-feladatok elküldése érdekében használható.

## PÉLDÁK

### 1. példa: Fürt kiválasztása a Hive-lekérdezések beküldéséhez
```
PS C:\># Cluster info
...
Ez a parancs kijelöl egy fürtöt a Hive-lekérdezések beküldéséhez.
