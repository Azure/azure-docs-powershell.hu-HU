...
## SYNOPSIS
Létrehozza egy szolgáltatáspéldány metaadatait.
...
## LEÍRÁS
Létrehozza vagy frissíti egy szolgáltatási példány metaadatait.

## PÉLDÁK

### 1. példa: Létrehozza a MyResourceGroup erőforráscsoport MyResourceGroup nevű új Azure healthcareapis fhir szolgáltatását egy westus2 helyen, ahol az átviteli sebesség = 400
```powershell
...
### 2. példa: Létrehozza a MyResourceGroup erőforráscsoport MyResourceGroup nevű új Azure healthcareapis fhir szolgáltatását egy westus2 helyen, ahol az átviteli sebesség = 400 és a kulcstár kulcs uri "https:// \<my-keyvault> \<my-key> .vault.azure.net/keys/"
```powershell
...
Access-házirendobjektum-iD-ek listája.
...
Adja meg a kérés során használható HTTP-fejléceket.
Az élőfejek bármelyikéhez használja a " * " kódot.
...
Adja meg, hogy mennyi ideig legyen gyorsítótárazva egy kérés eredménye másodpercek alatt.
Példa: A 600 jelentése 10 perc.
...
Adja meg az API-hoz hozzáférő forráswebhelyek URL-címeit, vagy a " * " használatával engedélyezze a hozzáférést bármely webhelyről.
...
### -SkeyVaultKeyUri
HealthcareApis Fhir ServiceLangsKeyVaultKeyUri.
A háttéradatbázis ügyfél által kezelt kulcsának URI-ja.
...
### -SofferThroughput
HealthcareApis Fhir ServiceLangsOfferThroughput.
...
### -Kind
Az HealthcareApis szolgáltatás fajtája.
Az alapértelmezett érték a Hir
...
### -Location
HealthcareApis szolgáltatási hely.
...
### -PublicNetworkAccess
A Felső szolgáltatás hálózati hozzáférési típusa. Gyakran `Enabled` vagy `Disabled` .
