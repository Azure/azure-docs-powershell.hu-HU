...
### 1. példa: Az összes futtatás eredményének felsorolása egy sablon alatt
```powershell
...
Ez a parancs felsorolja az összes futtatás eredményét egy sablon alatt.

### 2. példa: Futtatás eredményének lekérte egy sablon alatt
```powershell
...
Ez a parancs futtatás eredményt kap egy sablon alatt.

### 3. példa: Futtatás eredményének lekérte egy sablon alatt
```powershell
