...
### 1. példa: ImportExport feladat lekérte az alapértelmezett környezetben
```powershell
...
Ez a parancsmag az ImportExport feladatot erőforráscsoport és feladatnév szerint kapja meg.
...
### 4. példa: Az ImportExport feladat lekérte identitás szerint
```powershell
...
Ez a parancsmaglista identitás alapján importExport feladatot kap.
