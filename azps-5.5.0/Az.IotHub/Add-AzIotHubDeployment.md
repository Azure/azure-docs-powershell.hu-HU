...
## LEÍRÁS
A peremhálózati telepítéseket a felhasználó által definiált metrikák segítségével lehet létrehozni az igény szerinti értékeléshez.
...
Hozzon létre egy edge-telepítést alapértelmezett metaadatokkal.
...
Hozzon létre egy 3-as prioritású Edge-telepítést, amely akkor vonatkozik feltételre, ha egy eszköz meg van címkézve a 9-es épületben, és a környezet "teszt".
...
Hozzon létre egy Edge-telepítést felhasználói metrikák segítségével.
...
Hozzon létre egy Edge-telepítést címkékkel.
...
Hozzon létre egy Edge-telepítést tartalommal.
...
### -Label
A céltelepítéshez alkalmazandó címkék térképe.
...
### -Metric
Az IoT Edge üzembe helyezési metrikák definíciójának lekérdezésgyűjteménye.
...
### -ModulesContent
Modulok üzembe helyezése Az IoT Edge-eszközökhöz.
...
### -Priority
A telepítés súlyát versenyben álló szabályok (legnagyobb nyeremények) esetén.
...
### -TargetCondition
Cél feltétel, amelyben egy Edge-telepítés érvényes.
