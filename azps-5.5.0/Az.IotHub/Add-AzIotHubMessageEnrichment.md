...
## LEÍRÁS
IoT-központonként akár 10 üzenetgazdagítást is hozzáadhat. Ezek alkalmazástulajdonságként kerülnek be a kiválasztott végpont(ak)nak küldött üzenetekbe.
További tudnivalókért lásd: https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Új gazdagítás hozzáadása az "újKulcs" billentyűvel és az "újÉrték" értékkel. Ez az új gazdagítás a "végpont1" és a "végpont2" végpontokra vonatkozik.
