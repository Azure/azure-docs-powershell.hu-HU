...
## LEÍRÁS
Vegyen fel egy új végpontot az IoT-központban. A támogatott végpontokról további információt a https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
Vegyen fel egy Új EventHub típusú "E2" végpontot egy "myiothub" IoT-központba.
...
Vegyen fel egy új AzureStorageContainer típusú "S1" végpontot egy "myiothub" IoT-központba.

## PARAMETERS

### -ConnectionString
A Routing Endpoint kapcsolati karakterlánca
...
A Végpont erőforrás erőforráscsoportja
...
A Végpont erőforrás SubscriptionId-e
...
### -Kódolás
Válassza ki azt a formátumot, amelyben az adatokat át szeretné irányítatni. A JSON vagy az AVRO lehetőséget is választhatja. Az alapértelmezett beállítás az AVRO.
