...
## LEÍRÁS
Az IoT automatikus eszközkezelési konfigurációjának részletei vagy az IoT automatikus eszközkezelési konfigurációk listája az IoT-központban.
...
Az IoT-központban listába sorolja fel az automatikus eszközkezelési konfigurációkat.
