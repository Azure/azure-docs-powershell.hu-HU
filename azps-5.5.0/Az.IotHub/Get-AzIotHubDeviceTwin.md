...
## LEÍRÁS
Eszközeszközt kap. További https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins információt itt is láthat.
...
Az eszköz objektumát adja eredményül.
