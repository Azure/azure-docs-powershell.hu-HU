...
## LEÍRÁS
Közvetlen metódus meghívása egy eszközön. További https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods információt itt is láthat.
...
### -Name
Az eszközön meghívni használt módszer neve.
...
### -Hasznos terhelés
Az eszközön meghívható módszer hasznos terhelése.
