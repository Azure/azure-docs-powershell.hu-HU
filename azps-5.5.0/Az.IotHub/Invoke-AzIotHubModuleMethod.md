...
## LEÍRÁS
Edge-modul metódus meghívása További https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods információt itt is láthat.
...
### -ConnectionTimeOut
A kapcsolat sikeres kapcsolódásáig várakozási másodpercek száma.
...
### -Name
Az eszközmodulon meghívni használt módszer neve.
...
### -Hasznos terhelés
Az eszközmodulon meghívni használt módszer hasznos terhelése.
...
### -ResponseTimeOut
A közvetlen módszertől kapott eredmény bekért várakozási másodpercek száma.
Az alapértelmezett érték 10.
