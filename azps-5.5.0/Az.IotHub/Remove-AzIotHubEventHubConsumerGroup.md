...
## SYNOPSIS
Töröl egy eventhub fogyasztói csoportot.
...
### 1. példa: Az eventhub fogyasztói csoport eltávolítása a telemetriai eventhubról
```
...
Eltávolítja a myconsumergroup nevű fogyasztói csoportot a myiothub nevű IotHubról
