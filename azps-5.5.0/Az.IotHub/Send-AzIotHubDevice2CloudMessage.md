...
## LEÍRÁS
A parancs alkalmazás- és rendszertulajdonságokkal támogatja az üzenetek küldését.
...
Eszköz küldése a felhőbeli üzenetbe alapértelmezett átviteli típus használatával.
...
Mqtt-eszköz küldése felhőbeli üzenetbe.
...
### -Message
Az IoT-központba küldenének üzenet törzse.
...
### -TransportType
A használni használt átviteli típus.
Az alapértelmezett érték az Amqp.
