...
### 1. példa a termékváltozat frissítése
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName S1 -Units 5
```

Frissítse a termékváltozatot S1-re, az egységeket pedig 5-re a "myiothub" nevű IotHubhoz.

### 2. példa az eventhub tulajdonságainak frissítése
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -EventHubRetentionTimeInDays 4
```

Frissítse a telemetriai adatok megőrzési idejét napokban a 4-esre a "myiothub" nevű IotHub esetén.

## PARAMETERS

### -CloudToDevice
A felhőből az eszközre vonatkozó parancssor tulajdonságai. 
...
Flag that specifies that notifications should be enabled for file upload. 
...
Annak a tárolónak a neve, amelybe fel kell töltenie a fájlokat.
...
A fájlfeltöltési értesítések maximális kézbesítési száma.  
...
A fájlfeltöltési értesítési várólistán lévő üzenetek valós értékkel való feltöltésének ideje. 
...
### -FileUploadSasUriTtl
Itt az ideje a fájlfeltöltéshez létrehozott SAS Uri-nak. 
...
A fájlok feltöltéséhez szükséges tárterület-kapcsolati karakterlánc. 
...
### -Routes
Útvonaltervezéshez hozzáadható útvonalak
