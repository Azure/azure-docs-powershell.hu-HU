...
### -SamplingMode
A elosztott nyomkövetés engedélyezése és letiltása esetén a mintavételezést bekapcsolja.
...
### -SamplingRate
A nyomkövetési környezet hozzáadásához mintaként kiválasztott üzenetek mennyiségét szabályozza.
Ez az érték százalékérték.
Csak a 0 és 100 között (a határértékeket is beleértve) értékek megengedettek.
