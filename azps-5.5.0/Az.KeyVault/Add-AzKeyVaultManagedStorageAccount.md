...
## LEÍRÁS
Beállítja a meglévő Azure Storage-fiókot a kulcstárolóval ahhoz, hogy a tárfiók kulcskulcsait a kulcstár kezelnie kell. A tárfióknak már léteznie kell. A tárbillentyűk soha nem állnak rendelkezésre a hívók számára.
...
Beállítja a kulcstárolóval egy tárfiókot, hogy a kulcstár kezelnie kell a kulcstárat. Az aktív kulcskészlet a "kulcs1". Ezt a kulcsot használjuk a sas tokenek létrehozásához. A kulcstár a parancs időszaka után újra létrehozza a "key2" kulcsot, és aktív kulcsként beállítja azt. Ez az automatikus folyamat a "kulcs1" és a "kulcs2" között folytatódik, 90 napos eltéréssel.
...
Kulcs automatikus újragenerálása. Ha igaz, akkor a felügyelt tárfiók inaktív kulcsát a rendszer automatikusan újragenerálja, és az időszak után válik az új aktív kulcssá. Ha hamis, akkor a felügyelt tárfiók kulcsait a rendszer nem újra létrehozza automatikusan.
