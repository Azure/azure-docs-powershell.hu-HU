...
## SYNOPSIS
Egy kulcstárolóban tárolt tanúsítvány biztonsági biztonsági ának biztonságira van stb.
...
Visszaállíthatja a biztonsági másolatokat az előfizetés bármely kulcstárába, amelyről biztonsági másolat lett, felhasználhatja, ha a tároló ugyanabban az Azure geographyban van.
...
- Létrehozott egy tanúsítványt a kulcstárolóval, és most egy másik Azure-régióba szeretné klónozni az objektumot, hogy az elosztott alkalmazás összes példányából felhasználja.
...
Ezzel a paranccsal biztonsági másolatot készít a $cert. Név a tárolóban $cert. A VaultName paramétert a Backup.blob nevű fájlhoz írja, és ha már létezik, csendesen felülírja a fájlt.
