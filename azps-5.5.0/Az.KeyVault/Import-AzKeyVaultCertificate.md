...
- Segítségével `Add-AzKeyVaultCertificate` létrehozhat egy tanúsítvány-aláírási kérést, és elküldheti azt egy hitelesítésszolgáltatónak. Lásd: https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
[A CSR létrehozása és egyesítése a kulcstárban](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)