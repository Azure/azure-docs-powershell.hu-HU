...
## LEÍRÁS
A **Remove-AzKeyVaultCertificateOperation parancsmag** egy tanúsítványműveletet töröl egy kulcstárolóból.

## PÉLDÁK

### 1. példa: Tanúsítványművelet eltávolítása
```powershell
...
Ez a parancs jóváhagyás kérése nélkül eltávolítja a TestCert01 nevű tanúsítványműveletet a ContosoKV01 kulcstárolóból.
