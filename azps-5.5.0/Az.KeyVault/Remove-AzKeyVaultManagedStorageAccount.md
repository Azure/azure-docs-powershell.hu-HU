...
### 2. példa: A felhasználó jóváhagyása nélkül távolítson el egy kulcstár által felügyelt Azure Storage-fiókot és az összes hozzá tartozó SAS-definíciót.
```powershell
...
### 3. példa: Véglegesen töröljön (töröljön) egy kulcstár által felügyelt Azure Storage-fiókot és az összes hozzá tartozó SAS-definíciót egy soft-delete-enabled tárolóból.
```powershell
