...
## SYNOPSIS
Eltávolít egy kulcstár által felügyelt Azure Storage SAS-definíciókat.
...
## LEÍRÁS
Eltávolít egy kulcstár által felügyelt Azure Storage SAS-definíciókat. Ezzel az SAS-definíció alapján eltávolítja az SAS-jogkivonat lekért titkosságát is.

## PÉLDÁK

### 1. példa: Távolítsa el a kulcstár által felügyelt Azure Storage SAS-definíciót.
```powershell
...
Eltávolítja a mystorageaccount nevű fiókkal társított kulcstár által felügyelt TÁROLÓ SAS-definíció "mysasdef" nevű definícióját a myvault tárolóban.

### 2. példa: Felhasználó jóváhagyása nélkül távolítsa el a kulcstár által felügyelt Azure Storage SAS-definíciót.
```powershell
...
Eltávolítja a "myvault" tárolóban a "mystorageaccount" fiókkal társított kulcstár által felügyelt TÁROLÓ SAS-definíció "mysasdef" definícióját.

## PARAMETERS

### -AccountName
Tárfiók neve.
A parancsmag egy felügyelt tárfiók nevének FQDN-ét építi fel a tároló nevéből, amely jelenleg ki van jelölve a környezet és a tárfiók neve között.
