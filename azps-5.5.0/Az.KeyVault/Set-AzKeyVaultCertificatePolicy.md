...
### ExpandedRenewPercentage (alapértelmezett)
```
...
## LEÍRÁS
A **Set-AzKeyVaultCertificatePolicy** parancsmag létrehozza vagy frissíti a tanúsítvány házirendet egy kulcstárolóban.

## PÉLDÁK

### 1. példa: Tanúsítvány-házirend beállítása
```powershell
...
Ez a parancs beállítja a ContosoKV01 kulcstárolóban található TestCert01 tanúsítvány házirendet.
...
`-IssuerName` tulajdonság beállításakor meg kell adni.
...
### -EmailAtNumberOfDaysBeforeExpiry
Azt adja meg, hogy hány nappal a lejárat előtt induljon el az automatikus megújítás.
...
### -InputObject
A tanúsítvány-házirendet határozza meg.
