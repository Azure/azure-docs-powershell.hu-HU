...
## SYNOPSIS
Megosztott hozzáférés-aláírás (SAS) definícióját állítja be egy adott, kulcstárolóval felügyelt Azure Storage-fiók kulcstárával.
...
Egy "mykv" tárolóban egy KeyVault-felügyelt tárfiók "mysa" szolgáltatásában beállítja a fiók SAS-definíciójának "accountsas" beállítását. Konkrétan a fenti sorozat az alábbi műveleteket végzi el:
  ...
  - egy KeyVault-kezelt tárfiók hozzáadása a tárolóhoz, a Kulcs1 beállítása aktív kulcsként, és 180 napos időszakkal
  - tárterületkörnyezetet állít be a megadott tárfiókhoz a Kulcs1 billentyűvel
  ...
  - Egy KeyVault-kezelt tároló SAS-definíciót állít be a tárolóban, a fent létrehozott SAS-tokenként létrehozott uri sablonnal (SAS-jogkivonattal) és 30 napig érvényes sas-típussal
