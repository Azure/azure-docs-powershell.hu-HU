...
Az első parancs biztonságos karakterláncgé alakít egy karakterláncot a **ConvertTo-SecureString** parancsmag használatával, majd tárolja a karakterláncot a $Secret változóban. További információért írja be a `Get-Help
