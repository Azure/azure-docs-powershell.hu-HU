...
## LEÍRÁS
Frissítse egy kulcstár által felügyelt Azure Storage-fiók szerkeszthető attribútumát.

## PÉLDÁK

### 1. példa: Frissítse az aktív kulcsot "key2" kulcsra egy felügyelt Azure Storage-fiók kulcstárában.
```powershell
...
Frissíti a kulcstár által kezelt Azure Storage Account aktív kulcsot "key2" kulcsra. A frissítés után a "key2" lesz használatos SAS-jogkivonatok létrehozásához.

### 2. példa

Frissítheti egy kulcstár által felügyelt Azure Storage-fiók szerkeszthető attribútumát. (automatikusan generált)
...
### -ActiveKeyName
Aktív kulcs neve.
Ha nincs megadva, a felügyelt tárfiók aktív kulcsnevének meglévő értéke változatlan marad
...
### -AutoRegenerateKey
Kulcs automatikus újragenerálása.
Ha nincs megadva, a felügyelt tárfiók automatikus újragenerálás kulcsának meglévő értéke változatlan marad
...
### -Enable
Ha van ilyen, akkor engedélyezi a felügyelt tárfiók kulcsának használatát a sas token generálása során, ha az érték igaz. Letiltja a felügyelt tárfiók kulcsának használatát a sas tokenek generálásához, ha az érték hamis. Ha nincs megadva, a tárfiók engedélyezett/letiltott állapotának meglévő értéke változatlan marad.
...
### -PassThru
A parancsmag alapértelmezés szerint nem ad vissza objektumot. Ha ez a kapcsoló meg van adva, akkor a felügyelt tárfiók-objektumot adja vissza.
...
### -ÉsPeriod
Időtartam. Ha engedélyezve van az automatikus újragenerálás kulcs, ez az érték azt adja meg, hogy a felügyelt tárfiók inaktív kulcsai milyen idő után érik el automatikusan az újragenerálást, és aktív kulcssá válnak. Ha nincs megadva, a felügyelt tárfiók kulcskulcsának meglévő értéke változatlan marad
