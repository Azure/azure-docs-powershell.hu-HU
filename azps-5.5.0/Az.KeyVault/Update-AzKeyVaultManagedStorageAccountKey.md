...
## LEÍRÁS
A kulcstár által kezelt Azure Storage-fiók megadott kulcsának újragenerálása, és a kulcs aktív kulcsként való beállítja. A kulcstár a hívást az Azure Resource Managerhez proxyként használja a kulcs újragenerálása miatt. A hívónak jogosultságokkal kell rendelkeznie ahhoz, hogy újragenerálja a kulcsokat az adott Azure Storage-fiókon.
...
A "mystorageaccount" fiók "kulcs1" újragenerálása, és a kulcs1 aktívként állítja be a kulcstár felügyelt Azure Storage-fiókját.
