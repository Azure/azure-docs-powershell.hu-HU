...
### 1. példa: Az adatbázis-kezelők engedélyeinek hozzáadása
```powershell
...
A fenti parancs adatbázis-kezelő engedélyeket ad hozzá
...
VALUE <IDatabasePrincipal[]>: A Kusto-adatbázis-principalok listája.
  ...
  - `Type <DatabasePrincipalType>`: Egyszerű adatbázistípus.
