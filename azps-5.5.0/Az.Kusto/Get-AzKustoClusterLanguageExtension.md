...
### 1. példa: A fürthöz beállított összes nyelvi bővítmény felsorolása
```powershell
...
A fenti parancs a KQL-lekérdezésekben futtatható nyelvi bővítmények listáját adja vissza.
