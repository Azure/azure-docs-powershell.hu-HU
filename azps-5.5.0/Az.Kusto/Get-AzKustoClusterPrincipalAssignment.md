...
### 1. példa: Az összes Kusto-fürt egyszerű hozzárendelésének felsorolása
```powershell
...
A fenti parancs felsorolja a "testnewkustocluster" fürt összes egyszerű Hozzárendelését.

### 2. példa: Kusto-fürt egyszerű hozzárendelése név szerint
```powershell
...
A fenti parancs a Kusto cluster principalAssignment (kustoprincipal1) nevet adja vissza a "testnewkustocluster" fürtben.
