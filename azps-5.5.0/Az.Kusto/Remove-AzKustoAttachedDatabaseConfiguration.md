...
## SYNOPSIS
A megadott nevű csatolt adatbázis-konfiguráció törlése.
...
### 1. példa: Meglévő AttachedDatabaseConfiguration törlése név szerint
```powershell
...
A fenti parancs törli a AttachedDatabaseConfiguration "myfowerconfiguration" tulajdonságban definiált követési adatbázist a "testnewkustoclusterf" fürtből.
