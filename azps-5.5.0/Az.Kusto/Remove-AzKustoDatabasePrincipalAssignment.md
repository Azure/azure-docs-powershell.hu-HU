...
### 1. példa: Meglévő Kusto-adatbázis principalAssignment törlése név szerint
```powershell
...
A fenti parancs törli a "kustoprincipal1" nevű PrincipalAssignment rekordot a Kusto-adatbázisban (mykustodatabase).
