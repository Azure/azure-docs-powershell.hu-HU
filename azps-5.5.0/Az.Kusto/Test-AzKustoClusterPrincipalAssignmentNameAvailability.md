...
### 1. példa: Annak ellenőrzése, hogy rendelkezésre áll-e a használt fürt egyszerű hozzárendelési neve
```powershell
...
### -Type
A Microsoft.Kusto/Clusters/principalAssignments erőforrás típusa.
