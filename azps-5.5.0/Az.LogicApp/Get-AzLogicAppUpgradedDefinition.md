...
## LEÍRÁS
A **Get-AzCmAppUpgradedDefinition parancsmag** egy erőforráscsoportból megkapja a sémaverzió és a logikai alkalmazás frissített definícióját.
Ez a parancsmag egy objektumot ad vissza, amely a frissített logikai app definícióját képviseli.
Adja meg az erőforráscsoport nevét, a logikai alkalmazás nevét és a célséma verzióját.
...
### 1. példa: Logikai alkalmazás frissített definíciójának letöltése
```
...
Az első parancs megkapja a logikai app definícióját, amely a megadott célsémára frissít.
A parancs a definíciót a $UpgradedDefinition tárolja.
A második parancs karakterláncként jeleníti meg a $UpgradedDefinition tartalmát.
...
### -TargetSchemaVersion
A definíció célséma-verzióját adja meg.
