...
## LEÍRÁS
A **New-AzIntegrationAccountMap** parancsmag létrehoz egy integrációs fióktérképet.
Ez a parancsmag egy objektumot ad vissza, amely az integrációs fiók térképét képviseli.
Megadhatja az integrációs fiók nevét, az erőforráscsoport nevét, a leképezés nevét és a leképezés definícióját.
...
### 1. példa: Integrációs fióktérkép létrehozása
```powershell
...
Ez a parancs létrehozza az integrációs fiók leképezését a megadott erőforráscsoportban.
A parancs egy korábbi parancs által a $MapContent egy leképezésdefiníciót ad meg.

### 2. példa

Létrehoz egy integrációs fióktérképet. (automatikusan generált)
...
### -ContentType
Megadja az integrációs fiók térképének tartalomtípusát.
...
### -MapDefinition
Egy definícióobjektumot ad meg az integrációs fiók leképezésében.
Adja meg ezt a paramétert vagy *a MapFilePath paramétert.*
...
### -MapFilePath
Az integrációs fiók leképezés definíciójának fájl elérési útját adja meg. Adja meg ezt a paramétert vagy *a MapDefinition paramétert.*
...
### -MapName
Megadja az integrációs fiók térképének nevét.
...
### -MapType
Az integrációs fiók térképének típusát határozza meg.
Ez a parancsmag térképtípusként támogatja az Xslt-et.
...
### -Metadata
A leképezés metaadat-objektumát adja meg.
