...
## LEÍRÁS
A **New-AzIntegrationAccountPartner** parancsmag létrehoz egy integrációs partnert.
Ez a parancsmag egy objektumot ad vissza, amely az integrációs fiók partnerét képviseli.
Adja meg az integrációs fiók nevét, az erőforráscsoport nevét, a partner nevét és a partner identitását.
...
### 1. példa: Integrációs fiók partner létrehozása
```
...
Ez a parancs létrehozza az IntegrationAccountPartner22 nevű integrációs partnert a megadott erőforráscsoportban.
...
### -PartnerName
Megadja az integrációs fiók partnerének nevét.
