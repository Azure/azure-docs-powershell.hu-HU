...
Módosítja a "sampleAssembly" nevű szerelvényt az "$localAssemblyFilePath" fájl elérési útjában található helyi fájl használatával.
...
### -ContentLink
Az integrációs fiók szerelvényi adataira mutató nyilvánosan elérhető hivatkozás.
