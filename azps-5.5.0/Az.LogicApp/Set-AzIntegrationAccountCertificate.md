...
## LEÍRÁS
A **Set-AzIntegrationAccountCertificate** parancsmag módosítja az integrációs fiók tanúsítványát.
Ez a parancsmag egy olyan objektumot ad vissza, amely az integrációs fiók tanúsítványát képviseli.
Megadhatja az integrációs fiók nevét, az erőforráscsoport nevét és a tanúsítvány nevét.
...
### 1. példa: Integrációs fiók tanúsítványának módosítása
```
...
Ez a parancs módosítja az integrációs fiók tanúsítványát a megadott erőforráscsoportban.

## PARAMETERS

### -CertificateName
Egy integrációs fiók tanúsítványának nevét adja meg.
...
### -KeyName
A kulcstárolóban tárolt tanúsítványkulcs nevét adja meg.
