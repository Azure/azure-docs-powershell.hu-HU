...
## LEÍRÁS
A Set-AzIntegrationAccountGeneratedIcn parancsmag frissíti a meglévő integrációs fiók által létrehozott adatcsere-vezérlőszámot (ICN), és visszaad egy objektumot, amely az integrációs fiók által létrehozott adatcsere-vezérlő számát jelzi.
...
Ez a parancs egy adott integrációs fiók szerződésének EdifactIntegrationAccountAgreement interchange vezérlőszámát kapja meg, 100-sal növeli az értékét, majd visszaírja a frissített értéket.
