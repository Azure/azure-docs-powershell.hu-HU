...
## LEÍRÁS
A **Set-AzApp** parancsmag a Logic Apps funkcióval módosítja a logikai appokat.
...
### -DefinitionFilePath
Egy logikai app definícióját adja meg egy JSON formátumú definíciófájl elérési útjaként.
