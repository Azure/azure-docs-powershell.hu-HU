...
## LEÍRÁS
Törli az erőforráscsoport és a név alapján hivatkozott Azure Machine Learning webszolgáltatást.
...
### -MlWebService
Az eltávolítható webszolgáltatás.
...
### -Name
Az eltávolítható webszolgáltatás neve.
