...
## LEÍRÁS
Frissíti a meglévő kötelezettségvállalási terv erőforrását. Ne feledje, hogy a kötelezettségvállalási terv legtöbb tulajdonsága nem módosítható, és nem módosítható. A módosítható tulajdonságok közé tartozik a termékváltozat (lehetővé teszi a kötelezettségvállalási terv áttelepítését egyik termékváltozatból a másikba) és a címkéket.
