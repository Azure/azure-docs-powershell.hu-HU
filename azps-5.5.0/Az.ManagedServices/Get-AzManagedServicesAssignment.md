...
Az alapértelmezett hatókör alá tartozó összes regisztrációs hozzárendelést beveszi.
...
Beveszi az összes regisztrációs hozzárendelést a regisztrációdefiníció részleteivel.
...
Név szerint, a regisztráció definíciójának részletei nélkül kapja meg a regisztráció-hozzárendelést.
...
Név szerint kap egy regisztráció-hozzárendelést a regisztráció definíciójának részleteivel.
...
Az összes regisztrációs hozzárendelést egy adott hatókörben kapja meg.
...
Megadhatja, hogy szerepeljenek-e a regisztrációdefiníció részletei.
...
### -Scope
A regisztrációs feladat létrehozási hatóköre.
