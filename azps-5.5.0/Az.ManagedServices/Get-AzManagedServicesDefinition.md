...
Az összes regisztrációs definíció alapértelmezett hatókörét beveszi.
...
A regisztráció definícióját név szerint, alapértelmezett hatókör szerint kapja meg.
...
A megadott hatókörű összes regisztrációs definíciót beveszi.
...
### -Scope
Az a hatókör, ahol a regisztrációs definíció létre van hozva.
