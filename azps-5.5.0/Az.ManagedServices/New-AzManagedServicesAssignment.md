...
Egy regisztrációs hozzárendelést hoz létre bemenetként egy regisztrációdefiníciós objektummal.
...
Frissíti a regisztrációs hozzárendelést egy regisztrációs definíció azonosítóval és névvel.
