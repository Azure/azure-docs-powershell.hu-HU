...
## LEÍRÁS
A Get-AzMapsAccount egy kiépített Azure Maps-fiókot kap, akár erőforráscsoport, akár név, akár erőforrásazonosító alapján. Ezenkívül az erőforráscsoport összes fiókja, illetve az aktuális előfizetéshez az összes Azure Maps-fiók listáját is visszaadhatja.
...
A MyResourceGroup erőforráscsoport MyAccount nevű fiókját (ha van ilyen) kapja meg.
