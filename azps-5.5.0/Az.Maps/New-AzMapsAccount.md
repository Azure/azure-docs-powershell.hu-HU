...
## SYNOPSIS
Létrehoz egy Azure Maps-fiókot.
...
## LEÍRÁS
A New-AzMapsAccount parancsmag létrehoz egy Azure Maps-fiókot a megadott termékváltozatkal.
...
Létrehoz egy MyAccount nevű új Azure Maps-fiókot a MyResourceGroup erőforráscsoportban az SKU S0-val és egy címkével.
...
### -SkuName
Térképek-fiók termékváltozatának neve.
