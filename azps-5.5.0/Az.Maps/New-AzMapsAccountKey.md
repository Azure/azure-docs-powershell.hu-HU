...
## LEÍRÁS
A New-AzMapsAccountKey parancsmag újragenerálja az Azure Maps-fiók API-kulcsát.
...
A MyAccount fiók elsődleges API-kulcsának újragenerálása a MyResourceGroup erőforráscsoportban.
...
A megadott Azure Maps-fiók másodlagos API-kulcsának újragenerálása.
