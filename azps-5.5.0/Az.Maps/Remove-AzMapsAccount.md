...
## LEÍRÁS
A Remove-AzMapsAccount parancsmag törli a megadott Azure Maps-fiókot.
...
Törli a MyAccount fiókot a MyResourceGroup erőforráscsoportból.
...
A megadott Azure Maps-fiók törlése.
...
### -InputObject
Térképek-fiók, amely a Get-AzMapsAccount fájlból van befedve.
...
### -PassThru
Adja vissza, hogy a megadott fiók törlése sikeres volt-e.
