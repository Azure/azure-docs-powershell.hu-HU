...
### 1. példa: Tűzfalszabály létrehozása a MariaDB csoportban
```powershell
...
Ez a parancs tűzfalszabályt hoz létre a MariaDB alatt.

### 2. példa: Új MariaDB tűzfalszabály létrehozása a -ClientIPAddress használatával.
```powershell
...
Ez a parancsmag létrehoz egy MariaDB tűzfalszabályt a -ClientIPAddress használatával.

### 3. példa: Új MariaDB tűzfalszabály létrehozása az összes IP-fiók engedélyezése érdekében
```powershell
...
Ez a parancsmag létrehoz egy új MariaDB tűzfalszabályt, amely engedélyezi az összes IP-et.
