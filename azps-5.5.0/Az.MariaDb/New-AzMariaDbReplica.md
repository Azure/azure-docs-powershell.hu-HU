...
Ez a paraméter-inputobject paramétert kezelő parancs létrehoz egy paraméter inputobject paramétert a MariaDB paraméterrel.
...
Ennek létrehozásáról a NOTES (ALAPtulajdonságok) című szakaszban és egy kivonattáblát hozhat létre.
