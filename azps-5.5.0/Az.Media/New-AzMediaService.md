...
## LEÍRÁS
A **New-AzMediaService** parancsmag médiaszolgáltatást hoz létre.
Ha a médiaszolgáltatás már létezik, ez a parancsmag frissíti a tulajdonságait.

## PÉLDÁK

### Példa1: Médiaszolgáltatás létrehozása csak az elsődleges tárfiókkal
```
PS C:\># Variables
## Global
...
Ez a példa azt mutatja be, hogy miként hozhat létre médiaszolgáltatást kizárólag elsődleges tárfiók megadásával.
Ez a parancsprogram számos más parancsmagot használ.

### 2. példa: Több tárterületet tároló médiaszolgáltatás létrehozása
```
PS C:\># Variables
...
Az alábbi példa azt mutatja be, hogy miként hozhat létre több tárfiókot tároló médiaszolgáltatást.
Ez a parancsprogram számos más parancsmagot használ.

## PARAMETERS

### -AccountName
A parancsmag által létrehozott médiaszolgáltatás neve.
...
### -Location
Azt a régiót adja meg, ahol a parancsmag létrehozza a médiaszolgáltatást.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amelyhez a médiaszolgáltatás hozzá van rendelve.
...
### -StorageAccountId
A médiaszolgáltatás-fiókhoz társított tárfiókot adja meg.
...
### -StorageAccounts
Az adathordozó-szolgáltatással társítandó tárfiókok tömbje.
...
### -Tag
A médiaszolgáltatás-fiókhoz társított címkék.
