...
## LEÍRÁS
A **Sync-AzMediaServiceStorageKey** parancsmag szinkronizálja a médiaszolgáltatással társított tárfiókok tárfiókkulcsait.

## PÉLDÁK

### 1. példa: A médiaszolgáltatáshoz társított tárfiók kulcsának szinkronizálása
```
...
Az első parancs a Get-AzStorageAccount parancsmagot használva szerezze be a Storage135 nevű tárfiókot, amely az ResourceGroup001-hez tartozik, és az eredményt a $StorageAccount.
A második parancs szinkronizálja a MediaService001 nevű médiaszolgáltatás  tárfiókkulcsait a $StorageAccount azonosítótulajdonságával.

## PARAMETERS

### -AccountName
A parancsmag által szinkronizált médiaszolgáltatás neve.
...
### -StorageAccountId
A médiaszolgáltatás-fiókhoz társított tárfiók azonosítója.
