...
INPUTOBJECT: A replikáló <IJob> kiszolgáló feladatobjektumát adja meg.
  ...
  - `[StateDescription <String>]`: A feladat állapotának leírása. Például: - A sikeres állapothoz a leírás befejezve, RészbenSucceed, CompletedWithInformation vagy Kihagyva lehet.
