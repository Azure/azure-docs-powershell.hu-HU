...
## SYNOPSIS
Beolvassa a replikáló kiszolgáló adatait.
...
### 1. példa: Részletek lekérte azonosító szerint
```powershell
...
### 2. példa: List all in project by id.
```powershell
...
### 2. példa: A projekt összes projektjét név szerint sorolja fel.
```powershell
...
### -DiscoveredMachineId
A felderített kiszolgáló számítógépazonosítóját adja meg.
...
### -MachineName
A replikáló számítógép megjelenítendő nevét adja meg.
...
### -ProjectName
Az aktuális előfizetés azure-áttelepítési projektjét határozza meg.
...
### -TargetObjectID
A replikáló kiszolgálót adja meg.
