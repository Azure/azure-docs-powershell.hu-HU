...
A szerkezetről a NOTES (JEGYZETEK) szakaszban találhatók a TULAJDONSÁGtulajdonságok, és létrehozhat egy kivonattáblát.
...
TULAJDONSÁG: <IMigrateProjectProperties> A projekttulajdonságok megadása.
  - `[ProvisioningState <ProvisioningState?>]`: A projekt áttelepítésének kiépítési állapota.
