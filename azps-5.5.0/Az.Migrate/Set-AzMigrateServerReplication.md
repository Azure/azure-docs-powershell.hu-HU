...
### -TargetNetworkId
Frissíti a virtuális hálózat azonosítóját a cél Azure-előfizetésen belül, amelyre a kiszolgálót át kell telepíteni.
...
NICTOUPDATE <IVMwareCbtNicInput[]>: Frissíti a nic for the Azure VM to be created.
  ...
  - `[TargetSubnetName <String>]`: A cél alhálózatának neve.
