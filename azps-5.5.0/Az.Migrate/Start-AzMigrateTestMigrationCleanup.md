...
## SYNOPSIS
A replikáló kiszolgáló tesztelési áttelepítésének megtisztítása.
...
Gépazonosító szerint.

### 2. példa: Bemeneti objektum alapján
```powershell
...
### -InputObject
Azt a replikáló kiszolgálót adja meg, amelyen el kell indítani a teszt áttelepítési tisztítását.
A kiszolgálóobjektum lekérthető a létrehozni Get-AzMigrateServerReplication parancsmaggal, az INPUTOBJECT tulajdonságokat lásd a NOTES szakaszban, és hozzon létre egy kivonattáblát.
...
### -TargetObjectID
Azt a replikáló kiszolgálót adja meg, amelyen el kell indítani a teszt áttelepítési tisztítását.
Az azonosítót a Get-AzMigrateServerReplication kell lekérni.
...
INPUTOBJECT: Azt a replikáló kiszolgálót adja meg, amelyen meg kell kezdeményezni a teszt áttelepítési <IMigrationItem> tisztítását. A kiszolgálóobjektum lekérhető a Get-AzMigrateServerReplication parancsmag használatával
