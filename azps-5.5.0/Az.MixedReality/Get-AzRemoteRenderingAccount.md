...
## SYNOPSIS
Távoli leképezési fiók lekérte
...
## LEÍRÁS
Távoli leképezési fiók(ak) be- vagy listába való be- vagy listába be- vagy listába történő be- vagy megjelenítése bizonyos előfizetési és erőforráscsoportokban.
...
A távoli leképezési fiók "példa" megjelenítése az "rg1" erőforráscsoportban 
