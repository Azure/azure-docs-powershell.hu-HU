...
## LEÍRÁS
Térbeli horgonyok be- vagy listába való be- vagy listába be- vagy listába sorolása adott Előfizetés és Erőforrás csoportban.
...
Get Térbeli horgonyok account "example" in Resource Group "rg1". 
