...
## SYNOPSIS
A távoli leképezési fiók kulcsának újragenerálása
...
## LEÍRÁS
A távoli leképezési fiók elsődleges kulcsának vagy másodlagos kulcsának újragenerálása.
...
A távoli leképezési fiók "példa" másodlagos kulcsának újragenerálása az "rg1" erőforráscsoportban. 
...
A távoli leképezési fiók "példa" másodlagos kulcsának újragenerálása az aktuális Előfizetés és Erőforráscsoport "rg1" példából pipázással.
...
### -Primary
A távoli leképezési fiók elsődleges kulcsának újragenerálása.
...
### -ResourceId
A távoli leképezési fiók erőforrásazonosítója.
