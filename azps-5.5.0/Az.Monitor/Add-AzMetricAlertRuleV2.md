...
## SYNOPSIS
V2 -es (nem klasszikus) metrikus alapú riasztási szabályt ad hozzá vagy frissíti.
...
Ez a parancs letiltja a metrikus riasztási szabályt. A [Get-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/get-azmetricalertrulev2) kimenetét átvezetjük az [Add-AzMetricAlertRuleV2-re.](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) 
