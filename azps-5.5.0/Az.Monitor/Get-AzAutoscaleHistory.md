...
## LEÍRÁS
A **Get-AzAutoscaleHistory parancsmag** begyűjte az automatikus skálázási beállításhoz kapcsolódó események előzményeit.

## PÉLDÁK

### 1. példa: Az előfizetéshez társított összes esemény lekérte
```
PS C:\>Get-AzAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

Ez a parancs az aktuális előfizetéshez tartozó összes automatikus méretezéssel kapcsolatos eseményt beveszi.

### 2. példa: GetAutoscaleHistory egy adott erőforráshoz
```
...
Ez a parancs az erőforrás azonosítója (lényegében a ResourceUri) által meghatározott erőforráshoz tartozó összes automatikus skálás eseményt bekeni.
...
### -ResourceId
Azt az erőforrás-azonosítót adja meg, amelyhez az automatikus skálázási beállítás társítva van.
...
### -Állapot
Egy szűrőt ad meg állapot szerint.
Ez a paraméter nem kötelező.
