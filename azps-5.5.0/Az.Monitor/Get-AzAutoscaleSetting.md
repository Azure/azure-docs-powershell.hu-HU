...
## SYNOPSIS
Automatikus skálázási beállításokat ad meg.
...
## LEÍRÁS
A **Get-AzAutoscaleSetting** parancsmag begyűjte az erőforráscsoporthoz vagy egy megadott automatikusskála-beállításhoz tartozó összes automatikusskála-beállítást.

## PÉLDÁK

### 1. példa: Automatikus méretezés beállításainak be- és beállítása
```
...
Ez a parancs a Default-Web-EastUS erőforráscsoporthoz rendelt automatikus skálázási beállításokat kapja meg.

### 2. példa: Automatikus méretezés beállítása név szerint
```
...
Ez a parancs a DefaultServerFarm-Default-Web-EastUS nevű automatikusskála-beállítást kapja.
...
### -DetailedOutput
Azt jelzi, hogy a művelet minden részletet megjelenít a kimenetben.
...
### -Name
A lekért beállítás nevét adja meg.
