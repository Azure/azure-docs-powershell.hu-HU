...
Az az érték, amely azt jelzi, hogy az exportálás (ODS-fájlba) erőforrás-specifikus (ha van) vagy AzureDiagnostics szolgáltatásba (alapértelmezett, nincs jelen)
