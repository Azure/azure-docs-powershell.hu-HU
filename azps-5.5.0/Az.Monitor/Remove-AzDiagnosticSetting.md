...
### -Name
A diagnosztikai beállítás neve. Ha a hívás alapértelmezett értéke nem "szolgáltatás", mint az előző API-ban volt, és ez a parancsmag csak a metrikák/naplók kategóriáit tiltja le.
