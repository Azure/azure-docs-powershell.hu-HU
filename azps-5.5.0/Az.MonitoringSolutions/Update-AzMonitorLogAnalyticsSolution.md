...
### 1. példa: Figyelt naplóelemzési megoldás frissítése név szerint
```powershell
...
Ez a parancs név szerint frissíti a figyelésnapló-elemzési megoldást.

### 2. példa: Monitornapló-elemzési megoldás frissítése objektum szerint
```powershell
...
Ez a parancs objektumról objektumra frissíti a figyelésnapló-elemzési megoldást.
