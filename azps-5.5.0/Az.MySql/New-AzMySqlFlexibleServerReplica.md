...
MESTER: <IServerAutoGenerated> Az a forráskiszolgáló-objektum, amelyből másolatot kell létrehozni.
  ...
  - `[MaintenanceWindowCustomWindow <String>]`: azt jelzi, hogy az egyéni ablak engedélyezve vagy letiltva van-e
  ...
  - `[RestorePointInTime <DateTime?>]`: Visszaállítási pont létrehozási ideje (ISO8601 formátum), amely megadja a visszaállítás idejét.
