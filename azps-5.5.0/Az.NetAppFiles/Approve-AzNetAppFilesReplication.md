...
## LEÍRÁS
A forráskötet replikációs kapcsolatának jóváhagyása
...
Ez a parancs jóváhagyja a replikációt a MyAnfVolume-on.

## PARAMETERS

### -AccountName
A replikációs forráskötet ANF-fiókjának neve
...
A céladatvédelmi mennyiség fájlrendszer-azonosítója
...
### -InputObject
AnF-forráskötet-objektum a replikációs célhely engedélyének beállításához
...
### -Name
Az ANF-replikációs forráskötet neve
...
### -PassThru
Annak visszaadása, hogy a megadott kötet replikációs engedélyezése történt-e
...
### -PoolName
A replikációs forráskötet ANF-készletének neve
...
### -ResourceGroupName
Az ANF replikációs forráskötet erőforráscsoportja
...
### -ResourceId
Az ANF-replikációs forráskötet erőforrás-azonosítója
