...
Ez a parancs a replikáció állapotát kapja meg a MyVolen

## PARAMETERS

### -AccountName
A replikációs célkötet ANF-fiókjának neve
...
### -InputObject
AnF replikációs célhelyének kötetobjektuma a replikáció állapotának leellenőrzése
...
### -PoolName
A replikációs célkötet ANF-készletének neve
