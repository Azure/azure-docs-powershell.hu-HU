...
Ez a parancs az Active Directory-jelszót a "MyAnfAccount" ANF-fiók új Active Directory-konfigurációjában kapja meg.
...
### -BackupOperator
A beépített biztonságimásolat-operátor active directory-csoportjához hozzáadható felhasználók.
