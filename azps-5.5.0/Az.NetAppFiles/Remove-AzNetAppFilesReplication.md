...
Ez a parancs eltávolítja az ANF-replikációs kapcsolatot a "MyDestinationAnfVolume" köteten.
...
### -InputObject
Az ANF-célkötet az eltávolítható replikációval
...
### -PassThru
Annak visszaadása, hogy a megadott ANF-replikáció sikeresen el lett-e távolítva
