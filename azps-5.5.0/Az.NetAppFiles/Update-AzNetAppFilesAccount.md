...
## LEÍRÁS
Az **Update-AzNetAppFilesAccount** parancsmag módosítja az ANF-fiókot.

## PÉLDÁK

### 1. példa: ANF-fiók frissítése
```
...
Ez a parancs frissítést hajt végre az adott fiókon, és módosítja a megadott címkéket.
...
### -InputObject
Frissítend kell a fiókobjektumot
