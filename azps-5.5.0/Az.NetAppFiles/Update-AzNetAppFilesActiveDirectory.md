...
## LEÍRÁS
Az **Update-AzNetAppFilesAccount** parancsmag módosítja az ANF active directory-konfigurációt.
...
Ez a parancs frissítést hajt végre az adott Active Directory-konfiguráción, és módosítja a megadott felhasználónevet.
...
### -AccountObject
Az Active Directory-objektum fiókja
...
### -ActiveDirectoryId
Az ANF active directory azonosítója
...
### -AdName
Az Active Directory-számítógép neve.
Ezt a választható paramétert csak kerberos-kötet létrehozásakor használja a rendszer.
...
### -BackupOperator
Azok a felhasználók, akik hozzá lesznek adva a Beépített biztonságimásolat-operátor active directory-csoporthoz.
Egyedi felhasználónévk listája tartománykihívó nélkül
...
### -Dns
Az Active Directory-tartomány DNS-kiszolgálójának IP-címeinek vesszővel elválasztott listája (csak IPv4 esetén)
...
### -InputObject
Az eltávolítható Active Directory-objektum
...
### -KdcIP
az Active Directory-számítógép kdc-kiszolgálójának IP-címei.
Ezt az opcionális paramétert csak kerberos-kötet létrehozásakor használja a rendszer.
...
### -Password
Az Active Directory tartományi rendszergazdájának egyszerű szöveges jelszava, a válaszban az érték van maszkos
...
### -Site
Az Active Directory-webhely, a szolgáltatás a tartományvezérlő felderítését a következőre korlátozza:
...
### -SmbServerName
Az SMB-kiszolgáló Net ÖSSZES. neve.
Ez a név lesz regisztrálva számítógépfiókként az AD-ban, és a kötetek csatlakoztatásakor használatos.
