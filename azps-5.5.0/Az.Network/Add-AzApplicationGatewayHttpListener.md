...
## LEÍRÁS
Az **Add-AzApplicationGatewayHttpListener parancsmag** hozzáad egy HTTP-hallgatót egy alkalmazás-átjáróhoz.

## PÉLDÁK

### 1. példa: HTTP-hallgató hozzáadása
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> $Appgw = Add-AzApplicationGatewayHttpListener -ApplicationGateway $AppGw -Name "listener01" -Protocol "Http" -FrontendIpConfiguration $FIP01 -FrontendPort $FP01
```

Az első parancs az alkalmazás átjáróját a $AppGw tárolja. A második parancs hozzáadja a HTTP-hallgatót az alkalmazás átjáróhoz.

### 2. példa: HTTPS-hallgató hozzáadása SSL-sel
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
A második parancs hozzáadja a hallgatót, amely a HTTPS protokollt használja az alkalmazás-átjáróhoz.

### 3. példa: HTTPS-hallgató hozzáadása SSL és HostNames szolgáltatóval
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
### -ApplicationGateway
Azt az alkalmazás-átjárót adja meg, amelyhez ez a parancsmag hozzáad egy HTTP-hallgatót.
...
Az alkalmazás átjárója előlapi IP-erőforrás-objektumát adja meg.
...
Az alkalmazás átjárójának előlapi IP-azonosítója.
...
### -FrontendPort
Az alkalmazás átjárójának előlapi portobjektumát adja meg.
...
### -HostName
Megadja azt az állomásnevet, amelybe ez a parancsmag hozzáad egy HTTP-hallgatót.
...
### -Name
A parancs által összeadott előlapi port nevét adja meg.
...
### -Protocol
A HTTP-hallgató protokollját határozza meg.
A HTTP és a HTTPS protokoll egyaránt támogatott.
...
Meg kell adni, ha a HTTPS meg van adva hallgató protokollként.
...
### -SslCertificateId
A HTTP-hallgató SSL-tanúsítványazonosítóját adja meg.
Meg kell adni, ha a HTTPS protokoll van megadva.
