...
## LEÍRÁS
Az **Add-AzApplicationGatewayRequestRoutingRule** parancsmag hozzáad egy kéréstovábbítási szabályt egy alkalmazás-átjáróhoz.

## PÉLDÁK

### 1. példa: Kéréstovábbító szabály hozzáadása alkalmazás-átjáróhoz
```
...
A második parancs hozzáadja a kéréstovábbítási szabályt az alkalmazás-átjáróhoz.

## PARAMETERS

### -ApplicationGateway
Azt az alkalmazás-átjárót adja meg, amelyhez ez a parancsmag egy kéréstovábbító szabályt ad hozzá.
...
### -BackendAddressPool
Egy alkalmazás-átjáró háttércímkészlet-objektumát adja meg.
...
Egy alkalmazás-átjáró háttércímkészlet-azonosítóját adja meg.
...
### -BackendHttpSettings
Egy alkalmazás-átjáró háttér-HTTP-beállítási objektumát adja meg.
...
Egy háttér-HTTP-beállításazonosítót ad meg egy alkalmazás-átjáróhoz.
...
### -HttpListener
Az alkalmazás átjárója HTTP-et hallgató objektum megadása.
...
### -Name
A parancsmag által megadott kéréstovábbítja szabály nevét adja meg.
...
### -RuleType
A kéréstovább kiszolgálói szabály típusát határozza meg.
...
### -UrlPathMapId
Az útválasztási szabály URL-útvonal-leképezés-azonosítóját adja meg.
