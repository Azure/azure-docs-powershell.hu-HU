...
A parancs ezután az eredményt a $Subnet.
...
### -PublicIpAddress
Azt a nyilvános IP-címet adja meg, amely az előlapi IP-konfigurációhoz társítva van.
...
### -Alhálózat
Megadja azt az alhálózati objektumot, amelyhez előtér-IP-konfigurációt szeretne hozzáadni.
