...
Először két új alkalmazásbiztonsági csoportot hozunk létre. Ezután lekérünk egy "nsg1" nevű Azure-hálózatbiztonsági csoportot az "rg1" erőforráscsoportból. és adjon hozzá egy "rdp-rule" nevű hálózati biztonsági szabályt. A szabály lehetővé teszi az "srcAsg" alkalmazásbiztonsági csoport összes IP-konfigurációjának adatforgalmát a 3389-es porton található "destAsg" IP-konfigurációkba. A szabály hozzáadása után megmarad a módosított Azure-hálózat biztonsági csoport.
