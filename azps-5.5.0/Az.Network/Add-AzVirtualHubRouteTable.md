...
## LEÍRÁS
A virtuális központi útvonaltábla-erőforrás tartalmazza az útvonalak és kapcsolatok listáját, amelyekhez csatolható, és a virtuális központban lévő forgalom útválasztásához használható.
...
A fenti parancs létrehoz egy Virtuális központi útvonaltábla-erőforrást a neki átadott útvonalakból, és ez az objektum használható a virtuális központban lévő forgalom átirányítására.  

## PARAMETERS

### -Connection
Azon kapcsolatok listája, amelyekhez ez az útvonaltábla csatolva van.
...
### -Útvonal
A virtuális központi útvonalak listája.
