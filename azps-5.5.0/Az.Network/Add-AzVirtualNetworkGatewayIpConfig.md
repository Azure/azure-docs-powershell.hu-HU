...
## LEÍRÁS
Az **Add-AzVirtualNetworkGatewayIpConfig** parancsmag IP-konfigurációt ad egy virtuális hálózati átjáróhoz.
...
### -Name
A hozzáadni szükséges átjáró IP-konfigurációjának nevét adja meg.
...
A Get-AzVirtualNetworkGateway használatával lekérhet egy **PSVirtualNetworkGateway-objektumot.**
