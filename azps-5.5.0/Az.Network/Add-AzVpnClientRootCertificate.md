...
Ha nem rendelkezik X.509-es tanúsítvánnyal, létrehozhat egyet a nyilvános kulcsú infrastruktúrán keresztül, vagy használhat egy tanúsítványkészítőt, például makecert.exe.
Gyökértanúsítvány hozzáadásához meg kell adnia a tanúsítvány nevét, és csak szövegesen kell megadnia a tanúsítványt (további információt a *PublicCertData* paraméterben).
...
Az első parancs **a Get-Content** parancsmag segítségével bekéri a legfelső szintű tanúsítvány korábban exportált szövegét, és tárolja a $Text.
...
A harmadik parancs ezután a $CertificateText-ben tárolt szöveget használja az **Add-AzVpnClientRootCertificate** parancsmaggal a gyökértanúsítvány átjáróhoz való hozzáadásához.
...
Annak a virtuális hálózati átjárónak a neve, ahol a tanúsítványt hozzáadta.
