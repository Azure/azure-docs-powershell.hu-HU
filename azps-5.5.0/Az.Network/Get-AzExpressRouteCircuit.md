...
## LEÍRÁS
A **Get-AzExpressRouteCircuit** parancsmaggal lekérhető egy ExpressRoute-áramköri objektum az előfizetéséből. A visszaadott áramköri objektum használható bemenetként más, ExpressRoute-áramkörön működő parancsmagok számára.

## PÉLDÁK

### 1. példa: Az ExpressRoute-áramkör lekérte
```
...
Adott ExpressRoute-áramkör létrehozása "testrg" névvel és ResourceGroupName "teszt" névvel

### 2. példa: Az ExpressRoute-áramkörök felsorolása szűrés használatával
```
...
Szerezze be az összes Olyan ExpressRoute-áramkört, amelynek a neve "teszt" névvel kezdődik.
