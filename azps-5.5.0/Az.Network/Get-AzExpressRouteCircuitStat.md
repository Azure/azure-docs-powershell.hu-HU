...
## LEÍRÁS
A **Get-AzExpressRouteCircuitStat** parancsmag beolvassa egy ExpressRoute-áramkör adatforgalmi statisztikáját. A statisztikákban az elsődleges és a másodlagos útvonalon küldött és fogadott bájtok száma is szerepel.

## PÉLDÁK

### 1. példa: ExpressRoute-társ forgalmi statisztikáinak megjelenítése
```
