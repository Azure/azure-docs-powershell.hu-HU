...
## LEÍRÁS
A **Get-AzFirewallPolicyRuleCollectionGroup** parancsmag egy tűzfalházi házirendből megemlített RuleCollectionGroup parancsmagot kapja
...
Ebben a példában a szabálygyűjteményCsoport a tűzfal-házirendben $fp

### 2. példa

Gets a Azure Firewall Policy Rule Collection Group. (automatikusan generált)
