...
## SYNOPSIS
Szerezze be vagy sorolja fel a rendelkezésre álló hálózati virtuális eszköz-termék termékét a készletben.
...
## LEÍRÁS
A Get-AzNetworkVirtualApplianceSku a Microsoft Azure készletében elérhető hálózati virtuális eszköz-termék termékkusszal.
...
Termékváltozat lekérte név szerint.
...
Sorolja fel a hálózati virtuális eszköz összes elérhető termékét.
