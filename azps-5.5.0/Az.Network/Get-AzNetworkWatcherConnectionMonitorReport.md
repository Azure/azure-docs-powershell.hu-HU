...
## LEÍRÁS
A Get-AzNetworkWatcherConnectionMonitorReport parancsmag a legutóbbi csatlakozási államok jelentését adja vissza.

## PÉLDÁK

### 1. példa: A kapcsolatfigyelő legutóbbi kapcsolatfelvételi pillanatképének lekérte név szerint a megadott helyen
```
...
Ebben a példában a megadott kapcsolatfigyelő legutóbbi kapcsolati állapotát kérdezjük.
...
### -ResourceId
A kapcsolatfigyelő erőforrás-azonosítója.
...
## MEGJEGYZÉSEK
Kulcsszavak: azure, azurerm, arm, erőforrás, kapcsolat, kezelés, vezető, hálózat, hálózatkezelés, hálózati figyelő, kapcsolatfigyelő
