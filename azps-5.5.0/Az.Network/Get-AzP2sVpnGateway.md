...
## LEÍRÁS
A **Get-AzP2sVpnGateway** parancsmag lehetővé teszi, hogy meglévő P2SVpnGatewayt kap a VirtualHub alatt.
...
A **Get-AzP2sVpnGateway** parancsmag lehetővé teszi egy meglévő P2SVpnGateway lekért beállítását a VirtualHub alatt, amely a Point to site connectivity funkcióval használható.
