...
A **Get-AzP2sVpnGatewayConnectionHealth** parancsmag lehetővé teszi a P2SVpnGatewayből a webhelykapcsolatok aktuális összesített állapotát. Above command let output health shows that number to site clients connected to P2SVpnGateway are 2. A P2SVpnGatewayen keresztül átvitt összes bejövő és kiúsó bájt 100, illetve 200. A helyhez kapcsolt ügyfelek ip-címei a következőek: "192.168.2.1", "192.168.2.2".
