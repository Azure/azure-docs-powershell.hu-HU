...
## LEÍRÁS
A **Get-AzP2sVpnGatewayDetailedConnectionHealth** parancsmag lehetővé teszi a P2SVpnGatewayből a webhelykapcsolatok aktuális pontjának részletes adatait. Az ügyfélnek át kell adnia az SAS URL-címét, ahol meg tudjuk adni ezt a részletes egészségügyi információt.
...
A **Get-AzP2sVpnGatewayDetailedConnectionHealth** parancsmag lehetővé teszi a P2SVpnGatewayből a webhelykapcsolatok aktuális pontjának részletes adatait. Az ügyfél letöltheti az állapotadatokat az SAS-url-címről. Itt a webhely-kapcsolat minden pontjának adatait meg fogja jelenni felhasználónévvel, bájttal, bájttal, kiosztott IP-címmel stb.
...
### -OutputBlobSasUrl
OutputBlob Sas URL-cím, amelyre a p2s vpn kapcsolat állapota lesz megírva.
...
### -VpnUserNamesFilter
A szűrni megfelelő P2S vpn-felhasználónevek listája.
