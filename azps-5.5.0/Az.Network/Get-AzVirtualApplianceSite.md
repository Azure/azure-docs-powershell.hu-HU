...
## SYNOPSIS
Szerezze be vagy sorolja fel a hálózati virtuális eszköz erőforrás(ak)hoz csatlakoztatott webhelyeket.
...
## LEÍRÁS
A Get-AzVirtualApplianceSite egy vagy több hálózati virtuális eszközerőforráshoz csatlakoztatott webhelyeket kap vagy sorol fel.
...
Virtuális eszköz webhelyerőforrást kap.
...
Virtuális eszköz webhely erőforrásainak felsorolása egy hálózati virtuális eszközben.
...
A hálózati virtuális eszköz, amelyhez a webhely csatolva van.
...
### -ResourceId
A virtuális eszköz webhelyének erőforrás-azonosítója.
