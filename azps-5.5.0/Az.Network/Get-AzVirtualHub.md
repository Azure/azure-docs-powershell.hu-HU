...
A fenti egy "testRG" erőforráscsoportot, egy virtuális WAN-t és egy virtuális központot hoz létre az Azure-ban az adott erőforráscsoportban. A virtuális központ a "10.0.1.0/24" címterületet fogja rendelkezésre álló helyen.

Ezután a virtuális központ a ResourceGroupName és az ResourceName nevet használja.
...
Ez a parancsmag szűrést használva kapja meg a virtuális központot.
