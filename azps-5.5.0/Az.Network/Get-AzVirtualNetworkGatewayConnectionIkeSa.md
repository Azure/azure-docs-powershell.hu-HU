...
## SYNOPSIS
Virtuális hálózati átjárókapcsolat IKE biztonsági társításának lekésse
...
## LEÍRÁS
A **Get-AzVirtualNetworkGatewayConnectionIkeSa** parancsmag a kapcsolat IKE biztonsági társítását adja vissza a Kapcsolat neve és az Erőforráscsoport neve alapján.
Ha a **Get-AzVirtualNetworkGatewayConnection** parancsmagot a -Name paraméter megadása nélkül bocsátotta ki, a kimenet nem fogja az IKE biztonsági társításokat mutatni.
...
A "myRG" erőforráscsoporton belül a "myTunnel" nevű virtuális hálózati átjáró kapcsolat IKE biztonsági társítását adja eredményül.
...
### -InputObject
Az a virtuális hálózati átjáró kapcsolati objektuma, amelyhez le kell kérni az IKE SAs-t.
...
### -Name
Az a virtuális hálózati átjáró kapcsolatneve, amelyhez le kell kérni az IKE SAs-t.
...
### -ResourceId
A virtuális hálózati átjáró kapcsolatának Azure-erőforrásazonosítója, amelyhez le kell kérni az IKE SAs-t.
