...
## LEÍRÁS
Felsorolja az Azure virtuális hálózati átjáró által a különböző forrásokból megtanult útvonalakat. Ide tartoznak a BGP-kapcsolaton keresztül tanult útvonalak, valamint a statikus útvonalak is. 
...
Az Erőforráscsoport erőforráscsoportban az átjárónév nevű Azure virtuális hálózati átjáró esetében beolvassa az Azure-átjáró által ismert útvonalakat. Ebben az esetben az Azure virtuális hálózati átjárónak két statikus útvonala van (10.1.0.0/16 és 10.0.0.254/32), valamint egy BGP-en keresztül (10.0.0.0/16) tanult útvonal.
