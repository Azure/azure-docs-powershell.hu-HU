...
## LEÍRÁS
A **Get-AzVirtualNetworkTap** parancsmag egy Azure virtuális hálózatra való koppintást vagy az Azure virtuális hálózat egy erőforráscsoportban való listáját koppintja.
