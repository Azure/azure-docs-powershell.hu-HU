...
- A háttérkiszolgáló készletének beállításai. Minden készletnek vannak olyan beállításai, mint a port, a protokoll és a cookie-alapú affinitás, amelyek a készleten belüli összes kiszolgálóra érvényesek.
...
- Kéréstovábbító szabály, amely összeköti a figyelőt és a háttérkiszolgáló-készletet. A szabály azt határozza meg, hogy melyik háttérkiszolgáló készletbe kell irányítani a forgalmat, amikor egy adott hallgatóhoz ér.
...
Hogy engedélyezve van-e a Force firewallPolicy társítás.
...
### -Fogarasok
Az alkalmazás átjárójára vonatkozó értékeket határozza meg.
...
A megbízható ügyfél-hitelesítésszolgáltatói tanúsítványláncok listája
...
Az Alkalmazás átjáróhoz hozzárendelni rendelt felhasználó identitásának Erőforrásazonosítója.
...
Egy webalkalmazás tűzfalának (WAF) konfigurációját adja meg. A Get-AzApplicationGatewayWebApplicationFirewallConfiguration parancsmagot is használhatja.
