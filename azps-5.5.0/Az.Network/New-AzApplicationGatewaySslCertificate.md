...
### 2. példa: Hozzon létre egy SSL-tanúsítványt a KeyVault Secret (version-less secretId) segítségével, és vegye fel egy alkalmazás-átjáróba.
```
...
### -Password
A parancsmag által létrehozott SSL-jelszót adja meg.
