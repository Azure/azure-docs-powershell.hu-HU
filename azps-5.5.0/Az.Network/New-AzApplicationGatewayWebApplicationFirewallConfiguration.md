...
## LEÍRÁS
A **New-AzApplicationGatewayWebApplicationFirewallConfiguration parancsmag** létrehoz egy webalkalmazás tűzfalát (WAF) egy Azure-alkalmazás átjáróhoz.

## PÉLDÁK

### 1. példa: Webalkalmazás tűzfal-konfigurációjának létrehozása alkalmazás-átjáróhoz
```
...
Az első parancs létrehoz egy új letiltott szabálycsoport-konfigurációt a REQUEST-942-APPLICATION-ATTACK-SQLI nevű szabálycsoporthoz, a 942130-as és a 942140-es szabály letiltva.
A második parancs egy másik letiltott szabálycsoport-konfigurációt hoz létre a "REQUEST-921-PROTOCOL-ATTACK" nevű szabálycsoporthoz. Nincsenek kifejezetten átkért szabályok, így a szabálycsoport összes szabálya le lesz tiltva.
Az utolsó parancs ezután létrehoz egy, a $disabledRuleGroup 1-ben és a $disabledRuleGroup 2-ben konfigurált tűzfalszabályokat letiltó waf konfigurációt. Az új WAF-konfigurációt a rendszer a $firewallConfig tárolja.
...
### -FirewallMode
A webalkalmazás tűzfalmódját határozza meg.
...
### -MaxRequestQuestSizeInKb
A kérés maximális mérete KB-ban.
...
### -RequestCheck
Függetlenül attól, hogy a kérelem törzse be van-e jelölve.
...
### -RuleSetType
A webalkalmazás tűzfalszabály-halmazának típusa. A paraméter elfogadható értékei a következőek: 
- OWASP
...
### -RuleSetVersion
A szabálykészlet-típus verziója.
