...
Ez a példa létrehoz egy szabályt az összes TCP-forgalomra. Egy felhasználó kényszeríti, hogy a forgalom engedélyezett vagy megtagadható legyen-e egy szabályhoz a hozzá társított szabálygyűjtemény alapján.
...
Ebben a példában a 10.0.0.0/16-os számú forrásból származó összes TCP-forgalomra létrehoz egy szabályt. A felhasználó kényszeríti, hogy a forgalom engedélyezett vagy megtagadható legyen-e egy szabályhoz a hozzá társított szabálygyűjtemény alapján.
...
### -Protocol
Meghatározza, hogy milyen típusú adatforgalom legyen szűrve ezzel a s szabálysal. Lehetséges értékek: TCP, UDP, ICMP és Any.
