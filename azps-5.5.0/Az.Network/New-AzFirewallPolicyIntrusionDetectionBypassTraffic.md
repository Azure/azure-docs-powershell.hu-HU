...
## SYNOPSIS
Új Azure firewall policy intrusion Detection Bypass Traffic Setting (Adatforgalom megkerülése beállítás) létrehozása
...
## LEÍRÁS
A **New-AzFirewallPolicyIntionDetectionBypassTraffic** parancsmag létrehoz egy Azure tűzfalházi házirend-behatolás észlelését a forgalomobjektum megkerülése érdekében.

## PÉLDÁK

### 1. példa: 1. Adatforgalom megkerülése adott port- és forráscímekkel
```powershell
...
### -Leírás
Figyelmen kívül kell mellőzni a beállítás leírását.
...
### -DestinationAddress
A cél IP-címek vagy -tartományok listája.
...
### -DestinationPort
A célportok vagy tartományok listája.
...
### -Name
A beállítás nevének megkerülése
...
### -Protocol
Protokollbeállítás megkerülése
...
### -SourceAddress
Forrás IP-címek vagy -tartományok listája.
