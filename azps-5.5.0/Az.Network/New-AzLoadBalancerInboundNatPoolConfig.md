...
## LEÍRÁS
A **New-AzLoadBalancerInboundNatPoolConfig** parancsmag létrehoz egy bejövő NAT-készlet-konfigurációt egy terheléselegyenlő számára.
...
A TCP-inaktív kapcsolat időkorlátja. Az érték 4 és 30 perc között lehet. Az alapértelmezett érték 4 perc. Ez az elem csak AKKOR használatos, ha a protokoll TCP-re van állítva.
