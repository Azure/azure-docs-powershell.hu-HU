...
## LEÍRÁS
A **New-AzLoadBalancerRuleConfig** parancsmag létrehoz egy szabálykonfigurációt egy Azure terheléselegyenlő számára.

## PÉLDÁK

### 1. példa: Szabálykonfiguráció létrehozása az Azure Load Balancer eszközben
```powershell
...
Az első három parancs nyilvános IP-címet, előlapot és szabálykonfigurációt állíthat be a oda-vissza parancsban. A "oda" parancs létrehoz egy MyL Minden nevű szabályt bizonyos specifikációkkal.

## PARAMETERS

### -BackendAddressPool
Egy **BackendAddressPool** objektumot ad meg, amely a terheléselosztási szabály konfigurációját társítja.
...
### -Name
A parancsmag által létrehozott terheléselosztási szabály neve.
...
### -Protocol
Azt a protokollt adja meg, amelyet egy terheléselosztási szabály konfigurációja megfeleltet.
