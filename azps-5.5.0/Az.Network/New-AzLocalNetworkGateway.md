...
A **New-AzLocalNetworkGateway** parancsmag létrehozza a helyszíni átjárónak megfelelő objektumot az átjáró neve, erőforráscsoportneve, helye és IP-címe, valamint az Azure-hoz csatlakozó helyszíni hálózat címelőtagja alapján.
...
Létrehozza a helyi hálózati átjáró "myLocalGW" nevű objektumát a "myRG" erőforráscsoportban a "Nyugat-USA" helyen a "23.99.221.164" IP-címmel és a "10.5.51.0/24" előtaggal a helyszínen.
...
### -Fqdn
A helyi hálózati átjáró teljes tartománya.
...
### -ResourceGroupName
Azt az erőforráscsoportot adja meg, amelyhez a helyi hálózati átjáró tartozik.
