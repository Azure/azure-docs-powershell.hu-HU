...
## LEÍRÁS
A New-AzNetworkWatcherPacketCapture parancsmag létrehoz egy új csomagrögzítési erőforrást, és elindít egy csomagrögzítési munkamenetet egy VM-en.
A Csomagrögzítési munkamenetek hosszát időkényolhatja vagy méretkényolhatja. Az egyes csomagokhoz rögzített adatok mennyisége is konfigurálható.
Szűrők alkalmazhatók egy adott csomagrögzítési munkamenetre, így testre szabhatja a rögzített csomagok típusát. A szűrőkkel korlátozható a helyi és távoli IP-címek & címtartományok, helyi és távoli portok & porttartományok és a rögzített munkamenetszintű protokoll. A szűrők kompatibilisek, és több szűrőt is alkalmazhat, hogy a felvétel részletes legyen.
...
### -Filter
A csomagrögzítési munkamenet szűrői.
