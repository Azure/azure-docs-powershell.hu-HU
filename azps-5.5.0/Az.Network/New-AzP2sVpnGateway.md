...
### ByVirtualHubNameByVpnServerConfigurationObject (alapértelmezett)
```
...
## LEÍRÁS
A New-AzP2sVpnGateway parancsmag segítségével új P2SVpnGatewayt hozhat létre a VirtualHub alatt, hogy a Point to site connectivity (Point to site clients) és az Azure VirtualWan (Azure VirtualWan) között a point to site connectivity (Pontról webhelyre) lehetőség legyen.
...
A New-AzP2sVpnGateway parancsmag lehetővé teszi, hogy új P2SVpnGatewayt hozzon létre a VirtualHub alatt a Point to site connectivity beállításhoz.
...
### -VirtualHub
A VirtualHub ezzel a P2SVpnGateway-sel kell társítva lennie.
...
### -VirtualHubId
Annak a VirtualHubnak az azonosítója, amelyhez a P2SVpnGatewaynek társítva kell lennie.
