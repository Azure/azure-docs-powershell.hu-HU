...
## LEÍRÁS
A **New-AzRouteConfig** parancsmag létrehoz egy útvonalat egy Azure-útvonaltáblához.
...
Az első parancs létrehoz egy Route07 nevű útvonalat, majd a $Route tárolja.
...
- VirtualAppliance.
Egy virtuális eszköz, amely az Azure virtuális hálózatához van hozzáadva. 
