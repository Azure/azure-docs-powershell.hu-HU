...
```
A fenti parancsok beszerzik egy már meglévő AzVHubRoute RoutingConfiguration parancsát, majd hozzáadnak egy statikus útvonalat a kapcsolathoz. Másik lehetőségként, ha új kapcsolatot fog létrehozni a benne található statikus útvonalsal, olvassa el az [1. példát.](New-AzRoutingConfiguration.md)
## PARAMETERS
