...
A fenti egy "testRG" erőforráscsoportot, egy virtuális WAN-t és egy virtuális központot hoz létre az Azure-ban az adott erőforráscsoportban. A virtuális központ a "10.0.1.0/24" címterületet és egy útválasztási táblát fog csatolni.
