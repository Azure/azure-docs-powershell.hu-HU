...
A **New-AzVirtualNetworkGateway** parancsmag létrehozza az átjáró objektumát az Azure-ban a Név, az Erőforráscsoport neve, a Hely és az IP-cím konfigurációja, valamint az átjáró típusa, illetve ha VPN, a VPN-típus alapján. Az átjáró termékváltozatát is meg is nevezheti.
...
A fentiek létrehoznak egy erőforráscsoportot, nyilvános IP-címet kérnek, virtuális hálózatot és alhálózatot hoznak létre, valamint P2S-beállításokkal rendelkező virtuális hálózati átjárót hoznak létre (pl. VpnProtocol, VpnClientAddressPool, VpnClientRootCertificates, VpnClientIpsecPolicy stb.) az Azure-ban.
