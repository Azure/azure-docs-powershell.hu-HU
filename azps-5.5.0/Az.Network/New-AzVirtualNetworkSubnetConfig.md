...
## LEÍRÁS
**A New-AzVirtualNetworkSubnetConfig** parancsmag létrehoz egy virtuális hálózati alhálózati konfigurációt.

## PÉLDÁK

### 1. példa: Virtuális hálózat létrehozása két alhálózattal és egy hálózati biztonsági csoporttal
```powershell
...
Ebben a példában két új alhálózati konfigurációt hoz létre a New-AzVirtualSubnetConfig parancsmag használatával, majd egy virtuális hálózat létrehozásához használja őket. A New-AzVirtualSubnetConfig sablon csak az alhálózat memóriában való megjelenítését hozza létre. Ebben a példában a frontendSubnet CIDR 10.0.1.0/24-es, és egy RDP-hozzáférést lehetővé tő hálózati biztonsági csoportra hivatkozik. A BackendSubnet CIDR 10.0.2.0/24-es, és ugyanazon hálózati biztonsági csoportra hivatkozik.
...
### -Name
A létrehozni szükséges alhálózati konfiguráció nevét adja meg.
...
### -RouteTable
Az alhálózati konfigurációhoz társított útvonaltábla.
...
### -RouteTableId
Az alhálózat konfigurációjával társított útválasztási tábla azonosítója.
...
Szolgáltatásvégpont-házirendek
