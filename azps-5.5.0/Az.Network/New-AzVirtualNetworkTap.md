...
Ez a parancs létrehoz egy virtuális hálózatra vonatkozó "VirtualNetworkTap1" nevet, amely tartalmazza a cél VIRTUÁLIS GÉP konfigurációs adatait (DestinationIpConfiguration, DestinationPort).
...
Ez a parancs létrehoz egy virtuális hálózatra vonatkozó "VirtualNetworkTap1" nevet, amely tartalmazza a cél VIRTUÁLIS GÉP konfigurációs adatait (FrontEndIpConfiguration).
A VM-hez konfigurált összes forrássérintés ebbe a LoadBalancer IpConfigurationba lesz irányítva. Az alapértelmezett célport 4789.
