...
Az első parancs a **Get-Content** parancsmagot használja a legfelső szintű tanúsítvány korábban exportált szövegként való megjelenítéséhez; hogy a szöveges adatokat egy $Text.
