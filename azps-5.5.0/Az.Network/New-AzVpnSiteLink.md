...
A fentiekkel létrehoz egy erőforráscsoportot (Virtuális WAN és VpnSite, 1 VpnSiteLinks-et a nyugat-egyesült államokbeli "testRG" erőforráscsoportban az Azure-ban).

### 2. példa

Azure VpnSiteLink-objektumot hoz létre. (automatikusan generált)
...
### -BGPPeeringAddress
A VpnSiteLink BGP-társviszony-létesítő címe.
...
### -Fqdn
A következő ugrás teljes tartománya.
...
### -LinkSpeedInMbps
A csatolás sebessége mbit/s-ként.
