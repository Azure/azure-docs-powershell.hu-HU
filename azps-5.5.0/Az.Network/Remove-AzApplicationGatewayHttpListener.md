...
## LEÍRÁS
A **Remove-AzApplicationGatewayHttpListener** parancsmag eltávolítja a HTTP-szolgáltatásokat egy Azure-alkalmazás-átjáróból.

## PÉLDÁK

### 1. példa: Alkalmazás-átjáró HTTP-ének eltávolítása
```
...
A második parancs eltávolítja a Listener02 nevű HTTP-hallgatót a $AppGw.

## PARAMETERS

### -ApplicationGateway
Azt az alkalmazás-átjárót adja meg, amelyről el szeretné távolítani a HTTP-et.
...
### -Name
A parancsmag által eltávolított HTTP-hallgató nevét adja meg.
