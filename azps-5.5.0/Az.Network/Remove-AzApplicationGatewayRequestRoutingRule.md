...
## LEÍRÁS
A **Remove-AzApplicationGatewayRequestRoutingRule** parancsmag eltávolít egy kéréstovábbítási szabályt egy Azure-alkalmazás-átjáróból.

## PÉLDÁK

### 1. példa: Kéréstovábbító szabály eltávolítása egy alkalmazás-átjáróból
```
...
A második parancs eltávolítja a Szabály02 nevű útválasztási szabályt a $AppGw.

## PARAMETERS

### -ApplicationGateway
Azt az alkalmazás-átjárót adja meg, amelyből el szeretné távolítani a kéréstovábbító szabályt.
...
### -Name
Annak a kérés-útválasztási szabálynak a nevét adja meg, amelynek a parancsmagja eltávolítja.
