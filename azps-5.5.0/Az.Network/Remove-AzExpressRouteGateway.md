...
## LEÍRÁS
A Remove-AzExpressRouteGateway parancsmag eltávolít egy Azure ExpressRoute-átjárót. Ez egy olyan átjáró, amely az Azure Virtual WAN szoftverrel definiált kapcsolatát használja.
...
Ebben a példában egy Erőforráscsoport (Virtual WAN, Virtual Hub, scalable ExpressRoute) átjárót hoz létre az Egyesült Államok központjában, majd azonnal törli azt. A virtuális átjáró törlésekor megjelenő üzenet elrejtését a -Force jelölővel használhatja.
Ezzel törli az ExpressRouteGatewayt és a hozzá csatolt ExpressRouteConnectionst.
...
Ebben a példában egy Erőforráscsoport (Virtual WAN, Virtual Hub, scalable ExpressRoute) átjárót hoz létre az Egyesült Államok nyugati részén, majd azonnal törli azt. Ez a törlés powershell-pipázás használatával történik, amely a parancs által visszaadott ExpressRouteGateway Get-AzExpressRouteGateway használ.
A virtuális átjáró törlésekor megjelenő üzenet elrejtését a -Force jelölővel használhatja.
Ezzel törli az ExpressRouteGatewayt és a hozzá csatolt ExpressRouteConnectionst.
...
### -InputObject
Az ExpressRouteGateway-objektum, amit törölni kell.
...
### -ResourceId
Az ExpressRouteGateway törölnie kell Azure-erőforrásazonosítóját.
