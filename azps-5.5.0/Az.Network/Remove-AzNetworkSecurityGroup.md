...
## LEÍRÁS
A **Remove-AzNetworkSecurityGroup** parancsmag eltávolít egy Azure-hálózati biztonsági csoportot.

## PÉLDÁK

### 1. példa: Hálózati biztonsági csoport eltávolítása
```
PS C:\>Remove-AzNetworkSecurityGroup -Name "NSG-FrontEnd" -ResourceGroupName "TestRG"
```

Ez a parancs eltávolítja a TestRG nevű NSG-FrontEnd nevű erőforráscsoportból.
...
### -Name
Annak a hálózati biztonsági csoportnak a nevét adja meg, amelyről a parancsmag eltávolítja a parancsmagot.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyből a parancsmag eltávolít egy hálózati biztonsági csoportot.
