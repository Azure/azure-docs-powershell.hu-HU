...
## LEÍRÁS
Az Remove-AzNetworkWatcherConnectionMonitor parancsmag eltávolítja a megadott kapcsolatfigyelőt.

## PÉLDÁK

### 1. példa: A megadott kapcsolatfigyelő eltávolítása
```powershell
PS C:\> Remove-AzNetworkWatcherConnectionMonitor -Location centraluseuap -Name cm
```

Ebben a példában töröljük a hely és a név által megadott kapcsolatfigyelőt.

### 2. példa

Távolítsa el a kapcsolatfigyelőt. (automatikusan generált)
