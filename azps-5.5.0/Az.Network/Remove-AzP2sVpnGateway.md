...
## LEÍRÁS
A **Remove-AzP2sVpnGateway** parancsmag lehetővé teszi egy meglévő P2SVpnGateway eltávolítását a VirtualHub alatt. A P2SVpnGateway eltávolítása után a webhely ügyfeleinek csatlakozási pontja meghiúsul.
...
A **Remove-AzP2sVpnGateway** parancsmag lehetővé teszi egy meglévő P2SVpnGateway eltávolítását a VirtualHub alatt.
...
### -InputObject
A törölni szükséges p2sVpnGateway-objektum.
...
### -PassThru
Egy objektumot ad vissza, amely azt az elemet tartalmazza, amelyen a műveletet végre kell hajtotta.
...
### -ResourceId
A törölnie kell a p2sVpnGateway Azure-erőforrásazonosítóját.
