...
## LEÍRÁS
A **Remove-AzPrivateEndpoint** parancsmag eltávolít egy privát végpontot. 
...
Ebben a példában eltávolítunk egy MyPrivateEndpoint1 nevű privát végpontot.
...
### -ResourceGroupName
A magánjellegű végpont erőforráscsoportjának neve.
