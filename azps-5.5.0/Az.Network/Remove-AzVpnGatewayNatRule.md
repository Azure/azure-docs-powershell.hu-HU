...
## SYNOPSIS
Eltávolítja a VpnGatewayhez társított NAT-szabályt.
...
A fentiekkel a VpnGatewayhez társított erőforráscsoport (Virtual WAN, Virtual Network, Virtual Hub, VpnGateway és NAT) hozható létre.
Ezután eltávolítja a NAT-szabályt a NAT-szabály nevével.
...
### -Force
Ne kérjen megerősítést, ha törölni szeretne egy erőforrást
