...
A fenti parancs eltávolít egy meglévő VpnServerConfigurationt.
...
### -InputObject
A vpnServerConfiguration objektumot törölni kell.
...
### -ResourceId
A vpnServerConfiguration Azure-erőforrásazonosítóját törölni kell.
