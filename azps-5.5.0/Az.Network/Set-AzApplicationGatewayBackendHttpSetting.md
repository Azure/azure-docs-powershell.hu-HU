...
## LEÍRÁS
A Set-AzApplicationGatewayBackendHttpSetting parancsmag frissíti az Azure-alkalmazásátjárók HÁTTÉR-átvitele (HTTP) beállításait.
A háttér-HTTP-beállításokat a rendszer a készlet összes háttérkiszolgálója esetén alkalmazza.

## PÉLDÁK

### 1. példa: Az alkalmazásátjárók háttér-HTTP-beállításainak frissítése
```
...
A második parancs frissíti az alkalmazás átjárójának HTTP-beállításait a $AppGw változóban a 88-as port, a HTTP protokoll használatára, és engedélyezi a cookie-alapú affinitást.
...
### -ApplicationGateway
Egy olyan alkalmazás-átjáróobjektumot ad meg, amellyel ez a parancsmag háttér-HTTP-beállításokat társít.
...
### -ConnectionDraining
A háttér-http-beállítások erőforrás kapcsolatának kiürítését.
...
A paraméter elfogadható értékei: Letiltva vagy Engedélyezve.
...
### -Name
A háttér HTTP-beállítások objektumának nevét adja meg.
...
### -Port
A háttérkiszolgáló-készlet minden egyes kiszolgálójához használt portot adja meg.
...
### – Sivad
A háttér HTTP-beállításaihoz társítni kell egy 100 000 000 000 000(2010) http-kiszolgálót.
...
### -Azidid
A háttér HTTP-beállításaihoz társítni megfelelő házirend azonosítója.
...
### -Protocol
Az alkalmazás átjárója és a háttérkiszolgálók közötti kommunikációhoz használt protokoll.
