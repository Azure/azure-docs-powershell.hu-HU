...
A második parancs úgy állítja be az átjáró HTTP-hallgatóját, hogy az $FIP 01-ben tárolt előlapi konfigurációt használja a 80-as portON található HTTP-protokollal.
...
### -HostName
Megadja azt az állomásnevet, amelybe a parancsmag elküldi a HTTP-et.
