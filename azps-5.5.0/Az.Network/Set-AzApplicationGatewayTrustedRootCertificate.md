...
## LEÍRÁS
A **Set-AzApplicationGatewayTrustedRootCertificate** parancsmag módosítja egy alkalmazás átjáró meglévő megbízható gyökértanúsítványát.
...
A fenti példa azt mutatja be, hogy miként frissíthet egy meglévő megbízható főtanúsítványt a gyökértanúsítványok telepítésekor.
Az első parancs egy alkalmazás-átjárót kap, és a $gw tárolja.
A második parancs egy új főtanúsítványsal módosítja a meglévő megbízható gyökértanúsítványt.
