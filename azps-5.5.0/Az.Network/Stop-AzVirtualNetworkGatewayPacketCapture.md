...
## LEÍRÁS
Leállítja a csomagrögzítési műveletet egy virtuális hálózati átjárón, és feltölti az eredményt az adott SasUrl tárolón.
...
### -InputObject
A virtuális hálózati átjáró objektum, amelyben a csomagrögzítést el kell kezdeni.
...
### -Name
A virtuális hálózati átjáró neve, ahol a csomagok rögzítését el kell kezdeni.
...
### -SasUrl
AZ SAS URL-csomagrögzítése a virtuális hálózati átjárón.
