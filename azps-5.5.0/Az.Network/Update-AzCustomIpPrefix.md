...
## LEÍRÁS
Az **Update-AzCustomIpPrefix** parancsmaggal a felhasználó jutalékot vagy leszerelheti CustomIpPrefix eszközét, vagy szerkesztheti az erőforrás címkéit.

## PÉLDÁK

### 1. példa: A CustomIpPrefix jutaléka
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

A fenti parancs elindítja a CustomIpPrefix rendelési folyamatát.
...
A fenti parancs elindítja a CustomIpPrefix de-commissioning folyamatát.

### 3. példa: A CustomIpPrefix címkéinek frissítése
```powershell
