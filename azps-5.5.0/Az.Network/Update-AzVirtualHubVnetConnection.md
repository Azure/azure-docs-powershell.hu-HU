...
A fenti létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub in Central US) az Azure-ban az adott erőforráscsoportban. Létrejön egy virtuális hálózati kapcsolat is, amely a virtuális hálózat és a virtuális központ közötti társközi kapcsolat. A virtuális hálózati kapcsolat ekkor frissül az internetbiztonság engedélyezéséhez.
