...
Legalább egy értesítési központ névterének meg kell lennie.
...
Névtér létrehozásához adjon meg egy egyedi nevet a névtérnek; adja meg azt az adatközpontot, ahol a névtér található; és adja meg azt az erőforráscsoportot, amelyhez a névteret hozzárendeli.
...
Az egyes címkék két részből áll: a *névből,* illetve szükség esetén az *Értékből.*
A Department:IT (Részleg) részlegnél például a címke neve Részleg, a címke értéke pedig IT.
Címke hozzáadásához ehhez hasonló hash táblázatszintaxist használjon, amely a CalendarYear:2016 címkét hozza létre:
