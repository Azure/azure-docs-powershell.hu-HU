...
## LEÍRÁS
A "-ClusterName" meg nem adott, az erőforráscsoport alatti listacsoportokat, illetve a "-ClusterName" és az "ResourceGroupName" nem adott meg, listába sorolja az előfizetés alatti fürtcsoportokat.
