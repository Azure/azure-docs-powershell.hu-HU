...
## LEÍRÁS
Csatolt tárfiók lekérte, és felsorolja az összes csatolt tárfiókot, ha nincs megadva a "-DataSourceType" érték.
...
### -DataSourceType
Az adatforrás típusa a "CustomLogs" (AzureWatson) egyikének kell lennie.
