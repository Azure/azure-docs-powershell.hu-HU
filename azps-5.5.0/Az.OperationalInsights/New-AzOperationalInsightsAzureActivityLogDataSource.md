...
## LEÍRÁS
A New-AzOperationalInsightsAzureActivityLogDataSource engedélyezi a Log Analytics szolgáltatásnak, hogy az adott előfizetésből gyűjtsön Azure-tevékenységnaplót.
...
### -BackfillStartTime
Egy héttel ezelőtti naplók újratöltését is választhatja.
