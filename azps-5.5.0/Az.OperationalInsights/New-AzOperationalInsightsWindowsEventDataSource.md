...
## LEÍRÁS
A **New-AzOperationalInsightsWindowsEventDataSource** parancsmag hozzáad egy adatforrást, amely a Windows eseménynaplóit olyan csatlakoztatott számítógépekről gyűjti, amelyek a Windows operációs rendszert futtatják az Azure Operational Insights szolgáltatásban.

## PÉLDÁK

### 1. példa: Rendszer Windows-esemény adatforrásának létrehozása
```
$EventLogNames       = @()
...
### -CollectWarnings
Azt jelzi, hogy a Operational Insights figyelmeztető üzeneteket gyűjt.
