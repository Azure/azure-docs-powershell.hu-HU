...
## LEÍRÁS
A **Set-AzOperationalInsightsStorageInsight** parancsmag módosítja a Storage Insight konfigurációját.

## PÉLDÁK

### 1. példa: Tárterület-betekintés módosítása név szerint
```
...
Ez a parancs módosítja a táblákat, amelyekből a MyStorageInsight nevű Tárterület-betekintés felolvassa.
...
A második parancs módosítja a tárolókat, amelyekből a MyStorageInsight nevű Tárterület-betekintés felolvassa.

## PARAMETERS

### -Containers
Megadja az adatokat tartalmazó tárolók listáját.
...
### -Name
A Tárterület-betekintő nevét adja meg.
...
### -WorkspaceName
Egy munkaterület nevét adja meg.
