...
## LEÍRÁS
A parancs a régi társviszony-létesítő erőforrások megtekintésére szolgál, amelyeket Ön mindössze Azure Resource Management (ARM) erőforrásokká konvertál.
...
Örökölt társviszony-létesítés Seattle-ben
