...
## LEÍRÁS
Társviszony-létesítésből kapott útvonalak listája
...
A társviszonyhoz kapott összes útvonal listája

### Szűrés AS Path szerint
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName -AsPath "1234 5674 9834"
```

Egy társviszonyhoz kapott összes útvonal listája as szűrővel 
...
A RPKIValidationState szűrővel egy társviszonyhoz kapott összes útvonal listája
...
Egy társviszonyhoz kapott összes útvonal listája az OriginAsValidationState szűrővel

## PARAMETERS

### -AsPath
Szűrés AS Path szerint.
Például: '9342 1234 4567'
...
Szűrés forrás AS érvényességi állapota szerint
...
### -RPKIValidationState
Szűrés RPKI-érvényesítési állapot szerint.
