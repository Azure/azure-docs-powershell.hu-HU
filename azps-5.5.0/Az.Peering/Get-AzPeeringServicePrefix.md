...
## LEÍRÁS
Társviszony-létesítő szolgáltatáselőtagok listába sorolása a társviszony-létesítő szolgáltatásobjektumok esetén
...
A társviszony-létesítő szolgáltatás előtagját a pipázási parancsok alapján kapja meg.
...
Egy társviszony-szolgáltatáshoz erőforrás-azonosító alapján adott előtagot kap.
...
Egy kibontott attribútumokkal bővített társviszony-szolgáltatás adott előtagot kap
...
### -Kibontás
Társviszony-létesítő szolgáltatás előtagja eseményeinek megtekintése
...
### -PeeringServiceName
A társviszony-létesítő szolgáltatás neve. Egy New-AzPeeringService új társviszony-szolgáltatáshoz Get-AzPeeringService parancsmagot.
