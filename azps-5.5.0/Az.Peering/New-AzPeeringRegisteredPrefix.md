...
### Társviszony létrehozása és regisztrált előtag létrehozása
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Szerezze be azt a társviszonyt, amelybe regisztrált előtagot szeretne felvenni. Ezután adja át a parancsmagnak.
