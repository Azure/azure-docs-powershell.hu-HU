...
### DefaultExchange (alapértelmezett)
```
...
## LEÍRÁS
A PSPeering objektum beállítja

## PÉLDÁK

### Az Md5 hitelesítési kulcs frissítése
```powershell
...
Az Md5 hitelesítési kulcs beállítja

### UseForPeeringService frissítése
```powershell
...
Beállítja a társviszony-létesítő szolgáltatás jelzőjeként való használatot

### Az IPv4-cím frissítése exchange-társviszonyhoz
```powershell
...
Az Exchange-társviszony Ipv4-címének beállítja az ResourceId használatával
...
### -DirectConnection
Hozzon létre egy új közvetlen kapcsolatot a parancs New-AzDirectPeeringConnectionObject és egy pipával.
...
### -ExchangeConnection
Hozzon létre egy új Exchange-kapcsolatot a parancs New-AzExchangePeeringConnectionObject és egy pipával.
