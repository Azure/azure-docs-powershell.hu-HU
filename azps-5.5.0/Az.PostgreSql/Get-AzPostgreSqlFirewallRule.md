...
### 1. példa: A megadott PostgreSql-kiszolgáló tűzfalszabályának felsorolása
```powershell
...
Ez a parancsmag felsorolja a megadott PostgreSql-kiszolgáló tűzfalszabályát.

### 2. példa: Tűzfalszabály be szerezni név szerint
```powershell
...
Ez a parancsmag név szerint kapja meg a tűzfalszabályt.

### 3. példa: Tűzfalszabály beállítása identitás alapján
```powershell
...
Ez a parancsmag identitás szerint kapja meg a tűzfalszabályt.
