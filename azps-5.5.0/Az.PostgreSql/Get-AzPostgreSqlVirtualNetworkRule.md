...
### 1. példa: A virtuális hálózatra vonatkozó szabályok felsorolása a megadott PostgreSql-kiszolgálón
```powershell
...
Ez a parancsmag felsorolja a virtuális hálózatra vonatkozó szabályokat a megadott PostgreSql-kiszolgálón.

### 2. példa: Virtuális hálózat szabályának lekérte név szerint
```powershell
...
Ez a parancsmag név szerint virtuális hálózatszabályt kap.

### 3. példa: Virtuális hálózat szabályának lekérte identitás alapján
```powershell
...
Ez a parancsmag identitás szerint virtuális hálózatszabályt kap.
