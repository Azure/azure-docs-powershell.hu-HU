...
### 1. példa: Updatae megadott PostgreSql-konfiguráció név szerint
```powershell
...
### 1. példa: Az updatae által megadott PostgreSql-konfiguráció identitás szerint
```powershell
...
Ez a parancsmag identitás szerint frissíti a PostgreSql-konfigurációt.
