...
Ez a parancsmag név szerint frissíti a PostgreSql Virtuális hálózat szabályát.

### 2. példa: A PostgreSql virtuális hálózat szabályának frissítése identitás szerint.
```powershell
...
Ezek a parancsmagok identitás szerint frissítik a PostgreSql Virtuális hálózat szabályát.
