...
## LEÍRÁS
A Update-AzPowerBIEmbeddedCapacity parancsmag módosítja a PowerBI beágyazott kapacitásának egy példányát
...
### -PassThru
A törölt kapacitás adatait adja vissza, ha a művelet sikeresen befejeződött.
...
### -ResourceGroupName
Annak az Azure-erőforráscsoportnak a neve, amelyhez a kapacitás tartozik
...
### -ResourceId
PowerBI beágyazott kapacitási erőforrásazonosító.
...
### -Sku
A kapacitás termékváltozatának neve.
...
### -Tag
Kulcsérték-párok a kapacitás címkéiként beállított kivonattábla formájában.
