...
## LEÍRÁS
A Add-AzPrivateDnsRecordConfig parancsmag hozzáad egy DNS-rekordot egy RecordSet-objektumhoz. A RecordSet objektum egy offline objektum, és módosításai nem módosítják a privát DNS-válaszokat mindaddig, amíg a Set-AzPrivateDnsRecordSet-parancsmag futtatásával meg nem őrzi a Módosítást a Microsoft Azure Private DNS szolgáltatásban. A SOA-rekordok a privát DNS-zóna létrehozásakor jön létre, és törlődnek a privát DNS-zóna törlésekor. SoA-rekordokat nem adhat hozzá és nem távolíthat el, de szerkesztheti őket. A RecordSet objektumot paraméterként vagy a folyamat műveleti jelének használatával is át lehet adni ennek a parancsmagnak.
...
Ebben a példában egy AAAAA rekordot egy meglévő rekordkészlethez ad hozzá.
...
### 5. példa: PTR-rekord hozzáadása egy rekordkészlethez
```powershell
...
### 6. példa: SRV rekord hozzáadása egy rekordkészlethez
```powershell
...
### 7. példa: TXT rekord hozzáadása egy rekordkészlethez
```powershell
...
### -Exchange
A hozzáadni címzett MX rekord levelezési szolgáltatója.
Nem lehet a zóna nevéhez képest.
Nem lehet befejezési pont
