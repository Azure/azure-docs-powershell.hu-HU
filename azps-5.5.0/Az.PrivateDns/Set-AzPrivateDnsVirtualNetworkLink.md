...
A **PSPrivateDnsVirtualNetworkLink-objektumokat** a  Csatolás paraméterrel vagy a folyamat műveleti jelével, illetve a Name  *ZoneName* és *az ResourceGroupName* paraméter megadásával is átadhatja.
...
### -Name
A parancsmag által eltávolított hivatkozás neve.
...
### -Felülírás
Amikor a hivatkozást **PSPrivateDnsVirtualNetworkLink** objektummal adja meg  (a folyamaton vagy a Hivatkozás paraméteren keresztül adja át), a csatolás nem törlődik, ha az Azure DNS-ben módosult a helyi **PSPrivateDnsVirtualNetworkLink** objektum lekérése óta.
