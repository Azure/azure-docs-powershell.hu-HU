...
## LEÍRÁS
Az **Edit-AzRecoveryServicesAsrRecoveryPlan** parancsmag egy Azure-webhely-helyreállítási tervet szerkeszt.
...
Hozzáfűz egy csoportot a meglévő Azure Webhely-helyreállítási tervhez, és visszaadja a memóriában frissített helyreállítási tervet. 

### 2. példa

Szerkeszt egy webhely-helyreállítási tervet. (automatikusan generált)
...
### -AddProtectedItem
A helyreállítási terv objektumban a helyreállítási terv csoportjához hozzáadható, ASR-replikációval védett elemek listája.
...
### -AppendGroup
A paraméter váltása helyreállítási tervcsoportnak a helyreállítási terv objektumhoz való hozzáfűzése érdekében
...
### -Group
Helyreállítási tervcsoportot ad meg.
...
### -InputObject
Az ASR helyreállítási terv szerkeszthető objektuma (memóriaműveletben. A helyreállítási terv frissítéséhez futtassa Update-AzASRRecoveryPlan a szerkesztett helyreállítási terv objektummal.)
...
### -RemoveProtectedItem
A helyreállítási terv objektumban a helyreállítási terv csoportjából eltávolítható, ASR-replikációval védett elemek listája.
