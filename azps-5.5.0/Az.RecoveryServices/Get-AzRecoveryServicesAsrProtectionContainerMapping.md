...
## LEÍRÁS
A **Get-AzRecoveryServicesAsrProtectionContainerMapping** parancsmag információt kap a védelmi tárolóról a replikációs házirendleképezések (társítások) számára a tárolóban a megadott ASR védelmi tárolóban.
...
A tároló védelmi tárolóleképezései.
...
A megadott védelmi tároló összes védelmi tárolóleképezését beveszi.
...
### -Name
A lekért védelmi tároló megfeleltetésének nevét adja meg.
...
### -ProtectionContainer
A megadott ASR védelmi tárolóobjektumnak megfelelő védelmi tárolóleképezések lekértése.
