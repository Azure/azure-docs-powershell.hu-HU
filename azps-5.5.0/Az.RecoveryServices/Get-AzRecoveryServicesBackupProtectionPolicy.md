...
## LEÍRÁS
A **Get-AzRecoveryServicesBackupProtectionPolicy** parancsmag az Azure biztonságimásolat-védelmi házirendeket kap egy tárolóhoz.
...
### 1. példa: Az összes házirend lekérte a tárolóban
```
...
Ez a parancs a tárolóban létrehozott összes védelmi házirendet megkapja.

### 2. példa: Adott házirend lekérte
```
PS C:\> $Pol= Get-AzRecoveryServicesBackupProtectionPolicy -Name "DefaultPolicy"
```

Ez a parancs lekérte a DefaultPolicy nevű védelmi házirendet, majd a $Pol tárolja.

## PARAMETERS

### -BackupManagementType
A védett erőforrások osztálya. Jelenleg a parancsmag által támogatott értékek: AzureVM, AzureStorage, AzureWorkload
...
### -WorkloadType
Az erőforrás terheléstípusa. Az aktuálisan támogatott értékek: AzureVM, AzureFiles, MSSQL
