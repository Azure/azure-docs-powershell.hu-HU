...
### -Type
Annak az Azure-erőforrásnak a típusa, amelynek a képviselőjét ellenőrizni kell, ha azt már védi az előfizetésben egy helyreállítási szolgáltatás tárolója.
