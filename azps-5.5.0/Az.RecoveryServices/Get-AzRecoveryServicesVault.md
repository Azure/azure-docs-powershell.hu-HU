...
Annak a címkének a kulcsát határozza meg, amelynél a lekérdezést el kell
...
## MEGJEGYZÉSEK
Get-AzRecoveryServicesVault.RecoveryServices(<=2.10.0) verzióban nem működik az Az.Accounts(>=1.8.1) helytelen összeállítási hivatkozás miatt. Az Az.RecoveryServices modult frissíteni kell 2.11.0-s vagy újabb verzióra, ha a legújabb Az vagy Az.Accounts verziót használja.
