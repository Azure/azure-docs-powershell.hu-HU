...
## LEÍRÁS
a parancsmag egy tárolón belül érdeklődik adott munkaterhelések után. Ez a művelet védett elemeket hoz létre.
...
A parancsmag feltárási műveletet hajt végre az új védett elemeken.

### 2. példa

Ez a parancs elindítja az adott munkaterhelés-típus nem védett elemeinek észlelését az adott tárolóban. (automatikusan generált)
...
### -PassThru
Azt a tárolót adja vissza, amelyben a felderítés aktiválódik.
