...
Az első parancs a helyreállítási szolgáltatások tárolóját kapja meg, és egy $vault tárolja.
A második parancs a "V2VM" nevű AzureVM típusú biztonságimásolat-elemet kapja meg, és tárolja azt a $BackupItem változóban.
...
A negyedik parancs megadja, hogy mely fájlokat kell visszaállítani és egy $files tárolja.
...
Az a mappa, amelyben a fájlmegosztást vissza kell állítani a TargetFileShareName fájlon belül. Ha a biztonsági másolat tartalmát vissza kell állítani egy gyökérmappába, a célmappa értékeit üres karakterláncként adja meg.
...
A visszaállított lemezeket titkosító DES-azonosító.
...
Ezzel a kapcsolóval elindíthatja a régióközi visszaállítást a másodlagos régióra.
