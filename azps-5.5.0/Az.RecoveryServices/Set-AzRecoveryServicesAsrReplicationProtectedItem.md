...
Elindítja a replikációval védett elemek beállításainak frissítését a megadott paraméterekkel, és visszaadja a művelet nyomon követéséhez használt ASR-feladatot.
...
### -LicenseType
A Windows Server virtuális gépek licenctípusának kiválasztása. Ha jogosult az Azure Hybrid Use Benefit (HUB) használatára az áttelepítések során, és szeretné megadni, hogy a HUB beállítása a védett elem esetén a WindowsServer licenctípusra legyen állítva.
...
A replikációval védett elem elérhetőségi zónáját adja meg a feladatátvétel után.
...
### -RecoveryNetworkId
Annak a virtuális Azure-hálózatnak az azonosítója, amelynek a védett elemét meg kell hibásodni.
...
### -TfoAzureVMName
A teszt feladatátvevő virtuális gép nevét adja meg.
