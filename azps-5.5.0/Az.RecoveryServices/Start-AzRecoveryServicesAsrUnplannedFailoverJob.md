...
## LEÍRÁS
A **Start-AzRecoveryServicesAsrUnplannedFailoverService** parancsmag nem tervezett feladatátvételt indít az Azure-webhely-helyreállítási replikációval védett elem vagy helyreállítási terv esetében.
...
### -RecoveryPoint
Egy egyéni helyreállítási pontot ad meg, amely feladatátvételt nyújt a védett gépnek.
