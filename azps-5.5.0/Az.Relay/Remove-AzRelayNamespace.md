...
## LEÍRÁS
A **Remove-AzRelayNamespace** parancsmag eltávolítja a névteret a megadott erőforráscsoportból.
...
Eltávolítja a Továbbítás `TestNameSpace-Relay1` névteret a megadott erőforráscsoportból. `Default-ServiceBus-WestUS`
