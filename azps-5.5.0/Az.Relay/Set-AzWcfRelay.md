...
## LEÍRÁS
A Set-AzWcfRelay parancsmag frissíti a WcfRelay leírását a megadott Továbbítás névterében.
...
Frissíti a megadott WcfRelay értéket egy új leírással a megadott névterben.
Ebben a példában a UserMetadata tulajdonság új értékkel frissül.
...
### -UserMetadata
A usermetadata függvény egy helyőrző, amely a WcfRelay végpont felhasználó által definiált karakterlánc-adatait tárolja.pl. leíró adatok tárolására használhatók, például a csoportok listája és kapcsolattartási adataik, valamint a felhasználó által definiált konfigurációs beállítások is tárolhatók.
