...
Az adott foglalás korrektúraelőzményének megtekintése
...
### -ReservationId
Annak a foglalásazonosítónak a foglalása, amelynek `Reservation` az előzményeit meg kell mutatni
...
### -ReservationOrderId
ReservationOrderId for the `ReservationOrder` contains the `Reservation`
