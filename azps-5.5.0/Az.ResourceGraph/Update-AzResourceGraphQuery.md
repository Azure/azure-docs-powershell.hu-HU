...
## SYNOPSIS
Egy már hozzáadott grafikonlekérdezés frissítése.
...
### 1. példa: A paraméteres lekérdezés frissítése és címke név szerint
```powershell
...
Ez a parancs frissíti a paraméteres lekérdezést, és név szerint címkéz.

### 2. példa: A paraméterfájl frissítése objektum szerint
```powershell
...
Ez a parancs frissíti a paraméteres lekérdezést, és objektum szerint címkéz.
