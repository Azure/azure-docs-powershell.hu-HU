...
### 1. példa: Az erőforrások elvetés előtt ellenőrizze a függőségeket.
```powershell
...
Az erőforrások elvetés előtt ellenőrizze a függőségeket.

### 2. példa: Elveti az erőforrások áthelyezését a "MoveResource Name" bemenettel
```powershell
...
Az erőforrások áthelyezését a "MoveResource Name" bemenettel elveti.

### 3. példa: Elveti az erőforrások áthelyezését a "SourceARMID" bemenettel
```powershell
...
A "SourceARMID" bemenettel elveti az erőforrások áthelyezését.
