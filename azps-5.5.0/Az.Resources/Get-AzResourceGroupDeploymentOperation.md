...
## LEÍRÁS
A **Get-AzResourceGroupDeploymentOperation parancsmag** felsorolja azokat a műveleteket, amelyek egy központi telepítés részét képezték, hogy ön azonosítsa és további információt nyújtson az adott telepítés sikertelen műveleteiről.
