...
## LEÍRÁS
A **Get-AzResourceGroupDeploymentWhatIfResult** parancsmag megkapja a ARM sablont What-If egy sablon telepítéséhez a megadott erőforráscsoport-hatókörben. Visszaadja a módosítások listáját, jelezve, hogy mely erőforrások lesznek frissítve, ha a telepítést a tényleges erőforrások változtatása nélkül alkalmazza. Az eredmény formátumának megadásához használja a *ResultFormat paramétert.*
...
A parancs az *ResourceGroupName* paramétert használva adja meg azt az erőforráscsoportot, amelyben a sablon telepítve lesz.
...
### -ExcludeChangeType
Vesszővel elválasztott erőforrás-módosítási típusok, amelyek nem lesznek kizárva a What-If eredményből.
