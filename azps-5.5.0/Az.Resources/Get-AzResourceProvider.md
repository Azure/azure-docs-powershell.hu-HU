...
### 1. példa: Az aktuális előfizetéssel regisztrált összes erőforrás-szolgáltató lekérte
...
Ez a parancs az előfizetés összes erőforrás-szolgáltatóját beveszi.

### 2. példa: Az összes erőforrásszolgáltató részleteinek lekérte az adott ProviderNamespace szolgáltatótól
...
Ez a parancs az összes erőforrás-szolgáltatót a "Microsoft.Compute" csoportban kapja meg.

### 3. példa: Az összes erőforrásszolgáltató részleteinek betekintése a megadott ProviderNamespace tömbből
...
Ez a parancs beveszi az összes erőforrás-szolgáltatót a "Microsoft.Compute" és a "Microsoft.Network" csoportban.
...
### -ListAvailable
Azt jelzi, hogy ez a művelet az összes elérhető erőforrás-szolgáltatóhoz elérhető lesz.
...
### -Location
Az erőforrás-szolgáltató helyét határozza meg.
