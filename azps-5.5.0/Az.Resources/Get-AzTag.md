...
Az Azure Címkék modul, amely a **Get-AzTag** modul része, segíthet az előre definiált Azure-címkék kezelésében.
...
Ha egy adott címkenevet vagy nevet és értéket  keres az erőforráscsoportokban, használja a Get-AzResourceGroup címke paraméterét.
...
Ez a parancs részletes információkat kap a Részleg címkéről és értékeiről.
...
### 5. példa: Az erőforráshoz beállított összes címke lekérte
...
Ez a parancs a(z) {resourceId} értékkel bekérte az erőforrás teljes címkéit.
