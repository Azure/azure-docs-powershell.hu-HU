...
## LEÍRÁS
A **Get-AzTenantDeploymentWhatIfResult** parancsmag megkapja a ARM sablont What-If találatot a sablon telepítéséhez a megadott bérlői hatókörben. Visszaadja a módosítások listáját, jelezve, hogy mely erőforrások lesznek frissítve, ha a telepítést a tényleges erőforrások változtatása nélkül alkalmazza. Az eredmény formátumának megadásához használja a *ResultFormat paramétert.*

## PÉLDÁK

### 1. példa: Keresési What-If a bérlő hatókörében
```powershell
...
Ez a parancs egy egyéni sablonfájl és egy lemezen What-If paraméterfájl használatával kap egy találatot bérlői hatókörben.
...
### 2. példa: What-If eredmény a bérlő hatókörében a ResourceIdOnly-val
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
