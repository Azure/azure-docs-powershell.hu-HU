...
## LEÍRÁS
A New-AzADSpCredential parancsmag segítségével új hitelesítő adatokat adhat hozzá, vagy egy egyszerű szolgáltatásnévhez adhat hozzá hitelesítő adatokat.
...
### 3. példa: Új egyszerű szolgáltatás hitelesítő adatainak létrehozása a pipázás használatával
...
A szolgáltatásnév (SPN) neve, amelybe fel kell adni a hitelesítő adatokat.
...
A kezdő dátum alapértelmezett értéke a mai nap.
