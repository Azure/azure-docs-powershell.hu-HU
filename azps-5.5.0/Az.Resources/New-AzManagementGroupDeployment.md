...
### 3. példa: Egyéni sablonobjektum és paraméterfájl használata telepítés létrehozására
```
...
Ez a parancs létrehoz egy új telepítést a "myMG" felügyeleti csoportban egy egyéni sablon és egy, a lemezen található sablonfájl használatával, amelyet a rendszer memórián belülre konvertált hashtable-ként.
...
### -WhatIfResultFormat
A What-If formátuma. Akkor érvényes, ha a -WhatIf vagy a -Confirm kapcsoló be van állítva.
