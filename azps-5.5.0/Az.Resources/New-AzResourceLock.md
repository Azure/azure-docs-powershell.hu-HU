...
## LEÍRÁS
A **New-AzResourceLock** parancsmag erőforrás-zárolást hoz létre.

## PÉLDÁK

### 1. példa: Erőforrás zárolásának létrehozása egy webhelyen
```
...
Ez a parancs erőforrás-zárolást hoz létre egy webhelyen.

### 2. példa: Erőforrászárolás létrehozása adatbázishoz
```
...
Ez a parancs erőforrás-zárolást hoz létre egy Azure-adatbázisban.
...
### -LockLevel
A zárolás szintjét határozza meg.
Jelenleg érvényes értékek: CanNotDelete, ReadOnly.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyre a zárolás vonatkozik, vagy amely tartalmazza azt az erőforráscsoportot, amelyre a zárolás vonatkozik.
