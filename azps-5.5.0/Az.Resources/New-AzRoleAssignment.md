...
### -Feltétel
A Szerepkör-hozzárendelésre alkalmazandó feltétel.
...
Csak a ResourceGroupName, az ResourceType és (opcionális) ParentResource paraméterekkel együtt használva építsen hierarchikus hatókört egy erőforrást azonosító relatív URI-ként.
...
### -RoleDefinitionName
Annak az RBAC-szerepkörnek a neve, amely a fő felhasználóhoz (olvasó, közreműködő, virtuális hálózati rendszergazda stb.) van hozzárendelve.
