...
## SYNOPSIS
Telepítés létrehozása bérlői hatókörben
...
## LEÍRÁS
A **New-AzTenantDeployment** parancsmag hozzáad egy telepítést a bérlő aktuális hatókörében.

Ha bérlői hatókörben szeretne központi telepítést hozzáadni, adja meg a helyet és egy sablont.
...
Ha erőforrásokat szeretne hozzáadni egy felügyeleti csoporthoz, használja a **New-AzManagementGroupDeployment** bővítményt, amely létrehoz egy központi telepítést egy felügyeleti csoportban.
...
Ez a parancs új telepítést hoz létre a bérlő aktuális hatókörében egy egyéni sablon és egy lemezen lévő sablonfájl használatával, meghatározott címke paraméterrel.
...
Ez a parancs új telepítést hoz létre az aktuális bérlői webhelyen egy egyéni sablon és egy lemezen lévő sablonfájl használatával, amelyet a rendszer memóriában lévő hashtable-ként konvertált.
