...
## LEÍRÁS
A **Remove-AzManagedApplicationDefinition parancsmag** eltávolít egy felügyelt alkalmazásdefiníciót.

## PÉLDÁK

### 1. példa: Felügyelt alkalmazásdefiníció eltávolítása erőforrás-azonosító alapján
```
...
Az első parancs egy myAppDef nevű felügyelt alkalmazásdefiníciót kap a Get-AzManagedApplicationDefinition parancsmag használatával.
A parancs a $ApplicationDefinition tárolja.
A második parancs eltávolítja a felügyelt  alkalmazásdefiníciót, amelyet a $ApplicationDefinition.
...
### -Id
A teljesen minősített felügyelt alkalmazásdefiníciós azonosító, az előfizetéssel együtt.
