...
Az Azure Címkék modul, amely a **Remove-AzTag** része, segíthet az előre definiált Azure-címkék kezelésében.
...
**RemoveByResourceIdParameterSet:** A **Remove-AzTag** parancsmag egy **ResourceId** azonosítóval törli egy erőforrás vagy előfizetés címkéinek teljes készletét.
