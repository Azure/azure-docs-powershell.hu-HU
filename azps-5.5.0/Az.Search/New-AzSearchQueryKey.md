...
## LEÍRÁS
A **New-AzSearchQueryKey** parancsmag létrehoz egy új lekérdezéskulcsot az Azure Kognitív keresés szolgáltatáshoz.
...
A példa létrehoz egy új lekérdezéskulcsot az Azure Kognitív keresés szolgáltatáshoz.
...
### -Name
Azure Kognitív keresési szolgáltatás lekérdezéskulcsának neve.
