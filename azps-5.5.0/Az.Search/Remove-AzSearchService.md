...
## SYNOPSIS
Távolítsa el az Azure Kognitív keresési szolgáltatást.
...
## LEÍRÁS
A **Remove-AzSearchService** parancsmag eltávolítja a megadott paraméterekkel megadott Azure Kognitív keresési szolgáltatást.
...
A példa eltávolítja az Azure Kognitív keresési szolgáltatást.
