...
## LEÍRÁS
A Csak az ideje (JIT) hálózati hozzáférési házirendek segítségével meghatározhat egy házirendet, amely lehetővé teszi az egyszerű felhasználóknak, hogy ideiglenes hálózati kapcsolatot hozzanak létre a VIRTUÁLIS géphez.
...
A JIT-hálózat hozzáférési rendreinek lekérte egy előfizetésre
