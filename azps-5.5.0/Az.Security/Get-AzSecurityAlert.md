...
ms.locfileid: "100165171"
---
# <span data-ttu-id="9de58-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="9de58-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="9de58-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="9de58-102">SYNOPSIS</span></span>
<span data-ttu-id="9de58-103">Az Azure Biztonsági központ által észlelt biztonsági riasztásokat kap</span><span class="sxs-lookup"><span data-stu-id="9de58-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="9de58-104">SZINTAXIS</span><span class="sxs-lookup"><span data-stu-id="9de58-104">SYNTAX</span></span>

### <span data-ttu-id="9de58-105">SubscriptionScope (alapértelmezett)</span><span class="sxs-lookup"><span data-stu-id="9de58-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="9de58-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="9de58-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="9de58-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="9de58-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="9de58-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="9de58-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="9de58-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="9de58-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="9de58-110">LEÍRÁS</span><span class="sxs-lookup"><span data-stu-id="9de58-110">DESCRIPTION</span></span>
<span data-ttu-id="9de58-111">Az Azure Biztonsági központ által észlelt biztonsági riasztásokat kap</span><span class="sxs-lookup"><span data-stu-id="9de58-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="9de58-112">PÉLDÁK</span><span class="sxs-lookup"><span data-stu-id="9de58-112">EXAMPLES</span></span>

### <span data-ttu-id="9de58-113">1. példa</span><span class="sxs-lookup"><span data-stu-id="9de58-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="9de58-114">Az előfizetésen belüli erőforrásokon észlelt összes biztonsági riasztást beveszi.</span><span class="sxs-lookup"><span data-stu-id="9de58-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="9de58-115">2. példa</span><span class="sxs-lookup"><span data-stu-id="9de58-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="9de58-116">A "myService1" erőforráscsoporton belüli erőforrásokon észlelt összes biztonsági riasztást begyara</span><span class="sxs-lookup"><span data-stu-id="9de58-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="9de58-117">3. példa</span><span class="sxs-lookup"><span data-stu-id="9de58-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="9de58-118">Egy adott biztonsági riasztást kap, amely a "myService1" erőforráscsoporton belüli erőforrásokon észlelt</span><span class="sxs-lookup"><span data-stu-id="9de58-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="9de58-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="9de58-119">PARAMETERS</span></span>

### <span data-ttu-id="9de58-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="9de58-120">-DefaultProfile</span></span>
<span data-ttu-id="9de58-121">Az Azure-ral való kommunikációhoz használt hitelesítő adatok, fiók, bérlő és előfizetés.</span><span class="sxs-lookup"><span data-stu-id="9de58-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="9de58-122">-Location</span><span class="sxs-lookup"><span data-stu-id="9de58-122">-Location</span></span>
<span data-ttu-id="9de58-123">Hely.</span><span class="sxs-lookup"><span data-stu-id="9de58-123">Location.</span></span>
...
### <span data-ttu-id="9de58-124">-Name</span><span class="sxs-lookup"><span data-stu-id="9de58-124">-Name</span></span>
<span data-ttu-id="9de58-125">Erőforrás neve.</span><span class="sxs-lookup"><span data-stu-id="9de58-125">Resource name.</span></span>
...
### <span data-ttu-id="9de58-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="9de58-126">-ResourceGroupName</span></span>
<span data-ttu-id="9de58-127">Erőforráscsoport neve.</span><span class="sxs-lookup"><span data-stu-id="9de58-127">Resource group name.</span></span>
...
### <span data-ttu-id="9de58-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="9de58-128">-ResourceId</span></span>
<span data-ttu-id="9de58-129">Erőforrás-azonosító.</span><span class="sxs-lookup"><span data-stu-id="9de58-129">Resource ID.</span></span>
...
### <span data-ttu-id="9de58-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="9de58-130">CommonParameters</span></span>
<span data-ttu-id="9de58-131">Ez a parancsmag a következő közös paramétereket támogatja: -Hibakeresés, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -PipelineVariable, -Verbose, -WarningAction és -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="9de58-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="9de58-132">További információt a [about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="9de58-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="9de58-133">INPUTS</span><span class="sxs-lookup"><span data-stu-id="9de58-133">INPUTS</span></span>

### <span data-ttu-id="9de58-134">System.String</span><span class="sxs-lookup"><span data-stu-id="9de58-134">System.String</span></span>

## <span data-ttu-id="9de58-135">KIMENETEK</span><span class="sxs-lookup"><span data-stu-id="9de58-135">OUTPUTS</span></span>

### <span data-ttu-id="9de58-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="9de58-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="9de58-137">MEGJEGYZÉSEK</span><span class="sxs-lookup"><span data-stu-id="9de58-137">NOTES</span></span>

## <span data-ttu-id="9de58-138">KAPCSOLÓDÓ HIVATKOZÁSOK</span><span class="sxs-lookup"><span data-stu-id="9de58-138">RELATED LINKS</span></span>
