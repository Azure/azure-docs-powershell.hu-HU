...
## LEÍRÁS
Egy előfizetés biztonsági felmérési eredményének törlése, amely általában akkor használatos, amikor egy újrasorot törölnek, vagy ha a felmérés már nem releváns egy adott erőforráshoz.
