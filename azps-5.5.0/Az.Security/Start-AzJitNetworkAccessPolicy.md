...
## LEÍRÁS
Ideiglenes hálózati hozzáférési kérést hív meg.
A kérés érvényesítése a konfigurált JIT hálózati hozzáférési házirend alapján történik, és ha engedélyezett, a felhasználó kérésének megfelelően hálózati kapcsolatot nyit meg.
A kérést a rendszer későbbi ellenőrzésre naplózza a házirendben, és a megadott időtartam túllépése esetén megszűnik.
...
Hálózati kapcsolatot nyit meg 1 órával a 22-es porton keresztül a nyilvános IP-címemről (ez nem jelenik meg).
