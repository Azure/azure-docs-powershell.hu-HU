...
## LEÍRÁS
A **Get-AzServiceBusAuthorizationRule** parancsmag megkapja a megadott engedélyezési szabály leírását a megadott Névtér vagy Várólistán, Illetve Témakör vagy Alias (GeoDR-konfigurációk) belül.
...
Egy megadott névtér engedélyezési szabályának leírását adja eredményül.
...
Egy adott várólistához megadott engedélyezési szabály leírását adja eredményül.
...
Egy adott témakör engedélyezési szabályának megadott leírását adja eredményül.
...
Egy megadott névtérhez és aliashoz megadott engedélyezési szabályleírást ad eredményül.
