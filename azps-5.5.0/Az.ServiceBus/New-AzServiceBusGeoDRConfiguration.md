...
## LEÍRÁS
A **New-AzServiceBusGeoDRConfiguration** parancsmag létrehoz egy új aliast(Katasztrófa-helyreállítás konfiguráció)
...
Létrehozza az "SampleDRConfigName" aliast a "SampleNamespace_Primary" elsődleges névtér "SampleNamespace_Secondary" névterével
...
### -PartnerNamespace
DR Configuration PartnerNamespace (ARM PartnerNamespace azonosítója [Secondary namespace])
