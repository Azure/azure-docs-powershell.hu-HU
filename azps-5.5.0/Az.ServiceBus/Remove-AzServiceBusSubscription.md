...
## LEÍRÁS
A **Remove-AzServiceBusSubscription** parancsmag eltávolítja az előfizetést egy témakörből a megadott Service Bus névtérből.
...
### 5. példa: ResourceId – Karakterlánc-érték használata:
```powershell
...
A -ResourceId paraméter ARM $resourceid/karakterláncában megadott előfizetés eltávolítása 
