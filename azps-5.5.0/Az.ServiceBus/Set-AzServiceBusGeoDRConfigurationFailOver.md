...
## LEÍRÁS
A **Set-AzServiceBusGeoDRConfigurationFailOver** parancsmag meghívja a GEO DR feladatátvételt, és újrakonfigurálja az aliast úgy, hogy a másodlagos névtérre mutasson.
...
A "SampleDRConfigName" alias fölötti feladatátvételt meghívja, újrakonfigurál, és a Secondary namespace "SampleNamespace_Secondary" névtérre mutat
