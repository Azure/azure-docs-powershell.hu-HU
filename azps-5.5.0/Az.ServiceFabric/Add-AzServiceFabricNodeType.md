...
## LEÍRÁS
Vegyen fel egy új csomóponttípust egy meglévő fürtbe.
...
Ez a parancs hozzáad egy új NodeType 'n2'-t 5-ös kapacitással, a vm-rendszergazda neve pedig "adminName".
...
### –10.
Adja meg a NodeType minőségének szintjét.
...
### -VmPassword
A Vm gépre való bejelentkezéshez használt jelszó
