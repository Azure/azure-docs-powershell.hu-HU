...
## LEÍRÁS
A parancsmag létrehoz egy új service fabric alkalmazástípust a megadott erőforráscsoport és fürt alatt.
...
Ebben a példában egy új alkalmazástípust hozunk létre "testAppType" néven az erőforráscsoport és a megadott fürt alatt.
