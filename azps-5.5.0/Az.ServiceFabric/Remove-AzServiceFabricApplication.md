...
## SYNOPSIS
Alkalmazás eltávolítása a fürtből Ezzel eltávolítja az alkalmazás összes szolgáltatását. Csak a telepített ARM támogatja.
...
## LEÍRÁS
Ez a parancsmag eltávolítja a fürt egy alkalmazásűrlapját. Ezzel eltávolítja az alkalmazáserőforrás összes szolgáltatását (ha van ilyen).
...
Ez a példa eltávolítja a "testApp" alkalmazást a "testRG" erőforráscsoportból és a "testCluster" fürtből.
