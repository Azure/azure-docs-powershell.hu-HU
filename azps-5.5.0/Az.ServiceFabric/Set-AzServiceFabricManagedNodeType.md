...
## LEÍRÁS
Beállítja a csomóponttípus erőforrástulajdonságokat, vagy reimage műveleteket futtat a csomóponttípus -Reimage paraméterrel megadott ndes-ján. A reimgae művelet során a szolgáltatás hálócsomópontjai le lesznek tiltva, mielőtt újra képbe kerülnek a virtuális gépeket, és ismét engedélyezték őket, miután visszatértek. Ha ez az elsődleges csomóponttípusokon történik, kis ideig is szükség lehet rá, mivel előfordulhat, hogy nem tudja egyszerre újraemimálni az összes csomópontot. A -ForceReimage akkor is kényszeríti a műveletet, ha a szolgáltatás szövete nem tudja letiltani a csomópontokat, de legyen körültekintő, mivel ez adatvesztést okozhat, ha állapotos terhelések futnak a csomóponton.
...
Frissítse a csomópont példányszámát.
...
A 0- és a 3-as csomópont újraimálása a csomóponttípuson.
...
### -Reimage
Megadhatja a csomóponttípus csomópontjainak újraimálódását.
