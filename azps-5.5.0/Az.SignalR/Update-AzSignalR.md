...
### Frissítsen egy adott SignalR-szolgáltatást.
```powershell
...
Alapértelmezés szerint a "Standard_S1" értéket.
...
### -UnitCount
A SignalR szolgáltatásegységének száma, csak {1, 2, 5, 10, 20, 50, 100} értékből.
