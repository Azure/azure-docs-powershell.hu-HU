...
## SYNOPSIS
Frissítse a SignalR szolgáltatás hálózati ACL-ét.
...
## LEÍRÁS
Frissítse a SignalR szolgáltatás hálózati ACL-ét, beleértve a nyilvános és privát kapcsolat alapértelmezett műveletét és hálózati ACL-ét.

## PÉLDÁK

### RESTAPI,ClientConnection engedélyezése nyilvános hálózaton és alapértelmezett művelet elutasítása
```powershell
...
### Ügyfélkapcsolat és kiszolgálói kapcsolat engedélyezése privát végpontkapcsolat esetén
```powershell
...
### Ügyfélkapcsolat elutasítása nyilvános hálózat és privát végpontkapcsolat esetén is
```powershell
...
### -DefaultAction
A SignalR hálózati ACLs alapértelmezett művelete, amely vagy engedélyezi vagy elutasítja. Eldönti, hogy a hálózati ACL-ek elutasítása vagy a hálózati ACLs engedélyezése hatályba lép-e. Ha például az alapértelmezett művelet engedélyezett, akkor csak az elutasítási ACLs számít.
...
### -PrivateEndpointName
A frissíthető magánjellegű végpont(ak) neve
...
### -PublicNetwork
Nyilvános hálózati ACLs frissítése
