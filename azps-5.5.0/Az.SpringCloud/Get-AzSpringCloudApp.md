...
### 1. példa: A Spring Cloud app letöltése név szerint.
```powershell
...
Szerezze be a Spring Cloud appot név szerint.

### 2. példa: Az összes app felsorolása egy adott tavaszi felhőszolgáltatás alá.
```powershell
