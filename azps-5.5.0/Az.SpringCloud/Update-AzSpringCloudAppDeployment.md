...
### 1. példa: A tavaszi felhőbeli telepítés frissítése név szerint.
```powershell
...
Frissítse a Tavaszi felhőbeli telepítést név szerint.

### 2. példa: A tavaszi felhőbeli telepítés frissítése a pipe-ból.
```powershell
...
Frissítse a tavaszi felhőbeli telepítést a pipe-ból.
...
### -EnvironmentVariable
Környezeti változók gyűjteménye
...
### -MemoryInGb
A szükséges memória mérete GB-ban
...
### -Name
A Központi telepítés erőforrás neve.
...
Ennek kell lennie a célmodulhoz/projekthez vezető relatív elérési útnak.
...
### -SourceRelativePath
A forrást tároló tárhely relatív elérési útja
