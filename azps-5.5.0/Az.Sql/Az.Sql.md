...
SQL-adatbázis-képességeket kap az aktuális előfizetéshez.
...
Beveszi az adatbázisból az adatmaszkolási szabályokat.
...
Egy adatbázis TDE-vizsgálatának előrehaladását olvassa be.
...
A felügyelt adatbázis hosszú távú adatmegőrzési házirendje
...
Az SQL által felügyelt példány átlátszó adattitkosítási (TDE) védelemre van bevéve.
...
Az Azure AD csak egy adott SQL Serverhez kap hitelesítést.
...
Egy kiszolgáló biztonsági résértékelési beállításait kapja meg.
...
Egy Azure SQL Managed Instance-adatbázis visszaállítása.
...
Megszakítja az aszinkron frissítési műveletet egy rugalmas készleten.

### [Stop-AzSqlInstanceDatabaseLogReplay](Stop-AzSqlInstanceDatabaseLogReplay.md)
Megszakítja a Napló visszajátszása szolgáltatást az adatbázis leejtve.
