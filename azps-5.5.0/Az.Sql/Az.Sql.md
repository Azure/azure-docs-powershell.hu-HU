...
### [<span data-ttu-id="484dd-111">Add-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="484dd-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="484dd-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Clear-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="484dd-135">Complete-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="484dd-135">Complete-AzSqlInstanceDatabaseLogReplay</span></span>](Complete-AzSqlInstanceDatabaseLogReplay.md)
...
### [<span data-ttu-id="484dd-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="484dd-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Disable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="484dd-159">Enable-AzSqlInstanceAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="484dd-159">Enable-AzSqlInstanceAdvancedDataSecurity</span></span>](Enable-AzSqlInstanceAdvancedDataSecurity.md)
...
### [<span data-ttu-id="484dd-171">Get-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-171">Get-AzSqlDatabase</span></span>](Get-AzSqlDatabase.md)
...
### [<span data-ttu-id="484dd-185">Get-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-185">Get-AzSqlDatabaseDataMaskingPolicy</span></span>](Get-AzSqlDatabaseDataMaskingPolicy.md)
...
### [<span data-ttu-id="484dd-199">Get-AzSqlDatabaseIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="484dd-199">Get-AzSqlDatabaseIndexRecommendation</span></span>](Get-AzSqlDatabaseIndexRecommendation.md)
...
### [<span data-ttu-id="484dd-213">Get-AzSqlDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="484dd-213">Get-AzSqlDatabaseSensitivityRecommendation</span></span>](Get-AzSqlDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="484dd-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="484dd-239">Get-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="484dd-239">Get-AzSqlElasticJobStep</span></span>](Get-AzSqlElasticJobStep.md)
...
### [<span data-ttu-id="484dd-253">Get-AzSqlElasticPoolDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-253">Get-AzSqlElasticPoolDatabase</span></span>](Get-AzSqlElasticPoolDatabase.md)
...
### [<span data-ttu-id="484dd-267">Get-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-267">Get-AzSqlInstanceDatabase</span></span>](Get-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="484dd-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="484dd-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="484dd-293">Get-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="484dd-293">Get-AzSqlInstancePool</span></span>](Get-AzSqlInstancePool.md)
...
### [<span data-ttu-id="484dd-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="484dd-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Get-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="484dd-317">Get-AzSqlServerMSSupportAudit</span><span class="sxs-lookup"><span data-stu-id="484dd-317">Get-AzSqlServerMSSupportAudit</span></span>](Get-AzSqlServerMSSupportAudit.md)
...
### [<span data-ttu-id="484dd-331">Get-AzSqlServerServiceObjective</span><span class="sxs-lookup"><span data-stu-id="484dd-331">Get-AzSqlServerServiceObjective</span></span>](Get-AzSqlServerServiceObjective.md)
...
### [<span data-ttu-id="484dd-345">Get-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-345">Get-AzSqlSyncGroup</span></span>](Get-AzSqlSyncGroup.md)
...
### [<span data-ttu-id="484dd-359">Invoke-AzSqlInstanceFailover</span><span class="sxs-lookup"><span data-stu-id="484dd-359">Invoke-AzSqlInstanceFailover</span></span>](Invoke-AzSqlInstanceFailover.md)
...
### [<span data-ttu-id="484dd-373">New-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-373">New-AzSqlDatabaseInstanceFailoverGroup</span></span>](New-AzSqlDatabaseInstanceFailoverGroup.md)
...
### [<span data-ttu-id="484dd-387">New-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="484dd-387">New-AzSqlElasticPool</span></span>](New-AzSqlElasticPool.md)
...
### [<span data-ttu-id="484dd-401">New-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="484dd-401">New-AzSqlServerDnsAlias</span></span>](New-AzSqlServerDnsAlias.md)
...
### [<span data-ttu-id="484dd-415">Remove-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-415">Remove-AzSqlDatabase</span></span>](Remove-AzSqlDatabase.md)
...
### [<span data-ttu-id="484dd-429">Remove-AzSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="484dd-429">Remove-AzSqlDatabaseRestorePoint</span></span>](Remove-AzSqlDatabaseRestorePoint.md)
...
### [<span data-ttu-id="484dd-443">Remove-AzSqlElasticAsticTarget</span><span class="sxs-lookup"><span data-stu-id="484dd-443">Remove-AzSqlElasticJobTarget</span></span>](Remove-AzSqlElasticJobTarget.md)
...
### [<span data-ttu-id="484dd-457">Remove-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="484dd-457">Remove-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Remove-AzSqlInstanceDatabaseSensitivityClassification.md)
...
### [<span data-ttu-id="484dd-471">Remove-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="484dd-471">Remove-AzSqlServerDisasterRecoveryConfiguration</span></span>](Remove-AzSqlServerDisasterRecoveryConfiguration.md)
...
### [<span data-ttu-id="484dd-485">Remove-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-485">Remove-AzSqlSyncGroup</span></span>](Remove-AzSqlSyncGroup.md)
...
<span data-ttu-id="484dd-490">Eltávolít egy Azure SQL virtuális fürtöt.</span><span class="sxs-lookup"><span data-stu-id="484dd-490">Removes an Azure SQL Virtual Cluster.</span></span>

### [<span data-ttu-id="484dd-491">Restore-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-491">Restore-AzSqlDatabase</span></span>](Restore-AzSqlDatabase.md)
<span data-ttu-id="484dd-492">Sql-adatbázis visszaállítása.</span><span class="sxs-lookup"><span data-stu-id="484dd-492">Restores a SQL database.</span></span>

### [<span data-ttu-id="484dd-493">Restore-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-493">Restore-AzSqlInstanceDatabase</span></span>](Restore-AzSqlInstanceDatabase.md)
<span data-ttu-id="484dd-494">Egy Azure SQL Managed Instance-adatbázis visszaállítása.</span><span class="sxs-lookup"><span data-stu-id="484dd-494">Restores an Azure SQL Managed Instance database.</span></span>

### [<span data-ttu-id="484dd-495">Resume-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-495">Resume-AzSqlDatabase</span></span>](Resume-AzSqlDatabase.md)
<span data-ttu-id="484dd-496">Sql Data Warehouse-adatbázis folytatása.</span><span class="sxs-lookup"><span data-stu-id="484dd-496">Resumes a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="484dd-497">Set-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-497">Set-AzSqlDatabase</span></span>](Set-AzSqlDatabase.md)
<span data-ttu-id="484dd-498">Beállítja egy adatbázis tulajdonságait, vagy egy meglévő adatbázist rugalmas készletbe áthelyez.</span><span class="sxs-lookup"><span data-stu-id="484dd-498">Sets properties for a database, or moves an existing database into an elastic pool.</span></span>

### [<span data-ttu-id="484dd-499">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="484dd-499">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span></span>](Set-AzSqlDatabaseAdvisorAutoExecuteStatus.md)
<span data-ttu-id="484dd-500">Az Azure SQL-adatbázis tanácsadó automatikus végrehajtásának állapotát módosítja.</span><span class="sxs-lookup"><span data-stu-id="484dd-500">Modifies auto execute status of an Azure SQL Database Advisor.</span></span>

### [<span data-ttu-id="484dd-501">Set-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="484dd-501">Set-AzSqlDatabaseAudit</span></span>](Set-AzSqlDatabaseAudit.md)
<span data-ttu-id="484dd-502">Egy Azure SQL-adatbázis naplózási beállításait módosítja.</span><span class="sxs-lookup"><span data-stu-id="484dd-502">Changes the auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="484dd-503">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-503">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="484dd-504">Kiszolgálói hosszú távú adatmegőrzési házirendet állít be.</span><span class="sxs-lookup"><span data-stu-id="484dd-504">Sets a server long term retention policy.</span></span>

### [<span data-ttu-id="484dd-505">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-505">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="484dd-506">Biztonsági másolatot készít rövid távú adatmegőrzési házirendről.</span><span class="sxs-lookup"><span data-stu-id="484dd-506">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="484dd-507">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-507">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="484dd-508">Beállítja egy adatbázis adatmaszkolását.</span><span class="sxs-lookup"><span data-stu-id="484dd-508">Sets data masking for a database.</span></span>

### [<span data-ttu-id="484dd-509">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="484dd-509">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="484dd-510">Beállítja egy adatbázis adatmaszkolási szabályának tulajdonságait.</span><span class="sxs-lookup"><span data-stu-id="484dd-510">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="484dd-511">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-511">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="484dd-512">Egy Azure SQL-adatbázis feladatátvételi csoportjának konfigurációját módosítja.</span><span class="sxs-lookup"><span data-stu-id="484dd-512">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="484dd-513">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-513">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="484dd-514">Az adatbázis földrajzi biztonsági mentésének házirendet állít be.</span><span class="sxs-lookup"><span data-stu-id="484dd-514">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="484dd-515">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-515">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="484dd-516">Módosítja egy példány feladatátvételi csoportjának konfigurációját.</span><span class="sxs-lookup"><span data-stu-id="484dd-516">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="484dd-517">Set-AzSqlDatabaseRecomstateActionState</span><span class="sxs-lookup"><span data-stu-id="484dd-517">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="484dd-518">Frissíti egy Azure SQL-adatbázis ajánlott műveletének állapotát.</span><span class="sxs-lookup"><span data-stu-id="484dd-518">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="484dd-519">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="484dd-519">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="484dd-520">A feladatátvétel kezdeményezése érdekében elsődlegesre vált egy másodlagos adatbázist.</span><span class="sxs-lookup"><span data-stu-id="484dd-520">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="484dd-521">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="484dd-521">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="484dd-522">Beállítja az adatbázis oszlopainak információs típusait és bizalmasság-címkéit.</span><span class="sxs-lookup"><span data-stu-id="484dd-522">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="484dd-523">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="484dd-523">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="484dd-524">Módosítja egy adatbázis TDE tulajdonságát.</span><span class="sxs-lookup"><span data-stu-id="484dd-524">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="484dd-525">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="484dd-525">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="484dd-526">Beállítja a biztonsági rés felmérésére vonatkozó szabály alapértékét.</span><span class="sxs-lookup"><span data-stu-id="484dd-526">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="484dd-527">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="484dd-527">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="484dd-528">Feladat frissítése</span><span class="sxs-lookup"><span data-stu-id="484dd-528">Updates a job</span></span>

### [<span data-ttu-id="484dd-529">Set-AzSqlElasticAgent</span><span class="sxs-lookup"><span data-stu-id="484dd-529">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="484dd-530">Rugalmas ügynök frissítése</span><span class="sxs-lookup"><span data-stu-id="484dd-530">Updates an elastic job agent</span></span>

### [<span data-ttu-id="484dd-531">Set-AzSqlElasticCredential</span><span class="sxs-lookup"><span data-stu-id="484dd-531">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="484dd-532">A feladat hitelesítő adatainak frissítése</span><span class="sxs-lookup"><span data-stu-id="484dd-532">Updates a job credential</span></span>

### [<span data-ttu-id="484dd-533">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="484dd-533">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="484dd-534">Feladat lépésének frissítése</span><span class="sxs-lookup"><span data-stu-id="484dd-534">Updates a job step</span></span>

### [<span data-ttu-id="484dd-535">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="484dd-535">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="484dd-536">Módosítja egy rugalmas adatbáziskészlet tulajdonságait az Azure SQL-adatbázisban.</span><span class="sxs-lookup"><span data-stu-id="484dd-536">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="484dd-537">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="484dd-537">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="484dd-538">Frissíti az Azure SQL rugalmassági készlet tanácsadója automatikus végrehajtásának állapotát.</span><span class="sxs-lookup"><span data-stu-id="484dd-538">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="484dd-539">Set-AzSqlElasticPoolRecomstateActionState</span><span class="sxs-lookup"><span data-stu-id="484dd-539">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="484dd-540">Frissíti az Ajánlott Azure SQL-rugalmassági készlet állapotát.</span><span class="sxs-lookup"><span data-stu-id="484dd-540">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="484dd-541">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="484dd-541">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="484dd-542">Beállítja egy Azure SQL-adatbázis felügyelt példányának tulajdonságait.</span><span class="sxs-lookup"><span data-stu-id="484dd-542">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="484dd-543">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="484dd-543">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="484dd-544">Azure AD-rendszergazdát hoz létre az SQL Felügyelt példányhoz.</span><span class="sxs-lookup"><span data-stu-id="484dd-544">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="484dd-545">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-545">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="484dd-546">A **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** parancsmag beállítja a felügyelt adatbázis hosszú távú adatmegőrzési házirendet.</span><span class="sxs-lookup"><span data-stu-id="484dd-546">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="484dd-547">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="484dd-547">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="484dd-548">Biztonsági másolatot készít rövid távú adatmegőrzési házirendről.</span><span class="sxs-lookup"><span data-stu-id="484dd-548">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="484dd-549">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="484dd-549">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="484dd-550">Beállítja az Azure SQL felügyeltpéldány-adatbázisban az oszlopok adattípusát és bizalmasság-címkéit.</span><span class="sxs-lookup"><span data-stu-id="484dd-550">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="484dd-551">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="484dd-551">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="484dd-552">Beállítja a biztonsági rés felmérésére vonatkozó szabály alapértékét.</span><span class="sxs-lookup"><span data-stu-id="484dd-552">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="484dd-553">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="484dd-553">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="484dd-554">Beállítja egy Azure SQL-példánykészlet tulajdonságait.</span><span class="sxs-lookup"><span data-stu-id="484dd-554">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="484dd-555">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="484dd-555">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="484dd-556">Az ÁTLÁTSZÓ adattitkosítás (TDE) védelmét állítja be egy SQL-kezelt példányhoz.</span><span class="sxs-lookup"><span data-stu-id="484dd-556">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="484dd-557">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="484dd-557">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="484dd-558">Módosítja egy SQL-adatbázis-kiszolgáló tulajdonságait.</span><span class="sxs-lookup"><span data-stu-id="484dd-558">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="484dd-559">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="484dd-559">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="484dd-560">Azure AD-rendszergazdát hoz létre az SQL Serverhez.</span><span class="sxs-lookup"><span data-stu-id="484dd-560">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="484dd-561">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="484dd-561">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="484dd-562">Frissíti egy Azure SQL Server-tanácsadó automatikus végrehajtási állapotát.</span><span class="sxs-lookup"><span data-stu-id="484dd-562">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="484dd-563">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="484dd-563">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="484dd-564">Egy Azure SQL-kiszolgáló naplózási beállításainak módosítása.</span><span class="sxs-lookup"><span data-stu-id="484dd-564">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="484dd-565">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="484dd-565">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="484dd-566">Módosítja az adatbázis-kiszolgáló helyreállítási konfigurációját.</span><span class="sxs-lookup"><span data-stu-id="484dd-566">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="484dd-567">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="484dd-567">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="484dd-568">Módosítja azt a kiszolgálót, amelyre az Azure SQL Server DNS-aliasa mutat</span><span class="sxs-lookup"><span data-stu-id="484dd-568">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="484dd-569">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="484dd-569">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="484dd-570">Módosít egy tűzfalszabályt az Azure SQL-adatbázis-kiszolgálón.</span><span class="sxs-lookup"><span data-stu-id="484dd-570">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="484dd-571">Set-AzSqlServerMSSupportAudit</span><span class="sxs-lookup"><span data-stu-id="484dd-571">Set-AzSqlServerMSSupportAudit</span></span>](Set-AzSqlServerMSSupportAudit.md)
<span data-ttu-id="484dd-572">Egy Azure SQL-adatbázis Microsoft támogatási műveleteinek naplózási beállításait módosítja.</span><span class="sxs-lookup"><span data-stu-id="484dd-572">Changes the Microsoft support operations auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="484dd-573">Set-AzSqlServerRecomstateActionState</span><span class="sxs-lookup"><span data-stu-id="484dd-573">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="484dd-574">Frissíti az Ajánlott Azure SQL Server-művelet állapotát.</span><span class="sxs-lookup"><span data-stu-id="484dd-574">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="484dd-575">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="484dd-575">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="484dd-576">Az átlátszó adattitkosítás (TDE) védelmét állítja be egy SQL-kiszolgálóhoz.</span><span class="sxs-lookup"><span data-stu-id="484dd-576">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="484dd-577">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="484dd-577">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="484dd-578">Módosítja egy Azure SQL Server virtuális hálózati szabály konfigurációját.</span><span class="sxs-lookup"><span data-stu-id="484dd-578">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="484dd-579">Start-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="484dd-579">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="484dd-580">Elindítja az ajánlott indexműveletet futtató munkafolyamatot.</span><span class="sxs-lookup"><span data-stu-id="484dd-580">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="484dd-581">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="484dd-581">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="484dd-582">Biztonsági vizsgálat indítása.</span><span class="sxs-lookup"><span data-stu-id="484dd-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="484dd-583">Start-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="484dd-583">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="484dd-584">Elindít egy feladatot, és visszaad egy feladatvégrehajtási azonosítót, amely az állapotának megtekintéséhez lekérdezható</span><span class="sxs-lookup"><span data-stu-id="484dd-584">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="484dd-585">Start-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="484dd-585">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="484dd-586">Elindítja a napló visszajátszása szolgáltatást a megadott paraméterekkel.</span><span class="sxs-lookup"><span data-stu-id="484dd-586">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="484dd-587">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="484dd-587">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="484dd-588">Biztonsági vizsgálat indítása.</span><span class="sxs-lookup"><span data-stu-id="484dd-588">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="484dd-589">Start-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="484dd-589">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="484dd-590">Szinkronizálási csoportszinkronizálás indítása.</span><span class="sxs-lookup"><span data-stu-id="484dd-590">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="484dd-591">Stop-AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="484dd-591">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="484dd-592">Megszakítja az adatbázis aszinkron frissítésének műveletét.</span><span class="sxs-lookup"><span data-stu-id="484dd-592">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="484dd-593">Stop-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="484dd-593">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="484dd-594">Leállítja az ajánlott indexműveletet futtató munkafolyamatot.</span><span class="sxs-lookup"><span data-stu-id="484dd-594">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="484dd-595">Stop-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="484dd-595">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="484dd-596">Leállít egy feladatot, mert az feladatvégrehajtási azonosítója</span><span class="sxs-lookup"><span data-stu-id="484dd-596">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="484dd-597">Stop-AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="484dd-597">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="484dd-598">Megszakítja az aszinkron frissítési műveletet egy rugalmas készleten.</span><span class="sxs-lookup"><span data-stu-id="484dd-598">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="484dd-599">Stop-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="484dd-599">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="484dd-600">Megszakítja a Napló visszajátszása szolgáltatást az adatbázis leejtve.</span><span class="sxs-lookup"><span data-stu-id="484dd-600">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="484dd-601">Stop-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="484dd-601">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="484dd-602">Leállítja egy SQL által felügyelt példány műveleteit.</span><span class="sxs-lookup"><span data-stu-id="484dd-602">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="484dd-603">Stop-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="484dd-603">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="484dd-604">Leállítja a szinkronizálási csoport szinkronizálását.</span><span class="sxs-lookup"><span data-stu-id="484dd-604">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="484dd-605">Suspend-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="484dd-605">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="484dd-606">Sql Data Warehouse-adatbázis felfüggesztése.</span><span class="sxs-lookup"><span data-stu-id="484dd-606">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="484dd-607">Switch-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-607">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="484dd-608">Az Azure SQL-adatbázis feladatátvételi csoportjának feladatátvételét hajtja végre.</span><span class="sxs-lookup"><span data-stu-id="484dd-608">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="484dd-609">Switch-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-609">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="484dd-610">Egy példány feladatátvételi csoportjának feladatátvételét hajtja végre.</span><span class="sxs-lookup"><span data-stu-id="484dd-610">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="484dd-611">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-611">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="484dd-612">Speciális veszélyforrás-védelmi beállításokat ad meg egy adatbázishoz.</span><span class="sxs-lookup"><span data-stu-id="484dd-612">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="484dd-613">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-613">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="484dd-614">Frissíti egy adatbázis biztonsági rés-felmérési beállításait.</span><span class="sxs-lookup"><span data-stu-id="484dd-614">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="484dd-615">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-615">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="484dd-616">Frissíti a felügyelt adatbázisok biztonsági résértékelési beállításait.</span><span class="sxs-lookup"><span data-stu-id="484dd-616">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="484dd-617">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-617">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="484dd-618">Frissíti a felügyelt példányok biztonsági résértékelési beállításait.</span><span class="sxs-lookup"><span data-stu-id="484dd-618">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="484dd-619">Update-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-619">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="484dd-620">Speciális veszélyforrás-védelmi beállításokat ad meg a kiszolgálón.</span><span class="sxs-lookup"><span data-stu-id="484dd-620">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="484dd-621">Update-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="484dd-621">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="484dd-622">Frissíti a kiszolgáló biztonsági résértékelési beállításait.</span><span class="sxs-lookup"><span data-stu-id="484dd-622">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="484dd-623">Update-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="484dd-623">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="484dd-624">Frissíti az Azure SQL Database Sync-csoportot.</span><span class="sxs-lookup"><span data-stu-id="484dd-624">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="484dd-625">Update-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="484dd-625">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="484dd-626">Frissíti az Azure SQL Database Sync egyik tagját.</span><span class="sxs-lookup"><span data-stu-id="484dd-626">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="484dd-627">Update-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="484dd-627">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="484dd-628">Frissítse a szinkronizálási séma szinkronizálási tagadatbázis vagy szinkronizálási központ adatbázisát.</span><span class="sxs-lookup"><span data-stu-id="484dd-628">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="484dd-629">Be fogja szerezni a legújabb adatbázissémát a valós adatbázisból, majd ezt használva frissíti a metaadat-szinkronizálási adatbázis által gyorsítótárazott sémát.</span><span class="sxs-lookup"><span data-stu-id="484dd-629">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="484dd-630">Ha a "SyncMemberName" érték meg van adva, az frissíti a tagadatbázis-sémát; ha nem, akkor frissíti a központi adatbázissémát.</span><span class="sxs-lookup"><span data-stu-id="484dd-630">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
