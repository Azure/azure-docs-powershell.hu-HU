...
## LEÍRÁS
A **Clear-AzSqlDatabaseAdvancedThreatProtectionSetting** parancsmag eltávolítja a komplex veszélyforrások elleni védelem speciális beállításait az AzureAzure SQL-adatbázisból.
Ha használni szeretné ezt a parancsmagot, adja meg a *ResourceGroupName* és *a ServerName* paramétert annak az adatbázisnak a azonosításához, amelyből a parancsmag eltávolítja a beállításokat.
...
Ez a parancs eltávolítja a Komplex veszélyforrások elleni védelem speciális beállításait egy Database01 nevű adatbázisból a Server01 nevű kiszolgálón.

## PARAMETERS

### -DatabaseName
Annak az adatbázisnak a nevét adja meg, amelyből el kell távolítani a komplex veszélyforrások elleni védelem speciális beállításait.
