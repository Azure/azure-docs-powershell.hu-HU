...
## LEÍRÁS
A Disable-AzSqlInstanceDatabaseSensitivityRecommendation parancsmag letiltja (mellőzi) a bizalmasságra vonatkozó javaslatokat az Azure SQL felügyeltpéldány-adatbázis oszlopainál.

## PÉLDÁK

### 1. példa: Bizalmasság-javaslatok letiltása egy Azure SQL felügyeltpéldány-adatbázis adott oszlopában.
```powershell
...
### 2. példa: Tiltsa le a bizalmasság-javaslatokat olyan oszlopokban, amelyek bizalmasságra vonatkozó javaslatokat tartalmaznak a Pipinget tartalmazó Azure SQL felügyelt példány-adatbázisban.
```powershell
...
### 3. példa: A bizalmasságra vonatkozó javaslatok letiltása egy Azure SQL által felügyelt példányadatbázis adott oszlopában a Piping utasítással.
```powershell
