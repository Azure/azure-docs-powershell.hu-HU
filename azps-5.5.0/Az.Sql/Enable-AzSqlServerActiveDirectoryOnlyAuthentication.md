...
Ez a parancs csak az Azure Active Directory (Azure AD) hitelesítését teszi lehetővé egy Server01 nevű AzureSQL-kiszolgálóhoz, amely egy ResourceGroup01 nevű erőforráscsoporthoz van társítva.
