...
A parancsmagot a *ResourceGroupName,* *a ServerName* és a *DatabaseName* paraméter használatával azonosíthatja az adatbázist, a *RuleId* paraméterrel pedig megadhatja, hogy ez a parancsmag melyik szabályt adja vissza.
...
### 2. példa: A "dbo", a "table1" táblában és az "oszlop1" oszlopban definiált adatmaszkolási szabály be szerezni.
```
