...
## LEÍRÁS
A **Get-AzSqlDatabaseRecomdataAction** parancsmag egy vagy több javasolt műveletet kap egy Azure SQL-adatbázis tanácsadóhoz.
...
Ez a parancs a CreateIndex nevű tanácsadó által ajánlott műveletek listáját tartalmazza, amely elérhető az ausztráliai wi-runner-east nevű adatbázishoz.
...
Ez a parancs a CreateIndex nevű tanácsadóhoz IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 nevű javasolt műveletet \] kapja.
...
### -DatabaseName
Annak az adatbázisnak a nevét adja meg, amelyhez ez a parancsmag az ajánlott műveleteket kéri.
