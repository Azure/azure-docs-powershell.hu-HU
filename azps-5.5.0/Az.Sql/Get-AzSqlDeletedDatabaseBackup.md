...
## LEÍRÁS
A **Get-AzSqlDeletedDatabaseBackup** parancsmag egy megadott törölt SQL-adatbázis biztonsági másolatát kapja, amely visszaállítható, illetve az összes visszaállítható törölt biztonsági másolat.
...
Ez a parancs a ContosoDatabase törölt adatbázisának biztonsági másolatát kapja vissza.
...
### -DeletionDate
Az adatbázis törlési dátumát adja meg **DateTime-objektumként.**
