...
## LEÍRÁS
A **Get-AzSqlInstanceActiveDirectoryAdministrator** parancsmag információt kap az aktuális előfizetésben lévő AzureSQL Felügyelt példány Azure Active Directory (Azure AD) rendszergazdáiról.
