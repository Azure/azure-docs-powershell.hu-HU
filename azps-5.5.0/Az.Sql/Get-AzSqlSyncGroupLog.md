...
## LEÍRÁS
A **Get-AzSqlSyncGroupLog** parancsmag egy Azure SQL Database Sync-csoport naplóit adja vissza.

## PÉLDÁK

### 1. példa: Azure SQL Sync-csoport naplóinak lekérte
```
...
Ez a parancs egy Azure SQL Sync-csoport naplóit kapja meg.
...
### -EndTime
A lekérdezni naplók záró ideje.
...
### -LogLevel
A lekérdezéshez használható naplók típusa.
Érvényes értékek: "Hiba", "Figyelmeztetés", "Sikeres" és "Mind".
...
### -StartTime
A lekérdezni kezdhető naplók kezdési ideje.
