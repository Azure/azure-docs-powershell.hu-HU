...
## LEÍRÁS
Létrehoz egy új Azure SQL Server DNS-aliast, amely a megadott kiszolgálóra mutat.
...
Ez a parancs létrehozza az Azure SQL Server DNS-aliasát a serverName kiszolgálónévre mutató aliasnévvel
