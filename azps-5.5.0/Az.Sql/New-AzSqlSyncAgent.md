...
## LEÍRÁS
A **New-AzSqlSyncAgent** parancsmag létrehoz egy Azure SQL Sync-ügynököt.

## PÉLDÁK

### 1. példa: Szinkronizálási ügynök létrehozása Azure SQL-kiszolgálóhoz.
```
...
Ez a parancs szinkronizálási ügynököt hoz létre egy Azure SQL-kiszolgálóhoz.
