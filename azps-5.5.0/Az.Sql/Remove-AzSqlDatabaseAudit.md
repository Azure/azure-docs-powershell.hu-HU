...
## LEÍRÁS
A **Remove-AzSqlDatabaseAudit** parancsmag eltávolítja egy Azure SQL-adatbázis naplózási beállításait.
A parancsmagot a *ResourceGroupName,* *a ServerName* és a *DatabaseName* paraméter használatával azonosíthatja az adatbázist.

## PÉLDÁK

### 1. példa: Azure SQL-adatbázis naplózási beállításainak eltávolítása
```
PS C:\>Remove-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

### 2. példa: Azure SQL-adatbázis naplózási beállításainak eltávolítása folyamaton keresztül
```
