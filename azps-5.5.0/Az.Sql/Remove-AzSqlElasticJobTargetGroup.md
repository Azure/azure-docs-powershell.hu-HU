...
## LEÍRÁS
A Remove-AzSqlElasticJobTargetGroup parancsmag eltávolít egy célcsoportot és annak célcsoportjait.
...
Egy célcsoport és a célcsoport eltávolítása

### 2. példa

Eltávolítja a célcsoportot. (automatikusan generált)
