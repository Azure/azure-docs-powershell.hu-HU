...
## LEÍRÁS
A **Remove-AzSqlServerAudit** parancsmag eltávolítja egy Azure SQL-kiszolgáló naplózási beállításait.
A *kiszolgáló azonosításához adja* meg a ResourceGroupName és *a ServerName* paramétert.

## PÉLDÁK

### 1. példa: Azure SQL-kiszolgáló naplózási beállításainak eltávolítása
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### 2. példa: Azure SQL-kiszolgáló naplózási beállításainak eltávolítása folyamaton keresztül
```
