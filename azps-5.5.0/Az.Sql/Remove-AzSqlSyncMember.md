...
## LEÍRÁS
A **Remove-AzSqlSyncMember** parancsmag eltávolítja az Azure SQL Database Sync tagját.
...
Ez a parancs eltávolítja a syncMember01 nevű Azure SQL Database Sync membert.
...
### -PassThru
Meghatározza, hogy visszaadja-e az eltávolított szinkronizálási tagot
