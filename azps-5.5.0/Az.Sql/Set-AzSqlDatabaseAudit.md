...
RECEIVE  
HIVATKOZÁSOK  
A naplózó művelet meghatározásának általános űrlapja a következő: [művelet] ON [objektum] BY [principal] Megjegyzés: a fenti formátumban az [objektum] hivatkozhat objektumra, például táblázatra, nézetre vagy tárolt eljárásra, illetve egy teljes adatbázisra vagy sémára. Az utóbbi esetekben a DATABASE::[dbname] és a SCHEMA::[sémanév] űrlapot használja a rendszer.
Például:  
