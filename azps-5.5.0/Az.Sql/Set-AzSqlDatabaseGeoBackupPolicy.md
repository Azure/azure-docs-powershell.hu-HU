...
## LEÍRÁS
A **Set-AzSqlDatabaseGeoBackupPolicy** parancsmag beállítja az adatbázishoz regisztrált geo backup házirendet.
...
### -DatabaseName
Annak az adatbázisnak a nevét adja meg, amelyhez ez a parancsmag beállítja a földrajzi biztonsági mentési házirendet.
...
### -State
A földrajzi biztonsági mentési házirend állapotát határozza meg.
