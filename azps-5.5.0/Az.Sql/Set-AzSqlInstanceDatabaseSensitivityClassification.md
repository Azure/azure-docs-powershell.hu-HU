...
## LEÍRÁS
A Set-AzSqlInstanceDatabaseSensitivityClassification parancsmag az Azure SQL felügyeltpéldány-adatbázisban állítja be az oszlopok adattípusát és bizalmasság-címkéit.

## PÉLDÁK

### 1. példa: Egy Azure SQL felügyeltpéldány-adatbázisban lévő oszlop adattípusának és bizalmasság-címkéinek beállítása.
```powershell
...
### 2. példa: Az Ajánlott adattípusok és bizalmasság-címkék beállítása egy Azure SQL felügyeltpéldány-adatbázisban.
```powershell
...
### 3. példa: Az Azure SQL felügyeltpéldány-adatbázisban lévő oszlopok adattípusának és bizalmasság-címkéinek beállítása pipázás használatával.
```powershell
