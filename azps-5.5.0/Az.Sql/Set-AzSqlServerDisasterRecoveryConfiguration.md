...
## LEÍRÁS
A **Set-AzSqlServerDisasterRecoveryConfiguration** parancsmag módosítja az SQL-adatbázis-kiszolgáló helyreállítási konfigurációját.
...
### -AllowDataLoss
Azt jelzi, hogy a feladatátvételi művelet lehetővé teszi az adatvesztést.
