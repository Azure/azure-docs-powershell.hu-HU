...
## LEÍRÁS
A **Stop-AzSqlElasticPoolActivity** parancsmag megszakítja a rugalmas készlet aszinkron frissítési műveletét.

## PÉLDÁK

### 1. példa: Aszinkron frissítési művelet megszakítása rugalmas készleten
```
...
Ez a parancs megszakítja a rugalmas készlet aszinkron frissítését.
