...
## LEÍRÁS
A Stop-AzSqlInstanceOperation leállítja a műveletet az SQL felügyelt példányon megadott műveletnévvel.

## PÉLDÁK

### 1. példa: Adott művelet lekérte
```powershell
...
Ez a parancs leállítja a "d0f5bef5-e2b1-4ef8-bb42-2e54073874f9" nevű műveletet egy SQL-kezelt példányon.

### 2. példa: Művelet típusú erőforrás-azonosító használata
```powershell
...
Ez a parancs leállítja a műveletet $managedInstanceOperation.Id.
...
Ez a parancs leállítja a műveletet $managedInstanceOperation.
...
### -InputObject
A megszakítani szükséges művelet
...
### -ResourceId
A leállítni szükséges műveletobjektum erőforrás-azonosítója
