...
### Paraméterlista (alapértelmezett)
```
...
## LEÍRÁS
A Remove-AzSqlVMGroup parancsmag töröl egy sql virtuális gépcsoportot.
...
Törli az Azure SQL virtuális gép "tesztcsoport" csoportját az Erőforráscsoport01 erőforráscsoportban.
