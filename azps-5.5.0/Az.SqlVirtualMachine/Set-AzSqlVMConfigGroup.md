...
## LEÍRÁS
A Set-AzSqlVMConfigGroup parancsmag megszabadja az sql virtuális gép konfigurációjának sql virtuális gépcsoporthoz való csatlakozáshoz szükséges információkat.
...
Frissítse egy sql virtuális gép konfigurációjának csoportinformációit.

## PARAMETERS

### -ClusterBootstrapAccountPassword
A fürtindító fiók jelszava
...
A fürt műveleti jelszavának megadása
...
### -SqlVM
Az SQL virtuális gép konfigurációja, amelyhez csoporttagság lesz hozzáadva
...
### -SqlVMGroup
A csoport, amelybe az SQL virtuális gép fog
