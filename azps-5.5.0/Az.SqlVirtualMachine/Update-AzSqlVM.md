...
## SYNOPSIS
Egy sql virtuális gép frissítése.
...
## LEÍRÁS
A Update-AzSqlVM parancsmag frissíti az sql virtuális gépet.
...
Frissíti egy sql virtuális gép címkéit.

### 2. példa

Egy sql virtuális gép frissítése. (automatikusan generált)
