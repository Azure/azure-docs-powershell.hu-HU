...
## LEÍRÁS
A **Get-AzStackEdgeStorageAccount** parancsmag a Stack Edge-eszközön elérhetőVé válik a Edge Storage-fiókok számára. A Név paraméterként megadhatja a parancsmagban egy adott Edge Storage-fiók adatait.
