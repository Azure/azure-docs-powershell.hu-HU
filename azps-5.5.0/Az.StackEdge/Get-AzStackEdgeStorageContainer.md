...
## LEÍRÁS
A **Get-AzStackEdgeStorageContainer parancsmag** egy Stack Edge-eszközön található Edge Storage-fiók tárolóját kapja meg. A nevet paraméterként megadhatja a parancsmagban egy adott tároló részleteinek lehívása érdekében. 
