...
## LEÍRÁS
A **Remove-AzStackEdgeStorageAccount** parancsmag eltávolítja a stack edge-es eszközökhez tartozó Edge Storage-fiókot. Megadhatja a parancsmagban paraméterként eltávolítható Edge Storage-fiók nevét.
