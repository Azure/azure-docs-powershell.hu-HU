...
## LEÍRÁS
A **Remove-AzStackEdgeStorageContainer** parancsmag eltávolítja a Stack Edge-eszközön a Edge Storage-fiók társított tárolóját. Megadhatja a paraméterként eltávolítható tároló tároló nevét.
