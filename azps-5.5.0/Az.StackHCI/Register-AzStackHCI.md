...
## SYNOPSIS
Register-AzStackHCI létrehoz egy Microsoft.AzureStackHCI felhőerőforrást, amely a helyi fürtnek megfelelő, és regisztrálja a helyi fürtöt az Azure-zal.
...
## LEÍRÁS
Register-AzStackHCI létrehoz egy Microsoft.AzureStackHCI felhőbeli erőforrást, amely a helyi fürtnek megfelelő, és regisztrálja a helyi fürtöt az Azure-ral.
...
Ha ezt az ArmAccessToken és a GraphAccessToken mellett adja meg, azzal elkerüli az Azure interaktív bejelentkezését.
...
Az összes csomóponton elérhető tanúsítvány thumbprint-ját adja meg. A felhasználó felelős a tanúsítvány kezeléséért.
...
### -ComputerName
Megadja a fürt nevét vagy egy olyan fürtcsomópontot a környezetében, amely regisztrálva van az Azure-ban.
...
### -Régió
Megadja az erőforrás létrehozásához használt régiót.
Az alapértelmezett érték az EastUS.
...
### -RepairRegistration
Kijavíthatja az Azure Stack HCI-regisztrációját a felhőben. Ez a parancsmag törli a helyi tanúsítványokat a csoportosított csomópontokon és a távoli tanúsítványokat az Azure AD-alkalmazásban a felhőben, és mindkettőhöz új cseretanúsítványokat hoz létre. Az erőforráscsoport, az erőforrás neve és más regisztrációs lehetőségek megőrzve maradnak.
...
### Eredmény: Sikeres vagy sikertelen, illetve Függőben LévőForAdminConsent vagy Visszavonva.
### ResourceId: Az Azure-ban létrehozott erőforrás erőforrás-azonosítója.
### PortalResourceURL: Azure Portal Resource URL.
### PortalAADAppPermissionsURL: Az Azure Portal AAD-alkalmazások engedélyeinek lapja.
## MEGJEGYZÉSEK
