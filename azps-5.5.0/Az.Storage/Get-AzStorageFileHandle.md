...
## LEÍRÁS
A **Get-AzStorageFileHandle** parancsmag felsorolja a fájlmegosztások, illetve fájlkönyvtárak vagy fájlok kezelőit.

## PÉLDÁK

### 1. példa: A fájlmegosztás összes fogópontját rekurzív módon listába rendezheti, ClientIp és OpenTime szerint rendezheti
```
...
Ez a parancs felsorolja a fájlmegosztások fogópontját, és a kimenetet ClientIp, majd OpenTime szerint rendezi.

### 2. példa: Egy fájlkönyvtár első 2 fájlkezelő fogópontját sorolja fel rekurzív módon
```
...
Ez a parancs a fájlkönyvtárak első 2 fájlfogópontját sorolja fel rekurzív módon.

### 3. példa: A 3. és a 6. fájlfogópont felsorolása egy fájlon
```
...
Ez a parancs felsorolja a fájl 3–6. fájlfogópontját.
...
### -File
A CloudFile objektum a fájlt a fájlkezelők listájához jelölte.
...
### -Rekurzív
Listafogópontokat rekurzív módon.
...
### -IncludeTotalCount
Az adathalmazban lévő objektumok számát (egész számot) és az objektumokat jelenti. Ha a parancsmag nem tudja megállapítani a teljes számát, akkor az "Ismeretlen teljes szám" értéket adja vissza.
Ez a paraméter jelenleg nem tesz semmit.
...
### -First
Csak az első "n" objektumot kapja meg.
...
### Microsoft.Azure.Storage.File.File.FileHandleResultSegment
