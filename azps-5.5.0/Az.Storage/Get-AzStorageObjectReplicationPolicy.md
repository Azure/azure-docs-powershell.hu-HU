...
## LEÍRÁS
A **Get-AzStorageObjectReplicationPolicy parancsmag** egy tárfiók objektum-replikációs házirendjeit kapja vagy sorolja fel.

## PÉLDÁK

### 1. példa: Objektum-replikációs házirend lekérte adott házirend-azonosítót, és a szabály megjelenítése.
```
...
Ez a parancs egy objektumreplikációs házirendet kap adott házirend-azonosítóval, és annak szabályait jeleníti meg.

### 2. példa: Objektumreplikációs házirend listása tárfiókból
```
...
Ez a parancs felsorolja a tárfiókból származó objektumreplikációs házirendet.
...
### -PolicyId
Objektum-replikációs házirend azonosítója.
