...
## LEÍRÁS
A **Get-AzStorageServiceProperty** parancsmag megkapja az Azure Storage-szolgáltatások tulajdonságait.

## PÉLDÁK

### 1. példa: A Blob szolgáltatás Azure Storage Services tulajdonságának lekérte
```
...
Ez a parancs a Blob szolgáltatás DefaultServiceVersion tulajdonságát kapja meg.
