...
### 2. példa: Titkosítási tartomány létrehozása Keyvault-titkosítással
```
...
Ez a parancs a Keyvault titkosítással titkosítási hatókört hoz létre.
A tárfiók identitásának be kell szereznie, wrapkey,unwrapkey engedélyekkel kell rendelkeznie a keyvault kulcshoz.
