...
### 3. példa: Az ACL-rekurzív adattömb eltávolítása adattömbök szerint
```
$token = $null
...
Ez a parancsprogram a címtár-adattömbök ACL-rescursively-ját eltávolítja, és a fájlméret a BatchSize * MaxBatchCount lesz. A parancsprogramban 50000 darabos adattömb van.
