...
### 3. példa: Egy folyamatban lévő fájlrendszer összes elemének eltávolítása
```
...
### -Force
A fájlrendszer és a benne található összes tartalom eltávolításának kényszerítenie
