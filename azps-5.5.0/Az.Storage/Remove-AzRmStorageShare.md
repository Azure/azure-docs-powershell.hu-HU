...
## LEÍRÁS
A **New-AzRmStorageShare** parancsmag eltávolítja a tárhelyfájl megosztását.

## PÉLDÁK

### 1. példa: Tárterületfájl-megosztás eltávolítása a Tárfiók nevével és a megosztás nevével
```
PS C:\>Remove-AzRmStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" -Name "myshare"
```

Ez a parancs eltávolítja a Tárterületfájl-megosztást a Tárfiók nevével és a megosztás nevével.

### 2. példa: Tárterületfájl-megosztás eltávolítása a Tárfiók objektummal és a megosztás nevével
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Ez a parancs eltávolítja a tárterületfájl megosztását a Tárfiók objektummal és a megosztás nevével.

### 3. példa: A tárfiók összes tárfájlmegosztásának eltávolítása folyamaton keresztül
```
PS C:\>Get-AzStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" | Remove-AzRmStorageShare -Force
```

Ez a parancs eltávolítja a tárterületfájl-megosztásokat egy folyamatban futó Tárfiókban.
...
### -Force
A Megosztás és az abban található összes tartalom eltávolítása kényszerítve
