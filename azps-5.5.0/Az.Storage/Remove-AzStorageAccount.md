...
## LEÍRÁS
A **Remove-AzStorageAccount** parancsmag eltávolít egy tárfiókot az Azure-ból.

## PÉLDÁK

### 1. példa: Tárfiók eltávolítása
```
PS C:\>Remove-AzStorageAccount -ResourceGroupName "RG01" -AccountName "mystorageaccount"
```

Ez a parancs eltávolítja a megadott tárfiókot.
...
### -Name
Az eltávolítható tárfiók nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amely az eltávolítható tárfiókot tartalmazza.
