...
### 1. példa: Több IpRules eltávolítása AZ IPAddressOrRange protokollt
```
...
Ez a parancs eltávolít több IPRules ipAddressOrRange-val.
...
Ez a parancs eltávolítja a VirtualNetworkRule-et VirtualNetworkRule objektumbemenettel JSON-nal.
...
Ez a parancs eltávolít több VirtualNetworkRules-t VirtualNetworkResourceID-val.
