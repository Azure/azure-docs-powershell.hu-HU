...
## LEÍRÁS
A **Revoke-AzStorageAccountUserDelegationKeys** parancsmag visszavonja egy tárfiók összes felhasználói meghatalmazási kulcsát, így a tárfiók összes Identity SAS-jogkivonatát is visszavonja.

## PÉLDÁK

### 1. példa: Tárfiók felhasználói meghatalmazási kulcsának visszavonása
```powershell
PS C:\>Revoke-AzStorageAccountUserDelegationKeys -ResourceGroupName "myresourcegroup" -AccountName "mystorageaccount"
```

Ez a példa visszavonja egy tárfiók felhasználói meghatalmazási kulcsait, így a felhasználói meghatalmazási kulcsokból generált összes identity SAS-jogkivonat is vissza lesz vonva.
...
### -PassThru
Ez a parancsmag általában nem ad vissza kimenetet a sikeres befejezéskor, ez a paraméter arra kényszeríti a parancsmagot, hogy sikeres befejezéskor értéket ($true) ad vissza.
...
### -ResourceGroupName
A tárfiók-erőforrást tartalmazó erőforráscsoport neve.
