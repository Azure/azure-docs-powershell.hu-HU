...
## LEÍRÁS
A **Set-AzStorageCORSRule** parancsmag beállítja a források közötti erőforrás-megosztási (CORS) szabályokat egy adott Típusú Azure Storage-szolgáltatáshoz.
...
Az utolsó parancs hozzárendeli a $CorsRules Blob szolgáltatástípushoz.
