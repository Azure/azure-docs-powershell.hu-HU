...
### 3. példa: Töltsön fel egy helyi fájlt egy Azure-fájlba, és tartsa meg a helyi SMB-tulajdonságokat (Fájl-hozzárendelések, Fájl létrehozási idő, Fájl legutóbbi írási ideje) az Azure-fájlban.
```
...
Ha olyan fájlt ad meg, amely már létezik, és nem adja meg az Kényszerítve _értéket,_ ez a parancsmag nem módosítja, és hibát ad vissza.
