...
## LEÍRÁS
Az **Update-AzStorageFileServiceProperty** parancsmag módosítja az Azure Storage File szolgáltatás szolgáltatás tulajdonságait.

## PÉLDÁK

### 1. példa: A fájlmegosztás softdelete engedélyezése
```powershell
...
Ez a parancs lehetővé teszi a fájlmegosztás softdelete törlését 5 adatmegőrzési napokkal
...
Engedélyezze a tárfiók adatmegőrzési házirend megosztását úgy, hogy $true, letiltja a megosztási adatmegőrzési házirendet úgy, hogy $false.
...
### -ResourceId
Adja meg a tárfiók erőforrás-azonosítóját vagy egy fájlszolgáltatás erőforrás-azonosítóját.
...
### -ShareRetentionDays
Beállítja a megosztás DeleteRetentionPolicy adatmegőrzési napjainak számát.
Ezt az értéket csak akkor kell beállítani, ha engedélyezi a megosztási adatmegőrzési házirendet.
