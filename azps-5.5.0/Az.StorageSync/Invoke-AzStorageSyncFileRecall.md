...
## LEÍRÁS
Ha egy kiszolgálói végponton (egy regisztrált kiszolgálón egy adott helyen) engedélyezve van a felhőszintű rétegezés, ezzel a paranccsal visszahívhatja az összes réteges fájlt a helyi lemezre. A visszahívás megkezdése előtt erősen ajánlott letiltani a felhőréteget ezen a kiszolgálói végponton. Ha a rétegezés továbbra is be van va, a visszahívás más fájlok rétegezéséhez vezethet, amelyek nem érjék el a kívánt célokat a helyi lemezen lévő összes tartalom eléréséhez.
...
Ez a parancs rekurzív módon visszahívja a megadott kiszolgáló végpontjának gyökér elérési útja alatt található összes réteges fájlt.
...
### -RecallPath
Visszahívási útvonal, amelyet vissza kell visszahívni.
