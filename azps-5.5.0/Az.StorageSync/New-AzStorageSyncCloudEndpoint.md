...
## LEÍRÁS
Ez a parancs egy Azure File Sync felhőbeli végpontot hoz létre. A felhőbeli végpont egy meglévő Azure-fájlmegosztásra való hivatkozás. A fájlmegosztást képviseli, és meghatározza, hogy részt vesz a felhőbeli végpont által létrehozott szinkronizálási csoport összes fájlrészének szinkronizálásában.
...
A felhőbeli végpont a szinkronizálási csoport szerves tagja, ez egy példa arra, hogy létrehoz egy "mySyncGroupName" nevű meglévő szinkronizálási csoporton belül egyet.
...
### -AzureFileShareName
Tárfiók megosztási neve (Azure-fájlmegosztás neve)
...
### -Name
A felhőbeli végpont neve. Amikor az Azure Portalon keresztül jön létre, a Név az Azure-fájl megosztási hivatkozásának nevére van beállítva.
...
Tárfiók bérlőazonosítója (vállalati címtárazonosító)
