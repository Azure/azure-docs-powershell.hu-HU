...
## LEÍRÁS
A kiszolgálóvégpont eltávolítása ártalmas művelet. Ez a kiszolgálóhely leállítja a szinkronizálást. Ez a művelet nem végezhető el a szinkronizálási problémák megoldásához. Ha ezt a kiszolgálói helyet (incl. it's files) ismét hozzáadja ugyan ahhoz a szinkronizálási csoporthoz, mint egy kiszolgálói végpontot, az ütközési fájlokhoz és más nem szándékolt következményekhez vezethet. Ez a parancs csak leszerelésre szolgál.
...
### -InputObject
ServerEndpoint Input Object, amely általában áthalad a folyamaton.
