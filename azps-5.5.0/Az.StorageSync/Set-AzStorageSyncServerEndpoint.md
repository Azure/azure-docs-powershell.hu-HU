...
## LEÍRÁS
Ez a parancs lehetővé teszi a kiszolgáló végpontjának módosítható paramétereinek módosításait. A felhőréteg-ezés és a felhőszintű rétegezésre vonatkozó házirendek például bármikor módosíthatók. A kiszolgálói végpont számos aspektusa, például a helyi elérési út, nem módosítható a kiszolgáló végpontjának létrehozása után.
...
Ez a példa két műveletet hajt végre, egy új felhőszintű rétegezés házirendet állít be a megadott kiszolgálói végponton, amely arra irányítja a kiszolgálót, hogy az összes olyan fájlt rétegesítse, amelyekhez az elmúlt 30 napban nem fértek hozzá, valamint letiltja az offline adatátviteli módot is, amelyet eredetileg ezen a kiszolgálói végponton engedélyeztek a létrehozása során. Az offline adatátvitel a tömeges áttelepítési szolgáltatásokkal, például az Azure Data Box-zal való együttműködés részeként használatos.
