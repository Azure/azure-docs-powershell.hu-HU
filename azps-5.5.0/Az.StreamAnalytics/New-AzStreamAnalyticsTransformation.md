...
Ez a parancs létrehoz egy StreamingTransform nevű átalakítást a Streaming Streaming Streaming nevű feladatban.
...
### -File
Egy JSON-fájl elérési útját adja meg, amely tartalmazza a létrehozni kívánt Azure Stream Analytics-átalakítás JSON-ábrázolását.
