...
# Az.Synapse modul
## Leírás
A szakasz témakörei az Azure PowerShell Azure Synapse Analytics szolgáltatáshoz kapcsolódó parancsmagját dokumentálják.

## Az.Synapse parancsmagok
...
Letiltja a speciális adatbiztonságot a munkaterületeken.

### [Disable-AzSynapseSqlPoolSensitivityRecommendation](Disable-AzSynapseSqlPoolSensitivityRecommendation.md)
Letiltja (mellőzi) a bizalmasságra vonatkozó javaslatokat az SQL-készlet oszlopainál.
...
Engedélyezi a bizalmasságra vonatkozó javaslatokat az oszlopokon (a javaslatok alapértelmezés szerint minden oszlopban engedélyezve vannak) az SQL-készletben.

### [Export-AzSynapseNotebook](Export-AzSynapseNotebook.md)
Notbooks exportálása.

### [Get-AzSynapseActivityRun](Get-AzSynapseActivityRun.md)
Információkat kap a folyamatok futtatásához futtatott tevékenységekről.

### [Get-AzSynapseDataFlow](Get-AzSynapseDataFlow.md)
Információkat kap a munkaterületen folyó adatfolyamról.

### [Get-AzSynapseDataset](Get-AzSynapseDataset.md)
Információkat kap a munkaterületen található adatkészletekkel kapcsolatban.
...
Információkat kap az integrációs futásidejű erőforrásokról.
...
Az integrációs futásidejű metrikus adatokat kapja. 

### [Get-AzSynapseIntegrationRuntimeNode](Get-AzSynapseIntegrationRuntimeNode.md)
Integrációs futásidejű csomópontadatokat kap.

### [Get-AzSynapseLinkedService](Get-AzSynapseLinkedService.md)
Információkat kap a munkaterületen található csatolt szolgáltatásokról.
...
Információkat kap a munkaterületen található prognózisról.

### [Get-AzSynapsePipelineRun](Get-AzSynapsePipelineRun.md)
Információkat kap a folyamat futásának folyamatról.

### [Get-AzSynapseRoleAssignment](Get-AzSynapseRoleAssignment.md)
Synapse Analytics-szerepkör-hozzárendelést kap.

### [Get-AzSynapseRoleDefinition](Get-AzSynapseRoleDefinition.md)
Synapse Analytics szerepkördefiníciót kap.

### [Get-AzSynapseSparkJob](Get-AzSynapseSparkJob.md)
Synapse Analytics Spark-feladatot kap.

### [Get-AzSynapseSparkPool](Get-AzSynapseSparkPool.md)
Egy Synapse Analytics spark-készletet kap.
...
Synapse Analytics Spark utasítást kap.
...
A munkaterület speciális adatbiztonsági házirendet kap.

### [Get-AzSynapseSqlAdvancedThreatProtectionSetting](Get-AzSynapseSqlAdvancedThreatProtectionSetting.md)
A munkaterület komplex veszélyforrások elleni védelmi beállításainak megadása.

### [Get-AzSynapseSqlAuditSetting](Get-AzSynapseSqlAuditSetting.md)
Az Azure Synapse Analytics Workspace naplózási beállításait használja.

### [Get-AzSynapseSqlDatabase](Get-AzSynapseSqlDatabase.md)
Ez a funkció csak korlátozott előzetes verzióban érhető el, kezdetben csak bizonyos előfizetések számára. Synapse Analytics SQL-adatbázist kap.

### [Get-AzSynapseSqlPool](Get-AzSynapseSqlPool.md)
Synapse Analytics SQL-készletet kap.
...
Egy Azure Synapse Analytics SQL-készlet naplózási beállításait kapja meg.

### [Get-AzSynapseSqlPoolRestorePoint](Get-AzSynapseSqlPoolRestorePoint.md)
Beolvassa a különálló visszaállítási pontokat, amelyekből a Synapse Analytics SQL-készlet visszaállítható.
...
Az SQL-készlet oszlopainak ajánlott adattípusait és bizalmasság-címkéit kapja meg.

### [Get-AzSynapseSqlPoolTransparentDataEncryption](Get-AzSynapseSqlPoolTransparentDataEncryption.md)
Egy SQL-készlet TDE-állapotát kapja meg.
...
Egy SQL-készlet biztonsági résértékelési beállításait kapja meg.

### [Get-AzSynapseSqlVulnerabilityAssessmentSetting](Get-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Beveszi egy munkaterület biztonsági felmérési beállításait.
...
Az eseményindító előfizetésének állapotának lekérte a megadott külső szolgáltatási eseményekre.

### [Get-AzSynapseWorkspace](Get-AzSynapseWorkspace.md)
Synapse Analytics munkaterületet kap.

### [Invoke-AzSynapseIntegrationRuntimeUpgrade](Invoke-AzSynapseIntegrationRuntimeUpgrade.md)
Frissíti az önkiszolgáló integrációs futásiidőt.
...
Létrehozza a Synapse Analytics tűzfalszabályt.

### [New-AzSynapseIntegrationRuntimeKey](New-AzSynapseIntegrationRuntimeKey.md)
Az önkiszolgáló integráció futásidejű kulcsának újragenerálása.
...
Egy Synapse Analytics spark-készletet hoz létre.

### [New-AzSynapseSqlDatabase](New-AzSynapseSqlDatabase.md)
Ez a funkció csak korlátozott előzetes verzióban érhető el, kezdetben csak bizonyos előfizetések számára. Synapse Analytics SQL-adatbázist hoz létre.

### [New-AzSynapseSqlPool](New-AzSynapseSqlPool.md)
Létrehoz egy Synapse Analytics SQL-készletet.

### [New-AzSynapseSqlPoolRestorePoint](New-AzSynapseSqlPoolRestorePoint.md)
Új visszaállítási pontot hoz létre egy Azure Synapse Analytics SQL-készletben.

### [New-AzSynapseWorkspace](New-AzSynapseWorkspace.md)
Létrehozza a Synapse Analytics munkaterületet.

### [Remove-AzSynapseDataFlow](Remove-AzSynapseDataFlow.md)
Eltávolítja az adatfolyamot a munkaterületről.

### [Remove-AzSynapseDataset](Remove-AzSynapseDataset.md)
Eltávolít egy adatkészletet a munkaterületről.

### [Remove-AzSynapseFirewallRule](Remove-AzSynapseFirewallRule.md)
Törli a Synapse Analytics tűzfalszabályt.
...
Eltávolíthat egy adott nevű csomópontot egy integrációs futási időben.

### [Remove-AzSynapseLinkedService](Remove-AzSynapseLinkedService.md)
Eltávolít egy csatolt szolgáltatást a munkaterületről.

### [Remove-AzSynapseNotebook](Remove-AzSynapseNotebook.md)
Eltávolít egy jegyzetfüzetet egy munkaterületről.

### [Remove-AzSynapsePipeline](Remove-AzSynapsePipeline.md)
Eltávolít egy prognózist a munkaterületről.

### [Remove-AzSynapseRoleAssignment](Remove-AzSynapseRoleAssignment.md)
A Synapse Analytics szerepkör-hozzárendelésének törlése.

### [Remove-AzSynapseSparkPool](Remove-AzSynapseSparkPool.md)
Egy Synapse Analytics spark-készlet törlése.
...
Ez a funkció csak korlátozott előzetes verzióban érhető el, kezdetben csak bizonyos előfizetések számára. Egy Synapse Analytics SQL-adatbázis törlése.

### [Remove-AzSynapseSqlPool](Remove-AzSynapseSqlPool.md)
Töröl egy Synapse Analytics SQL-készletet.
...
Eltávolítja az SQL-készlet oszlopainak adattípusait és bizalmasság-címkéit.

### [Remove-AzSynapseTrigger](Remove-AzSynapseTrigger.md)
Eltávolít egy eseményindítót egy munkaterületről.

### [Remove-AzSynapseTriggerSubscription](Remove-AzSynapseTriggerSubscription.md)
Leiratkozhat az eseményindítóról a külső szolgáltatás eseményeiről.

### [Remove-AzSynapseWorkspace](Remove-AzSynapseWorkspace.md)
A Synapse Analytics munkaterületének törlése.
...
Eltávolítja a komplex veszélyforrások elleni védelem speciális beállításait egy munkaterületről.

### [Reset-AzSynapseSqlAuditSetting](Reset-AzSynapseSqlAuditSetting.md)
Eltávolítja az Azure Synapse Analytics Workspace naplózási beállításait.
...
Létrehoz egy prognózist a munkaterületen.

### [Set-AzSynapseSqlActiveDirectoryAdministrator](Set-AzSynapseSqlActiveDirectoryAdministrator.md)
Azure AD-rendszergazdát biztosít a Synapse Analytics SQL-készlethez.

### [Set-AzSynapseSqlAuditSetting](Set-AzSynapseSqlAuditSetting.md)
Egy Azure Synapse Analytics Workspace naplózási beállításait módosítja.

### [Set-AzSynapseSqlPoolAuditSetting](Set-AzSynapseSqlPoolAuditSetting.md)
Egy Azure Synapse Analytics SQL-készlet naplózási beállításait módosítja.

### [Set-AzSynapseSqlPoolSensitivityClassification](Set-AzSynapseSqlPoolSensitivityClassification.md)
Beállítja az SQL-készlet oszlopainak adattípusait és bizalmasság-címkéit.

### [Set-AzSynapseSqlPoolTransparentDataEncryption](Set-AzSynapseSqlPoolTransparentDataEncryption.md)
Módosítja egy SQL-készlet TDE tulajdonságát.

### [Set-AzSynapseSqlPoolVulnerabilityAssesssmentRuleBaseline](Set-AzSynapseSqlPoolVulnerabilityAssessmentRuleBaseline.md)
Beállítja a biztonsági rés felmérésére vonatkozó szabály alapértékét.

### [Set-AzSynapseTrigger](Set-AzSynapseTrigger.md)
Létrehoz egy eseményindítót egy munkaterületen.

### [Start-AzSynapseSparkSession](Start-AzSynapseSparkSession.md)
Synapse Analytics Spark munkamenetet kezd.

### [Start-AzSynapseTrigger](Start-AzSynapseTrigger.md)
Elindít egy eseményindítót egy munkaterületen.

### [Stop-AzSynapsePipelineRun](Stop-AzSynapsePipelineRun.md)
Leállítja a munkaterületen futó prognózist.

### [Stop-AzSynapseSpark Áll](Stop-AzSynapseSparkJob.md)
Megszakítja a Synapse Analytics Spark-feladatot.

### [Stop-AzSynapseSparkSession](Stop-AzSynapseSparkSession.md)
Leállítja a Synapse Analytics Spark munkamenetet.

### [Stop-AzSynapseSparkStatement](Stop-AzSynapseSparkStatement.md)
Visszavonja a Synapse Analytics Spark utasítást.
...
Synapse Analytics Spark-feladatot küld.

### [Suspend-AzSynapseSqlPool](Suspend-AzSynapseSqlPool.md)
Felfüggeszti a Synapse Analytics SQL-készletet.
...
Ez a funkció csak korlátozott előzetes verzióban érhető el, kezdetben csak bizonyos előfizetések számára. Ellenőrzi, hogy létezik-e Synapse Analytics SQL-adatbázis.

### [Test-AzSynapseSqlPool](Test-AzSynapseSqlPool.md)
Ellenőrzi, hogy létezik-e Synapse Analytics SQL-készlet.

### [Test-AzSynapseWorkspace](Test-AzSynapseWorkspace.md)
Ellenőrzi, hogy létezik-e Synapse Analytics-munkaterület.

### [Update-AzSynapseFirewallRule](Update-AzSynapseFirewallRule.md)
Frissíti a Synapse Analytics tűzfalszabályt.
...
Frissíti az önkiszolgáló integrációs futásidejű csomópontot.
...
Ez a funkció csak korlátozott előzetes verzióban érhető el, kezdetben csak bizonyos előfizetések számára. Frissíti a Synapse Analytics SQL-adatbázist.

### [Update-AzSynapseSqlPool](Update-AzSynapseSqlPool.md)
Frissíti a Synapse Analytics SQL-készletet.
...
Frissíti az SQL-készlet biztonsági résértékelési beállításait.

### [Update-AzSynapseSqlVulnerabilityAssessmentSetting](Update-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Frissíti a munkaterületek biztonsági résértékelési beállításait.
