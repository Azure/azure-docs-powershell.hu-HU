...
## LEÍRÁS
A Disable-AzSynapseSqlPoolSensitivityRecommendation parancsmag letiltja (mellőzi) a bizalmasságra vonatkozó javaslatokat az SQL-készlet oszlopainál.

## PÉLDÁK

### 1. példa: Tartalomra vonatkozó javaslatok letiltása egy Azure Synapse SQL-készlet adott oszlopában.
```powershell
...
### 2. példa: Tiltsa le a bizalmasság-javaslatokat olyan oszlopokban, amelyek bizalmasságra vonatkozó javaslatokat tartalmaznak egy Azure Synapse SQL-készletben a Piping használatával.
```powershell
...
### 3. példa: Tiltsa le a bizalmasság-javaslatokat egy Azure Synapse SQL-készlet adott oszlopában a Piping használatával.
```powershell
...
### -InputObject
Egy SQL-készlet bizalmasság-besorolását képviselő objektum.
