...
## LEÍRÁS
A Enable-AzSynapseSqlPoolSensitivityRecommendation parancsmag bizalmasságra vonatkozó javaslatokat tesz az SQL-készlet oszlopainál.

## PÉLDÁK

### 1. példa: Bizalmasság-javaslatok engedélyezése egy Azure Synapse SQL-készlet adott oszlopában.
```powershell
...
### 2. példa: Bizalmasság-javaslatok engedélyezése egy adott oszlopban az Azure Synapse SQL-készlethez a Piping használatával.
```powershell
...
### -SqlPoolObject
SQL-készlet bemeneti objektuma, amely általában áthalad a folyamaton.
