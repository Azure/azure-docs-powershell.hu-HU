...
## LEÍRÁS
A **Get-AzSynapsePipelineRun parancs** információkat ad vissza a megadott folyamat futási adatairól. Ha a PipelineRunId érték meg van adva, akkor az adott azonosítóval futtatott futtatás részleteit jeleníti meg. Ha a PipelineRunId nincs megadva, akkor a RunStartedAfter és a RunStartedBefore érték között lefutó folyamatok összes futásának adatait jeleníti meg.
