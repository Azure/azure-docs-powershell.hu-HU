...
## LEÍRÁS
A **Get-AzSynapseSqlActiveDirectoryAdministrator** parancsmag információt kap az aktuális előfizetés azure synapse Analytics Workspace szolgáltatásának Azure Active Directory (Azure AD) rendszergazdáiról.
