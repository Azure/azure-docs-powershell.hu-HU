...
## LEÍRÁS
A **Get-AzSynapseSqlPool** parancsmag információkat kap az Azure Synapse Analytics SQL-készletről.
...
Ez a parancs az összes SQL-készletet egy munkaterület alá kapja.
...
Ez a parancs a ContosoWorkspace munkaterület alatti SQL-készletet kapja ContosoSqlPool néven.
...
Ez a parancs az összes SQL-készletet egy munkaterület alatt, folyamaton keresztül kapja meg.
...
Ez a parancs a megadott erőforrás-azonosítójú SQL-készletet kapja meg.
...
### -Verzió
[Ez a funkció korlátozott előzetes verzióban érhető el, kezdetben csak bizonyos előfizetések számára érhető el.] A Synapse SQL-készlet verziója. Például 2 vagy 3.
