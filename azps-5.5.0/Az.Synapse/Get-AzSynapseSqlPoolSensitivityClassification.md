...
### 2. példa: A Pipinget futtató Azure Synapse SQL-készlet aktuális adattípusának és bizalmasság-címkéinek be szereznie.
```powershell
...
### 4. példa: Az Azure Synapse SQL-készlet adott oszlopának aktuális adattípus- és bizalmasság-címkéje a Piping használatával.
```powershell
