...
## LEÍRÁS
A Get-AzSynapseSqlPoolSensitivityRecommendation parancsmag az SQL-készlet oszlopainak ajánlott adattípusait és bizalmasság-címkéit adja vissza.

## PÉLDÁK

### 1. példa: Az Azure Synapse SQL-készlet ajánlott adattípusai és bizalmasság-címkéinek lekértése.
```powershell
...
### 2. példa: A Piping használatával az Azure Synapse SQL-készlet ajánlott adattípusai és bizalmasság-címkéinek lekérte.
```powershell
