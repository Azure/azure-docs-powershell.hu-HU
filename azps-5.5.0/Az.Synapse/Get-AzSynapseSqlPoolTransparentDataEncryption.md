...
## LEÍRÁS
A **Get-AzSynapseSqlPoolTransparentDataEncryption** parancsmag az Átlátszó adattitkosítás (TDE) állapotát kapja egy Azure Synapse Analytics SQL-készlethez.
...
Ez a parancs a ContosoSqlPool nevű SQL-készlet TDE-állapotát kapja a ContosoWorkspace nevű munkaterület alatt.
