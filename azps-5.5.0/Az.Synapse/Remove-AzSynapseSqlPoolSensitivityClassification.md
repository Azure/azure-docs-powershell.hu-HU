...
## LEÍRÁS
A Remove-AzSynapseSqlPoolSensitivityClassification parancsmag eltávolítja az SQL-készlet oszlopainak adattípusait és bizalmasság-címkéit.

## PÉLDÁK

### 1. példa: Távolítsa el egy Azure Synapse SQL-készlet oszlopának adattípusát és bizalmasság-címkéjét.
```powershell
...
### 2. példa: Az Azure Synapse SQL-készlet oszlopainak aktuális adattípusait és bizalmasság-címkéit a Piping használatával távolíthatja el.
```powershell
...
### 3. példa: Távolítsa el egy Azure Synapse SQL-készlet oszlopának adattípusát és bizalmasság-címkéjét a Piping használatával.
```powershell
