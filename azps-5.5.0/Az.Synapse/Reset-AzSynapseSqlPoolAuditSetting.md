...
## LEÍRÁS
A **Reset-AzSynapseSqlPoolAuditSetting** parancsmag eltávolítja az Azure Synapse Analytics SQL-készlet naplózási beállításait.
...
Ez a parancs eltávolítja a ContosoSqlPool nevű SQL-készlet naplózási beállításait a ContosoWorkspace munkaterületről.
