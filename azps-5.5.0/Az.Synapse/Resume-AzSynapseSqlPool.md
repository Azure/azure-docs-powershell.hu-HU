...
### ResumeByNameParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **Resume-AzSynapseSqlPool** parancsmag egy Azure Synapse Analytics SQL-készletet folytat.
...
Ez a parancs egy felfüggesztett Azure Synapse Analytics SQL-készletet folytat.
