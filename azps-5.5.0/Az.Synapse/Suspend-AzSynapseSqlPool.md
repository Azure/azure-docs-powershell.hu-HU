...
### SuspendByNameParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **Suspend-AzSynapseSqlPool** parancsmag felfüggeszti az Azure Synapse Analytics SQL-készletet.
...
Ez a parancs felfüggeszti az aktív Azure Synapse Analytics SQL-készletet.
