...
### 1. példa: Idősorok elemzési környezetének lekérte
```powershell
...
Ez a parancs idősorozat-elemzési környezetet kap.

### 2. példa: Az összes idősorozat-elemzési környezet felsorolása
```powershell
...
Ez a parancs felsorolja egy erőforráscsoport összes idősorozat-elemzési környezetét.

### 3. példa: Idősorok elemzési környezetének lekérte objektumról objektumra
```powershell
...
Ez a parancs idősorozat-elemzési környezeteket kap.
...
### -Kibontás
A $expand=állapot beállításának része lesz a környezet belső szolgáltatásainak állapota az Idősor insights szolgáltatásban.
