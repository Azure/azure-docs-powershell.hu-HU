...
### 1. példa: A Generációs1 idősorozatok elemzési környezetének frissítése
```powershell
...
Ez a parancs frissíti a Gen1 idősorok elemzési környezetét.

### 2. példa: A Gen1 idősorok elemzési környezetének frissítése
```powershell
...
### -Tag
A környezet további tulajdonságainak kulcsértékes párja.
