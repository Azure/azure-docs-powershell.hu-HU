...
### 1. példa: Privát felhő létrehozása
```powershell
...
Privát felhő létrehozása

## PARAMETERS

### -AcceptEULA
Az AVS-rel kapcsolatos eula-k elfogadása, a jogi kifejezés előugró ablakként jelenik meg a paraméter megadása nélkül
...
### -NetworkBlock
A címblokknak egyedinek kell lennie az előfizetés VNet-hálózatában, valamint a webhelyen is.
Győződjön meg arról, hogy a CIDR formátum megfelel az (A.B.C.D/X) formátumnak, ahol az A,B,C,D 0 és 255 közötti, az X pedig 0 és 22 között van
...
### -NsxtPassword
Szükség esetén állítsa be az NSX-T Manager jelszavát a privát felhő létrehozásakor
...
### -VcenterPassword
Szükség esetén állítsa be a vCenter rendszergazdai jelszavát a privát felhő létrehozásakor
