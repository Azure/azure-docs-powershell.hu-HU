...
### 1. példa: AzADDomain törlése ResourceGroupName és Name szerint
```powershell
PS C:\> Remove-AzADDomainService -ResourceGroupName $env.ResourceGroupName -Name $env.ADdomainName

```

Az AzADDomain törlése ResourceGroupName és Name szerint

### 2. példa: AzADDomain törlése az InputObject által
```powershell
...
Az AzADDomain törlése inputObject szerint
