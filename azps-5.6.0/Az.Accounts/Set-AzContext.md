...
## LEÍRÁS
A Set-AzContext parancsmag beállítja az aktuális munkamenetben futtatott parancsmagok hitelesítési adatait.
A környezet bérlői, előfizetési és környezeti információkat tartalmaz.

## PÉLDÁK

### 1. példa: Az előfizetés környezetének beállítása
```
...
Ez a parancs beállítja a környezetét a megadott előfizetés használatára.

## PARAMETERS

### -Környezet
Az aktuális munkamenet környezetét határozza meg.
...
### -ExtendedProperty
További környezettulajdonságok
...
### -Force
Ha van ilyen, felülírja a meglévő környezetét ugyanazokkal a névvel.
...
### -Előfizetés
Annak az előfizetésnek a neve vagy azonosítója, amelybe a kontextust be kell állítani. Ez a paraméter -SubscriptionName és -SubscriptionId aliasokkal rendelkezik, így az átláthatóság érdekében ezek bármelyike használható a -Subscription helyett a név és az azonosító megadásakor.
