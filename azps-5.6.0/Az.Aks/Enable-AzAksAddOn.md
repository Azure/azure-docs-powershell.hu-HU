...
Engedélyezze a `HttpApplicationRouting` `Monitoring` bővítményeket, `AzurePolicy` a , és a `VirtualNode` `KubeDashboard` ékeket.
...
### -SubnetName
A VirtualNode alhálózatának neve.
...
### -WorkspaceResourceId
A figyelési munkaterület erőforrás-azonosítója.
