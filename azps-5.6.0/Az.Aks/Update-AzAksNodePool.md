...
### A minimunszám módosítása 5-re a megadott csomópontkészlethez
```powershell
...
### -Force
Csomópontkészlet frissítése kérdés nélkül
...
### -Id
A felügyelt Kubanetes-fürtben található csomópontkészlet azonosítója
...
### -InputObject
EGY PSAgentPool-objektum, amely általában a folyamaton keresztül megy keresztül.
