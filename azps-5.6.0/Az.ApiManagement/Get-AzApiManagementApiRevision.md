...
## LEÍRÁS
A **Get-AzApiManagementApiRevision** parancsmag az API összes változatának részleteit tartalmazza

## PÉLDÁK

### 1. példa: Az API összes API-változatának lekérte
```powershell
...
Ez a parancs a megadott API api-nak az adott ApiManagement környezetben való összes api-változatát lejátszja.

## PARAMETERS

### -ApiId
Azok az API-azonosítók, amelyeknek a korrektúraszámát fel szeretnénk sorolni.
