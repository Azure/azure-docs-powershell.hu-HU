...
Ez a parancs egy prémiumszintű API-kezelési szolgáltatást hoz létre egy Azure virtuális hálózati alhálózatban, amelynek belső átjáró végpontja van egy fő régióval az Egyesült Államok nyugati részén.
...
Ez a parancs létrehoz egy normál termékváltozat api-kezelési szolgáltatást, és engedélyezi a TLS 1.0-t az Előlapi ügyfélprogramban az ApiManagement Átjáró és a Backend ügyfélprogram között az ApiManagement átjáró és a Backend között.
