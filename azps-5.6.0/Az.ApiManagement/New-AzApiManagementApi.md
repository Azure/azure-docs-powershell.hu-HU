...
Ez a parancs létrehoz egy API-t az ApiVersionSet-ban, és a forrás Api-ból az összes műveletet, címkét és házirendet `echoapiv3` `xmsVersionSet` `echo-api` átmásolja. Felülbírálja a SubscriptionRequired, ServiceUrl, Path, Protocols
