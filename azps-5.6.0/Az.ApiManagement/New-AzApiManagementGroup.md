...
### -Type
Csoport típusa. Az egyéni csoport a Felhasználó által definiált csoport. A rendszercsoport rendszergazdákat, fejlesztőket és vendégeket tartalmaz. Rendszercsoport nem hozható létre és nem frissíthető.  A külső csoport külső identitásszolgáltatótól (például Azure Active Directory) származó csoportok. Ez a paraméter nem kötelező, és alapértelmezés szerint egyéni csoportként van megadva.
