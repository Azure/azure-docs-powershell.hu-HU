...
## LEÍRÁS
A **New-AzApiManagementUserToken** parancsmag megosztott hozzáférési jogkivonatot hoz létre egy adott felhasználóhoz.

## PÉLDÁK

### 1. példa: Megosztott hozzáférési jogkivonat létrehozása Git-felhasználónak
```powershell
...
Ez a parancsfájl beállítja a Git-felhasználót az ApiManagement szolgáltatásban, és létrehoz egy megosztott hozzáférési jogkivonatot az elsődleges kulcs használatával, amely 8 óráig érvényes.

### 2. példa

Megosztott hozzáférési jogkivonatot hoz létre a felhasználónak. (automatikusan generált)
...
### -Expiry
A jogkivonat lejárata.
Ha nincs megadva, a token 8 óra után lejár.
...
### -KeyType
A token generálásakor használható felhasználói kulcs.
Ez a paraméter nem kötelező.
