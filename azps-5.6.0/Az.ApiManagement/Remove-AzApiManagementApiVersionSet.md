...
A **Remove-AzAzureRmApiManagementApiVersionSet** parancsmag eltávolít egy meglévő API-verziókészletet.

## PÉLDÁK

### 1. példa: API-verziókészlet eltávolítása
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiVersionSet -Context $apimContext -ApiVersionSetId "query-param-set"
```

Ez a parancs eltávolítja az API-verziókészletet a megadott ApiVersionSetId értékekkel.

## PARAMETERS

### -ApiVersionSetId
Az API-verziókészlet azonosítója.
...
### -ResourceId
Arm ResourceId of ApiVersionSet. Ezt a paramétert kötelező megadni.
