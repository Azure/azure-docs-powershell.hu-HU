...
## LEÍRÁS
A **Remove-AzApiManagementGateway** parancsmag leválasztja az API-t az átjáróról.

## PÉLDÁK

### 1. példa: Meglévő átjáró eltávolítása
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementGateway -Context $apimContext -GatewayId "g0001" -Force
```

Ez a parancs eltávolít egy meglévő átjárót, és nem kér megerősítést a felhasználótól.
