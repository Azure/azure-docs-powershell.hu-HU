...
## LEÍRÁS
A **Set-AzApiManagementApi** parancsmag módosítja az Azure API Felügyeleti API-t.

## PÉLDÁK

### 1. példa: API módosítása
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementApi -Context $ApiMgmtContext -Name "EchoApi" -ServiceUrl "https://contoso.com/apis/echo" -Protocols @('https') -Description "Responds with what was sent" -Path "echo"
```

### 2. példa: API hozzáadása meglévő ApiVersionSethez
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Ez a példa hozzáad egy API-t egy meglévő API-verziókészlethez

### 3. példa: A Backend ServiceUrl módosítása arra a pontra, ahová az API mutat
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Ebben a példában az a ServiceUrl `echo-api` frissül, amelyre mutat.

## PARAMETERS

### -ApiId
A módosítani szükséges API azonosítója.
...
Az OAuth engedélyezési kiszolgáló azonosítóját adja meg.
Az alapértelmezett érték $Null.
...
### -Path
Megadja a webes API elérési útját, amely az API nyilvános URL-címének utolsó része.
...
psdx_paramvalues http és https.
...
Az előfizetés kulcslekérdezés karakterlánc paraméterének nevét adja meg.
Az alapértelmezett érték $Null.
