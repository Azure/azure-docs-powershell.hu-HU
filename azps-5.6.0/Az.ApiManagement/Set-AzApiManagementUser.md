...
## LEÍRÁS
A **Set-AzApiManagementUser** parancsmag beállítja a felhasználói adatokat.

## PÉLDÁK

### 1. példa: Felhasználó jelszavának, e-mail címének és állapotának módosítása
```powershell
...
Ez a parancs új felhasználói jelszót és e-mail-címet állít be, és letiltja a felhasználót.

### 2. példa

Beállítja a felhasználói adatokat. (automatikusan generált)
...
Ez a paraméter nem kötelező.
Az alapértelmezett érték az Aktív.
