...
### 1. példa: Folyamatos exportálás alkalmazáselemzési erőforráshoz
```
...
Alkalmazásstatikációk folyamatos exportálási konfigurációja a "teszt" nevű erőforráshoz a "tesztcsoport" erőforráscsoportban

### 2. példa: Folyamatos exportálás alkalmazáselemzési erőforráshoz
```
...
Az "ZJrfffySPdtG3ESn3iRxVIEFuNY=" exportazonosítóval folyamatos exportálási konfigurációt kaphat az "teszt" nevű erőforráshoz a "tesztcsoport" erőforráscsoportban
