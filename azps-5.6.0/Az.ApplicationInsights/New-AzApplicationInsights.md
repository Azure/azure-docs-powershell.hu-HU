...
### 1. példa: Új alkalmazásstatstatórata-erőforrás létrehozása
```
...
"java" típusú erőforráscsoport "teszt" nevű új alkalmazáselemzési erőforrás hozzáadása
...
### -Location
Application Insights erőforrás helye.
...
Az Application Insights-adatokhoz való hozzáférés hálózati hozzáférési típusa. Az értéknek "Engedélyezve" vagy "Letiltva" értékűnek kell lennie.
...
Az Application Insights lekérdezés eléréséhez használható hálózati hozzáférés típusa. Az értéknek "Engedélyezve" vagy "Letiltva" értékűnek kell lennie.
