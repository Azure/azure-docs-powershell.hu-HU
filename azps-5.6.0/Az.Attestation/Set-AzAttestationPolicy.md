...
## LEÍRÁS
A Set-AzAttestationPolicy parancsmag beállítja a házirendet egy bérlőtől az Azure Attestation szolgáltatásban.
...
Szöveges házirendformátumban (alapértelmezett) beállítja a felhasználó által definiált házirendet az *SgxEnclave* for Attestation Provider *pshtest* szolgáltatóhoz.
...
Egy JWT-házirendformátumot használva beállítja a felhasználó által definiált házirendet az *SgxEnclave* for Attestation Provider *pshtest* szolgáltatóhoz.
...
### -Name
Megadja a bérlő nevét.
Ez a parancsmag beállítja a paraméterként megadott bérlői webhelyre vonatkozó attestation házirendet.
...
### -Házirend
A beállított házirenddokumentumot adja meg.  A házirend formátuma szöveg vagy JSON webtoken (JWT) lehet.
...
### -PolicyFormat
A házirend formátumát (Szöveg vagy JWT (JSON Web Token) adja meg.  Az alapértelmezett házirendformátum a Szöveg.
...
### -Tee
A megbízható végrehajtási környezet típusát határozza meg.
Négyféle környezet támogatott: SgxEnclave, OpenEnclave, CyResComponent és VBSEnclave.
