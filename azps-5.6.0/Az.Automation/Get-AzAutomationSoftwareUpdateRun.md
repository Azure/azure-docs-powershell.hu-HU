...
## SYNOPSIS
Lejátsssa az Azure Automation szoftverfrissítések listáját.
...
## LEÍRÁS
A Get-AzAutomationSoftwareUpdateRun parancsmag visszaadja a futtatott szoftverfrissítések listáját. Mivel a szoftverfrissítések konfigurációja társított ütemezést tartalmaz, többször is elindítható. Minden alkalommal, amikor egy ütemezés aktiválódik, egy frissítési futtatás jön létre. A frissítési futtatás az összes gépi futtatás eredményének összesítése. Futtathat adott szoftverfrissítés-konfigurációt a SoftwareUpdateConfigurationName paraméterrel. Egy adott futtatáshoz át kell adni a név paramétert. A listában adott állapottal is futtathat, adott operációs rendszert célozhat meg, illetve a megfelelő paraméterrel meghatározott idő után is elindíthatja a futtatásokat.

## PÉLDÁK

### 1. példa
Ez a példa felsorolja az összes frissítést, amelyet egy adott szoftverfrissítés-konfiguráció indít el.
...
### -Id
A szoftverfrissítéskonfiguráció azonosítója.
...
A futtatást a szoftverfrissítéskonfiguráció indította el.
...
A futtatást indító szoftverfrissítés-konfiguráció neve.
