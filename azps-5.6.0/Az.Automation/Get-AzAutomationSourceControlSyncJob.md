...
## LEÍRÁS
A Get-AzAutomationSourceControlSyncJob parancsmag megkapja az Azure Automation forrásvezérlő szinkronizálási feladatokat. Ha egy adott forrásvezérlő szinkronizálási feladatot kap, adja meg az azonosítóját.

## PÉLDÁK

### 1. példa
Ez a parancs a VSTSNative forrásvezérlő összes automatizálási forrásvezérlő szinkronizálási feladatát megkapja.
