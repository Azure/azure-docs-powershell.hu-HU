...
## SYNOPSIS
Létrehozza az Azure Automation szoftverfrissítések konfigurációs Azure Query-objektumát.
...
## LEÍRÁS
Olyan szoftverfrissítéskonfigurációt hoz létre az Azure queries objektumhoz, amellyel szoftverfrissítéskonfiguráció hozható létre, amely ütemezés szerint fog frissülni az Azure virtuális gépek dinamikusan megoldott listájának frissítéséhez.
...
### -Location
Azure virtuális gépek helyének listája.
