...
Amikor a runbook a társított ütemezésnek megfelelő elindul, ezeket a paramétereket a program a runbooknak is továbbadja.
...
### -RunbookName
Annak a runbooknak a nevét adja meg, amelyhez a parancsmag hozzá van társítva egy ütemezéshez.
