...
## LEÍRÁS
A **Set-AzAutomationCertificate** parancsmag módosítja egy tanúsítvány konfigurációját az Azure Automationben.

## PÉLDÁK

### 1. példa: Tanúsítvány módosítása
```
...
A második parancs módosítja a ContosoCertificate nevű tanúsítványt.
...
Annak az automatizálási fióknak a nevét adja meg, amelynek a parancsmagja módosítja a tanúsítványt.
...
### -Leírás
Megadja annak a tanúsítványnak a leírását, amit ez a parancsmag módosít.
...
### -Name
A parancsmag által módosított tanúsítvány neve.
...
### -Path
A feltöltni kívánt parancsfájl elérési útját adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amelynek a parancsmagja módosítja a tanúsítványt.
