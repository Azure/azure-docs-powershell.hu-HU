...
## LEÍRÁS
A **Unregister-AzAutomationDscNode** parancsmag eltávolítja az APS kívánt államkonfigurációs (DSC) csomópontját az Azure Automation-fiók kezeléséből.

## PÉLDÁK

### 1. példa: Azure DSC-csomópont eltávolítása automatizálási fiók kezelésből
```
...
Ez a parancs eltávolítja azt a DSC-csomópontot, amely a megadott GUID azonosítóval rendelkezik a Contoso17 nevű automatizálási fiók kezelésében.

## PARAMETERS

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelyből a parancsmag eltávolít egy DSC-csomópontot.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyben a parancsmag nem regisztrál egy DSC-csomópontot.
