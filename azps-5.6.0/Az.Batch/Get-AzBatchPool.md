...
## LEÍRÁS
A **Get-AzBatchPool** parancsmag a BatchContext paraméterrel megadott Batch-fiók alatt kapja meg az *Azure Batch-kötegkészleteket.*
Az Azonosító  paramétert használva egyetlen készletet kaphat,  vagy a Szűrő paramétert használva lekértheti az OData-szűrőnek megfelelő készleteket.

## PÉLDÁK

### 1. példa: Készlet lekérte azonosító szerint
```
...
Ez a parancs a készletet a Saját várólista azonosítóval kapja meg.

### 2. példa: Az összes készlet lekérte az OData-szűrőt
```
...
Ez a parancs a Szűrő paraméter használatával bekérte a Saját kezdetú adatokat használó *készleteket.*
...
### -Filter
A készletek lekérdezéséhez használható OData-szűrő záradékot adja meg.
Ha nem ad meg szűrőt, a *BatchContext* paraméterrel megadott Batch-fiókban található összes készletet visszaadja a függvény.
