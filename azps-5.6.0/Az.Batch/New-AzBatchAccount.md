...
## LEÍRÁS
A **New-AzBatchAccount** parancsmag létrehoz egy Azure Batch-fiókot a megadott erőforráscsoporthoz és helyhez.

## PÉLDÁK

### 1. példa: Kötegfiók létrehozása
```powershell
...
Ez a parancs létrehoz egy pfuller nevű Batch-fiókot az Erőforráscsoport03 erőforráscsoport használatával az Egyesült Államok nyugati részén.

### 2. példa

Létrehoz egy Batch-fiókot. (automatikusan generált)
...
### -AccountName
A parancsmag által létrehozott Batch-fiók nevét adja meg.
A kötegfiókok nevének 3 és 24 karakter között kell lennie, és csak számokat és kisbetűket tartalmazhat.
...
### -IdentityType
A BatchAccounthoz társított identitás
...
### -KeyVaultId
A Batch-fiókkal társított Azure-kulcstár erőforrás-azonosítója.
...
### -KeyVaultUrl
A Batch-fiókkal társított Azure-kulcstár URL-címe.
...
### -Location
Azt a régiót adja meg, ahol ez a parancsmag létrehozza a fiókot.
További információért lásd: [Azure Régiók.](https://azure.microsoft.com/en-us/regions)
...
### -PoolAllocationMode
A kötegfiók készletének létrehozására vonatkozó kiosztási mód.
...
### -PublicNetworkAccess
A nyilvános hálózat hozzáférési típusa
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amelyben ez a parancsmag létrehozza a fiókot.
