...
### 1. példa: Feladathoz társított fájl törlése
```
PS C:\>Remove-AzBatchNodeFile -JobId "Job-000001" -TaskId "Task26" -Path "wd\testFile.txt" -BatchContext $Context
```

Ez a parancs törli a csomópontfájlt, amely neve wd\testFile.txt.
Ez a fájl a Feladat-000001 feladat alatt a 26-os azonosítójú tevékenységhez van társítva.
...
Ez a parancs törli a startup\testFile.txt az id Pool07 azonosítójú készlet megadott számítási csomópontjának csomópontját.
...
Ez a parancs a **Get-AzBatchNodeFile** használatával kapja meg a csomópontfájlt.
Ez a fájl a Feladat-000001 feladat alatt a 26-os azonosítójú tevékenységhez van társítva.
A parancs a folyamat segítségével átadja a fájlt az aktuális parancsmagnak.
Az aktuális parancsmag eltávolítja a csomópontfájlt.
...
### -ComputeNodeId
Annak a számítási csomópontnak az azonosítója, amely a parancsmag által törölt Batch csomópontfájlt tartalmazza.
...
### -InputObject
A parancsmag által törölt csomópontfájlt képviselő **PSNodeFile-objektumot** adja meg.
**PSNodeFile beszerzéséhez** használja a Get-AzBatchNodeFile parancsmagot.
...
### -PoolId
Annak a készletnek az azonosítóját adja meg, amely azokat a számítási csomópontokat tartalmazza, amelyekből a parancsmag eltávolít egy fájlt.
...
### -Rekurzív
Azt jelzi, hogy ez a parancsmag törli a mappát, valamint a megadott elérési út alatti almappákat és fájlokat.
Ez a parancsmag csak akkor releváns, ha az elérési út egy mappa.
