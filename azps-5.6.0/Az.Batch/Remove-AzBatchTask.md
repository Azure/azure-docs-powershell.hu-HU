...
## LEÍRÁS
A **Remove-AzBatchTask** parancsmag töröl egy Azure Batch-feladatot.
Ez a parancsmag megerősítést kér, hacsak nem adja meg a *Force paramétert.*

## PÉLDÁK

### 1. példa: Batch-feladat törlése azonosító szerint
```
PS C:\>Remove-AzBatchTask -JobId "Job-000001" -Id "Task23" -BatchContext $Context
```

Ez a parancs törli a 000001 azonosítójú feladat alatt az Azonosító Tevékenység23 azonosítót.
A parancs megerősítést kér.
A **Get-AzBatchAccountKey** parancsmaggal kontextust rendelhet a $Context változóhoz.

### 2. példa: Kötegfeladat törlése a folyamat használatával megerősítés nélkül
```
PS C:\>Get-AzBatchTask -JobId "Job-000001" -Id "Task26" -BatchContext $Context | Remove-AzBatchTask -Force -BatchContext $Context
```

Ez a parancs a **Get-AzBatchTask** parancsmagot használva kapja meg azt a kötegtevékenységet, amely a 000001-es azonosítófeladatot használó feladatban az Azonosító feladat26 feladatot használja.
...
### -InputObject
A parancsmag által törölt feladat.
