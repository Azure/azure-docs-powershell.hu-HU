...
## LEÍRÁS
A **Reset-AzBatchComputeNode** parancsmag újratelepíti az operációs rendszert a megadott számítási csomóponton.

## PÉLDÁK

### 1. példa: Csomópont újraimálása
```
PS C:\>Reset-AzBatchComputeNode -PoolId "MyPool" -Id "tvm-3257026573_2-20150813t200938z" -BatchContext $Context
```

Ez a parancs újragondolja a számítási csomópontot a MyPool nevű készlet "tvm-3257026573_2-20150813t200938z" azonosítójával.
A Get-AzBatchAccountKey parancsmag használatával kontextust rendelhet a $Context változóhoz.

### 2. példa: A készlet összes csomópontja újraimálása
```
PS C:\>Get-AzBatchComputeNode -PoolId "MyPool" -BatchContext $Context | Reset-AzBatchComputeNode -BatchContext $Context
```

Ez a parancs újragondolja a MyPool nevű készlet összes számítási csomópontját.
...
### -ComputeNode
Azt a **PSComputeNode** objektumot adja meg, amely a reimage-nak megfelelő számítási csomópontot jelöli.
...
### -Id
A visszaimálható számítási csomópont azonosítóját adja meg.
...
### -ReimageOption
Azt adja meg, hogy mikor kell újraimálni a csomópontot, és hogy mit kell tenni az éppen futó feladatokkal.
