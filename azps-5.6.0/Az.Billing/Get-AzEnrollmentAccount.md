...
## LEÍRÁS
A **Get-AzEnrollmentAccount** parancsmag regisztrációs fiókokat kap.
...
Szerezze be az összes elérhető regisztrációs fiókot.
...
A megadott objektumazonosítóval szerezze be a regisztrációs fiókot.
