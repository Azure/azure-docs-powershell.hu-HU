...
- A használat jelentésének kezdő és záró időpontja.
- Az összesítés pontossága napi vagy óránkénti.
- Példányszintű részletek ugyanannak az erőforrásnak több példányához.
Az egységes eredmény érdekében a visszaadott adatok azon alapulnak, hogy mikor jelente meg a használati adatokat az Azure-erőforrás.
...
### 1. példa: Előfizetési adatok lekérése
```
PS C:\>Get-UsageAggregates -ReportedStartTime "5/2/2015" -ReportedEndTime "5/5/2015"
```

Ez a parancs beolvassa az előfizetéshez jelentett használati adatokat 2015.05.02. és 2015.05.05. között.
...
Ha nem adja meg ezt a paramétert, az adatokat a *ReportedStartTime-ban* megadott nap vagy óra elejéről olvassa be a rendszer.
...
### -ShowDetails
Azt jelzi, hogy ez a parancsmag példányszintű adatokat ad-e vissza a használati adatokkal együtt.
...
Ha azonban az értéket $False, az ugyanannak az **előfizetésiIdnek,** a **meterIdnek,** a **usageStartTime-nak** és a **usageEndTime-nak** az összes adata egyetlen sorelembe lesz összecsukva.
