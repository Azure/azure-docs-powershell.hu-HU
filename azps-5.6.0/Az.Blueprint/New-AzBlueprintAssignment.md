...
Hozzon létre egy új tervrajz-hozzárendelést a megadott előfizetésben a megadott paraméter- és erőforráscsoport-szótár alapján, és konfigurálja az erőforrászárolást az `$blueprintObject` **AllResources szolgáltatásban.** Alapértelmezés szerint a rendszer által hozzárendelt identitást használja.  A hely határozza meg a felügyelt identitás létrehozására vonatkozó régiót.
