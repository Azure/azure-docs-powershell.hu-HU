...
### 1. példa: A robot frissítése név és ResourceGroupName szerint
```powershell
...
A robot frissítése név és ResourceGroupName szerint

### 2. példa: A robot frissítése inputObject szerint
```powershell
...
A robot frissítése InputObject szerint
...
Az Application Insights API-kulcs
...
Az Application Insights appazonosítója
...
### -Kind
Kötelező.
Beállítja vagy beállítja az erőforrás fajtáját.
...
### -LuisAppId
A LUIS-appazonosítók gyűjteménye
...
### -MsaAppId
A robot Microsoft-appazonosítója
