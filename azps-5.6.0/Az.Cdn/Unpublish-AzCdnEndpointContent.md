...
## LEÍRÁS
Az **Unpublish-AzCdnEndpointContent parancsmag** véglegesen véglegesen elvégz egy Azure Content Delivery Network (CDN) végpont tartalmát.
...
### -PurgeContent
Annak a forráskiszolgálónak a relatív elérési útjai tömbét adja meg, amely a parancsmagot véglegesen véglegesen meghatározza.
