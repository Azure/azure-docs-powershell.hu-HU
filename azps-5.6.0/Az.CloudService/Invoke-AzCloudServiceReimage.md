...
### ReimageExpanded (alapértelmezett)
```
...
### 1. példa: Felhőszolgáltatás szerepkörpéldányainak újraimáltatása
```powershell
...
Ez a parancs két szerepkörpéldányt egyes ContosoFrontEnd_IN_0 és ContosoBackEnd_IN_1 ContosoCS nevű felhőszolgáltatásban, amely a ContosOrg nevű erőforráscsoporthoz tartozik.

### 2. példa: A felhőszolgáltatás összes szerepkörének újraimáltatása
```powershell
PS C:\> Invoke-AzCloudServiceReimage -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "*"
```

Ez a parancs újraértesi a ContosoCS nevű felhőszolgáltatás összes olyan szerepkörpéldányát, amely a ContosOrg nevű erőforráscsoporthoz tartozik.
