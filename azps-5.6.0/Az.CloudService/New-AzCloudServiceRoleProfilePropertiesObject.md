...
### 1. példa: Szerepkörprofil-tulajdonságobjektum létrehozása
```powershell
$role = New-AzCloudServiceRoleProfilePropertiesObject -Name 'WebRole' -SkuName 'Standard_D1_v2' -SkuTier 'Standard' -SkuCapacity 2
```

Ez a parancs létrehozza a szerepkörprofil-tulajdonságobjektumot, amely egy felhőszolgáltatás létrehozására vagy frissítésére használható.
További részletekért lásd: New-AzCloudService.

## PARAMETERS

### -Name
A szerepkörprofil neve.
...
### -SkuCapacity
A felhőszolgáltatás szerepkör-példányainak számát adja meg.
