...
### DeleteExpanded (alapértelmezett)
```
...
### 1. példa: Felhőszolgáltatás szerepkörpéldányának eltávolítása
```powershell
PS C:\> Remove-AzCloudServiceInstance -ResourceGroup "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "ContosoFrontEnd_IN_0"
```

Ez a parancs eltávolítja a ContosoCS nevű ContosoFrontEnd_IN_0 nevű felhőszolgáltatás szerepkörpéldányát, amely a ContosOrg nevű erőforráscsoporthoz tartozik.
