...
### 1. példa: A felhőszolgáltatás leállítása
```powershell
PS C:\> Stop-AzCloudService -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS"
```

Ez a parancs leállítja a ContosoCS nevű felhőszolgáltatáshoz tartozó összes szerepkörpéldányt.
