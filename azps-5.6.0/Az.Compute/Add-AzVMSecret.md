...
A harmadik parancs a **Set-AzVMOperatingSystem** parancsmag segítségével konfigurálja a $VirtualMachine.
...
Az **Add-AzVMSecret** bővítményt többször is futtatva további tanúsítványokat is felvehet.
