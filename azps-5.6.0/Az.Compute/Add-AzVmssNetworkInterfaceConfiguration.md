...
## LEÍRÁS
Az **Add-AzVmssNetworkInterfaceConfiguration** parancsmag hozzáad egy hálózati felületi konfigurációt a virtuális gép mérethalmazához (VMSS).

## PÉLDÁK

### 1. példa: Hálózati felület konfigurációjának hozzáadása a VMSS-hez
```
PS C:\> Add-AzVmssNetworkInterfaceConfiguration -VirtualMachineScaleSet $VMSS -Name "Test" -Primary $True -IPConfiguration $IPCfg
```

Ez a parancs hozzáadja a hálózati felület konfigurációját a VMSS-hez.
...
A DNS-beállításokHOZ szükséges DNS-kiszolgáló IP-címeinek listája.
...
Meghatározza, hogy a hálózati felület gyorsítsa-e a hálózatépítést.
...
### -EnableIPForwarding
Azt adja meg, hogy engedélyezve van-e az IP-továbbítás ezen a NIC-on.
...
### -IpConfiguration
A hálózati felület IP-konfigurációját adja meg.
...
### -Primary
Azt jelzi, hogy a hálózati felület konfigurációjában létrehozott hálózati felületek lesznek-e a virtuális gép elsődleges hálózati információs központja (NIC).
