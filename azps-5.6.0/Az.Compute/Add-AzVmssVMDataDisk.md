...
A *VhdUri* szükséges ahhoz, hogy az Azure platformon meg tudja mondani a virtuális merevlemez (VHD) helyét, hogy adatlemezként csatolja a virtuális géphez.
- Üres.
...
Megadja azt a helyi virtuális gép méretarányú VM-objektumot, amelyhez adatlemezt szeretne hozzáadni.
