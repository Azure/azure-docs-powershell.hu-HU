...
## LEÍRÁS
A **Grant-AzSnapshotAccess** parancsmag hozzáférést biztosít egy pillanatfelvételhez.
...
60 másodpercig adjon olvasási hozzáférést az "Erőforráscsoport01" erőforráscsoport "Snapshot01" nevű pillanatképének.

## PARAMETERS

### -Access
Az Access szintjét adja meg.
...
### -DurationInSecond
A hozzáférési időtartamot adja meg másodpercben.
