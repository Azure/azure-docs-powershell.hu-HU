...
### -InstanceId
A virtuális gép méretezéskészletének VM-példányazonosítója.
...
### -ScriptPath
A végrehajtandó parancsfájl elérési útja.  Ha ezt az értéket adta meg, a parancsprogram felülírja a parancsprogram alapértelmezett parancsprogramját.
