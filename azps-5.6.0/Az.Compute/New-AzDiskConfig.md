...
Ha a lemez állapota "ReadyToUpload", a felhasználó feltölthet egy lemezt a blobtárból a lemez SAS URL-címére az AzCopy használatával.
...
### -DiskIOPSReadOnly
Az összes olyan VM-hez engedélyezett IOPS-fájlok száma, amelyek a megosztott lemezhez ReadOnly-ként lesznek rögzítve. Egy művelet 4 és 256 bájt közötti átvitelt tud.
...
### -DiskMBpsReadOnly
"description": "Az a teljes átviteli sebesség (MBps), amely az összes olyan VM-hez engedélyezett, amely a megosztott lemezt ReadOnly-ként rögzíti. A MBps másodpercenként több millió bájtot jelent – a MB itt a 10-eshatalmak ISO-ként való meghatalmazását használja.
...
### -LogicalSectorSize
Logikai ágazat mérete bájtban az Ultra lemez esetén. 
...
### -SkuName
A tárfiók termékváltozatnevét adja meg.  A rendelkezésre álló értékek a következő értékek: Standard_LRS, Premium_LRS, StandardSSD_LRS és UltraSSD_LRS.  UltraSSD_LRS a CreateOption paraméterhez csak üres érték használható.
...
### -UploadSizeInBytes
A feltöltés tartalmának mérete, beleértve a VHD élőlábat is, amikor a CreateOption a Upload.  Ennek az értéknek 20972032 (20 MiB + 512 bájt a VHD élőlábhoz) és 35183298347520 bájtnak (32 TiB + 512 bájt a VHD élőlábhoz) kell lennie.
