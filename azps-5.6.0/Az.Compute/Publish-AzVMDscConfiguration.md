...
## LEÍRÁS
A **Publish-AzVMDscConfiguration** parancsmag feltölt egy kívánt államkonfigurációs (DSC) parancsfájlt az Azure blobtárba, amelyet később a Set-AzVMDscExtension parancsmagot használva lehet azure-Set-AzVMDscExtension alkalmazni.
