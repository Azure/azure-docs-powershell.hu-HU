...
### -ABDemonInterval
Megadja a sűrűség (percben) azt, hogy a rendszer milyen gyakorisággal fut. Ha nem szeretné telepíteni a szoftverszolgáltatást az Azure VM-en, akkor ebben a mezőben állítsa be az értéket 0-ként.
...
### -ClientRb
A Minden ügyfél.rb teljes elérési útját adja meg.
...
### -RunList
A Csomópont futási csomópontjának listáját határozza meg.
