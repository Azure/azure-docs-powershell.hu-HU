...
## SYNOPSIS
Ez a parancsmag az adott virtuálisgép-méretskálakészlet összes bővítményének gördülékenyes frissítését kezdi a legújabb elérhető verzióra. 
...
## LEÍRÁS
Egy folyamatos frissítést kezd, hogy a virtuális gép méretarányán az összes bővítményt a legújabb elérhető verzióra állítsa át.
Azok a bővítmények, amelyek már a legújabb elérhető verziót futtatják, nem érintik.
...
Ez a példa beveszi a meglévő VM-skálakészletet (MyVmssName) és hozzáad hozzá egy bővítményt. Az utolsó parancs futtatja a bővítmény frissítésének folyamatban lévő folyamatát. 
...
### -ResourceId
A VM méretaránykészlet-objektumának erőforrás-azonosítója. 
...
A VM méretarány-beállítása objektum.
