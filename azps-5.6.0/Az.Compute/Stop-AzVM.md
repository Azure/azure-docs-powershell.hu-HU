...
## LEÍRÁS
A **Stop-AzVM parancsmag** leállít egy Azure virtuális gépet.

## PÉLDÁK

### 1. példa: Virtuális gép leállítása
```
PS C:\> Stop-AzVM -ResourceGroupName "ResourceGroup11" -Name "VirtualMachine07"
```

Ez a parancs leállítja a VirtualMachine07 nevű virtuális gépet az ResourceGroup11-ben.
...
### -SkipShutdown
Nem türelmes vm-leállítás kérése a virtuális gép kiépítésekor.
...
### -StayProvisioned
A parancsmag leállítja az összes virtuális gépet a VMSS-en belül, de nem foglalkozik velük. A leállított virtuális gépekért díjat számítunk fel a fiókért.
