...
## LEÍRÁS
Az **Update-AzDisk** parancsmag frissíti a lemezeket.
...
Az első parancs egy 10 GB-os helyi üres lemezfrissítési objektumot hoz létre Premium_LRS tárfiók típusában.  Emellett beállítja a Windows operációs rendszer típusát, és engedélyezi a titkosítási beállításokat.
A második és a harmadik parancs a lemezfrissítési objektum lemeztitkosítási kulcsának és kulcstitkosítási kulcsának beállításait adja meg.
Az utolsó parancs a lemezfrissítési objektumot veszi fel, és frissíti a "Disk01" nevű meglévő lemez nevét az "ResourceGroup01" erőforráscsoportban.
...
Ezek a parancsok a "ResourceGroup01" erőforráscsoportban a "Disk01" nevű meglévő lemezeket is frissítik 10 GB-os lemezméretre.
...
### -DiskUpdate
Helyi lemezfrissítési objektumot ad meg.
