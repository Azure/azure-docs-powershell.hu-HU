...
## SYNOPSIS
Egy adott szervezeti erőforrás tulajdonságainak lekérte.
...
### 1. példa: Az előfizetések alatt található összes összefolyásos szervezet felsorolása
```powershell
...
Ez a parancs felsorolja az előfizetés alatt található összes összefolyásos szervezetet.

### 2. példa: Egy erőforráscsoport összes összefolyásos szervezetének felsorolása
```powershell
...
Ez a parancs felsorolja egy erőforráscsoport összes összefolyásos szervezetét.

### 3. példa: Összefolyásos szervezet elnevezése
```powershell
...
Ez a parancs egy összefolyásos szervezetet kap név szerint.

### 4. példa: Összefolyásos szervezet létrehozása folyamat szerint
```powershell
...
Ez a parancs folyamat szerint összefolyásos szervezetet kap.
