...
## SYNOPSIS
Szervezeti erőforrás létrehozása
...
### 1. példa: Összefolyásos szervezet létrehozása
```powershell
...
Ez a parancs összefolyásos szervezetet hoz létre.
