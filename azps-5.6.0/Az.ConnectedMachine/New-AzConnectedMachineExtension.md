...
Ez létrehoz egy új bővítményt, amely a folyamaton keresztül átadott objektum által megadott kiterjesztési paraméterekkel rendelkezik.
Ez akkor lehet jó, ha meg szeretné ragadni az egyik gép paramétereit, és egy másik gépre szeretné alkalmazni.
...
### 4. példa: Új bővítmény hozzáadása bővítményobjektum használatával helyként és paraméterekként a frissítéshez
```powershell
...
Ez létrehoz egy új gépbővítményt a folyamaton keresztül megadott identitás és a bővítményobjektum által megadott kiterjesztés részletei alapján.
Ezt valószínűleg nem fogja megtenni, de ez lehetséges.
...
### -ExtensionParameter
Gépbővítményt ír le.
Az EXTENSIONPARAMETER tulajdonságainak létrehozására és a kivonattáblák létrehozására vonatkozó MEGJEGYZÉSEK című szakaszban található.
...
EXTENSIONPARAMETER: <IMachineExtension> Egy gépbővítményt ismertet.
  ...
  - `[MachineExtensionType <String>]`: A bővítmény típusát adja meg; példa: "CustomScriptExtension".
  ...
  - `[Setting <IMachineExtensionPropertiesSettings>]`: A bővítmény Json formátumú nyilvános beállításai.
