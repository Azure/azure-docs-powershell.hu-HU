...
### 2. példa: Bővítmény beállítása a folyamaton keresztül megadott bővítményparaméterekkel
```powershell
...
Ez a beállítás egy bővítményt a folyamaton keresztül átadott objektum által megadott kiterjesztési paraméterekkel együtt állít be.
