...
Itt a folyamaton keresztül átadott bővítményt használjuk annak azonosítására, hogy melyik bővítményen kívánunk működni, és meg szeretnénk adni, hogy mit módosítsunk a normál paramétereken (például ) keresztül. `-Settings`
...
Frissíti a folyamaton keresztül átadott adott bővítményt.
Itt a folyamaton keresztül átadott bővítményt használjuk annak azonosításához, hogy melyik bővítményen kívánunk működni.
...
EXTENSIONPARAMETER: <IMachineExtensionUpdate> Gépi bővítményfrissítést ismertet.
  ...
  - `[Type <String>]`: A bővítmény típusát adja meg; példa: "CustomScriptExtension".
