...
Ez a parancs egy tárolócsoportot hoz létre a legújabb nginx-kép használatával, és nyilvános IP-címet kér a 8000-es port megnyitásához.
...
Ez a parancs egyéni lemezkép használatával létrehoz egy tárolócsoportot egy egyéni tárolókép-beállításjegyzékből.
...
Ez a parancsok létrehoznak egy tárolócsoportot, amely a megadott Azure-fájlmegosztást `/mnt/azfile` csatlakoztatja.
