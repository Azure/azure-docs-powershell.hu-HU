...
## LEÍRÁS
A **Remove-AzContainerGroup** parancsmag eltávolít egy tárolócsoportot.

## PÉLDÁK

### 1. példa: Tárolócsoport eltávolítása
```
PS C:\> Remove-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer
```

Ez a parancs eltávolítja a megadott tárolócsoportot.

### 2. példa: Egy tárolócsoport eltávolítása pipázás használatával
```
PS C:\> Get-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer | Remove-AzContainerGroup
```

Ez a parancs egy tárolócsoportot pipával távolít el.

### 3. példa: Egy tárolócsoport eltávolítása erőforrás-azonosító alapján.
```
PS C:\> Find-AzResource -ResourceGroupEquals MyResourceGroup -ResourceNameEquals MyContainer | Remove-AzContainerGroup
```

Ez a parancs erőforrás-azonosító szerint eltávolítja a tárolócsoportokat.
...
### -InputObject
Az eltávolítható tárolócsoport.
