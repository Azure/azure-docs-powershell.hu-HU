...
## LEÍRÁS
A Get-AzContainerRegistryWebhookEvent parancsmag felsorolja a webhook összes eseményét.

## PÉLDÁK

### 1. példa: Egy webhook összes eseményét beveszi.
```powershell
...
Beveszi egy webhook összes eseményét.
