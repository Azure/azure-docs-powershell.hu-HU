...
## LEÍRÁS
A New-AzContainerRegistryWebhook parancsmag létrehoz egy tárolóadatbázis-webhookot.

## PÉLDÁK

### 1. példa: Hozzon létre egy tárolóadatbázis-webhookot.
```
...
Hozzon létre egy tárolóadatbázis-webhookot.
...
### -Header
A webhook értesítésekhez hozzáadható egyéni fejlécek.
