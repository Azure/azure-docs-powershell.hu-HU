...
## LEÍRÁS
A Update-AzContainerRegistry parancsmag frissíti a tároló beállításjegyzékét.

## PÉLDÁK

### 1. példa: Rendszergazdai felhasználó engedélyezése egy megadott tárolóadatbázishoz
```powershell
...
Ez a parancs lehetővé teszi a rendszergazdai felhasználónak a megadott tárolóadatbázis-beállításjegyzéket.

### 2. példa: A megadott tárolóadatbázis által használt tárfiók beállítása
```powershell
...
Ez a parancs úgy állítja be a megadott tároló beállításjegyzékét, hogy egy meglévő tárfiók \` mystorageaccount-ját használja \` ugyanabban az előfizetésben.
...
### -DisableAdminUser
Engedélyezze a rendszergazdai felhasználót a tároló beállításjegyzékéhez.
...
### -NetworkRuleSet
A tároló beállításjegyzékéhez beállított hálózati szabály.
...
### -Termékváltozat
Container Registry termékváltozat.
...
### -Tag
Kulcsérték-párok kivonattábla formájában.
Például: @{key0="érték0";key1=$null;key2="érték2"}
