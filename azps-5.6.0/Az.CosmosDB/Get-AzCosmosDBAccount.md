...
## LEÍRÁS
A **Get-AzCosmosDBAccount** parancsmag lekérte egy adott ResourceGroupName-fiók összes meglévő, ABB-fiókjainak listáját, és egy adott ResourceGroupName és AccountName fiókhoz egyetlen KülönBB-fiókot kap.
