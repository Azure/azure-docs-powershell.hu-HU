...
## SYNOPSIS
A TamakDB MongoDB adatbázist kapja
...
## LEÍRÁS
A **Get-AzCosmosDBMongoDBDatabase** parancsmag megkapja a TamakDB MongoDB adatbázist.
...
Az Erőforrásobjektum _rid, _ts, _etag tulajdonságokat tartalmaz.
