...
## LEÍRÁS
A **Get-AzCosmosDBSqlUserDefinedFunction** parancsmag lekérte az adott ResourceGroupName, AccountName, DatabaseName és ContainerName rekordhoz az összes meglévő Sql UserDefinedFunctions listáját, és egy adott ResourceGroupName, AccountName, ContainerName és UserDefinedFunctionName fájlhoz egyetlen Sql UserDefinedFunction függvényt kap.
