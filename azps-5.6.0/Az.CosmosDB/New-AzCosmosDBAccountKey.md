...
## SYNOPSIS
Egy adott TárolóDB-fiókkulcs újragenerálható.
...
Új kulcsok jönnek létre a ResourceGroup rg-ben a fióknévvel( dbname) fiókhoz.

### 2. példa

Egy adott TárolóDB-fiókkulcs újragenerálható. (automatikusan generált)
...
### -KeyKind
Az újrageneráláshoz szükséges hozzáférési kulcs.
Elfogadott értékek: elsődleges, primaryReadonly, secondary, secondaryReadonly
