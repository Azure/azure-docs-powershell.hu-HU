...
### -DatasetGrouping
Kifejezés szerint csoportosított tömb, amelyet a lekérdezésben használhat.
...
A külső felhőszolgáltató dimenzióval/lekérdezési művelettel társított típusa.
...
### -TimePeriodTo
A záró dátum, amelybe az adatokat le kell húzni.
