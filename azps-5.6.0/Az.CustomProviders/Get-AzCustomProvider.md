...
## SYNOPSIS
Az egyéni erőforrás-szolgáltató jegyzékfájlját kapja meg.
...
### 1. példa: Az előfizetés összes egyéni szolgáltatóának felsorolása
```powershell
...
Az előfizetés összes egyéni szolgáltatója

### 2. példa: Egyetlen egyéni szolgáltató lekérte
```powershell
...
Egyetlen egyéni szolgáltató adatait kapja meg.
Az Format-List objektum részleteinek a képernyőn való megjelenítése.
