...
Hozzon létre egy egyéni szolgáltatót az egyéni szolgáltatói társítások útvonalával.

## PARAMETERS

### -Művelet
Az egyéni erőforrás-szolgáltató által implementálja a műveletek listáját.
Az ACTION tulajdonságokat és a kivonattáblát a MEGJEGYZÉSEK szakaszban hozhatja létre.
...
ACTION <ICustomRpActionRouteDefinition[]>: Az egyéni erőforrás-szolgáltató által implementálható műveletek listája.
  - `Endpoint <String>`: Az az útvonaldefiníciós végpont URI, amelytől az egyéni erőforrás-szolgáltató proxyt kér. Ez lehet egyszerű URI (például ' '), vagy megadhatja, hogy egy útvonalon keresztül (például ' ') keresztül https://testendpoint/ https://testendpoint/{requestPath} halad-e.
