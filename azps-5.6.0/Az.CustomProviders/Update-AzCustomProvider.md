...
## SYNOPSIS
Egy meglévő egyéni erőforrás-szolgáltató frissítése.
A PATCH-en keresztül jelenleg csak a címkék frissíthetők.
...
### 1. példa: Címkék hozzáadása egyéni szolgáltatóhoz
```powershell
...
Frissítse egy egyéni szolgáltató címkéit.

### 2. példa: Egyéni szolgáltató frissítése pipázással
```powershell
...
Egyéni szolgáltató frissítése pipázás használatával.
