...
## LEÍRÁS
A **New-AzDataBoxEdgeBandwidthSchedule** parancsmag új sávszélesség-ütemezést hoz létre egy adatmező-edge-eszköz számára a sávszélesség-használat kezelése érdekében.
...
### -UnlimitedBandwidth
A Korlátlan sávszélesség beállítása, ha a hamis értékre van állítva, az alapértelmezett érték 20 Mb/s
