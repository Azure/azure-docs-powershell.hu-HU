...
## LEÍRÁS
A **New-AzDataBoxEdgeRole** parancsmag új szerepkört hoz létre egy Data Box Edge-eszközhöz.
...
### -ConnectionString
Kapcsolati karakterláncok biztosítanak
...
### -DeviceProperty
Eszköztulajdonságok beállítása
...
Adja meg az IOT-eszköz kapcsolati karakterláncát
...
Az Iot Edge-eszköz hozzáférési kulcsa
...
Adja meg a Edge-eszköz kapcsolati karakterláncát
...
### -iotEdgeDeviceId
Az Iot Edge-eszköz azonosítója
...
### -Platform
Platform biztosítanak például: Linux
