...
## LEÍRÁS
A **Remove-AzDataBoxEdgeStorageAccount** parancsmag eltávolítja egy kapcsolódó Edge Storage-fiókot egy Adatmező Edge-eszközhöz. Megadhatja a parancsmagban paraméterként eltávolítható Edge Storage-fiók nevét.
