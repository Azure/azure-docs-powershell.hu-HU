...
## LEÍRÁS
A **Remove-AzDataBoxEdgeStorageContainer** parancsmag eltávolítja a Edge Storage-fiók társított tárolóját egy Data Box Edge-eszközön. Megadhatja a paraméterként eltávolítható tároló tároló nevét.
