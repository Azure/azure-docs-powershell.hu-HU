...
Az adatszelet készen áll arra, hogy a függő szeletek felhasználják azt. 
- Sikertelen.
...
Az alábbi példakód óránként beállítja az adatkészlet elérhetőségét a JSON (JavaScript Object Notation) fájlban.
...
Ez a parancsmag a paraméter által megadott időpont előtt gyártott szeleteket kap.
