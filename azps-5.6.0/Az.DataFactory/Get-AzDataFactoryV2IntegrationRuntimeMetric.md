...
Ez a parancs a "rg-test-dfv2" nevű erőforráscsoport és a "test-df-eu2" nevű adatüzemellátó erőforráscsoporthoz a "test-selfhost-ir" nevű integrációs futásidő metrikus adatait jeleníti meg az előfizetésben.
