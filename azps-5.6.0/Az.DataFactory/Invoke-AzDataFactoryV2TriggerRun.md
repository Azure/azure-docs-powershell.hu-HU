...
```
Egy eseményindító másik példányát indítja el egy új eseményindító futtatásának azonosítójával, az eredeti eseményindítóval azonos windowStartTime és windowEndTime megtartásával.
