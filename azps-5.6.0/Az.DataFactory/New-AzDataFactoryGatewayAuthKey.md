...
## LEÍRÁS
A **New-AzDataFactoryGatewayAuthKey** parancsmag átjáró-hitelesítéskulcsot hoz létre egy megadott Azure Data Factory-átjáróhoz.
Ezzel a kulccsal regisztrálhatja az átjárót egy felhőszolgáltatással.

## PÉLDÁK

### 1. példa: Átjárói hitelesítéskulcs létrehozása a Key1 kulcshoz
```
...
Ez a parancs létrehozza a Key1 kulcs egy átjáró-hitelesítési kulcsát a MyGateway nevű adat gyári átjáróhoz.
...
### -KeyName
Az újragenerálható átjáró-hitelesítési kulcs neve , "kulcs1" vagy "kulcs2".
