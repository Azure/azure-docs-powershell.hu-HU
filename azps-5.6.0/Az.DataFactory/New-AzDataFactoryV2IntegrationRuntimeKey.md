...
## LEÍRÁS
A **New-AzDataFactoryV2IntegrationRuntimeKey** parancsmag a "KeyName" paraméterben megadott kulcsnévvel újragenerálja az integrációs futásidejű kulcsot. Az előző kulcs érvénytelen.

## PÉLDÁK

### 1. példa: Új kulcs létrehozása integrációs futásidejű futási időben
```
...
A parancsmag a "test-selfhost-ir" nevű integrációs runtime-hoz újragenerálja az "authKey2" kulcsot.
...
### -KeyName
Az önkiszolgáló integrációs futásidejű hitelesítési kulcs neve.
