...
## LEÍRÁS
A Remove-AzDataFactoryV2IntegrationRuntimeNode parancsmag eltávolít egy csomópontot egy integrációs futási időben.

## PÉLDÁK

### 1. példa: Csomópont eltávolítása integrációs futási időből

Eltávolíthat egy adott nevű csomópontot egy integrációs futási időben. (automatikusan generált)
