...
## LEÍRÁS
A Remove-AzDataFactoryV2LinkedService parancsmag eltávolítja a csatolt szolgáltatásokat az Azure Data Factoryból.

## PÉLDÁK

### 1. példa: Csatolt szolgáltatás eltávolítása
```
...
Ez a parancs eltávolítja a LinkedServiceTest nevű csatolt szolgáltatást a WikiADF nevű adatüzemből.
...
Ez a parancsmag eltávolít egy csatolt szolgáltatást a paraméter által megadott adatüzemből.
...
### -InputObject
Az eltávolítható LinkedService-objektumot adja meg.
...
### -Name
Az eltávolítható csatolt szolgáltatás neve.
A csatolt szolgáltatás neve.
...
Ez a parancsmag eltávolít egy csatolt szolgáltatást a paraméter által megadott csoportból.
...
### -ResourceId
Az eltávolítható csatolt szolgáltatás Azure-erőforrásazonosítója.
