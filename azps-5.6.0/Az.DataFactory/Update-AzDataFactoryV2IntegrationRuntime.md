...
## LEÍRÁS
Az **Update-AzDataFactoryV2IntegrationRuntime parancsmag** frissíti az integráció futásidejű tulajdonságait. A parancsmag jelenleg csak az "AutoUpdate" és az "AutoUpdateDelayOffset" frissítését támogatja az önkiszolgáló integráció futásidejéhez.

## PÉLDÁK

### 1. példa: Integrációs futási idő frissítése
```
...
A parancsmag frissíti a "test-selfhost-ir" nevű önkiszolgáló integrációs futásiidőt.

## PARAMETERS

### -AutoUpdate
Az önkiszolgáló integrációs futásidejű automatikus frissítés engedélyezése vagy letiltása.
...
Az önkiszolgáló integráció futásidejű automatikus frissítésének a nap órájában elérhető ideje.
