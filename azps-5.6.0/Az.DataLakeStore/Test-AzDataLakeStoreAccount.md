...
## LEÍRÁS
A **Test-AzDataLakeStoreAccount** parancsmag teszteli a Data Lake Store-fiók meglétét.

## PÉLDÁK

### 1. példa: Fiók tesztelése
```
PS C:\>Test-AzDataLakeStoreAccount -Name "ContosoADL"
```

Ez a parancs teszteli, hogy létezik-e a ContosoADL nevű fiók.
...
### -Name
A tesztelni szükséges Data Lake Store-fiók nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amely a tesztelni kívánt fiókot tartalmazza.
