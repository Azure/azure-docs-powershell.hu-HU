...
## LEÍRÁS
A New-AzDataMigrationSelectedDB parancsmag létrehoz egy adatbázis-információs objektumot, amely a forrás- és céladatbázisok, valamint a táblaleképezések adatait tartalmazza az áttelepítéshez. Ez a parancsmag paraméterként használható a New-AzDataMigrationTask parancsmaggal.
...
### -BackupFileShare
Fájlmegosztás, amelyről az adatbázis forráskiszolgáló-adatbázisfájlja biztonsági mentése szükséges.
Ezzel a beállítással felülbírálhatja az egyes adatbázisok fájlmegosztási adatait.
A kiszolgáló teljes tartománynevét használja.
...
Adatbázis beállítása csak olvashatóként az áttelepítés előtt
...
Állítsa az áttelepítés típusát SQL Serverre SQL DB-áttelepítésre.
...
### -MigrateSqlServerSqlDbMi
Állítsa át az áttelepítés típusát SQL Serverre SQL DB MI-áttelepítésre.
