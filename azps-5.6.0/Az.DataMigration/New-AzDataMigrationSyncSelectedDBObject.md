...
A New-AzDataMigrationSyncSelectedDB parancsmag létrehoz egy, a szinkronizálási helyzetre jellemző adatbázis-információs objektumot, amely a forrás- és céladatbázisokkal kapcsolatos információkat tartalmazza.
...
Ez a példa létrehoz egy adatbázis metaadat-objektumát, amely leírja az adatbázis-áttelepítési beállításokat$DatabaseName adatbázis-$DatabaseName.  
...
### -MigrationSetting
Az áttelepítés működését finomhangoló áttelepítési beállítások
...
### -SchemaName
Áttelepítenie kell a séma nevét
...
### -SourceSetting
Forrásbeállítások a forrás végpont áttelepítési viselkedésének finomhangolásához
...
### -TableMap
Forrás hozzárendelése céltáblákhoz
...
### -TargetSetting
Célbeállítások a cél végpont áttelepítési viselkedésének finomhangolásához
