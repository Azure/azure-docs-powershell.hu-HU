...
### -Wait
Hogy várni kell-e a tevékenység befejezésére. Ha a jelölő be van állítva, minden másodpercben ellenőrzi, amíg a feladat be nem fejezi a feladatot, és visszatér a felhasználóhoz a feladat tulajdonságai között, ahol a kimenet vagy a hiba megvizsgálható. 
```yaml
