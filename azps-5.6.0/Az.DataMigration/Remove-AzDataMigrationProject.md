...
## LEÍRÁS
A Remove-AzDataMigrationProject parancsmag eltávolítja az Azure Database Migration Service-projektet az Azure-ból. A DeleteRunningTask paraméter megadva eltávolítja az eltávolított projekthez társított Összes Azure-adatbázis-áttelepítési szolgáltatásbeli feladatot. 
...
A fenti példa eltávolítja a myDMProject nevű Azure Adatbázis-áttelepítési szolgáltatás projektet az Azure-ból a bemeneti paraméterként megadott név alapján.
...
A fenti példa eltávolítja a PSProject objektumon alapuló Azure Database Migration Service projektet bemeneti paraméterként.
