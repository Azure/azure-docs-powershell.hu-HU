...
## LEÍRÁS
A Remove-AzDataMigrationService parancsmag eltávolítja az Azure Adatbázis-áttelepítési szolgáltatás egy példányát az Azure-ból. A DeleteRunningTask paraméter megadva eltávolítja az eltávolított szolgáltatáshoz társított összes Azure Adatbázis-áttelepítési szolgáltatásbeli feladatot. 
