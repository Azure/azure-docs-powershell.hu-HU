...
### ExpandExpanded (alapértelmezett)
```
...
### 1. példa: Kibővíti a megadott kép elérési útját, és beolvassa a csomag metaadatait a AppxManifest.xml
```powershell
...
Ez a parancs a megadott kép elérési útban található MSIX-csomag metaadatait adja vissza.
...
### -MsixImageUri
Az MSIX Image To construct (Létrehozva) URI azonosítót jelöli, lásd az MSIXIMAGEURI tulajdonságok MEGJEGYZÉSEK szakaszát, és hozzon létre egy kivonattáblát.
...
MSIXIMAGEURI: <IMsixImageUri> Az MSIX-képre hivatkozó URI
  - `[Uri <String>]`: URI –Kép
