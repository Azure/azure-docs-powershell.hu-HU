...
Ez a parancs egy Windows Virtual Desktop HostPool-t kap egy erőforráscsoportban.

### 2. példa: A Windows virtuális asztali hostpools listájának megjelenítése
```powershell
...
Ez a parancs felsorolja az erőforráscsoportok windowsos virtuális asztali állomássorát.
