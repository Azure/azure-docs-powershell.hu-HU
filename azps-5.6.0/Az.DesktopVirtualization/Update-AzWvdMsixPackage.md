...
### 1. példa: MSIX-csomag frissítése 
```powershell
...
Ez a parancs frissíti az MSIX-csomagot a HostPoolban.
...
### -DisplayName
Az MSIX-csomag megjelenítendő neve.
...
### -IsActive
Állítsa be, hogy a csomag egy verziója aktív legyen a hostpoolban.
...
Regisztrációs mód beállítása
Normál vagy késleltetett.
