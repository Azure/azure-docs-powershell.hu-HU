...
## LEÍRÁS
A **Set-AzDtlAutoStartPolicy** parancsmag beállítja egy laboratórium automatikus indítási házirendjét, amely lehetővé teszi a laboratóriumi virtuális gépek automatikus indításra való ütemezését.
A parancsmag a megadott erőforráscsoportot és a laboratórium nevét használja a házirend beállításhoz.

## PÉLDÁK

### 1. példa

Beállítja egy laboratórium automatikus indítási házirendét a DevTest Labsban. (automatikusan generált)
...
### -Days
Tömbként megadja a hét azon napjait, amikor a laboratórium virtuális gépeit el kell kezdeni.
...
### -Disable
Azt jelzi, hogy ez a parancsmag letiltja a házirendet a virtuális gépeken a laboratóriumban.
...
### -Enable
Azt jelzi, hogy ez a parancsmag engedélyezi a házirendet a laboratórium virtuális gépei számára.
...
### -LabName
Annak a laboratóriumnak a neve, amelyhez ez a parancsmag beállítja az automatikus indítási házirendet.
...
### -Time
Azt az időt adja meg, amikor a laboratórium virtuális gépeit el kell kezdeni.
