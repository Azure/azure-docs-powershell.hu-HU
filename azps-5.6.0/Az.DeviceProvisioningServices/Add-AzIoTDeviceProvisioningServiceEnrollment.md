...
## LEÍRÁS
Eszközbeiratkozást hozhat létre egy Azure IoT Hub-eszköz kiépítési szolgáltatásban.
...
Regisztráció létrehozása Szimmetrikus kulcs tanúsítványtípussal
...
Regisztráció létrehozása TPM-tanúsítványsal.
...
Regisztráció létrehozása X509-es tanúsítványtípussal
...
Hozzon létre egy regisztrációt Szimmetrikuskulcs típusú és kezdeti beállításállapotú tanúsítványokkal.
...
### -EndorsementKey
TPM-támogató kulcs TPM-eszközhöz.
...
### -PrimaryCAName
Az elsődleges legfelső szintű hitelesítésszolgáltatói tanúsítvány neve.
Ha a legfelső szintű hitelesítésszolgáltatói tanúsítvánnyal való hitelesítést szeretné biztosítani, akkor meg kell adni egy legfelső szintű hitelesítésszolgáltató nevét.
...
### -PrimaryCertificate
Az elsődleges tanúsítványt tartalmazó fájl elérési útja.
Az X509-es tanúsítvány .cer fájl vagy .pem fájl elérési útvonalának 64-es alapformátumú reprezentációja.
...
### -PrimaryKey
A base64 formátumban tárolt elsődleges szimmetrikus megosztott hozzáférési kulcs.
...
### -RootCertificate
Főtanúsítványok használatával X509atte-tanúsítványt hozhat létre.
...
### -SecondaryCAName
A másodlagos legfelső szintű hitelesítésszolgáltatói tanúsítvány neve.
Ha a legfelső szintű hitelesítésszolgáltatói tanúsítvánnyal való hitelesítést szeretné biztosítani, akkor meg kell adni egy legfelső szintű hitelesítésszolgáltató nevét.
...
A másodlagos tanúsítványt tartalmazó fájl elérési útja.
Az X509-es tanúsítvány .cer fájl vagy .pem fájl elérési útvonalának 64-es alapformátumú reprezentációja.
...
### -SecondaryKey
A másodlagos szimmetrikus megosztott hozzáférési kulcs, amely base64 formátumban van tárolva.
...
### -StorageRootKey
TPM-eszköz TPM-tárterületének gyökérkulcsa.
