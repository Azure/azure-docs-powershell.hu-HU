...
## LEÍRÁS
Az Azure IoT Hub eszköz kiépítési szolgáltatásában található regisztrációs csoportok részleteinek leigénylése vagy az összes regisztrációs csoport felsorolása.
