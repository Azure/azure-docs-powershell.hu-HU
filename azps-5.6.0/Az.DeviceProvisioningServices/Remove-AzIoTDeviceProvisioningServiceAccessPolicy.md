...
A megosztott hozzáférési házirend "mypolicy" törlése egy Azure IoT Hub-eszköz kiépítési szolgáltatásában.
...
A megosztott hozzáférési házirend "mypolicy" törlése egy Azure IoT Hub-eszköz kiépítési szolgáltatásában egy folyamat használatával.
