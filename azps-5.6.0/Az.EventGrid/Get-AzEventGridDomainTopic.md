...
Ha a tartománytémakrata nevét is meg kell adni, akkor a rendszer visszaadja egyetlen Eseményrács tartománytémának a részleteit.
...
A MyResourceGroupName erőforráscsoport Eseményrács tartomány1 eseményrács tartománya tartomány1 csoportjában található \` \` \` DomainTopic1 \` \` eseményrács tartománytémaktémát \` tartalmazza.
