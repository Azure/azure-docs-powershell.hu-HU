...
## LEÍRÁS
A Get-AzEventGridSubscription parancsmag vagy egy megadott Event Grid-előfizetés adatait, vagy az aktuális Azure-előfizetés vagy erőforráscsoport eseményrács-előfizetésének listáját kapja meg.
...
Az Esemény-előfizetés \` EventSubscription1 nevű, a \` \` \` \` MyResourceGroupName erőforráscsoportban a Témakör1 témaköréhez létrehozott részleteket \` tartalmazza.
...
Tördelés nélkül megkapja a megadott EventHub névtérhez létrehozott összes esemény-előfizetés listáját.
