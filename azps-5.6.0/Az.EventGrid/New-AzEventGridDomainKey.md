...
A \' MyResourceGroupName erőforráscsoportBan az Event Grid tartomány1 eseményrács tartomány1 kulcsának megfelelő kulcs \` \` \` újragenerálásával. \`
...
A MyResourceGroupName erőforráscsoport Eseményrács tartomány1 eseményrács tartományának 2\. kulcsának megfelelő kulcs újragenerálásával használja a \' \` teljes \` \` \` erőforrás-azonosítót.
