...
## LEÍRÁS
A **New-AzFrontDoorBackendpoolsSettingObject** parancsmag létrehoz egy új PSBackendPoolsSettings objektumot a Front Door létrehozásához.
...
### 2. példa: BackendPoolsSettings objektum létrehozása felhasználó által megadott értékekkel
```powershell
...
Kényszerítse-e a tanúsítványnév-ellenőrzést a HTTPS-kérelmeken az összes háttérkészletben.
Nincs hatása a nem HTTPS-ről való kérelmekre.
...
Időtúllépés küldése és fogadása a háttérnek való továbbítási kéréskor. Az időkorlát elérésekor a kérés sikertelen lesz, és visszatér.
