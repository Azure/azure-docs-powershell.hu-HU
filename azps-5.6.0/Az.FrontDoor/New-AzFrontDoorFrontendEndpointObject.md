...
Hozzon létre EGY PSFrontendEndpoint-objektumot a Front Door létrehozásához.
...
### -CertificateType
a frontendEndpointtal létesített biztonságos kapcsolatokhoz használt tanúsítvány típusa
...
### -HostName
A frontendEndpoint állomásneve.
...
### -ProtocolType
A biztonságos kézbesítéshez használt TLS-bővítmény protokoll
...
Engedélyezi-e a munkamenet-affinitást ezen az állomáson.
...
A munkamenet affinitása esetén másodpercben használható TTL, ha van. Az alapértelmezett érték 0
...
### -Vault
Az SSL-tanúsítványt tartalmazó kulcstároló
...
### -WebApplicationFirewallPolicyLink
A webalkalmazás tűzfal házirendje erőforrás-azonosítója az egyes gazdakiszolgálókhoz (ha van ilyen)
