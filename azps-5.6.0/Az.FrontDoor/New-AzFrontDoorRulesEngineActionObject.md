...
A "New-AzFrontDoorHeaderActionObject" parancsmag használatával PSHeaderObjects parancsmagokat hozhat létre, amelyek a "-RequestHeaderActions" és a "-ResponseHeaderActions" paraméterbe írják át őket.
...
Hozzon létre egy szabálymotor-műveletet, és mutassa meg, hogyan lehet megtekinteni a létrehozott szabálymotor-műveletet.

## PARAMETERS

### -BackendPoolName
Annak a BackendPoolnak a neve, amelyre a szabály
...
Az első?
és & automatikusan megjelenik, ezért ne szerepeljenek az elsőben, hanem válassza el egymástól a lekérdezési karakterláncokat &.
...
### -DynamicCompression
Hogy engedélyezi-e a dinamikus tömörítést a gyorsítótárazott tartalomhoz.
...
### -EnableCaching
Hogy engedélyezi-e a gyorsítótárazást ehhez az útvonalhoz.
...
### -ForwardingProtocol
A szabály által használt protokoll a háttértendékekbe továbbítja a forgalmat.
...
### -RedirectType
A szabály által a forgalom átirányításakor használt átirányítási típus.
Az alapértelmezett érték át van jelölve
...
### -RequestHeaderAction
Az AFD-től a forrásra vonatkozó kérelemben alkalmazandó fejlécműveletek listája.
...
Az AFD-től az ügyfélre adott válaszból alkalmazandó fejlécműveletek listája.
