...
### -MatchValue
Egyezést ad meg az egyező értékeknek.
Az operátor az OR szemantikai operátorral megadott értékeket fogja alkalmazni.
Ha bármelyikük megfelel a megadott operátorral megadott változónak, akkor a feltétel egyezésnek minősül.
...
### -MatchVariable
Változó egyeztetése
Lehetséges értékek: IsMobile, RemoteAddr, RequestMethod, QueryString, PostArg, RequestUri, RequestPath, RequestFileName, RequestfilenameExtension, RequestHeader, RequestFile, RequestScheme
...
### -NegateCondition
Azt írja le, hogy ez nem egy feltétel-e
...
### -Operátor
Az egyezés feltételre alkalmazandó operátort ismerteti.
Lehetséges értékek: Any, IPMatch, GeoMatch, Equal, Contains, LessThan, GreaterThan, LessThanOrEqual, GreaterThanOrEqual, BeginsWith, EndsWith.
...
### -Választó
A választó neve a RequestHeaderben vagy a RequestGépben, hogy egyeztethető legyen
...
### -Átalakítás
Az egyezés előtt alkalmazott átalakítások listája. Az egyes transzformációk lehetséges értékei: Kisbetűk, Nagybetűk, Trim, UrlDecode, UrlEncode, RemoveNulls.
