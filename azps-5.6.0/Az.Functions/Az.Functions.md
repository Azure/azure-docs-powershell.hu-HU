...
# Az.Functions modul
## Leírás
Microsoft Azure PowerShell – A Windows PowerShellben és a PowerShell Coreban elérhető Azure Resource Manager Azure Functions szolgáltatás parancsmagja.\n\nAz Azure-függvényekkel kapcsolatos információkért látogasson el az alábbi webhelyre: https://docs.microsoft.com/azure/azure-functions/
...
Itt érhetők el az adott operációs rendszerhez és tervtípushoz használható függvényalkalmazások.

### [Get-AzFunctionAppPlan](Get-AzFunctionAppPlan.md)
Függvényalkalmazás-csomagokat is lekért egy előfizetésbe.

### [Get-AzFunctionAppSetting](Get-AzFunctionAppSetting.md)
Alkalmazásbeállításokat ad egy függvényalkalmazáshoz.

### [Get-AzSystemAssignedIdentity](Get-AzSystemAssignedIdentity.md)
A megadott RP hatókör alatt elérhetővé válik a systemAssignedIdentity.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
A függvénykulcsok beolvasója egy webhelyen vagy egy központi telepítési helyen található függvények esetén.

### [Get-AzWebAppFunctionKeySzaj](Get-AzWebAppFunctionKeySlot.md)
A függvénykulcsok beolvasója egy webhelyen vagy egy központi telepítési helyen található függvények esetén.

### [Get-AzWebAppSettingKeyVaultReference](Get-AzWebAppSettingKeyVaultReference.md)
Leírás: A konfigurációs referenciaalkalmazás beállításainak és állapotának lekért leírása

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Ennek a leírásnak a leírása lehetővé teszi a powershellen és a ARM keresztüli hívásokat.

### [Get-AzWebAppSyncStatusSzaj](Get-AzWebAppSyncStatusSlot.md)
Ennek a leírásnak a leírása lehetővé teszi a powershellen és a ARM keresztüli hívásokat.
...
### [Move-Az](Move-Az.md)
Leírás: Erőforrások áthelyezése az erőforráscsoportok között.
...
Függvényalkalmazást hoz létre.

### [New-AzFunctionAppPlan](New-AzFunctionAppPlan.md)
Függvényalkalmazás-szolgáltatástervet hoz létre.
...
Egy függvényalkalmazás törlése.
...
Eltávolítja az appbeállításokat egy függvényalkalmazásból.
...
A Szinkronizálások függvény leírása a felügyeleti adatbázis metaadatainak aktiválásához

### [Test-Az](Test-Az.md)
Annak leírása, hogy hogyan ellenőrizheti, hogy lehet-e erőforrást létrehozni.
...
### [ValidateConstionPlanLocation](ValidateConsumptionPlanLocation.md)
