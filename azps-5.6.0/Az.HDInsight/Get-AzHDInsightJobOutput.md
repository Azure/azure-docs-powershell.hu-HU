...
## LEÍRÁS
A **Get-AzHDInsight JobOutput** parancsmag egy Azure HDInsight-fürthöz társított tárfiókból kapja meg egy feladat naplókimenetét.

## PÉLDÁK

### 1. példa: Egy feladat naplókimenetének lekérte
```
PS C:\># Cluster info
...
Ez a parancs a naplókimenetet a saját-hadoop-001 nevű fürtből kapja meg.
...
### -DefaultContainer
Az alapértelmezett tárolónevet adja meg.
...
Az alapértelmezett tárfiókkulcsot adja meg.
...
Az alapértelmezett tárfiók nevét adja meg.
...
### -DisplayOutputType
A kért kimeneti típus megadása.
...
### -JobId
Annak a feladatnak a feladatazonosítóját adja meg, amelynek kimenetét lekéri a alkalmazás.
