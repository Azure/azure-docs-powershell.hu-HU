...
## LEÍRÁS
A **New-AzHDInsightMapReduce JobDefinition** parancsmag új MapReduce-feladatot határoz meg azure HDInsight-fürthöz való használatra.

## PÉLDÁK

### 1. példa: MapReduce-feladatdefiníció létrehozása
```
PS C:\># Cluster info
...
Ezzel a paranccsal MapReduce-feladatdefiníciót hoz létre.
...
### -ClassName
A JAR-fájlban található feladatosztályt adja meg.
...
### -JarFile
A feladathoz használni kívánt JAR-fájl.
...
### -LibJars
A feladathoz a lib JARS-t adja meg.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightMapReduceÚtDefinition
