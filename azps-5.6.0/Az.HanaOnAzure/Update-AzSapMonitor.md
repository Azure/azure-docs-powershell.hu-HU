...
### 1. példa: SAP-monitor frissítése név szerint
```powershell
...
Ez a parancs név szerint frissíti az SAP-monitort.

### 2. példa: SAP-monitor frissítése objektum szerint
```powershell
...
Ez a parancs objektumról objektumra frissíti az SAP-monitort.
