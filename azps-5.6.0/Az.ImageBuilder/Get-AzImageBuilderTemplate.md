...
### 4. példa: Sablon lekérte egy erőforráscsoport alatt
```powershell
...
Az előfizetés azonosítója minden szolgáltatási hívás URI-jának részét képezi.
...
INPUTOBJECT: <IImageBuilderIdentity> Identity Parameter
  ...
  - `[SubscriptionId <String>]`: Az előfizetés hitelesítő adatai, amelyek egyedileg azonosítják a Microsoft Azure-előfizetést. Az előfizetés azonosítója minden szolgáltatási hívás URI-jának részét képezi.
