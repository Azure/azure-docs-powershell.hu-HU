...
## LEÍRÁS
Az IoT Edge-telepítés vagy az IoT Edge-telepítések listája az IoT-központban.
...
Az IoT Edge-telepítés részleteinek megtekintése.
...
Az IoT-központban felsorolja az Összes IoT Edge-telepítést.
