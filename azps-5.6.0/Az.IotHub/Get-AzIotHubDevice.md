...
## LEÍRÁS
Az Iot Hub-eszközök részleteinek megtekintése vagy az Iot-központ összes eszközének felsorolása.
...
Az Iot-központban az összes eszköz megjelenítése.
...
Az IoT-központot tartalmazó eszközök részleteinek lekérte.
