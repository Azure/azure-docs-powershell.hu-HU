...
## LEÍRÁS
Útvonal szerkesztése Frissítheti az útvonal összes mezőjét, beleértve az adatforrást, a végpontot és az útválasztási lekérdezést, valamint engedélyezheti vagy letilthatja az útvonalat.
...
Az útvonal adatainak frissítése.
...
### -Feltétel
Az útválasztási szabály alkalmazásához kiértékelt feltétel
