...
## LEÍRÁS
Az **Add-AzKeyVaultCertificate** parancsmag elindítja a tanúsítvány regisztrálását egy kulcstárolóban az Azure Key Vaultban.
...
Az első parancs a New-AzKeyVaultCertificatePolicy parancsmag használatával hoz létre egy tanúsítványházi házirendet, majd a $Policy tárolja.
A második parancs **az Add-AzKeyVaultCertificate** segítségével indítja el a tanúsítvány létrehozásához szükséges folyamatot.
A harmadik parancs a Get-AzKeyVaultCertificateOperation parancsmag segítségével ellenőrzi, hogy befejeződött-e a művelet.
Az utolsó parancs a Get-AzKeyVaultCertificate parancsmag használatával szerez be tanúsítványt.
...
### -Name
A hozzáadni szükséges tanúsítvány neve.
