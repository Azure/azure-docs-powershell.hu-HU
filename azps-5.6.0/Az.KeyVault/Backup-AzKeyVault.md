...
A parancsmag létrehoz egy mappát (általában névvel) a tárolóban, a biztonsági másolatot ebben a mappában tárolja, és kimenetként hozza létre a mappa `mhsm-{name}-{timestamp}` URI-ját.
