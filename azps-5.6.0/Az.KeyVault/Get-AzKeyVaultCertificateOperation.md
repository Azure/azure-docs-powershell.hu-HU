...
## LEÍRÁS
A **Get-AzKeyVaultCertificateOperation parancsmag** egy tanúsítványművelet állapotát kapja meg.

## PÉLDÁK

### 1. példa: Tanúsítványművelet állapotának ellenőrzése
```powershell
...
Ez a parancs a ContosoKV01 kulcstárolóBan található TestCert01 tanúsítványművelet állapotát kapja meg.
