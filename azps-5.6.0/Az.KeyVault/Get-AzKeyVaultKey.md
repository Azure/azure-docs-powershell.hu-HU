...
Ez a parancs a Contoso nevű kulcstárban a "teszt" kezdetű összes kulcsot megkapja.
...
Ez a lépés a HSM által védett kulcsok importálása az Azure-kulcstárba. Lásd: https://docs.microsoft.com/azure/key-vault/keys/hsm-protected-keys
