...
A "myvault" tároló által kezelt, kulcstár által felügyelt tárfiókhoz tartozó összes SAS-definíciót felsorolja.
...
A "myvault" nevű tároló által kezelt tárhoz tartozó SAS-definíciós "accountsas" adatait tartalmazza.

### 3. példa: Az összes kulcstár által felügyelt tár SAS-definíciójának felsorolása szűrés használatával
```powershell
...
### -InRemovedState
Megadja, hogy meg kell-e mutatni a korábban törölt tárolási sas-definíciókat a kimenetben.
