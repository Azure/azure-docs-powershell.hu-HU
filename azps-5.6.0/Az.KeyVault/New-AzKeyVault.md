...
## LEÍRÁS
A **New-AzKeyVault parancsmag** létrehoz egy kulcstárat a megadott erőforráscsoportban. Ez a parancsmag engedélyeket ad a jelenleg bejelentkezett felhasználónak a kulcstárban lévő kulcsok és titkos kulcsok hozzáadásához, eltávolításához vagy listához.
...
Egy kulcstár létrehozása és hálózati szabályok megadása a megadott IP-cím eléréséhez az $myNetworkResId. További `New-AzKeyVaultNetworkRuleSetObject` információt itt is láthat.
...
### -Name
Megadja a létrehozni szükséges kulcstár nevét. A név betűk, számjegyek vagy kötőjelek bármilyen kombinációja lehet. A névnek betűvel vagy számjegysel kell kezdődnie és végződnie. A névnek univerzálisan egyedinek kell lennie.
...
Azt adja meg, hogy mennyi ideig őrzi meg a rendszer a törölt erőforrásokat, és hogy mennyi ideig tart egy tároló vagy objektum törlése a törölt állapotban. Az alapértelmezett érték 90 nap.
