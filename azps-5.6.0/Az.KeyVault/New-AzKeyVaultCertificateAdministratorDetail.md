...
## LEÍRÁS
A **New-AzKeyVaultCertificateAdministratorDetail** parancsmag létrehoz egy memória-tanúsítvány rendszergazdai adatait tartalmazó objektumot.

## PÉLDÁK

### 1. példa: Tanúsítvány-rendszergazdai részletek objektum létrehozása
```
...
Ez a parancs létrehoz egy memória-tanúsítvány rendszergazdai részleteket tartalmazó objektumot, majd tárolja azt a $AdminDetails változóban.
...
### -EmailAddress
A tanúsítvány-rendszergazda e-mail-címét adja meg.
...
### -FirstName
A tanúsítvány-rendszergazda vezetékneve.
...
### -LastName
A tanúsítvány rendszergazdájának vezetékneve.
...
### -PhoneNumber
A tanúsítvány rendszergazdájának telefonszámát adja meg.
