...
## LEÍRÁS
A **Remove-AzKeyVaultCertificate** parancsmag eltávolítja a tanúsítványt a kulcstárolóból.
...
Ez a parancs eltávolítja a SelfSigned01 nevű tanúsítványt a ContosoKV01 nevű kulcstárolóból.
Ez a parancs a *Force paramétert* adja meg.
Ezért a parancsmag nem kér megerősítést.

### 2. példa: A törölt tanúsítvány végleges törlése a kulcstárolóból
```powershell
PS C:\> Remove-AzKeyVaultCertificate -VaultName 'Contoso' -Name 'MyCert' -InRemovedState
```

Ez a parancs véglegesen eltávolítja a "MyCert" nevű tanúsítványt a "Contoso" kulcstárolóból.
A parancsmag végrehajtatása "végleges végleges" engedélyt igényel, amelyet korábban és kifejezetten a kulcstárban adott meg a felhasználónak.
...
### -InRemovedState
Ha van ilyen, véglegesen eltávolítja a korábban törölt tanúsítványt
...
### -Name
Annak a tanúsítványnak a nevét adja meg, amelyről a parancsmag eltávolítja a kulcstárolót.
Ez a parancsmag egy tanúsítvány teljes tartománynevét (FQDN) építi fel a paraméter által megadott név, a kulcstároló neve és az aktuális környezet alapján.
...
### -VaultName
Annak a kulcstárolónak a neve, amelyből a parancsmag eltávolítja a tanúsítványt.
