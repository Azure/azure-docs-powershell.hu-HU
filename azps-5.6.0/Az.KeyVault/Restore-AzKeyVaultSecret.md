...
Ha a kulcstárnak már van ugyanaz a neve, a parancsmag nem tudja felülírni az eredetit.
Ha a biztonsági másolat egy titkos fájl több verzióját tartalmazza, a rendszer az összes verziót visszaállítja.
Az a kulcstár, amelybe visszaállítja a titkos kulcsot, különbözik attól a kulcstártól, amelyről a titkos kulcsot biztonsági másolatként tárolta.
