...
## LEÍRÁS
A **Stop-AzKeyVaultCertificateOperation parancsmag** megszakítja a tanúsítványműveletet az Azure Key Vault szolgáltatásban.

## PÉLDÁK

### 1. példa: Tanúsítványművelet megszakítása
```powershell
...
Ez a parancs megszakítja a TestCert02 tanúsítványműveletet.
