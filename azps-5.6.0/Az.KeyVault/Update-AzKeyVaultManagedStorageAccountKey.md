...
## LEÍRÁS
A kulcstároló által felügyelt Azure Storage-fiók megadott kulcsának újragenerálása és a kulcs aktív kulcsként való beállítja. A kulcstár a kulcs újragenerálásával létrehozza a hívást az Azure Resource Managerhez. A hívónak jogosultságokkal kell rendelkeznie ahhoz, hogy újragenerálja a kulcsokat az adott Azure Storage-fiókon.
...
A "mystorageaccount" "key1" újragenerálja, és beállítja a "key1" kulcsszót a kulcstár által kezelt Azure Storage-fiók aktív felhasználójaként.
...
### -KeyName
A tárfiók kulcsának neve az újrageneráláshoz és az aktívvá tenni.
