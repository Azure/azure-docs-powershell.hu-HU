...
### 1. példa: Konfiguráció létrehozása a rendszernetes fürthöz
```powershell
...
Ez a parancs konfigurációt hoz létre a kubernetes fürthöz.

### 1. példa: Konfigurálás létrehozása a következő paramétert megadásával: operátorNevespace
```powershell
...
Ez a parancs konfigurációt hoz létre az új operátor névterében a kubernetes fürthöz.
Megjegyzés: Nem lehet konfigurációt létrehozni egy meglévő operátor névterében.
...
### -ClusterScoped
Ha a beállításnak megfelelő értéket ad meg, a konfiguráció hatókörét fürtre állíthatja (az alapértelmezett névTér).
