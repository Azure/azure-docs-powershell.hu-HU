...
### 1. példa: Egy fürt összes Kusto-adatbázisának felsorolása név szerint
```powershell
...
### 2. példa: Adott Kusto-adatbázis lekért neve
```powershell
...
A fenti parancs a "testrg" erőforráscsoportban található "testnewkustocluster" fürt "mykustodatabase" nevű Kusto-adatbázisát adja vissza.
