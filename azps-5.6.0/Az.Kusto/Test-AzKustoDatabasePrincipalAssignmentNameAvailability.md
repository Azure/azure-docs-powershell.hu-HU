...
### 1. példa: A használatban álló adatbázis-egyszerű hozzárendelési név elérhetőségének ellenőrzése
```powershell
...
A fenti parancs azt adja vissza, hogy létezik-e "myprincipal" nevű PrincipalAssignment az "mykustodatabase" adatbázisban a "testnewkustocluster" fürtből.

### 2. példa: Egy nem használt adatbázis-egyszerű hozzárendelési név elérhetőségének ellenőrzése
```powershell
...
### -Type
Az erőforrás típusa, Microsoft.Kusto/Clusters/Databases/principalAssignments.
