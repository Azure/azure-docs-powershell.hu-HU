...
## LEÍRÁS
A **Get-AzCmAppUpgradedDefinition parancsmag** egy erőforráscsoportból kapja meg a sémaverzió és a logikai alkalmazás frissített definícióját.
...
### 1. példa: A logic app frissített definíciójának lekérte
```
