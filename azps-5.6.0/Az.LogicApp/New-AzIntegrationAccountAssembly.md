...
## LEÍRÁS
A **Get-AzIntegrationAccountAssembly** parancsmag létrehoz egy új szerelvényt egy integrációs fiókban.

## PÉLDÁK

### 1. példa: Új szerelvény létrehozása helyi fájl használatával
```powershell
...
Létrehoz egy új szerelvényt az "$localAssemblyFilePath" fájl elérési útjában található helyi fájl használatával.

### 2. példa: Új szerelvény létrehozása bájtadatokkal
```powershell
...
Létrehoz egy új szerelvényt a "$assemblyContent" bájttömb használatával.

### 3. példa: Új szerelvény létrehozása tartalomhivatkozás használatával
```powershell
...
Létrehoz egy új szerelvényt a "$assemblyUrl" URL-címen található bájtadatokkal. Ez a javasolt módszer nagy méretű szerelvények létrehozására.
