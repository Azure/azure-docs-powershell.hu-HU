...
## LEÍRÁS
A **Get-AzIntegrationAccountBatchConfiguration** parancsmag létrehoz egy új kötegkonfigurációt egy integrációs fiókban.

## PÉLDÁK

### 1. példa: Új kötegkonfiguráció létrehozása helyi fájl használatával
```powershell
...
Létrehoz egy új kötegkonfigurációt az "$batchConfigurationFilePath" fájl elérési útjában található helyi fájl használatával.

### 2. példa: Új kötegkonfiguráció létrehozása JSON-karakterlánc használatával
```powershell
...
Létrehoz egy új kötegkonfigurációt a "$batchConfigurationContent" JSON karakterlánc használatával.

### 3. példa: Új kötegkonfiguráció létrehozása paraméterek használatával
```powershell
...
Új kötegkonfigurációt hoz létre az összes szükséges paraméter manuális meg biztosításával.
