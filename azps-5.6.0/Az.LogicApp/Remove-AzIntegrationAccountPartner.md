...
## LEÍRÁS
A **Remove-AzIntegrationAccountPartner** parancsmag eltávolít egy integrációs partnert egy erőforráscsoportból.
...
### 1. példa: Integrációs fiók partnerének eltávolítása
```
...
Ez a parancs eltávolítja az IntegrationAccountPartner1 nevű integrációs partnert.
