...
## LEÍRÁS
A **Set-AzIntegrationAccount** parancsmag módosítja az integrációs fiókot.
Ez a parancsmag egy olyan objektumot ad vissza, amely az integrációs fiókot képviseli.
...
### 1. példa: Integrációs fiók módosítása
```
...
Ez a parancs módosítja az IntegrationAccount31 nevű integrációs fiókot a megadott erőforráscsoportban.
