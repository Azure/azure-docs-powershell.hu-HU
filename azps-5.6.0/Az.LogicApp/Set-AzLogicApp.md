...
## LEÍRÁS
A **Set-Az EgészAlkalmazás** parancsmag a Logic Apps funkcióval módosítja a logikai appokat.
...
A logikai appokat név, hely, Logic App-definíció, erőforráscsoport és terv megadásával módosíthatja.
...
### 1. példa: Logikai alkalmazás módosítása
```
...
Ez a parancs módosít egy logikai alkalmazást.
...
### -Name
Egy logikai alkalmazás nevét adja meg.
...
### -UseConstionModel
Azt jelzi, hogy a logic app számlázása a felhasználásalapú modellt használja.
