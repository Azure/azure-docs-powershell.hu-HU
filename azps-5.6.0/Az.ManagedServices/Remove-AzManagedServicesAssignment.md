...
## SYNOPSIS
Egy regisztrációs feladat törlése.
...
Törli a regisztrációs hozzárendelést név szerint az alapértelmezett hatókörben.
...
A megadott bemeneti objektum használatával törli a regisztrációs hozzárendelést.
...
Törli a regisztrációs hozzárendelést név szerint a megadott hatókörben.
...
### -InputObject
A regisztrációs hozzárendelés-objektum.
...
### -Scope
A regisztráció-hozzárendelés hatóköre.
