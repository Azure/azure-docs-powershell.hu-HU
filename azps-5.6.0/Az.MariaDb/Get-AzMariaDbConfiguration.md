...
### 1. példa: A MariaDB alatti összes konfiguráció felsorolása
```powershell
...
Ez a parancs felsorolja a MariaDB alatti összes konfigurációt.

### 2. példa: A MariaDB konfigurációjának beállítása
```powershell
...
Ez a parancs a MariaDB konfigurációt kapja.
