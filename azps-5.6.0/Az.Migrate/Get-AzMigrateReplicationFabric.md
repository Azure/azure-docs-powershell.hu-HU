...
### 1. példa: Az összes anyag behozása erőforráscsoport és tárolónév szerint
```powershell
...
Az összes anyag behozása az erőforráscsoportba és a tárolóba

### 2. példa: Anyag behozása erőforráscsoportok, tárolónév és anyagnév szerint
```powershell
