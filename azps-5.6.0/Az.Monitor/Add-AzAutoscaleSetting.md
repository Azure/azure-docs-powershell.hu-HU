...
Az első két parancs a [New-AzAutoscaleRule](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscalerule) segítségével hoz létre két automatikus skálázási szabályt( $Rule 1 és $Rule 2.
A harmadik és negyedik parancs a [New-AzAutoscaleProfile](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscaleprofile) segítségével hozza létre az $Profile 1 és a $Profile 2 autoskálaprofilokat az $Rule 1 és a $Rule 2 segítségével.
Az utolsó parancs létrehoz egy automatikus skálázási beállítást a $Profile 1 és a $Profile 2 profiljaival.
