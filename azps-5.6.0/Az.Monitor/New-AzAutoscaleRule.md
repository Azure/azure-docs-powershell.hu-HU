...
## LEÍRÁS
Az **Új-AzAutoscaleRule** parancsmag létrehoz egy automatikus skálázási szabályt.
...
Az első parancs létrehoz egy szabályt a Kérelmek metrikára, majd azt a $Rule 1 változóban tárolja.
A második parancs létrehoz egy második szabályt a Kérelmek mutatóhoz, majd a $Rule 2 változóban tárolja.

### 3. példa

Automatikus skálázási szabályt hoz létre. (automatikusan generált)
...
### -MetricResourceId
A metrikus erőforrásazonosítót adja meg.
...
### -MetricStatistic
A metrikus statisztika megadása.
...
### -ScaleActionCooldown
Az Automatikus skálázás művelet lehűtődési idejét adja meg.
...
A méretezési művelet irányát határozza meg.
A paraméter elfogadható értékei a következőek:
- Nincs
- Növekedés
- Csökkenés
...
A méretarány típusát határozza meg.
A paraméter elfogadható értékei a következőek:
- ChangeSize
- ChangeCount
- PercentChangeCount
...
### -Threshold
A metrikus érték küszöbértékét határozza meg.
...
Az időösszesítő operátort adja meg.
A paraméter elfogadható értékei a következőek:
- Átlag
- Minimum
- Maximum
