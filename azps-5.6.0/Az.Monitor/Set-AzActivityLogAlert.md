...
Az utolsó parancs egy tevékenységnapló-riasztást hoz létre a feltétel és a műveletcsoport használatával.
...
Az első parancs a nop-hoz hasonlóan beállítja a riasztást ugyanazokkal az értékekkel, amelyek már tartalmazták a többi parancsot is, beolvassa a riasztási szabályt, módosítja a leírást, és letiltja, majd az InputObject paraméter használatával megőrzi ezeket a módosításokat.
...
### -DisableAlert
Lehetővé teszi, hogy a felhasználó letiltott tevékenységnapló-riasztást hozzon létre. Ha nincs megadva, a riasztások engedélyezve vannak.
