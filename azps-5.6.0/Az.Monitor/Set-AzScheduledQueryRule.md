...
## LEÍRÁS
Naplóriasztás szabályának frissítése PUT szemantikai adatok alapján

## PÉLDÁK

### 1. példa: Beállítás szabálynév szerint
```powershell
...
### 2. példa: Bemeneti objektum által beállítva
```powershell
...
### 3. példa: Beállítás erőforrás-azonosító szerint
```powershell
...
### -Művelet
Az ütemezett lekérdezési szabály riasztási művelete
...
### -Source
Az ütemezett lekérdezési szabályforrás
