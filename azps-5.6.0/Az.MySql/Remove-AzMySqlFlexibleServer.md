...
### 1. példa: A MySql-kiszolgáló eltávolítása erőforráscsoport és kiszolgálónév alapján
```powershell
PS C:\> Remove-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Ez a parancsmag eltávolítja a MySql-kiszolgálót az resourceGroup és a kiszolgáló neve alapján.

### 2. példa: A MySql-kiszolgáló eltávolítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás szerint eltávolítják a MySql-kiszolgálót.
