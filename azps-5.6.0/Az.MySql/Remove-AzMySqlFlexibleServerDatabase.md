...
### 1. példa: A MySql-adatbázis eltávolítása név szerint
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

Ez a parancsmag név szerint eltávolítja a MySql-adatbázist.

### 2. példa: A MySql-adatbázis eltávolítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás szerint eltávolítják a MySql-adatbázist.
