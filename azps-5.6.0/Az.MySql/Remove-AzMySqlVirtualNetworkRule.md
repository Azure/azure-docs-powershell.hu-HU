...
### 1. példa: A MySql-kiszolgáló virtuális hálózatszabályának eltávolítása név szerint
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Ez a parancsmag név szerint eltávolítja a MySql-kiszolgáló virtuális hálózatszabályát.

### 2. példa: A MySql-kiszolgáló virtuális hálózatszabályának eltávolítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás szerint eltávolítják a MySql-kiszolgáló virtuális hálózatszabályát.
