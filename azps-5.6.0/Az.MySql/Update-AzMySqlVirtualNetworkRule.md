...
### 1. példa: A MySql virtuális hálózat szabályának frissítése név szerint
```powershell
...
Ez a parancsmag név szerint frissíti a MySql virtuális hálózat szabályát.

### 2. példa: A MySql virtuális hálózat szabályának frissítése identitás alapján.
```powershell
...
Ezek a parancsmagok identitás szerint frissítik a MySql virtuális hálózat szabályát.
