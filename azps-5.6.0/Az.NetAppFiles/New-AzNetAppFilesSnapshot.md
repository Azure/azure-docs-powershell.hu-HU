...
## LEÍRÁS
A **New-AzNetAppFilesSnapshot** parancsmag ANF-pillanatképet hoz létre.
...
Ez a parancs létrehozza az új ANF-pillanatképet (MyAnfSnapshot) a "MyAnfVolume" köteten belül.
...
### -VolumeObject
Az új pillanatkép-objektum hangereje
