...
## LEÍRÁS
A **Remove-AzNetAppFilesSnapshot** parancsmag törli az ANF-pillanatfelvételt.
...
Ez a parancs törli a "MyAnfSnapshot" ANF-pillanatképet.
...
### -ResourceGroupName
Az ANF-pillanatfelvétel erőforráscsoportja
...
### -VolumeObject
Az eltávolítható pillanatképet tartalmazó kötetobjektum
