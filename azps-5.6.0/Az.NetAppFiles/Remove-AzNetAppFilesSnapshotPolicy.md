...
## LEÍRÁS
A **Remove-AzNetAppFilesSnapshotPolicy** parancsmag egy ANF-pillanatfelvételi házirendet töröl.
...
### -InputObject
Az eltávolítható SnapshotPolicy objektum
...
### -PassThru
Annak visszaadése, hogy a megadott fiók eltávolítása sikeresen megtörtént-e
