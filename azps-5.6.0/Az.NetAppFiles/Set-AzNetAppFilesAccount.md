...
## LEÍRÁS
A **Set-AzNetAppFilesAccount** parancsmag módosítja az ANF-fiókot.

## PÉLDÁK

### 1. példa: ANF-fiók módosítása
```
...
Ez a parancs frissítést hajt végre az adott fiókon. Az Active Directory hiányában a rendszer eltávolítja azt a fiókból.

## PARAMETERS

### -ActiveDirectory
Az aktív könyvtárakat képviselő kivonatos tömb
