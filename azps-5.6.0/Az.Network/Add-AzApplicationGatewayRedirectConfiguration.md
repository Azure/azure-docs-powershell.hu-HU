...
## LEÍRÁS
Az **Add-AzApplicationGatewayRedirectConfiguration parancsmag** hozzáad egy átirányítási konfigurációt egy alkalmazás-átjáróhoz.
...
Átirányítási konfigurációt ad hozzá egy alkalmazás-átjáróhoz. (automatikusan generált)
