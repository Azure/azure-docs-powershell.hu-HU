...
## LEÍRÁS
Az **Add-AzDelegation** parancsmag hozzáad egy szolgáltatásdelegálást egy Azure-alhálózathoz.
...
Az első parancs beolvassa azt a virtuális hálózatot, amelyen az alhálózat található. A második parancs elkülöníti az érdekes alhálózatot – azt, amelyiket meg szeretné delegálni. A harmadik parancs delegálást ad az alhálózathoz. Ez a példa akkor lehet hasznos, ha engedélyezni szeretné az SQL-nek, hogy felületi végpontokat hozzon létre ebben az alhálózatban. Az utolsó parancs elküldi a frissített alhálózatot a kiszolgálónak, hogy ténylegesen frissítse az alhálózatot.
