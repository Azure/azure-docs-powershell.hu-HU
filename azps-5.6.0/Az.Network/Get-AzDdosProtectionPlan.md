...
Ebben az esetben a **ResourceGroupName** és a **Name** attribútumot is meg kell adnunk, amelyek megfelelnek az erőforráscsoportnak, illetve a DDoS védelmi tervnek.
...
Ez a parancsmag a "test" kezdetű DdosProtectionPlans parancsmagot adja vissza.
