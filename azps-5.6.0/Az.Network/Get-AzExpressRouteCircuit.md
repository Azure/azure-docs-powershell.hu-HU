...
## LEÍRÁS
A **Get-AzExpressRouteCircuit** parancsmaggal lekérhető egy ExpressRoute-áramköri objektum az előfizetéséből. A visszaadott áramköri objektum használható bemenetként az ExpressRoute-áramkörön működő más parancsmagok számára.
