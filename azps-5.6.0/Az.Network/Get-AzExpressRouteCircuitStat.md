...
## LEÍRÁS
A **Get-AzExpressRouteCircuitStat** parancsmag beolvassa egy ExpressRoute-áramkör forgalmi statisztikáját. A statisztikákban az elsődleges és a másodlagos útvonalon küldött és fogadott bájtok száma is szerepel.
