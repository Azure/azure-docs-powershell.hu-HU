...
## LEÍRÁS
A **Get-AzExpressRouteCrossConnectionPeering** parancsmag beolvassa egy társviszony konfigurációját egy ExpressRoute-keresztkapcsolathoz.

## PÉLDÁK

### 1. példa: Az ExpressRoute-kapcsolat társviszony-konfigurációjának megjelenítése
```
...
Az ExpressRoute-kapcsolati objektum, amely a társviszony-konfigurációt tartalmazza.
...
### -Name
A visszakeresni szükséges társviszony-konfiguráció neve.
