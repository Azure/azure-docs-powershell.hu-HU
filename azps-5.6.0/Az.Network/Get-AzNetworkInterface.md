...
### 2. példa: Az összes hálózati felület lekérte az adott kiépítési állapotot
```
...
Ez a parancs az Erőforráscsoport1 nevű erőforráscsoport minden olyan hálózati felületét beveszi, amelyek kiépítési állapota sikeres.
...
### -VirtualMachineIndex
Annak a virtuális gépnek a virtuális gép méretarány-készletét adja meg, amelyből a parancsmag hálózati felületekhez jut.
...
Annak a virtuálisgép-méretarány-készletnek a neve, amelyből a parancsmag hálózati felületekhez jut.
