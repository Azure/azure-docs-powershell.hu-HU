...
Létrehozza a "RuleRuleSetType" típusú FelügyeltRuleSetet $ruleSetType, ruleSetVersion as $ruleSetVersion és RuleGroupOverrides mint teljes listát $ruleGroupOverride 1, $ruleGroupOverride 2 Az új ManagedRuleSet hozzá van rendelve a $managedRuleSet
