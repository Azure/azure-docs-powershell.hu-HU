...
### 2. példa: Statikus privát IP-cím létrehozása előlapi IP-címként
```
...
Ez csak akkor lehet megadni, ha meg van adva egy alhálózat.
...
### -SubnetId
Azt az alhálózati azonosítót adja meg, amelyet ez a parancsmag társít az alkalmazás átjárójának előtér-IP-konfigurációjával.
