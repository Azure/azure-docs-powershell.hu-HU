...
## LEÍRÁS
**A New-AzApplicationGatewayRedirectConfiguration parancsmag** létrehoz egy átirányítási konfigurációt egy alkalmazás-átjáróhoz.
...
Ez a parancs létrehoz egy Redirect01 nevű átirányítási konfigurációt, és az eredményt a következő nevű változóban $RedirectConfig.

### 2. példa

Átirányítási konfigurációt hoz létre egy alkalmazás-átjáróhoz. (automatikusan generált)
