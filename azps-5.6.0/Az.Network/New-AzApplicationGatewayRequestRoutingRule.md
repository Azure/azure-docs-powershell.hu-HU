...
## LEÍRÁS
**Az Add-AzApplicationGatewayRequestRoutingRule** parancsmag létrehoz egy kéréstovábbítási szabályt egy Azure-alkalmazás-átjáróhoz.

## PÉLDÁK

### 1. példa: Kéréstovábbító szabály létrehozása alkalmazás-átjáróhoz
```
...
Ez a parancs létrehoz egy Szabály01 nevű egyszerű kéréstovábbítási szabályt, és az eredményt a Következő nevű változóban $Rule.

## PARAMETERS

### -BackendAddressPool
Megadja a háttércímkészletet objektumként ahhoz, hogy létrejöjjön a kérés útválasztási szabálya.
...
A létrehozni kért útválasztási szabály háttércímkészlet-azonosítóját adja meg.
...
### -BackendHttpSettings
Megadja a háttér-HTTP-beállításokat objektumként ahhoz, hogy a kéréstovábbirányítási szabály létrejöjjön.
...
A létrehozni kért útválasztási szabály háttér-HTTP-beállításazonosítóját adja meg.
...
### -HttpListener
Megadja a létrehozni szükséges kéréstovábbító szabály háttér-HTTP- hallgatóját.
...
### -HttpListenerId
Megadja a létrehozható kéréstovábbító szabály háttér-HTTP-jának listener-azonosítóját.
...
### -Name
A parancsmag által létrehozott kérés-útválasztási szabály nevét adja meg.
