...
## LEÍRÁS
**A New-AzApplicationGatewayRewriteRuleActionSet** parancsmag létrehoz egy újraírási szabály műveletkészletet egy Azure-alkalmazás átjáróhoz.
...
Ez a parancs egy újraírási szabály-műveletkészletet hoz létre, és az eredményt a következő nevű változóban $action.
...
Kérésfejléc-konfigurációk listája
...
Válaszfejléc-konfigurációk listája
