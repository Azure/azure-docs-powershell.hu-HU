...
Ebben a példában egy tűzfalat hozunk létre, amely lehetővé teszi az összes HTTPS-forgalmat a 443-as porton.
...
Ebben a példában egy tűzfal jött létre, amely lefordította a cél IP-címét és az összes csomag portját, amely a 10.1.2.3:80-as és a 10.2.3.4.4:8080 Threat Intel-re van ki kapcsolva ebben a példában.
...
Ez azt jelenti, hogy a többi szabály alkalmazása előtt figyelmeztetést küld a naplókról a kártékony adatforgalomhoz (ebben az esetben csak az alapértelmezett szabály – Az összes elutasítása)

### 5. példa: Tűzfal létrehozása, amely lehetővé teszi az összes HTTP-adatforgalmat a 8080-as porton, de letiltja a Threat Intel által azonosított kártékony tartományokat
```powershell
$rgName = "resourceGroupName"
$vnet = Get-AzVirtualNetwork -ResourceGroupName $rgName -Name "vnet"
$pip = Get-AzPublicIpAddress -ResourceGroupName $rgName -Name "publicIpName"
...
Ebben a példában egy tűzfalat hoz létre, amely a "99.99.99.0/24" és a "66.66.0.0/16" ip-címtartományt magánjellegű IP-tartományként kezeli, és nem fogja e címek forgalmát elgépelni.
...
A tűzfalhoz 2 nyilvános, implicit módon létrehozott IP-t rendelünk hozzá.
...
### -ResourceGroupName
A tűzfalat tartalmazó erőforráscsoport nevét adja meg.
...
### -Zone
A rendelkezésre állási zónák listája, amely azt sorolja fel, hogy honnan kell a tűzfalnak létrejöjjön.
