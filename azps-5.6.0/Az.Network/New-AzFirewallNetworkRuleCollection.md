...
Ha egy másik, magasabb prioritású (kisebb számú) szabálygyűjtemény is van, amely az $rule 1-ben vagy a $rule 2-ben azonosított forgalommal is egyezik, akkor a magasabb prioritású szabálygyűjtemény művelete lép életbe. 
...
Ebben a példában egy új hálózatszabály-gyűjteményt hoz létre egy s szabály alapján, majd név szerint kapja meg a szabályt, a GetRuleByName hívási metódust a szabálygyűjtemény-objektumon. A GetRuleByName metódus szabályneve a kis- és
