...
## LEÍRÁS
A **New-AzFirewallPolicyRuleCollectionGroup** parancsmag létrehoz egy szabálycsoportot egy Azure tűzfalházi házirendben.
...
Ebben a példában egy szabálycsoportot hoz létre a tűzfal házirend-$fp

### 2. példa

Hozzon létre egy új Azure firewall policy rule collection group. (automatikusan generált)
