...
## SYNOPSIS
Háttércímkészletet hoz létre egy loadbalancer eszközben. 
...
## LEÍRÁS
Háttércímkészletet hoz létre egy loadbalancer eszközben. Lehetővé teszi a PSLoadBalancerBackendAddress tömbje megírását. 
## PÉLDÁK
...
### -ResourceGroupName
A terheléselosztás erőforráscsoportneve.
