...
## LEÍRÁS
A **New-AzNetworkInterfaceIpConfig** parancsmag létrehoz egy Azure hálózatifelület-IP-konfigurációt egy hálózati felülethez.
...
Az első két parancs egy myvnet nevű virtuális hálózatot, illetve egy korábban létrehozott mysubnet nevű alhálózatot kap. Ezeket a fájlok a $vnet, illetve $Subnet tárolják. A harmadik parancs létrehoz egy új IP-konfigurációt (IPConfig-2) egy 10.0.0.5-ös személyes IP-címmel.
Az utolsó parancs ezután létrehoz egy mynic1 nevű hálózati felületet ezzel az IP-konfigurációval.
...
Megadja a terheléselosztás bejövő natszabály-hivatkozásai gyűjteményét, amelyekhez ez a hálózati felület IPConfiguration tartozik.
