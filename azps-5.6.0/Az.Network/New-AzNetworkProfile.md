...
## LEÍRÁS
A **New-AzNetworkProfile** parancsmag létrehoz egy új, legfelső szintű hálózati profil-erőforrást.
...
Ez egy új, legfelső szintű hálózati profil típusú erőforrást hoz létre

### 2. példa

Létrehoz egy új hálózati profilt. (automatikusan generált)
...
### -ContainerNicConfig
Az ehhez a hálózati profilhoz hozzáadható tárolóhálózati felület konfigurációja.
