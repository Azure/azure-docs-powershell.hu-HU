...
## LEÍRÁS
A New-AzP2sVpnGateway parancsmag lehetővé teszi egy új P2SVpnGateway létrehozására a VirtualHub alatt a Point to site connectivity lehetőséget a Point to site clients to Azure VirtualWan szolgáltatáshoz.
