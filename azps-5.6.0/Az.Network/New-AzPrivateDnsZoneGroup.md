...
## LEÍRÁS
A **New-AzPrivateDnsZoneGroup** parancsmag lehetővé teszi, hogy új privát DNS-zónacsoportot hozzon létre.
...
A privát végpont létrehozása után a fenti példa a DNS-zónacsoportot a magánjellegű végpont `test-pr-endpoint` alatt hozza létre.
...
A privát DNS-zónacsoport privát DNS-zónakonfigurációinak gyűjteménye.
