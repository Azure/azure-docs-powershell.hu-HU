...
## LEÍRÁS
A **New-AzPrivateLinkService** parancsmag létrehoz egy privát hivatkozásszolgáltatást

## PÉLDÁK

### 1. példa

Az alábbi példa létrehoz egy privát hivatkozásszolgáltatást.
...
### -AutoApproval
A privát hivatkozásszolgáltatás automatikus jóváhagyási előfizetései
...
### -EnableProxyProtocol
Proxy protokoll engedélyezése a privát csatolási szolgáltatáshoz.
...
### -Láthatóság
A privát hivatkozásszolgáltatás láthatósági előfizetései
