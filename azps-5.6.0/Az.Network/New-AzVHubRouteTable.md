...
## SYNOPSIS
Egy VirtualHubbal társított központi útvonaltábla-erőforrást hoz létre.
...
## LEÍRÁS
Létrehozza a megadott virtuális központhoz társított útvonaltáblát a megadott útvonalokkal és címkékkel.
...
Ez a parancs létrehoz egy központi útválasztási táblát a virtuális központból.
...
### -Útvonal
Az útvonaltáblához az útvonalak listája.
