...
## SYNOPSIS
Nat-szabályt hoz létre a VpnGatewayen, amely a VpnSiteLinkConnectionhoz társítható.
...
## LEÍRÁS
Nat-szabályt hoz létre a VpnGatewayen, amely társítható a VpnGateway-tel.
...
A fentiekkel létrehozhat egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub). Ezután létre fogjuk hozni a VpnGatewayt a virtuális központ alatt. Ezután a következő paranccsal: New-AzVpnGatewayNatRule, NAT-szabály hozható létre és társítható a létrehozott VpnGateway-sel.
...
### -ExternalMapping
A NAT privát IP-cím alhálózati hozzárendeléseinek listája
...
### -ParentObject
A NAT-szabály szülő VpnGatewayje.
...
### -ParentResourceId
A NAT-szabály szülő VpnGateway-ének erőforrás-azonosítója.
