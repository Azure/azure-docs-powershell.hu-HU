...
## SYNOPSIS
Töröl egy Azure RouteServer-kiszolgálót.
...
## LEÍRÁS
A **Remove-AzRouteServer** parancsmag töröl egy Azure RouteServer-kiszolgálót
...
### -InputObject
Az útvonalkiszolgáló bemeneti objektuma.
...
### -ResourceId
Az útvonalkiszolgáló-erőforrás azonosítója.
