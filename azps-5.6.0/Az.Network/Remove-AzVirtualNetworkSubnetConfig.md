...
Ez a példa létrehoz egy erőforráscsoportot és egy virtuális hálózatot két alhálózattal. Ezután a Remove-AzVirtualNetworkSubnetConfig paranccsal eltávolítja a háttérhálózati alhálózatot a virtuális hálózat memóriában való megjelenítéséből. Set-AzVirtualNetwork rendszer ekkor a virtuális hálózat kiszolgálóoldali módosítására hív fel.
...
### -VirtualNetwork
Megadja az eltávolítható alhálózati konfigurációt tartalmazó **VirtualNetwork** objektumot.
