...
A második parancs módosítja az alkalmazás-átjáró átirányítási konfigurációját úgy, hogy állandó típusú átirányítást adjon meg, és cél URL-címet használjon.

### 2. példa

Beállítja az átirányítási konfigurációt egy meglévő alkalmazás átjárón. (automatikusan generált)
