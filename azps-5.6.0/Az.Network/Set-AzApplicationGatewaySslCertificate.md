...
## LEÍRÁS
A **Set-AzApplicationGatewaySslCertificate** parancsmag frissíti egy alkalmazás-átjáró SSL-tanúsítványát.
...
Frissítse az ApplicationGateway01 nevű alkalmazás-átjáró meglévő SSL-tanúsítványát.
...
### 3. példa: Meglévő SSL-tanúsítvány frissítése a KeyVault-titkosítás használatával az alkalmazásátjárón
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
