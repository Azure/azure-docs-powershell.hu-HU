...
A fentiekkel létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub és ExpressRouteSite in West US in "testRG" resource group in Azure. Ezután létrejön egy ExpressRoute-átjáró a virtuális központban 2 méretarányú egységben.
