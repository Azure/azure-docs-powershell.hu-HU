...
## LEÍRÁS
A **Set-AzPrivateDnsZoneGroup** parancsmag frissíti a DNS-zónacsoportot.
...
A fenti példa frissíti a DNSGroup1 NEVŰ DNS-zónacsoportot egy új dnsconfig névvel, amely egy másik DNS-zónához kapcsolódik.
