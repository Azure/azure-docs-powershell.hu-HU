...
## LEÍRÁS
A **Set-AzPublicIpPrefix** parancsmag beállítja egy nyilvános IP-előtag címkéit.

## PÉLDÁK

### Nyilvános IP-előtag címkéinek beállítása
```powershell
...
Az első parancs egy meglévő nyilvános IP-előtagot kap, a második beállítja a Címkék tulajdonságot, a harmadik pedig frissíti a meglévő objektumot.
