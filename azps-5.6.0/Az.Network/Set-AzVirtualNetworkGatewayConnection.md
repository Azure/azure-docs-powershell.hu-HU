...
## LEÍRÁS
A **Set-AzVirtualNetworkGatewayConnection** parancsmag virtuális hálózati átjárókapcsolatot konfigurál.
...
### 2. példa: Címkék hozzáadása/frissítése meglévő VirtualNetworkGatewayConnectionhoz
```
$conn = Get-AzVirtualNetworkGatewayConnection -Name 1 -ResourceGroupName myRG
...
### -EnableBgp
BGP-munkamenet használata S2S VPN-csatornán keresztül
...
A PrivateIP használata S2S-kapcsolat esetén
...
Megadja azt a PSVirtualNetworkGatewayConnection objektumot, amely a parancsmag segítségével módosítja a virtuális hálózati átjáró kapcsolatát.
