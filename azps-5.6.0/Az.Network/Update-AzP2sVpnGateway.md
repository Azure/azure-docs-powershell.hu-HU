...
### ByP2SVpnGatewayNameNoVpnServerConfigurationUpdate (alapértelmezett)
```
...
## LEÍRÁS
Az **Update-AzP2sVpnGateway** parancsmaggal frissítheti egy meglévő P2SVpnGatewayt a VirtualHub alatt az új VpnClientAddressPool vagy új VpnServerConfiguration vagy a VpnGatewayScaleUnit módosításával.
...
Az **Update-AzP2sVpnGateway** parancsmaggal frissítheti egy meglévő P2SVpnGatewayt a VirtualHub alatt az új VpnClientAddressPool-val. Amikor a Point to site client csatlakozik ezzel a P2SVpnGateway-hez, a VpnClientAddressPool ip-címének egyike lesz kiosztva az adott ügyfélnek.

### 2. példa

Frissítsen egy meglévő P2SVpnGatewayt a VirtualHub alatt, hogy a webhelyre mutasson a kapcsolat. (automatikusan generált)
...
### -CustomDnsServer
Az egyéni DNS-kiszolgálók listája.
...
Internetbiztonsági jelző engedélyezése ehhez a P2SVpnGateway-kapcsolathoz
...
Az internetbiztonsági jelző letiltása ehhez a P2SVpnGateway-kapcsolathoz
...
### -VpnClientAddressPool
P2S VpnClient AddressPool ehhez a P2SVpnGateway P2SConnectionConfigurationhoz.
...
A P2SVpnGatewayhez csatolható VpnServerConfiguration.
...
A vpn-kiszolgáló konfigurációs objektumának azonosítója, amelyhez a P2SVpnGateway csatolva lesz.
