...
## SYNOPSIS
Frissítsen egy Azure RouteServer-kiszolgálót.
...
## LEÍRÁS
Az **Update-AzRouteServer** parancsmag egy Azure RouteServer-kiszolgálóra váltja az ágak közötti forgalmat.
...
```
Elágaztatás engedélyezése az útvonal-kiszolgáló elágaztatásának engedélyezéséhez

### 1. példa
```powershell
PS C:\>  Update-AzRouteServer -ResourceGroupName $rgname -RouteServerName $routeServerName
```
Az útvonal-kiszolgáló elágaztatási ágának letiltásához.
