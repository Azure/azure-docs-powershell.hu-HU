...
A fentiekkel az Azure-ban az adott erőforráscsoportban létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub in Central US). Létrejön egy virtuális hálózati kapcsolat is, amely a virtuális hálózat és a virtuális központ közötti társközi kapcsolat. A virtuális hálózati kapcsolat ekkor frissül az internetbiztonság engedélyezéséhez.
...
Engedélyezze az internetbiztonságot ehhez a kapcsolathoz.
