...
## LEÍRÁS
Az **Update-AzVpnGateway** parancsmag frissít egy méretezhető VPN-átjárót.  
Az Azure VPN-átjáró egy olyan szoftveres kapcsolat, amely a VirtualHubon belüli webhelykapcsolatokat csatlakoztatja a webhelyhez. Ez az átjáró átméretezi és méretezi a felhasználó által megadott méretarányt. Egy VPN-webhelyről be lehet állítani egy kapcsolatot a méretezhető átjáróval. Minden kapcsolat 2 különböző Active-Active része
...
A fentiekkel létrehoz egy erőforráscsoportot (Virtual WAN, Virtual Network, Virtual Hub in West US in "testRG" resource group in Azure). Ezután létrejön egy VPN-átjáró a virtuális központban 2 méretarányú egységben.

Az átjáró létrehozása után a Update-AzVpnGateway 3 méretarányú egységekre frissíti az átjárót.
...
Az átjáró létrehozása után a Set-AzVpnGateway BgpPeeringAddress frissítése.
...
### -BgpPeeringAddress
A VpnGateway bgpsettings BGP-társviszony-címei.
...
### -InputObject
A módosítható VPN-átjáróobjektum
...
### -ResourceId
A módosítható VpnGateway Azure-erőforrásazonosítója.
