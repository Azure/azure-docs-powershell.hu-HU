...
Az engedélyezési szabályok kezelik a névtérhez és az adott névtérhez található értesítési központok felhasználói jogait.
...
A hitelesítéshez használt *PrimaryKey* véletlenszerűen generálható a Következő Windows PowerShell-paranccsal: \[ Convert \] ::ToBase64String(((1.32 |% { \[ byte/](Get-Random -Minimum 0 -Maximum 255) }))
