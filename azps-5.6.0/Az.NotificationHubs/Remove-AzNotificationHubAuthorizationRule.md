...
## LEÍRÁS
A **Remove-AzNotificationHubAuthorizationRule** parancsmag eltávolítja a Megosztott hozzáférés-aláírás (SAS) engedélyezési szabályt az értesítési központban.
...
Ez a parancs eltávolítja a ListenRule engedélyezési szabályt a ContosoExternalHub nevű értesítési központból.
A parancs futtatásakor meg kell adnia a névteret és azt az erőforráscsoportot is, amelyhez a központ hozzá van rendelve.

## PARAMETERS

### -AuthorizationRule
Annak az SAS-hitelesítési szabálynak a nevét adja meg, amelyről ez a parancsmag eltávolítja.
...
### -NotificationHub
Azt az értesítési központot adja meg, amelyhez az engedélyezési szabályok vannak hozzárendelve.
Az értesítési központokkal leküldéses értesítéseket lehet küldeni több ügyfélnek, platformtól függetlenül.
