...
## Leírás
Ez a témakör az Azure Operational Insights parancsmagok súgótémakörét mutatja be.
...
Csatolt szolgáltatás le- vagy listabe hozás munkaterülethez

### [Get-AzOperationalInsightsLinkedStorageAccount](Get-AzOperationalInsightsLinkedStorageAccount.md)
Csatolt tárfiók be- vagy listába való be- vagy listába
...
Információkat kap a Tárterület-betekintésről.
...
Naplókat gyűjt az adott Application-Insights alkalmazásból.

### [New-AzOperationalInsightsAzureActivityLogDataSource](New-AzOperationalInsightsAzureActivityLogDataSource.md)
Azure-tevékenységnaplót gyűjthet az adott előfizetésből.
...
Eseménynaplókat gyűjt a Windows operációs rendszert futtató számítógépekről.
...
Hozzáadja a Windows teljesítményszámláló adatforrását a Windows operációs rendszert futtató csatlakoztatott számítógépekhez.
