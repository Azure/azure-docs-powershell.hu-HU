...
A lekérdezésre vonatkozó általános korlátozásokat itt ellenőrizheti: https://docs.microsoft.com/azure/azure-monitor/service-limits#log-queries-and-language .
...
### 2. példa: $results. Tömbhöz megszámolható eredmény
```
PS C:\> $queryResults = Invoke-AzOperationalInsightsQuery -WorkspaceId "63613592-b6f7-4c3d-a390-22ba13102111" -Query "union * | take 10"
...
### -Wait
A lekérdezés feldolgozásával töltött idő felső határát köti.
