...
## LEÍRÁS
A **New-AzOperationalInsightsApplicationInsightsDataSource** parancsmag lehetővé teszi a naplók egy adott Application-Insights gyűjtését.

## PÉLDÁK

### 1. példa: Alkalmazásstatikációk adatforrásának létrehozása a munkaterületen
```
...
Ez a parancs egy adott alkalmazás alkalmazás-insights adatforrását hozza létre egy adott naplóstatikai munkaterületen. Ez lehetővé teszi a naplók gyűjteményét az adott alkalmazásból a naplóelemzés munkaterületére.

### 2. példa: Munkaterület-objektum lekérte és alkalmazás-insights adatforrást hozhat létre az alkalmazáserőforrás-azonosító alapján
```
...
Ez a parancs azt mutatja be, hogy hogyan lehet leküldeni egy log analytics munkaterületi objektumot, majd a kimenetet át kell haladni egy társított alkalmazás-insights adatforrás létrehozásához az alkalmazáserőforrás-azonosító alapján. 

## PARAMETERS

### -ApplicationName
A csatolt alkalmazás neve.
...
A csatolt alkalmazás erőforráscsoportneve.
...
A csatolt alkalmazáserőforrás azonosítója.
...
A csatolt alkalmazás előfizetésazonosítója.
...
### -WorkspaceName
Az adatforrást tartalmazó munkaterület neve.
