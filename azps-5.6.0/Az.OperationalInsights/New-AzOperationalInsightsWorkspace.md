...
A második parancs átadja a $OILinkTargets a **New-AzOperationalInsightsWorkspace** parancsmagnak a folyamatoperációs operátor használatával.
...
### -Termékváltozat
A munkaterület szolgáltatási rétegét határozza meg. Ha többet meg kell tudni arról, hogy melyik értéket kell használni, https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage#legacy-pricing-tiers ellenőrizze.
Érvényes értékek:
- ingyenes
- pergb2018
- pernode
