...
## LEÍRÁS
A **Remove-AzOperationalInsightsStorageInsight** parancsmag törli a tárterület-betekintéseket a munkaterületről.

## PÉLDÁK

### 1. példa: Tárterület-betekintés eltávolítása név szerint
```
...
Ez a parancs eltávolítja a MyStorageInsight nevű tárterület-betekintőt a MyWorkspace nevű munkaterületről a megadott erőforráscsoportban.
A parancs nem adja meg az *Kényszerítés* paramétert, ezért a Storage Insight eltávolítása előtt megerősítést kér.

### 2. példa: Tárterület-betekintés eltávolítása megerősítés nélkül
```
...
Az első parancs a Get-AzOperationalInsightsWorkspace parancsmagot használva szerezze be a MyWorkspace nevű munkaterületet, majd tárolja azt a $Workspace változóban. A második parancs anélkül távolítja el a MyStorageInsight nevű tárterület-$Workspace hogy megerősítést kér.
...
### -Workspace
A Tárterület-betekintőt tartalmazó munkaterület.
...
### -WorkspaceName
A Tárterület-betekintőt tartalmazó munkaterület neve.
