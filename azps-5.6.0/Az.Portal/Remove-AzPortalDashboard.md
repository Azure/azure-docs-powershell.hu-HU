...
Szaggatottszó eltávolítása az erőforráscsoport és az irányítópult nevével.

### 2. példa: Irányítópult eltávolítása a folyamat használatával
```powershell
PS C:\> Get-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02 | Remove-AzPortalDashboard
```

Távolítsa el a visszaküldött irányítópultot egy Get-AzDashboard hívásból.
