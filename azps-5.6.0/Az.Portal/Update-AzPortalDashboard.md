...
## SYNOPSIS
Egy meglévő irányítópult frissítése.
...
### 1. példa: Irányítópult címkéinek frissítése
```powershell
...
Frissítse a címkéket egy irányítópulton.
A címkék beágyazott hashtable-ként vannak ábrázolva.

### 2. példa: Irányítópult-címkék frissítése a folyamat használatával
```powershell
...
Frissítse a Get-AzPortalDashboard használatával újrakért címkéket egy irányítópulton.
Ezzel frissítheti a címkéket egyetlen irányítópulton vagy több irányítópulton keresztül.
