...
### 1. példa: A PostgreSql-kiszolgáló virtuális hálózat szabályának eltávolítása név szerint
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Ez a parancsmag név szerint eltávolítja a PostgreSql-kiszolgáló virtuális hálózatszabályát.

### 2. példa: A PostgreSql-kiszolgáló virtuális hálózat szabályának eltávolítása identitás alapján
```powershell
...
Ezek a parancsmagok identitás szerint eltávolítják a PostgreSql-kiszolgáló virtuális hálózatszabályát.
