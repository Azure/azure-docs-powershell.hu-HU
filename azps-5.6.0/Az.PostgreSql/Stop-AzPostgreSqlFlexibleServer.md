...
### 1. példa: A kiszolgáló leállítása erőforrásnév szerint
```powershell
PS C:\> Stop-AzPostgreSqlFlexibleServer -ResourceGroupName PowershellPostgreSqlTest -Name postgresql-test
```

A kiszolgáló név szerint való leállítása

### 2. példa: A kiszolgáló leállítása identitás alapján
```powershell
...
A kiszolgáló leállítása identitás alapján
