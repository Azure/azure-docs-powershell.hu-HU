...
Használjon Update-AzPostSqlFlexibleServerConfiguration kiszolgálóparamétereket, például wait_timeout vagy net_retry_count.
...
Ez a parancsmag erőforráscsoport és kiszolgálónév szerint frissíti a PostgreSql-kiszolgálót.

### 2. példa: A PostgreSql-kiszolgáló frissítése identitás szerint.
```powershell
...
Ez a parancsmag identitás szerint frissíti a PostgreSql-kiszolgálót.
...
### -MaintenanceWindow
Karbantartásra kijelölt időtartam (UTC).
Példák: "Nap:23:30" az ütemezéshez vasárnap, 11:30 UTC.
Vissza az alapértelmezett bérletre a "Letiltva" beállításban
...
### -Termékváltozat
A termékváltozat neve, például Burstable_B1ms, Standard_D2ds_v4
...
### -SkuTier
Az adott termékváltozat rétege.
