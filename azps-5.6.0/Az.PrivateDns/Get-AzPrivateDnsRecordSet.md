...
### FieldsWithNoName (alapértelmezett)
```
...
## LEÍRÁS
A Get-AzPrivateDnsRecordSet parancsmag a megadott névvel és típussal megadott DNS-rekordot kapja meg a megadott privát zónában. Ha nem adja meg a Name vagy a RecordType paramétert, ez a parancsmag a megadott típusú összes rekordkészletet visszaadja a privát zónában. Ha a RecordType paramétert adja meg, de a Name paramétert nem, ez a parancsmag a megadott rekordtípus összes rekordkészletét visszaadja. A folyamat műveleti jelét használva átadhatja a PSPrivateDnsZone-objektumot ennek a parancsmagnak, vagy átadhatja a PSPrivateDnsZone objektumot zóna paraméterként, vagy másik lehetőségként név szerint is megadhatja a zónát és az erőforráscsoportot. A privát zónát a privát zóna erőforrás-azonosítójával is megadhatja.
...
Ez a parancs a megadott erőforráscsoportban és privát zónában beveszi az A rekordtípus (A) nevű rekordkészletet, majd azt a $RecordSet tárolja. Mivel a Name és a RecordType paraméter meg van adva, csak egy RecordSet-objektumot ad vissza a visszaadott érték.
...
Ez a parancs a MyResourceGroup nevű erőforráscsoport myzone.com nevű privát zónában beállítja az A rekordtípusú rekordkészletek tömbét, majd a $RecordSets változóban tárolja őket.

### 3. példa: Az összes rekordkészlet behozása egy privát zónába
```powershell
...
Ez a parancs a MyResourceGroup nevű erőforráscsoport myzone.com nevű privát zóna összes rekordkészletét beállítja, majd a $RecordSets tárolja.

### 4. példa: Az összes rekordkészlet beása egy privát zónába PSPrivateDnsZone-objektum használatával
```powershell
...
Ez a példa egyenértékű a fenti 3. példával. A privát zóna ezúttal egy privát zónaobjektum használatával van megadva.
...
### -RecordType
A DNS-rekordok típusa ebben a rekordkészletben.
...
### -Zone
A rekordkészlet létrehozásához használt zóna DNSZone-objektuma.
