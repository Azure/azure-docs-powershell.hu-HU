...
## LEÍRÁS
A **New-AzPrivateDnsVirtualNetworkLink** parancsmag létrehoz egy új dns-virtuális hálózati kapcsolatot a megadott erőforráscsoportban és a privát zónában. Meg kell adnia egy egyedi hivatkozásnevet a *Name* paraméternek, különben a parancsmag hibát ad vissza. A Confirm *paraméter* és a Windows PowerShell$ConfirmPreference változó segítségével szabályozhatja, hogy a parancsmag megerősítést kér-e.

## PÉLDÁK

### 1. példa: Virtuális DNS-kapcsolat létrehozása
```
...
Ez a parancs létrehoz egy új virtuális hálózati hivatkozást a myzone.com nevű privát DNS-zónához és a "myvirtualnetwork" virtuális hálózathoz (amely már létrejött az erőforráscsoportban) a megadott erőforráscsoportban, majd a $Link változóban tárolja.
...
### -Name
A létrehozni szükséges virtuális hálózati hivatkozás nevét adja meg.
...
### -RemoteVirtualNetworkId
Egy másik bérlő virtuális hálózatának erőforrás-azonosítója.
...
### -ResourceGroupName
Megadja azt az erőforráscsoportot, amelyben létre kell hoznia a hivatkozást.
...
### -VirtualNetwork
A csatolással társított virtuális hálózati objektum.
...
### -VirtualNetworkId
A csatolással társított virtuális hálózat erőforrás-azonosítója.
...
### -ZoneName
Megadja annak a zónának a nevét, amely a virtuális hálózati kapcsolathoz lesz csatolva.
