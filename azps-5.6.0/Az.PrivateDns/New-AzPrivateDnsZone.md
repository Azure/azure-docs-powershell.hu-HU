...
## LEÍRÁS
A **New-AzPrivateDnsZone** parancsmag létrehoz egy új dns-zónát a megadott erőforráscsoportban. A Name paraméterhez egyedi privát  DNS-zónanevet kell megadnia, különben a parancsmag hibát ad vissza. A zóna létrehozása után a New-AzPrivateDnsRecordSet parancsmag használatával hozzon létre rekordkészleteket a zónában.
...
### 1. példa: Privát DNS-zóna létrehozása
```
...
### -Name
A létrehozni szükséges privát DNS-zóna neve.
