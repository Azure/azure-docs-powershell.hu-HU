...
## LEÍRÁS
A **Disable-AzRecoveryServicesBackupAutoProtection** parancsmag letiltja a védett elemek védelmét.
...
Az első parancsmag lekérte az AzureVMAppContainer típusú biztonsági mentési tárolót.  A második parancsmag megkapja a védett biztonsági másolatot, és letiltja az automatikus védelmet.

### 2. példa

Letiltja a védett elemek automatikus biztonsági mentését. (automatikusan generált)
...
### -WorkloadType
Az erőforrás terheléstípusa. A jelenlegi támogatott érték az "MSSQL"
