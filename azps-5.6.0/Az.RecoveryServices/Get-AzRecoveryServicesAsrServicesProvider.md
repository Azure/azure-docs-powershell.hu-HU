...
## LEÍRÁS
A **Get-AzRecoveryServicesAsrServicesProvider** parancsmag információkat kap a tárolóban található Azure-webhely-helyreállítási szolgáltatókról.
...
A helyreállítási szolgáltatások tárolóban regisztrált ASR helyreállítási szolgáltatók adatait tartalmazza. (automatikusan generált)
...
### -Fabric
Az ASR-anyagobjektumot határozza meg.
...
### -FriendlyName
Megadja az ASR helyreállítási szolgáltató rövid nevét, amelyről részleteket olvashat.
...
### -Name
Megadja annak az ASR helyreállítási szolgáltatónak a nevét, amelyről le kell szereznie a részleteket.
