...
## LEÍRÁS
A **New-AzRecoveryServicesAsrvCenter** parancsmag hozzáad egy vCenter-kiszolgálót a védett elemek felderítéséhez. Ez a parancsmag regisztrálja a vCenter-kiszolgálót a konfigurációs kiszolgálóval való felderítéshez.
...
Hozzáad egy vCenter-kiszolgálót a védett elemek felderítéséhez. (automatikusan generált)
...
### -Account
Felhasználói hitelesítő adatokkal megadott fiók.
...
### -Fabric
A Konfigurációs kiszolgálónak megfelelő ASR-szövet.
...
### -IpOrHostName
A vCenter-kiszolgáló IPv4-címe vagy FQDN-címe.
...
### -Port
A feltáráshoz használt TCP-port a vCenter-kiszolgálón.
