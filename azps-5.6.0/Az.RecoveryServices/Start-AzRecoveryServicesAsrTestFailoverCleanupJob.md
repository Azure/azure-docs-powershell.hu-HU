...
## LEÍRÁS
A **Start-AzRecoveryServicesAsrTestFailoverCleanup Parancsfájl parancsmag** elindítja a feladatátvétel-helyreállítási műveletet egy replikációval védett elemen vagy helyreállítási terven, amelyen tesztelési feladatátvételt hajtottak végre.

## PÉLDÁK

### 1. példa

Feladat az Azure-webhely-helyreállítási helyreállítási terv teszt feladatátvételi karbantartásának nyomon követéséhez.
...
Elindítja a feladatátvételi teszt-tisztítási műveletet. (automatikusan generált)
...
### -Comment
Felhasználói megjegyzés a teszt feladatátvételhez.
...
### -RecoveryPlan
Helyreállítási terv a teszt feladatátvételi tisztításának elvégzéséhez.
...
Replikációval védett elem a teszt feladatátvételi tisztításának végrehajtásához
...
### -ResourceId
A replikációval védett elem/ helyreállítási terv erőforrás-azonosítója a helyreállítási teszt feladatátvételi tesztjére.
