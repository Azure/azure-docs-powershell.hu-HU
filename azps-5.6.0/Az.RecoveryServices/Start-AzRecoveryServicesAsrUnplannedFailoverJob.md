...
## LEÍRÁS
A **Start-AzRecoveryServicesAsrUnplannedFailoverService** parancsmag nem tervezett feladatátvételt indít az Azure-webhely-helyreállítási replikációval védett elemekkel vagy helyreállítási tervekkel.
...
Elindítja a helyreállítási terv nem tervezett feladatátvételi műveletét a megadott paraméterekkel, és visszaadja a művelet nyomon követéséhez használt ASR-feladatot.

### 2. példa

Nem tervezett feladatátvételi műveletet kezd. (automatikusan generált)
...
A védett elem feladatátvételéhez szükséges elsődleges tanúsítványfájl elérési útját adja meg.
...
A védett elem feladatátvételéhez szükséges adattitkosítási másodlagos tanúsítványfájl elérési útját adja meg.
...
A nem tervezett feladatátvétel megkezdése előtt végezze el a műveletet a forrásoldalon.
...
### -RecoveryPoint
Megad egy egyéni helyreállítási pontot, amely feladatátvételt nyújt a védett gépnek.
...
### -RecoveryTag
Azt a helyreállítási címkét adja meg, amelybe a feladatátvételt el kell látni.
...
Egy azure-webhely-helyreállítási replikációval védett elemet ad meg.
