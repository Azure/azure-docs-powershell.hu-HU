...
### 1. példa: A nagyvállalati gyorsítótár frissítése
```powershell
...
Ez a parancs frissíti a minimális TLS-verziót, és hozzáad egy MyCache nevű címkét a Redis Enterprise Cache-hez.
...
Az alapérték 2 vagy 3 az adott termékváltozattól függően.
