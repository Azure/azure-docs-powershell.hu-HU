...
## LEÍRÁS
A New-AzRelayHybridConnection parancsmag hibrid összekapcsolást hoz létre a megadott Továbbítás névterében.
...
Létrehoz egy új HybirdConnection \` TestHybirdConnection2-t a \` megadott Relay namespace \` TestNameSpace-HybirdConnection \` fájlban.
...
Létrehoz egy új HybirdConnection \` TestHybirdConnection1-et \` a megadott Relay namespace \` TestNameSpace-HybirdConnection \` fájlban.
...
true, ha ügyfél-hitelesítés szükséges ehhez a HibridConnections szolgáltatáshoz; ellenkező esetben hamis
