...
## LEÍRÁS
A **New-AzRelayNamespace** parancsmag létrehoz egy új továbbítási névteret. Létrehozás után a névtérerőforrás jegyzékfájlja nem módosítható.
...
Új továbbítási névteret hoz létre a megadott erőforráscsoporton belül.
...
### -Name
Relay Namespace Name (Továbbítás neve)
