...
## LEÍRÁS
A **Remove-AzRelayAuthorizationRule** parancsmag eltávolítja a megadott továbbítási entitások engedélyezési szabályát (Namespace/WcfRelay/HybridConnection).
...
Eltávolítja a névtér `AuthoRule1` engedélyezési `TestNameSpace-Relay1` szabályát.
...
Eltávolítja a `AuthoRule1` WcfRelay engedélyezési szabályát `TestWcfRelay` a névtérből. `TestNameSpace-Relay1`
...
Eltávolítja a HybridConnection engedélyezési szabályát `AuthoRule1` `TestHybridConnection` a névtérből. `TestNameSpace-Relay1`
