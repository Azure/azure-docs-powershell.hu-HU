...
## LEÍRÁS
A **Remove-AzRelayHybridConnection** parancsmag eltávolítja a HybridConnectiont a megadott továbbítási névtérből.
...
Eltávolítja a HybridConnectiont `TestHybridConnection` a névtérből. `TestNameSpace-Relay1`
