...
## LEÍRÁS
A **Remove-AzWcfRelay** parancsmag eltávolítja a WcfRelay értéket a megadott Továbbítás névtérből.
...
A WcfRelay eltávolítása `TestWCFRelay1` a névtérből. `TestNameSpace-Relay1`
