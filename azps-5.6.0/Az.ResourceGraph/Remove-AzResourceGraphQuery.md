...
### 1. példa: Erőforrás-grafikon lekérdezés eltávolítása név szerint
```powershell
PS C:\> Remove-AzResourceGraphQuery -ResourceGroupName azure-rg-test -Name query-t03

```

Ez a parancs név szerint eltávolítja az erőforrás-grafikon lekérdezést.

### 2. példa: Erőforrás-grafikon lekérdezés eltávolítása objektum szerint
```powershell
...
Ez a parancs objektum szerint eltávolítja az erőforrás-grafikon lekérdezést.
