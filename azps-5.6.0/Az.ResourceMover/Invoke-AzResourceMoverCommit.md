...
### 1. példa: Az erőforrások véglegesítése előtt ellenőrizze a függőségeket.
```powershell
...
### 2. példa: Az Áthelyezési gyűjtemény erőforráskészletének véglegesítéséhez használja a "MoveResource Name" bemenetet.
```powershell
...
Az Áthelyezési gyűjteményben a "MoveResource Name" erőforráskészletet bemenetként véglegesítésére használja.

### 3. példa: Az Áthelyezési gyűjtemény erőforráskészletének véglegesítéséhez használja a "SourceARMID" bemenetet.
```powershell
...
Az Áthelyezési gyűjteményben a "SourceARMID" erőforráskészletet bemenetként véglegesítéssel kell véglegesen használnia.
