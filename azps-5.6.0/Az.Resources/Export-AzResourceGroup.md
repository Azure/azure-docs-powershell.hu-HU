...
Ez a parancs sablonként rögzíti a "TestGroup" erőforráscsoport "TestVirtualMachine" nevű virtuális gép típusú erőforrását, és az aktuális címtárban lévő JSON-fájlba menti azt.
...
Ha nincs megadva, akkor a legújabb API-verziót használja a program.
