...
### 1. példa: Az AD szolgáltatásnévszők felsorolása
...
### 2. példa: Az AD szolgáltatásban használt egyszerű szolgáltatásnévlista lapozással

```powershell
PS C:\> Get-AzADServicePrincipal -First 100
```

Egy bérlő első 100 AD szolgáltatásának egyszerű felhasználóját sorolja fel.
...
### 4. példa: Egyszerű szolgáltatásnév felsorolása keresési karakterlánc alapján
...
### 5. példa: Egyszerű szolgáltatásnév listázása pipázással

```powershell
PS C:\> Get-AzADApplication -ObjectId 39e64ec6-569b-4030-8e1c-c3c519a05d69 | Get-AzADServicePrincipal
```

A (39e64ec6-569b-4030-8e1c-c3c519a05d69) objektumazonosítót megjelenítő AD alkalmazást beveszi a Get-AzADServicePrincipal-parancsmagba az alkalmazás összes szolgáltatásnévének listájához.
...
### -ApplicationObject
Az alkalmazásobjektum, amelynek a szolgáltatásnév lekérése folyamatban van.
