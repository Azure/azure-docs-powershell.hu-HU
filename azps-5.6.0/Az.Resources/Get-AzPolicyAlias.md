...
Paramétereket biztosítunk, amelyek az erőforrástípus vagy aliasaik különböző tulajdonságainak egyeztetésével korlátozzák a lista elemeit.
...
A szolgáltató összes erőforrástípusát felsorolja, az alias nélkülieket is beleértve.
...
Azokat a szolgáltatói erőforrástípusokat sorolja fel, amelyeknek a névtere megegyezik a "számítás" névvel, és aliast tartalmaz.
