...
## LEÍRÁS
Létrehoz egy új Azure Active Directory-alkalmazást. Az alábbiakban az alkalmazások létrehozásához szükséges engedélyeket olvashatja:
...
### 1. példa: Új AAD-alkalmazás létrehozása.

```powershell
PS C:\> New-AzADApplication -DisplayName "NewApplication" -HomePage "http://www.microsoft.com" -IdentifierUris "http://NewApplication"
```

Új Azure Active Directory-alkalmazást hoz létre hitelesítő adatok nélkül.

### 2. példa: Új AAD-alkalmazás létrehozása jelszóval.
...
Létrehoz egy új Azure Active Directory-alkalmazást, és a jelszó hitelesítő adatait társítja hozzá.

## PARAMETERS

### -AvailableToOtherTenants
Az az érték, amely meghatározza, hogy az alkalmazás egyetlen bérlői vagy több-bérlős-e.
...
### -DisplayName
Az új alkalmazás megjelenítendő neve.
...
### -KeyCredentials
Az alkalmazáshoz társított tanúsítvány hitelesítő adatainak listája.
...
### -PasswordCredentials
Az alkalmazáshoz társított jelszó-hitelesítő adatok listája.
...
Az alapértelmezett kezdő dátum a mai nap. Az "aszimmetrikus" típusú hitelesítő adatoknál ezt az X509-tanúsítvány érvényességének dátumán vagy azt követően kell megadni.
