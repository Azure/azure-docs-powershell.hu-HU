...
Ide tartoznak a telepítéshez szükséges erőforrások is.
...
A -RollBackDeploymentName használata esetén ne legyen jelen az erőforráscsoport utolsó sikeres telepítéséhez való visszatérés.
...
### -TemplateFile
A sablonfájl teljes elérési útját adja meg. Támogatott sablonfájltípus: json és bicep.
Ez lehet egyéni sablon vagy JSON-fájlként mentett gyűjteménysablon, például a **Save-AzResourceGroupGalleryTemplate** parancsmaggal létrehozott sablon.
...
### -TemplateUri
Egy sablonfájl URI-ját adja meg.
