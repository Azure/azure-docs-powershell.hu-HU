...
### RemoveDeploymentScriptLogByName (alapértelmezett)
```
...
## LEÍRÁS
A **Remove-AzDeploymentScript** parancsmag eltávolítja a telepítési parancsfájlt és a hozzá tartozó erőforrásokat.
...
Törli a MyDeploymentScript nevű telepítési parancsfájlt a DS-TestRG erőforráscsoportban.
