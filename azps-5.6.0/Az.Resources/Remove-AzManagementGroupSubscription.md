...
## LEÍRÁS
A **Remove-AzManagementGroupSubscription** parancsmag eltávolít egy előfizetést egy felügyeleti csoportból.

## PÉLDÁK

### 1. példa: Előfizetés eltávolítása egy felügyeleti csoportból
```powershell
