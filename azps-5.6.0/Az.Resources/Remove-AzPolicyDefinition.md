...
## LEÍRÁS
A **Remove-AzPolicyDefinition** parancsmag eltávolítja a házirend-definíciókat.

## PÉLDÁK

### 1. példa: A házirenddefiníció eltávolítása név szerint
```
PS C:\> Remove-AzPolicyDefinition -Name 'VMPolicyDefinition'
```

Ez a parancs eltávolítja a megadott házirenddefiníciót.

### 2. példa: Házirenddefiníció eltávolítása erőforrás-azonosító szerint
```
...
A parancs a $PolicyDefinition tárolja.
A második parancs eltávolítja a  házirend-definíciót, amelyet a $PolicyDefinition.
...
### -Id
A parancsmag által eltávolított házirenddefiníció teljes erőforrás-azonosítóját adja meg.
...
### -InputObject
A másik parancsmagból származó kimenetet eltávolító házirenddefiníciós objektum.
...
### -ManagementGroupName
A törölni kívánt házirenddefiníció felügyeleti csoportjának neve.
...
### -Name
A parancsmag által eltávolított házirenddefiníció nevét adja meg.
...
### -SubscriptionId
A törölni kívánt házirend-definíció előfizetésazonosítója.
