...
**RemoveByResourceIdParameterSet:** A **Remove-AzTag** parancsmag egy **ResourceId** értékkel törli az erőforrás vagy előfizetés címkéinek teljes készletét.
...
Ez a parancs törli az erőforrás teljes címkéit a(z) {resourceId} értékkel. Visszaadja a töröltectect értéket, amikor a "-PassThru" értéket adja át.
