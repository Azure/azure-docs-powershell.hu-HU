...
## LEÍRÁS
A **Save-AzResourceGroupDeploymentTemplate**  parancsmag JSON-fájlba ment egy erőforráscsoport-telepítő sablont.

## PÉLDÁK

### 1. példa: Telepítési sablon mentése
```powershell
PS C:\>Save-AzResourceGroupDeploymentTemplate -DeploymentName "TestDeployment" -ResourceGroupName "TestGroup"
```

Ez a parancs lekérte a telepítési sablont a TestDeploymentből, és JSON-fájlként menti azt az aktuális címtárba.

### 2. példa

Fájlba menti az erőforráscsoport-telepítő sablont. (automatikusan generált)
...
### -DeploymentName
Az üzembe helyezés nevét adja meg.
...
### -Pre
Azt jelzi, hogy ez a parancsmag megjelenés előtti API-verziókat használ, amikor automatikusan meghatározza, hogy melyik API-verziót kell használni.
