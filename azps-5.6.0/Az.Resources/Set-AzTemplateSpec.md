...
## LEÍRÁS
Módosítja az Templace Spec függvényt. Ha a megadott nevű és/vagy adott verziójú sablon specifikációja még nem létezik, akkor létrejön.

Ha módosítja egy sablon specifikációs verziójának ARM-sablonjának tartalmát, a tartalom vagy egy nyers JSON karakterláncból (az **UpdateVersionByNameFromJsonParameterSet** paraméterkészletből) vagy egy megadott JSON-fájlból **(az UpdateVersionByNameFromJsonFileParameterSet** paraméterkészletből) lehet.
...
Módosítja a "myTemplateSpec" nevű sablon specifikációjának "v1.0" verzióját. A megadott verzió a $templateJson sablon tartalmának ARM lesz. Ha a fő sablon specifikációja és/vagy verziója még nem létezik, a rendszer létrehoz egy sablont.
