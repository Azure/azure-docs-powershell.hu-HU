...
Az erőforráscsoportok erőforrás-gyűjtemények, amelyek egységként vannak telepítve.
Erőforráscsoport telepítéséhez használja a New-AzResourceGroupDeployment parancsmagot.
A New-AzResource parancsmag létrehoz egy új erőforrást, de nem indít el olyan erőforráscsoport-telepítési műveletet, amely leállítható.
...
### -Id
Annak az erőforráscsoport-telepítésnek az azonosítóját adja meg, amely leállítja a leállítást.
...
Ha egynél több futó telepítést talál, a parancs nem fog sikerülni.
