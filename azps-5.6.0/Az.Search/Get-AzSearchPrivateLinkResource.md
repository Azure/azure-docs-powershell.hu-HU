...
## LEÍRÁS
A **Get-AzSearchPrivateLinkResource** parancsmag személyes hivatkozáserőforrás-adatokat kap az Azure Cognitive Search szolgáltatáshoz.
...
A példa bemutatja, hogy miként olvashatja be a privát hivatkozás típusú erőforrások adatait (az egyszerűség kedvéért JSON-formában) az Azure Kognitív keresés szolgáltatáshoz.
