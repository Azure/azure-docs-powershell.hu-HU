...
## LEÍRÁS
A **Remove-AzSearchPrivateEndpointConnection** eltávolítja a privát végpontkapcsolatot az Azure Cognitive Search szolgáltatásból.
...
Ez a példa név szerint eltávolít egy privát végpontkapcsolatot a keresési szolgáltatásból.
