...
## LEÍRÁS
A **Set-AzSearchService** parancsmag módosítja az Azure Kognitív keresési szolgáltatást.
...
A példa 2-re módosítja az Azure Cognitive Search szolgáltatás partíciók és replikaszámát.
