...
## LEÍRÁS
A Get-AzIotSecurityAnalyticsAggregatedAlert parancsmag egy vagy több összesített riasztást ad vissza az iot hub eszközein.
Az összesített riasztások neve a riasztástípus és a riasztások aggragált dátumának kombinációja, "/" elválasztva egymástól.
...
Az összesített "IoT_Bruteforce_Fail/2019-02-02" (a riasztástípusból és az összesített dátumból egyesített név) a "MySolution" megoldásban és a "MyResourceGroup" erőforráscsoportban
...
Az összes összesített riasztás listájának lekérte a "MySolution" megoldásban és a "MyResourceGroup" erőforráscsoportban
