...
## LEÍRÁS
A New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject parancsmag létrehoz egy új listát az eszköz biztonsági csoportjának engedélyezett egyéni riasztási szabályairól az IoT biztonsági megoldásban.
...
Új engedélyezett lista egyéni riasztási rull létrehozása a "LocalUserNotAllowed" típusból, letiltható állapottal
