...
### SQL Information Protection Policy (alapértelmezett)
```
...
### -FilePath
Az SQL Information Protection Policy definícióját tartalmazó .json fájl elérési útját adja meg.
...
### -Házirend
Megadja az SQL adatvédelmi házirenddefinícióját. Megadhatja a házirendet definiáló .json fájl vagy JSON formátumú karakterlánc elérési útját.
