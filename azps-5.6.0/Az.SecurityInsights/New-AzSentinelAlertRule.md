...
A létrehozni kívánt riasztási szabály  fajtáját meg kell adnia a három paraméter egyikeként *(Az ütemezés,* az Ütemezett vagy a *MicrosoftSecurityIncidentCreation* paraméter).  Minden egyes típusúhoz különböző kötelező paramétereket kell megadni.
...
Ebben a példában létrehoz egy **AlertRule-t** a *MicrosoftSecurityIncidentCreation* típusúról az Azure Security Center for *IoT-riasztások* alapján létrehozott incidensek létrehozása sablon alapján, majd a sablont a $AlertRule tárolja.
