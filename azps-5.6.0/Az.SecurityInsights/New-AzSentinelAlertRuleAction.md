...
## LEÍRÁS
A **New-AzSentinelAlertRuleAction** parancsmag létrehoz egy automatikus választ egy riasztási szabályhoz a megadott munkaterületen.
Meg kell adnia a Logic App Resorce-azonosítóját és a Trigger Uri azonosítót, amely a Logic App modul használatával található meg.
...
Ebben a példában létrehoz egy **AlertRuleActiont** a megadott riasztási szabályhoz a Logic app tulajdonságaival, majd azt a $AlertRuleAction változóban tárolja.
