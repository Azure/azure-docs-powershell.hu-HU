...
A létrehozható riasztási szabály fajtáját meg kell adnia az egyik paraméternek, például az -AzureActiveDirectorynak.  Minden egyes típusúhoz különböző kötelező paramétereket kell megadni.
...
Megjegyzés: A portálon nem minden adatkapcsolat érhető el API-n keresztül.
