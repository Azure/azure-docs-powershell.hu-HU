...
## LEÍRÁS
A **Remove-AzSentinelAlertRuleAction** parancsmag véglegesen töröl egy automatikus választ a riasztási szabályból egy adott munkaterületen.
A **AlertRuleAction** objektumokat átadhatja a folyamat műveleti jelével, vagy megadhatja a szükséges paramétereket.
