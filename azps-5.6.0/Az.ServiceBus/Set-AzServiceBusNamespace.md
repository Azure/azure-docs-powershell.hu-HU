...
## LEÍRÁS
A **Set-AzServiceBusNamespace** parancsmag frissíti az erőforráscsoporton belül a szolgáltatásbusz névterének leírását.
...
Frissíti a Service Bus névterét egy új leírással.
...
### -Location
A szolgáltatásbusz névterének helye.
...
### -SkuCapacity
Namespace Sku Capacity (Névtér-termékváltozat kapacitása).
...
### -Confirm
Frissíti a Service Bus névterét a megadott információkkal.
