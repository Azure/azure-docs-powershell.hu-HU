...
## LEÍRÁS
A **Set-AzServiceBusTopic** parancsmag frissíti a service bus témakör leírásobjektumát a megadott Service Bus namespace mezőben.
...
Frissíti a megadott témakört egy új leírással a megadott névtérben. Ebben a példában igaz értékre frissíti az **EnableExpress** **tulajdonságot.** 
...
### -InputObject
ServiceBus-témakör definíciója.
