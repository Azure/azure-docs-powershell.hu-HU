...
Az ezt a modellt használó szolgáltatások általában olyan adatokat tartalmaznak, amelyek egy kötött halmazon belül gyűjtővel is el vannak állítva.
Az elnevezett partíciókulcsként használt adatmezők közé tartozik például a régiók, az irányítószámok, az ügyfélcsoportok vagy más üzleti határvonalak.
...
Azt jelzi, hogy a szolgáltatás az egytonos partíciós sémát használja.
