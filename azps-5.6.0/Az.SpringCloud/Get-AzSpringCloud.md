...
### 1. példa: A Spring Cloud Service szolgáltatás lekért neve
```powershell
...
A Spring Cloud Service szolgáltatás lekért neve

### 2. példa: Sorolja fel az erőforráscsoportban az összes tavaszi felhőszolgáltatást.
```powershell
...
Sorolja fel a tavaszi felhőszolgáltatást az erőforráscsoport alatt.
