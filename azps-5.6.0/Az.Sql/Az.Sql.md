...
Letiltja az Azure AD-alapú hitelesítést egy adott SQL Serveren.
...
Engedélyezi a komplex veszélyforrások elleni védelmet a kiszolgálón.
...
Adatbázis-kiszolgálói rendszer-helyreállítási konfigurációt kap.

### [Get-AzSqlServerDisasterRecoveryConfigurationActivity](Get-AzSqlServerDisasterRecoveryConfigurationActivity.md)
Egy adatbázis-kiszolgálói rendszer helyreállítási konfigurációjának tevékenységét kapja meg.
...
Információkat ad vissza az Azure SQL Sync-ügynökökről.
...
Egy Azure SQL-adatbázist .bacpac fájlként exportál egy tárfiókba.
...
Frissíti az Azure SQL rugalmassági készlet tanácsadója automatikus végrehajtását.
...
Egy SQL-kezelt példány átlátszó adattitkosítási (TDE) védelmét állítja be.
...
Leállít egy feladatot, ha a feladat végrehajtási azonosítója meg van adva
