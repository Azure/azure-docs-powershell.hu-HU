...
## LEÍRÁS
A **Disable-AzSqlServerActiveDirectoryOnlyAuthentication** parancsmag letiltja az Azure Active Directory (Azure AD) csak hitelesítési követelményét egy AzureSQL-kiszolgálóhoz az aktuális előfizetésben.
