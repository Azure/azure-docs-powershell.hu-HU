...
## LEÍRÁS
Az **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** parancsmag csak az Azure Active Directory (Azure AD) hitelesítését teszi lehetővé az aktuális előfizetésben lévő AzureSQL Felügyelt példány esetén.
