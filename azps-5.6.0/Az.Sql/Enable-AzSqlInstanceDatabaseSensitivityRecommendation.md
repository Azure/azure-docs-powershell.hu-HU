...
## LEÍRÁS
A Enable-AzSqlInstanceDatabaseSensitivityRecommendation parancsmag bizalmasság-javaslatokat tesz lehetővé az Azure SQL felügyeltpéldány-adatbázis oszlopainál.

## PÉLDÁK

### 1. példa: Bizalmasság-javaslatok engedélyezése egy Azure SQL felügyeltpéldány-adatbázis adott oszlopához.
```powershell
...
### 2. példa: Bizalmasság-javaslatok engedélyezése egy adott oszlopon egy Azure SQL felügyelt példány adatbázisában Piping utasítással.
```powershell
