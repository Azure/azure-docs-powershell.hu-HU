...
## LEÍRÁS
A **Get-AzSqlDatabase** parancsmag egy vagy több Azure SQL-adatbázist kap egy Azure SQL Database Serverből.
Ezt a parancsmagot az Azure SQL Server Stretch Database szolgáltatása is támogatja.

## PÉLDÁK

### 1. példa: Az összes adatbázis lekérte egy kiszolgálón
```
...
Ez a parancs a kiszolgáló01 nevű kiszolgálón található összes adatbázist beveszi.

### 2. példa: Adatbázis létrehozása név szerint egy kiszolgálón
```
...
Ez a parancs egy Adatbázis02 nevű adatbázist kap egy Server01 nevű kiszolgálóról.

### 3. példa: Kiszolgáló összes adatbázisának be szerezze a szűrést
```
...
Ez a parancs az "adatbázis" kezdetű összes adatbázist a kiszolgáló01 kiszolgálóról kapja.

## PARAMETERS

### -DatabaseName
A beolvassa az adatbázis nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amelyhez az adatbázis-kiszolgáló hozzá van rendelve.
