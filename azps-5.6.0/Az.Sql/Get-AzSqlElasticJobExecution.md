...
### WithCutExecutionIdUsingParentObject
```
Get-AzSqlElasticJobExecution [-ParentObject] <AzureSqlElasticJobAgentModel> -JobName <String>
...
### WithCutExecutionIdUsingParentResourceId
```
...
## LEÍRÁS
A Get-AzSqlElasticJobExecution parancsmag egy vagy több feladatvégrehajtást kap

## PÉLDÁK

### 1. példa: Egy vagy több feladatvégrehajtást kap minden munkakörben
```powershell
...
### 2. példa: Egy vagy több feladatvégrehajtást kap egy feladathoz
```powershell
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
...
Egy vagy több feladatvégrehajtást kap. (automatikusan generált)
