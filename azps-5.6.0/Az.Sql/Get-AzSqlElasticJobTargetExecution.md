...
## LEÍRÁS
A Get-AzSqlElasticJobTargetExecution parancsmag egy vagy több feladatvégrehajtást kap egy feladatvégrehajtásból

## PÉLDÁK

### 1. példa: Egy vagy több feladatcél végrehajtását kapja meg egy feladatvégrehajtásból
```powershell
...
### 2. példa: Egy vagy több feladatvégrehajtást kap egy feladatvégrehajtásból – lépésnév alapján végzett szűrés
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Aktív
Megjelölés aktív végrehajtások szerinti szűréshez.
...
### -Count
A darabszám a végrehajtások legfelső számát adja vissza.
...
### -CreateTimeMax
Szűrés idő létrehozási idő szerint max
...
### -JobExecutionId
A feladatvégrehajtás azonosítója.
...
### -ParentObject
A feladatvégrehajtási objektum.
...
### -ParentResourceId
A feladatvégrehajtás erőforrás-azonosítója.
...
### Microsoft.Azure.Commands.Sql.ElasticMods.Model.AzureSqlElasticAsticAsticExecutionModel
