...
### GetInstanceDatabaseFromInputParameters (alapértelmezett)
```
...
## LEÍRÁS
A **Get-AzSqlInstanceDatabase** parancsmag egy vagy több Azure SQL-adatbázist kap egy Azure SQL-adatbázis felügyelt példányából.

## PÉLDÁK

### 1. példa: Az összes adatbázis lekérte egy példányon
```
...
Ez a parancs a managedInstance1 nevű példány összes adatbázisát beveszi.

### 2. példa: Adatbázis lekérte név szerint felügyelt példányon
```
...
Ez a parancs egy managedDatabase1 nevű adatbázist kap a managedInstance1 nevű példányból.

### 3. példa: Egy példány összes adatbázisának be szereznie szűrés használatával
```
...
Ez a parancs a managedInstance1 példányon a "managedDatabase" kezdetű összes adatbázist lekérte.
...
### -InstanceObject
A példányadatbázis beszerzéshez használt példányobjektum
...
### -InstanceResourceId
A lekért példányobjektum erőforrás-azonosítója
...
### -Name
A lekérni megfelelő Azure SQL-példány adatbázisának neve.
