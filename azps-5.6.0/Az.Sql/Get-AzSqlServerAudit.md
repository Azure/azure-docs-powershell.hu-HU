...
## LEÍRÁS
A **Get-AzSqlServerAudit** parancsmag egy Azure SQL-kiszolgáló naplózási beállításait kapja meg.
A *kiszolgáló azonosításához adja* meg a ResourceGroupName és *a ServerName* paramétert.

## PÉLDÁK

### 1. példa: Azure SQL-kiszolgáló naplózási beállításainak leellenőrzése
```
...
### 2. példa: Egy Azure SQL-kiszolgáló naplózási beállításainak be- és beállítása folyamaton keresztül
```
...
### 3. példa: Azure SQL-kiszolgáló naplózási beállításainak leellenőrzése
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
