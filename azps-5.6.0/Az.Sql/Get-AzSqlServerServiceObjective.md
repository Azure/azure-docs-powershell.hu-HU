...
## LEÍRÁS
A **Get-AzSqlServerServiceObjective** parancsmag megkapja az Azure SQL Database-kiszolgálóhoz elérhető szolgáltatási célokat.

## PÉLDÁK

### 1. példa: A szolgáltatás célkitűzéseinek lekérte
```
...
Ez a parancs a Kiszolgáló01 nevű kiszolgáló szolgáltatási céljait kapja meg.

### 2. példa: Szolgáltatásra vonatkozó célok elérése szűrés használatával
```
...
Ez a parancs a "Rendszer" kezdetű Kiszolgáló01 kiszolgáló szolgáltatási céljait kapja meg.

### 3. példa: Szolgáltatási célok lekérte egy helyhez
```
...
Ez a parancs egy adott Azure-régió szolgáltatási céljait kapja meg.
...
### -Location
Annak a helynek a neve, amelynek a szolgáltatásra vonatkozó célkitűzéseit ki kell kapnia.
...
Ez a parancsmag az erőforráshoz hozzárendelt SQL-adatbázis-kiszolgáló szolgáltatási céljait kapja.
...
### -ServerName
Az SQL-adatbázis SQL-adatbázis-kiszolgálójának nevét adja meg.
...
Egy Azure SQL-adatbázis-kiszolgáló szolgáltatási céljának nevét adja meg.
A paraméter elfogadható értékei: Basic, S0, S1, S2, P1, P2 és P3.
