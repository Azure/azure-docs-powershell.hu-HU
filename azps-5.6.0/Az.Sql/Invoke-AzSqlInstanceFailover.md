...
## LEÍRÁS
Az **Invoke-AzSqlInstanceFailover** parancsmag feladatátvételt ad az Azure SQL Felügyelt példányhoz.
...
Ez a parancs feladatátvételt ad vissza a "ManagedInstance01" nevű példány elsődleges példányában.
...
Ez a parancs feladatátvételt ad a felügyelt példány "ManagedInstance01" olvasható másodlagos példányának.
...
### -Name
Az eltávolítható Azure SQL-példány neve.
