...
Létrehozza egy olyan SQL-adatbázis másolatát, amely az aktuális időben használja a pillanatképet. (automatikusan generált)
...
### -ResourceGroupName
Annak az erőforráscsoportnak a nevét adja meg, amely a másolni kívánt adatbázist tartalmazza.
...
Annak a szolgáltatás-célnak a nevét adja meg, amit hozzá szeretne rendelni a másolathoz.
