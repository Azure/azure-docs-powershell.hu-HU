...
A Name.SqlDatabaseDnsSuffix (például az Name.database.windows.net) és a Name.secondary.SqlDatabaseDnsSuffix fájlban két Azure SQL-adatbázis TDS-végpont jön létre. Ezek a végpontok a feladatátvételi csoport elsődleges és másodlagos régióihoz való csatlakozásra használhatók. Ha az elsődleges régiót egy kimaradás érinti, a végpontok és adatbázisok automatikus feladatátvételét a rendszer a Példány feladatátvételi csoport feladatátvételi házirendjéből és türelmi időszakából fogja kiválteni.
