...
## LEÍRÁS
A **New-AzSqlInstanceDatabase** parancsmag létrehoz egy Azure SQL Felügyelt példány adatbázist.

## PÉLDÁK

### 1. példa: Adatbázis létrehozása egy megadott példányon
```
...
Ez a parancs létrehoz egy Database01 nevű példányadatbázist a példány managedInstance1 példányon.
...
### -Collation
Az Azure SQL Instance Database szétválogatása használatra.
...
### -Name
A létrehozni szükséges Azure SQL-példány-adatbázis neve.
...
### -Tag
Az Azure Sql Instance-adatbázissal társítva
