...
## LEÍRÁS
A **Remove-AzSqlDatabaseRestorePoint** parancsmag eltávolítja a visszaállítási pontot az Azure SQL-adatbázisból.
Ezt a parancsmagot jelenleg az SQL Server Datawarehouse szolgáltatás támogatja az Azure SQL-adatbázisban.

## PÉLDÁK

### 1. példa: Visszaállítási pont eltávolítása
```
...
Ez a parancs eltávolítja az Azure SQL-adatbázis visszaállítási pontját a létrehozás adott dátumával.
...
A visszaállítási pont létrehozásának dátumát adja meg.
