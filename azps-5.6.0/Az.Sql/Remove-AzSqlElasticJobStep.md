...
## LEÍRÁS
A Remove-AzSqlElasticJobStep parancsmag eltávolítja a feladat lépését egy feladatból

## PÉLDÁK

### 1. példa: Egy feladat lépésének eltávolítása egy feladatból
```powershell
...
Egy feladat lépésének eltávolítása egy feladatból
