...
## LEÍRÁS
A **Remove-AzSqlElasticPool** parancsmag törli az Azure SQL-adatbázis rugalmas készletét.

## PÉLDÁK

### 1. példa: Rugalmas készlet törlése
```
PS C:\>Remove-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Ez a parancs töröl egy RugalmasságPool01 nevű rugalmas készletet.
...
### -ElasticPoolName
Annak a rugalmas készletnek a nevét adja meg, amelyből a parancsmag töröl.
