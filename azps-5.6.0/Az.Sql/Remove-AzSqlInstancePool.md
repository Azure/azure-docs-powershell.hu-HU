...
## LEÍRÁS
A **Remove-AzSqlInstancePool** parancsmag eltávolít egy Azure SQL-példánykészletet.

## PÉLDÁK

### 1. példa: Példánykészlet eltávolítása
```powershell
PS C:\> Remove-AzSqlInstancePool -ResourceGroup resourcegroup01 -Name instancePool0
```

### 2. példa: Példánykészlet eltávolítása az erőforrás-azonosító alapján
```powershell
...
### 3. példa: Példánykészlet eltávolítása egy példánykészlet-objektum alapján
```powershell
...
Ez a parancs eltávolítja az InstancePool0 nevű példánykészletet.
...
### -InputObject
Az eltávolítható példánykészlet-objektum.
...
### -ResourceId
Az eltávolítható példánykészlet erőforrás-azonosítója.
