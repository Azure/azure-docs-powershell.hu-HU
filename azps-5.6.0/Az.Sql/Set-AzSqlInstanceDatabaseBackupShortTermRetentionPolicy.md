...
### PolicyByResourceInstanceDatabaseSet (alapértelmezett)
```
...
## LEÍRÁS
A **Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy parancsmag** megkapja az adatbázishoz regisztrált rövid távú adatmegőrzési házirendet.
A házirend az időkorrekciós biztonsági másolatok megőrzési ideje napokban.
...
Ez a parancs 35 napra állítja be az adatbázis01 rövid távú adatmegőrzési házirendját.
...
Ez a parancs egy adatbázis-objektum pipázásával 35 napra állítja be az adatbázis01 rövid távú adatmegőrzési házirendét.
...
Ez a parancs beállítja a rövid távú adatmegőrzési házirendet az összes DB1 nevű törölt adatbázisra egy törölt adatbázis-objektum pipázásával. Megjegyzés: A törölt adatbázisok adatmegőrzési ideje csak csökkenthető.

## PARAMETERS

### -DatabaseName
Annak az Azure SQL Instance Databasenek a neve, amelyről a biztonsági másolatok lekérhetők.
...
### -InputObject
Az élő vagy törölt adatbázis-objektum, amelyhez be kell szerezni/be kell állítani a házirendet.
...
### -InstanceName
Annak az Azure SQL Managed Instancenek a neve, amelyben az adatbázis van.
