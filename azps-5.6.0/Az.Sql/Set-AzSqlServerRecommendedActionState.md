...
## LEÍRÁS
A **Set-AzSqlServerRecom recommendedActionState** parancsmag frissíti egy Azure SQL Server ajánlott művelet állapotát.
Ez a parancsmag az új állapot alapján alkalmazza, visszaállítja vagy elveti az ajánlott műveletet.

## PÉLDÁK

### Példa1: A megadott javasolt művelet állapotának frissítése függőben lévőre
```
...
### -AdvisorName
Az ajánlott műveletet tartalmazó tanácsadó neve.
