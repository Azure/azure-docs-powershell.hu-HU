...
## LEÍRÁS
A Set-AzSqlServerTransparentDataEncryptionProtector parancsmag beállítja egy SQL-kiszolgáló TDE-védelmét.
A TDE-védelem típusának módosítása elforgatja a védelmet.
...
Ez a parancs szolgáltatás által felügyelt szolgáltatásra frissíti a kiszolgáló TDE-védelem típusát.
...
Ez a parancs frissíti a kiszolgálót úgy, hogy a kiszolgálókulcs-tároló kulcsát tDE-védelemként használja az https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 Azonosító ' azonosítóval.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
Az Azure Sql Database TDE-védelem típusa.
