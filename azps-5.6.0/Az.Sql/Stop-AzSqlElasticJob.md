...
## LEÍRÁS
A Stop-AzSqlElasticJob parancsmag futásvégrehajtással leállítja a feladatok végrehajtását.
A feladat végrehajtásának aktuális állapotát adja eredményül.

## PÉLDÁK

### 1. példa: Egy futó feladatvégrehajtással végzett feladat leállítja
```powershell
...
Leállít egy futó feladatvégrehajtást, és visszaadja az aktuális állapotát.
