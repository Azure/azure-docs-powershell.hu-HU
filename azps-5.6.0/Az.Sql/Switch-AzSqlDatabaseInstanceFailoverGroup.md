...
## LEÍRÁS
Ez a parancs felcseréli a felügyelt példányok szerepkörét egy példány feladatátvételi csoportjában azáltal, hogy feladatátvételt ad a megadott másodlagos régiónak, így az lesz az új elsődleges régió. Az elsődleges végponthoz csatlakozó összes új TDS-munkamenet automatikusan át lesz irányítva az új elsődleges régióba. 
...
Feladatátvételi művelettel adatvesztést engedélyez a példány feladatátvételi csoportjában.
...
### -AllowDataLoss
Akkor is befejezheti a feladatátvételt, ha ez adatvesztést okozhat.
Ez lehetővé teszi a feladatátvételt akkor is, ha az elsődleges adatbázis nem érhető el.
...
### -ResourceId
A váltáshoz szükséges példány feladatátvételi csoport erőforrás-azonosítója.
