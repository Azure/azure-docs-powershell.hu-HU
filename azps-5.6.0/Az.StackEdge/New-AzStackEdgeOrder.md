...
## LEÍRÁS
A **New-AzStackEdgeOrder** parancsmag új sorrendet hoz létre a Stack Edge-es eszközhöz. A rendelés létrehozása előtt először létre kell hozzon egy Stack Edge típusú eszközerőforrást. A rendelés létrehozásához megadhatja az olyan adatokat, mint a kapcsolattartó, a cég neve, az e-mail-cím stb. a sorrend létrehozásához szükséges paraméterek.
