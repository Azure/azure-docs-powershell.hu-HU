...
## LEÍRÁS
A **New-AzStackEdgeStorageAccount** parancsmag létrehoz egy új Edge Storage-fiókot egy Stack Edge-eszközön. Egy eszköz esetén egy Edge Storage-fióknak legalább egy felhőbeli tárfióknak lehet megfeleltetve.
