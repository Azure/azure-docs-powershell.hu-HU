...
Ha ezt a paramétert speicify, az egyes listabejegyzések tulajdonosi és csoportmezőiben visszaadott felhasználói identitásértékek Azure Active Directory-objektum-azonosítókból egyszerű felhasználónevekké alakulnak át. Ha nem speicify ez a paraméter, az értékeket a rendszer Azure Active Directory-objektum-adatokat ad vissza. Felhívjuk a figyelmét arra, hogy a csoport- és alkalmazásobjektum-azonosítókat nem fordítja a program, mert nem rendelkezik egyedi felhasználóbarát névvel.
