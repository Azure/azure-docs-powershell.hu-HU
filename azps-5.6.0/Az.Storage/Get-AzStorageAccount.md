...
## LEÍRÁS
A **Get-AzStorageAccount** parancsmag egy megadott tárfiókot vagy egy erőforráscsoport vagy az előfizetés összes tárfiókját megkapja.

## PÉLDÁK

### 1. példa: Adott tárfiók lekérte
```
PS C:\>Get-AzStorageAccount -ResourceGroupName "RG01" -Name "mystorageaccount"
```

Ez a parancs a megadott Tárfiókot kapja meg.

### 2. példa: Erőforráscsoport összes tárfiókja
```
PS C:\>Get-AzStorageAccount -ResourceGroupName "RG01"
```

Ez a parancs egy erőforráscsoport összes tárfiókját beveszi.

### 3. példa: Az előfizetés összes tárfiókja lekérte
```
PS C:\>Get-AzStorageAccount
```

Ez a parancs az előfizetés összes tárfiókját beveszi.

### 4. példa: Tárfiókok lekérte blob-visszaállítási állapotát
```
...
Ez a parancs blob-visszaállítási állapottal rendelkező tárfiókokat kap, és a blob-visszaállítás állapotát mutatja.
...
Szerezze be a BlobRestoreStatus tárfiókját.
...
Szerezze be a Tárfiók GeoReplicationStats-ját.
...
### -Name
A lekért tárfiók nevét adja meg.
...
### -ResourceGroupName
Annak az erőforráscsoportnak a neve, amely a behozni kívánt tárfiókot tartalmazza.
