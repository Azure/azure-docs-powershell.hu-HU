...
## LEÍRÁS
A **Get-AzStorageAccountManagementPolicy parancsmag** egy Azure Storage-fiók felügyeleti házirendjéhez jut.

## PÉLDÁK

### 1. példa: Tárfiók felügyeleti házirendének lekérte.
```
...
Ez a parancs egy Tárfiók felügyeleti házirendet kap.
