...
Ez a parancs a folyamat segítségével behoz minden blobot (a Törölt állapotban lévő blobokat is) egy tárolóba.
...
### 4. példa: Több köteg blob-ját listába sorolja
```
...
Ebben a példában *a MaxCount* és *a ContinuationToken paramétert* használva több kötegben felsoroljuk az Azure Storage blobokat.
...
### 5. példa: A tárolóban lévő összes blob lekért verziója a blobverziót is tartalmazza
```
...
Ez a parancs a tárolók összes blobját beveszi, például a blobverziót.
...
### -IncludeVersion
A blobverziók csak akkor lesznek felsorolva, ha ez a paraméter jelen van, alapértelmezés szerint a blob lekért verziója nem tartalmaz blobverziókat.
...
### -Előtag
Megadja a lekért blobnevek előtagját.
