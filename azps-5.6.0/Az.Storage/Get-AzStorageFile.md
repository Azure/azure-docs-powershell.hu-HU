...
Először begyűjte a címtárpéldányt, majd a **Get-AzStorageFile** parancsmagba befuttatva felsorolja a címtárat.
...
Ha tartalmazza a *Path* paramétert, akkor a **Get-AzStorageFile** egy címtár vagy fájl adott példányát adja vissza a megadott elérési útban.
...
Ha a megadott időköz eltelik, mielőtt a szolgáltatás feldolgozná a kérelmet, a Társzolgáltatás hibát ad vissza.
