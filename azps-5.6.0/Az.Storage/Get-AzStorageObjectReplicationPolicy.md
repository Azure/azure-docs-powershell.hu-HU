...
### 1. példa: Az objektum-replikációs házirend lekérte az adott házirend-azonosítót, és megmutatja a szabályokat.
```
...
Ez a parancs egy objektum-replikációs házirendet kap adott házirend-azonosítóval, és annak szabályait jeleníti meg.
