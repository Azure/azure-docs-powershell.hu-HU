...
Az első parancs a **New-AzStorageContext** parancsmagot használja környezet létrehozásához a *Helyi* paraméter használatával, majd ezt a környezetobjektumot a $Context tárolja.
...
Ez a parancs egy adott megosztási névvel és SnapshotTime-val készített fájlmegosztási pillanatképet kap.
...
Ez a parancsmag olyan fájlmegosztásokat kap, amelyek megegyeznek a paraméter által megadott előtaggal, vagy nem kap fájlmegosztást, ha egyetlen fájlmegosztás sem felel meg a megadott előtagnak.
