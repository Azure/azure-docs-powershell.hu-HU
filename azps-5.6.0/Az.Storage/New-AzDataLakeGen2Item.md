...
### 1. példa: Címtár létrehozása megadott engedéllyel, Umask-tulajdonságokkal, tulajdonságokkal és metaadatokkal
```
...
### -Tulajdonság
Megadja a létrehozott címtár vagy fájl tulajdonságait. A fájlok támogatott tulajdonságai: CacheControl, ContentDisposition, ContentEncoding, ContentLanguage, ContentMD5, ContentType.
