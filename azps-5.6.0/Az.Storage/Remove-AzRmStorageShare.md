...
### 2. példa: Tárterületfájl-megosztás eltávolítása a Tárfiók objektummal és a megosztás neve
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Ez a parancs eltávolítja a Tárfiók-objektummal és a megosztás nevével együtt a tárfájl megosztását.

### 3. példa: A tárfiók összes tárfájlmegosztásának eltávolítása folyamatban
```
