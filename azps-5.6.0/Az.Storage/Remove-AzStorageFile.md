...
### 1. példa: Fájl törlése fájlmegosztásból
```
PS C:\>Remove-AzStorageFile -ShareName "ContosoShare06" -Path "ContosoFile22"
```

Ez a parancs törli a ContosoFile22 nevű fájlt a ContosoShare06 nevű fájlmegosztásból.

### 2. példa: Fájl behozása fájlmegosztásból fájlmegosztási objektum használatával
```
PS C:\>Get-AzStorageShare -Name "ContosoShare06" | Remove-AzStorageFile -Path "ContosoFile22"
```

Ez a parancs **a Get-AzStorageShare** parancsmagot használva lekérte a ContosoShare06 nevű fájlmegosztást, majd a folyamat műveleti operátorával átadja az objektumot az aktuális parancsmagnak.
Az aktuális parancs törli a ContosoFile22 nevű fájlt a ContosoShare06-ból.
...
Ez a parancsmag eltávolít egy fájlt a paraméter által megadott mappából.
...
Ez a parancsmag eltávolítja a fájlt a paraméter által megadott megosztásban.
