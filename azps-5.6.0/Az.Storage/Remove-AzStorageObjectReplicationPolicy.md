...
## LEÍRÁS
A **Remove-AzStorageObjectReplicationPolicy parancsmag** eltávolítja a megadott objektum-replikációs házirendet egy tárfiókból.

## PÉLDÁK

### 1. példa: Tárfiókból eltávolíthat egy adott házirendazonosítóval megadott objektumreplikációs házirendet.
```
Remove-AzStorageObjectReplicationPolicy -ResourceGroupName "myresourcegroup" -AccountName "mystorageaccount" -PolicyId $policyId
```

Ez a parancs eltávolít egy tárfiókból egy adott házirendazonosítóval megadott objektumreplikációs házirendet.
...
### -InputObject
Törlünk egy objektum-replikációs házirendobjektumot.
