...
## LEÍRÁS
A **Restore-AzStorageBlobRange** parancsmag adott blobtartományok blobját visszaállítja egy tárfiókban.
Az indítási tartományt a rendszer tartalmazza, a végponttartományt pedig kihagyja a blob-visszaállításból.

## PÉLDÁK

### 1. példa: Blobok visszaállítása adott blobtartományokkal egy tárfiókban
```powershell
...
Ez a parancs először 2 blobtartományt hoz létre, majd egy 1 nappal ezelőtti 2 blobtartományt tároló tárfiókban elindítja a blobok visszaállítását. A felhasználó a Get-AzStorageAccount később nyomon tudja követni a visszaállítás állapotát.

### 2. példa: Egy tárfiók összes blobját visszaállítja a háttértárban
```powershell
...
Ez a parancs visszaállítja egy tárfiók összes blobját 30 perce, és várja meg, amíg a visszaállítás befejeződik. Mivel a visszaállítási blobok hosszú ideig is eltelhet, futtassa azt a backendben -As job paraméterrel, majd várja meg, amíg a feladat befejeződik, és mutassa az eredményt.

### 3. példa: Blobok visszaállítása bemeneti blobtartományok alapján közvetlenül, és várakozás a teljesre
```powershell
...
Ez a parancs 1 napja visszaállítja egy tárfiók blobját úgy, hogy 2 blobtartományt ad meg közvetlenül a Restore-AzStorageBlobRange parancsmagnak. Ez a parancs a visszaállítás befejeződik.
...
### -BlobRestoreRange
A visszaállítható blobtartomány.
Ha nem adja meg ezt a paramétert, az összes blobot visszaállítja.
...
### -WaitForComplete
Várakozás a visszaállítási feladat befejezésére
