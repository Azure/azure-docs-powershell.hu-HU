...
## LEÍRÁS
A **Set-AzStorageAccountManagementPolicy** parancsmag létrehoz vagy módosít egy Azure Storage-fiók kezelési házirendet.

## PÉLDÁK

### 1. példa: Tárfiók felügyeleti házirendének létrehozása vagy frissítése a ManagementPolicy szabályobjektumokkal.
```
...
Ez a parancs először 2 ManagementPolicy szabályobjektumot hoz létre, majd létrehozza vagy frissíti egy Tárfiók felügyeleti házirendét a 2 ManagementPolicy szabályobjektumokkal.

### 2. példa: Tárfiók kezelési házirendje létrehozása vagy frissítése Json formátumi házirend segítségével.
```
...
Ez a parancs json formátumi házirendet hoz létre vagy frissíti egy tárfiók felügyeleti házirendjéhez.

### 3. példa: Szerezze be a felügyeleti házirendet egy tárfiókból, majd állítsa be egy másik tárfiókra.
```
...
Ez a parancs először egy tárfiókból kapja meg a felügyeleti házirendet, majd beállít egy másik tárfiókot.
...
### -Házirend
Beállít egy felügyeleti házirendobjektumot
...
### -Rule
A Felügyeleti házirend szabályai. Szerezze be az objektumot egy New-AzStorageAccountManagementPolicyRule parancsmaggal.
