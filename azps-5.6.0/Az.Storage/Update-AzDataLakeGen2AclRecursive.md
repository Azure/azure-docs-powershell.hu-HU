...
## LEÍRÁS
Az **Update-AzDataLakeGen2AclRecursive** parancsmag frissíti az ACL-t rekurzívan a megadott útvonalon. A bemeneti ACL egyesíti az eredeti ACL-et: Ha az ACL-bejegyzés azonos AccessControlType/EntityId/DefaultScope létezik, frissítse az engedélyt; különben vegyen fel egy új ACL-bejegyzést.
...
### 2. példa: Az ACL frissítése rekurzív módon egy címtáron, és folytatás a ContinuationToken hiba esetén
```
