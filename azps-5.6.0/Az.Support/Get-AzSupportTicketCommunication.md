...
## LEÍRÁS
Egy támogatási jegy kommunikációját kapja meg. Ha nem ad meg más paramétereket, a rendszer beolvassa egy jegy összes kommunikációját. A CreatedDate vagy CommunicationType paraméterrel is szűrheti a kommunikációt. Íme néhány példa a megadható szűrőértékek használatára.
...
### 6. példa: Támogatási jegy 2019. december 20-án vagy után létrehozott összes kommunikáció lekérése
```powershell
