...
A parancsmag a "test-df-eu2" munkaterület "test-df-eu2" nevű, önkiszolgáló integrációs futásidejű "test-selfhost-ir" "Node_1" nevű csomópontról kap információkat, az IP-címet is beleértve.
