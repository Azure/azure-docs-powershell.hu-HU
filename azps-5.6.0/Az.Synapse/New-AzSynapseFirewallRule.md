...
## LEÍRÁS
A **New-AzSynapseFirewallRule parancsmag** létrehoz egy Azure Synapse Analytics tűzfalszabályt.
...
Ez a parancs létrehozza a ContosoFirewallRule nevű tűzfalszabályt a ContosoWorkspace munkaterületen ContosoFirewallRule néven.
...
Ez a parancs létrehozza a ContosoFirewallRule nevű tűzfalszabályt egy munkaterületen keresztüli folyamaton keresztül.
...
Ez a parancs olyan tűzfalszabályt hoz létre, amely engedélyezi az összes Azure IP-címet egy munkaterületen.

## PARAMETERS

### -AllowAllAzureIP
Létrehoz egy speciális tűzfalszabályt, amely engedélyezi az Összes Azure IP-nek a hozzáférést.
...
### -EndIpAddress
A tűzfalszabály ip-címe.
IPv4 formátumúnak kell lennie.
A startIpAddress értéknél nem kisebbnek kell lennie.
