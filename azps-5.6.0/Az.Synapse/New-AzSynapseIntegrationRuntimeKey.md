...
### NewByNameParameterSet (alapértelmezett)
```
...
## LEÍRÁS
A **New-AzSynapseIntegrationRuntimeKey** parancsmag a "KeyName" paraméterben megadott kulcsnévvel újragenerálja az integrációs futásidejű kulcsot. Az előző kulcs érvénytelen.
