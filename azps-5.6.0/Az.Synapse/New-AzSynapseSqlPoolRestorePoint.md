...
## LEÍRÁS
A **New-AzSynapseSqlPoolRestorePoint** parancsmag létrehoz egy új visszaállítási pontot, amelyből az Azure Synapse Analytics SQL-készlet visszaállítható.
...
Ez a parancs létrehozza a ContosoSqlPool nevű SQL-készlet visszaállítási pontját a ContosoWorkspace munkaterületen.
...
### -RestorePointLabel
Előfordulhat, hogy a visszaállítási pont címkéje nem egyedi.
