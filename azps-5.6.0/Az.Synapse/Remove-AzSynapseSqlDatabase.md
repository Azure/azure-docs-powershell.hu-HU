...
## SYNOPSIS
Egy Synapse Analytics SQL-adatbázis törlése.
...
## LEÍRÁS
A **Remove-AzSynapseSqlPool** parancsmag véglegesen töröl egy Azure Synapse Analytics SQL-adatbázist.
...
Ez a parancs töröl egy Azure Synapse Analytics SQL-adatbázist.
...
Ez a parancs egy Azure Synapse Analytics SQL-adatbázist töröl folyamaton keresztül.
...
Ez a parancs törli a megadott erőforrás-azonosítójú Azure Synapse Analytics SQL-adatbázist.
...
### -InputObject
SQL-adatbázis bemeneti objektuma, amely általában a folyamaton keresztül van átfutva.
