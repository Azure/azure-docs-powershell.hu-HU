...
### 1. példa: Hozzáférési házirend létrehozása egy adott környezethez
```powershell
...
Ez a parancs hozzáférési házirendet hoz létre egy adott környezethez.
