...
### 1. példa: Megadott hozzáférési házirend eltávolítása név szerint
```powershell
PS C:\> Remove-AzTimeSeriesInsightsAccessPolicy -EnvironmentName tsitest001 -Name policy001 -ResourceGroupName testgroup

```

Ez a parancs eltávolít egy megadott hozzáférési házirendet.

### 2. példa: Megadott hozzáférési házirend eltávolítása objektum szerint
```powershell
