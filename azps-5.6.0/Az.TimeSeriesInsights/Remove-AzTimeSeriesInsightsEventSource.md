...
### 1. példa: Egy megadott eseményforrás eltávolítása név szerint
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEventSource -EnvironmentName tsitest001 -Name iots001 -ResourceGroupName testgroup

```

Ezzel eltávolít egy adott eseményforrást.

### 2. példa: Egy megadott eseményforrás eltávolítása objektum alapján
```powershell
