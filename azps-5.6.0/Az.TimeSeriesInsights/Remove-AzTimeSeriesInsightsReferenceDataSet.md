...
### 1. példa: Egy megadott hivatkozási adatkészlet eltávolítása név szerint
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Ez a parancs eltávolít egy megadott hivatkozási adatkészletet.

### 2. példa: Egy megadott hivatkozási adatkészlet eltávolítása objektum szerint
```powershell
