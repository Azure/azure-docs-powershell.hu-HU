...
### 1. példa: Egy megadott hozzáférési házirend frissítése név szerint
```powershell
...
### 2. példa: Egy megadott hozzáférési házirend frissítése objektum szerint
```powershell
...
### -Szerepkör
A környezetben hozzárendelt szerepkörök listája.
