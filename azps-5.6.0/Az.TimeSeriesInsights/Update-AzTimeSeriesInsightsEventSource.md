...
### 1. példa: Egy megadott eseményforrás frissítése név szerint
```powershell
...
Ez a parancs frissíti egy adott eseményforrást.

### 3. példa: Egy megadott eseményforrás frissítése objektum szerint
```powershell
...
### -Tag
Az eseményforrás további tulajdonságainak kulcsértékei.
