...
### 1. példa: Egy megadott hivatkozási adatkészlet frissítése név szerint
```powershell
...
### 2. példa: Egy megadott hivatkozási adatkészlet frissítése objektum szerint
```powershell
...
### -Tag
A hivatkozási adatkészlet további tulajdonságainak kulcsértékei.
