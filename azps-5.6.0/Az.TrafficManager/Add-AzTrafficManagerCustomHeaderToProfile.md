...
## LEÍRÁS
Az **Add-AzTrafficManagerCustomHeaderToProfile** parancsmag egyéni fejlécadatokat ad a helyi Azure Traffic Manager-profilobjektumhoz.
...
### 1. példa: Egyéni fejléc-információk hozzáadása egy profilhoz
```
...
A második parancs egyéni fejlécadatokat ad hozzá a $TrafficManagerProfile.
