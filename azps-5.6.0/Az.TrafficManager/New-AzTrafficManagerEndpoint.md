...
### -GeoMapping
Az ehhez a végponthoz csatlakoztatott régiók listája a "Földrajzi" forgalom útválasztási metódusának használata esetén. Az elfogadott értékek teljes listáját a Traffic Manager dokumentációjában találhatja meg.
...
### -Name
Ez a parancsmag által létrehozott Traffic Manager-végpont nevét adja meg.
...
### -ProfileName
Annak a Traffic Manager-profilnak a nevét adja meg, amelyhez a parancsmag hozzáad egy végpontot.
