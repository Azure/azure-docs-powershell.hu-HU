...
## LEÍRÁS
Az **Edit-AzWebAppBackupConfiguration** parancsmag az Azure Web App aktuális konfigurációs biztonsági másolatát szerkeszti.

## PÉLDÁK

### 1. példa

A Edit-AzWebAppBackupConfiguration parancsmag az Azure Web App aktuális konfigurációs biztonsági másolatát szerkeszti. (automatikusan generált)
