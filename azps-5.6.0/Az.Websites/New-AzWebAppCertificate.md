...
## SYNOPSIS
Létrehoz egy appszolgáltatás által felügyelt tanúsítványt egy Azure Web Apphoz. 
...
## LEÍRÁS
A **New-AzWebAppCertificate** parancsmag létrehoz egy Azure App Service Felügyelt tanúsítványt
## PÉLDÁK
...
Ez a parancs appszolgáltatás által felügyelt tanúsítványt hoz létre az adott WebApphoz
...
Ez a parancs létrehoz egy appszolgáltatás által felügyelt tanúsítványt, és a megadott webapphelyhez kötődik.
...
Ez a parancs létrehoz egy appszolgáltatás által felügyelt tanúsítványt, és a megadott WebApphoz kötődik.

## PARAMETERS

### -AddBinding
A létrehozott tanúsítvány hozzáadása a WebApp/slot alkalmazáshoz.
...
### -HostName
A webalkalmazáshoz/-tárolóhelyhez társított egyéni állomásnevek.
...
### -SslState
Ssl-állapot beállítás.
Használja a "SniEnabled" vagy az "IpBasedEnabled" címet.
Az alapértelmezett beállítás a "SniEnabled".
