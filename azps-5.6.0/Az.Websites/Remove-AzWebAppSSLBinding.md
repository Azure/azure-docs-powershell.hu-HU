...
Az 1. példához hasonlóan ez a parancs a Web App ContosoWebApp SSL-kötését is eltávolítja.
...
Ebben a példában a Web App webhelyére hivatkozó objektumhivatkozás eltávolítja egy webalkalmazás SSL-kötését.
