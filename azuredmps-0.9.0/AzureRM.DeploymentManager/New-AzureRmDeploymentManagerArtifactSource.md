...
## Leírás
A **New-AzureRmDeploymentManagerArtifactSource** parancsmag tárgyi forrást hoz létre.
Adja meg a *nevet* , a *ResourceGroupName* és a szükséges tulajdonságokat.

A visszaadott objektumot helyileg módosíthatja, majd a Set-AzureRmDeploymentManagerArtifactSource parancsmag használatával alkalmazhatja a módosításokat az objektum forrására.

A parancsmag egy olyan ArtifactSource objektumot ad eredményül, amely ResourceId hivatkozik az New-AzureRmDeloymentManagerServiceTopology parancsmagban, így a ServiceUnit-erőforrásokhoz, a sablon-és a Parameters-fájlokhoz szükséges leletek is hivatkozhatók erre a helyről.
