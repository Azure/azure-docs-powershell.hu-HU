...
## Leírás
A **Remove-AzureRmDeploymentManagerServiceUnit** parancsmag egy szolgáltatási egységet töröl a szolgáltatásban.
...
### -Name (név)
A törlendő szolgáltatási egység neve.
...
### -Szolgáltatásnév
Annak a szolgáltatásnak a neve, amelyhez a szolgáltatási egység tartozik.
...
### -ServiceTopologyName
Annak a szolgáltatási hálózatnak a neve, amelyhez a szolgáltatási egység tartozik.
