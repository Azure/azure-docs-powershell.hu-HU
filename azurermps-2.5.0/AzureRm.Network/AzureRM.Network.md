...
{{Manuálisan adja meg a Add-AzureRmLoadBalancerInboundNatPoolConfig leírását}}
...
{{Manuálisan adja meg a Get-AzureRmBgpServiceCommunity leírását}}
...
{{Manuálisan adja meg a Get-AzureRmLoadBalancerInboundNatPoolConfig leírását}}
...
{{Manuálisan adja meg a Get-AzureRmVirtualNetworkGatewayConnectionSharedKey leírását}}
...
Lehetővé teszi a felhasználóknak, hogy egyszerűen töltse le a New-AzureRmVpnClientConfiguration parancsmagot létrehozott VPN-profil csomagot.
...
### [Új – AzureRmApplicationGatewayAuthenticationCertificate](New-AzureRmApplicationGatewayAuthenticationCertificate.md)
...
### [Új – AzureRmApplicationGatewayFirewallDisabledRuleGroupConfig](New-AzureRmApplicationGatewayFirewallDisabledRuleGroupConfig.md)
...
### [Új – AzureRmApplicationGatewayProbeConfig](New-AzureRmApplicationGatewayProbeConfig.md)
Létrehoz egy egészségi szondát.

### [Új – AzureRmApplicationGatewayProbeHealthResponseMatch](New-AzureRmApplicationGatewayProbeHealthResponseMatch.md)
A Health Probe által használt állapottanúsítvány-választ tartalmazó egyezést hoz létre egy alkalmazás-átjáróhoz.

### [Új – AzureRmApplicationGatewayRedirectConfiguration](New-AzureRmApplicationGatewayRedirectConfiguration.md)
...
### [Új – AzureRmIpsecPolicy](New-AzureRmIpsecPolicy.md)
...
### [Új – AzureRmLoadBalancerInboundNatPoolConfig](New-AzureRmLoadBalancerInboundNatPoolConfig.md)
{{Manuálisan adja meg a New-AzureRmLoadBalancerInboundNatPoolConfig leírását}}
...
### [Új – AzureRmLocalNetworkGateway](New-AzureRmLocalNetworkGateway.md)
...
{{Manuálisan adja meg a New-AzureRmVirtualNetworkGatewayConnection leírását}}
...
### [Új – AzureRmVpnClientConfiguration](New-AzureRmVpnClientConfiguration.md)
...
{{Manuálisan adja meg a Remove-AzureRmLoadBalancerInboundNatPoolConfig leírását}}
...
{{Manuálisan adja meg a Remove-AzureRmVirtualNetworkGatewayIpConfig leírását}}

### [Remove-AzureRmVirtualNetworkPeering](Remove-AzureRmVirtualNetworkPeering.md)
{{Manuálisan adja meg a Remove-AzureRmVirtualNetworkPeering leírását}}
...
{{Manuálisan adja meg a Reset-AzureRmVirtualNetworkGateway leírását}}

### [Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey](Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey.md)
{{Manuálisan adja meg a Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey leírását}}
...
{{Manuálisan adja meg a Set-AzureRmLoadBalancerInboundNatPoolConfig leírását}}
...
### [Teszt-AzureRmDnsAvailability](Test-AzureRmDnsAvailability.md)
{{Manuálisan adja meg a Test-AzureRmDnsAvailability leírását}}
...
### [Teszt-AzureRmPrivateIPAddressAvailability](Test-AzureRmPrivateIPAddressAvailability.md)
