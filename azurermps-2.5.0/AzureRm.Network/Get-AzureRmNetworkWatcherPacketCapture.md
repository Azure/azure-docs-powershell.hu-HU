...
## Leírás
A Get-AzureRmNetworkWatcherPacketCapture a csomag-rögzítő erőforrás tulajdonságait és állapotát kapja meg.

## Példák

### ---Példa 1: több szűrővel rendelkező csomag létrehozása és állapotának beolvasása---
```
...
Ebben a példában a "PacketCaptureTest" nevű csomagot hozzuk létre több szűrővel és időkorlátozással. A munkamenet befejezésekor a program a megadott tárterület-fiókba menti a fájlt. Ezután hívja fel Get-AzureRmNetworkWatcherPacketCapture a rögzítési munkamenet állapotának visszakereséséhez. 
