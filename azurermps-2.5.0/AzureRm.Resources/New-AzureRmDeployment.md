...
## Leírás
A **New-AzureRmDeployment** parancsmag bevezetést ad az aktuális előfizetési tartományhoz.
...
Ha erőforrásokat szeretne felvenni egy erőforráscsoport számára, használja az **új AzureRmDeployment** , amely egy erőforrás-csoportban hoz létre központi telepítést.
A **New-AzureRmDeployment** parancsmag létrehoz egy központi telepítést a jelenlegi előfizetési tartományhoz, amely az előfizetési szint erőforrásait telepíti. 
