...
### 2. példa: blob beszerzése a csővezeték használatával
```
PS C:\>Get-AzureStorageContainer -Name container* | Get-AzureStorageBlob
```

Ez a parancs a futószalagot használva blobot kap.

### 3. példa: név előtagjának beszerzése
```
PS C:\>Get-AzureStorageBlob -Container "ContainerName" -Prefix "blob"
```

Ez a parancs egy név előtagot használ a blob beszerzéséhez.
