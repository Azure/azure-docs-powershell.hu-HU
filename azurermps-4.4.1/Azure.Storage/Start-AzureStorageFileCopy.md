...
## Leírás
A **Start-AzureStorageFileCopy** parancsmag a forrásfájl szövegfájlba való másolását kezdi.

## Példák

### 1. példa: a másolási művelet indítása fájlból fájlból fájlból a megosztás név és fájlnév használatával
```
...
Ez a parancs a fájlból fájlból másolt műveletet indítja el.
A parancs a megosztás neve és a fájlnév nevet adja meg

### 2. példa: a másolási művelet indítása blobról fájlra a tároló neve és a blob neve segítségével
```
...
Ez a parancs egy másolati műveletet indít el a blob-fájlból.
A parancs a tároló nevét és a blob nevét adja meg

## PARAMÉTEREK

### -AbsoluteUri
A forrásfájl URI-azonosítóját adja meg.
Ha a forrás helyéhez hitelesítő adatokra van szükség, meg kell adnia egyet.
...
### -DestContext
A cél Azure tárolási környezetét adja meg.
Környezet beolvasásához használja az **új AzureStorageContext**.
...
### -DestFilePath
A célfájl elérési útját adja meg a cél megosztásához viszonyítva.
...
### -DestShareName
A célként megadott megosztás nevét adja meg.
...
A Get-AzureStorageBlob parancsmag segítségével létrehozhat egy felhőalapú blobot, vagy megadhat egyet.
...
### -SrcContainer
Egy felhőalapú blob-tároló objektumot ad meg.
Létrehozhat felhőalapú blob-tároló objektumot, vagy használhatja az Get-AzureStorageContainer parancsmagot.
...
### -SrcFile
Egy **CloudFile** -objektumot ad meg.
Létrehozhat egy felhőalapú fájlt, vagy beszerezhet egyet a **Get-AzureStorageFile** segítségével.
...
### -SrcFilePath
A forrásfájl elérési útvonalát adja meg a forrás vagy a forrás megosztásához viszonyítva.
...
### -SrcShare
A felhőalapú fájlmegosztás objektumát adja meg.
A Get-AzureStorageShare parancsmag segítségével létrehozhatja a felhőalapú fájlokat, vagy megadhat egyet.
...
### -SrcShareName
A forrás megosztás nevét adja meg.
...
A ' SrcBlob ' paraméter az "CloudBlob" típusú értéket fogadja el a csővezetékről

### CloudFile

A ' SrcFile ' paraméter az "CloudFile" típusú értéket fogadja el a csővezetékről
