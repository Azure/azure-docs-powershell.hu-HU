...
## Leírás
A **Get-AzureRmAutomationHybridWorkerGroup** parancsmag Azure Automation hibrid runbook-munkacsoportokat kap.
...
### Microsoft. Azure. Command. Automation. Model. HybridRunbookWorker
