...
## Leírás
A **Get-AzureRmAutomationRunbook** parancsmag Azure automatizálási runbooks kap.
Ha meghatározott runbook szeretne kapni, adja meg a nevét.
...
Annak az automatizálási fióknak a nevét adja meg, amelyben a parancsmag runbooks válik.
...
### -Name (név)
Annak a runbook a nevét adja meg, amely a parancsmagot kapja.
...
### -ResourceGroupName
Annak az erőforráscsoportnek a neve, amelyhez a parancsmag runbooks válik.
