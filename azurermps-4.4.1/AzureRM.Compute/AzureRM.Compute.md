...
A kép hivatkozási tulajdonságait állítja be a Disk Update objektumban.
...
A kép hivatkozásának tulajdonságait állítja be egy pillanatkép-frissítő objektumon.
...
A virtuális gép platformjának képét adja meg.
