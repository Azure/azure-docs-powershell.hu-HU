...
## Leírás
A **Get-AzureRmVMImage** parancsmag a VMImage összes verzióját kapja.
...
Képközzétevő beolvasásához használja az Get-AzureRmVMImagePublisher parancsmagot.
...
SKU beolvasásához használja az Get-AzureRmVMImageSku parancsmagot.
