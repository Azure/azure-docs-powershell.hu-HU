...
## Leírás
A **New-AzureVMSqlServerAutoBackupConfig** parancsmag létrehoz egy konfigurációs OBJEKTUMOT az SQL Server automatikus biztonsági mentéséhez.
...
### -FullBackupFrequency
SQL Server – teljes biztonsági másolat gyakorisága, naponta vagy hetente
