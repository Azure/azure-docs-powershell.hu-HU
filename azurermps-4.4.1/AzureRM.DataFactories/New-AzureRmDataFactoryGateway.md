...
## Leírás
A **New-AzureRmDataFactoryGateway** parancsmag átjárót hoz létre az Azure Data Factory-ban.

## Példák

### Példa 1: átjáró létrehozása
```
...
Ez a parancs létrehoz egy ContosoGateway nevű átjárót az WikiADF nevű adatgyárban az ADF nevű erőforrás csoportban.

## PARAMÉTEREK

### -DataFactory
Egy **PSDataFactory** -objektumot ad meg.
Ez a parancsmag létrehoz egy átjárót az adatfeldolgozó számára, amely ezt a paramétert adja meg.
...
### -Name (név)
A létrehozandó átjáró nevét adja meg.
...
Ez a parancsmag létrehoz egy átjárót, amely a paraméter által definiált csoportba tartozik.
