...
## Leírás
A **Get-AzureRmDataLakeStoreItem** parancsmag az adatok tava áruházban található fájlok vagy mappák részleteit kapja meg.
...
### DataLakeStoreItem
A megadott elérési úton lévő fájl vagy mappa
