...
Ez a parancs feltölti a fájlt SrcFile.csv és felveszi a MyFiles-mappába az adattó áruházban File.csv.
...
### -ConcurrentFileCount
Adja meg, hogy a feltöltött fájlok legfeljebb hány fájlt tölthetnek fel párhuzamosan a mappa feltöltésekor.
...
### -ForceBinary
Azt jelzi, hogy ez a művelet bináris fájlként tölti fel a fájlt.
...
### – Önéletrajz
Azt jelzi, hogy ez a művelet a korábban lemondott vagy sikertelen feltöltést folytassa.
