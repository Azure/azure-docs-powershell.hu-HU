...
### -Clean
Jelzi, hogy ez a művelet eltávolítja a célmappa teljes tartalmát, és megtartja a mappát.
Használja ezt a paramétert a *recurse* paraméterrel.
...
Ha nem adja meg a *Clean* paramétert, a célmappát is törli.
...
### bool
Ha a PassThru meg van adva, a művelet eredményét adja eredményül.
