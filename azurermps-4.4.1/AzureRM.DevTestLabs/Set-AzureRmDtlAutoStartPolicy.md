...
## Leírás
A **set-AzureRmDtlAutoStartPolicy** parancsmag egy Lab automatikus indítási házirendjét állítja be, amely lehetővé teszi, hogy a laboratóriumban futó virtuális gépek az automatikus indításra legyenek ütemezve.
...
### -Days
A hét azon napjait adja meg tömbként, amikor a Lab virtuális számítógépeit el kell indítani.
...
### -Letiltása
Jelzi, hogy ez a parancsmag letiltja a tesztkörnyezetben a virtuális gépekre vonatkozó házirendet.
...
### – Engedélyezés
Jelzi, hogy ez a parancsmag engedélyezi a tesztkörnyezetben a virtuális gépek házirendjét.
...
### -LabName
Annak a laboratóriumnak a nevét adja meg, amelyhez ez a parancsmag állítja be az automatikus indítási házirendet.
...
### -Idő
Meghatározza, hogy mikor kell elindítani a Lab virtuális számítógépeit.
...
Ez a parancsmag azt az ütemtervet adja eredményül, amely meghatározza, hogy mikor kell elindítani a Lab virtuális számítógépeit.
