...
## Áttekintés
A megadott engedélyezési szabály törlése az esemény-hubok névtérben.
...
## Leírás
A Remove-AzureRmEventHubNamespaceAuthorizationRule parancsmag eltávolítja és törli a megadott engedélyezési szabályt az adott esemény-hubok névtérben.
