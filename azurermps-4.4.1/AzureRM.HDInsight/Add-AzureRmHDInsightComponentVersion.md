...
## Leírás
A Add-AzureRmHDInsightComponentVersion parancsmag a New-AzureRmHDInsightClusterConfig parancsmag által létrehozott Azure HDInsight Configuration objektumhoz ad egy verziót a fürtben futó szolgáltatásokhoz.

## Példák

### --------------------------Példa 1: a szikra verzió hozzáadása a fürtkonfigurációs objektumhoz.  --------------------------
@ {bekezdés = PS C: \\ \> }
...
Ez a parancs hozzáadja a szikra verzióját a "saját szikra-001" nevű HDInsight-fürthöz.
