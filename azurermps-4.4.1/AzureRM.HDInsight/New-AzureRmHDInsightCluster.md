...
## Leírás
A New-AzureHDInsightCluster Azure HDInsight-fürtöt hoz létre a megadott paraméterekkel vagy a New-AzureRmHDInsightClusterConfig parancsmaggal létrehozott konfigurációs objektum használatával.

## Példák

### --------------------------Példa 1: Azure HDInsight-ös fürt létrehozása--------------------------
@ {bekezdés = PS C: \\ \> }
...
A Add-AzureRmHDInsightStorage parancsmagot is használhatja.
...
A beállítások a következők: Hadoop, HBase, Storm, szikra
...
Ezt az objektumot az New-AzureRmHDInsightClusterConfig parancsmag segítségével hozhatja létre.
...
A Add-AzureRmHDInsightConfigValues parancsmagot is használhatja.
...
A Set-AzureRmHDInsightDefaultStorage parancsmagot is használhatja.
...
Annak az alapértelmezett Azure-tárterületnek a nevét adja meg, amelyet a HDInsight-fürt használni fog.
A Set-AzureRmHDInsightDefaultStorage parancsmagot is használhatja.
...
A HDInsight-fürtöt használó alapértelmezett tárterület-fiók típusát adja meg. A lehetséges értékek a AzureStorage és a AzureDataLakeStore. Az alapértelmezett érték a AzureStorage, ha nincs megadva.
...
Annak az alapértelmezett tárolónak a nevét adja meg, amely a HDInsight-fürtöt használó alapértelmezett Azure Storage fiókban található.
A Set-AzureRmHDInsightDefaultStorage parancsmagot is használhatja.
...
Megadja az elérési utat az adattó-tároló fiókban, amelyet a HDInsight-fürt alapértelmezett fájlrendszerként fog használni.
...
Másik lehetőségként használhatja a bővítmények AzureRmHDInsightScriptAction.
...
A Add-AzureRmHDInsightSecurityProfile parancsmagot is használhatja.
...
### -SubnetName
A fürt kiválasztott virtuális hálózatán belüli alhálózat nevét adja meg.
