...
## Leírás
A **WAIT-AzureRmHDInsightJob** parancsmag várja az Azure HDInsight-feladatok befejezését vagy hibáját.

## Példák

### Példa 1: várakozás a feladat befejezésére vagy hibájának megtartására
```
PS C:\># Cluster info
...
A parancs megvárja a feladatok befejezését vagy kudarcát.
...
### -TimeoutInSeconds
A munkavégzés befejezéséhez szükséges teljes idő másodpercben.
...
A feladatok állapotának ellenőrzése között eltelt idő másodpercben.
...
### Karakterlánc
A ' JobId ' paraméter a "string" típusú értéket fogadja el a csővezetékről
