...
### New-AzureRmAutoscaleProfile parancsmag paraméterei ütemezett időpontok nélkül
```
...
### New-AzureRmAutoscaleProfile parancsmag paramétereinek beállítása a javítás dátuma ütemezésével
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
### New-AzureRmAutoscaleProfile parancsmag paraméterei ismétlődő ütemezés használatával
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
