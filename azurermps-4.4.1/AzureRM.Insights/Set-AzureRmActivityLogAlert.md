...
### A műveletnapló riasztásának beállítása alapértelmezett paraméterei
```
...
### A ResourceId a pipe-ról történő átvételét jelző paraméterek
```
...
### A tevékenység-naplózási riasztások értékének beállítására szolgáló paraméterek a pipe-ról
```
