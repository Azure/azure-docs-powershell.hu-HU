...
## Leírás
Egy fogyasztói csoportot hoz létre a megadott IotHub társított Eventhub.

## Példák

### 1. példa: fogyasztói csoport felvétele a telemetriai eventhub
```
...
Egy "myconsumergroup" nevű új consumergroup ad a eventhub a telemetriai eseményeiről a iothub nevű "myiothub"-hoz.

### 2. példa: fogyasztói csoport felvétele a műveletek figyelési eventhub
```
...
Egy "myconsumergroup" nevű új consumergroup ad a eventhub az "myiothub" nevű iothub műveletek figyelési eseményeihez.

## PARAMÉTEREK

### -EventHubConsumerGroupName
A felvenni kívánt EventHub-ConsumerGroup neve.
