...
### Példa 1 a SKU frissítése
```
PS C:\> Set-AzureRmIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName S1 -Units 5
```

Frissítse a SKU-ot S1-re, és a "myiothub" nevű IotHub az 5 egységre

### 2. példa a eventhub tulajdonságainak frissítése
```
PS C:\> Set-AzureRmIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -EventHubRetentionTimeInDays 4
```

A "myiothub" nevű IotHub telemetriai-és operationsmonitoringevents-eseményeinek frissítése a napok és a 4 közötti adatmegőrzési idő között

## PARAMÉTEREK

### -CloudToDevice
A felhőalapú eszközhöz tartozó parancssori várólista tulajdonságai 
...
Megjelölés, amely azt adja meg, hogy a fájlfeltöltés esetén engedélyezve legyenek-e az értesítések. 
...
### -FallbackRoute
Az útválasztási tartalék útvonala
...
Annak a tárolónak a neve, amelybe fel szeretné tölteni a fájlokat.
...
A maximális kézbesítési szám a fájlfeltöltés-értesítésekhez.  
...
A fájlfeltöltés értesítési várólistájában szereplő üzenetek értékének megadására szolgáló idő. 
...
### -FileUploadSasUriTtl
A feltöltéshez létrehozott SAS-URI-hoz használható idő. 
...
A tárterület-kapcsolat karakterlánca a fájlok feltöltéséhez. 
...
A műveletek figyeléséhez kapcsolódó tulajdonságok. 
...
### -Útvonalak
Az útválasztáshoz hozzáadni kívánt útvonalak
...
### -RoutingProperties
Az útválasztási üzenetek külső végpontokhoz való útválasztási tulajdonságai 
...
### System. String
Microsoft. Azure. Command. Management. IotHub. models. PSCloudToDeviceProperties Microsoft. Azure. Command. Management. IotHub. models. PSOperationsMonitoringProperties
