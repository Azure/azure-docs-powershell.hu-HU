...
## Leírás
A **Get-AzureKeyVaultCertificateOperation** parancsmag egy tanúsítvány-művelet állapotát kapja meg.

## Példák

### Példa 1: tanúsítvány-művelet állapotának beszerzése
```
...
Ez a parancs a ContosoKV01 TestCert01 tanúsítványának állapotát kapja meg.
