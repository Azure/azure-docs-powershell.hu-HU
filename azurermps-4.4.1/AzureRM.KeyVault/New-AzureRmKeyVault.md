...
### -EnableSoftDelete
Ha meg van adva, akkor a "puha Törlés" funkció engedélyezve van ehhez a kulcs boltozathoz.
...
### -Hely
Azt az Azure-területet adja meg, amelyben a fő pince hozható létre. A https://msdn.microsoft.com/ választható lehetőségek megjelenítéséhez használja az Get-AzureLocation (Library/Azure/mt589064. aspx) parancsot. További információért írja be a következőt: `Get-Help Get-AzureLocation` .
