...
## Leírás
Áthelyezi a kötelezettségvállalási társulás erőforrását a fölérendelt kötelezettségvállalási tervből egy másik kötelezettségvállalási csomagra.

## Példák

### --------------------------Példa 1: kötelezettségvállalási társítás áthelyezése--------------------------
@ {bekezdés = PS C: \\ \> }
...
### -DestinationPlanId
Az Azure Resource ID a cél Azure ML kötelezettségvállalási csomaghoz.
