...
## Leírás
A Get-AzureRmNetworkWatcherTroubleshootingResult parancsmag a korábban futtatott vagy a jelenleg futó Start-AzureRmNetworkWatcherResourceTroubleshooting műveletből kapja meg a hibaelhárítási találatokat. Ha a hibaelhárítási művelet jelenleg folyamatban van, előfordulhat, hogy a művelet elvégzéséhez néhány percet is igénybe vehet. Jelenleg a virtuális hálózati átjárók és a kapcsolatok támogatottak.

## Példák

### ---Példa 1: a hibaelhárítás indítása virtuális hálózati átjárón és a találatok beolvasása---
```
...
A hibaelhárítást követően a hívás eredményének beolvasásához Get-AzureRmNetworkWatcherTroubleshootingResult hívást kell kezdeményezni az erőforrásra. 
