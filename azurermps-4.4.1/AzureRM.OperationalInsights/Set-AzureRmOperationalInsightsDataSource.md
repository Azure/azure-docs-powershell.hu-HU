...
## Leírás
A **set-AzureRmOperationalInsightsDataSource** parancsmag frissíti az adatforrást.
...
### PSDataSource
A "DataSource" paraméter az "PSDataSource" típusú értéket fogadja el a csővezetékről
