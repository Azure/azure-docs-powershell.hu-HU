...
## Leírás
A **New-AzureRmRedisCacheKey** parancsmag újból létrehoz egy Azure Redis-gyorsítótár elérési kulcsát.

## Példák

### 1. példa: elsődleges kulcs újragenerálása
```
...
Ez a parancs újból létrehoz egy Redis-gyorsítótár elsődleges kulcsát.

### 2. példa: másodlagos kulcs újragenerálása
```
...
Ez a parancs újból létrehoz egy Redis-gyorsítótár másodlagos kulcsát.
...
### -Típus
Itt adhatja meg, hogy az elsődleges vagy másodlagos hozzáférési kulcs újragenerálása
Az érvényes értékek: elsődleges, másodlagos.
...
Ez a parancsmag egy Redis-gyorsítótár elsődleges és másodlagos elérési kulcsát számítja ki.
