...
## Leírás
A **set-AzureRmServiceBusQueue** parancsmag frissíti a szolgáltatás busz-várólistájának leírását a megadott Service Bus névtérben.
...
Frissíti a megadott várólistát egy új leírással a megadott névtérben. Ez a példa frissíti a **DeadLetteringOnMessageExpiration** tulajdonságot **true** értékre, és a **SupportOrdering** **true** értékre.
