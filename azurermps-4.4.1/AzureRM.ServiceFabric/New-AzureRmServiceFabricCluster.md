...
### 3. példa: új fürt létrehozása egyéni sablon használatával. Adja meg a kulcsfájl eltérő RG nevét, és a rendszer feltölti a tanúsítványt a rendszerbe.
```
...
Ez a parancs egy új fürtöt hoz létre egyéni sablon használatával. Adja meg a kulcsfájl eltérő RG-nevét, és a rendszer feltölti a tanúsítványt.
