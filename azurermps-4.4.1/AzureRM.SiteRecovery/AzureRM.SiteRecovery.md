...
## AzureRM. SiteRecovery parancsmagok
...
A Hyper-V-webhelyeket a webhely-helyreállítási boltozatból kapja meg.
...
Az aktuális webhely-helyreállítási boltozat beállítási adatait kapja meg.
...
Az Azure webhely-helyreállítási védelmi tárolók megfeleltetését egy házirend védett tárolóhoz társításával hozza létre.
...
Tárolási besorolási megfeleltetést hoz létre a webhely-helyreállításban.
...
Az Azure webhely-helyreállítási replikációval védett elem eltávolítása.

### [Remove-AzureRmSiteRecoveryServer](Remove-AzureRmSiteRecoveryServer.md)
Eltávolítja a webhely-helyreállítási kiszolgálót az aktuális boltozatról.
...
A helyreállítási tulajdonságokat (például a cél hálózat és a virtuális gép méretét) állítja be a replikációs szolgáltatással védett elemekhez.
...
Teszteli a feladatátvételt a webhely-helyreállítási védelem entitásban.
...
{{Manuálisan adja meg a Update-AzureRmSiteRecoveryPolicy leírását}}
