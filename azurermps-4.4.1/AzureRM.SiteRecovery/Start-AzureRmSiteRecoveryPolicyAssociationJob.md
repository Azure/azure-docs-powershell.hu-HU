...
## Leírás
A **Start-AzureRmSiteRecoveryPolicyAssociationJob** parancsmag társítási feladatot kezdeményez a replikációs házirend társításához az Azure webhely-helyreállítási védelmi tárolóval.
