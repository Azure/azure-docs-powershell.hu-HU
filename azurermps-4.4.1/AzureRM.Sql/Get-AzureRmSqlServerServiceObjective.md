...
## Leírás
A **Get-AzureRmSqlServerServiceObjective** parancsmag elérhetővé válik az Azure SQL adatbázis-kiszolgálók elérhető szolgáltatási céljainak.
...
Ez a parancs a Server01 és a Database01 nevű adatbázis szolgáltatási céljait kapja meg.

## PARAMÉTEREK

### -DatabaseName
Egy Azure SQL-adatbázis nevét adja meg.
