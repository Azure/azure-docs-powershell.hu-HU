...
## Leírás
A **Get-AzureRmSqlSyncSchema** parancsmag egy tag-adatbázis vagy egy központi adatbázis szinkronizálási sémájáról ad információt.

## Példák

### Példa 1,1: a Szinkronizáló séma beszerzése központi adatbázishoz
```
...
Ez a parancs a központi adatbázis szinkronizálási sémáját a szinkronizálás csoport syncGroup01 kapja.

### Példa 1,2: a központi adatbázis szinkronizálási sémájának beszerzése és a táblázatok kibontása
```
...
Ez a parancs a központi adatbázis szinkronizálási sémáját a szinkronizálás csoport syncGroup01 és a Tables tulajdonság kibontásával kapja meg.

### 2. példa: a szinkronizálási séma beszerzése egy tag adatbázishoz
```
...
Ez a parancs a szinkronizálási tag syncMember01 a tagsági adatbázis szinkronizálási sémáját kapja meg.
...
### Microsoft. Azure. Command. SQL. DataSync. Model. AzureSqlSyncFullSchemaModel

### Táblázatok: Microsoft. Azure. commands. SQL. DataSync. Model. AzureSqlSyncFullSchemaTableModel
