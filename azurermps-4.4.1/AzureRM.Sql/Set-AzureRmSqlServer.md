...
## Leírás
A **set-AzureRmSqlServer** parancsmag egy Azure SQL-adatbázis kiszolgálójának tulajdonságait módosítja.
...
### -Címkék
A parancsmag által a kiszolgálóhoz társított címkék szótárát adja meg. A kulcs-érték párok a kiszolgálón címkékként beállított kivonatoló táblázat formájában. Példa:
