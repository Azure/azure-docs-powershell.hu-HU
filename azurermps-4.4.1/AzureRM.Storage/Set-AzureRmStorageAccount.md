...
### -KeyvaultEncryption
Adja meg, hogy a tárterület-titkosítási forrást szeretné-e beállítani a Microsoft. vagy a kiindulási fiókban. Ha a kulcsnév, a verziószám és a KeyvaultUri megadását adja meg, akkor a tárterület-titkosítási forrás is a Microsoft.-boltozatos időjárási értékre van állítva.
```yaml
Type: System.Management.Automation.SwitchParameter
Parameter Sets: KeyvaultEncryption
Aliases: 
