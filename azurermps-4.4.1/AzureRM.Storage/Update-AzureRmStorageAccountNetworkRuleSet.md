...
## Leírás
Az **Update-AzureRmStorageAccountNetworkRuleSet** parancsmag frissíti a tárolási fiók NetworkRule tulajdonságát.
...
Az engedélyezett érték nincs vagy a következő kombinációk egyike: â € ̆ naplózási â € ¢ Metrics â € ¢ Azureservices
...
Az engedélyezett beállítások: â € ¢ Allow â € ¢ deny
...
### System. String
Microsoft. Azure. Command. Management. Storage. models. PSIpRule [] Microsoft. Azure. commands. Management. Storage. models. PSVirtualNetworkRule []
