...
A felhasználó adatai az API-menedzsment szolgáltatásban.

### IList<Microsoft. Azure. Command. ApiManagement. ServiceManagement. models. PsApiManagementUser>
A felhasználó listája az API-kezelési szolgáltatásban.
