...
## Leírás
A **Get-AzureRmAutomationWebhook** parancsmag webhorgokat kap.
Ha konkrét webhorgokat szeretne bekapcsolni, adjon meg egy webhook-nevet, vagy adja meg az Azure Automation runbook nevét, hogy beszerezze az ahhoz kapcsolódó webhorgokat.

## Példák

### Példa 1: a runbook minden webakasztójának beszerzése
```
...
Ez a parancs a ResourceGroup01 nevű erőforráscsoport AutomationAccount01 nevű automatizálási fiókjának Runbook03 nevű runbook beilleszti az összes webhorgot.

## PARAMÉTEREK

### -AutomationAccountName
Annak az automatizálási fióknak a nevét adja meg, amelyben a parancsmag webhorogot kap.
...
### -Name (név)
Itt adhatja meg annak a webkampónak a nevét, amely a parancsmagot kapja.
...
### -ResourceGroupName
Annak az erőforráscsoportnek a neve, amelyhez a parancsmag webhorgokat kap.
...
### -RunbookName
Annak a runbook a nevét adja meg, amelyhez a parancsmag webhorgokat kap.
...
[Új – AzureRmAutomationWebhook](./New-AzureRMAutomationWebhook.md)
