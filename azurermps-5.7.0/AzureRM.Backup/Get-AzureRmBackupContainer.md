...
- Azure-infrastruktúra szolgáltatás (IaaS) virtuális gép

Mielőtt biztonsági másolatot készíthet egy adatforrásról vagy elemről, regisztrálnia kell azt tároló tárolót, amely az Azure Backup szolgáltatással rendelkezik.
