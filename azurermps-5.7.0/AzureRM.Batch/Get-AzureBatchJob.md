...
## Áttekintés
Kötegelt feladatokat kap egy köteg-vagy projekt-ütemtervhez.
...
## Leírás
A **Get-AzureBatchJob** parancsmag az Azure kötegelt feldolgozásokat kapja a *BatchAccountContext* paraméterrel megadott köteg számlára.
Az *ID* paramétert használva egyetlen feladatot kaphat.
A *szűrő* paraméterrel az Open Data Protocol (OData) szűrőhöz tartozó feladatok is elérhetők.
Ha projekt-ütemezési azonosítót vagy **PSCloudJobSchedule** -példányt ad meg, ez a parancsmag csak az adott projekthez tartozó feladatokat adja eredményül.

## Példák

### Példa 1: kötegelt feladat beszerzése AZONOSÍTÓval
```
...
Ez a parancs a Job01 AZONOSÍTÓval rendelkező feladatot kapja.
A Get-AzureRmBatchAccountKeys parancsmaggal társítson egy környezetet a $Context változóhoz.

### 2. példa: az aktív munkafolyamatok beszerzése ütemtervhez
```
...
Ez a parancs beilleszti az aktív munkafolyamatokat a JobSchedule27 azonosító munkabeosztáshoz.

### 3. példa: a munkabeosztásban minden feladat beolvasása a csővezeték használatával
```
...
Ez a parancs azt a munkabeosztást kapja, amely az azonosító JobSchedule27 az Get-AzureBatchJobSchedule parancsmag használatával.
A parancs a munkabeosztást átadja az aktuális parancsmagnak a pipeline operátor használatával.
A parancs a projekt minden feladatát megkapja.
...
### -Szűrő
A OData-szűrési záradékot adja meg a feladatokhoz.
Ha nem ad meg szűrőt, ez a parancsmag a köteg-vagy a projekt-ütemterv minden feladatát adja eredményül.
...
### -JobSchedule
Itt adhatja meg azt a **PSCloudJobSchedule** -objektumot, amely a munkafolyamatokat tartalmazó projekt ütemtervét képviseli.
**PSCloudJobSchedule** objektum beolvasásához használja az Get-AzureBatchJobSchedule parancsmagot.
...
### -JobScheduleId
A munkabeosztást tartalmazó projekt AZONOSÍTÓját adja meg.
...
### -MaxCount
A visszaadni kívánt feladatok maximális számát adja meg.
...
### PSCloudJobSchedule
A ' JobSchedule ' paraméter az "PSCloudJobSchedule" típusú értéket fogadja el a csővezetékről
