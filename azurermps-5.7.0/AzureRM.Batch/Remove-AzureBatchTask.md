...
## Leírás
A **Remove-AzureBatchTask** parancsmag egy Azure-köteg-feladatot töröl.
...
Ez a parancs azt a kötegelt feladatot kapja meg, amely a Task26 azonosítójú projekt azonosítóját tartalmazza a **Get-AzureBatchTask** parancsmag használatával.
...
### PSCloudTask
A ' InputObject ' paraméter az "PSCloudTask" típusú értéket fogadja el a csővezetékről
