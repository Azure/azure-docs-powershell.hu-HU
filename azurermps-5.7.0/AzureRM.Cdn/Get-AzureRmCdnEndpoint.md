...
## Leírás
A **Get-AzureRMCdnEndpoint** parancsmag az Azure Content Delivery Network (CDN) végpontját és a hozzá tartozó konfigurációs adatokat kapja meg.
...
### -CdnProfile
Annak a CDN-profil objektumnak a megadása, amelyhez a végpont tartozik.
...
A végpont neve nem a végpont állomásnevét adja meg.
...
###  
Ez a parancsmag végpont-objektumot ad eredményül.
