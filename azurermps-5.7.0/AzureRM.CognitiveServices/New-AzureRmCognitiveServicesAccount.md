...
További információt a [kognitív szolgáltatás API](https://www.microsoft.com/cognitive-services/en-us/apis)-k című témakörben találhat.
...
### -Type (típus)
A létrehozandó fiók típusát adja meg. A paraméter jelenlegi elfogadható értékei a következők:

- Bing. autojavasolna. v7
- Bing. CustomSearch
- Bing. Search. v7
- Bing. Speech (beszédfelismerés)
- Bing. helyesírás. v7
- ComputerVision
- ContentModerator
- CustomSpeech
- CustomVision. előrejelzés
- CustomVision. oktatás
- Érzelem
- Arc
- LUIS
- QnAMaker
