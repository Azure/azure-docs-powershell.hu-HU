...
## Leírás
A **New-AzureRmSnapshotUpdateConfig** parancsmag egy konfigurálható Snapshot Update-objektumot hoz létre.
...
### -CreateOption
Itt adhatja meg, hogy a parancsmag létrehoz-e egy pillanatképet a virtuális gépen egy platformról vagy egy felhasználói képről, létrehoz egy üres lemezt, vagy csatol egy meglévő lemezt.
...
System.Nullable` 1 [[System. Boolean, mscorlib, Version = 4.0.0.0, Culture = semleges, PublicKeyToken = b77a5c561934e089]] Microsoft. Azure. Management. számítás. models. KeyVaultAndSecretReference. KeyVaultAndKeyReference. számítás

## KIMENETEK

### Microsoft. Azure. Management. kiszámítás. models. SnapshotUpdate
