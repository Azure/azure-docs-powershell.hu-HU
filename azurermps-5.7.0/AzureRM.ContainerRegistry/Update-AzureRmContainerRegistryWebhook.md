...
## Leírás
Az Update-AzureRmContainerRegistryWebhook parancsmag a tároló beállításjegyzékének webkampóját frissíti.

## Példák

### 1. példa: a meglévő tároló beállításjegyzék-webakasztójának frissítése.
```powershell
...
Frissítsen egy meglévő tároló rendszerleíró webhelyről.

## PARAMÉTEREK

### -Műveletek
A webkampót elindító műveletek elvégzése az értesítések elküldésével
...
### -Header
Szóközzel elválasztott egyéni fejlécek a ' Key \[ = Value \] ' formátumban, amelyet a webhook-értesítésekhez fog hozzáadni.
...
### -Címke
Szóközzel tagolt címkék a "kulcs \[ = érték \] " formátumban.
...
### -URI
A webhook szolgáltatás URI-ja értesítéseket küldhet.
...
### -Webhook
Tároló rendszerleíró webhook-objektum.
