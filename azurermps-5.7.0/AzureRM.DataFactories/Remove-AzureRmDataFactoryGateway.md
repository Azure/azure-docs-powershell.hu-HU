...
## Leírás
A **Remove-AzureRmDataFactoryGateway** parancsmag eltávolítja a megadott átjárót az Azure Data Factoryból.
...
Ez a parancs eltávolítja a ContosoGateway nevű átjárót a WikiADF nevű adatgyárból.

## PARAMÉTEREK

### -DataFactory
Egy **PSDataFactory** -objektumot ad meg.
Ez a parancsmag eltávolítja az adatgyárból az átjárót, amely ezt a paramétert adja meg.
...
### -Force
Jelzi, hogy ez a parancsmag eltávolítja az átjárót anélkül, hogy megerősítést kér.
...
### -Name (név)
Az eltávolítandó átjáró nevét adja meg.
...
Ez a parancsmag eltávolítja azt az átjárót, amely a paraméter által megadott csoportba tartozik.
