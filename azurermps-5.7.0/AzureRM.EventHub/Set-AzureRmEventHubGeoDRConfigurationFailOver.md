...
## Leírás
A **set-AzureRmEventHubGeoDRConfigurationFailOver** PARANCSMAG ENVOKES geo Dr feladatátvételi lehetőséget, és átállíthatja az aliast, hogy a másodlagos névtérre mutasson
...
A feladatátvételt a "SampleDRCongifName" aliasra hívja, átirányítja, majd a másodlagos névtér "SampleNamespace_Secondary" elemre mutat.
...
### -InputObject
Eventhub GeoDR konfigurációs objektum
...
### System. String
Microsoft. Azure. Command. EventHub. models. PSEventHubDRConfigurationAttributes
