...
## Leírás
A **Get-AzureRmLocationBasedServicesAccountKey** parancsmag a kiépített helyekre épülő Services-fiók API kulcsait kapja meg.

A helyekre épülő szolgáltatási fiók két API-kulcsból áll: elsődleges és másodlagos.
A billentyűk lehetővé teszik az interakciót a hely-és szolgáltatási fiók végponttal.

A billentyűk újragenerálásához használja a [New-AzureRmLocationBasedServicesAccountKey](New-AzureRmLocationBasedServicesAccountKey.md) .
...
A megadott hely alapú szolgáltatások fiók kulcsait adja eredményül.
...
### Microsoft. Azure. Command. LocationBasedServices. models. PSLocationBasedServicesAccountKeys
