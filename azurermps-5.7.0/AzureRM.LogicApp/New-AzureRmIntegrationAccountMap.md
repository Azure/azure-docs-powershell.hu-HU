...
## Leírás
A **New-AzureRmIntegrationAccountMap** parancsmag létrehoz egy integrációs fiók megfeleltetését.
Ez a parancsmag egy olyan objektumot ad eredményül, amely az integrációs fiók megfeleltetését jelképezi.
Adja meg az integrációs fiók nevét, az erőforráscsoport nevét, a megfeleltetés nevét és a Térkép definícióját.
...
### 1. példa: az integrációs fiók megfeleltetésének létrehozása
```
...
Ez a parancs létrehozza az integrációs fiók megfeleltetését a megadott erőforráscsoport számára.
A parancs a $MapContent változóban egy korábbi parancs által tárolt megfeleltetési definíciót adja meg.

## PARAMÉTEREK

### -ContentType
Az integrációs fiók megfeleltetésének tartalomtípusát adja meg.
...
### -MapDefinition
Az integrációs fiók megfeleltetését megadó objektum.
...
### -MapFilePath
Az integrációs fiók megfeleltetése definíciójának fájlelérési útját adja meg. Adja meg ezt a paramétert vagy a *MapDefinition* paramétert.
...
### -MapName
Az integrációs fiók megfeleltetésének nevét adja meg.
...
### -MapType
Az integrációs fiók megfeleltetésének típusát adja meg.
Ez a parancsmag a térkép típusú XSLT-t támogatja.
...
### -Metadata
A megfeleltetés metaadat-objektumát adja meg.
