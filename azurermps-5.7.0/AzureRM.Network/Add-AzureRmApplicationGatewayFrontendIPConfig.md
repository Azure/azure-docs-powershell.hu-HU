...
## Leírás
Az **Add-AzureRmApplicationGatewayFrontendIPConfig** parancsmag egyoldalas IP-konfigurációt ad az alkalmazás-átjárónak.
Az alkalmazás-átjárók kétféle előtér-IP-konfigurációt támogatnak: 

- Nyilvános IP-címek
- Privát IP-címek belső terheléselosztási (ILB) használatával

Az alkalmazás-átjárók legfeljebb egy nyilvános IP-címet és egy privát IP-t tartalmazhatnak.
...
Ha a *PrivateIPAddresss* paramétert adja meg, akkor az az alhálózathoz kell tartoznia.
