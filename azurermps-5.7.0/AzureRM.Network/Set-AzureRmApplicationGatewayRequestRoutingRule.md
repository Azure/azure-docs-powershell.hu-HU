...
## Leírás
A **set-AzureRmApplicationGatewayRequestRoutingRule** parancsmag módosítja a kérések útválasztási szabályát.

## Példák

### Példa 1: a Request útválasztási szabály frissítése
```
...
A második parancs módosítja az alkalmazás átjárójának Request (útválasztási) szabályát a $Setting változóban megadott, a $Listener változóban megadott HTTP-figyelők, valamint a $Pool változóban megadott, a végpontokat tartalmazó címkészlet használatára.

## PARAMÉTEREK

### -ApplicationGateway
Azt az alkalmazásobjektum-objektumot adja meg, amelyhez ez a parancsmag a kérések útválasztási szabályát társítja.
...
### -BackendAddressPool
Az Application Gateway back-end címkészletet adja meg.
...
Az Application Gateway back-end Address Pool AZONOSÍTÓját adja meg.
...
### -BackendHttpSettings
Az Application Gateway backend HTTP-beállításait adja meg.
...
Az Application Gateway back-end HTTP-beállításai AZONOSÍTÓját adja meg.
...
### -HttpListener
Az Application Gateway HTTP-figyelőt adja meg.
...
### -HttpListenerId
Az alkalmazás-átjáró HTTP-figyelő AZONOSÍTÓját adja meg.
...
### -Name (név)
Annak a kérési művelettervi szabálynak a neve, amelyet a parancsmag módosított.
...
### -RuleType
A Request útválasztási szabály típusát adja meg.
