...
## Leírás
Az Start-AzureRmNetworkWatcherResourceTroubleshooting parancsmag az Azure-ban egy hálózati erőforrás hibaelhárítását indítja el, és a potenciális problémákról és a mérséklésekről ad információt. Jelenleg a virtuális hálózati átjárók és a kapcsolatok támogatottak.

## Példák

### ---Példa 1: a hibaelhárítás indítása virtuális hálózati átjárón---
```
