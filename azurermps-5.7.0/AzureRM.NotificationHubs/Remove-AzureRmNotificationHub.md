...
## Leírás
A **Remove-AzureRmNotificationHub** parancsmag eltávolít egy meglévő értesítési központot.
...
A **Remove-AzureRmNotificationHub** parancsmag használatával eltávolíthatja a meglévő értesítési központot.
