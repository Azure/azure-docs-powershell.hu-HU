...
## Leírás
A New-AzureRmOperationalInsightsAzureActivityLogDataSource a log Analytics segítségével begyűjtheti az Azure Activity naplót az adott előfizetésből.
...
### -BackfillStartTime
Választhat, hogy egy héttel ezelőtt backfill a naplókat.
