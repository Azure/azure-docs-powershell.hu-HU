...
## Leírás
A **set-AzureRmOperationalInsightsSavedSearch** parancsmag a már létező mentett keresést frissíti.

## Példák

### 1. példa: mentett keresés megadása frissített tulajdonságokkal
```
...
Ezzel a paranccsal a mentett keresések frissített tulajdonságokkal rendelkeznek.
...
### -DisplayName
A megjelenítendő nevet adja meg.
