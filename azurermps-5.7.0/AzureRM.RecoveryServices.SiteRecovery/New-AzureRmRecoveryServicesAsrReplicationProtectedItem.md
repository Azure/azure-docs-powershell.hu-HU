...
### -AzureToAzure
A paramétert leválasztva megadhatja, hogy a replikált elem a helyreállítási Azure-területre replikált Azure virtuális gép.
...
### -AzureVmId
A replikálni kívánt Azure VM-azonosítót adja meg.
