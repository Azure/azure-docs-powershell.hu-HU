...
## Leírás
A **set-AzureRmRecoveryServicesAsrNotificationSetting** parancsmag az Azure webhely-helyreállítási értesítési beállításait (e-mail-értesítést) állítja be a boltozathoz.
...
Váltás a paraméter-ra: az értesítés engedélyezése az előfizetés tulajdonosának.
...
### -LocaleID
Az értesítési/notifcation a felhasználó (támogatott kulturális kódok a Microsofttól) levelezési nyelve. 
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. commands. RecoveryServices. SiteRecovery. ASRAlertSetting, Microsoft. Azure. commands. RecoveryServices. SiteRecovery; Version = 0.1.1.0, Culture = semleges, PublicKeyToken = null]]
