...
## Leírás
Az **export-AzureRmRedisCache** parancsmag az Azure Redis-gyorsítótárából származó adatot exportálja tárolóba.
...
### -Container
Annak a tárolónak a szolgáltatás-URL-címét adja meg, ahol a parancsmag az adatot exportálja. A következő PowerShell-parancsok segítségével létrehozhatja a szolgáltatás SAS URL-címét:

$storageAccountContext = New-AzureStorageContext-StorageAccountName "storageName"-StorageAccountKey "kulcs"

$sasKeyForContainer = New-AzureStorageContainerSASToken név "ContainerName" – Permission "rwdl" – kezdő időpont ([System. DateTime]:: most). AddMinutes (-15)-ExpiryTime ([System. DateTime]:: most). AddHours (5) – környezet $storageAccountContext-FullUri 
