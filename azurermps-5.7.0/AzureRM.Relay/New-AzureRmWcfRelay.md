...
## Leírás
Az New-AzureRmWcfRelay parancsmag létrehoz egy WcfRelay a megadott továbbító névtérben.
...
Új WcfRelay \` -TestWCFRelay2 hoz létre \` a megadott továbbítási névtér \` TestNameSpace – továbbítóban \` .
...
Új WcfRelay TestWCFRelay hoz \` létre \` a megadott továbbító névtér \` TestNameSpace-Relay1 \` .
...
True, ha az ügyfél engedélye szükséges ehhez a továbbításhoz; egyéb esetben false
...
igaz, ha a továbbításhoz átviteli biztonságra van szükség; egyéb esetben false
...
### -WcfRelayType
WcfRelay típusa
A lehetséges értékek a következők: "NetTcp" vagy "http"
...
### -InputObject
Microsoft. Azure. Command. Relay. models. WcfRelayAttributes
...
### Microsoft. Azure. Command. Relay. models. WcfRelayAttributes
RelayType: http CreatedAt: 4/26/2017 5:14:46 PM UpdatedAt: 4/26/2017 5:14:46 PM ListenerCount: RequiresClientAuthorization: false RequiresTransportSecurity: true IsDynamic: false UserMetadata: TestWCFRelay2-azonosító:/subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/Default-Storage-WestUS/providers/Microsoft.Rel: TestNameSpace, Relay1, WcfRelays, TestWCFRelay2

### Példa 2 – tulajdonságok

### Microsoft. Azure. Command. Relay. models. WcfRelayAttributes
RelayType: NetTcp CreatedAt: 4/26/2017 5:20:08 PM UpdatedAt: 4/26/2017 5:20:08 PM ListenerCount: RequiresClientAuthorization: true RequiresTransportSecurity: true IsDynamic: false UserMetadata: user meta Data ID:/subscriptions/55f3dcd4-cac7-43b4-990b-a139d62a1eb2/resourceGroups/Default-Storage-WestUS/providers/Microsoft.Rel ay/Namespaces/TestNameSpace-Relay1
