...
## Leírás
A Get-AzureRmRoleDefinition parancs segítségével megtekintheti annak részleteit.
...
### -AtScopeAndBelow
Ha meg van adva, az összes szerepkör-definíció megjelenik.
...
### Karakterlánc
A "scope" paraméter elfogadja a "string" típusú értéket a csővezetékről

## KIMENETEK

### System. Collections. Generic. list ' 1 [Microsoft. Azure. commands. Resources. PSRoleDefinition]
