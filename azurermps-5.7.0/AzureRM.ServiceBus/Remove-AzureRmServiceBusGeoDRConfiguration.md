...
### GeoDRBreakPairFailOverPropertiesSet (alapértelmezett)
```
...
## Leírás
A **Remove-AzureRmServiceBusGeoDRConfiguration** parancsmag egy aliast töröl (katasztrófa-helyreállítási konfiguráció)
