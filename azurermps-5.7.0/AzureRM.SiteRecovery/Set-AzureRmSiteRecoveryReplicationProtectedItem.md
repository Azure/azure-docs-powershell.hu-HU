...
## Leírás
A **set-AzureRmSiteRecoveryReplicationProtectedItem** parancsmag a replikációs szolgáltatással védett elemek helyreállítási tulajdonságait állítja be.
...
### -LicenseType
A Windows Server-alapú virtuális gépekhez a hibrid használat előnyeiből áttelepített licenc típusának kiválasztása.
...
### -Name (név)
A helyreállítási virtuális gép nevét adja meg.
...
### -RecoveryNetworkId
Annak az Azure virtuális hálózatnak az AZONOSÍTÓját adja meg, amelyre ez a parancsmag visszanyeri a védett elemet.
...
A helyreállítási Azure virtuális hálózatban annak az alhálózatnak a nevét adja meg, amelyre a parancsmag visszanyeri a védett elemet.
...
Az Azure webhely-helyreállítási replikációval védett elemét adja meg.
