...
## Leírás
A **Get-AzureRmSqlElasticPoolRecommendedAction** parancsmag egy vagy több ajánlott műveletet kap egy Azure SQL elasztikus Pool tanácsadóban.

## Példák

### Példa 1: egy tanácsadó összes ajánlott műveletének listázása
```
...
Ez a parancs felsorolja a CreateIndex nevű tanácsadó által az WIRunnerPool nevű rugalmas készlethez elérhető összes javasolt műveletet.
...
Ez a parancs \[ beolvassa a IR_ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 a CreateIndex nevű tanácsadóból.

## PARAMÉTEREK

### -AdvisorName
Annak a tanácsadónak a nevét adja meg, amelyhez a parancsmag ajánlott műveleteket kér.
...
### -ElasticPoolName
Annak a rugalmas készletnek a neve, amelyhez a parancsmag az ajánlott műveleteket kéri.
...
### Microsoft. Azure. Command. SQL. RecommendedAction. Model. AzureSqlElasticPoolRecommendedActionModel

## MEGJEGYZI
* Kulcsszavak: Azure, azurerm, ARM, erőforrás, kezelés, vezető, SQL, elasticpool, MSSQL, Advisor, recommendedaction
