...
---
# AzureRM. előfizetés. minta modul
## Leírás
A szakasz témakörei az Azure PowerShell-parancsmagokat az Azure Resource Manager (ARM) keretrendszerben az Azure-előfizetésre vonatkozóan dokumentálják. A parancsmagok a Microsoft. Azure. commands. előfizetés névtérben találhatók.

## AzureRM. előfizetés parancsmagok
### [Get-AzureRmSubscriptionDefinition](Get-AzureRmSubscriptionDefinition.md)
Előfizetéses definíciót kap.

### [Új – AzureRmSubscriptionDefinition](New-AzureRmSubscriptionDefinition.md)
