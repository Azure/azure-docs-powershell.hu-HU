...
## Áttekintés
Előfizetés-definíció beszerzése

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## SZINTAXISA

### Előfizetési definíciók beszerzése
```
Get-AzureRmSubscriptionDefinition
```
...
Az összes előfizetés-definíció beolvasása
...
Előfizetéses definíciót kap a név MyProdSubscription2.

## PARAMÉTEREK

### -Name (név)
A lekérdezni kívánt előfizetés-definíció neve.
...
### System. Collections. Generic. list ' 1 [[Microsoft. Azure. Command. SubscriptionDefinition. models. PSSubscriptionDefinition, Microsoft. Azure. commands. SubscriptionDefinition, Version = 0.1.0.0, Culture = semleges, PublicKeyToken = null]]
