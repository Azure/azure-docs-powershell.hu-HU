...
## Leírás
A segítő parancs a PsApiManagementRegion példányának létrehozásához.
Ezt a parancsot New-AzureRmApiManagement paranccsal kell használni.
...
A West US region külső VpnType ApiManagement szolgáltatását hozza létre egy további Közép-amerikai régióval.

## PARAMÉTEREK

### -Kapacitás
Az Azure API-kezelési szolgáltatás további régiójának SKU-kapacitása.
...
### -VirtualNetwork
A virtuális hálózat konfigurációja az Azure API felügyeleti közterjesztési területről
