...
Ez a parancs a **Update-AzureRmApiManagementDeployment** parancsmagtal használható.
...
Ez a példa virtuális hálózatot hoz létre, majd felhívja az **Update-AzureRmApiManagementDeployment** parancsmagot.
...
### -Hely
Az API-kezelési szolgáltatás támogatott területe közötti helyet adja meg.
