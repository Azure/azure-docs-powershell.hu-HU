...
## Áttekintés
Automatizálási runbook importál.
...
## Leírás
Az **import-AzureRmAutomationRunbook** parancsmag az Azure automatizálási runbook importálja. Adja meg az wps_2 parancsfájl (. ps1) elérési útját, amely az importálandó wps_2-és wps_2 munkafolyamat-runbooks (. graphrunbook) a Python 2 runbooks grafikus runbooks vagy (. vagy) fájljának elérési útját adja meg. Wps_2 munkafolyamat-runbooks a parancsfájlnak olyan egyetlen wps_2 munkafolyamat-definíciót kell tartalmaznia, amely megfelel a fájl nevének.
...
A második parancs importál egy GraphicalRunbook06 nevű grafikus runbook a AutomationAccount01 nevű automatizálási fiókba.
A parancs a $Tagsban tárolt címkéket is kiosztja.

## PARAMÉTEREK

### -AutomationAccountName
Annak az automatizálási fióknak a neve, amelybe a parancsmag runbook importál.
...
### -Leírás
Az importált runbook leírását adja meg.
...
### -LogProgress
Meghatározza, hogy a runbook naplózza-e a folyamat adatait.
...
### -LogVerbose
Megadja, hogy a runbook naplózza-e a részletes információkat.
...
### -Name (név)
Annak a runbook a nevét adja meg, amelyet a parancsmag importál.
...
### -Path (elérési út)
A parancsmag által importált. ps1 vagy. graphrunbook fájl elérési útvonalát adja meg.
...
### Által közzétett
Jelzi, hogy ez a parancsmag közzéteszi a runbook, amelyet importál.
...
### -ResourceGroupName
Annak az erőforráscsoport a neve, amelyhez a parancsmag runbook importál.
