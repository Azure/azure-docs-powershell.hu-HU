...
– Ez a parancsmag egy **Projektfeladat** értékét adja eredményül, hacsak nem adja meg a _várakozási_ paramétert.
– Ha nem adja meg a _várakozást_ **, az Azure** PowerShell azonnal visszaadja a munkaobjektumot.
– Ha megad egy _várakozást_ , az Azure PowerShell végrehajtja a feladatot, majd az eredményt adja eredményül.
