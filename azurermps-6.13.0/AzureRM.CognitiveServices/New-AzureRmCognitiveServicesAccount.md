...
## Leírás
A **New-AzureRmCognitiveServicesAccount** parancsmag a megadott típusú és SKU-hoz létrehoz egy kognitív szolgáltatásokat tartalmazó fiókot.
...
### -Type (típus)
A létrehozandó fiók típusát adja meg. Használja `Get-AzureRmCognitiveServicesAccountType` a parancsmagot a jelenlegi elfogadható értékek beolvasásához.
