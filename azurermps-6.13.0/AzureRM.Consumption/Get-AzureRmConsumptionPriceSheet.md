...
## Leírás
A **Get-AzureRmConsumptionPriceSheet** parancsmag az előfizetés árlista-lapjait kapja meg.

## Példák

### Példa 1: árlista beszerzése
```powershell
...
### 2. példa: árlista beszerzése a MeterDetails kibontásával
```powershell
...
### 3. példa: az BillingPeriodName lekérése
```powershell
...
### 4. példa: az árlista első 5 rekordjának beszerzése
```powershell
...
### -BillingPeriodName
Egy adott számlázási időszak neve, amely a hozzárendelni kívánt árlista beszerzésére használható.
...
### -ExpandMeterDetail
Az MeterDetails alapján bontsa ki az árlistát.
...
### Microsoft. Azure. commands. fogyasztás. models. PSPriceSheet
