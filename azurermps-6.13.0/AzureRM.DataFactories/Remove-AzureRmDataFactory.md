...
## Leírás
A **Remove-AzureRmDataFactory** parancsmag eltávolítja az adatfeldolgozót.
...
### -DataFactory
Az eltávolítandó **PSDataFactory** -objektumot adja meg.
...
### -Force
Jelzi, hogy ez a parancsmag eltávolítja az adatfeldolgozót, ha nem kér megerősítést.
