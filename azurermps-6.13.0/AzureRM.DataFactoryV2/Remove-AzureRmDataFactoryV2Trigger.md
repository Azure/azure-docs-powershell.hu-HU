...
## Leírás
A **Remove-AzureRmDataFactoryV2Trigger** parancsmag eltávolítja az indítót egy adatgyárból. Ha meg van adva az _erő_ paraméter, a parancsmag nem kérdez rá, mielőtt eltávolítja az indítót.

## Példák

### 1. példa: trigger eltávolítása
```
...
Távolítsa el az "ScheduledTrigger" nevű triggert az "WikiADF" adatgyárból.
...
### -InputObject
Az eltávolítandó indító objektum.
