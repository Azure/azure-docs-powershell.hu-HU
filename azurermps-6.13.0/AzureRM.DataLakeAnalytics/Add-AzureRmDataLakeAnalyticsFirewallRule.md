...
## Leírás
Az **Add-AzureRmDataLakeAnalyticsFirewallRule** parancsmag tűzfal-szabályt ad az Azure Data Lake-tó Analytics-fiókjához.
...
Ez a parancs hozzáadja a "My Firewall Rule" nevű tűzfal-szabályt a "ContosoAdlAcct" fiókból az IP-tartománnyal: 127.0.0.1-127.0.0.10

## PARAMÉTEREK

### -Fiók
Az Data Lake Analytics-fiók a tűzfalszabály hozzáadásához
