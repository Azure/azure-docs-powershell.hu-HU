...
## Leírás
A **set-AzureRmDataLakeAnalyticsCatalogItemAclEntry** parancsmag egy BEJEGYZÉST (ACE) ad hozzá vagy módosít egy katalógus vagy katalógus hozzáférés-vezérlési listájában (ACL) az adattó-elemzések listájában.
...
Ez a parancs a katalógus ACE-t módosította az olvasási engedélyekkel.
