...
## Leírás
A **New-AzureRmDnsRecordSet** PARANCSMAG új DNS-rekordot hoz létre a megadott névvel és típussal a megadott zónában.
...
Ez a paraméter a DNS-rekordok egy sorát veszi igénybe, amelyet a New-AzureRmDnsRecordConfig-ban építettek.
...
A New-AzureRmDnsRecordConfig parancsmaggal DNS-rekord objektumokat hozhat létre.
...
Paraméterek: DnsRecords (ByValue)
