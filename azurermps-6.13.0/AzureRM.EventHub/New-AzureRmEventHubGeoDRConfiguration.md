...
## Leírás
A **New-AzureRmEventHubGeoDRConfiguration** parancsmag új aliast hoz létre (katasztrófa-helyreállítási konfiguráció)
...
"SampleDRCongifName" aliast hoz létre "SampleNamespace_Primary" elsődleges névtérrel, "SampleNamespace_Secondary" másodlagos névtérrel

## PARAMÉTEREK

### -AlternateName
Az elsődleges névtérként használt DR-AlternateName megadásához szükséges beállítások
...
### -PartnerNamespace
DR konfigurációs PartnerNamespace
