...
## Leírás
A **Get-AzureRmFrontDoorFireWallPolicy** cmdletGet az aktuális előfizetés alatti erőforráscsoport WAF házirendjét kapja.

## Példák

### Példa 1: WAF-házirend beszerzése $Name néven $resourceGroup
```powershell
...
A $resourceGroup $Name nevű WAF-házirend beszerzése

### 2. példa: az összes WAF-házirend beszerzése $resourceGroup
```powershell
...
Az összes WAF-házirend beszerzése $resourceGroup
