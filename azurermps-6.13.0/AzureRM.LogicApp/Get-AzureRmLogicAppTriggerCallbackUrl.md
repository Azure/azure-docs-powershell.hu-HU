...
## Leírás
A **Get-AzureRmLogicAppTriggerCallbackUrl** parancsmag logikai alkalmazást kap, amely egy erőforráscsoport visszahívási URL-címét jeleníti meg.
Ez a parancsmag egy **WorkflowTriggerCallbackUrl** -objektumot ad eredményül, amely a visszahívás URL-címét jelöli.
Adja meg az erőforráscsoport nevét, a logikai app nevét és az trigger nevét.
...
### Példa 1: logikai app beszerzése visszahívási URL-cím
```
...
Ez a parancs a logikai app visszahívási URL-jét jeleníti meg.
