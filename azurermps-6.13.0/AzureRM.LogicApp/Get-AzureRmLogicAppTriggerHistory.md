...
## Leírás
A **Get-AzureRmLogicAppTriggerHistory** parancsmag az eseményindítók előzményeit a logikai alkalmazások funkcióban egy logikai alkalmazásban kapja meg.
Ez a parancsmag egy **WorkflowTriggerHistory** objektumot ad eredményül.
Adja meg a logikai alkalmazást, az erőforráscsoportot és az triggert.
...
### Példa 1: egy logikai app trigger-előzményeinek beszerzése
```
...
Ez a parancs a LogicApp03 nevű logikai alkalmazásban meghatározott logikai alkalmazási előzményeket hoz létre a triggerekhez.

### 2. példa: egy logikai app indító előzményeinek beszerzése
```
...
Ez a parancs a LogicApp07 nevű logikai app trigger-előzményeit kapja.
...
### -HistoryName
Itt adhatja meg annak az előzményeinek a nevét, amely a parancsmagot kapja.
...
### -Name (név)
Annak a logikai alkalmazásnak a nevét adja meg, amelyhez ez a parancsmag a trigger-előzményeket kapja.
...
### -ResourceGroupName
Annak az erőforrás csoportnak a nevét adja meg, amelyben a parancsmag előzményeit kapja.
...
### -TriggerName
Annak az indítónak a neve, amelyhez ez a parancsmag az előzményeket kapja.
