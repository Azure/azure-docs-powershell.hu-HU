...
## Leírás
A **Get-AzureRmExpressRouteCircuitStats** parancsmag ExpressRoute-áramkör forgalmi statisztikáit keresi meg. A statisztika tartalmazza az elsődleges és a másodlagos útvonalon keresztül küldött és fogadott bájtok számát.
