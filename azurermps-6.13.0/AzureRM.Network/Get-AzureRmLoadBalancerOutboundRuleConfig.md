...
## Leírás
A **Get-AzureRmLoadBalancerOutboundRuleConfig** parancsmag Kimenő szabály-konfigurációt vagy kimenő szabály konfigurációjának listáját adja meg a terheléselosztásban.
