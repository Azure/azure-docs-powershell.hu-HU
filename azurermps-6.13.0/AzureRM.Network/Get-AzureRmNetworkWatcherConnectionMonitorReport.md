...
## Leírás
A Get-AzureRmNetworkWatcherConnectionMonitorReport parancsmag a legutóbbi kapcsolati állapotokra vonatkozó jelentést jeleníti meg.

## Példák

### Példa 1: a kapcsolati figyelő legutóbbi kapcsolati pillanatképének beszerzése a megadott helyen lévő nevekkel
```
...
Ebben a példában a megadott kapcsolati monitor legutóbbi kapcsolati állapotait kérdezjük le.
...
### -ResourceId
A kapcsolat figyelője erőforrás-azonosítója.
...
[Új – AzureRmNetworkWatcherPacketCapture]()

[Új – AzureRmPacketCaptureFilterConfig]()
...
[Új – AzureRmNetworkWatcherConnectionMonitor]()

[Új – AzureRmNetworkWatcherProtocolConfiguration]()

[Teszt-AzureRmNetworkWatcherIPFlow]()

[Teszt-AzureRmNetworkWatcherConnectivity]()
