...
## Leírás
A **New-AzureRmNetworkProfileContainerNicConfig** parancsmag létrehoz egy új tároló hálózati adapter-konfiguráció objektumát. Ez az objektum a hálózat hálózati profiljára hivatkozó hálózati interfacs jellemzőit határozza meg.
...
### System. Collections. Generic. list ' 1 [[Microsoft. Azure. commands. Network. models. PSIPConfigurationProfile, Microsoft. Azure. commands. Network, Version = 6.7.0.0, Culture = semleges, PublicKeyToken = null]]
