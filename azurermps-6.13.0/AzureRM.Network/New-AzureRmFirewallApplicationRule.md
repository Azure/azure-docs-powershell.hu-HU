...
## Leírás
A **New-AzureRmFirewallApplicationRule** parancsmag létrehoz egy szabályt az Azure tűzfalhoz.
...
### -FqdnTag
A szabályhoz tartozó FQDN-címkék listáját adja meg. A rendelkezésre álló címkéket a [Get-AzureRmFirewallFqdnTag](./Get-AzureRmFirewallFqdnTag.md) parancsmag használatával lehet beolvasni.
...
[Új – AzureRmFirewallApplicationRuleCollection](./New-AzureRmFirewallApplicationRuleCollection.md)
