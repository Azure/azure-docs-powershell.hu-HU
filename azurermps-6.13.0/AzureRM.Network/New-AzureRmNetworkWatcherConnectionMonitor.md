...
## Leírás
A New-AzureRmNetworkWatcherConnectionMonitor parancsmag a megadott forrás-és rcreates-figyelőt adja meg.

## Példák

### 1. példa: kapcsolati monitor létrehozása VM-és internetes célhelyhez
```
...
Az New-AzureRmNetworkWatcherConnectionMonitor parancsmag létrehoz egy kapcsolat monitort egy adott forráshoz és célhoz.
