...
### 4: új nyilvános IP-cím létrehozása előtagból
```
$publicIp = New-AzureRmPublicIpAddress -Name $publicIpName -ResourceGroupName $rgName -AllocationMethod Static -DomainNameLabel $dnsPrefix -Location $location
...
### System. Collections. Generic. list ' 1 [[Microsoft. Azure. commands. Network. models. PSPublicIpTag, Microsoft. Azure. commands. Network, Version = 6.4.1.0, Culture = semleges, PublicKeyToken = null]]
