...
## Leírás
A Remove-AzureRmNetworkWatcherConnectionMonitor parancsmag eltávolítja a megadott kapcsolati monitort.

## Példák

### 1. példa: a megadott kapcsolati monitor eltávolítása
```
PS C:\> Remove-AzureRmNetworkWatcherConnectionMonitor -Location centraluseuap -Name cm
```

Ebben a példában töröljük a kapcsolat monitor helyét és nevét.
