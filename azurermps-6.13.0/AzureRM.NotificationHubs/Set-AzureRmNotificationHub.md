...
} Ha a **set-AzureRmNotificationHub** parancsmaggal együtt használja, az előző JSON-minta a ContosoNotificationHub nevű értesítési központ helyének értékét állítja be.
