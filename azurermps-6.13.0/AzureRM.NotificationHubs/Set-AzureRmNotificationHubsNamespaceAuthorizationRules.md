...
A JSON-fájl egy olyan szöveges fájl, amely az alábbihoz hasonló szintaxist használ: {  
    ...
    "Jogok": \[  
        ...
        Küldése  
    \]  
} Ha a **set-AzureRmNotificationHubsNamespaceAuthorizationRules** parancsmaggal együtt használja, az előző JSON-minta módosítja a ContosoAuthorizationRule nevű engedélyezési szabályt, hogy a felhasználók hallgassák meg és küldjenek hozzáférést a névtérhez.
