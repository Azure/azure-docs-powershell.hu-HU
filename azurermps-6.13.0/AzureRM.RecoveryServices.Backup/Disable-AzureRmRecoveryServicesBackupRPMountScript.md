...
## Leírás
A Disable-AzureRmRecoveryServicesBackupRPMountScript parancsmag leválasztja azokat a helyreállítási pont fájljait, amelyek korábban a Get-AzureRmRecoveryServicesBackupRPMountScript parancsmag használatával lettek felszerelve.
