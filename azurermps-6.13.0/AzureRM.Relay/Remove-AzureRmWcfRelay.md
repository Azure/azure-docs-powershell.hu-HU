...
## Leírás
A **Remove-AzureRmWcfRelay** parancsmag eltávolítja a WcfRelay a megadott továbbító névtérből.
...
Eltávolítja a WcfRelay `TestWCFRelay1` a névtérből `TestNameSpace-Relay1` .
