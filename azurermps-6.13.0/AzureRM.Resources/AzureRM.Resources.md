...
Beilleszti az előfizetést a tartományba.

### [Get-AzureRmDeploymentOperation](Get-AzureRmDeploymentOperation.md)
Beilleszti az előfizetési tartomány központi telepítéséhez szükséges műveleteket.
...
### [Meghívó-AzureRmResourceAction](Invoke-AzureRmResourceAction.md)
...
### [Új – AzureRmADGroup](New-AzureRmADGroup.md)
...
### [Új – AzureRmDeployment](New-AzureRmDeployment.md)
Új telepítő létrehozása az előfizetéses hatókörben.

### [Új – AzureRmManagedApplication](New-AzureRmManagedApplication.md)
Azure-felügyelt alkalmazást hoz létre.

### [Új – AzureRmManagedApplicationDefinition](New-AzureRmManagedApplicationDefinition.md)
Felügyelt alkalmazás-definíciót hoz létre.

### [Új – AzureRmManagementGroup](New-AzureRmManagementGroup.md)
Felügyeleti csoport létrehozása

### [Új – AzureRmManagementGroupSubscription](New-AzureRmManagementGroupSubscription.md)
...
### [Új – AzureRmPolicySetDefinition](New-AzureRmPolicySetDefinition.md)
...
A telepített példány eltávolítása az előfizetéses hatókörben.
...
### [Mentés-AzureRmDeploymentTemplate](Save-AzureRmDeploymentTemplate.md)
Kinyeri az előfizetéshez tartozó sablont.

### [Mentés-AzureRmResourceGroupDeploymentTemplate](Save-AzureRmResourceGroupDeploymentTemplate.md)
...
Lemond egy futó telepítőt az előfizetéses hatókörben.

### [Stop-AzureRmResourceGroupDeployment](Stop-AzureRmResourceGroupDeployment.md)
Erőforráscsoport-telepítő lemondása

### [Teszt-AzureRmDeployment](Test-AzureRmDeployment.md)
A központi telepítő sablon és a paraméterek érvényesítése az előfizetések hatókörében.
