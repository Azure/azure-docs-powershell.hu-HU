...
## Leírás
A Get-AzureRMManagementGroup parancsmag a teljes vagy egy bizonyos kezelési csoportot kapja.
...
### Példa 4: speciális kezelési csoport és a képekből hierarchikus minden szintjének beolvasása
```
