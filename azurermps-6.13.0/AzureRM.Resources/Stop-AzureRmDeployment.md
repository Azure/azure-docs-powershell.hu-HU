...
## Leírás
A **stop-AzureRmDeployment** parancsmag lemondja az előfizetéses hatókört, amely a kezdést, de nem fejeződött be.
...
Az előfizetéses hatókörben az New-AzureRmDeployment parancsmagot használva hozhat létre központi telepítőt.
