...
ms.locfileid: "93493920"
---
# <span data-ttu-id="6c85c-101">Get-AzureRmSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="6c85c-101">Get-AzureRmSecurityAlert</span></span>

## <span data-ttu-id="6c85c-102">Áttekintés</span><span class="sxs-lookup"><span data-stu-id="6c85c-102">SYNOPSIS</span></span>
<span data-ttu-id="6c85c-103">Az Azure Security Center által észlelt biztonsági riasztásokat kapja</span><span class="sxs-lookup"><span data-stu-id="6c85c-103">Gets security alerts that were detected by Azure Security Center</span></span>

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## <span data-ttu-id="6c85c-104">SZINTAXISA</span><span class="sxs-lookup"><span data-stu-id="6c85c-104">SYNTAX</span></span>

### <span data-ttu-id="6c85c-105">SubscriptionScope (alapértelmezett)</span><span class="sxs-lookup"><span data-stu-id="6c85c-105">SubscriptionScope (Default)</span></span>
```
Get-AzureRmSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="6c85c-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="6c85c-106">ResourceGroupScope</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="6c85c-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="6c85c-107">ResourceGroupLevelResource</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="6c85c-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="6c85c-108">SubscriptionLevelResource</span></span>
```
Get-AzureRmSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="6c85c-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="6c85c-109">ResourceId</span></span>
```
Get-AzureRmSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="6c85c-110">Leírás</span><span class="sxs-lookup"><span data-stu-id="6c85c-110">DESCRIPTION</span></span>
<span data-ttu-id="6c85c-111">Az Azure Security Center által észlelt biztonsági riasztásokat kapja</span><span class="sxs-lookup"><span data-stu-id="6c85c-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="6c85c-112">Példák</span><span class="sxs-lookup"><span data-stu-id="6c85c-112">EXAMPLES</span></span>

### <span data-ttu-id="6c85c-113">Példa 1</span><span class="sxs-lookup"><span data-stu-id="6c85c-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="6c85c-114">Az resoruces-on belül észlelt összes biztonsági figyelmeztetést kapja</span><span class="sxs-lookup"><span data-stu-id="6c85c-114">Gets all the security alerts that were detected on resoruces inside a subscription</span></span>

### <span data-ttu-id="6c85c-115">2. példa</span><span class="sxs-lookup"><span data-stu-id="6c85c-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="6c85c-116">Az resoruces-on a "myService1" erőforráscsoport belsejében észlelt összes biztonsági figyelmeztetést kapja.</span><span class="sxs-lookup"><span data-stu-id="6c85c-116">Gets all the security alerts that were detected on resoruces inside the "myService1" resource group</span></span>

### <span data-ttu-id="6c85c-117">3. példa</span><span class="sxs-lookup"><span data-stu-id="6c85c-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="6c85c-118">A resoruces-ban a "myService1" erőforráscsoport belsejében észlelt biztonsági figyelmeztetést kapja.</span><span class="sxs-lookup"><span data-stu-id="6c85c-118">Gets a specific security alert that were detected on resoruces inside the "myService1" resource group</span></span>

## <span data-ttu-id="6c85c-119">PARAMÉTEREK</span><span class="sxs-lookup"><span data-stu-id="6c85c-119">PARAMETERS</span></span>

### <span data-ttu-id="6c85c-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="6c85c-120">-DefaultProfile</span></span>
<span data-ttu-id="6c85c-121">Az Azuretal való kommunikációhoz használt hitelesítő adatok, fiók, bérlői fiók és előfizetés.</span><span class="sxs-lookup"><span data-stu-id="6c85c-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="6c85c-122">-Hely</span><span class="sxs-lookup"><span data-stu-id="6c85c-122">-Location</span></span>
<span data-ttu-id="6c85c-123">Helyre.</span><span class="sxs-lookup"><span data-stu-id="6c85c-123">Location.</span></span>
...
### <span data-ttu-id="6c85c-124">-Name (név)</span><span class="sxs-lookup"><span data-stu-id="6c85c-124">-Name</span></span>
<span data-ttu-id="6c85c-125">Erőforrás neve</span><span class="sxs-lookup"><span data-stu-id="6c85c-125">Resource name.</span></span>
...
### <span data-ttu-id="6c85c-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="6c85c-126">-ResourceGroupName</span></span>
<span data-ttu-id="6c85c-127">Erőforráscsoporthoz tartozó név.</span><span class="sxs-lookup"><span data-stu-id="6c85c-127">Resource group name.</span></span>
...
### <span data-ttu-id="6c85c-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="6c85c-128">-ResourceId</span></span>
<span data-ttu-id="6c85c-129">Erőforrás-azonosító.</span><span class="sxs-lookup"><span data-stu-id="6c85c-129">Resource ID.</span></span>
...
### <span data-ttu-id="6c85c-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="6c85c-130">CommonParameters</span></span>
<span data-ttu-id="6c85c-131">Ez a parancsmag a következő általános paramétereket támogatja:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-,-PipelineVariable-WarningAction</span><span class="sxs-lookup"><span data-stu-id="6c85c-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="6c85c-132">További információ: about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="6c85c-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="6c85c-133">BEMENETEK</span><span class="sxs-lookup"><span data-stu-id="6c85c-133">INPUTS</span></span>

### <span data-ttu-id="6c85c-134">System. String</span><span class="sxs-lookup"><span data-stu-id="6c85c-134">System.String</span></span>

## <span data-ttu-id="6c85c-135">KIMENETEK</span><span class="sxs-lookup"><span data-stu-id="6c85c-135">OUTPUTS</span></span>

### <span data-ttu-id="6c85c-136">Microsoft. Azure. commands. Security. models. riasztások. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="6c85c-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="6c85c-137">MEGJEGYZI</span><span class="sxs-lookup"><span data-stu-id="6c85c-137">NOTES</span></span>

## <span data-ttu-id="6c85c-138">KAPCSOLÓDÓ HIVATKOZÁSOK</span><span class="sxs-lookup"><span data-stu-id="6c85c-138">RELATED LINKS</span></span>
