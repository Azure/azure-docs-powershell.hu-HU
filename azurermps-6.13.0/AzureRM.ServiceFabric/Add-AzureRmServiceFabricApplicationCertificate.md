...
## Leírás
A **Add-AzureRmServiceFabricApplicationCertificate** használatával telepítsen tanúsítványt a fürt összes csomópontjára. Megadhatja a már meglévő tanúsítványokat, vagy megadhatja, hogy a rendszer létrehoz egy újat, és feltölti egy új vagy meglévő Azure-fő boltozatra.
...
Ez a parancs a meglévő Azure Key Vault tanúsítványát fogja hozzáadni a fürt minden csomópont-típusához.
...
Ez a parancs létrehoz egy önaláírt tanúsítványt az Azure Key Vault-ban, amelyen a fő pince-erőforráscsoport neve és a kulcsfájl neve látható, a fürt összes csomópont-típusára települ, és a "c:\test" mappa alatt letölti a tanúsítványt. A letöltendő tanúsítvány neve megegyezik a kulcsfájl-tanúsítvány nevével.

## PARAMÉTEREK

### -CertificateFile
A meglévő tanúsítványfájl elérési útja.
...
A létrehozandó új tanúsítvány mappa elérési útja.
...
A létrehozandó tanúsítvány DNS-neve.
...
Azure Key Vault-erőforrás csoport neve.
...
### -SecretIdentifier
A meglévő Azure Key Vault titkos URI-azonosító.
...
### System. String
Paraméterek: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), KeyVaultName (ByValue), KeyVaultResouceGroupName (ByValue), SecretIdentifier (ByValue)

### System. Security. SecureString
Paraméterek: CertificatePassword (ByValue)

## KIMENETEK

### Microsoft. Azure. Command. ServiceFabric. models. PSKeyVault
