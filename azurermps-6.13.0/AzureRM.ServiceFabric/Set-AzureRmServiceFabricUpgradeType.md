...
## Leírás
A **set-AzureRmServiceFabricUpgradeType** beállíthatja, hogy a frissítési típust az automatikus vagy a kézi beállítással állítsa be az adott szolgáltatás szövet-verziószáma.
...
Ez a parancs automatikusan beállítja a cluster upgrade üzemmódot.
...
### System. String
Paraméterek: verzió (ByValue)

### Microsoft. Azure. Command. ServiceFabric. models. ClusterUpgradeMode
Paraméterek: UpgradeMode (ByValue)
