...
## Leírás
A **Get-AzureRmSqlDatabaseAuditingPolicy** parancsmag egy Azure SQL-adatbázis naplózási házirendjét kapja meg.
A parancsmag használatához a *ResourceGroupName* , a *kiszolgálónév* és a *databasename* paraméterrel keresse meg az adatbázist.

## Példák

### 1. példa: az Azure SQL-adatbázisok naplózási házirendjének beszerzése az Ön által meghatározott táblázatos naplózással
```
...
### 2. példa: az Azure SQL-adatbázis naplózási házirendjének beszerzése a blob-naplózással
```
PS C:\>Get-AzureRmSqlDatabaseAuditingPolicy -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
DatabaseName           : database01
AuditAction            : {}
