...
## Leírás
A **Get-AzureRmSqlDatabaseRecommendedAction** parancsmag legalább egy javasolt műveletet kap egy Azure SQL-adatbázis-tanácsadóhoz.
...
Ez a parancs a CreateIndex nevű tanácsadó által elérhető összes javasolt műveletet felsorolja a Wi-Runner-Ausztrália-Kelet nevű adatbázisban.
...
Ez a parancs beolvassa a IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 a CreateIndex nevű tanácsadóhoz.
...
### -DatabaseName
Annak az adatbázisnak a neve, amelyhez a parancsmag az ajánlott műveleteket kéri.
...
### -ResourceGroupName
Annak a kiszolgálónak az erőforráscsoport nevét adja meg, amely az adatbázist tartalmazza.
