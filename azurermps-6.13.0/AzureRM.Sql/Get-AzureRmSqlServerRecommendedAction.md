...
## Leírás
A **Get-AzureRmSqlServerRecommendedAction** parancsmag legalább egy javasolt műveletet kap az Azure SQL Server-tanácsadók számára.

## Példák

### Példa 1: egy adott tanácsadó összes javasolt műveletének beszerzése
```
...
Ez a parancs felsorolja az CreateIndex nevű SQL Server-tanácsadó által az összes javasolt műveletet, amely a Wi-Runner-Ausztrália-Kelet nevű kiszolgálón elérhető.

### 2. példa: egyetlen ajánlott művelet beszerzése egy tanácsadó számára
```
...
Ez a parancs IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 a CreateIndex nevű tanácsadótól kapja meg.

## PARAMÉTEREK

### -AdvisorName
Annak a tanácsadónak a nevét adja meg, amelynek a parancsmagja a műveleteket kéri.
...
Annak a javasolt tevékenységnek a neve, amely a parancsmagot kapja.
...
### -ResourceGroupName
A kiszolgálót tartalmazó kiszolgáló erőforráscsoport-csoportjának nevét adja meg.
...
### -Kiszolgálónév
Annak a kiszolgálónak a neve, amelyhez a tanácsadó tartozik.
...
### Microsoft. Azure. Command. SQL. RecommendedAction. Model. AzureSqlServerRecommendedActionModel

## MEGJEGYZI
* Kulcsszavak: Azure, azurerm, ARM, erőforrás, kezelés, vezető, SQL, Server, MSSQL, Advisor, recommendedaction
