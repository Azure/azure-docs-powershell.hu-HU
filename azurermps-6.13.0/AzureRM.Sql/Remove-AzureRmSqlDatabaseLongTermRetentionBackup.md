...
## Leírás
A **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** parancsmag törli a megadott biztonsági másolatot.

## Példák

### Példa 1: egyetlen biztonsági másolat törlése
```powershell
...
### 2. példa: egy hely minden biztonsági mentésének törlése
```powershell
