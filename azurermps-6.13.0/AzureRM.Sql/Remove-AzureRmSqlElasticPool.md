...
## Leírás
A **Remove-AzureRmSqlElasticPool** parancsmag egy Azure SQL-adatbázis rugalmas készletének törlése.

## Példák

### Példa 1: elasztikus Pool törlése
```
PS C:\>Remove-AzureRmSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Ez a parancs törli a ElasticPool01 nevű elasztikus medencét.
...
### -ElasticPoolName
Annak a rugalmas készletnek a nevét adja meg, amelyre a parancsmag törlődik.
