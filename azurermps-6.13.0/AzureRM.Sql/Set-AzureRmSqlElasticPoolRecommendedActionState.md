...
## Leírás
A **set-AzureRmSqlElasticPoolRecommendedActionState** parancsmag frissíti az Azure SQL rugalmas készlet javasolt műveletének állapotát.
Ez a parancsmag az új állapoton alapuló javasolt műveleteket alkalmazza, visszaállította vagy elveti.

## Példák

### Példa 1: a javasolt művelet állapotának frissítése függőben
```
...
Ez a parancs frissíti a rugalmas alkalmazáskészlet IR_ \[ test_schema \] _ \[ Test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 függőben állapotot.
...
Annak a javasolt tevékenységnek a neve, amelyhez a parancsmag frissíti az államot.
...
### -State (állami)
Azt az értéket adja meg, amelyre a parancsmag a javasolt műveleti állapotot frissíti.
...
### Microsoft. Azure. Command. SQL. RecommendedAction. parancsmag. RecommendedActionState
