...
## Áttekintés
SQL Server-adatbázis-fiókot ad hozzá egy HDInsight-fürt konfigurációhoz.
...
Az **Add-AzureHDInsightMetastore** PARANCSMAG Microsoft SQL Server-adatbázist ad hozzá a **New-AzureHDInsightClusterConfig** parancsmag által létrehozott Azure HDInsight-konfigurációhoz.
Az adatbázis a kaptár vagy a Oozie (vagy mindkettő) metaadatainak tárolására szolgál.

## Példák

### 1. példa: metastore hozzáadása
```
...
Ez a parancs hozzáadja a ContosoSQLServer nevű SQL Server-adatbázist a HDInsight-fürtök kaptár-metastore.

### 2. példa: a tárterület beállítása és a metastores hozzáadása
```
...
Ez a parancsmag a metastore adatait hozzáadja a konfigurációs objektumhoz, amelyet a paraméter határoz meg.
...
### -DatabaseName
Annak az adatbázisnak a nevét adja meg, amely a kaptár vagy a Oozie metaadatait tárolja.
...
A paraméter elfogadható értékei a következők: HiveMetaStore vagy OozieMetaStore.
...
### -SqlAzureServerName
Annak az SQL-kiszolgálónak a teljes tartománynevét adja meg, amely a metaadatok tárolására szolgáló adatbázist tartalmazza.
