...
A **Get-AzureHDInsightJob** parancsmag a legutóbbi Azure HDInsight-munkahelyeket kapja egy adott fürthöz, és fordított időrendi sorrendben jeleníti meg őket.
...
### -Cluster
Egy fürtöt ad meg.
Ez a parancsmag azokat a HDInsight-feladatokat kapja meg, amelyek a megadott paraméter által megadott szektorcsoporton futnak.
...
### -Előfizetés
A HDInsight feladatokat tartalmazó előfizetést adja meg.
