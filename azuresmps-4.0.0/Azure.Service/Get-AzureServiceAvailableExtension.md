...
## Áttekintés
Információt kap a hosztolt szolgáltatások elérhető bővítményeiről.
...
## Leírás
A **Get-AzureServiceAvailableExtension** parancsmag a hosztolt szolgáltatások legújabb elérhető bővítményeinek adatait kapja meg.

## Példák

### Példa 1: elérhető bővítmények beszerzése
```
...
Ez a parancs minden elérhető bővítményt elérhetővé válik.

### 2. példa: a bővítmények beszerzése egy megadott névtérben
```
...
Ez a parancs a megadott névtérben megadott nevű kiterjesztéseket kapja meg.

### 3. példa: a bővítmény meghatározott verziójának beszerzése
```
...
Ez a parancs a bővítmény egy adott verziójáról nyújt tájékoztatást.

## PARAMÉTEREK

### -AllVersions
Azt jelzi, hogy ez a parancsmag a bővítmény minden verzióját megkapja.
