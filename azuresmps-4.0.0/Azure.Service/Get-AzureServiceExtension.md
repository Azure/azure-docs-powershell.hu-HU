...
## Áttekintés
A felhőben telepített bővítmények a telepített példányon.
...
## Leírás
A **Get-AzureServiceExtension** parancsmag a telepített Felhőbeli szolgáltatási bővítményeket kapja meg.

## Példák

### Példa 1: megadott bővítmény beszerzése
```
...
Ez a parancs a Felhőbeli szolgáltatások bővítményt a megadott névvel és névtérrel kapja meg.
