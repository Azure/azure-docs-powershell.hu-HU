...
## Áttekintés
Védett tárolókat kap a webhelyek helyreállítási boltozatához.
...
## Leírás
A **Get-AzureSiteRecoveryProtectionContainer** parancsmag védett tárolókat kap az aktuális Azure webhely-helyreállítási boltozathoz.
...
### 1. példa: védett tárolók beszerzése
```
...
Ez a parancs az aktuális boltozat védett tárolóit kapja meg.

## PARAMÉTEREK

### -Azonosító
A beolvasott védett tároló AZONOSÍTÓját adja meg.
...
### -Name (név)
A beolvasott védelmi tároló nevét adja meg.
