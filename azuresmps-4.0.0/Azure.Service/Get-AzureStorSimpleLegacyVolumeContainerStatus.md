...
## Áttekintés
A kötet-tárolók áttelepítési állapotát kapja.
...
## Leírás
A **Get-AzureStorSimpleLegacyVolumeContainerStatus** parancsmag a mennyiségi tárolók áttelepítési állapotát kapja meg.
Ez a parancsmag azokat az állapotadatokat jeleníti meg, amelyek azt jelzik, hogy a mennyiségi tároló áttelepítése továbbra is folyamatban, befejezett vagy sikertelen.

## Példák

### Példa 1: sikertelen áttelepítés állapotának beolvasása
```
...
Ez a parancs beolvassa a régi nevű tároló áttelepítési állapotát.
Az eredmények azt mutatják, hogy az áttelepítés sikertelen volt.

### 2. példa: állapot beszerzése folyamatban lévő áttelepítés esetén
```
PS C:\>Get-AzureStorSimpleLegacyVolumeContainerStatus -LegacyConfigId "dcddbb51-2ab2-4d22-8204-fefdbd6b7ba4" -LegacyContainerNames "OneSDKAzureCloud"
...
Ez a parancs beolvassa a régi nevű tároló áttelepítési állapotát.
Az eredmények azt mutatják, hogy az áttelepítés folyamatban van.

### 3. példa: befejezett áttelepítés állapotának beolvasása
```
PS C:\>Get-AzureStorSimpleLegacyVolumeContainerStatus -LegacyConfigId dcddbb51-2ab2-4d22-8204-fefdbd6b7ba4 -LegacyContainerNames OneSDKAzureCloud
ConfigId             : 5a83ec88-9e0a-4722-9fb0-9131caa7387a
...
Ez a parancs beolvassa a régi nevű tároló áttelepítési állapotát.
Az eredmények azt mutatják, hogy az áttelepítés befejeződött.
