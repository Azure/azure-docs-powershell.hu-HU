...
## Áttekintés
A létrehozott összes erőforrást megkapja.
...
## Leírás
A **Get-AzureStorSimpleResource** parancsmag az Azure Portal használatával létrehozott összes erőforrást megkapja.
A parancsmag az erőforrásokhoz való csatlakozáshoz használható részleteket tartalmaz.

## Példák

### Példa 1: az összes erőforrás beolvasása
```
...
Ez a parancs minden létrehozott erőforrást megkapja.
Ebben a példában három erőforrás áll rendelkezésre.

### 2. példa: erőforrás beszerzése a neve alapján
```
...
Ez a parancs a Contoso63-Tsqa nevű erőforrást kapja.

### 3. példa: nem létező erőforrás beszerzésének kísérlete
```
...
Ez a parancs megkísérli a Contoso64-Tsqa nevű erőforrás beszerzését.
Nincs ilyen nevű erőforrás.
Ez a példa nem ad vissza erőforrást.
...
### -ResourceName
Itt adhatja meg annak az erőforrásnak a nevét, amely a parancsmagot kapja.
...
Ez a parancsmag a következő tulajdonságokat tartalmazó **ResourceCredentials** -objektumokat ad eredményül: 
