...
## Áttekintés
Egy Azure virtuális hálózati átjáró IPsec-paramétereit kapja meg.
...
## Leírás
A **Get-AzureVirtualNetworkGatewayIPsecParameters** parancsmag egy Azure virtuális hálózati átjáró IPSec-paramétereit kapja meg.
...
### -ConnectedEntityId
A csatlakoztatott entitiy AZONOSÍTÓját adja meg.
