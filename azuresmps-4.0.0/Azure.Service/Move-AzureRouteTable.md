...
## Áttekintés
Áttelepíti az útválasztási táblázatot az Azure Resource Manager-kötegbe.
...
## Leírás
A **Move-AzureRouteTable** parancsmag az Azure Resource Manager-kötegben lévő erőforrás-csoportba áttelepíti az útválasztási táblázatot.
...
### -Megszakítás
Jelzi, hogy ez a parancsmag lemondja az útválasztási táblázat áttelepítését.
...
### -Commit
Azt jelzi, hogy ez a parancsmag elindítja az útválasztási táblázat áttelepítését.
...
### – Előkészületek
Jelzi, hogy ez a parancsmag előkészíti az útválasztási táblázatot az áttelepítésre.
...
### -RouteTableName
Annak az útválasztási táblázatnak a nevét adja meg, amelyre a parancsmag át van telepítve.
...
### – Érvényesítés
Megadja, hogy ez a parancsmag ellenőrzi az útválasztási táblázatot az áttelepítéshez.
