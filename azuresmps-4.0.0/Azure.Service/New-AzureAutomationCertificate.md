...
Azure automatizálási tanúsítványt hoz létre.
...
A **New-AzureAutomationCertificate** parancsmag létrehoz egy tanúsítványt a Microsoft Azure automatizálási szolgáltatásban.
Megadja a feltölteni kívánt tanúsítványfájl elérési útját.

## Példák

### Példa 1: tanúsítvány létrehozása
```
...
Ezek a parancsok az Azure Automation MyCertificate nevű tanúsítványát hozza létre.
Az első parancs létrehozza a tanúsítványt létrehozó második parancsban használt tanúsítványfájl jelszavát.

## PARAMÉTEREK

### -AutomationAccountName
Itt adhatja meg annak az automatizálási fióknak a nevét, amelyet a rendszer tárol a tanúsítványban.
