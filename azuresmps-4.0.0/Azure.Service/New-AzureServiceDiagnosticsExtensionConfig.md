...
## Áttekintés
Diagnosztikai bővítmény konfigurációjának létrehozása meghatározott szerepkör (ek) vagy minden szerepkör esetében.
...
## Leírás
A **New-AzureServiceDiagnosticsExtensionConfig** parancsmag a megadott szerepkörök vagy az összes szerepkör diagnosztikai bővítményének konfigurációját hozza létre.

## Példák

### Példa 1: az Azure Diagnostics bővítmény létrehozása a felhőalapú szolgáltatás összes szerepköréhez
```
...
Ez a parancs létrehozza az Azure Diagnostics bővítményt a felhőalapú szolgáltatás összes szerepköréhez.

### 2. példa: az Azure Diagnostics bővítmény létrehozása szerepkörhöz
```
...
Ez a parancs létrehozza az Azure Diagnostics bővítményt a felhőalapú szolgáltatás szerepkör-WebRole01.
...
A diagnosztikai konfiguráció elérési útját adja meg.
...
### -Role (szerepkör)
A szerepkörök választható tömböket adja meg a diagnosztikai konfiguráció megadásához.
Ha nem adja meg, akkor az összes szerepkör alapértelmezett konfigurációjaként alkalmazza a diagnosztikai konfigurációt.
