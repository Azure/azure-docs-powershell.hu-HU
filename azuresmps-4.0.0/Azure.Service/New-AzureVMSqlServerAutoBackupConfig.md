...
### Példa 1: automatikus biztonsági mentési konfiguráció létrehozása a tárolási URI és a fiók kulccsal
```
...
Ez a parancs a tárterület URL-címének és a fiók kulcsának megadásával automatikus biztonsági másolatot hoz létre a konfigurációs objektumról.

### 2. példa: automatikus biztonsági mentési konfiguráció létrehozása a tárolási környezettel
```
...
A parancs a tárolási környezet megadásával automatikus biztonsági másolatot hoz létre a konfigurációs objektumról.

### 3. példa: automatikus biztonsági mentési konfiguráció létrehozása tárolási környezettel a titkosítás és a jelszó használatával
```
...
Ezzel a paranccsal automatikus biztonsági mentési objektumot hozhat létre a tárolási környezet megadásával és a titkosítás engedélyezésével a jelszó beállítással.
A certificatepassword ist a $CertPasswd nevű változóban tárolják.
...
Ha ezt a paramétert használja, az automatikus biztonsági mentés az összes aktuális és új adatbázis biztonsági ütemezését állítja be.
...
### -EnableEncryption
Azt jelzi, hogy a titkosítás engedélyezve van.
...
Az adatmegőrzési időszak hosszát adja meg napokban.
...
### -StorageContext
A biztonsági másolatok tárolásához használandó tárterületet adja meg.
...
### -StorageUri
A blob-tároló fiók URI-azonosítóját adja meg.
