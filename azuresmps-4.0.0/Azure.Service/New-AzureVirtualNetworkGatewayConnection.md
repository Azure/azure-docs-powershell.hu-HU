...
## Áttekintés
Azure virtuális átjáró hálózati kapcsolat létrehozása
...
## Leírás
A **New-AzureVirtualNetworkGatewayConnection** parancsmag az Azure virtuális átjáró hálózati kapcsolatát hozza létre.
...
### -EnableBgp
Engedélyezi a Border Gateway Protocol (BGP) protokollt.
...
Az átjáró kapcsolatának nevét adja meg.
...
Az átjáró-kapcsolat típusát adja meg.
...
A virtuális hálózati átjáró AZONOSÍTÓját adja meg.
