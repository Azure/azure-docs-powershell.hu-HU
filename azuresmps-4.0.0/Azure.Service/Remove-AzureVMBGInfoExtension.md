...
## Áttekintés
Eltávolítja a virtuális gépen alkalmazott BGInfo-bővítményt.
...
## Leírás
A **Remove-AzureVMBGInfoExtension** parancsmag eltávolítja a virtuális gépen alkalmazott BGInfo-bővítményt.

## Példák

### 1. példa: a BGInfo-bővítmény eltávolítása virtuális gépen
```
PS C:\> Remove-AzureVMBGInfoExtension -VM $VM;
```

Ez a parancs eltávolítja a virtuális gépen alkalmazott BGInfo-bővítményt.
