...
## Áttekintés
Eltávolítja az Azure Diagnostics bővítményt egy virtuális gépről.
...
## Leírás
A **Remove-AzureVMDiagnosticsExtension** parancsmag eltávolítja a Microsoft Azure Diagnostics bővítményt egy virtuális gépről.
Át kell adnia a parancsmag kimenetét a **Update-AzureVM** parancsmagnak.

## Példák

### 1. példa: az Azure Diagnostics bővítmény eltávolítása virtuális gépről
```
PS C:\> Remove-AzureVMDiagnosticsExtension -VM $VM | Update-AzureVM
```

Ez a parancs eltávolítja az Azure Diagnostics bővítményt egy virtuális gépről.
