...
## Áttekintés
Eltávolít egy meglévő webes feladatot egy webhelyhez.
...
### 1. példa: meglévő webes feladat eltávolítása egy webhelyhez
```
PS C:\> Remove-AzureWebsiteJob -Name MyWebsite -JobName MyWebJob -JobType Continuous
```

Eltávolítja a MyWebJob nevű webes feladatot a MyWebSite.

## PARAMÉTEREK

### -Force
Jelzi, hogy ez a parancsmag eltávolítja a webes feladatot, és nem kér megerősítést.
