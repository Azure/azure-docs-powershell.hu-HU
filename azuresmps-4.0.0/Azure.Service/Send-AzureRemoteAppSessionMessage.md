...
## Áttekintés
Üzenetet küld egy felhasználónak.
...
## Leírás
A **Send-AzureRemoteAppSessionMessage** parancsmag üzenetet küld azoknak a felhasználóknak, akik Azure RemoteApp-munkamenethez csatlakoznak.

## Példák

### 1. példa: üzenet küldése egy felhasználónak
```
...
Ez a parancs üzenetet küld annak a felhasználónak, akinek az UPN-je PattiFuller@contoso.com .
