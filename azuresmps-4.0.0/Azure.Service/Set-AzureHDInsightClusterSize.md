...
## Áttekintés
A HDInsight-fürtök adatcsomópontjainak számát állítja be.

## SZINTAXISA

### A szektorcsoport méretének beállítása a név nevű csomópontokban
```
Set-AzureHDInsightClusterSize -ClusterSizeInNodes <Int32> -Name <String> [-Force] [-Profile <AzureSMProfile>]
 [<CommonParameters>]
```

### A szektorcsoportok méretének beállítása a fürtöket a csővezetéket szolgáltató csomópontok között.
```
...
A **set-AzureHDInsightClusterSize** parancsmag az Azure HDInsight-fürtök adatcsomópontjainak számát állítja be.
...
### -Cluster
Az átméretezni kívánt szektorcsoportot adja meg.
...
### -Name (név)
Az átméretezni kívánt HDInsight-szektorcsoport nevét adja meg.
...
Ez a parancsmag a paraméter által megadott előfizetéshez tartozó szektorcsoport-méretet adja meg.
