...
## Áttekintés
Felhőbeli szolgáltatás bővítményt ad hozzá a bevezetéshez.
...
## Leírás
A **set-AzureServiceExtension** parancsmag a Felhőbeli szolgáltatások bővítményét hozzáadja a központi üzembe helyezéshez.

## Példák

### 1. példa: Felhőbeli szolgáltatás hozzáadása a központi üzembe helyezéshez
```
...
Ez a parancs Felhőbeli szolgáltatást ad a bevezetéshez.

### 2. példa: Felhőbeli szolgáltatás hozzáadása adott szerepkör telepítéséhez
```
...
Ez a parancs Felhőbeli szolgáltatást ad a központi üzembe helyezéshez meghatározott szerepkörhöz.
...
### -ThumbprintAlgorithm
A tanúsítványt azonosító ujjlenyomat-ujjlenyomat-algoritmust adja meg.
