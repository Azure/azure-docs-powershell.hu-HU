...
## Áttekintés
Frissíti a meglévő kötetek tulajdonságait.
...
## Leírás
A **set-AzureStorSimpleDeviceVolume** parancsmag frissíti egy meglévő kötet tulajdonságait.
Ez a parancsmag egy vagy több hozzáférés-vezérlési rekorddal rendelkező kötetet társít.
Ha **AccessControlRecord** -objektumokat szeretne beolvasni, használja a **Get-AzureStorSimpleAccessControlRecord** parancsmagot.
A kötet méretének vagy típusának frissítése
Azt is megadhatja, hogy a kötetet online szeretné-e létrehozni.

## Példák

### Példa 1: a kötet online értékének frissítése
```
...
Ez a parancs frissíti a Volume18 nevű kötetet, és a $False online értékét tartalmazza.
...
### 2. példa: az online érték módosítása és beírása
```
...
Ez a parancs frissíti a Volume18 nevű kötetet.
Módosította a típust, és módosítja az *online* paraméter értékét $Truera.
...
### -DeviceName
Annak a StorSimple-eszköznek a nevét adja meg, amelyen a kötetet frissíteni szeretné.
...
### -NewName
A StorSimple-eszköz új nevét adja meg.
...
### -Online
Megadja, hogy a kötet online legyen-e.
...
### -Volume
A frissítendő kötet nevét adja meg.
...
### -VolumeAppType
Azt adja meg, hogy a kötetet elsődleges vagy archív kötetként szeretné-e frissíteni.
...
### -VolumeSizeInBytes
A kötetben a frissített méretet adja meg bájtban.
...
Ez a parancsmag elfogadja a kötethez társítani kívánt **AccessControlRecord** -objektumok listáját.
