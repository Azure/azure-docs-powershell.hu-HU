...
## Áttekintés
Az Azure Virtual Machine egyéni parancsfájl-bővítményének adatait határozza meg.
...
## Leírás
A **set-AzureVMCustomScriptExtension** parancsmag az Azure Virtual Machine egyéni parancsfájl-bővítményének adatait állítja be.

## Példák

### Példa 1: a virtuális gép egyéni parancsfájl-bővítményének beállítása
```
...
Ez a parancs a virtuális gép egyéni parancsfájl-bővítményének adatait állítja be.

### 2. példa: a virtuális gép egyéni parancsfájl-kiterjesztésére vonatkozó információk beállítása a fájl elérési útján
```
...
Ez a parancs a virtuális gép egyéni parancsfájl-kiterjesztésére vonatkozó információkat több fájl URL-címének használatával állítja be.

## PARAMÉTEREK

### -Argumentum
Olyan karakterláncot ad meg, amely egy olyan argumentumot ad meg, amely a parancsmag futását a virtuális gépen futtatja.
...
### -ContainerName
A tároló nevét adja meg a tároló fiókon belül.
...
### -Fájlnév
A megadott tárolóban lévő blob-fájlok nevét tartalmazó karakterlánc-tömböt ad meg.
...
### -FileUri
A blob-fájlok URL-címét tartalmazó karakterlánc-tömböt ad meg.
...
### -ForceUpdate
Azt jelzi, hogy ez a parancsmag újra alkalmazza a konfigurációt a bővítményre, ha a konfiguráció még nincs frissítve.
...
Ez a paraméter egy felhasználó által definiált karakterlánc, amellyel hivatkozhat a bővítményekre.
...
### -Run (Futtatás)
Azt a parancsot adja meg, amelyet a parancsmag a virtuális gép bővítménye által futtat.
Csak a "powershell.exe" támogatott.
...
### -StorageAccountName
A tárolási fiók nevét adja meg az aktuális előfizetésben.
...
A tárterület-szolgáltatási végpontot adja meg.
...
### -Uninstall
Azt jelzi, hogy ez a parancsmag eltávolítja az egyéni parancsfájl-kiterjesztést a virtuális gépről.
...
### -Verzió
Az egyéni parancsfájl-kiterjesztés verziószámát adja meg.
