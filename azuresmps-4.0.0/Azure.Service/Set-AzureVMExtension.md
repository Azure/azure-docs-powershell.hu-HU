...
## Áttekintés
A virtuális gépek erőforrás-bővítményeinek beállítása.

## SZINTAXISA

### SetByExtensionName (alapértelmezett)
```
...
## Leírás
A **set-AzureVMExtension** parancsmag a virtuális gépek erőforrás-kiterjesztését állítja be.

## Példák

### Példa 1: virtuális gép létrehozása az alkalmazott erőforrás-kiterjesztésekkel
```
...
Ez a parancs létrehoz egy virtuális gépet az erőforrás-kiterjesztések alkalmazásával.
...
### -ExtensionName
A virtuális gép mellékének nevét adja meg.
...
### -ForceUpdate
Jelzi, hogy ez a parancsmag újra alkalmazza a konfigurációt, ha a konfiguráció még nincs frissítve.
...
### -PrivateConfigKey
Privát konfigurációs kulcsot ad meg.
...
### -PrivateConfigPath
A privát konfiguráció elérési útját adja meg.
...
### -PublicConfigKey
A nyilvános konfigurációs kulcsot adja meg.
...
### -PublicConfigPath
A nyilvános konfiguráció elérési útját adja meg.
...
Ez egy felhasználó által definiált karakterlánc, amellyel hivatkozhat a bővítményekre.
Ha a bővítményt első alkalommal hozzáadja a virtuális géphez, meg kell adnia.
...
### -Uninstall
Azt jelzi, hogy ez a parancsmag eltávolítja az erőforrás-kiterjesztést a virtuális gépről.
