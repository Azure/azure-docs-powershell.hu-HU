...
## Leírás
A **Start-AzureSiteRecoveryTestFailoverJob** parancsmag elindítja az Azure webhely-helyreállítási védelmi szervezet vagy helyreállítási terv feladatátvételét.
Ellenőrizheti, hogy a feladat sikeres volt-e a **Get-AzureRMSiteRecoveryJob** parancsmag használatával.

## Példák

### Példa 1: teszt-feladatátvétel indítása
```
...
A végleges parancs elindítja a teszt-feladatátvételi műveletet az $ProtectionEntity tárolt védett entitások esetében, és a feladatátvétel irányát adja meg.

### 2. példa: teszt-feladatátvétel indítása helyreállítási csomag használatával
```
...
Ez a parancs a **Get-AzureSiteRecoveryRecoveryPlan** parancsmaggal megkapja a RecoveryPlan01 nevű helyreállítási tervet az aktuális Azure webhely-helyreállítási boltozathoz.
A parancs a csomagot a $RecoveryPlan változóban tárolja.

A második parancs elindítja a teszt-feladatátvételi műveletet az $RecoveryPlan tárolt helyreállítási tervhez, és a feladatátvétel irányát adja meg.
...
### -LogicalNetworkId
A logikai hálózat AZONOSÍTÓját adja meg.
...
### – Hálózat
Annak a hálózati objektumnak a meghatározása, amelyet a feladatátvétel teszteléséhez használni kell.
Ha hálózatba szeretne hozzájutni, használja a **Get-AzureSiteRecoveryNetwork** parancsmagot.
...
### -NetworkType
A feladatátvétel teszteléséhez használandó hálózati típust adja meg.
A paraméter elfogadható értékei a következők:
...
### -RecoveryPlan
Azt a helyreállítási tervet adja meg, amelyre a feladatot el szeretné indítani.
...
### -VmNetworkId
A virtuálisgép-hálózat AZONOSÍTÓját adja meg.
