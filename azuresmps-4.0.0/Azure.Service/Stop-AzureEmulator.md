...
## Áttekintés
Leállítja a számítási emulátort.
...
A **stop-AzureEmulator** parancsmag leállítja az Azure számítási emulátort.
Az emulátorban jelenleg futó szolgáltatások törlődnek.
