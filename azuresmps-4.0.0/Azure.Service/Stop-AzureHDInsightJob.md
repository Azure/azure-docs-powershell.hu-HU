...
## Áttekintés
Leállít egy HDInsight-feladatot.
...
A **stop-AzureHDInsightJob** parancsmag egy Azure HDInsight-feladatot állít le a megadott fürtön.
...
### -Cluster
Egy fürtöt ad meg.
Ezzel a parancsmaggal megszüntetheti a fürtön futó olyan feladatot, amelyet a paraméter határoz meg.
...
### -JobId
A HDInsight feladat AZONOSÍTÓját adja meg.
...
Ez a parancsmag leállítja a paraméter által megadott előfizetéshez tartozó munkát.
