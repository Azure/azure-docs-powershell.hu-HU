...
## Leírás
A virtuálisgép-bővítmények lemezképének létrehozása
...
Vegyen fel egy új platform képkiterjesztést.
...
### -ComputeRole
A szerepkör, a IaaS vagy a Péter, ez a bővítmény támogatja.
...
### -SourceBlob
URI a Virtual Machine Extension csomaghoz.
...
### -Verzió
A vritual Machine Image Extension verziója.
