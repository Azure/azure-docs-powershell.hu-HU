...
### Példa 1: létező VM-kiterjesztés eltávolítása 
```powershell
PS C:\> Remove-AzsVMExtension -Location local -Publisher Microsoft -Type MicroExtension -Version 0.1.0
```

A számítási kvóta eltávolításának sikeres felhívása nem ad vissza semmilyen eredményt.

### 2. példa: nem létező VM-kiterjesztés eltávolítása
```powershell
