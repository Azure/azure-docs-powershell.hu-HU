...
```
## Leírás
Számítási kvóta frissítése

## Példák

### Példa 1: meglévő számítási kvóta tulajdonságainak beállítása
```powershell
...
Adja meg a parancssorban megadott paramétereket.
A nem beállított paraméterek értéke alapértelmezés szerint 0 lesz
