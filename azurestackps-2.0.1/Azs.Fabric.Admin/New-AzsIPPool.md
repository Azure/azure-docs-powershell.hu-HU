...
### -Hely
Az a terület, ahol az erőforrás található.
...
Az aktuálisan lefoglalt IP-címek száma.
...
Az IP-címek jelenlegi száma az áttűnésben.
...
### -Pool (Pool)
Ez az erőforrás azt határozza meg, hogy az IP-címek tartománya milyen címekhez van hozzárendelve egy alhálózaton belül.
A kivitelezéshez lásd: jegyzetek szakasz a készlet tulajdonságaihoz, és hozzon létre egy ujjlenyomat-táblázatot.
...
POOL (POOL) <IIPPool> : ez az erőforrás azt határozza meg, hogy az IP-címek tartománya milyen címekhez van hozzárendelve egy alhálózaton belül.
  - `[Location <String>]`: Az a terület, ahol az erőforrás található.
  - `[Tag <IResourceTags>]`: A kulcs-érték párok listája.
    - `[(Any) <String>]`: Ez azt jelzi, hogy az objektumhoz bármely tulajdonság hozzá lehet adni.
  - `[AddressPrefix <String>]`: A cím előtagja.
  - `[EndIPAddress <String>]`: A záró IP-cím.
  - `[NumberOfAllocatedIPAddresses <Int64?>]`: Az aktuálisan lefoglalt IP-címek száma.
  - `[NumberOfIPAddresses <Int64?>]`: Az IP-címek teljes száma.
  - `[NumberOfIPAddressesInTransition <Int64?>]`: Az IP-címek aktuális száma az áttűnésben.
  - `[StartIPAddress <String>]`: A kezdő IP-cím.
