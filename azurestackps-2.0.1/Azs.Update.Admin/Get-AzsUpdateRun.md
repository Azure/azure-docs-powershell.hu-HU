...
## Áttekintés
Az AZONOSÍTÓval beolvashatja az Update Run példányát.
...
Ha nem adja meg a UpdateName értékét, a Get-UpdateRun mindig a bevitelt kérni fogja.
Egyszer megadhatja, hogy a UpdateRun minden olyan példányát kiadja, amely sikertelen volt vagy sikertelen volt.

### 2. példa: UpdateName szerint Get-AzsUpdateRun
```powershell
...
Egy adott frissítéshez társított összes UpdateRuns lekérése

### 2. példa: Get-AzsUpdateRun név szerint
```powershell
...
Visszaadja az adott frissítéshez társított összes UpdateRuns és egy konkrét nevet.
