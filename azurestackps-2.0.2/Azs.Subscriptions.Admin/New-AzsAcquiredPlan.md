...
A kivitelezéshez tekintse meg a ACQUIREDPLANDEFINITION tulajdonságainak megjegyzések szakaszát, és hozzon létre egy ujjlenyomat-táblázatot.
...
### Microsoft. Azure. PowerShell. parancsmagok. SubscriptionsAdmin. modellek. Api20151101. IPlanAcquisition
...
ACQUIREDPLANDEFINITION <IPlanAcquisition> : 
  - `[AcquisitionId <String>]`: Beszerzési azonosító.
  - `[AcquisitionTime <DateTime?>]`: Beszerzési idő.
  - `[ExternalReferenceId <String>]`: Külső hivatkozási azonosító.
  - `[Id <String>]`: Azonosító a bérlői előfizetési környezetben.
  - `[PlanId <String>]`: A csomag azonosítóját a bérlői előfizetési környezetben.
  - `[ProvisioningState <ProvisioningState?>]`: A kiépítés állapota
