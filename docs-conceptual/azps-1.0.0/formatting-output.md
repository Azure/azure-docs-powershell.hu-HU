...
Ebben a példában lekérjük az Azure-beli virtuális gépek listáját az alapértelmezett előfizetésben.  A `Get-AzVM` parancs kimenete alapértelmezés szerint táblázatos formában jelenik meg.
