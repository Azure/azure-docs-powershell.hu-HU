...
Az Azure PowerShell a Windows 7 vagy újabb rendszeren a PowerShell 5.x, más platformon a PowerShell 6.x verziójával működik.
...
Ha Windows rendszeren futtatja a PowerShell 5.x verziót, akkor a .NET-keretrendszer 4.7.2-es verziójának is telepítve kell lennie. A .NET-keretrendszer új verziójának frissítésével vagy telepítésével kapcsolatos utasításokat a [.NET-keretrendszer telepítési útmutatójában](/dotnet/framework/install) találja.
