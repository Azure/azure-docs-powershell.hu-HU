...
Az Azure PowerShellt bármely platformon telepítheti, amely támogatja a PowerShell 5.x vagy PowerShell 6.x verzióját, vagy futtathatja az Azure Cloud Shellben is.
