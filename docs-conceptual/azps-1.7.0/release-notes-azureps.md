...
* Ki lett javítva a hiba, amely akkor jelentkezett, amikor a `Get-AzResource` eredménye át lett irányítva a következőbe: `Set-AzResource`
    - További információ: https://github.com/Azure/azure-powershell/issues/8240
* Ki lett javítva a JSON-adattípus módosításával kapcsolatos probléma, amely a következő futtatásakor jelentkezett: `Set-AzResource`
...
### <a name="azresources"></a>Az.Resources
* Frissült a következők erőforrás-identitásokkal kapcsolatos paramétereinek súgódokumentációja: `New-AzureRmPolicyAssignment` és `Set-AzureRmPolicyAssignment`
