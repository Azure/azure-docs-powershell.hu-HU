...
A(z) `Get-AzApiManagementProperty` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.

### `New-AzApiManagementProperty`

A(z) `New-AzApiManagementProperty` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.

### `Remove-AzApiManagementProperty`

A(z) `Remove-AzApiManagementProperty` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.

### `Set-AzApiManagementProperty`

A(z) `Set-AzApiManagementProperty` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.
...
A(z) `Get-AzOperationalInsightsSavedSearchResult` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.

### `Get-AzOperationalInsightsSearchResult`

A(z) `Get-AzOperationalInsightsSearchResult` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.
...
A(z) `Get-AzOperationalInsightsLinkTarget` parancsmag el lett távolítva, és nem található alias az eredeti parancsmagnévhez.
