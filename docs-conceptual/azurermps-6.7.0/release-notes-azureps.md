...
#### <a name="azurestorage"></a><span data-ttu-id="18014-111">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="18014-111">Azure.Storage</span></span>
...
#### <a name="azurermbatch"></a><span data-ttu-id="18014-126">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="18014-126">AzureRM.Batch</span></span>
...
#### <a name="azurermcontainerinstance"></a><span data-ttu-id="18014-142">AzureRM.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="18014-142">AzureRM.ContainerInstance</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="18014-157">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="18014-157">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermlogicapp"></a><span data-ttu-id="18014-173">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="18014-173">AzureRM.LogicApp</span></span>
...
* <span data-ttu-id="18014-206">Frissítve az Azure ClientRuntime legújabb verziójára.</span><span class="sxs-lookup"><span data-stu-id="18014-206">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
* <span data-ttu-id="18014-228">Frissítve az Azure ClientRuntime legújabb verziójára.</span><span class="sxs-lookup"><span data-stu-id="18014-228">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="18014-243">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="18014-243">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="18014-258">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="18014-258">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="18014-276">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="18014-276">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="18014-292">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="18014-292">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="18014-307">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="18014-307">AzureRM.Storage</span></span>
...
#### <a name="azurermautomation"></a><span data-ttu-id="18014-324">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="18014-324">AzureRM.Automation</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="18014-338">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="18014-338">AzureRM.Network</span></span>
...
* <span data-ttu-id="18014-355">Standard – Prémium NameSpace migrálási parancsmagok hozzáadása:</span><span class="sxs-lookup"><span data-stu-id="18014-355">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    ...
    - <span data-ttu-id="18014-358">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="18014-358">Complete-AzureRmServiceBusMigration</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="18014-375">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="18014-375">AzureRM.Profile</span></span>
...
* <span data-ttu-id="18014-394">A DataLake-parancsmagok tesztelési helye javítva</span><span class="sxs-lookup"><span data-stu-id="18014-394">Fix location of test of DataLake cmdlets</span></span>
...
#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="18014-413">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="18014-413">AzureRM.RecoveryServices.Backup</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="18014-431">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="18014-431">AzureRM.ServiceBus</span></span>
...
* <span data-ttu-id="18014-448">A következő parancsmagok ki lettek javítva, így helyesen jelenítik meg a műveletazonosítót és a művelet állapotát:</span><span class="sxs-lookup"><span data-stu-id="18014-448">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    ...
    - <span data-ttu-id="18014-450">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="18014-450">Stop-AzureRmVM</span></span>
...
#### <a name="azurermpolicyinsights"></a><span data-ttu-id="18014-472">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="18014-472">AzureRM.PolicyInsights</span></span>
...
* <span data-ttu-id="18014-484">Frissült a Set-AzureRmWebApp, így az AppSettings nem lesz felülírva az -AssignIdentity használatakor</span><span class="sxs-lookup"><span data-stu-id="18014-484">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="18014-485">Frissült a New-AzureRmWebAppSlot, így figyelembe veszi az AppServicePlan paramétert választható paraméterként</span><span class="sxs-lookup"><span data-stu-id="18014-485">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="18014-486">6.2.1 – 2018. június</span><span class="sxs-lookup"><span data-stu-id="18014-486">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="18014-487">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="18014-487">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="18014-488">Frissült a PSWorkspace modell, így lehetővé teszi, hogy a hálózat a típust paraméterként használja</span><span class="sxs-lookup"><span data-stu-id="18014-488">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="18014-489">6.2.0 – 2018. június</span><span class="sxs-lookup"><span data-stu-id="18014-489">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="18014-490">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="18014-490">AzureRM.Profile</span></span>
* <span data-ttu-id="18014-491">Kijavítottuk a problémát, amely miatt a Newtonsoft.Json 10.0.3-as verziója nem töltődött be a modul importálása során</span><span class="sxs-lookup"><span data-stu-id="18014-491">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="18014-492">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="18014-492">AzureRM.Compute</span></span>
* <span data-ttu-id="18014-493">VMSS VM frissítési funkciója</span><span class="sxs-lookup"><span data-stu-id="18014-493">VMSS VM Update feature</span></span>
    - <span data-ttu-id="18014-494">Hozzá lett adva az Update-AzureRmVmssVM és a New-AzureRmVMDataDisk parancsmag</span><span class="sxs-lookup"><span data-stu-id="18014-494">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="18014-495">A VirtualMachineScaleSetVM paraméter hozzá lett adva az Add-AzureRmVMDataDisk parancsmaghoz, hogy adatlemezt lehessen hozzáadni a VMSS VM-hez</span><span class="sxs-lookup"><span data-stu-id="18014-495">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="18014-496">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="18014-496">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="18014-497">Az ADF .Net SDK frissült a 0.8.0-s előzetes verzióra, amely az alábbi változásokat tartalmazza:</span><span class="sxs-lookup"><span data-stu-id="18014-497">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="18014-498">Hozzá lett adva a gyári adattár konfigurálási művelete</span><span class="sxs-lookup"><span data-stu-id="18014-498">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="18014-499">Frissült a QuickBooks társított szolgáltatás a consumerKey és a consumerSecret tulajdonság elérhetővé tételéhez</span><span class="sxs-lookup"><span data-stu-id="18014-499">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="18014-500">Több modelltípus is frissült, a SecretBase-től az objektumig</span><span class="sxs-lookup"><span data-stu-id="18014-500">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="18014-501">A rendszer blobesemény-indítókkal bővült</span><span class="sxs-lookup"><span data-stu-id="18014-501">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="18014-502">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="18014-502">AzureRM.KeyVault</span></span>
* <span data-ttu-id="18014-503">A dokumentáció kimeneti példával bővült</span><span class="sxs-lookup"><span data-stu-id="18014-503">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="18014-504">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="18014-504">AzureRM.Network</span></span>
* <span data-ttu-id="18014-505">Engedélyezve lettek a Traffic Analytics-paraméterek a Network Watcher-parancsmagokon</span><span class="sxs-lookup"><span data-stu-id="18014-505">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="18014-506">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="18014-506">AzureRM.Resources</span></span>
* <span data-ttu-id="18014-507">Kijavítottuk a „PSResource” objektum(ok) Get-AzureRmResource által visszaadott „Properties” tulajdonságával kapcsolatos hibát</span><span class="sxs-lookup"><span data-stu-id="18014-507">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="18014-508">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="18014-508">AzureRM.Scheduler</span></span>
* <span data-ttu-id="18014-509">Kijavítottuk a hibát, amely miatt a ServiceBusQueueJob frissítése nem állított be új hitelesítési adatokat</span><span class="sxs-lookup"><span data-stu-id="18014-509">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="18014-510">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="18014-510">AzureRM.Sql</span></span>
* <span data-ttu-id="18014-511">A következő parancsmagok az opcionális LicenseType paraméterrel frissültek</span><span class="sxs-lookup"><span data-stu-id="18014-511">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="18014-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="18014-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="18014-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="18014-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="18014-514">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="18014-514">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="18014-515">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="18014-515">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="18014-516">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="18014-516">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="18014-517">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="18014-517">AzureRM.Websites</span></span>
* <span data-ttu-id="18014-518">Frissült a New-AzureRMWebApp, hogy képes legyen a stratégia könyvtárból származó bevett algoritmusok használatára.</span><span class="sxs-lookup"><span data-stu-id="18014-518">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="18014-519">6.1.0 – 2018. május</span><span class="sxs-lookup"><span data-stu-id="18014-519">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="18014-520">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="18014-520">AzureRM.Profile</span></span>
* <span data-ttu-id="18014-521">Ki lett javítva az a hiba, amelyben a „Clear-AzureRmContext” futtatása egy üres környezetet tartott meg az előző alapértelmezett környezet nevével, így a felhasználó nem tudott létrehozni új környezetet a régi néven</span><span class="sxs-lookup"><span data-stu-id="18014-521">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="18014-522">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="18014-522">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="18014-523">Az átjárók társítási/társításmegszüntetési műveleteinek engedélyezése.</span><span class="sxs-lookup"><span data-stu-id="18014-523">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="18014-524">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="18014-524">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="18014-525">Az ApiVersion, ApiRelease és ApiRevision paraméterek mostantól támogatottak</span><span class="sxs-lookup"><span data-stu-id="18014-525">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="18014-526">A Service Fabric háttérrendszer mostantól támogatott</span><span class="sxs-lookup"><span data-stu-id="18014-526">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="18014-527">Az Application Insights naplózó mostantól támogatott</span><span class="sxs-lookup"><span data-stu-id="18014-527">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="18014-528">Az „Alapszintű” termékváltozat érvényes termékváltozatként való elismerése mostantól támogatott az API Management szolgáltatásban</span><span class="sxs-lookup"><span data-stu-id="18014-528">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="18014-529">A privát hitelesítésszolgáltató által kiállított tanúsítványok fő- vagy hitelesítésszolgáltatói tanúsítványként való telepítése mostantól támogatott</span><span class="sxs-lookup"><span data-stu-id="18014-529">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="18014-530">Az egyéni SSL-tanúsítványok KeyVault- és többproxys gazdaneveken keresztüli fogadása mostantól támogatott</span><span class="sxs-lookup"><span data-stu-id="18014-530">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="18014-531">Az MSI-identitások mostantól támogatottak</span><span class="sxs-lookup"><span data-stu-id="18014-531">Added support for MSI identity</span></span>
* <span data-ttu-id="18014-532">A házirendek URL-kapcsolaton keresztüli fogadása mostantól támogatott MEGJEGYZÉS: A következő parancsmagok elavulttá válnak a jövőbeli kiadásokban</span><span class="sxs-lookup"><span data-stu-id="18014-532">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="18014-533">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="18014-533">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="18014-534">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="18014-534">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="18014-535">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="18014-535">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="18014-536">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="18014-536">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="18014-537">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="18014-537">AzureRM.Batch</span></span>
* <span data-ttu-id="18014-538">Új Get-AzureBatchPoolNodeCounts parancsmag kiadása</span><span class="sxs-lookup"><span data-stu-id="18014-538">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="18014-539">Új Start-AzureBatchComputeNodeServiceLogUpload parancsmag kiadása</span><span class="sxs-lookup"><span data-stu-id="18014-539">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="18014-540">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="18014-540">AzureRM.Consumption</span></span>
* <span data-ttu-id="18014-541">A Get-AzureRmConsumptionUsageDetail parancsmag kiegészítése új Expand, ResourceGroup, InstanceName, InstanceId, Tags és Top paraméterekkel</span><span class="sxs-lookup"><span data-stu-id="18014-541">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="18014-542">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="18014-542">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="18014-543">Az Export-AzureRmDataLakeStoreChildItemProperties példájának kijavítása</span><span class="sxs-lookup"><span data-stu-id="18014-543">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="18014-544">A Set-AzureRmDataLakeStoreItemAclEntry Recurse esetében fellépő null paraméter kivétel kijavítása</span><span class="sxs-lookup"><span data-stu-id="18014-544">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="18014-545">A Set-AzureRmDataLakeStoreItemAclEntry, a Set-AzureRmDataLakeStoreItemAcl és a Remove-AzureRmDataLakeStoreItemAclEntry súgófájljainak javítása</span><span class="sxs-lookup"><span data-stu-id="18014-545">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="18014-546">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="18014-546">AzureRM.Network</span></span>
* <span data-ttu-id="18014-547">A hálózati SDK-verzió felléptetése a 18.0.0-s előzetes verzióról a 19.0.0-s előzetes verzióra</span><span class="sxs-lookup"><span data-stu-id="18014-547">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="18014-548">Új parancsmag hozzáadva a protokollkonfigurációk létrehozásához</span><span class="sxs-lookup"><span data-stu-id="18014-548">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="18014-549">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="18014-549">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="18014-550">Új parancsmag hozzáadva az új kapcsolatcsoportok hozzáadásához a meglévő ExpressRoute-kapcsolatcsoportokhoz.</span><span class="sxs-lookup"><span data-stu-id="18014-550">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="18014-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="18014-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="18014-552">Új parancsmag hozzáadva a kapcsolatcsoportok eltávolításához a meglévő ExpressRoute-kapcsolatcsoportokból.</span><span class="sxs-lookup"><span data-stu-id="18014-552">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="18014-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="18014-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="18014-554">Új parancsmag hozzáadva a kapcsolatcsoportok lekéréséhez</span><span class="sxs-lookup"><span data-stu-id="18014-554">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="18014-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="18014-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="18014-556">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="18014-556">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="18014-557">A kiszolgálói hitelesítés létrehozott tanúsítványokkal való használata (5998. sz. hiba) ki lett javítva</span><span class="sxs-lookup"><span data-stu-id="18014-557">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="18014-558">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="18014-558">AzureRM.Sql</span></span>
* <span data-ttu-id="18014-559">A frissített naplózási parancsmagok lehetővé teszik az AuditAction és AuditActionGroup paraméterek eltávolítását</span><span class="sxs-lookup"><span data-stu-id="18014-559">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="18014-560">A Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy hibája ki lett javítva, amikor az új rugalmas adatmegőrzési szabályzatok megadásakor a parancs a következő hibát adta vissza: „A hosszútávú adatmegőrzési szabályzat megadása Azure Recovery Services-tárolókkal és szabályzatokkal már nem támogatott.</span><span class="sxs-lookup"><span data-stu-id="18014-560">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="18014-561">Adja le a kérést az új rugalmas adatmegőrzési szabályzattal”.</span><span class="sxs-lookup"><span data-stu-id="18014-561">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="18014-562">Az összes Azure SQL Database/ElasticPool létrehozással/frissítéssel kapcsolatos parancsmag frissítve lett az új Database API használatára, amely támogatja a termékváltozat tulajdonságot a méretezéssel és szintekkel kapcsolatos tulajdonságok esetében.</span><span class="sxs-lookup"><span data-stu-id="18014-562">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="18014-563">A frissített parancsmagok a következők:</span><span class="sxs-lookup"><span data-stu-id="18014-563">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="18014-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="18014-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="18014-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="18014-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="18014-566">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="18014-566">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="18014-567">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="18014-567">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="18014-568">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="18014-568">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="18014-569">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="18014-569">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="18014-570">A Get-AzureRmTrafficManagerProfile paramétereinek frissítésével a -ResourceGroupName paraméter megadása mostantól kötelező a -Name paraméter használata esetén.</span><span class="sxs-lookup"><span data-stu-id="18014-570">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
